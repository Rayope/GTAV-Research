...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_259(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_244(&Var0, 1);
	}
	...
	iVar61[1] = 59;
	iVar61[2] = 62;
	if (!func_241(&iVar61, &Var0, Local_91, 1f))
	{
	...
	while (true)
	{
		...
		func_190(Var0);
		func_182(&iLocal_268, &(Var0.f_9), Local_91);
		func_164(&Var0);
		if (func_149(&Var0, 0))
		{
			if (!func_2(&Var0))
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x562B
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5CC5
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x607B
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		if (fVar0 < (20f * 20f) && iLocal_97)
		{
			switch (iLocal_98)
			{
				case 0:
					if (!func_129())
					{
						func_181(&uLocal_99, 3, uParam0->f_28[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_180(&uLocal_99, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
						...
						{
							func_172(&uLocal_99, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
							{
								TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
								TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
						...
						{
							func_172(&uLocal_99, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_1", 4, 0, 0);
							if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
							{
								TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
								TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
				...
				case 2:
					if (func_171(&uLocal_264))
					{
						if (func_165(&uLocal_264) > MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 15f))
						{
							iLocal_267++;
							switch (iLocal_267)
							{
								case 1:
									if (*uParam0 == 58)
									{
										func_180(&uLocal_99, "TOWAUD", "TONYA_BECK_2", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_2", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
								...
								case 2:
									if (*uParam0 == 58)
									{
										func_180(&uLocal_99, "TOWAUD", "TONYA_BECK_3", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_3", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
								...
								case 3:
									if (*uParam0 == 58)
									{
										func_180(&uLocal_99, "TOWAUD", "TONYA_BECK_4", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_4", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
								...
								case 4:
									if (*uParam0 == 58)
									{
										func_180(&uLocal_99, "TOWAUD", "TONYA_BECK_5", 4, 0, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECK2", "TONYA_BECK2_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
									...
									{
										func_172(&uLocal_99, "TOWAUD", "TONYA_BECKON", "TONYA_BECKON_5", 4, 0, 0);
										if (!ENTITY::IS_ENTITY_DEAD(uParam0->f_28[0]))
										{
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_95);
											TASK::OPEN_SEQUENCE_TASK(&uLocal_95);
...
float func_186(int iParam0, struct<3> Param1, int iParam4)//Position - 0xC21E
{
	struct<3> Var0;
...
int func_191(int iParam0, bool bParam1)//Position - 0xC38A
{
	...
	func_94(*iParam0, &Var0);
	if ((func_228(*iParam0) || func_226(*iParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
bool func_205(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD2C9
{
	...
	uVar0 = func_206(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_206(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xD38A
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_210(struct<3> Param0, struct<3> Param3)//Position - 0xD656
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_218(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xD9D4
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_227() && Global_89962.f_11 == 6) && iParam0 == func_147(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_230(var uParam0)//Position - 0xDD99
{
	...
	switch (iLocal_90)
	{
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
			{
				TASK::CLEAR_SEQUENCE_TASK(&uVar1);
				TASK::OPEN_SEQUENCE_TASK(&uVar1);
...
int func_241(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE488
{
	int iVar0;
...
int func_242(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xE4ED
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_243(Var1.f_6, Param1, fParam4))
	{
...
int func_243(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xE56A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
