...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	iLocal_37 = joaat("prop_forsale_lenny_01");
...
void func_1()//Position - 0xD3
{
	...
	if (iLocal_41)
	{
		if (func_46(uLocal_43))
		{
			if ((((!func_45() && !PED::IS_PED_FLEEING(uLocal_43)) && !PED::IS_PED_RAGDOLL(uLocal_43)) && !PED::IS_PED_PRONE(uLocal_43)) && !PED::IS_PED_INJURED(uLocal_43))
			{
				if (func_44(uLocal_43, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_42) > 8000)
					{
						if (func_27(&uLocal_44, "JOSH1AU", "JOSH1_AMB2", 7, 0, 0, 0))
						{
			...
			if (func_44(uLocal_43, PLAYER::PLAYER_PED_ID(), 1) > 150f)
			{
				func_26(&uLocal_43);
			}
		}
	...
	while (iVar0 < 15)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_209[iVar0 /*11*/]))
		{
			if (OBJECT::HAS_OBJECT_BEEN_BROKEN(Local_209[iVar0 /*11*/]) || func_24(Local_209[iVar0 /*11*/]))
			{
				MISC::SET_BIT(&(Global_97353.f_8303.f_108), iVar0);
				func_21(iVar0);
				ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(Local_209[iVar0 /*11*/]));
				bLocal_38 = true;
				func_20(1, 0);
				func_18();
			}
			...
			{
				func_16(&(Local_209[iVar0 /*11*/]), &(Local_209[iVar0 /*11*/].f_10));
			}
		}
		else if (!MISC::IS_BIT_SET(Global_97353.f_8303.f_108, iVar0))
		{
			func_13(&(Local_209[iVar0 /*11*/]), iLocal_37, 0, 200f);
		}
		iVar0++;
	}
	func_11();
	if (!bLocal_375 && !bLocal_38)
	{
		if (func_2(2))
		{
			iLocal_36 = 2;
...
int func_2(int iParam0)//Position - 0x247
{
	int iVar0;
	...
	else
	{
		...
		{
			if (!MISC::IS_BIT_SET(Global_97353.f_8303.f_108, func_3(func_4(iParam0), iVar0)))
			{
				return 0;
			}
			iVar0++;
...
int func_3(int iParam0, int iParam1)//Position - 0x2A6
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_4(int iParam0)//Position - 0x2C2
{
	if (iParam0 == 3)
	{
		return 30;
...
int func_5(int iParam0)//Position - 0x312
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == 2)
	{
		...
		{
			if (MISC::IS_BIT_SET(Global_97353.f_8303.f_108, func_3(func_4(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_6(int iParam0, int iParam1, int iParam2)//Position - 0x3DA
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_7(int iParam0)//Position - 0x417
{
	int iVar0;
...
int func_8(int iParam0, int iParam1)//Position - 0x577
{
	int iVar0;
...
int func_9()//Position - 0x6C0
{
	return Global_1312737;
}

int func_10(int iParam0)//Position - 0x6CC
{
	if (iParam0 == 3)
	{
		return 815;
	...
	if (bLocal_38)
	{
		switch (iLocal_39)
		{
			case 0:
				...
				{
					uLocal_40 = unk_0x67D02A194A2FC2BD("MIDSIZED_MESSAGE");
					if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_40))
					{
						uVar0 = AUDIO::GET_SOUND_ID();
						AUDIO::PLAY_SOUND_FRONTEND(uVar0, "SIGN_DESTROYED", "HUD_AWARDS", 1);
						iLocal_39++;
					}
				}
				break;
			...
			case 1:
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_40, "SHOW_SHARD_MIDSIZED_MESSAGE");
			...
			case 2:
				...
				{
					GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_40, "SHARD_ANIM_OUT");
				...
				else if (!func_12())
				{
					if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_40))
					{
						GRAPHICS::DRAW_SCALEFORM_MOVIE_FULLSCREEN(uLocal_40, 100, 100, 100, 255, 0);
					}
				}
				break;
			...
			case 4:
				if (GRAPHICS::HAS_SCALEFORM_MOVIE_LOADED(uLocal_40))
				{
					GRAPHICS::SET_SCALEFORM_MOVIE_AS_NO_LONGER_NEEDED(&uLocal_40);
				}
				bLocal_375 = false;
				bLocal_38 = false;
				iLocal_39 = 0;
...
void func_13(var uParam0, int iParam1, bool bParam2, float fParam3)//Position - 0x880
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (func_15(PLAYER::PLAYER_PED_ID(), uParam0->f_3, fParam3) && !ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			...
			*uParam0 = OBJECT::CREATE_OBJECT(iParam1, uParam0->f_3, 1, 1, 0);
			uParam0->f_10 = 1;
...
void func_14(struct<3> Param0)//Position - 0x911
{
	var uVar0;
...
bool func_15(var uParam0, struct<3> Param1, float fParam4)//Position - 0x94F
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Param1) <= (fParam4 * fParam4);
}

void func_16(var uParam0, var uParam1)//Position - 0x96C
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(*uParam0, 1), 1) >= 110f && !ENTITY::IS_ENTITY_ON_SCREEN(*uParam0))
		{
			func_17(uParam0);
			*uParam1 = 0;
		}
...
void func_17(var uParam0)//Position - 0x9B6
{
...
bool func_19(bool bParam0)//Position - 0xA2C
{
...
void func_20(int iParam0, int iParam1)//Position - 0xA57
{
	Global_90001.f_7 = iParam0;
	Global_90001.f_8 = iParam1;
}

void func_21(int iParam0)//Position - 0xA6F
{
	if (iParam0 < 16)
	{
...
void func_22(int iParam0, int iParam1)//Position - 0xA99
{
	int iVar0;
...
int func_23(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xABC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_24(var uParam0)//Position - 0xD17
{
	struct<3> Var0;
...
void func_25(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD68
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_26(var uParam0)//Position - 0xDB7
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
bool func_27(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xDF6
{
...
int func_28(char* sParam0, int iParam1, bool bParam2)//Position - 0xE44
{
	Global_15693 = 0;
...
var func_34()//Position - 0x1337
{
	func_35();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_35()//Position - 0x1350
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_38(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_36(iVar0) && (!func_39(14) || Global_96306))
			{
...
bool func_36(int iParam0)//Position - 0x144D
{
	return iParam0 < 3;
}

int func_37(var uParam0)//Position - 0x1459
{
	int iVar0;
	int iVar1;
...
int func_38(int iParam0)//Position - 0x1496
{
	if (func_36(iParam0))
	{
...
bool func_39(int iParam0)//Position - 0x14C0
{
	return Global_34913 == iParam0;
}

void func_40()//Position - 0x14CE
{
	int iVar0;
...
bool func_41(int iParam0, int iParam1)//Position - 0x1525
{
	switch (iParam0)
	{
		case 5:
...
void func_43(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x15B7
{
...
float func_44(var uParam0, var uParam1, int iParam2)//Position - 0x160D
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_46(var uParam0)//Position - 0x168B
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(uParam0))
...
void func_47()//Position - 0x16AB
{
	iLocal_41 = func_48();
	if (!func_2(2))
	{
		Local_209[0 /*11*/].f_3 = { -1569.525f, 444.04f, 108.135f };
		Local_209[0 /*11*/].f_9 = 80f;
		Local_209[1 /*11*/].f_3 = { -1352.88f, 613.77f, 134.34f };
		Local_209[1 /*11*/].f_9 = 198f;
		Local_209[2 /*11*/].f_3 = { -1467f, -5.5f, 53.105f };
		Local_209[2 /*11*/].f_9 = 104f;
		Local_209[3 /*11*/].f_3 = { -1632.833f, -413.8573f, 39.9441f };
		Local_209[3 /*11*/].f_9 = 321.5f;
		Local_209[4 /*11*/].f_3 = { -1765.678f, -423.9763f, 41.5f };
		Local_209[4 /*11*/].f_9 = 256.25f;
		Local_209[5 /*11*/].f_3 = { -380.75f, 427.79f, 110.97f };
		Local_209[5 /*11*/].f_9 = 286.5f;
		Local_209[6 /*11*/].f_3 = { -163.2826f, 989.2324f, 234.0641f };
		Local_209[6 /*11*/].f_9 = 0f;
		Local_209[7 /*11*/].f_3 = { -493.083f, 588.6333f, 122.485f };
		Local_209[7 /*11*/].f_9 = 177.2061f;
		Local_209[8 /*11*/].f_3 = { -818.84f, 434.74f, 88.15f };
		Local_209[8 /*11*/].f_9 = 91.5f;
		Local_209[9 /*11*/].f_3 = { -913.24f, 785.4f, 184.66f };
		Local_209[9 /*11*/].f_9 = 96.26f;
		Local_209[10 /*11*/].f_3 = { -825.92f, -26.67f, 38.68f };
		Local_209[10 /*11*/].f_9 = 15f;
		Local_209[11 /*11*/].f_3 = { -1103.5f, 587.29f, 103.25f };
		Local_209[11 /*11*/].f_9 = 305.5f;
		Local_209[12 /*11*/].f_3 = { -1253.439f, 491.05f, 94.3706f };
		Local_209[12 /*11*/].f_9 = 0f;
		Local_209[13 /*11*/].f_3 = { 160.29f, 486.71f, 142.96f };
		Local_209[13 /*11*/].f_9 = 95f;
		Local_209[14 /*11*/].f_3 = { -1163.859f, 319.19f, 67.96f };
		Local_209[14 /*11*/].f_9 = 40f;
		iLocal_36 = 1;
	}
	else
	{
	...
	while (iVar1 < iVar0)
	{
		if (func_46(uVar2[iVar1]))
		{
			if (ENTITY::GET_ENTITY_MODEL(uVar2[iVar1]) == func_50(58))
			{
				...
				PED::SET_PED_NAME_DEBUG(uLocal_43, "POSTJOSH");
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_43, 1862763509);
				func_49(&uLocal_44, 5, uLocal_43, "JOSH", 1, 1);
				return 1;
			}
		}
		iVar1++;
...
void func_49(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1995
{
...
int func_50(int iParam0)//Position - 0x1A30
{
	if (!func_36(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
...
int func_51(int iParam0)//Position - 0x1A5B
{
...
int func_52(int iParam0)//Position - 0x1A88
{
	int iVar0;
	int iVar1;
...
void func_53()//Position - 0x1AE2
{
	...
	while (iVar0 < 15)
	{
		func_66(&(Local_209[iVar0 /*11*/].f_2));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 < 15)
	{
		func_65(&(Local_209[iVar0 /*11*/]), 0);
		iVar0++;
	}
...
int func_54(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1B89
{
	struct<14> Var0;
...
void func_55(int iParam0)//Position - 0x1CA4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_56(int iParam0)//Position - 0x1D68
{
	switch (iParam0)
	{
		case 0:
...
void func_57(char* sParam0)//Position - 0x1DD2
{
	int iVar0;
...
int func_58(int iParam0)//Position - 0x1E86
{
...
void func_59(char* sParam0, int iParam1)//Position - 0x1EDB
{
	int iVar0;
...
int func_60(int iParam0)//Position - 0x1FF3
{
	int iVar0;
	int iVar1;
...
void func_61(int iParam0, int iParam1, int iParam2)//Position - 0x204D
{
	bool bVar0;
...
void func_62()//Position - 0x2135
{
	...
	{
		func_64(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
int func_63()//Position - 0x25F6
{
	return Global_24444;
}

int func_64(int iParam0, int iParam1)//Position - 0x2601
{
	int iVar0;
...
void func_65(var uParam0, bool bParam1)//Position - 0x2652
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_66(var uParam0)//Position - 0x268D
{
