...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_239(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_226(&Var0, 1);
	}
	...
	func_211(&Var0);
	uLocal_91 = PED::ADD_SCENARIO_BLOCKING_AREA(Var61 - Vector(20f, 20f, 20f), Var61 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x55BE
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5C58
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x600E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_168(int iParam0, struct<3> Param1, int iParam4)//Position - 0xABC9
{
	struct<3> Var0;
...
int func_188(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xBD35
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_192(struct<3> Param0, struct<3> Param3)//Position - 0xC003
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_200(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xC381
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_223(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xCB5E
{
	int iVar0;
...
int func_224(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xCBC3
{
	int iVar0;
	struct<7> Var1;
...
int func_225(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xCC40
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
