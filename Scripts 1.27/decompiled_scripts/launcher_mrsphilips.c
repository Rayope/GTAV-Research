...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_239(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_226(&Var0, 1);
	}
	iVar2[0] = 35;
	if (!func_223(&iVar2, &Var0, Var1, 1f))
	{
		func_222();
	...
	func_211(&Var0);
	uLocal_51 = PED::ADD_SCENARIO_BLOCKING_AREA(Var1 - Vector(20f, 20f, 20f), Var1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
	...
	while (true)
	{
		...
		func_172(Var0);
		func_164(&iLocal_50, &(Var0.f_9), Var1);
		if (func_149(&Var0, 0))
		{
			if (Var0 == 35)
			{
...
int func_26(var uParam0)//Position - 0x2838
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x285A
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28E1
{
...
int func_29(int iParam0)//Position - 0x2921
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x294F
{
...
int func_31(int iParam0)//Position - 0x2A2B
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A6D
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2AD0
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2B5E
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BA0
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E17
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E23
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x30CF
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x317F
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x3259
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3309
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x3436
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34A7
{
...
int func_44(int iParam0)//Position - 0x357F
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x35BC
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x35E6
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x3790
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x37C2
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x37F6
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x3802
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x382E
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D76
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x40D1
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x40DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x41D2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x4436
{
...
int func_59(int iParam0, int iParam1)//Position - 0x455C
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4D78
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4DB3
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x5027
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x5063
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x55BE
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x5602
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5C58
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5C81
{
...
bool func_68(int iParam0)//Position - 0x5CDA
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5CEA
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5D4A
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x5FF3
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x5FFE
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x600E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x60A5
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x6576
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x6586
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x67DF
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x67F0
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x6836
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x68BC
{
...
void func_81(var uParam0, int iParam1)//Position - 0x68EF
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x6940
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x69E2
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6A07
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6A1E
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6A2B
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6A65
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6AA0
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6ADC
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6AF5
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6B4E
{
...
bool func_92(bool bParam0)//Position - 0x6B8F
{
...
struct<2> func_93(int iParam0)//Position - 0x6BBA
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x7006
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x824F
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x8595
{
	var uVar0;
...
void func_98(int iParam0)//Position - 0x8639
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x86D4
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x8732
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x878B
{
...
int func_103(int iParam0)//Position - 0x880E
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x883F
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x8853
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x88FB
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x8916
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8962
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x89AB
{
	if (func_111(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x89CB
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_112(int iParam0)//Position - 0x89EB
{
	switch (iParam0)
	{
		case 5:
...
int func_114(int iParam0)//Position - 0x8ABB
{
	switch (iParam0)
	{
		case 5:
...
void func_115(var uParam0, int iParam1, bool bParam2)//Position - 0x8B0E
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x8C02
{
	switch (iParam0)
	{
		case 5:
...
void func_117(bool bParam0)//Position - 0x8C6D
{
	var uVar0;
...
void func_118(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8CA9
{
	if (bParam0)
	{
...
int func_119(int iParam0)//Position - 0x8D7A
{
...
bool func_120()//Position - 0x8DBB
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_121(int iParam0, int iParam1)//Position - 0x8DCC
{
	bool bVar0;
...
int func_122(int iParam0, bool bParam1)//Position - 0x8E17
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, var uParam1, var uParam2)//Position - 0x8E58
{
	int iVar0;
...
void func_125(int iParam0)//Position - 0x8EB0
{
	if (iParam0 == 1)
	{
...
int func_126(char* sParam0)//Position - 0x8ED3
{
...
void func_127()//Position - 0x8F10
{
	Global_38DE = 0;
	func_128();
}

void func_128()//Position - 0x8F20
{
...
int func_132(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x9004
{
...
void func_135(int iParam0)//Position - 0x91FF
{
	if (Global_38D7)
	{
		func_136(0, 0);
...
void func_136(bool bParam0, bool bParam1)//Position - 0x926F
{
	if (bParam0)
	{
		if (func_137(0))
...
int func_137(int iParam0)//Position - 0x92E3
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_138(int iParam0)//Position - 0x933D
{
...
int func_139(int iParam0)//Position - 0x937E
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0x93C3
{
...
int func_141(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x93F5
{
	int iVar0;
...
void func_142(var uParam0, int iParam1)//Position - 0x952C
{
	int iVar0;
...
bool func_143(int iParam0)//Position - 0x957B
{
	return func_144(iParam0, Global_8861);
}

int func_144(int iParam0, int iParam1)//Position - 0x958C
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_145(int iParam0)//Position - 0x976D
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_146()//Position - 0x978F
{
	return func_147(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_147(var uParam0, int iParam1)//Position - 0x97A0
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_149(var uParam0, int iParam1)//Position - 0x980D
{
	switch (uParam0->f_10)
	{
		case 0:
...
void func_150()//Position - 0x9FEF
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_151(var uParam0)//Position - 0xA00A
{
	float fVar0;
...
void func_152(int iParam0, int iParam1)//Position - 0xA098
{
	if (iParam0 == 1)
	{
		if (!func_114(iParam1))
...
int func_153(bool bParam0)//Position - 0xA0FB
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0xA192
{
	if (func_111(uParam0))
	{
...
int func_155(int iParam0)//Position - 0xA1BC
{
	int iVar0;
...
var func_156()//Position - 0xA8D9
{
	return Global_15F91.f_1;
}

int func_157()//Position - 0xA8E7
{
	if (Global_154F9 != -1)
	{
...
bool func_160()//Position - 0xA951
{
	return Global_15F9E.f_123 > 0;
}

bool func_161(int iParam0, int iParam1)//Position - 0xA962
{
	switch (iParam0)
	{
		case 5:
...
var func_162()//Position - 0xA99D
{
	return Global_14143C;
}

int func_163()//Position - 0xA9A9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_164(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xA9C5
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_165(int iParam0, bool bParam1)//Position - 0xAAB6
{
	if (iParam0 == -1)
	{
		return;
...
int func_166(int iParam0)//Position - 0xAAF2
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_167(int iParam0, int iParam1)//Position - 0xAB2B
{
	bool bVar0;
	int iVar1;
...
float func_168(int iParam0, struct<3> Param1, int iParam2)//Position - 0xABC9
{
	struct<3> Var0;
...
bool func_169()//Position - 0xAC02
{
	return Global_1567C;
}

void func_170(int iParam0)//Position - 0xAC0E
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_171(iParam0);
...
void func_171(int iParam0)//Position - 0xAC25
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_172(int iParam0)//Position - 0xAD0D
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_173(var uParam0, bool bParam1)//Position - 0xAD35
{
	struct<27> Var0;
	...
	if ((func_210(*uParam0) || func_208(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
...
void func_174(int iParam0, var uParam1, int iParam2)//Position - 0xAFA8
{
	var uVar0;
	var uVar1;
...
int func_175(int iParam0)//Position - 0xB2FD
{
...
int func_176(var uParam0)//Position - 0xB31D
{
...
int func_177(var uParam0)//Position - 0xB335
{
...
void func_178(var uParam0)//Position - 0xB35A
{
	int iVar0;
	var uVar1;
...
void func_179(var uParam0)//Position - 0xB65E
{
...
void func_180(var uParam0)//Position - 0xB689
{
	int iVar0;
...
int func_181(var uParam0, bool bParam1, bool bParam2)//Position - 0xB709
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_182(int iParam0, int iParam1)//Position - 0xB8C6
{
	int iVar0;
...
int func_183(var uParam0, bool bParam1, int iParam2)//Position - 0xB8F6
{
	int iVar0;
	int iVar1;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_202(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_197(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_178(uParam0);
						...
						if (func_185(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_178(uParam0);
...
int func_184(int iParam0)//Position - 0xBBB2
{
...
int func_185(int iParam0, float fParam1)//Position - 0xBBE6
{
	float fVar0;
...
bool func_186(int iParam0, float fParam1)//Position - 0xBC5C
{
	return func_187(iParam0, PLAYER::PLAYER_PED_ID(), fParam1, 1, 250, 7);
}

bool func_187(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBC74
{
	var uVar0;
	struct<3> Var1;
	int iVar2;
	...
	uVar0 = func_188(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_188(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xBD35
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_189(int iParam0, int iParam1)//Position - 0xBE61
{
	int iVar0;
...
int func_191(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xBF70
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_192(struct<3> Param0, struct<3> Param1)//Position - 0xC003
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_193(struct<3> Param0)//Position - 0xC024
{
	float fVar0;
	float fVar1;
...
void func_194(var uParam0)//Position - 0xC063
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_195(int iParam0, int iParam1)//Position - 0xC07E
{
	int iVar0;
...
int func_196(var uParam0)//Position - 0xC0BD
{
...
int func_197(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC0E5
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_198(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC1E0
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_199(var uParam0, float fParam1)//Position - 0xC2EC
{
	var uVar0;
	struct<3> Var1;
...
int func_200(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xC381
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_201(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xC40F
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_202(int iParam0)//Position - 0xC457
{
...
void func_203(int iParam0)//Position - 0xC4A1
{
	var uVar0;
...
int func_204(int iParam0)//Position - 0xC53E
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_205(int iParam0)//Position - 0xC5D6
{
...
int func_208(int iParam0)//Position - 0xC658
{
	if ((func_209() && Global_15F6A.f_B == 6) && iParam0 == func_147(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_210(int iParam0)//Position - 0xC6CA
{
	if (func_92(0))
	{
...
void func_211(int iParam0)//Position - 0xC6F2
{
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
...
void func_212(int iParam0)//Position - 0xC71F
{
	iParam0->f_10 = 5;
...
int func_213(int iParam0)//Position - 0xC774
{
	struct<27> Var0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xC7C8
{
	char* sVar0;
...
int func_215(int iParam0)//Position - 0xC85F
{
	var uVar0;
...
int func_216(int iParam0)//Position - 0xC920
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_217(int iParam0, char* sParam1)//Position - 0xC9A5
{
...
bool func_218(int iParam0)//Position - 0xCA85
{
...
bool func_219(int iParam0)//Position - 0xCAB3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_220(int iParam0)//Position - 0xCAE1
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_221(int iParam0)//Position - 0xCB0F
{
	if (func_205(iParam0))
	{
		return 0;
...
void func_222()//Position - 0xCB44
{
	func_240("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_223(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xCB5E
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_224((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_224((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_224(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xCBC3
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_225(Var1.f_6, Param1, fParam2))
	{
...
int func_225(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xCC40
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_226(int iParam0, bool bParam1)//Position - 0xCC8C
{
	if (bParam1)
	{
...
void func_227(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xCCE0
{
...
void func_228(var uParam0, bool bParam1)//Position - 0xCD00
{
	func_229(&(uParam0->f_29), bParam1);
}

void func_229(var uParam0, bool bParam1)//Position - 0xCD12
{
	int iVar0;
...
void func_230(var uParam0, bool bParam1)//Position - 0xCD50
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_231(var uParam0, bool bParam1)//Position - 0xCD8B
{
	func_232(&(uParam0->f_23), bParam1);
}

void func_232(var uParam0, bool bParam1)//Position - 0xCD9D
{
	int iVar0;
...
void func_233(var uParam0)//Position - 0xCDDA
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_234(var uParam0)//Position - 0xCE11
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_235(var uParam0, int iParam1)//Position - 0xCEAD
{
	func_236(&(uParam0->f_1C), iParam1);
}

void func_236(var uParam0, int iParam1)//Position - 0xCEBF
{
	int iVar0;
...
void func_237(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCF00
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_238(var uParam0)//Position - 0xCF4F
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_239(var uParam0)//Position - 0xCF8E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_240(char* sParam0)//Position - 0xCFCB
{
...
void func_241(var uParam0)//Position - 0xCFDD
{
	*uParam0 = -1;
