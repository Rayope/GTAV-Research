...
void func_5()//Position - 0x276
{
	...
	{
		case 0:
			func_232(&uLocal_171, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		...
		case 1:
			if (func_216(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					if (func_216(iLocal_170) && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_170, 1))
					{
...
void func_14()//Position - 0x8A5
{
	...
	{
		if (func_17(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_28()//Position - 0xDFB
{
	...
	{
		func_30(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x1FD7
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_95(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_95(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_56(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2257
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_86(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_95(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_95(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x50C8
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_95(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F1E
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_95(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_82(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_101(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_101(Var16.f_2)] = func_82(iParam1, Var16.x, func_101(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_112(int iParam0, int iParam1, int iParam2)//Position - 0xCA0E
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_106(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_95(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_106(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_167(int iParam0, int iParam1, int iParam2)//Position - 0x1DDEF
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_95(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_95(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_180()//Position - 0x1FC72
{
	...
	{
		func_14();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_181(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_259(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x25FE1
{
	func_260(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_260(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2600A
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_264(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x26563
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_265(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x26859
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_279()//Position - 0x26D57
{
	...
	if (func_281())
	{
		if (MISC::GET_GAME_TIMER() < iLocal_145 && !func_280(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 5f))
		{
...
int func_287(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2711C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_291(struct<3> Param0, struct<3> Param3)//Position - 0x273E8
{
...
int func_299(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2776E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_308()//Position - 0x27ACA
{
	...
	if (func_281())
	{
		if (HUD::HAS_ADDITIONAL_TEXT_LOADED(0))
		{
			...
			if (func_275(PLAYER::PLAYER_PED_ID()) && func_275(Local_80.f_28[0]))
			{
...
{
	if (((!func_323(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_329(var uParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x289AE
{
	func_225(uParam0);
...
int func_330(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x289E9
{
...
int func_331(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0x28A44
{
	int iVar0;
