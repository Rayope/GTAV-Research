...
void func_15()//Position - 0x818
{
	...
	{
		func_17(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x19F4
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_82(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_82(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x1C74
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_73(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_82(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_82(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4AE5
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_82(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x593B
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_82(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_69(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_88(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_88(Var16.f_2)] = func_69(iParam1, Var16.x, func_88(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_100(int iParam0, int iParam1, int iParam2)//Position - 0xC518
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_82(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_93(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_155(int iParam0, int iParam1, int iParam2)//Position - 0x1D999
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_82(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_82(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_161()//Position - 0x1DD04
{
	...
	{
		if (func_157(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_172()//Position - 0x1F98C
{
	...
	{
		func_161();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_173(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
	...
	switch (iLocal_154)
	{
		...
		case 1:
			...
			if (!func_413(iLocal_155))
			{
				...
				if (!MISC::IS_BIT_SET(Global_97353.f_16828.f_382, 0))
				{
					MISC::SET_BIT(&(Global_97353.f_16828.f_382), 0);
				}
				func_279(4);
			}
...
void func_238()//Position - 0x25979
{
	if (!bLocal_506)
	{
		if (func_250(PLAYER::PLAYER_PED_ID(), iLocal_155, fLocal_333))
		{
...
void func_239(int iParam0, int iParam1, int iParam2, var uParam3, char* sParam4, char* sParam5, bool bParam6)//Position - 0x25A00
{
	...
	if (!*uParam3)
	{
		if (!iLocal_536)
		{
			if (!*iParam0)
			{
				if ((func_240(iLocal_155) && !PED::IS_PED_RAGDOLL(iLocal_155)) && !TASK::IS_PED_IN_WRITHE(iLocal_155))
				{
					if (func_250(PLAYER::PLAYER_PED_ID(), iLocal_155, fLocal_333))
					{
						if (!func_233())
...
int func_245(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x25E79
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_246(struct<3> Param0, struct<3> Param3)//Position - 0x25F07
{
...
void func_256(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x26186
{
...
void func_257(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x261BE
{
	int iVar0;
	int iVar1;
...
void func_266(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x268FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_269(struct<3> Param0, struct<3> Param3)//Position - 0x26A28
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}
	...
	switch (iLocal_154)
	{
		...
		case 1:
			...
			else
			{
				...
				func_241(0);
				func_254(&uLocal_548, iLocal_155, 0, 0, 1, 1, 1);
				if (((!iLocal_331 && func_250(PLAYER::PLAYER_PED_ID(), iLocal_155, 10f)) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_SITTING_IN_ANY_VEHICLE(iLocal_155))
				{
...
void func_283()//Position - 0x272FF
{
	if (func_413(Local_85.f_35[0]))
	{
		...
		else if (PED::IS_PED_BEING_JACKED(iLocal_155) || !func_3(Local_85.f_35[0]))
		{
			iLocal_331 = 1;
			func_279(3);
		}
...
bool func_285(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x273E1
{
...
void func_300()//Position - 0x27D04
{
	switch (iLocal_154)
	{
		case 0:
			...
			if (((CAM::IS_SCREEN_FADED_IN() && !func_423()) && func_413(iLocal_155)) && func_278(PLAYER::PLAYER_PED_ID(), Local_85.f_28[0], 1) > 4f)
			{
			...
			switch (iLocal_561)
			{
				...
				case 3:
					...
					else
					{
						...
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Dreyfuss", 0) && func_413(iLocal_155))
						{
...
void func_312(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x285D4
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_91351.f_4))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(Global_91351.f_4, 0))
		{
			if (func_355(24) != Global_91351.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_352(ENTITY::GET_ENTITY_COORDS(Global_91351.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_313(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)//Position - 0x2864F
{
	struct<54> Var0;
...
void func_344(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x2AF72
{
	if (func_341(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
...
void func_345(struct<54> Param0, var uParam54)//Position - 0x2B074
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_349(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_352(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2B679
{
	int iVar0;
...
int func_353(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2B78F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_356(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x2B852
{
	func_357(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_357(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2B87B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_359(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2BC8B
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_360(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2BF81
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_362(struct<3> Param0, int iParam3)//Position - 0x2C09B
{
	return func_363(Global_91351.f_2167.f_12.f_42, Param0, iParam3);
}

int func_363(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2C0B8
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_371()//Position - 0x2C455
{
	...
	if (iLocal_563 == 0)
	{
		if (func_413(iLocal_155))
		{
			if (func_278(PLAYER::PLAYER_PED_ID(), iLocal_155, 1) < 3f)
			{
				iLocal_563 = 1;
...
{
	if (((!func_392(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_398(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2D2B0
{
	var uVar0;
	int iVar1;
...
int func_403(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2D4DA
{
	int iVar0;
...
int func_405(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x2D5AE
{
	bool bVar0;
	float fVar1;
...
void func_410(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2DB16
{
	if (func_423())
	{
...
void func_412()//Position - 0x2DBD5
{
	...
	func_408();
	MISC::CLEAR_BIT(&(Global_97353.f_16828.f_382), 0);
	HUD::REQUEST_ADDITIONAL_TEXT("DREY1", 0);
	func_402(&uLocal_164, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_401();
	func_400();
}
...
void func_417(var uParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x2DEDB
{
	func_2(uParam0);
