...
void func_9()//Position - 0x479
{
	switch (iLocal_167)
	{
		...
		case 1:
			...
			else if (func_224(PLAYER::PLAYER_PED_ID(), iLocal_168) > 250f)
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) == 0)
				{
					iLocal_167 = 2;
			...
			else
			{
				...
				if (iLocal_337 == 0)
				{
					if (((!func_221() && func_220(iLocal_168, PLAYER::PLAYER_PED_ID(), 20f)) && !PED::IS_PED_RAGDOLL(iLocal_168)) && func_208(&uLocal_172, "SONARAU", "SONAR_SHOOTS", 7, 0, 0, 0))
					{
						iLocal_337 = 1;
					}
				}
				else if (((((iLocal_345 < 15 && !func_221()) && (MISC::GET_GAME_TIMER() - iLocal_342) > 10000) && func_220(iLocal_168, PLAYER::PLAYER_PED_ID(), 20f)) && !PED::IS_PED_RAGDOLL(iLocal_168)) && func_208(&uLocal_172, "SONARAU", "SONAR_CHASE", 7, 0, 0, 0))
				{
...
void func_229(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x256A6
{
...
void func_230(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x256DE
{
	int iVar0;
	int iVar1;
...
void func_239(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x25E1A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_242(struct<3> Param0, struct<3> Param3)//Position - 0x25F48
{
...
{
	if (!HUD::DOES_BLIP_EXIST(iLocal_169) && func_409(iLocal_168))
	{
...
void func_252()//Position - 0x26536
{
	switch (iLocal_167)
	{
		...
		case 1:
			...
			{
				if (((iLocal_339 == 0 && !func_221()) && func_220(iLocal_168, PLAYER::PLAYER_PED_ID(), 20f)) && func_208(&uLocal_172, "SONARAU", "SONAR_ARRIVE", 7, 0, 0, 0))
				{
					iLocal_339 = 1;
					func_250();
				}
				if (func_224(PLAYER::PLAYER_PED_ID(), iLocal_168) > 250f)
				{
					iLocal_167 = 2;
				}
			}
	...
	switch (iLocal_167)
	{
		...
		case 1:
			...
			else
			{
				...
				if (iLocal_338 == 0)
				{
					if (((func_409(iLocal_161) && PED::IS_PED_IN_VEHICLE(iLocal_168, iLocal_161, 1)) && func_220(iLocal_168, PLAYER::PLAYER_PED_ID(), 20f)) && func_208(&uLocal_172, "SONARAU", "SONAR_INCAR", 7, 0, 0, 0))
					{
						iLocal_338 = 1;
					}
					if (((((iLocal_344 < 7 && !func_221()) && (MISC::GET_GAME_TIMER() - iLocal_341) > 10000) && func_220(iLocal_168, PLAYER::PLAYER_PED_ID(), 20f)) && !PED::IS_PED_RAGDOLL(iLocal_168)) && func_208(&uLocal_172, "SONARAU", "SONAR_FOLLOW", 7, 0, 0, 0))
					{
						iLocal_341 = MISC::GET_GAME_TIMER();
						iLocal_344++;
					}
...
int func_264(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x26D9F
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_267(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x26FDA
{
	...
	{
		Var3 = { func_269(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_268(struct<3> Param0, struct<3> Param3)//Position - 0x2706B
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_277(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27430
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
		...
		case 1:
			switch (iLocal_350)
			{
				...
				case 2:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("ABIGAIL", func_444(16)) && func_409(iLocal_168))
						{
...
void func_288(int iParam0)//Position - 0x28306
{
	...
	else if (MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_290() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_97353.f_23789.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_290() /*8053*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
...
bool func_292(int iParam0)//Position - 0x2846F
{
	...
	return MISC::IS_BIT_SET(Global_2097152[func_290() /*8053*/].f_5756.f_10, iParam0);
}
...
int func_318(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x28C85
{
	bool bVar0;
	float fVar1;
...
void func_323(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x28F20
{
	func_324(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_324(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28F49
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_328(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x294A2
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_329(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x29798
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_338()//Position - 0x29BC0
{
	...
	if ((!func_221() && HUD::HAS_ADDITIONAL_TEXT_LOADED(0)) && STREAMING::HAS_MODEL_LOADED(iLocal_160))
	{
...
{
	if (((!func_357(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_363(struct<3> Param0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2AA57
{
	var uVar0;
	int iVar1;
...
void func_366(struct<3> Param0, float fParam3, struct<3> Param4, float fParam7, struct<3> Param8, float fParam11, struct<3> Param12, float fParam15)//Position - 0x2AAE8
{
	...
	{
		func_318(PLAYER::PLAYER_PED_ID(), Param0, fParam3, 0, 1);
	}
	STREAMING::REQUEST_MODEL(iLocal_160);
...
int func_368(int iParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0x2AC0A
{
	int iVar0;
...
void func_405(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2F509
{
	if (func_407())
	{
...
int func_424(char* sParam0, int iParam1, int iParam2)//Position - 0x2F983
{
	...
	if (func_430())
	{
		...
		{
			iVar33 = func_425(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
