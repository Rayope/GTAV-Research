		...
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
		{
			switch (iLocal_20)
			{
				...
				case 1:
					...
					{
						Global_35462 = 1;
						func_185(-1613.869f, -1054.958f, 12.0722f, -1082130432, 350, 1114636288, 0);
						CUTSCENE::REQUEST_CUTSCENE("SOL_5_MCS_2_P5", 8);
						func_184(0, 1);
						func_68(PLAYER::PLAYER_PED_ID(), 12, 35, 0, -1, 0, 0, 0, -1, -1, -1, 0);
						SYSTEM::WAIT(500);
						iLocal_20 = 2;
					}
					func_188();
				...
				case 2:
					if ((CUTSCENE::HAS_THIS_CUTSCENE_LOADED("SOL_5_MCS_2_P5") && func_67(0, 1)) && PED::HAVE_ALL_STREAMING_REQUESTS_COMPLETED(PLAYER::PLAYER_PED_ID()))
					{
						CLOCK::SET_CLOCK_TIME(7, 5, 30);
						MISC::SET_WEATHER_TYPE_NOW_PERSIST("EXTRASUNNY");
						MISC::CLEAR_WEATHER_TYPE_PERSIST();
						MISC::CLEAR_AREA(-1590.055f, -1037.067f, 12.0186f, 4f, 1, 0, 0, 0);
						func_53(&iLocal_21, 0, -1590.055f, -1037.067f, 12.0186f, 24.5062f, 1, 1);
						func_8(iLocal_21, -1590.055f, -1037.067f, 12.0186f, 24.5062f, 24, 0);
				...
				case 3:
					if (CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						if (!iLocal_19)
						{
							iLocal_22 = ENTITY::GET_PED_INDEX_FROM_ENTITY_INDEX(CUTSCENE::GET_ENTITY_INDEX_OF_CUTSCENE_ENTITY("Michael", joaat("player_zero")));
							if (ENTITY::DOES_ENTITY_EXIST(iLocal_22))
							{
								if (!ENTITY::IS_ENTITY_DEAD(iLocal_22))
								{
									PED::CLEAR_PED_BLOOD_DAMAGE(iLocal_22);
									PED::CLEAR_PED_DAMAGE_DECAL_BY_ZONE(iLocal_22, 0, "ALL");
									PED::CLEAR_PED_DAMAGE_DECAL_BY_ZONE(iLocal_22, 1, "ALL");
									PED::CLEAR_PED_DAMAGE_DECAL_BY_ZONE(iLocal_22, 4, "ALL");
									PED::CLEAR_PED_DAMAGE_DECAL_BY_ZONE(iLocal_22, 5, "ALL");
									PED::CLEAR_PED_DAMAGE_DECAL_BY_ZONE(iLocal_22, 2, "ALL");
									PED::CLEAR_PED_DAMAGE_DECAL_BY_ZONE(iLocal_22, 3, "ALL");
									iLocal_19 = 1;
								}
							}
						}
				...
				case 4:
					if (!CUTSCENE::IS_CUTSCENE_PLAYING())
					{
						func_7(Global_85405[0 /*10*/].f_7, 1, 0);
						func_6(0, &sLocal_23);
						iLocal_31 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(Global_85405[0 /*10*/].f_3, &sLocal_23);
						if (Global_90014.f_288 == iLocal_31)
						{
							Global_90014.f_288 = INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID());
						}
						if (iLocal_31 != 0)
						{
							INTERIOR::UNPIN_INTERIOR(iLocal_31);
						}
						Global_90001 = 0;
						func_4();
						Global_35462 = 0;
...
void func_1(int iParam0, int iParam1)//Position - 0x2B5
{
	if (!func_2(iParam0))
	{
		return;
	}
	Global_97353.f_1729.f_539.f_1560[iParam0] = iParam1;
}

bool func_2(int iParam0)//Position - 0x2DD
{
	return iParam0 < 3;
}

void func_3(int iParam0)//Position - 0x2E9
{
	Global_35464 = (MISC::GET_GAME_TIMER() + iParam0);
}

int func_4()//Position - 0x2FB
{
	if (func_5(0))
	{
		return 0;
...
bool func_5(bool bParam0)//Position - 0x346
{
...
bool func_6(int iParam0, char* sParam1)//Position - 0x371
{
...
void func_7(int iParam0, bool bParam1, bool bParam2)//Position - 0x445
{
	int iVar0;
	bool bVar1;
...
void func_8(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x54E
{
	struct<54> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_40(iParam5, Var0, Param1, fParam4, func_46(iParam0));
		func_9(iParam5, iParam0, 0);
	}
}

void func_9(int iParam0, int iParam1, int iParam2)//Position - 0x679
{
	int iVar0;
	...
	if (!func_37(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97353.f_18371.f_4249 = func_26();
			}
...
void func_10(int iParam0, int iParam1)//Position - 0x796
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_11(int iParam0)//Position - 0x997
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_23(iParam0, 0, 0)) || func_23(iParam0, 1, 0)) || func_23(iParam0, 2, 0)) || func_46(iParam0) != 145) || func_22(iParam0)) || func_21(iParam0)) || func_20(iParam0)) || func_19(iParam0)) || !func_12(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_21(iParam0))
		{
		}
		...
		if (func_23(iParam0, 1, 0))
		{
		}
		if (func_23(iParam0, 2, 0))
		{
		}
...
int func_12(int iParam0)//Position - 0xA74
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_13(int iParam0)//Position - 0xC24
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((((!func_17() && !func_16()) && !func_15()) && !func_14()) && !func_18())
		{
			return 0;
		}
	}
...
int func_14()//Position - 0xDF3
{
	return 0;
}

int func_15()//Position - 0xDFC
{
	return 1;
}

int func_16()//Position - 0xE05
{
	return 1;
}

int func_17()//Position - 0xE0E
{
...
int func_19(int iParam0)//Position - 0xEAA
{
	int iVar0;
	char* sVar1;
...
int func_20(int iParam0)//Position - 0xEEE
{
	int iVar0;
...
int func_22(int iParam0)//Position - 0xFA5
{
	int iVar0;
...
int func_23(int iParam0, int iParam1, bool bParam2)//Position - 0x108D
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_24(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_24(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x10FE
{
...
int func_25(int iParam0)//Position - 0x11D3
{
	if (iParam0 == -1)
	{
		return 0;
...
var func_26()//Position - 0x11EF
{
	var uVar0;
	
	func_36(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_35(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_34(&uVar0, CLOCK::GET_CLOCK_HOURS());
...
void func_27(var uParam0, int iParam1)//Position - 0x1235
{
	if (iParam1 <= 0)
	{
		return;
...
void func_28(var uParam0, int iParam1)//Position - 0x12BB
{
...
void func_29(var uParam0, int iParam1)//Position - 0x12EE
{
	int iVar0;
	int iVar1;
...
int func_30(int iParam0, int iParam1)//Position - 0x133F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_31(var uParam0)//Position - 0x13E1
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_32(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_32(bool bParam0, int iParam1, int iParam2)//Position - 0x1406
{
	if (bParam0)
	{
		return iParam1;
...
int func_33(var uParam0)//Position - 0x141D
{
	return uParam0 & 15;
}

void func_34(var uParam0, int iParam1)//Position - 0x142A
{
...
void func_35(var uParam0, int iParam1)//Position - 0x1464
{
...
void func_36(var uParam0, int iParam1)//Position - 0x149F
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_37(var uParam0, int iParam1)//Position - 0x14DB
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_47(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_47(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_47(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
int func_38(int iParam0, int iParam1)//Position - 0x2BCF
{
	struct<58> Var0;
...
void func_39(int iParam0, var uParam1, int iParam2)//Position - 0x2C11
{
	int iVar0;
	struct<74> Var1;
...
void func_40(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x2E89
{
	if (func_37(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_45(iParam0);
			func_44(Param1, &(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_41(int iParam0, bool bParam1)//Position - 0x2F8B
{
	if (iParam0 == -1)
	{
		return;
...
void func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x2FE8
{
	if (iParam0 == -1)
	{
		return;
...
bool func_43(int iParam0, int iParam1)//Position - 0x3023
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_44(struct<54> Param0, var uParam54)//Position - 0x3046
{
...
void func_45(int iParam0)//Position - 0x3111
{
	if (iParam0 == -1)
	{
		return;
...
int func_46(int iParam0)//Position - 0x318B
{
	int iVar0;
...
bool func_47(struct<3> Param0, struct<3> Param3)//Position - 0x31EE
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

void func_48(int iParam0, var uParam1)//Position - 0x3217
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_50(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
...
int func_49(int iParam0)//Position - 0x34C3
{
	switch (iParam0)
	{
		case 1:
...
int func_50(int iParam0, var uParam1, var uParam2)//Position - 0x3573
{
	int iVar0;
	int iVar1;
...
void func_51(var uParam0)//Position - 0x364D
{
	int iVar0;
...
void func_52(int iParam0)//Position - 0x36FD
{
...
int func_53(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x3724
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_64(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_64(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, Param2, fParam5, 1, 1);
				...
				func_64(iParam0, &(Var5.f_31), &(Var5.f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 1)
				{
...
void func_54(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x450C
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_2(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_58(*iParam1, 0, &uVar0))
		{
			func_50(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_57(*iParam1);
				...
				func_55(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_55(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_55(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x50EB
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_56(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_56(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x515E
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_57(int iParam0)//Position - 0x6650
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0, bool bParam1, var uParam2)//Position - 0x670E
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_59(iVar0, bParam1, uParam2))
	{
		return 0;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_20(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_59(int iParam0, bool bParam1, var uParam2)//Position - 0x67B0
{
	if (!bParam1)
	{
...
int func_60(int iParam0)//Position - 0x6B4A
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_61(int iParam0, int iParam1)//Position - 0x6B73
{
	int iVar0;
...
void func_62(var uParam0)//Position - 0x6BF5
{
	if (!func_63(*uParam0))
	{
...
bool func_63(int iParam0)//Position - 0x6C20
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(uParam0, 5);
}

int func_64(var uParam0, var uParam1, var uParam2)//Position - 0x6C2F
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0)//Position - 0x6D61
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_66(var uParam0, var uParam1)//Position - 0x6E3D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
int func_67(int iParam0, int iParam1)//Position - 0x6E7E
{
	if (func_2(iParam0))
	{
		return STREAMING::HAS_MODEL_LOADED(func_38(iParam0, iParam1));
	}
	else if (iParam0 != 145)
	{
	}
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x6EA9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_68106[1 /*14*/] = { func_119(iVar10, iParam1, iParam2) };
		if (!func_118(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			if (!func_103(iVar10, 14, iVar7))
			{
				iVar7 = -99;
			}
			iVar8 = func_104(iParam0, 0);
			if (!func_102(iVar10, 14, iVar8) && !func_100(iVar10, 14, iVar8))
			{
				iVar8 = -99;
			}
			if (iVar10 == joaat("player_one"))
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_68106[1 /*14*/] = { func_119(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar27 = { func_90(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_68106[1 /*14*/] = { func_119(iVar10, 14, uVar27[iVar1]) };
							func_89(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
							func_110(14);
							if (Global_68105 == 1)
							{
								iVar2 = 0;
								while (iVar2 < 15)
								{
									iVar3 = func_81(iParam0, iVar10, 14, uVar27[iVar1], iVar2, 0);
									if (iVar3 != -99)
									{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_79(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_110(iVar0);
						if (Global_68105 == 1)
						{
			...
			{
				Global_68106[1 /*14*/] = { func_119(iVar10, iVar0, func_78(iParam0, iVar0, -1)) };
		...
		if (iParam7 == 1)
		{
			...
			Var53 = { func_119(iVar10, 14, iVar7) };
			if (iVar7 != -99)
			{
			...
			Var53 = { func_119(iVar10, 14, iVar8) };
			if (iVar8 != -99)
			{
			...
			Var53 = { func_119(iVar10, 14, iVar9) };
			if (iVar9 != -99)
			{
	...
	{
		uVar67 = { func_90(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_68106[1 /*14*/] = { func_119(iVar10, 14, uVar67[iVar1]) };
			func_89(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
			func_110(14);
			if (Global_68105 == 1)
			{
				...
				while (iVar2 < 15)
				{
					iVar3 = func_81(iParam0, iVar10, 14, uVar67[iVar1], iVar2, 0);
					if (iVar3 != -99)
					{
						func_68(iParam0, iVar2, iVar3, 0, -1, 0, 0, 0, -1, -1, -1, 0);
					}
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_79(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_79(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_69(var uParam0, int iParam1, int iParam2)//Position - 0x7696
{
	int iVar0;
	...
	{
		if (!func_70(uParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x7722
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_68106[1 /*14*/] = { func_119(iVar0, iParam1, iParam2) };
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
	}
	if (iParam1 == 12)
	{
		...
		while (iVar2 <= 14)
		{
			...
			{
				if (!func_70(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar21 = { func_90(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_70(iParam0, 14, uVar21[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
									Global_68106[2 /*14*/] = { func_119(iVar0, 14, iVar4) };
									if (Global_68106[2 /*14*/].f_12 == iVar3)
									{
										if (func_70(iParam0, 14, iVar4))
										{
					...
					else
					{
						...
						Global_68106[2 /*14*/] = { func_119(iVar0, iVar2, iVar1) };
	...
	{
		uVar32 = { func_90(iVar0, iParam2) };
		iVar31 = 0;
		while (iVar31 <= 8)
		{
			if (!func_70(iParam0, 14, uVar32[iVar31]))
			{
				return 0;
			}
			iVar31++;
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_79(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_79(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_71(int iParam0)//Position - 0x797A
{
	switch (iParam0)
	{
...
void func_72(int iParam0, int iParam1, int iParam2)//Position - 0x79B5
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1, int iParam2)//Position - 0x7A3F
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_74(int iParam0, int iParam1, int iParam2)//Position - 0x7B1D
{
	Global_68106[1 /*14*/] = { func_119(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_75(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x7B47
{
	var uVar0;
	int iVar10;
	...
	if (iParam0 == joaat("player_zero"))
	{
		...
		else if (func_102(iParam0, iParam2, iParam3))
		{
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x8144
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_77(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x81DD
{
	int iVar0;
	...
	{
		if (!func_70(uParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x8273
{
	int iVar0;
	int iVar1;
...
int func_79(int iParam0)//Position - 0x8314
{
	switch (iParam0)
	{
		case 0:
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x83C4
{
	int iVar0;
...
int func_81(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x86CB
{
	int iVar0;
	int iVar1;
	int iVar2;
					...
					case 3:
						switch (iParam2)
						{
							case 11:
								...
								{
									if (!func_85(uParam0, 3, 176, 191) && !func_85(uParam0, 3, 227, 242))
									{
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x927E
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9562
{
	int iVar0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9829
{
	int iVar0;
	int iVar1;
...
int func_85(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9860
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2)//Position - 0x9889
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9B53
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2)//Position - 0x9DDD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_89(var uParam0, var uParam1, int iParam2, var uParam3)//Position - 0x9F34
{
	if (iParam2 == -1)
	{
...
struct<10> func_90(int iParam0, int iParam1)//Position - 0x9F5D
{
	int iVar0;
	struct<10> Var1;
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA88C
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA9B6
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_79(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				...
				{
					return (func_93(iParam0, func_79(iParam2)) + iVar38);
				}
				iVar38++;
			}
			iVar37++;
...
int func_93(int iParam0, int iParam1)//Position - 0xAA96
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_94(int iParam0)//Position - 0xAE3D
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xAE9E
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_96(int iParam0, int iParam1)//Position - 0xAEE6
{
	int iVar0;
	struct<16> Var1;
...
void func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCD2A
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_98(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_98(Var16.f_2)] = func_92(iParam1, Var16.x, func_98(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_98(int iParam0)//Position - 0xCEDB
{
	switch (iParam0)
	{
		case 0:
...
void func_99(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xCF8B
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0xCFFC
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 14, 3), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 1, 3), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 14, 4), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 1, 4), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD21F
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar39 = 0;
		iVar40 = (iParam1 - func_93(iParam0, func_79(iParam2)));
		if (iVar40 < 0)
		{
			return -1;
		}
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_79(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0xD319
{
	var uVar0;
	var uVar1;
	...
	else if (iParam0 == joaat("mp_m_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					uVar0 = func_101(iParam0, iParam2, 1, 3);
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					uVar1 = func_101(iParam0, iParam2, 1, 4);
...
int func_103(int iParam0, int iParam1, int iParam2)//Position - 0xD70E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 14, 3), joaat("GLASSES"), 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_101(iParam0, iParam2, 14, 4), joaat("GLASSES"), 1);
				}
			}
			break;
	}
...
int func_104(int iParam0, int iParam1)//Position - 0xD9ED
{
	int iVar0;
	int iVar1;
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDA33
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1)//Position - 0xDB2F
{
	int iVar0;
...
int func_107(int iParam0)//Position - 0xDC6D
{
	switch (iParam0)
	{
		case 0:
...
int func_108(int iParam0, int iParam1)//Position - 0xDCF3
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_109(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDD53
{
	var uVar0;
	int iVar1;
	int iVar2;
...
void func_110(int iParam0)//Position - 0xDDD7
{
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		func_117(iParam0, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_111(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xDE8F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_116(uParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
void func_112(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xDED8
{
	int iVar0;
...
int func_113(var uParam0)//Position - 0xDF03
{
	int iVar0;
	int iVar1;
...
var func_114()//Position - 0xDF37
{
	return Global_1312737;
}

int func_115(int iParam0, int iParam1, int iParam2)//Position - 0xDF43
{
	var uVar0;
	var uVar1;
...
bool func_116(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xDF75
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xE616
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_118(int iParam0)//Position - 0xF534
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_119(int iParam0, int iParam1, int iParam2)//Position - 0xF585
{
	func_183();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_120(int iParam0, int iParam1)//Position - 0xF5D7
{
	switch (iParam0)
	{
		case 0:
...
void func_121(int iParam0)//Position - 0xF6C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_122(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_122(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1093E
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_126(14))
			{
				uVar0 = func_115(func_125(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_115(func_124(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_115(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
bool func_123(int iParam0, int iParam1, var uParam2)//Position - 0x10CC1
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_124(int iParam0, int iParam1)//Position - 0x110C6
{
	switch (iParam1)
	{
		case 0:
...
int func_125(int iParam0, int iParam1)//Position - 0x114C1
{
	switch (iParam1)
	{
		case 0:
...
bool func_126(int iParam0)//Position - 0x118BC
{
	return Global_34913 == iParam0;
}

int func_127(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x118CA
{
	int iVar0;
	var uVar1;
	int iVar2;
	...
	if (func_116(uParam0, iParam1, &iVar2, &uVar1, bParam2, bParam3))
	{
		uVar3 = func_115(iVar2, iVar0, 0);
...
int func_128(int iParam0)//Position - 0x1190C
{
	switch (iParam0)
	{
		case -1:
...
void func_129(int iParam0, int iParam1, int iParam2)//Position - 0x119E0
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_122(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_122(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_122(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_79(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_122(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_130(int iParam0)//Position - 0x11C5B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x11DB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x122BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x12332
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x123A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x1248B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x127ED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x129FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x12C2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x12D3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x136D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1424C
{
	if (iParam0 < 136)
	{
		func_143(iParam0);
...
void func_142(int iParam0)//Position - 0x14280
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x14E84
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x15D92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x15EBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0, int iParam1)//Position - 0x15FBB
{
	switch (iParam0)
	{
		case 0:
...
void func_147(int iParam0)//Position - 0x160AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x1759B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x176EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x17BF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x18263
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x182D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x183A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x188D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x18A6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x19267
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x19376
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1A2A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1AF5C
{
	if (iParam0 < 107)
	{
		func_162(iParam0);
...
void func_160(int iParam0)//Position - 0x1AFA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1BA46
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1C837
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1D480
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1D6F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0, int iParam1)//Position - 0x1D83D
{
	switch (iParam0)
	{
		case 0:
...
void func_166(int iParam0)//Position - 0x1D92D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1E6B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1E82F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1EDA5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1F2CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1F341
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1F410
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1F8E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1FB4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1FE24
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1FFEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x20B40
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x21789
{
	if (iParam0 < 60)
	{
		func_180(iParam0);
...
void func_179(int iParam0)//Position - 0x217BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x2255D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x22BE9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x22CCF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183()//Position - 0x22DCC
{
...
void func_184(int iParam0, int iParam1)//Position - 0x22E45
{
	if (func_2(iParam0))
	{
		STREAMING::REQUEST_MODEL(func_38(iParam0, iParam1));
	}
	else if (iParam0 != 145)
	{
	}
...
void func_185(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6)//Position - 0x22E6C
{
	int iVar0;
	...
	STREAMING::NEW_LOAD_SCENE_START_SPHERE(Param0, iParam5, 0);
	iVar0 = 0;
...
void func_187()//Position - 0x22F90
{
...
void func_188()//Position - 0x22FA4
{
	Global_90001 = 1;
}
