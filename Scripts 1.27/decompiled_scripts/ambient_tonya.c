...
{
	if (!SCRIPT::IS_THREAD_ACTIVE(uLocal_247))
	{
		if (func_165(61))
		{
			iLocal_78 = 6;
...
int func_3(int iParam0)//Position - 0x1C7
{
	struct<4> Var0;
	char* sVar1;
...
void func_4(int iParam0, char* sParam1)//Position - 0x249
{
	func_22(sParam1);
...
void func_26(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x18C1
{
	int iVar0;
	int iVar1;
...
int func_27(var uParam0)//Position - 0x2745
{
...
void func_28(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2767
{
	int iVar0;
...
int func_29(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x27EE
{
...
int func_30(int iParam0)//Position - 0x282E
{
	int iVar0;
...
void func_31(var uParam0, int iParam1, int iParam2)//Position - 0x285C
{
...
int func_32(int iParam0)//Position - 0x2938
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0x297A
{
	int iVar0;
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x29DD
{
	int iVar0;
...
int func_35(int iParam0, int iParam1)//Position - 0x2A6B
{
	struct<58> Var0;
...
void func_36(int iParam0, var uParam1, int iParam2)//Position - 0x2AAD
{
	int iVar0;
	struct<74> Var1;
...
bool func_37(int iParam0)//Position - 0x2D20
{
	return iParam0 < 3;
}

void func_38(int iParam0, var uParam1)//Position - 0x2D2C
{
	int iVar0;
...
int func_39(int iParam0)//Position - 0x2FD6
{
	switch (iParam0)
	{
		case 1:
...
int func_40(int iParam0, var uParam1, var uParam2)//Position - 0x3086
{
	int iVar0;
	int iVar1;
...
void func_41(var uParam0)//Position - 0x3160
{
	int iVar0;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3210
{
	var uVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x333A
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x33AB
{
...
int func_45(int iParam0)//Position - 0x347D
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x34BA
{
	if (func_37(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x34E4
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x368E
{
	var uVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x36C0
{
	int iVar0;
	int iVar1;
...
var func_50()//Position - 0x36F4
{
	return Global_1407E1;
}

int func_51(int iParam0, int iParam1)//Position - 0x3700
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x372C
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3C74
{
	int iVar0;
...
int func_54()//Position - 0x3EB5
{
	func_55();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_55()//Position - 0x3ECE
{
	int iVar0;
...
bool func_56(int iParam0)//Position - 0x3FCB
{
	return Global_8861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x3FD9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x40CF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4333
{
...
int func_60(int iParam0, int iParam1)//Position - 0x4459
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_61(int iParam0, var uParam1)//Position - 0x4C75
{
	int iVar0;
	int iVar1;
...
int func_62(int iParam0)//Position - 0x4CB0
{
	int iVar0;
...
void func_63(int iParam0)//Position - 0x4F24
{
	int iVar0;
...
void func_64(var uParam0, int iParam1)//Position - 0x4F60
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_65(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x54BB
{
	int iVar0;
	int iVar1;
...
bool func_66(int iParam0, var uParam1, var uParam2)//Position - 0x54FF
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_67(struct<3> Param0, struct<3> Param1)//Position - 0x5B55
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_68(var uParam0)//Position - 0x5B7E
{
...
bool func_69(int iParam0)//Position - 0x5BD7
{
	return func_70(iParam0, 0, 1);
}

int func_70(int iParam0, int iParam1, bool bParam2)//Position - 0x5BE7
{
	if (bParam2)
	{
...
int func_71(int iParam0)//Position - 0x5C47
{
	switch (iParam0)
	{
		case 0:
...
int func_72()//Position - 0x5EF0
{
	return Global_5F7C;
}

int func_73(int iParam0)//Position - 0x5EFB
{
	return func_70(iParam0, 5, 1);
}

int func_74(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5F0B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_75(int iParam0)//Position - 0x5FA2
{
	switch (iParam0)
	{
		case -1:
...
int func_76(int iParam0)//Position - 0x6473
{
	return func_70(iParam0, 0, 0);
}

int func_77(int iParam0)//Position - 0x6483
{
	switch (iParam0)
	{
		case -1:
...
bool func_78()//Position - 0x66DC
{
	return Global_15F9E.f_122 > 0;
}

var func_79()//Position - 0x66ED
{
	var uVar0;
...
void func_80(var uParam0, int iParam1)//Position - 0x6733
{
	if (iParam1 <= 0)
	{
		return;
...
void func_81(var uParam0, int iParam1)//Position - 0x67B9
{
...
void func_82(var uParam0, int iParam1)//Position - 0x67EC
{
	int iVar0;
	int iVar1;
...
int func_83(int iParam0, int iParam1)//Position - 0x683D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_84(var uParam0)//Position - 0x68DF
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_85(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_85(bool bParam0, int iParam1, int iParam2)//Position - 0x6904
{
	if (bParam0)
	{
		return iParam1;
...
int func_86(var uParam0)//Position - 0x691B
{
	return uParam0 & 15;
}

void func_87(var uParam0, int iParam1)//Position - 0x6928
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6962
{
...
void func_91(int iParam0)//Position - 0x69FD
{
	var uVar0;
	char cVar1[24];
...
void func_92(char* sParam0, var uParam1, int iParam2)//Position - 0x6A56
{
	...
	STATS::PLAYSTATS_MISSION_STARTED(sParam0, uParam1, iParam2, func_168(0));
}

struct<2> func_93(int iParam0)//Position - 0x6A97
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x6EE3
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x8128
{
	switch (iParam0)
	{
		case 0:
...
void func_97(int iParam0)//Position - 0x846E
{
	char* sVar0;
	...
	func_98(iParam0);
	uLocal_247 = SYSTEM::START_NEW_SCRIPT(sVar0, 17000);
	SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(sVar0);
}

void func_98(int iParam0)//Position - 0x84BF
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x855A
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x85B8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x8611
{
...
int func_103(int iParam0)//Position - 0x8694
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x86C5
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x86D9
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8781
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x879C
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x87E8
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8831
{
	if (func_111(uParam0))
	{
...
int func_111(int iParam0)//Position - 0x8851
{
...
int func_112(int iParam0)//Position - 0x8871
{
	switch (iParam0)
	{
		case 5:
...
void func_114(char* sParam0)//Position - 0x8941
{
...
int func_115(int iParam0)//Position - 0x8953
{
	if (iParam0 == -1)
	{
		iParam0 = func_125();
...
int func_116(int iParam0)//Position - 0x89EB
{
...
int func_119(int iParam0)//Position - 0x8A6D
{
	if ((func_121() && Global_15F6A.f_B == 6) && iParam0 == func_120(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_120(var uParam0, int iParam1)//Position - 0x8AA1
{
	int iVar0;
	var uVar1;
	int iVar2;
...
bool func_122(int iParam0)//Position - 0x8B28
{
	return func_123(iParam0, Global_8861);
}

int func_123(int iParam0, int iParam1)//Position - 0x8B39
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_124(int iParam0)//Position - 0x8D1A
{
	if (func_168(0))
	{
...
int func_125()//Position - 0x8D42
{
	return func_120(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_126(int iParam0)//Position - 0x8D53
{
	int iVar0;
	...
	iVar0 = func_128(&(Global_178B8[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_127(int iParam0)//Position - 0x8D98
{
...
int func_128(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x8DCA
{
	int iVar0;
...
void func_129(var uParam0, int iParam1)//Position - 0x8F01
{
	int iVar0;
...
int func_130(int iParam0)//Position - 0x8F50
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_131(int iParam0)//Position - 0x8F72
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_17890) || Global_5F7E) || func_138()) || func_137(8, -1)) || func_78()) || func_136()) || func_135()) || func_134()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_139()) || Global_5F7E) || func_138()) || func_137(8, -1)) || func_135()) || func_78()) || func_136()) || func_134()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_17890) || Global_5F7E) || func_138()) || func_137(8, -1)) || func_135()) || func_78()) || func_136()) || func_134()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_139()) || Global_17890) || Global_5F7E) || func_138()) || func_137(8, -1)) || func_78()) || func_136()) || func_134()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_139() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_137(8, -1)) || func_134()) || func_133()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_139()) || Global_5F7E) || func_138()) || func_137(8, -1)) || func_136()) || func_135()) || func_134()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_139()) || func_136()) || Global_17890) || Global_5F7E) || func_138()) || Global_8C75) || func_137(8, -1)) || func_135()) || func_133()) || func_134()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_139()) || Global_17890) || Global_5F7E) || func_138()) || func_137(8, -1)) || func_135()) || func_133()) || func_78()) || func_136()) || func_134())
						{
							return 0;
						}
						break;
...
var func_132()//Position - 0x968F
{
	return Global_15F91.f_1;
}

int func_133()//Position - 0x969D
{
	if (Global_154F9 != -1)
	{
...
bool func_136()//Position - 0x9707
{
	return Global_15F9E.f_123 > 0;
}

bool func_137(int iParam0, int iParam1)//Position - 0x9718
{
	switch (iParam0)
	{
		case 5:
...
var func_138()//Position - 0x9753
{
	return Global_14143C;
}

int func_139()//Position - 0x975F
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_141(int iParam0)//Position - 0x9793
{
	...
	switch (iLocal_79)
	{
		case 0:
			if (!func_156())
			{
				if (func_141(103))
				{
					func_155(&uLocal_80, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_144(int iParam0)//Position - 0x9905
{
	if (Global_61[iParam0 /*10*/].f_8 != 138)
	{
...
int func_145(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x9943
{
...
int func_146(char* sParam0, int iParam1, bool bParam2)//Position - 0x99A2
{
	Global_3D4D = 0;
...
void func_154(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x9F43
{
	Global_3B2A = { *uParam0 };
	Global_62B = uParam1;
...
void func_155(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x9F99
{
...
int func_159(int iParam0)//Position - 0xA105
{
...
int func_160(int iParam0)//Position - 0xA132
{
	int iVar0;
...
void func_162(int iParam0, int iParam1, bool bParam2)//Position - 0xA1B0
{
	Global_B85 = iParam0;
	if (Global_61[iParam0 /*10*/].f_8 != 138)
	{
...
int func_164()//Position - 0xA3D9
{
	func_55();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

bool func_165(int iParam0)//Position - 0xA3F2
{
...
bool func_166(int iParam0, int iParam1)//Position - 0xA420
{
	bool bVar0;
...
int func_167(int iParam0)//Position - 0xA46D
{
	int iVar0;
	int iVar1;
...
bool func_168(bool bParam0)//Position - 0xA4C7
{
...
int func_170(int iParam0)//Position - 0xA51A
{
	int iVar0;
	int iVar1;
