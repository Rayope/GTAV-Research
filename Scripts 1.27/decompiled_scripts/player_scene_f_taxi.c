...
int func_2()//Position - 0x118
{
	...
	if (!func_3(&uVar0))
	{
		Var1 = { ENTITY::GET_ENTITY_COORDS(uLocal_63, 0) };
		fVar2 = SYSTEM::VDIST2(Local_141 + Local_144, Var1);
		if (fVar2 < (4.5f * 4.5f))
		{
			TASK::TASK_VEHICLE_DRIVE_WANDER(uLocal_63, uLocal_65, uLocal_142, 786599);
			return 1;
		}
	}
	return 0;
...
int func_3(var uParam0)//Position - 0x16C
{
...
int func_4()//Position - 0x1B3
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15691))
		{
			...
			if (!func_5(Global_15E94, uLocal_65, 2))
			{
				if (fVar1 >= 0.9f)
				{
					PED::SET_PED_INTO_VEHICLE(Global_15E94, uLocal_65, 2);
				}
			}
			if (!iLocal_143)
			{
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_63, 0);
				iLocal_143 = 1;
			}
			TASK::TASK_VEHICLE_TEMP_ACTION(uLocal_63, uLocal_65, 6, 50);
		}
		else
		{
			if (!func_5(Global_15E94, uLocal_65, 2))
			...
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uLocal_65, -8f, 1);
			SYSTEM::WAIT(100);
			if (!func_3(&uVar0))
			{
				TASK::OPEN_SEQUENCE_TASK(&uVar2);
				TASK::TASK_VEHICLE_TEMP_ACTION(0, uLocal_65, 24, 50);
				TASK::TASK_PAUSE(0, 2000);
				TASK::TASK_VEHICLE_DRIVE_TO_COORD(0, uLocal_65, Local_141 + Local_144, uLocal_142, 0, uLocal_66, 786599, ((4.5f / 2f) - 1f), 10f);
				TASK::CLOSE_SEQUENCE_TASK(uVar2);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uVar2);
...
int func_5(int iParam0, int iParam1, int iParam2)//Position - 0x2C2
{
...
int func_8(int iParam0, int iParam1)//Position - 0x367
{
	struct<3> Var0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_9(Global_15E94) && iParam1 != 0)
		{
			Global_15E94 = 0;
		}
	}
...
int func_9(var uParam0)//Position - 0x44A
{
	return uParam0;
}

bool func_10(var uParam0, var uParam1)//Position - 0x454
{
	return (uParam0 && uParam1) != 0;
}

int func_11()//Position - 0x463
{
	func_12();
...
bool func_13(int iParam0)//Position - 0x5A6
{
	return iParam0 < 3;
}

int func_14(int iParam0)//Position - 0x5B2
{
	int iVar0;
	int iVar1;
...
int func_15(int iParam0)//Position - 0x5EF
{
	if (func_13(iParam0))
	{
...
bool func_16(int iParam0)//Position - 0x619
{
	return Global_8861 == iParam0;
}

void func_17()//Position - 0x627
{
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
...
void func_18()//Position - 0x66F
{
	int iVar0;
	
	STREAMING::REQUEST_MODEL(iLocal_64);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_64, 1);
	uLocal_65 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_144 + Local_140, 15f, uLocal_66, 2);
	iVar0 = 0;
	while ((!ENTITY::DOES_ENTITY_EXIST(Global_15E94) || !ENTITY::DOES_ENTITY_EXIST(uLocal_65)) || (!STREAMING::HAS_MODEL_LOADED(iLocal_64) && iVar0 < 400))
	{
		if (!ENTITY::DOES_ENTITY_EXIST(iLocal_65))
		{
			iLocal_65 = VEHICLE::GET_RANDOM_VEHICLE_IN_SPHERE(Local_144 + Local_140, 15f, uLocal_66, 2);
		}
		iVar0++;
		SYSTEM::WAIT(0);
	}
	...
	{
		PED::SET_PED_RELATIONSHIP_GROUP_HASH(Global_15E94, Global_14D7B);
		AUDIO::SET_AMBIENT_VOICE_NAME(Global_15E94, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_65))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(iLocal_65, 1, 1);
		VEHICLE::SET_VEHICLE_DOORS_LOCKED(iLocal_65, 2);
		VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(iLocal_65);
		iLocal_63 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_65, 4, iLocal_64, -1, 1, 1);
		PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_63, 0);
		STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_64);
	}
}

void func_19()//Position - 0x764
{
	char[] cVar0[8];
	var uVar1;
	struct<109> Var2;
	...
	func_35(iLocal_61, &Local_144, &uLocal_145, &cVar0);
	iLocal_64 = joaat("a_m_m_eastsa_02");
	func_25(1, iLocal_61, &uLocal_66, &Local_140, &uVar1, &Local_141, &uLocal_142);
	Var2.f_1 = -1;
	Var2.f_11 = 4;
	Var2.f_11.f_8 = 4;
	Var2.f_11.f_D = 4;
	...
	Var2 = 0;
	Var2.f_2 = iLocal_61;
	Var2.f_3 = Global_15725.f_2D;
	func_22(Var2, &Var3);
	func_20(iLocal_61, &sLocal_146, &cLocal_162, &cLocal_162, &uVar4, &uVar5);
}

int func_20(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x868
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
	{
		...
		case joaat("mpsv_lp0_31"):
			func_21(sParam1, sParam2, sParam3, "SWITCH@MICHAEL@SITTING", "IDLE", "EXIT_FORWARD");
			*uParam4 |= 1024;
			*uParam5 |= 1024;
			return 1;
			break;
		...
		case 206:
		case 207:
			if (func_20(205, sParam1, sParam2, sParam3, uParam4, uParam5))
			{
				return 1;
			}
			break;
		...
		case 289:
			func_21(sParam1, sParam2, sParam3, "SWITCH@MICHAEL@PIER", "pier_lean_smoke_idle", "pier_lean_smoke_idle");
			return 1;
			break;
...
void func_21(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0xF77
{
...
int func_22(struct<109> Param0, var uParam1)//Position - 0xF91
{
	uParam1->f_77 = 0;
	switch (Param0.f_2)
	{
...
void func_23(var uParam0, int iParam1, int iParam2, int iParam3, struct<3> Param4, float fParam5)//Position - 0x430C
{
...
void func_24(var uParam0)//Position - 0x4336
{
	func_23(uParam0, 145, 1435919172, 1435919172, 0f, 0f, 0f, 0f);
}

int func_25(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x4354
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_3C = 255;
	...
	switch (iParam1)
	{
		...
		case 9:
			return func_25(iParam0, 8, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 23:
			return func_25(iParam0, 208, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 113:
			if (func_25(iParam0, 112, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam3 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
				*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
				return 1;
		...
		case 119:
			if (func_25(iParam0, 118, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam5 = { 5f, 20f, 0f };
				*uParam6 = 5f;
				return 1;
		...
		case 106:
			return func_25(iParam0, 105, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 100:
			return func_25(iParam0, 99, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 93:
			if (func_25(iParam0, 91, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 136:
			if (func_25(iParam0, 135, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam3 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
				*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
				return 1;
		...
		case 140:
			if (func_25(iParam0, 142, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam5 = { 0f, 15f, 0f };
				*uParam6 = 10f;
				return 1;
		...
		case 151:
			if (func_25(iParam0, 94, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 162:
			if (func_25(iParam0, 115, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 166:
			return func_25(iParam0, 98, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 213:
			if (func_25(iParam0, 211, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 194:
			if (func_25(iParam0, 193, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 223:
			if (func_25(iParam0, 222, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 224:
			return func_25(iParam0, 222, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 251:
			if (func_25(iParam0, 250, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 282:
			if (func_25(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				return 1;
			}
			break;
		...
		case 276:
			return func_25(iParam0, 275, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
...
void func_26(int iParam0, var uParam1, int iParam2)//Position - 0x77C6
{
	int iVar0;
	struct<74> Var1;
...
int func_27(int iParam0, var uParam1, int iParam2)//Position - 0x7A3E
{
	if (Global_15D9F[iParam0 /*74*/] == 0)
	{
		func_26(iParam0, uParam1, iParam2);
	...
	if (!func_28(Global_15D9F[iParam0 /*74*/]))
	{
		func_26(iParam0, uParam1, iParam2);
		uParam1->f_43 = iParam2;
		return 1;
...
int func_28(int iParam0)//Position - 0x7C74
{
	int iVar0;
	struct<2> Var1;
...
int func_29()//Position - 0x7E43
{
	return 0;
}

int func_30()//Position - 0x7E4C
{
	return 1;
}

int func_31()//Position - 0x7E55
{
	return 1;
}

int func_32()//Position - 0x7E5E
{
...
int func_34(int iParam0)//Position - 0x7EFA
{
...
int func_35(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x817B
{
	int iVar0;
	
	if (func_38(iParam0, uParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
...
bool func_36(var uParam0)//Position - 0x8376
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
...
bool func_37(struct<3> Param0, struct<3> Param1)//Position - 0x8430
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_38(int iParam0, var uParam1, char* sParam2)//Position - 0x8459
{
	struct<3> Var0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[0];
			StringCopy(sParam2, func_42(Global_17C49.f_6C1.f_21B.f_606[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[1];
			StringCopy(sParam2, func_42(Global_17C49.f_6C1.f_21B.f_606[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[2];
			StringCopy(sParam2, func_42(Global_17C49.f_6C1.f_21B.f_606[2]), 32);
			return 1;
			break;
		
		case 11:
			if (func_41(iParam0, &Var0, uParam1))
			{
		...
		case 9:
			return func_38(8, uParam1, sParam2);
			break;
		...
		case 23:
			return func_38(208, uParam1, sParam2);
			break;
	...
	switch (iParam0)
	{
		...
		case 224:
			return func_38(222, uParam1, sParam2);
			break;
		...
		case 294:
			return func_38(293, uParam1, sParam2);
			break;
		
		case 295:
			return func_38(292, uParam1, sParam2);
			break;
		...
		case 300:
			return func_38(303, uParam1, sParam2);
			break;
...
int func_39(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xAA5B
{
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					if (func_39(0, iParam1, uParam2, uParam3))
					{
		...
		case 21:
			...
			{
				case 0:
					if (func_39(0, 5, uParam2, uParam3))
					{
		...
		case 33:
			...
			{
				case 1:
					if (func_39(1, 32, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
						*uParam3 = (*uParam3 + 0f);
						return 1;
		...
		case 46:
			return func_39(iParam0, 26, uParam2, uParam3);
			break;
		...
		case 60:
			if (func_39(iParam0, 59, uParam2, uParam3))
			{
		...
		case 77:
			if (func_39(iParam0, 47, uParam2, uParam3))
			{
				*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
				*uParam3 = (*uParam3 + 0f);
				return 1;
		...
		case 131:
			...
			{
				case 13:
					if (func_39(iParam0, 130, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f)) };
						*uParam3 = (*uParam3 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f));
						return 1;
...
int func_41(int iParam0, var uParam1, var uParam2)//Position - 0xC9CB
{
	switch (iParam0)
	{
		case 11:
		...
		case 9:
			return func_41(8, uParam1, uParam2);
			break;
...
char* func_42(int iParam0)//Position - 0xD33A
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_43()//Position - 0xD3CD
{
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_63) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_63, 1))
	{
		ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&iLocal_63);
	}
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_65) && ENTITY::DOES_ENTITY_BELONG_TO_THIS_SCRIPT(iLocal_65, 1))
	{
		ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_65);
	}
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_64, 0);
	STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_64);
