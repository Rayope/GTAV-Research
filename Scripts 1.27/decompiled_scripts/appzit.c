...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_14 = 0.001f;
	iLocal_25 = -99;
	StringCopy(&cLocal_26, "TRACKID", 32);
	MISC::NETWORK_SET_SCRIPT_IS_SAFE_FOR_NETWORK_GAME();
	HUD::REQUEST_ADDITIONAL_TEXT(&cLocal_26, 1);
		...
		if (iLocal_32)
		{
			if (iLocal_34 < 101)
			{
				if (SYSTEM::TIMERA() > 30)
				{
					...
					func_10("CELL_4005");
					GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(iLocal_34);
					GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
					func_9(Global_3826, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432);
					SYSTEM::SETTIMERA(0);
				}
			}
			else
...
void func_6()//Position - 0x2D0
{
	if (SYSTEM::TIMERA() > 2200)
	{
		if (Global_382D)
		{
			func_7(Global_3826, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, "CELL_201", 0, 0, 0, 0);
		}
		else
		{
			func_7(Global_3826, "SET_SOFT_KEYS", 2f, 1f, 13f, -1f, -1f, 0, 0, 0, 0, 0);
		}
		iLocal_31 = 1;
	}
}
...
void func_8()//Position - 0x3D3
{
	if (Global_3823 == 0)
	{
		if (func_5(2, Global_381A, 0))
		{
			if ((iLocal_31 && iLocal_33 == 0) && iLocal_32 == 0)
			{
				iLocal_34 = 0;
				GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_3826, "SET_DATA_SLOT");
				GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(23);
...
void func_14()//Position - 0x691
{
	...
	func_10("CELL_4001");
	func_10(&Local_19);
	func_10(&(Local_19.f_10));
	func_10("CELL_4002");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(Local_19.f_18);
	func_10("CELL_4003");
	func_10(&(Local_19.f_19));
	func_10("CELL_4004");
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	func_9(Global_3826, "DISPLAY_VIEW", 23f, SYSTEM::TO_FLOAT(0), -1082130432, -1082130432, -1082130432);
	if (Global_382D)
...
{
	iLocal_25 = AUDIO::GET_AUDIBLE_MUSIC_TRACK_TEXT_ID();
	StringCopy(&Local_19, "", 64);
	StringIntConCat(&Local_19, iLocal_25, 64);
	StringConCat(&Local_19, "S", 64);
	StringCopy(&(Local_19.f_10), "", 32);
	StringIntConCat(&(Local_19.f_10), iLocal_25, 32);
	StringConCat(&(Local_19.f_10), "A", 32);
	StringCopy(&(Local_19.f_19), AUDIO::GET_PLAYER_RADIO_STATION_NAME(), 24);
	if (!HUD::DOES_TEXT_LABEL_EXIST(&Local_19))
	{
		StringCopy(&Local_19, "CELL_195", 64);
	}
	if (!HUD::DOES_TEXT_LABEL_EXIST(&(Local_19.f_10)))
	{
		StringCopy(&(Local_19.f_10), "CELL_195", 32);
		StringCopy(&(Local_19.f_19), "CELL_195", 24);
	}
}
