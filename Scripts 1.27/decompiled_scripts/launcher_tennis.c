...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_95 = 0;
	func_185(&Global_96007, 0);
	func_180();
	if (func_179(uLocal_94, 1))
	{
		iLocal_100 = 10;
	}
	else
	...
	if (!func_179(uLocal_94, 8))
	{
		if (!func_177(iLocal_100))
		{
			if (func_176(0, iLocal_99))
			{
				func_187(0);
			}
			else
	...
	if (func_179(uLocal_94, 8388608))
	{
		func_187(1);
	}
	if (func_179(uLocal_94, 524288) && (func_175() && !func_174()))
	{
		func_187(1);
	}
	if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(SCRIPT::GET_HASH_OF_THIS_SCRIPT_NAME()) > 1 && !func_179(uLocal_94, 4194304))
	{
		if (iLocal_105 != 262)
		{
			func_173(iLocal_105, 1, 0);
			iLocal_105 = 262;
		}
		func_172(10);
	}
	while (true)
	{
		...
		uLocal_85 = PLAYER::GET_PLAYER_PED(PLAYER::PLAYER_ID());
		if (func_179(uLocal_94, 1048576))
		{
			if (ENTITY::IS_ENTITY_DEAD(uLocal_85))
			{
				func_187(1);
			}
		}
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_85) && !ENTITY::IS_ENTITY_DEAD(iLocal_85))
		{
			Local_87 = { ENTITY::GET_ENTITY_COORDS(iLocal_85, 1) };
			uLocal_93 = SYSTEM::VDIST2(Local_87, ScriptParam_0.f_1[0 /*3*/]);
			uLocal_93 = uLocal_93;
			Local_111 = { Local_87 };
			...
			{
				case 0:
					if (func_177(iLocal_100) || (func_179(uLocal_94, 16) && !func_179(uLocal_94, 524288)))
					{
						iLocal_98 = -1;
						func_171();
						func_172(1);
				...
				case 3:
					...
					if (!func_179(uLocal_94, 4))
					{
						func_168();
						func_167(&uLocal_94, 4);
					}
					if (fLocal_110 > (fLocal_102 * fLocal_102) && !Global_89996)
					{
						if (iLocal_105 != 262)
						{
							if (func_166(6) && !func_165(iLocal_105))
							{
							}
							else
							{
					...
					{
						cLocal_69 = { Local_53 };
						bVar2 = !func_179(uLocal_94, 64);
						func_185(&uLocal_94, 128);
						if (!func_164(3) && !Global_89996)
						{
							if (func_179(uLocal_94, 2097152))
							{
								if ((!func_179(uLocal_94, 1) || !ENTITY::DOES_ENTITY_EXIST(func_163())) && !Global_89996)
								{
									func_172(10);
									break;
								}
						...
						if ((!func_152(6) || Global_96400) || func_151())
						{
							bVar2 = false;
						}
						if (!bLocal_126)
						...
						if (bVar2)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_117, Local_120, fLocal_123, 1, 0, iLocal_103) || (fLocal_125 > 0f && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), func_138(Local_117, Local_120, 0.5f), 0) > fLocal_125))
							{
								bVar2 = false;
							}
							else if (fLocal_124 > 0f)
							{
								if (MISC::ABSF((Local_87.f_2 - Local_117.f_2)) > fLocal_124)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_137(uLocal_86))
								{
									if (iLocal_96 == -1)
									{
										func_136(&iLocal_96, 4, sLocal_101, 0, 0);
										func_149(&uLocal_94, 2048);
									}
									else if (!func_179(uLocal_94, 2048) || !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
									{
										func_135(&iLocal_96);
										func_185(&uLocal_94, 2048);
									}
									if (func_133(iLocal_96, 1))
									{
				...
				case 6:
					if (func_179(Global_96007, 262144))
					{
						func_185(&Global_96007, 262144);
						func_15();
					}
					if (func_179(uLocal_94, 2097152))
					{
						if (!func_164(3) && !SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
						{
							func_172(10);
						}
					}
					if (!SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
					{
						...
						func_10(&uLocal_107);
						func_185(&uLocal_94, 256);
						func_9();
						if (bVar0)
						{
							func_185(&uLocal_94, 2);
						}
						else if (func_179(uLocal_94, 2))
						{
							if (func_179(Global_96007, 0))
							{
								func_8(&iLocal_98);
								iLocal_98 = -1;
								func_185(&uLocal_94, 2);
						...
						if (iLocal_99 != -1)
						{
							if (func_179(Global_96007, 0))
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_99), 0, Global_89999, 0);
								func_7(func_19(iLocal_99), 0, Global_89999, 1, 0);
							}
							else
							{
								STATS::PLAYSTATS_MISSION_CHECKPOINT(func_19(iLocal_99), 0, Global_89999, 0);
								func_7(func_19(iLocal_99), 0, Global_89999, 0, 0);
							}
						}
						func_6();
						func_185(&Global_96007, 0);
						if (func_179(uLocal_94, 16777216))
						{
							func_187(1);
						}
						if (iLocal_99 != -1)
					...
					if ((iLocal_104 % 150) == 0)
					{
						if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
						{
							if (iLocal_106 == 2)
							{
								if (iLocal_106 == 2)
								{
									if (func_177(iLocal_100) && func_176(0, iLocal_99))
									{
										func_180();
										if (iLocal_105 != 262)
										{
...
bool func_1(char* sParam0)//Position - 0xA59
{
	HUD::BEGIN_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(sParam0);
	return HUD::END_TEXT_COMMAND_IS_THIS_HELP_MESSAGE_BEING_DISPLAYED(0);
}

void func_2()//Position - 0xA6C
{
	func_4(128);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_3(int iParam0)//Position - 0xA8E
{
	PED::RELEASE_PED_PRELOAD_VARIATION_DATA(iParam0);
	PED::RELEASE_PED_PRELOAD_PROP_DATA(iParam0);
}

void func_4(int iParam0)//Position - 0xAA2
{
	Global_96439 = (Global_96439 - (Global_96439 && iParam0));
}

void func_5()//Position - 0xABA
{
}

void func_6()//Position - 0xAC2
{
}

void func_7(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xACA
{
...
void func_8(int iParam0)//Position - 0xB0E
{
	if (*iParam0 == -1)
	{
		return;
...
void func_10(var uParam0)//Position - 0xB8D
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
float func_11(var uParam0)//Position - 0xBA3
{
	if (func_14(uParam0))
	{
		if (func_13(uParam0))
...
float func_12(bool bParam0)//Position - 0xBE2
{
	int iVar0;
...
bool func_13(var uParam0)//Position - 0xC2A
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

bool func_14(var uParam0)//Position - 0xC3A
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_15()//Position - 0xC4A
{
	return 1;
}

void func_16()//Position - 0xC53
{
}

void func_17(char* sParam0, int iParam1, int iParam2)//Position - 0xC5B
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Global_87437))
	{
...
bool func_18(bool bParam0)//Position - 0xC9C
{
...
char* func_19(int iParam0)//Position - 0xCC7
{
	switch (iParam0)
	{
		case 0:
...
void func_21(var uParam0)//Position - 0xE5C
{
	if (!func_14(uParam0))
	{
		func_24(uParam0);
...
void func_22(var uParam0)//Position - 0xE7D
{
	func_23(uParam0, 0f);
}

void func_23(var uParam0, float fParam1)//Position - 0xE8C
{
...
void func_24(var uParam0)//Position - 0xEBA
{
	if (!func_14(uParam0))
	{
		func_22(uParam0);
...
void func_25(int iParam0)//Position - 0xED2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_26(int iParam0)//Position - 0xF2B
{
...
int func_27(int iParam0)//Position - 0xFAE
{
	int iVar0;
...
void func_28(int iParam0, int iParam1, int iParam2)//Position - 0xFDF
{
	func_29(iParam0, iParam1, iParam2, 0, 0);
}

void func_29(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xFF3
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, int iParam2)//Position - 0x109B
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x10B6
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0x1102
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x11C8
{
	int iVar0;
...
void func_36(var uParam0, int iParam1)//Position - 0x12FF
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x134E
{
	if (Global_34913 == 15)
	{
		return 0;
...
int func_40(int iParam0)//Position - 0x1480
{
...
int func_42(int iParam0)//Position - 0x14C2
{
	return Global_85373[iParam0];
}

void func_43(var uParam0, int iParam1)//Position - 0x14D2
{
	int iVar0;
	struct<16> Var1;
	...
	func_44(uParam0, iVar0, &Var1);
}

void func_44(var uParam0, int iParam1, var uParam2)//Position - 0x14F9
{
	int iVar0;
	struct<14> Var1;
	int iVar15;
	...
	while (iVar0 <= 11)
	{
		Var1 = { func_54(iParam1, func_122(iVar0), (*uParam2)[func_122(iVar0)]) };
	...
	while (iVar15 <= 8)
	{
		...
		{
			Var1 = { func_54(iParam1, 14, uVar19[iVar15]) };
			if (Var1.f_3 != -1 && Var1.f_3 != 255)
			{
				PED::SET_PED_PRELOAD_PROP_DATA(uParam0, iVar17, Var1.f_3, Var1.f_4);
			}
		}
		iVar15++;
	}
...
int func_45(int iParam0)//Position - 0x15D3
{
	switch (iParam0)
	{
		case 0:
...
int func_46(int iParam0)//Position - 0x1659
{
	switch (iParam0)
	{
		case -1:
...
struct<10> func_47(int iParam0, int iParam1)//Position - 0x172D
{
	int iVar0;
	struct<10> Var1;
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x205C
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_49(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2186
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_51(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_50(int iParam0, int iParam1)//Position - 0x2266
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_51(int iParam0)//Position - 0x260D
{
	switch (iParam0)
	{
		case 0:
...
int func_52(int iParam0)//Position - 0x26BD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x271E
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<14> func_54(int iParam0, int iParam1, int iParam2)//Position - 0x2766
{
	func_121();
...
void func_55(int iParam0, int iParam1)//Position - 0x27B8
{
	switch (iParam0)
	{
		case 0:
...
void func_56(int iParam0)//Position - 0x28A8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_67(iVar10, iParam0, 155);
			return;
			break;
	}
	func_57(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_57(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x3ADC
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_166(14))
			{
				uVar0 = func_60(func_63(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_60(func_59(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_60(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
bool func_58(int iParam0, int iParam1, var uParam2)//Position - 0x3E5E
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_59(int iParam0, int iParam1)//Position - 0x426F
{
	switch (iParam1)
	{
		case 0:
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x466A
{
	var uVar0;
	var uVar1;
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_61(iParam1)];
...
int func_61(var uParam0)//Position - 0x469C
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4AD7
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_65(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x59F5
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_66(uParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
bool func_66(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5A37
{
	int iVar0;
...
void func_67(int iParam0, int iParam1, int iParam2)//Position - 0x60D8
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
	...
	iVar1 = Global_68106[0 /*14*/].f_5;
	if (iParam0 == 12)
	{
		iVar18 = 0;
		iVar19 = FILES::SETUP_SHOP_PED_OUTFIT_QUERY(iVar1, 0);
		iVar17 = 0;
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_57(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_57(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_57(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_51(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_57(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_68(int iParam0)//Position - 0x6352
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_69(int iParam0)//Position - 0x649E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_70(int iParam0)//Position - 0x69AA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_71(int iParam0)//Position - 0x6A1D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_72(int iParam0)//Position - 0x6A8F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_73(int iParam0)//Position - 0x6B75
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_74(int iParam0)//Position - 0x6EB6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0x70BD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0x72DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0x73E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_78(int iParam0)//Position - 0x7D75
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0)//Position - 0x8B30
{
	if (iParam0 < 136)
	{
		func_81(iParam0);
	...
	{
		func_67(3, iParam0, 242);
	}
}

void func_80(int iParam0)//Position - 0x8B64
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_81(int iParam0)//Position - 0x9768
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_82(int iParam0)//Position - 0xA668
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_83(int iParam0)//Position - 0xA794
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_84(int iParam0, int iParam1)//Position - 0xA88A
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xA97A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(int iParam0)//Position - 0xBE46
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(int iParam0)//Position - 0xBF8C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(int iParam0)//Position - 0xC4E1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_89(int iParam0)//Position - 0xCB49
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_90(int iParam0)//Position - 0xCBBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_91(int iParam0)//Position - 0xCC8A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_92(int iParam0)//Position - 0xD184
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(int iParam0)//Position - 0xD314
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0xDB02
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xDC0A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xEB2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xF7D8
{
	if (iParam0 < 107)
	{
		func_100(iParam0);
	...
	if (Global_68106[0 /*14*/].f_2 == -1)
	{
		func_67(3, iParam0, 318);
	}
}

void func_98(int iParam0)//Position - 0xF81D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0x102C2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0x110B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0x11CEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0x11F66
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0, int iParam1)//Position - 0x120A1
{
	switch (iParam0)
	{
		case 0:
...
void func_104(int iParam0)//Position - 0x12191
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x12EEE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x1305C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x135CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x13AF3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x13B65
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x13C34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x140E4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x1433E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x145FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x147B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x152FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x15F2D
{
	if (iParam0 < 60)
	{
		func_118(iParam0);
	...
	if (Global_68106[0 /*14*/].f_2 == -1)
	{
		func_67(3, iParam0, 181);
	}
}

void func_117(int iParam0)//Position - 0x15F61
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x16CF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x17376
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x1745B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121()//Position - 0x17551
{
...
int func_122(int iParam0)//Position - 0x175C9
{
	switch (iParam0)
	{
		case 0:
...
struct<16> func_123(int iParam0, int iParam1)//Position - 0x17679
{
	int iVar0;
	struct<16> Var1;
...
void func_124(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x194BE
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_122(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_122(Var16.f_2)] = func_49(iParam1, Var16.x, func_122(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*iParam0)[func_122(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar19++;
		}
...
void func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1966F
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
void func_126(int iParam0)//Position - 0x196E0
{
	Global_96439 = (Global_96439 || iParam0);
}

bool func_127(int iParam0)//Position - 0x196F3
{
	return (Global_96439 && iParam0) != 0;
}

void func_128(int iParam0)//Position - 0x19704
{
	if (iLocal_95 < 5)
	{
		if (iParam0 != 262)
...
int func_130(int iParam0)//Position - 0x19751
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0)//Position - 0x1978E
{
	if (func_132(iParam0))
	{
...
bool func_132(int iParam0)//Position - 0x197B8
{
	return iParam0 < 3;
}

int func_133(int iParam0, bool bParam1)//Position - 0x197C4
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0x1987C
{
	int iVar0;
...
void func_135(int iParam0)//Position - 0x198B7
{
	int iVar0;
...
void func_136(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4)//Position - 0x1990E
{
	int iVar0;
...
int func_137(var uParam0)//Position - 0x19A19
{
	return 1;
}

Vector3 func_138(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x19A22
{
	return FtoV((1f - fParam6)) * Param0 + Vector(fParam6, fParam6, fParam6) * Param3;
}

var func_139()//Position - 0x19A3D
{
	return Global_67058;
}

int func_140(int iParam0)//Position - 0x19A49
{
	if (iParam0 == 1)
	{
...
bool func_141(int iParam0, int iParam1)//Position - 0x19AA3
{
	switch (iParam0)
	{
		case 5:
...
bool func_142()//Position - 0x19ADE
{
	return MISC::GET_GAME_TIMER() <= Global_17236.f_5130 + 100;
}

int func_143()//Position - 0x19AF3
{
...
bool func_144(bool bParam0)//Position - 0x19B0D
{
	if (bParam0)
	{
...
int func_145()//Position - 0x19B36
{
	if (func_166(6) || func_166(7))
	{
		if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
		{
			switch (func_146(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
			{
				case 1:
					return func_165(95);
					break;
...
int func_146(struct<3> Param0)//Position - 0x19C04
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	while (iVar3 < 10)
	{
		fVar1 = SYSTEM::VDIST2(Param0, func_147(iVar3));
		if (fVar0 > fVar1)
		{
			fVar0 = fVar1;
			iVar2 = iVar3;
...
Vector3 func_147(int iParam0)//Position - 0x19C48
{
	int iVar0;
...
Vector3 func_148(int iParam0, int iParam1)//Position - 0x19D26
{
	int iVar0;
...
void func_149(var uParam0, int iParam1)//Position - 0x19D64
{
	func_150(uParam0, iParam1);
}

void func_150(var uParam0, var uParam1)//Position - 0x19D74
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_151()//Position - 0x19D85
{
	int iVar0;
	bool bVar1;
...
int func_152(int iParam0)//Position - 0x19E8F
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_159()) || Global_96400) || Global_24446) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_155()) || func_143()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_159()) || Global_24446) || func_158()) || func_141(8, -1)) || func_155()) || func_157()) || func_156()) || func_143()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_159()) || Global_96400) || Global_24446) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_143()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_159() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_141(8, -1)) || func_143()) || func_154()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_159()) || Global_24446) || func_158()) || func_141(8, -1)) || func_156()) || func_155()) || func_143()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_159()) || func_156()) || Global_96400) || Global_24446) || func_158()) || Global_35957) || func_141(8, -1)) || func_155()) || func_154()) || func_143()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_159()) || Global_96400) || Global_24446) || func_158()) || func_141(8, -1)) || func_155()) || func_154()) || func_157()) || func_156()) || func_143())
						{
							return 0;
						}
						break;
...
var func_153()//Position - 0x1A5AC
{
	return Global_90001.f_1;
}

int func_154()//Position - 0x1A5BA
{
	if (Global_87289 != -1)
	{
...
bool func_156()//Position - 0x1A60A
{
	return Global_90014.f_291 > 0;
}

bool func_157()//Position - 0x1A61B
{
	return Global_90014.f_290 > 0;
}

var func_158()//Position - 0x1A62C
{
	return Global_1315900;
}

int func_159()//Position - 0x1A638
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
var func_160()//Position - 0x1A654
{
	func_161();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_161()//Position - 0x1A66D
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_131(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_130(PLAYER::PLAYER_PED_ID());
			if (func_132(iVar0) && (!func_166(14) || Global_96306))
			{
				if (Global_97353.f_1729.f_539.f_3213 != iVar0 && func_132(Global_97353.f_1729.f_539.f_3213))
				{
...
var func_163()//Position - 0x1A784
{
	return Global_86199;
}

int func_164(int iParam0)//Position - 0x1A790
{
	switch (iParam0)
	{
		case 0:
...
bool func_165(int iParam0)//Position - 0x1A802
{
	int iVar0;
...
bool func_166(int iParam0)//Position - 0x1A83E
{
	return Global_34913 == iParam0;
}

void func_167(var uParam0, int iParam1)//Position - 0x1A84C
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_168()//Position - 0x1A85D
{
	var uVar0;
	int iVar4;
	var uVar5[3];
	...
	if (bLocal_128 && SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_127 == 1)
		{
			...
			{
				uVar5[iVar9] = func_169(&uVar5, 3, 2, 7);
				iVar9++;
			}
			iVar9 = 0;
			while (iVar9 < iVar4 && iVar9 < 3)
...
int func_169(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1A903
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_171()//Position - 0x1A995
{
	if (bLocal_128)
	{
		if (iLocal_127 == 1)
...
void func_172(int iParam0)//Position - 0x1A9B0
{
	iLocal_95 = iParam0;
}

void func_173(int iParam0, bool bParam1, bool bParam2)//Position - 0x1A9BC
{
	int iVar0;
	int iVar1;
...
bool func_176(int iParam0, int iParam1)//Position - 0x1AB08
{
	bool bVar0;
...
bool func_177(int iParam0)//Position - 0x1AB55
{
	return func_178(iParam0, Global_34913);
}

int func_178(int iParam0, int iParam1)//Position - 0x1AB66
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_179(var uParam0, int iParam1)//Position - 0x1AD47
{
	return (uParam0 && iParam1) != 0;
}

void func_180()//Position - 0x1AD56
{
	int iVar0;
	int iVar1;
	
	iLocal_99 = 13;
	StringCopy(&Local_53, "tennis", 64);
	iLocal_97 = 17000;
	func_167(&uLocal_94, 1);
	sLocal_101 = "PLAY_TENNIS";
	if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()))
	{
		iLocal_127 = func_146(Local_90);
	}
	iLocal_105 = func_183(Local_90);
	bLocal_128 = true;
	iVar0 = func_130(PLAYER::PLAYER_PED_ID());
	if (iVar0 == 1)
	{
		func_167(&uLocal_94, 8388608);
		return;
	}
	...
	switch (iLocal_127)
	{
		case 2:
			...
			bLocal_128 = true;
			Local_117 = { -765.014f, 154.244f, 67.25f };
			Local_120 = { -782.014f, 154.244f, 67.25f };
			fLocal_123 = 28f;
			fLocal_124 = 2f;
			break;
		...
		case 1:
			...
			Local_117 = { -1164.958f, -1667.262f, 4.28f };
			Local_120 = { -1200.919f, -1615.872f, 4.28f };
			fLocal_123 = 65.5f;
			fLocal_124 = 5f;
			break;
		...
		case 3:
			...
			Local_117 = { 491.2348f, -206.7215f, 52.78849f };
			Local_120 = { 469.6835f, -266.507f, 53.78639f };
			fLocal_123 = 14f;
			fLocal_124 = 5f;
			break;
		...
		case 4:
			...
			Local_117 = { -1218.939f, 321.685f, 79.02952f };
			Local_120 = { -1228.746f, 355.2947f, 79.98589f };
			fLocal_123 = 20f;
			fLocal_124 = 2f;
			break;
		...
		case 5:
			...
			Local_117 = { -1250.003f, 367.6283f, 79.94628f };
			Local_120 = { -1216.369f, 377.5503f, 80.10213f };
			fLocal_123 = 20f;
			fLocal_124 = 2f;
			break;
		...
		case 6:
			...
			Local_117 = { -1610.862f, 249.7006f, 60.1168f };
			Local_120 = { -1626.516f, 282.9467f, 59.83001f };
			fLocal_123 = 32f;
			fLocal_124 = 5f;
			break;
		...
		case 7:
			...
			Local_117 = { -942.1958f, -1251.207f, 7.1391f };
			Local_120 = { -930.3892f, -1271.587f, 8.0366f };
			fLocal_123 = 12f;
			fLocal_124 = 5f;
			break;
		...
		case 8:
			...
			Local_117 = { -1373.602f, -83.734f, 50f };
			Local_120 = { -1369.198f, -120.774f, 50f };
			fLocal_123 = 20.84f;
			fLocal_124 = 5f;
			fLocal_125 = 19.6f;
			break;
		...
		case 9:
			...
			Local_117 = { -2860.762f, 13.3794f, 10.6083f };
			Local_120 = { -2924.066f, 31.5452f, 10.6083f };
			fLocal_123 = 28f;
			fLocal_124 = 5f;
			break;
	}
...
int func_182(int iParam0)//Position - 0x1B1A4
{
	if (func_132(iParam0))
	{
		if ((Global_97353.f_7341 || Global_3) || func_18(0))
		{
...
int func_183(struct<3> Param0)//Position - 0x1B1F2
{
	return func_184(func_146(Param0));
}

int func_184(var uParam0)//Position - 0x1B206
{
	int iVar0;
...
void func_185(var uParam0, int iParam1)//Position - 0x1B27E
{
	func_186(uParam0, iParam1);
}

void func_186(var uParam0, var uParam1)//Position - 0x1B28E
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_187(bool bParam0)//Position - 0x1B2A3
{
	if (bParam0)
	{
		if (iLocal_105 != 262)
...
void func_188()//Position - 0x1B2EC
{
	func_185(&uLocal_94, 4);
	func_189();
	if (SCRIPT::IS_THREAD_ACTIVE(uLocal_52))
	{
...
void func_189()//Position - 0x1B329
{
	func_4(128);
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
