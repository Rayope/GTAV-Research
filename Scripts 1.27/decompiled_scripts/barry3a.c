...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_423())
	{
		...
		{
			case 0:
				func_421(Local_144, Local_144.f_3, 1, 0);
				func_419(1);
				break;
			
			case 1:
				func_421(Local_160, 298.7f, 1, 0);
				func_418(1);
				break;
	...
	{
		func_397(&(Local_185[0 /*29*/]), &(Local_80.f_35[1]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_80.f_28[0]))
	{
		func_396(&(Local_185[0 /*29*/].f_1), &(Local_80.f_28[0]));
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_80.f_28[1]))
	{
		func_396(&(Local_185[0 /*29*/].f_2), &(Local_80.f_28[1]));
	}
	func_394();
	while (true)
	{
		...
		case 0:
			...
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_144.f_4, 0))
			{
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < 1)
				{
					iLocal_436 = 1;
					iLocal_437 = 0;
					iLocal_143 = func_210(Local_160, 5, 1);
				}
				else
				{
					iLocal_436 = 1;
			...
			else
			{
				...
				iLocal_143 = func_205(Local_144.f_4, 1, 5);
			}
			iLocal_142 = 1;
			break;
		
		case 1:
			if (!func_204(Local_144.f_4, Local_160, 125f))
			{
...
bool func_204(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2501F
{
...
void func_207(int iParam0)//Position - 0x250A1
{
	if (func_206(iParam0))
	{
		func_208(Local_166[iParam0 /*3*/].f_2, 7500, 1);
...
int func_210(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2510F
{
	int iVar0;
	...
	switch (iLocal_142)
	{
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_COORD(Local_144.f_4, Local_160, 10f, 10f, 2f, 0, 1, 0))
			{
				...
				{
					func_214();
					if (!func_213(PLAYER::PLAYER_PED_ID(), Local_144.f_4, 55f) && !ENTITY::IS_ENTITY_ON_SCREEN(Local_144.f_4))
					{
						iLocal_142 = 2;
					}
					else if ((iLocal_432 && func_206(5)) && (MISC::GET_PROFILE_SETTING(203) == 0 || !func_209()))
					{
						func_207(5);
					}
				}
...
void func_214()//Position - 0x252F7
{
	...
	else if (!iLocal_432)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_434)
		{
			if (iLocal_428 == 1)
			{
				if (func_215(&uLocal_250, 49, "BAR3AAU", "BAR3A_P1", 9, 1, 0, 0, 0))
				{
					iLocal_142 = 1;
					iLocal_432 = 1;
				}
			}
			else if (func_215(&uLocal_250, 49, "BAR3AAU", "BAR3A_P1b", 9, 1, 0, 0, 0))
			{
				iLocal_142 = 1;
				iLocal_432 = 1;
			}
...
int func_227()//Position - 0x25A1C
{
	...
	while (iLocal_249 <= 5)
	{
		if (func_228(Local_166[iLocal_249 /*3*/].f_2, 0, 0))
		{
			iVar0 = 1;
		}
		iLocal_249++;
...
void func_229()//Position - 0x25A6D
{
	switch (iLocal_142)
	{
		case 0:
			...
			if (func_232(Local_144.f_4, 1093140480, 1, 1056964608, 0, 1))
			{
				func_231(0, -1);
				iLocal_441 = 0;
				iLocal_438 = 0;
		...
		case 2:
			func_230(&uLocal_250, 3, 0, "BARRY", 0, 1);
			iLocal_142 = 0;
			iLocal_141 = 7;
			break;
	}
...
void func_233()//Position - 0x25DC7
{
	switch (iLocal_142)
	{
		...
		case 1:
			func_239(&uLocal_449, &uLocal_250, "BAR3AAU", &sLocal_450, &cLocal_456);
...
void func_236()//Position - 0x25F28
{
	...
	{
		if (!func_209() && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_144.f_4, 0))
		{
			if (!iLocal_424)
			{
				iLocal_424 = 1;
			...
			if ((MISC::GET_GAME_TIMER() - iLocal_426) > Local_415[iLocal_425 /*2*/].f_1 && (func_238() || iLocal_425 == 0))
			{
				if (iLocal_425 != 2 || ENTITY::GET_ENTITY_SPEED(Local_144.f_4) > 10f)
				{
					...
					{
						if (func_237(&uLocal_250, "BAR3AAU", Local_415[iLocal_425 /*2*/], 7, 1, 0, 0))
						{
							iLocal_424 = 0;
							iLocal_425++;
						}
					}
					else if (func_237(&uLocal_250, "BAR3AAU", Local_415[iLocal_425 /*2*/], 7, 0, 0, 0))
					{
						iLocal_424 = 0;
						iLocal_425++;
					}
		...
		case 1:
			if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_144.f_4, 0))
			{
				...
				else
				{
					...
					if (!iLocal_431)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_426) > 8000 && iLocal_425 >= 4) && !func_209())
						{
							if (func_237(&uLocal_250, "BAR3AAU", "BAR3A_LW", 7, 0, 0, 0))
							{
								iLocal_431 = 1;
							}
						}
...
void func_249(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2661C
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_198(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_97353.f_16828[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_154(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_89999, iParam0);
			}
			else
			{
				iVar10 = func_305(&(Global_89962.f_3));
				if (iVar10 > -1)
				{
...
{
	func_251(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_251(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x267AD
{
	...
	*uParam0 = func_222();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_272())
		{
			func_268(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_253(&(uParam0->f_2167), uParam0, iParam5, 1, 1, 0);
	}
	func_252(&(uParam0->f_2233));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
{
	func_262(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_259(iParam1, 145, 0);
	uParam0->f_11 = func_258(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_257(iParam1);
		}
	}
	if (iParam2 == 1)
	{
...
void func_262(int iParam0, var uParam1)//Position - 0x27C11
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_264(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_263(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_281(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2A115
{
	int iVar0;
	int iVar1;
...
bool func_283(struct<3> Param0, struct<3> Param3)//Position - 0x2A7AF
{
...
int func_289(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2AB5A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_306(int iParam0)//Position - 0x2B67E
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_307(Global_97353.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_307(Global_97353.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_307(Global_97353.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_307(Global_97353.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_307(Global_97353.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
void func_312(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2BABA
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_91351.f_4))
	{
		...
		{
			if (func_336(24) != Global_91351.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_333(ENTITY::GET_ENTITY_COORDS(Global_91351.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
...
void func_313(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)//Position - 0x2BB35
{
	struct<54> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_329(iParam5, Var0, Param1, uParam4, func_258(iParam0));
...
void func_314(int iParam0, int iParam1, int iParam2)//Position - 0x2BC60
{
	...
	if (!func_328(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97353.f_18371.f_4249 = func_294();
			}
...
void func_315(int iParam0, int iParam1)//Position - 0x2BD7D
{
	...
	func_262(iParam0, &(Global_97353.f_18371.f_4742));
}
...
int func_328(var uParam0, int iParam1)//Position - 0x2C675
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_283(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_283(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_283(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_329(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x2DD69
{
	if (func_328(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_331(iParam0);
			func_330(Param1, &(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_330(struct<54> Param0, var uParam54)//Position - 0x2DE6B
{
...
int func_333(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x2DFD7
{
	int iVar0;
	
	iVar0 = func_334(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_334(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2E0ED
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_338()//Position - 0x2E211
{
	switch (iLocal_142)
	{
		case 0:
			func_230(&uLocal_250, 3, 0, "BARRY", 0, 1);
			if (func_215(&uLocal_250, 49, "BAR3AAU", "BAR3A_PICK2", 7, 1, 0, 0, 0))
			{
				iLocal_142 = 1;
			}
			break;
...
void func_341(int iParam0)//Position - 0x2E31C
{
	switch (Local_185[iParam0 /*29*/].f_24)
	{
		case 0:
			...
			{
				if (func_201(Local_185[iParam0 /*29*/]))
				{
			...
			else if (!ENTITY::IS_ENTITY_DEAD(Local_185[iParam0 /*29*/].f_1))
			{
				...
				if (func_201(Local_185[iParam0 /*29*/].f_2))
				{
		...
		case 1:
			if (func_204(PLAYER::PLAYER_PED_ID(), Local_185[iParam0 /*29*/].f_3, 275f))
			{
				if (func_360(iParam0))
				{
		...
		case 3:
			if (!func_204(PLAYER::PLAYER_PED_ID(), Local_185[iParam0 /*29*/].f_3, 275f))
			{
				if (!Local_185[iParam0 /*29*/].f_26 && ENTITY::DOES_ENTITY_EXIST(Local_185[iParam0 /*29*/].f_1))
				{
					func_342(&(Local_185[iParam0 /*29*/].f_1), 1, 0, 1);
					Local_185[iParam0 /*29*/].f_26 = 1;
				}
				if (!Local_185[iParam0 /*29*/].f_27 && ENTITY::DOES_ENTITY_EXIST(Local_185[iParam0 /*29*/].f_2))
				{
...
void func_344(int iParam0, int iParam1)//Position - 0x2E7D2
{
	...
	if (func_201(Local_185[iParam0 /*29*/].f_1))
	{
	...
	if (func_201(Local_185[iParam0 /*29*/].f_2))
	{
		...
		func_342(&(Local_185[iParam0 /*29*/].f_2), 1, 0, 1);
	}
	if (iParam1 && func_201(Local_185[iParam0 /*29*/]))
	{
		VEHICLE::SET_VEHICLE_ENGINE_ON(Local_185[iParam0 /*29*/], 1, 1);
		func_345(&(Local_185[iParam0 /*29*/]));
	}
...
bool func_349(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2EA0B
{
	...
	uVar0 = func_350(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_350(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2EACC
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_353(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2ED07
{
	...
	{
		Var3 = { func_355(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_354(Var3, Var0);
...
float func_354(struct<3> Param0, struct<3> Param3)//Position - 0x2ED98
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_364()//Position - 0x2F02B
{
	switch (iLocal_438)
	{
		...
		case 2:
			...
			{
				if ((!iLocal_442 && MISC::GET_GAME_TIMER() >= iLocal_440) && !func_209())
				{
					if (func_237(&uLocal_250, "BAR3AAU", "BAR3A_HURRY", 7, 0, 0, 0))
					{
						iLocal_442 = 1;
					}
				}
...
void func_367(bool bParam0)//Position - 0x2F22D
{
	if (bParam0)
	{
		...
		while (iLocal_249 <= 1)
		{
			func_343(&(Local_185[iLocal_249 /*29*/].f_1));
			func_343(&(Local_185[iLocal_249 /*29*/].f_2));
			iLocal_249++;
		}
		iLocal_249 = 0;
		while (iLocal_249 <= 1)
		{
			func_200(&(Local_185[iLocal_249 /*29*/]));
			iLocal_249++;
		}
	}
	else
	{
		func_368(&uLocal_154, 0);
		func_345(&(Local_144.f_4));
		iLocal_249 = 0;
		while (iLocal_249 <= 1)
		{
			func_342(&(Local_185[iLocal_249 /*29*/].f_1), 1, 0, 1);
			func_342(&(Local_185[iLocal_249 /*29*/].f_2), 1, 0, 1);
			func_345(&(Local_185[iLocal_249 /*29*/]));
			iLocal_249++;
		}
	}
	if (iLocal_244)
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_380(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_391(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_393(iParam0, Global_34913);
}
...
void func_421(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30978
{
	if (func_423())
	{
...
void func_424()//Position - 0x30A5B
{
	...
	if (func_201(PLAYER::PLAYER_PED_ID()))
	{
		func_230(&uLocal_250, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	iLocal_431 = 0;
	iLocal_442 = 0;
	iLocal_425 = 0;
...
{
	Local_166[0 /*3*/] = { func_429("B3ADELV", 1) };
	Local_166[1 /*3*/] = { func_429("B3AGETIN", 1) };
	Local_166[2 /*3*/] = { func_429("B3AWAN1", -1) };
	Local_166[3 /*3*/] = { func_429("B3ARTV", 1) };
	Local_166[4 /*3*/] = { func_429("B3AEXIT", 1) };
	Local_166[5 /*3*/] = { func_429("B3ALEAVE", 1) };
}
...
int func_442(char* sParam0, int iParam1, int iParam2)//Position - 0x312DF
{
	...
	if (func_445())
	{
		...
		{
			iVar33 = func_305(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_443()//Position - 0x31471
{
	...
	iVar0 = func_308(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_445()//Position - 0x314E5
{
	...
	{
		if (func_305(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
