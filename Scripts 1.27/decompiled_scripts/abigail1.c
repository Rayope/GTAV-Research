...
void __EntryFunction__()//Position - 0x0
{
	...
	func_312(&iLocal_148, &(Local_87.f_28[0]));
	while (true)
	{
		SYSTEM::WAIT(0);
...
void func_1()//Position - 0xF3
{
	switch (iLocal_152)
	{
		...
		case 1:
			func_285();
			if ((func_289(iLocal_148) && ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_148, "rcmabigail", "loop_2_cs", 3)) && ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_148, "rcmabigail", "loop_2_cs") > 0.99f)
			{
				iLocal_152++;
			}
			break;
		...
		case 4:
			if (CUTSCENE::IS_CUTSCENE_PLAYING())
			{
				...
				if (func_289(iLocal_148) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Abigail", 0))
				{
		...
		case 5:
			...
			if (func_215(1000) || MISC::GET_GAME_TIMER() > iLocal_151)
			{
...
void func_203(var uParam0, int iParam1, bool bParam2)//Position - 0x2536D
{
	...
	while (iVar0 < 6)
	{
		if (func_289(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_289(uParam0->f_35[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_289(uParam0->f_41[iVar0]))
		{
...
void func_224(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x25AC6
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_91351.f_4))
	{
		...
		{
			if (func_268(24) != Global_91351.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_265(ENTITY::GET_ENTITY_COORDS(Global_91351.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_225(Global_91351.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_225(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)//Position - 0x25B41
{
	struct<54> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_256(iParam5, Var0, Param1, uParam4, func_259(iParam0));
...
void func_226(int iParam0, int iParam1, int iParam2)//Position - 0x25C6C
{
	...
	if (!func_253(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97353.f_18371.f_4249 = func_242();
			}
...
void func_227(int iParam0, int iParam1)//Position - 0x25D89
{
	...
	func_261(iParam0, &(Global_97353.f_18371.f_4742));
}
...
int func_240(int iParam0, int iParam1, bool bParam2)//Position - 0x26681
{
	...
	iVar0 = 0;
	while (func_241(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_253(var uParam0, int iParam1)//Position - 0x26AB7
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_260(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_260(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_260(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_256(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x28468
{
	if (func_253(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_258(iParam0);
			func_257(Param1, &(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_257(struct<54> Param0, var uParam54)//Position - 0x2856A
{
...
bool func_260(struct<3> Param0, struct<3> Param3)//Position - 0x28712
{
...
void func_261(int iParam0, var uParam1)//Position - 0x2873B
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_263(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_262(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_265(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x28B98
{
	int iVar0;
...
int func_266(struct<3> Param0, int iParam3, int iParam4)//Position - 0x28CAE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_270(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, var uParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28D9A
{
	var uVar0;
	bool bVar1;
	bool bVar2;
...
int func_272(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x291AA
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_273(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x294A0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_285()//Position - 0x2999D
{
	if (func_289(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (iLocal_153 == 0)
		{
			if (func_289(iLocal_148))
			{
				if (func_286(PLAYER::PLAYER_PED_ID(), iLocal_148, 1) < 4f || (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 2f && func_286(PLAYER::PLAYER_PED_ID(), iLocal_148, 1) < 6f))
				{
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_298(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_309(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_311(iParam0, Global_34913);
}
...
int func_331()//Position - 0x2ACAE
{
	...
	iVar0 = func_332(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_335()//Position - 0x2AD82
{
	...
	{
		if (func_330(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_348(&(uParam0->f_28));
	func_348(&(uParam0->f_35));
