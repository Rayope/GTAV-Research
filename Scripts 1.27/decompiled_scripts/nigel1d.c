...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	uLocal_91 = func_533(64);
	uLocal_92 = func_533(63);
	...
	MISC::CLEAR_BIT(&(Global_97353.f_16828.f_382), 4);
	func_482();
	iVar0 = 0;
	while (iVar0 <= (Local_480 - 1))
	{
		if (func_481(Local_480[iVar0 /*13*/]))
		{
	...
	while (true)
	{
		...
		if (func_481(Local_454))
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_371) > 2000)
			{
				if (!iLocal_370)
				{
					func_451(Local_454, 0);
		...
		case 0:
			...
			if (func_481(PLAYER::PLAYER_PED_ID()))
			{
				...
				while (iVar0 <= 2)
				{
					...
					func_286(&(Local_480[iVar0 /*13*/].f_11));
					iVar0++;
				}
				func_286(&iLocal_338);
				func_285(&uLocal_173, 2);
				func_285(&uLocal_173, 3);
				func_285(&uLocal_173, 4);
				func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				func_284(&uLocal_173, 3, 0, "NIGEL", 0, 1);
				func_284(&uLocal_173, 4, 0, "MRSTHORNHILL", 0, 1);
				iLocal_170 = 1;
		...
		case 1:
			...
			if (!func_14())
			{
				if (!iLocal_358)
				{
					...
					{
						if (func_235(&uLocal_173, 64, "NIG1DAU", "NIG1D_OUTRO", 9, 1, 0, 0, 0))
						{
...
void func_37(int iParam0, bool bParam1)//Position - 0x132A
{
	...
	{
		func_199(&(Global_96440[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_40()//Position - 0x1589
{
	...
	{
		func_42(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x2737
{
	...
	Global_68106[1 /*14*/] = { func_113(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_68106[1 /*14*/] = { func_113(iVar0, iParam1, uVar30[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_105(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_105(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_105(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_64(int iParam0, int iParam1, int iParam2)//Position - 0x28F0
{
	...
	{
		if (!func_178(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x29B7
{
	...
	if (iParam5 == 0)
	{
		Global_68106[1 /*14*/] = { func_113(iVar10, iParam1, iParam2) };
		if (!func_103(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_68106[1 /*14*/] = { func_113(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_68106[1 /*14*/] = { func_113(iVar10, 14, uVar27[iVar1]) };
							func_82(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
							func_96(14);
							if (Global_68105 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_105(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_105(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_105(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_96(iVar0);
						if (Global_68105 == 1)
						{
			...
			{
				Global_68106[1 /*14*/] = { func_113(iVar10, iVar0, func_72(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_68106[1 /*14*/] = { func_113(iVar10, 14, uVar67[iVar1]) };
			func_82(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
			func_96(14);
			if (Global_68105 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_105(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_105(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_105(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
{
	Global_68106[1 /*14*/] = { func_113(iParam0, iParam1, iParam2) };
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x58CA
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_105(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6720
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_105(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_96(int iParam0)//Position - 0x696A
{
	...
	{
		func_102(iParam0, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6A6B
{
	...
	iVar0 = Global_2454605[iParam0 /*6*/][func_99(iParam2)];
	if (iVar0 != 0)
	{
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x6ACA
{
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_99(iParam1)];
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x810C
{
	...
	{
		if (!func_178(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_92(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_112(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[0], Global_97353.f_1729.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_112(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[1], Global_97353.f_1729.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_112(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[2], Global_97353.f_1729.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_111(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_111(Var16.f_2)] = func_92(iParam1, Var16.x, func_111(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_115(int iParam0)//Position - 0xAF4A
{
	...
	func_116(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_120(14))
			{
				uVar0 = func_100(func_119(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_100(func_118(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_100(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_123(int iParam0, int iParam1, int iParam2)//Position - 0xD263
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_116(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_116(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_116(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_105(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_116(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_178(int iParam0, int iParam1, int iParam2)//Position - 0x1E6CA
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_178(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_178(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_68106[2 /*14*/] = { func_113(iVar0, 14, iVar4) };
									if (Global_68106[2 /*14*/].f_12 == iVar3)
									{
										if (func_178(iParam0, 14, iVar4))
										{
											if (!func_70(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_68106[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_68106[2 /*14*/] = { func_113(iVar0, iVar2, iVar1) };
						if (!func_70(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_68106[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_105(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_105(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_182()//Position - 0x1E9FF
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_232(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_179(PLAYER::PLAYER_PED_ID());
			if (func_183(iVar0) && (!func_120(14) || Global_96306))
			{
				if (Global_97353.f_1729.f_539.f_3213 != iVar0 && func_183(Global_97353.f_1729.f_539.f_3213))
				{
...
void func_188(int iParam0, int iParam1, int iParam2)//Position - 0x1F074
{
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&uVar32, {func_185(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar32, 0, Global_89999, 0);
		func_189(&uVar32, Var0.f_3, Global_89999, iParam1, iParam2);
	}
}
...
void func_194()//Position - 0x20729
{
	...
	{
		func_182();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_195(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
{
	func_204(iParam0, 1);
	Global_97353.f_16828[iParam0 /*6*/].f_3 = func_203();
...
int func_230(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x25CF9
{
	...
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_102(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 1, Global_68106[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
					...
					while (iVar1 <= 14)
					{
						if ((uVar3[iVar1] != -99 && iVar1 != 12) && iVar1 != 14)
						{
							...
							else
							{
								...
								while (iVar2 <= 8)
								{
									func_230(iParam0, 14, uVar19[iVar2], 1, 1);
									func_231(iParam0, 14, uVar19[iVar2], 1);
									iVar2++;
								}
							}
						}
		...
		{
			func_102(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 1, Global_68106[1 /*14*/].f_1, 0, 1);
		}
					...
					switch (iParam1)
					{
						...
						case 11:
							if (iParam2 >= 9 && iParam2 <= 24)
							{
								...
								func_230(iParam0, 11, iVar29, 1, 0);
							}
							else if (iParam2 >= 25 && iParam2 <= 40)
							{
						...
						case 14:
							if (iParam2 >= 64 && iParam2 <= 79)
							{
								...
								func_230(iParam0, 14, iVar29, 1, 0);
							}
							break;
					}
					break;
...
int func_231(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x260E0
{
	...
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_102(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 0, Global_68106[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_102(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 0, Global_68106[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_245()//Position - 0x26801
{
		...
		switch (iLocal_169)
		{
			case 0:
				...
				if (func_263(Local_454, 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (!func_14())
					{
						...
						func_284(&uLocal_173, 7, Local_480[0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						if (func_261())
						{
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 0, 0);
						}
						else
						{
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_5", 7, 0, 0);
						}
						func_255();
						iLocal_169 = 3;
					}
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_454, 11f, 11f, 11f, 0, 1, 0))
				{
					if (!func_178(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						...
						func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
						func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_260(&uLocal_173, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_1", 7, 0, 0);
						if (func_5(Local_748))
						{
							if (func_6(Local_454))
							{
			...
			case 1:
				...
				else
				{
					...
					else if ((MISC::GET_GAME_TIMER() - iLocal_380) >= 2500)
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(Local_454, PLAYER::PLAYER_PED_ID()))
						{
							if (!func_14())
							{
								func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
								func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_BUMPF", 7, 0, 0, 0))
								{
									iLocal_380 = MISC::GET_GAME_TIMER();
								}
							}
					...
					if ((func_5(Local_748) && func_5(Local_693[5 /*6*/])) && func_481(PLAYER::PLAYER_PED_ID()))
					{
						if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_748, 0) || PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_693[5 /*6*/], 0))
						{
							...
							func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
							func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_BANK", "NIG1D_BANK_1", 7, 0, 0);
							TASK::OPEN_SEQUENCE_TASK(&uLocal_775);
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_387) >= 15000)
					{
						...
						{
							func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_BANK", "NIG1D_BANK_2", 7, 0, 0);
							TASK::OPEN_SEQUENCE_TASK(&uLocal_775);
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
							TASK::CLOSE_SEQUENCE_TASK(uLocal_775);
							TASK::TASK_PERFORM_SEQUENCE(Local_454, uLocal_775);
							TASK::CLEAR_SEQUENCE_TASK(&uLocal_775);
							if (func_481(Local_781.f_1))
							{
								ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_781.f_1, Local_454, PED::GET_PED_BONE_INDEX(Local_454, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
							}
							iLocal_386 = MISC::GET_GAME_TIMER();
			...
			case 3:
				if (((func_5(Local_748) && func_253(Local_454, Local_748, 1) < 10f) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_748, 0)) && !ENTITY::IS_ENTITY_UPSIDEDOWN(Local_748))
				{
					if (PED::IS_PED_SITTING_IN_VEHICLE(Local_454, Local_748))
					{
						func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
						func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
						func_260(&uLocal_173, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_3", 7, 0, 0);
						if (func_6(Local_454))
						{
							if (!func_251())
							{
	...
	else
	{
		...
		if (!MISC::IS_BIT_SET(Global_97353.f_16828.f_382, 4))
		{
			MISC::SET_BIT(&(Global_97353.f_16828.f_382), 4);
		}
	}
}
...
int func_246()//Position - 0x2717F
{
	if (ENTITY::GET_ENTITY_SPEED(Local_748) < 0.15f && PED::IS_PED_IN_VEHICLE(Local_454, Local_748, 0))
	{
		...
		{
			TASK::VEHICLE_WAYPOINT_PLAYBACK_PAUSE(Local_748);
			if (func_5(Local_748) && func_481(Local_454))
			{
				...
				if (PED::IS_PED_IN_VEHICLE(Local_454, Local_748, 0))
				{
					...
					func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
					func_260(&uLocal_173, "NIG1DAU", "NIG1D_GIVEUP", "NIG1D_GIVEUP_1", 7, 0, 0);
			...
			if (!func_14())
			{
				if ((MISC::GET_GAME_TIMER() - iLocal_384) >= 3000)
				{
					switch (iLocal_378)
					{
						case 0:
							func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_7", 7, 0, 0);
							break;
						
						case 1:
							func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_8", 7, 0, 0);
							break;
						
						case 2:
							func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_9", 7, 0, 0);
							break;
						
						case 3:
							func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_10", 7, 0, 0);
							break;
					}
					iLocal_378++;
			...
			if (!HUD::IS_MESSAGE_BEING_DISPLAYED())
			{
				if (!func_14())
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_385) > 15000)
					{
						if (func_6(Local_454))
						{
							if (func_249(Local_454, PLAYER::PLAYER_PED_ID()) < 40f)
							{
								func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
								func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								switch (iLocal_379)
								{
									case 0:
										if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_CHASE1", 8, 0, 0, 0))
										{
									...
									case 1:
										if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_CHASE2", 8, 0, 0, 0))
										{
									...
									case 2:
										if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_CHASE3", 8, 0, 0, 0))
										{
									...
									case 3:
										if (iLocal_168 == 5)
										{
											if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_CHASE4", 8, 0, 0, 0))
											{
									...
									case 4:
										if (iLocal_168 == 5)
										{
											if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_CHASE5", 8, 0, 0, 0))
											{
...
void func_250()//Position - 0x274FD
{
	...
	while (iVar0 <= 2)
	{
		if (func_481(Local_520[iVar0 /*13*/]))
		{
			iLocal_680[iVar0] = 1;
		}
		iVar0++;
...
int func_251()//Position - 0x27539
{
	if (func_481(PLAYER::PLAYER_PED_ID()))
	{
		if (func_252(&uLocal_934, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
		{
			return 1;
		}
	}
...
bool func_252(var uParam0, struct<2> Param1, float fParam3)//Position - 0x27564
{
	bool bVar0;
	int iVar1;
	int iVar2;
	...
	if (iLocal_356 == 0)
	{
		...
		while (iVar0 <= 2)
		{
			if (func_481(Local_480[iVar0 /*13*/]))
			{
				...
				{
					Local_480[iVar0 /*13*/].f_11 = func_259(Local_480[iVar0 /*13*/], 0, 0, 5);
				}
		...
		func_257();
		if (iLocal_168 <= 3 && func_481(Local_454))
		{
			ENTITY::ATTACH_ENTITY_TO_ENTITY(Local_781.f_1, Local_454, PED::GET_PED_BONE_INDEX(Local_454, 28422), 0.06f, 0.04f, 0f, -90f, 180f, 0f, 0, 0, 0, 0, 2, 1);
			if (func_481(Local_467))
			{
...
void func_257()//Position - 0x27969
{
	...
	while (iVar0 <= 5)
	{
		if (func_481(Local_560[iVar0 /*13*/]))
		{
			func_258(iVar0);
			iLocal_670[iVar0] = 3;
		}
...
bool func_266(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27C25
{
	...
	uVar0 = func_267(&(Local_48[iVar4 /*4*/]), Var1, iParam1, &(Local_48[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_48[iVar4 /*4*/].f_3) < iParam4);
}

int func_267(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x27CE6
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_271(struct<3> Param0, struct<3> Param3)//Position - 0x27FB2
{
...
int func_280(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x28378
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_282()//Position - 0x2844E
{
	...
	{
		case 0:
			if (func_6(Local_454) && func_481(PLAYER::PLAYER_PED_ID()))
			{
				if (((func_283(PLAYER::PLAYER_PED_ID(), Local_454, 35f) && iLocal_666[0] != 5) && iLocal_666[1] != 5) && iLocal_666[2] != 5)
				{
					if (!func_14())
					{
						func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
						if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_SWING", 8, 0, 0, 0))
						{
							iLocal_692 = 1;
						}
					}
...
void func_289()//Position - 0x287FD
{
	if (iLocal_367)
	{
		if (!func_481(Local_454) && func_291())
		{
...
void func_292()//Position - 0x288CF
{
	...
	else
	{
		...
		while (iVar0 <= 1)
		{
			if (func_481(Local_639[iVar0 /*13*/]))
			{
				func_293(iVar0);
			}
			iVar0++;
			...
			if (func_5(Local_748))
			{
				if (func_481(Local_454))
				{
					if (PED::IS_PED_IN_VEHICLE(Local_454, Local_748, 0))
					{
						...
						{
							if (func_6(Local_639[iParam0 /*13*/]))
							{
						...
						{
							func_284(&uLocal_173, 8, Local_639[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
							if (func_253(PLAYER::PLAYER_PED_ID(), Local_639[iParam0 /*13*/], 1) < 45f)
							{
								func_294(Local_560[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
							}
		...
		case 1:
			if (ENTITY::IS_ENTITY_AT_ENTITY(Local_454, Local_639[iParam0 /*13*/], 38f, 38f, 38f, 0, 1, 0))
			{
				if (func_6(Local_639[iParam0 /*13*/]))
				{
					...
					if (func_253(PLAYER::PLAYER_PED_ID(), Local_639[iParam0 /*13*/], 1) < 45f)
					{
						func_294(Local_560[iParam0 /*13*/], "GENERIC_CURSE_HIGH", 34);
					}
		...
		if (func_481(Local_480[iVar0 /*13*/]))
		{
			if (iLocal_356 == 0 && iLocal_350 == 0)
			{
				if (func_309())
				{
					...
					{
						func_284(&uLocal_173, 7, Local_480[iVar0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0);
						func_255();
					}
					else
					{
...
void func_301(int iParam0)//Position - 0x29101
{
	...
	if (func_481(PLAYER::PLAYER_PED_ID()) && func_481(Local_480[iParam0 /*13*/]))
	{
		if (func_253(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 1) < 20f)
		{
	...
	switch (iLocal_666[iParam0])
	{
		case 0:
			if (func_263(Local_480[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) || PED::HAS_PED_RECEIVED_EVENT(Local_480[iParam0 /*13*/], 60))
			{
				if (func_265(Local_480[iParam0 /*13*/], 110f))
				{
					...
					if (func_261())
					{
						func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0);
					}
			...
			{
				if ((ENTITY::IS_ENTITY_ON_SCREEN(Local_480[iParam0 /*13*/]) && func_265(Local_480[iParam0 /*13*/], 1126825984)) && func_253(Local_480[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) < 50f)
				{
					if (func_14())
					{
						func_12();
			...
			else if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), Local_480[iParam0 /*13*/]))
			{
				if (func_261())
				{
					if (func_265(Local_480[iParam0 /*13*/], 1126825984))
					{
						...
						func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
						if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_6", 7, 1, 0))
						{
			...
			else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					if (!func_178(PLAYER::PLAYER_PED_ID(), 12, 4))
					{
						if (!func_305())
						{
							if (func_265(Local_480[iParam0 /*13*/], 1126825984) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
							{
								...
								func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_5", 7, 0, 0))
								{
						...
						else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
						{
							if (iLocal_348 == 0)
							{
								...
								{
									if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 0, 0))
									{
										TASK::OPEN_SEQUENCE_TASK(&uLocal_774);
										TASK::TASK_PLAY_ANIM(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
										TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
								...
								else if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_1", 7, 1, 0))
								{
									TASK::OPEN_SEQUENCE_TASK(&uLocal_774);
									TASK::TASK_PLAY_ANIM(0, "rcmnigel1d", "thanks_male_03", 8f, -8f, -1, 0, 0, 0, 0, 0);
									TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
							...
							else if (iLocal_350 == 1)
							{
								if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
								{
									...
									func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
									if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 0, 0))
									{
					...
					else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 18f, 18f, 18f, 0, 1, 0))
					{
						if (iLocal_348 == 0)
						{
							if (!func_14() && iLocal_358 == 0)
							{
								if (func_6(Local_480[iParam0 /*13*/]))
								{
								...
								func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
								func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
								if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_OUTFIT", 7, 0, 0, 0))
								{
									iLocal_348 = 1;
									iVar0 = 0;
									while (iVar0 <= 2)
						...
						else if (iLocal_350 == 1)
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 12f, 12f, 12f, 0, 1, 0))
							{
								...
								func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
								if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_4", 7, 1, 0))
								{
			...
			else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 50f, 50f, 50f, 0, 1, 0))
			{
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 25f, 25f, 25f, 0, 1, 0))
				{
					...
					else if (func_265(Local_480[iParam0 /*13*/], 1126825984))
					{
						...
						if (iLocal_355 == 0)
						{
							if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_7", 7, 0, 0))
							{
		...
		case 1:
			if (!func_305())
			{
				if (func_265(Local_480[iParam0 /*13*/], 1126825984))
				{
					if (func_253(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 1) < 80f)
					{
			...
			{
				func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
				if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_3", 7, 0, 0))
				{
					if (func_6(Local_480[iParam0 /*13*/]))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_480[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), -1);
			...
			else if ((MISC::GET_GAME_TIMER() - iLocal_386) >= 8000)
			{
				...
				{
					func_284(&uLocal_173, 7, Local_480[iParam0 /*13*/], "Nigel1DCelebSecurity", 0, 1);
					if (func_260(&uLocal_173, "NIG1DAU", "NIG1D_SECUR", "NIG1D_SECUR_2", 7, 0, 0))
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_774);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1);
			...
			else if (!func_178(PLAYER::PLAYER_PED_ID(), 12, 4))
			{
				...
				else
				{
					...
					if ((MISC::GET_GAME_TIMER() - iLocal_386) >= 7000)
					{
						...
						else if (func_253(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 1) > 20f)
						{
		...
		case 3:
				...
				if (func_265(Local_480[iParam0 /*13*/], 1126825984))
				{
					if (func_253(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 1) < 80f)
					{
						...
						else
						{
							...
							{
								Local_480[iParam0 /*13*/].f_11 = func_259(Local_480[iParam0 /*13*/], 0, 0, 5);
							}
			...
			else
			{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_480[iParam0 /*13*/], 7f, 7f, 5f, 0, 1, 0) || (func_303(PLAYER::PLAYER_PED_ID(), -1097.28f, 68.05f, 52.99f, 10f) && iLocal_350 == 1))
				{
					if (func_14())
					{
						func_12();
		...
		case 4:
			if (func_253(Local_480[iParam0 /*13*/], PLAYER::PLAYER_PED_ID(), 1) > 120f && (PED::IS_PED_IN_ANY_VEHICLE(Local_454, 0) || func_481(Local_454)))
			{
				if (HUD::DOES_BLIP_EXIST(Local_480[iParam0 /*13*/].f_11))
				{
			...
			else if (!func_302(Local_480[iParam0 /*13*/], 242628503))
			{
				TASK::OPEN_SEQUENCE_TASK(&uLocal_774);
				TASK::TASK_PAUSE(0, MISC::GET_RANDOM_INT_IN_RANGE(5, 200));
				TASK::TASK_COMBAT_PED(0, PLAYER::PLAYER_PED_ID(), 0, 16);
...
bool func_303(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2A4D4
{
...
void func_306()//Position - 0x2A565
{
	...
	{
		if (iLocal_168 < 3 || func_253(PLAYER::PLAYER_PED_ID(), Local_454, 1) > 100f)
		{
			iVar0 = 0;
			while (iVar0 <= 2)
			{
				if (func_6(Local_480[iVar0 /*13*/]))
				{
					ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(Local_480[iVar0 /*13*/], 1);
					if (iVar0 == 1)
					{
			...
			if (func_481(Local_454))
			{
				if (!func_302(Local_454, 474215631))
				{
					TASK::CLEAR_PED_TASKS(Local_454);
...
float func_308(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2A722
{
	struct<3> Var0;
...
int func_309()//Position - 0x2A75B
{
	...
	while (iVar0 <= 2)
	{
		if ((!func_481(Local_480[iVar0 /*13*/]) || func_310(PLAYER::PLAYER_PED_ID(), Local_480[iVar0 /*13*/], 1)) || PED::IS_PED_RAGDOLL(Local_480[iVar0 /*13*/]))
		{
	...
	if ((!func_481(Local_454) || func_310(PLAYER::PLAYER_PED_ID(), Local_454, 1)) || PED::IS_PED_RAGDOLL(Local_454))
	{
		func_493("HAS_PLAYER_MUCKED_ABOUT(): Celeb ragdoll OR player bumped celeb with vehicle OR celeb isn't alive");
		return 1;
	}
	if ((!func_481(Local_467) || func_310(PLAYER::PLAYER_PED_ID(), Local_467, 1)) || PED::IS_PED_RAGDOLL(Local_467))
	{
		func_493("HAS_PLAYER_MUCKED_ABOUT(): Celeb friend ragdoll OR player bumped friend with vehicle OR friend isn't alive");
		return 1;
	}
	if (func_5(Local_748) && func_481(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_748, 0))
		{
	...
	if (func_5(Local_693[4 /*6*/]) && func_481(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_693[4 /*6*/], 0))
		{
	...
	if (func_5(Local_693[5 /*6*/]) && func_481(PLAYER::PLAYER_PED_ID()))
	{
...
{
	if (func_252(&uLocal_830, ENTITY::GET_ENTITY_COORDS(iParam0, 1)))
	{
		return 1;
	}
	return 0;
...
void func_317()//Position - 0x2ADD6
{
	if (iLocal_363 == 0)
	{
		if (func_481(Local_781.f_1) && iLocal_168 == 6)
		{
...
void func_320()//Position - 0x2B019
{
	if (iLocal_343 == 1)
	{
		...
		func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
		func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		func_260(&uLocal_173, "NIG1DAU", "NIG1D_HIT", "NIG1D_HIT_11", 7, 0, 0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_454) && func_481(Local_781.f_1))
	{
...
void func_321()//Position - 0x2B0D6
{
	switch (iLocal_170)
	{
		case 0:
			...
			if (func_481(Local_781.f_1) && func_481(Local_454))
			{
			...
			func_286(&iLocal_338);
			iLocal_338 = func_348(Local_748, 0, 5);
			iLocal_170 = 1;
			break;
		...
		case 1:
			func_245();
			func_317();
			func_347(iLocal_338, Local_748, 140f, 1061158912, 0);
			func_289();
			if (bLocal_368)
			{
				if (func_481(Local_781.f_1) && func_481(iLocal_776))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
...
int func_322()//Position - 0x2B35A
{
	if (func_5(Local_748))
	{
		if (func_481(Local_454))
		{
			func_324(&uLocal_35, Local_748, 0, 0, 1, 1, 1);
			if (PED::IS_PED_IN_VEHICLE(Local_454, Local_748, 0))
			{
				func_323();
			}
...
void func_325(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2B4B3
{
	func_326(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_326(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2B4D1
{
	...
	uParam0->f_6 = 2;
	func_327(uParam0, iParam1, Param2, sParam5, iParam6, bParam7, uParam8, bParam9);
}

void func_327(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2B509
{
	int iVar0;
	int iVar1;
...
void func_336(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x2BC59
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_339(struct<3> Param0, struct<3> Param3)//Position - 0x2BD8F
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}
...
void func_349()//Position - 0x2C46E
{
	switch (iLocal_170)
	{
		case 0:
			...
			func_363(&(Local_693[3 /*6*/]));
			if (func_481(iLocal_776) && func_5(Local_748))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(iLocal_776))
				{
					func_493("Reattaching bag to buggy!?");
			...
			if ((func_481(Local_781.f_1) && func_481(Local_454)) && func_5(Local_748))
			{
				if (!ENTITY::IS_ENTITY_ATTACHED(Local_781.f_1))
				{
					func_493("Reattaching club to bag!?");
		...
		case 1:
			...
			func_315();
			PLAYER::_0x4669B3ED80F24B4E(PLAYER::PLAYER_ID());
			func_347(iLocal_338, Local_454, 140f, 1061158912, 0);
			if (!func_481(Local_781.f_1))
			{
				HUD::CLEAR_PRINTS();
				if (func_14())
			...
			if (func_350() || !func_481(Local_454))
			{
				func_32("N1D_COLLECT", 7500, 5);
				func_34(6);
			}
...
int func_350()//Position - 0x2C768
{
	if (func_5(Local_748))
	{
		if (func_481(Local_454))
		{
			...
			{
				func_351();
				func_477("VEHICLE HEALTH IS ", ENTITY::GET_ENTITY_HEALTH(Local_748));
...
void func_351()//Position - 0x2C8C3
{
	if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203) == 0)
	{
		if (!func_14())
		{
			...
			{
				func_284(&uLocal_173, 6, Local_454, "FOSTENBURG", 0, 1);
				if (func_254(&uLocal_173, "NIG1DAU", "NIG1D_HIT", 7, 0, 0, 0))
				{
					iLocal_383 = MISC::GET_GAME_TIMER();
					iLocal_384 = MISC::GET_GAME_TIMER();
				}
	...
	switch (iLocal_670[iParam0])
	{
		case 0:
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_560[iParam0 /*13*/], 1), 50f, 0))
				{
					...
					{
						func_294(Local_560[iParam0 /*13*/], "GENERIC_SHOCKED_HIGH", 34);
					}
				...
				else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), Local_560[iParam0 /*13*/], 20f, 20f, 20f, 0, 1, 0))
				{
					if (func_263(Local_560[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
					{
						if (!func_305())
						{
							if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								func_294(Local_560[iParam0 /*13*/], "GENERIC_FRIGHTENED_HIGH", 34);
							}
							func_258(iParam0);
						...
						else
						{
							...
							if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								func_294(Local_560[iParam0 /*13*/], "GENERIC_FUCK_YOU", 34);
		...
		case 1:
			if (func_263(Local_560[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0) && !func_305())
			{
				if (!func_14() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					func_284(&uLocal_173, 8, Local_560[iParam0 /*13*/], "NIGEL1DAMBIENTGOLFER1", 0, 1);
					func_294(Local_560[iParam0 /*13*/], "GENERIC_CURSE_MED", 34);
				}
		...
		case 3:
			if (!func_302(Local_560[iParam0 /*13*/], 1805844857))
			{
				func_258(iParam0);
			}
			func_307(&(Local_560[iParam0 /*13*/]), 1, 0, 1);
			break;
...
void func_364()//Position - 0x2D3A1
{
	switch (iLocal_170)
	{
		case 0:
			...
			func_286(&iLocal_338);
			iLocal_338 = func_259(Local_454, 1, 0, 5);
			iLocal_170 = 1;
			break;
		...
		case 2:
			HUD::CLEAR_PRINTS();
			if (func_481(Local_454) && !bLocal_365)
			{
				func_34(4);
			}
			else
...
void func_366(int iParam0)//Position - 0x2D90B
{
	...
	Global_97353.f_1729.f_539.f_1560[iParam0] = 1;
}
...
void func_369()//Position - 0x2DA0D
{
	...
	while (iVar0 <= 3)
	{
		if (func_481(Local_401[iVar0 /*13*/]))
		{
			func_370(iVar0);
		}
		iVar0++;
			...
			if (func_263(Local_401[iParam0 /*13*/], 1, 1116471296, 1126825984, 0, 0, 0, 0))
			{
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!func_14())
					{
						if (iParam0 == 0)
						{
							func_284(&uLocal_173, 7, Local_401[iParam0 /*13*/], "CONCIERGE", 0, 1);
							func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_9", 7, 0, 0);
						}
					}
				}
				func_362();
				...
				if (!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!func_14())
					{
						if (iParam0 == 0)
						{
							func_284(&uLocal_173, 7, Local_401[iParam0 /*13*/], "CONCIERGE", 0, 1);
							func_284(&uLocal_173, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_260(&uLocal_173, "NIG1DAU", "NIG1D_FLEE", "NIG1D_FLEE_7", 7, 0, 0);
						}
					}
				}
				func_362();
...
{
	if (func_252(&uLocal_882, ENTITY::GET_ENTITY_COORDS(iParam0, 0)))
	{
		return 1;
	}
	return 0;
...
void func_374()//Position - 0x2DC6B
{
	switch (iLocal_170)
	{
		...
		case 1:
			...
			func_245();
			func_365();
			if (func_481(Local_454) && func_481(PLAYER::PLAYER_PED_ID()))
			{
				if (func_283(PLAYER::PLAYER_PED_ID(), Local_454, 50f) || iLocal_169 == 3)
				{
					iLocal_170 = 2;
				}
				else if (func_31())
				...
				{
					if (func_283(PLAYER::PLAYER_PED_ID(), Local_454, 150f))
					{
						iLocal_170 = 2;
					}
				}
...
{
	func_377(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_377(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2DF5F
{
	...
	*uParam0 = func_241();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_398())
		{
			func_394(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_379(&(uParam0->f_2167), uParam0, iParam5, 1, 1, 0);
	}
	func_378(&(uParam0->f_2233));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
{
	func_388(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_385(iParam1, 145, 0);
	uParam0->f_11 = func_384(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_383(iParam1);
		}
	}
	if (iParam2 == 1)
	{
...
void func_388(int iParam0, var uParam1)//Position - 0x2F3C8
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_390(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_389(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_392(int iParam0, int iParam1, bool bParam2)//Position - 0x2F930
{
	...
	iVar0 = 0;
	while (func_393(iParam1, iVar0, &sVar1, &iVar9))
	{
...
void func_394(int iParam0, var uParam1, int iParam2)//Position - 0x2FA81
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_395(161, -1))
			{
				uParam1->f_59 = func_100(2035, Global_68104, 0);
			}
			else
			{
				uParam1->f_59 = func_100(740, Global_68104, 0);
			}
			uParam1->f_60 = func_100(741, Global_68104, 0);
			uParam1->f_61 = func_100(742, Global_68104, 0);
		}
...
int func_395(int iParam0, int iParam1)//Position - 0x2FC2B
{
	...
	uVar0 = Global_2473393[iParam0 /*6*/][func_99(iParam1)];
...
void func_399(int iParam0, bool bParam1)//Position - 0x303FA
{
	...
	if (func_183(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_400(iParam0, &(Global_97353.f_1729.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_400(int iParam0, var uParam1)//Position - 0x304ED
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_401(Var9.f_1)) && iVar70 < 50)
			{
...
int func_407(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x318DA
{
	int iVar0;
	int iVar1;
...
int func_414(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x322F6
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 43)
	{
		if (iParam3 == 5 || iParam3 == func_417(iVar0))
		{
			if (!bParam5 || func_416(iVar0))
			{
...
int func_431(int iParam0)//Position - 0x32E1E
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_432(Global_97353.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_432(Global_97353.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_432(Global_97353.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_432(Global_97353.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_432(Global_97353.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
void func_437(int iParam0)//Position - 0x3332C
{
	if (iLocal_689 != 5 || iParam0 == 1)
	{
		...
		{
			iLocal_339 = func_438(-1377.18f, 55.39f, 53.7f, 0);
...
int func_438(struct<3> Param0, int iParam3)//Position - 0x33375
{
	int iVar0;
...
void func_442()//Position - 0x336C0
{
	switch (iLocal_170)
	{
		...
		case 1:
			if (!iLocal_358)
			{
				if (func_235(&uLocal_173, 64, "NIG1DAU", "NIG1D_INTRO", 9, 1, 0, 0, 0))
				{
					RECORDING::_0x293220DA1B46CEBC(2f, 8f, 1);
...
void func_445()//Position - 0x338DF
{
	...
	while (iVar0 <= 3)
	{
		func_4(&(Local_401[iVar0 /*13*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_4(&(Local_560[iVar0 /*13*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_4(&(Local_639[iVar0 /*13*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_4(&(Local_480[iVar0 /*13*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_4(&(Local_520[iVar0 /*13*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		func_3(&(Local_693[iVar0 /*6*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_3(&(Local_754[iVar0 /*6*/]));
		iVar0++;
	}
	func_3(&Local_748);
	func_447(&(Local_781.f_1));
	func_447(&iLocal_776);
	func_447(&Local_824);
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_447(&(Local_787[iVar0 /*6*/]));
		iVar0++;
	}
...
void func_446(int iParam0, var uParam1)//Position - 0x33A42
{
	...
	Global_97353.f_1729.f_539.f_1560[iParam0] = uParam1;
}
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_454(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_455(iVar2), 8);
					break;
			}
			break;
...
{
	if (((!func_465(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_467(iParam0, Global_34913);
}
...
void func_476(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x34B03
{
	if (func_501())
	{
...
int func_479(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x34BD2
{
	bool bVar0;
	float fVar1;
...
void func_482()//Position - 0x34C77
{
	...
	func_486(&uLocal_830);
	func_485(&uLocal_830, -1313.714f, -27.2202f, 48.0314f);
	func_485(&uLocal_830, -1294.066f, -27.0136f, 47.5724f);
	func_485(&uLocal_830, -1069.844f, -143.769f, 39.7493f);
	func_485(&uLocal_830, -925.2529f, -89.9079f, 38.3457f);
	func_485(&uLocal_830, -1010.948f, 40.0643f, 49.9277f);
	func_485(&uLocal_830, -1122.838f, 233.7037f, 64.7587f);
	func_485(&uLocal_830, -1282.578f, 188.8798f, 59.2769f);
	func_485(&uLocal_830, -1328.153f, 192.0178f, 57.8136f);
	func_485(&uLocal_830, -1386.75f, 167.32f, 57.11f);
	func_485(&uLocal_830, -1411.5f, 109.64f, 51.49f);
	func_485(&uLocal_830, -1399.63f, -10.83f, 51.93f);
	func_485(&uLocal_830, -1359.54f, 18.93f, 52.52f);
	func_485(&uLocal_830, -1342.27f, 16.92f, 52.16f);
	func_484(&uLocal_830);
	func_483(&uLocal_882, &uLocal_830, 100f);
	func_486(&uLocal_934);
	func_485(&uLocal_934, -1100.2f, 77.1233f, 53.2703f);
	func_485(&uLocal_934, -1040.69f, 97.3963f, 51.9067f);
	func_485(&uLocal_934, -977.9333f, -5.5166f, 45.6548f);
	func_485(&uLocal_934, -1039.687f, -35.872f, 45.4867f);
	func_485(&uLocal_934, -1062.19f, -2.8635f, 49.6013f);
	func_484(&uLocal_934);
	iLocal_172 = 1;
}
...
int func_491(int iParam0)//Position - 0x355C5
{
	...
	return Global_97353.f_1729.f_539.f_1560[iParam0];
}
...
int func_495(var uParam0, var uParam1)//Position - 0x35F0D
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if ((!func_500(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_90 = 2;
...
void func_502(int iParam0)//Position - 0x36A45
{
	...
	while (iVar0 <= 3)
	{
		func_307(&(Local_401[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_307(&(Local_520[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		func_307(&(Local_480[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 5)
	{
		func_307(&(Local_560[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_307(&(Local_639[iVar0 /*13*/]), 1, 0, 1);
		iVar0++;
	}
	func_307(&Local_467, 1, 0, 1);
	func_307(&Local_454, 1, 0, 1);
	iVar0 = 0;
	while (iVar0 <= 8)
	{
		func_363(&(Local_693[iVar0 /*6*/]));
		iVar0++;
	}
	iVar0 = 0;
	while (iVar0 <= 1)
	{
		func_363(&(Local_754[iVar0 /*6*/]));
		iVar0++;
	}
	func_363(&Local_748);
	iVar0 = 0;
...
int func_515(char* sParam0, int iParam1, int iParam2)//Position - 0x36EF2
{
	...
	if (func_518())
	{
		...
		{
			iVar33 = func_430(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_516()//Position - 0x37084
{
	...
	iVar0 = func_433(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_518()//Position - 0x370F8
{
	...
	{
		if (func_430(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
