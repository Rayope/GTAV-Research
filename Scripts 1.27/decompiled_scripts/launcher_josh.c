...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	...
	if (Var0 == 27)
	{
		func_231(&uLocal_96, 5, Var0.f_28[0], "JOSH", 0, 1);
	}
	else if (Var0 == 30)
	{
		func_231(&uLocal_96, 4, Var0.f_28[0], "JOSH", 0, 1);
		func_231(&uLocal_96, 3, Var0.f_28[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		func_191(Var0);
		func_184(&iLocal_94, &(Var0.f_9), Var61);
		if (Var0 == 27)
		{
			func_182(&Var0, Var61, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0 == 28)
		{
			func_182(&Var0, Var61, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 29)
		{
			func_182(&Var0, Var61, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 30)
		{
			if (iLocal_264 == 0)
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x571F
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5DB9
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x616F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_149(struct<3> Param0, int iParam3)//Position - 0x9E67
{
	var uVar0;
	...
	if (*uParam0 == 30)
	{
		if (func_181(uParam0->f_28[0]))
		{
			if (bLocal_262)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_153(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 15f)
					{
						func_283("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_153(PLAYER::PLAYER_PED_ID(), uParam0->f_28[0], 1) <= 10f)
				{
	...
	switch (uParam0->f_16)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_181(uParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_163(2))
							{
								if (func_161(uParam0->f_27))
								{
									func_160(uParam0->f_27, *uParam0);
				...
				else if (func_181(uParam0->f_28[0]))
				{
					if (func_159(uParam0))
					{
						if (func_163(2))
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_96400) || Global_24446) || func_170()) || func_169(8, -1)) || func_77()) || func_168()) || func_167()) || func_166()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_171()) || Global_24446) || func_170()) || func_169(8, -1)) || func_167()) || func_77()) || func_168()) || func_166()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_96400) || Global_24446) || func_170()) || func_169(8, -1)) || func_167()) || func_77()) || func_168()) || func_166()) || Global_97353.f_5944.f_919[iVar0] == 5) || Global_35460 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_96400) || Global_24446) || func_170()) || func_169(8, -1)) || func_77()) || func_168()) || func_166()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_171() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_169(8, -1)) || func_166()) || func_165()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_171()) || Global_24446) || func_170()) || func_169(8, -1)) || func_168()) || func_167()) || func_166()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_171()) || func_168()) || Global_96400) || Global_24446) || func_170()) || Global_35957) || func_169(8, -1)) || func_167()) || func_165()) || func_166()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_171()) || Global_96400) || Global_24446) || func_170()) || func_169(8, -1)) || func_167()) || func_165()) || func_77()) || func_168()) || func_166())
						{
							return 0;
						}
						break;
...
void func_172()//Position - 0xB327
{
	switch (iLocal_95)
	{
		...
		case 1:
			...
			{
				if (func_173(&uLocal_96, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_95 = 2;
				}
			}
...
int func_182(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xB9DC
{
	var uVar0;
	
	if ((((func_181(PLAYER::PLAYER_PED_ID()) && func_181(iParam0->f_28[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_231(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
float func_193(int iParam0, struct<3> Param1, int iParam4)//Position - 0xBE56
{
	struct<3> Var0;
...
int func_194(var uParam0, bool bParam1)//Position - 0xBE8F
{
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_162(uVar2))
						{
							...
							{
								if (func_162(uParam0->f_35[iVar0]))
								{
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCD51
{
	...
	uVar0 = func_208(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_208(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xCE12
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_212(struct<3> Param0, struct<3> Param3)//Position - 0xD0DE
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_220(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xD45C
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_229() && Global_89962.f_11 == 6) && iParam0 == func_146(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_233(var uParam0)//Position - 0xD8DD
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_246(&(uParam0->f_48), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_245(&iVar0) || !func_244(&(uParam0->f_48)))
			{
				return 0;
			}
			if (!func_243(0, 1))
		...
		case 2:
			...
			{
				if (func_239(&(uParam0->f_28[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_237(&(uParam0->f_28[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
			...
			{
				func_237(&(uParam0->f_28[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_181(uParam0->f_28[2]))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_235(&(uParam0->f_35[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_234(&(uParam0->f_35[1]), 0);
				if (func_162(uParam0->f_35[1]))
				{
...
void func_234(var uParam0, bool bParam1)//Position - 0xDCCD
{
	...
	func_235(uParam0, iLocal_92, Var0, fVar3);
...
void func_235(var uParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xDD41
{
	func_236(uParam0);
...
void func_237(var uParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xDE18
{
	func_238(uParam0);
...
int func_239(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xDE78
{
...
int func_240(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xDED3
{
	int iVar0;
...
int func_247(var uParam0)//Position - 0xE152
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_239(&(uParam0->f_28[0]), 58, 566.1639f, -1773.817f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
{
	func_235(uParam0, iLocal_92, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*uParam0, 4);
...
int func_249(var uParam0)//Position - 0xE380
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_239(&(uParam0->f_28[0]), 58, 565.3901f, -1772.838f, 29.80087f, 62.50156f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
int func_250(var uParam0)//Position - 0xE5A2
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_246(&(uParam0->f_48), "rcmjosh1", "idle", 0);
			iLocal_90 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_239(&(uParam0->f_28[0]), 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
...
int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xEB69
{
	int iVar0;
...
int func_263(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xEBCE
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_264(Var1.f_6, Param1, fParam4))
	{
...
int func_264(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xEC4B
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
