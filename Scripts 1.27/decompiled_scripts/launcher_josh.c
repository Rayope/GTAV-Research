...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_51 = func_286(58);
	iLocal_52 = joaat("felon2");
	iLocal_54 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
	...
	if (Var0 == 27)
	{
		func_231(&uLocal_56, 5, Var0.f_1C[0], "JOSH", 0, 1);
	}
	else if (Var0 == 30)
	{
		func_231(&uLocal_56, 4, Var0.f_1C[0], "JOSH", 0, 1);
		func_231(&uLocal_56, 3, Var0.f_1C[1], "JOSHCOP", 0, 1);
	...
	while (true)
	{
		...
		if (!func_194(&Var0, 1))
		{
			if (Var0 == 30)
			{
				if (func_193(PLAYER::PLAYER_PED_ID(), -1102.724f, 290.1463f, 63.23002f, 1) < 200f)
				{
					PLAYER::SET_PLAYER_WANTED_LEVEL_NO_DROP(PLAYER::PLAYER_ID(), 1, 0);
					func_192(&Var0);
					func_283("Making Josh cops attack");
				}
			}
			func_265(&Var0, 1);
		}
		func_191(Var0);
		func_184(&iLocal_54, &(Var0.f_9), Var1);
		if (Var0 == 27)
		{
			func_182(&Var0, Var1, "JOSH1AU", "JOSH1_AMB1", 5, "JOSH", 5000, 14f);
		}
		else if (Var0 == 28)
		{
			func_182(&Var0, Var1, "JOSH2AU", "JOSH2_AMB", 5, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 29)
		{
			func_182(&Var0, Var1, "JOSH3AU", "JOSH3_AMB", 3, "JOSH", 5000, 1101004800);
		}
		else if (Var0 == 30)
		{
			if (iLocal_224 == 0)
			{
				...
				{
					if (func_181(Var0.f_1C[1]))
					{
						func_283("Josh 4: Trying to set Cop 1 component variation");
						CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_standing_idle", Var0.f_1C[1], 0);
					}
					if (func_181(Var0.f_1C[2]))
					{
						func_283("Josh 4: Trying to set Cop 2 component variation");
						CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Cop_with_notepad", Var0.f_1C[2], 0);
					}
					iLocal_224 = 1;
				}
			}
		...
		if (((func_157(&Var0, 0) || func_156(&Var0)) || func_154(&Var0)) || func_152(&Var0))
		{
			if (func_151(Var0))
			{
				func_148(Var0, &uLocal_223);
			}
			if (!func_2(&Var0))
			{
				func_265(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x3B3
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x494
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1B15
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x2999
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29BB
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A42
{
...
int func_29(int iParam0)//Position - 0x2A82
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2AB0
{
...
int func_31(int iParam0)//Position - 0x2B8C
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2BCE
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2C31
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2CBF
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2D01
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2F79
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2F85
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3231
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x32E1
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x33BB
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x346C
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x3599
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x360A
{
...
int func_44(int iParam0)//Position - 0x36E3
{
	int iVar0;
	int iVar1;
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x374A
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x38F4
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x3926
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x395A
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x3966
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3992
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EDA
{
	int iVar0;
...
int func_53()//Position - 0x411C
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x4135
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x4232
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x4240
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x4333
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x4597
{
...
int func_59(int iParam0, int iParam1)//Position - 0x46BD
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4ED9
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4F14
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x5188
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x51C4
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x571F
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x5763
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5DB9
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5DE2
{
...
bool func_68(int iParam0)//Position - 0x5E3B
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5E4B
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5EAB
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x6154
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x615F
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x616F
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x6206
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x66D7
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x66E7
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x6940
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x6951
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x6997
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x6A1D
{
...
void func_81(var uParam0, int iParam1)//Position - 0x6A50
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x6AA1
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x6B43
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6B68
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6B7F
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6B8C
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6BC6
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6C01
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6C3D
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6C56
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6CAF
{
...
bool func_92(bool bParam0)//Position - 0x6CF1
{
...
struct<2> func_93(int iParam0)//Position - 0x6D1C
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x7169
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x8442
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x8788
{
	var uVar0;
...
void func_98(int iParam0)//Position - 0x882C
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x88C7
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x8925
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x897E
{
...
int func_103(int iParam0)//Position - 0x8A01
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x8A32
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x8A46
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8AEE
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x8B09
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8B55
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8B9E
{
	if (func_181(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8BBE
{
	switch (iParam0)
	{
		case 5:
...
int func_113(int iParam0)//Position - 0x8C8E
{
	switch (iParam0)
	{
		case 5:
...
void func_114(var uParam0, int iParam1, bool bParam2)//Position - 0x8CE1
{
	int iVar0;
...
int func_115(int iParam0)//Position - 0x8DD5
{
	switch (iParam0)
	{
		case 5:
...
void func_116(bool bParam0)//Position - 0x8E40
{
	var uVar0;
...
void func_117(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8E7C
{
	if (bParam0)
	{
...
int func_118(int iParam0)//Position - 0x8F4D
{
...
bool func_119()//Position - 0x8F8E
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_120(int iParam0, int iParam1)//Position - 0x8F9F
{
	bool bVar0;
...
int func_121(int iParam0, bool bParam1)//Position - 0x8FEA
{
	int iVar0;
	int iVar1;
...
int func_122(int iParam0, var uParam1, var uParam2)//Position - 0x902B
{
	int iVar0;
...
void func_124(int iParam0)//Position - 0x9083
{
	if (iParam0 == 1)
	{
...
int func_125(char* sParam0)//Position - 0x90A6
{
...
void func_126()//Position - 0x90E3
{
	Global_38DE = 0;
	func_127();
}

void func_127()//Position - 0x90F3
{
...
int func_131(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x91D7
{
...
void func_134(int iParam0)//Position - 0x93D2
{
	if (Global_38D7)
	{
		func_135(0, 0);
...
void func_135(bool bParam0, bool bParam1)//Position - 0x9442
{
	if (bParam0)
	{
		if (func_136(0))
...
int func_136(int iParam0)//Position - 0x94B6
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_137(int iParam0)//Position - 0x9510
{
...
int func_138(int iParam0)//Position - 0x9551
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0x9596
{
...
int func_140(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x95C8
{
	int iVar0;
...
void func_141(var uParam0, int iParam1)//Position - 0x96FF
{
	int iVar0;
...
bool func_142(int iParam0)//Position - 0x974E
{
	return func_143(iParam0, Global_8861);
}

int func_143(int iParam0, int iParam1)//Position - 0x975F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_144(int iParam0)//Position - 0x9940
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_145()//Position - 0x9962
{
	return func_146(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_146(var uParam0, int iParam1)//Position - 0x9973
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_148(int iParam0, var uParam1)//Position - 0x99E0
{
	switch (iParam0)
	{
		case 0:
...
var func_149(struct<3> Param0, int iParam1)//Position - 0x9E67
{
	var uVar0;
...
float func_150(bool bParam0, float fParam1, float fParam2)//Position - 0x9E93
{
	if (bParam0)
	{
		return fParam1;
...
int func_151(int iParam0)//Position - 0x9EAA
{
	switch (iParam0)
	{
		case 0:
	...
	if (*uParam0 == 30)
	{
		if (func_181(uParam0->f_1C[0]))
		{
			if (bLocal_222)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_153(PLAYER::PLAYER_PED_ID(), uParam0->f_1C[0], 1) <= 15f)
					{
						func_283("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_153(PLAYER::PLAYER_PED_ID(), uParam0->f_1C[0], 1) <= 10f)
				{
					func_283("Special launching Josh 4 (in vehicle)");
					return 1;
				}
			}
		}
...
float func_153(int iParam0, int iParam1, int iParam2)//Position - 0x9FB8
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_154(var uParam0)//Position - 0xA014
{
	if (*uParam0 == 29)
	{
		if (func_193(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 6f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				func_283("Special launching Josh 3");
				return 1;
			}
			else if ((!func_155(PLAYER::PLAYER_PED_ID(), -828834893) && func_181(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && func_131(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1f, 1, 1056964608, 0, 1))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_155(int iParam0, int iParam1)//Position - 0xA0A6
{
	if (func_110(iParam0))
	{
...
int func_156(var uParam0)//Position - 0xA0D9
{
	if (*uParam0 == 28)
	{
		if (func_193(PLAYER::PLAYER_PED_ID(), 566.7472f, -1771.875f, 28.35786f, 1) < 9f)
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				func_283("Special launching Josh 2");
				return 1;
			}
			else if ((!func_155(PLAYER::PLAYER_PED_ID(), -828834893) && func_181(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && func_131(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 4f, 1, 1056964608, 0, 1))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_157(var uParam0, int iParam1)//Position - 0xA16F
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_181(uParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_1C[0], 1), 1) < 3f)
						{
							if (func_163(2))
							{
								if (func_161(uParam0->f_1B))
								{
									func_160(uParam0->f_1B, *uParam0);
				...
				else if (func_181(uParam0->f_1C[0]))
				{
					if (func_159(uParam0))
					{
						if (func_163(2))
...
void func_158()//Position - 0xA951
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_159(var uParam0)//Position - 0xA96C
{
	float fVar0;
...
void func_160(int iParam0, int iParam1)//Position - 0xA9FA
{
	if (iParam0 == 1)
	{
		if (!func_113(iParam1))
...
int func_161(bool bParam0)//Position - 0xAA5D
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0xAAF4
{
	if (func_181(uParam0))
	{
...
int func_163(int iParam0)//Position - 0xAB1E
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_17890) || Global_5F7E) || func_170()) || func_169(8, -1)) || func_77()) || func_168()) || func_167()) || func_166()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_171()) || Global_5F7E) || func_170()) || func_169(8, -1)) || func_167()) || func_77()) || func_168()) || func_166()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_17890) || Global_5F7E) || func_170()) || func_169(8, -1)) || func_167()) || func_77()) || func_168()) || func_166()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_171()) || Global_17890) || Global_5F7E) || func_170()) || func_169(8, -1)) || func_77()) || func_168()) || func_166()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_171() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_169(8, -1)) || func_166()) || func_165()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_169(8, -1) || func_77()) || func_168()) || func_165()) || func_164())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_171()) || Global_5F7E) || func_170()) || func_169(8, -1)) || func_168()) || func_167()) || func_166()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_171()) || func_168()) || Global_17890) || Global_5F7E) || func_170()) || Global_8C75) || func_169(8, -1)) || func_167()) || func_165()) || func_166()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_171()) || Global_17890) || Global_5F7E) || func_170()) || func_169(8, -1)) || func_167()) || func_165()) || func_77()) || func_168()) || func_166())
						{
							return 0;
						}
						break;
...
var func_164()//Position - 0xB23B
{
	return Global_15F91.f_1;
}

int func_165()//Position - 0xB249
{
	if (Global_154F9 != -1)
	{
...
bool func_168()//Position - 0xB2B3
{
	return Global_15F9E.f_123 > 0;
}

bool func_169(int iParam0, int iParam1)//Position - 0xB2C4
{
	switch (iParam0)
	{
		case 5:
...
var func_170()//Position - 0xB2FF
{
	return Global_14143C;
}

int func_171()//Position - 0xB30B
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_172()//Position - 0xB327
{
	...
	{
		case 0:
			if ((MISC::GET_GAME_TIMER() - iLocal_221) > 100 && bLocal_222 == 0)
			{
				iLocal_55 = 1;
			}
			break;
		...
		case 1:
			if (func_193(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) <= 20f)
			{
				if (func_173(&uLocal_56, "JOSH4AU", "JOSH4_AMB", 8, 0, 0, 0))
				{
					iLocal_55 = 2;
				}
			}
		...
		case 2:
			if (!func_128())
			{
				...
				iLocal_55 = 0;
				bLocal_222 = true;
				func_283("Josh 4 conversation finished and will not loop");
			}
			else if (func_193(PLAYER::PLAYER_PED_ID(), -1103.44f, 290.18f, 63.28f, 1) >= 25f)
			{
				func_126();
				bLocal_222 = true;
				iLocal_55 = 0;
...
bool func_173(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB3F3
{
...
int func_174(char* sParam0, int iParam1, bool bParam2)//Position - 0xB441
{
	Global_3D4D = 0;
...
void func_180(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB966
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
int func_181(int iParam0)//Position - 0xB9BC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
...
int func_182(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xB9DC
{
	var uVar0;
	
	if ((((func_181(PLAYER::PLAYER_PED_ID()) && func_181(iParam0->f_1C[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_193(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_231(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_183(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBA64
{
...
void func_184(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xBA9F
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_185(int iParam0, bool bParam1)//Position - 0xBB90
{
	if (iParam0 == -1)
	{
		return;
...
int func_186(int iParam0)//Position - 0xBBCC
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_187(int iParam0, int iParam1)//Position - 0xBC05
{
	bool bVar0;
	int iVar1;
...
bool func_188()//Position - 0xBCA3
{
	return Global_1567C;
}

void func_189(int iParam0)//Position - 0xBCAF
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_190(iParam0);
...
void func_190(int iParam0)//Position - 0xBCC6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_191(int iParam0)//Position - 0xBDAE
{
	if (iParam0 == -1)
	{
		iParam0 = func_145();
...
float func_193(int iParam0, struct<3> Param1, int iParam2)//Position - 0xBE56
{
	struct<3> Var0;
...
int func_194(var uParam0, bool bParam1)//Position - 0xBE8F
{
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_198(&(uParam0->f_30)) && bParam1)
	{
		func_195(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_195(int iParam0, var uParam1, int iParam2)//Position - 0xC105
{
	var uVar0;
	var uVar1;
	...
	if (func_181(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_197(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_196(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_197(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_196(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_196(int iParam0)//Position - 0xC45A
{
...
int func_197(var uParam0)//Position - 0xC47A
{
...
int func_198(var uParam0)//Position - 0xC492
{
...
void func_199(var uParam0)//Position - 0xC4B7
{
	int iVar0;
	var uVar1;
	...
	if (*uParam0 == 52)
	{
		func_200(&(uParam0->f_29[1]));
		func_200(&(uParam0->f_29[2]));
	}
	if (func_181(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
void func_200(var uParam0)//Position - 0xC7BB
{
...
int func_201(var uParam0, bool bParam1, bool bParam2)//Position - 0xC7E6
{
	int iVar0;
	int iVar1;
	var uVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_162(uVar2))
						{
							...
							{
								if (func_162(uParam0->f_23[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_202(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
...
int func_202(int iParam0, int iParam1)//Position - 0xC9A3
{
	int iVar0;
...
int func_204(int iParam0)//Position - 0xCC8F
{
...
bool func_207(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCD51
{
	...
	uVar0 = func_208(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_208(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xCE12
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_209(int iParam0, int iParam1)//Position - 0xCF3E
{
	int iVar0;
...
int func_211(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD04D
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_213(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_213(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_212(Var1, Var0);
...
float func_212(struct<3> Param0, struct<3> Param1)//Position - 0xD0DE
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_213(struct<3> Param0)//Position - 0xD0FF
{
	float fVar0;
	float fVar1;
...
void func_214(var uParam0)//Position - 0xD13E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_216(var uParam0)//Position - 0xD198
{
...
int func_217(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD1C0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_218(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xD2BB
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_219(var uParam0, float fParam1)//Position - 0xD3C7
{
	var uVar0;
	struct<3> Var1;
...
int func_220(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xD45C
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_213(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_221(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xD4EA
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_222(int iParam0)//Position - 0xD532
{
...
void func_223(int iParam0)//Position - 0xD57C
{
	var uVar0;
...
int func_224(int iParam0)//Position - 0xD619
{
	if (iParam0 == -1)
	{
		iParam0 = func_145();
...
int func_225(int iParam0)//Position - 0xD6B1
{
...
int func_228(int iParam0)//Position - 0xD733
{
	if ((func_229() && Global_15F6A.f_B == 6) && iParam0 == func_146(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_230(int iParam0)//Position - 0xD7A5
{
	if (func_92(0))
	{
...
void func_231(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD7CD
{
...
int func_233(var uParam0)//Position - 0xD8DD
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_246(&(uParam0->f_30), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_50 = 1;
			break;
		
		case 1:
			if (!func_245(&iVar0) || !func_244(&(uParam0->f_30)))
			{
				return 0;
			}
			if (!func_243(0, 1))
		...
		case 2:
			...
			{
				if (func_239(&(uParam0->f_1C[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_237(&(uParam0->f_1C[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
				if (func_181(uParam0->f_1C[1]))
				{
					...
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_1C[1], joaat("weapon_pistol"), -1, 0, 1);
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						TASK::CLEAR_PED_TASKS(uParam0->f_1C[1]);
						TASK::TASK_PLAY_ANIM(uParam0->f_1C[1], "rcmjosh4", "BECKON_A_COP_B", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			{
				func_237(&(uParam0->f_1C[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_181(uParam0->f_1C[2]))
				{
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 0, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 3, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 10, 0, 1, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_1C[2], 1);
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_1C[2], joaat("weapon_pistol"), -1, 0, 1);
					if (STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh4"))
					{
						TASK::CLEAR_PED_TASKS(uParam0->f_1C[2]);
						TASK::TASK_PLAY_ANIM(uParam0->f_1C[2], "rcmjosh4", "BECKON_A_COP_A", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_235(&(uParam0->f_23[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[1]))
			{
				func_234(&(uParam0->f_23[1]), 0);
				if (func_162(uParam0->f_23[1]))
				{
					VEHICLE::SET_VEHICLE_PETROL_TANK_HEALTH(uParam0->f_23[1], 900f);
					fVar2 = VEHICLE::GET_VEHICLE_ENGINE_HEALTH(uParam0->f_23[1]);
					fVar2 = (fVar2 / 2f);
					VEHICLE::SET_VEHICLE_ENGINE_HEALTH(uParam0->f_23[1], fVar2);
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_23[1]);
				}
				else
				{
					bVar3 = false;
...
void func_234(var uParam0, bool bParam1)//Position - 0xDCCD
{
	...
	func_235(uParam0, iLocal_52, Var0, fVar1);
...
void func_235(var uParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xDD41
{
	func_236(uParam0);
...
void func_236(var uParam0)//Position - 0xDD7C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_237(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xDE18
{
	func_238(uParam0);
	*uParam0 = PED::CREATE_PED(iParam4, uParam1, Param2, fParam3, 0, 0);
}

void func_238(var uParam0)//Position - 0xDE39
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_239(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xDE78
{
	if (func_240(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
int func_240(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xDED3
{
	int iVar0;
...
int func_241(var uParam0, int iParam1)//Position - 0xDF61
{
	int iVar0;
...
int func_244(var uParam0)//Position - 0xE0BB
{
	if (func_198(uParam0))
	{
...
int func_245(int iParam0)//Position - 0xE0E5
{
	int iVar0;
...
void func_246(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xE116
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_247(var uParam0)//Position - 0xE152
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh3"))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_239(&(uParam0->f_1C[0]), 58, 566.1639f, -1773.817f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_181(uParam0->f_1C[0]))
			{
				...
				uParam0->f_3B = PED::CREATE_SYNCHRONIZED_SCENE(563.76f, -1773.86f, 28.36f, 0f, 0.05f, -110.7f, 2);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uParam0->f_3B, "rcmjosh3", "sit_stairs_idle", 8f, -8f, 17, 0, 1148846080, 0);
...
{
	func_235(uParam0, iLocal_52, 558.09f, -1765.39f, 28.86f, 335.3252f);
	VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(*uParam0, 4);
...
int func_249(var uParam0)//Position - 0xE380
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmjosh2"))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_239(&(uParam0->f_1C[0]), 58, 565.3901f, -1772.838f, 29.80087f, 62.50156f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_181(uParam0->f_1C[0]))
			{
				...
				uLocal_53 = PED::CREATE_SYNCHRONIZED_SCENE(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_53, 1);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uLocal_53, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_250(var uParam0)//Position - 0xE5A2
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_246(&(uParam0->f_30), "rcmjosh1", "idle", 0);
			iLocal_50 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_239(&(uParam0->f_1C[0]), 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
...
int func_252(int iParam0)//Position - 0xE77D
{
	struct<27> Var0;
	int iVar1;
...
int func_253(int iParam0)//Position - 0xE7D1
{
	char* sVar0;
...
int func_254(int iParam0)//Position - 0xE868
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xE929
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_256(int iParam0, char* sParam1)//Position - 0xE9AE
{
...
bool func_257(int iParam0)//Position - 0xEA90
{
...
bool func_258(int iParam0)//Position - 0xEABE
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_259(int iParam0)//Position - 0xEAEC
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0xEB1A
{
	if (func_225(iParam0))
	{
		return 0;
...
void func_261()//Position - 0xEB4F
{
	func_283("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_262(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xEB69
{
	int iVar0;
...
int func_263(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xEBCE
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_264(Var1.f_6, Param1, fParam2))
	{
...
int func_264(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xEC4B
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_266(char* sParam0)//Position - 0xED45
{
...
void func_267()//Position - 0xED64
{
	Global_38DE = 0;
	func_268();
}

void func_268()//Position - 0xED74
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_269(char* sParam0)//Position - 0xED95
{
	struct<6> Var0;
...
struct<6> func_270()//Position - 0xEDB5
{
	struct<6> Var0;
...
int func_271(var uParam0)//Position - 0xEDD9
{
	if (func_198(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEE0F
{
...
void func_273(var uParam0, bool bParam1)//Position - 0xEE2F
{
	func_274(&(uParam0->f_29), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xEE41
{
	int iVar0;
...
void func_275(var uParam0, bool bParam1)//Position - 0xEE7F
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0xEEBA
{
	func_277(&(uParam0->f_23), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xEECC
{
	int iVar0;
...
void func_278(var uParam0)//Position - 0xEF09
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0xEF40
{
	func_280(&(uParam0->f_1C), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0xEF52
{
	int iVar0;
...
void func_281(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEF93
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_282(var uParam0)//Position - 0xEFE2
{
	if (*uParam0 == -1)
	{
		return;
...
void func_283(char* sParam0)//Position - 0xF01F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_284(var uParam0)//Position - 0xF031
{
	*uParam0 = -1;
...
void func_285()//Position - 0xF064
{
	func_283("Running start routines.");
	Global_17B2F++;
}

int func_286(int iParam0)//Position - 0xF07E
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
