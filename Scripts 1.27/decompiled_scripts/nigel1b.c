...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	uLocal_79 = func_560(64);
	uLocal_80 = func_560(63);
	...
	if (func_519())
	{
		func_467(&iLocal_805, -990.5321f, 342.9136f, 70.4615f, 111.0291f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
		iVar0 = func_466();
		if (Global_84544 == 1)
		{
			iVar0++;
		...
		{
			case 0:
				func_465(Local_800, fLocal_419, 1, 0);
				func_453(0, 0);
				break;
			
			case 1:
				func_465(-1045.017f, 367.3012f, 68.9128f, 103.701f, 1, 0);
				func_453(1, 0);
				break;
			
			case 2:
				func_465(-462.2575f, -156.7884f, 37.0458f, 112.5754f, 1, 0);
				func_453(4, 0);
				break;
	...
	else if (func_452(0))
	{
		...
		{
			func_450(PLAYER::PLAYER_PED_ID(), Local_800, fLocal_419, 0, 0);
	...
	if (func_30(PLAYER::PLAYER_PED_ID()))
	{
		...
		switch (iLocal_95)
		{
			case 0:
				if (iLocal_97 == 1)
				{
					func_21(&(Local_463.f_2));
					func_20(&Local_463);
					if (func_519() && func_466() == 1)
					{
						func_19(Global_89962.f_12[1], 1);
						func_15(Global_89962.f_12[0], 1);
						if (iLocal_534 == 2 && iLocal_537 == 2)
						{
							func_450(Local_420.f_8, -1050.359f, 354.0594f, 68.9132f, 38.0338f, 0, 0);
							Local_420.f_9 = 38;
						}
					...
					if (!func_44())
					{
						func_450(PLAYER::PLAYER_PED_ID(), -1045.017f, 367.3012f, 68.9128f, 103.701f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_356 == 0)
						{
							if (iLocal_96 == 1)
							{
								if (func_451(PLAYER::PLAYER_PED_ID()))
								{
									func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 50f, 13, 5000, 0, 0);
									iLocal_356 = 1;
								}
							}
						}
			...
			case 1:
				if (iLocal_97 == 1)
				{
					...
					if (!func_44())
					{
						func_450(PLAYER::PLAYER_PED_ID(), -462.2575f, -156.7884f, 37.0458f, 112.5754f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						SYSTEM::WAIT(0);
						if (iLocal_356 == 0)
...
void func_4(int iParam0)//Position - 0x547
{
	if (Global_14551)
	{
		func_6(0, 0);
...
void func_6(bool bParam0, bool bParam1)//Position - 0x5DE
{
	if (bParam0)
	{
		if (func_7(0))
...
int func_7(int iParam0)//Position - 0x652
{
	if (iParam0 == 1)
	{
...
void func_9(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x6F6
{
	var uVar0;
	int iVar1;
...
void func_13(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7BA
{
...
void func_14(var uParam0)//Position - 0x809
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
			...
			switch (iLocal_537)
			{
				...
				case 5:
					if (Local_434[iVar0 /*14*/].f_9 != 42 || Local_434[iVar0 /*14*/].f_9 != 43)
					{
						...
						if (func_451(Local_434[iVar0 /*14*/].f_8))
						{
...
void func_20(var uParam0)//Position - 0xB2B
{
...
void func_21(var uParam0)//Position - 0xB44
{
...
void func_24()//Position - 0xBB5
{
	Global_14558 = 0;
	func_25();
}

void func_25()//Position - 0xBC5
{
...
void func_26()//Position - 0xBFC
{
	Global_14558 = 0;
	func_27();
}

void func_27()//Position - 0xC0C
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
...
void func_28()//Position - 0xC2D
{
	Global_14558 = 0;
	func_29();
}

void func_29()//Position - 0xC3D
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
...
int func_30(int iParam0)//Position - 0xC94
{
	if (func_451(iParam0))
	{
...
void func_31(int iParam0, bool bParam1)//Position - 0xCB4
{
...
void func_34(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xDCB
{
	if (bParam0)
	{
	...
	else
	{
		...
		func_40(0, iParam3, iParam2);
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_35(PLAYER::PLAYER_ID()))
		{
...
int func_35(int iParam0)//Position - 0xE9C
{
...
bool func_36()//Position - 0xEDD
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_37(int iParam0, int iParam1)//Position - 0xEEE
{
	bool bVar0;
...
int func_38(int iParam0, bool bParam1)//Position - 0xF39
{
	int iVar0;
	int iVar1;
...
int func_39()//Position - 0xF7A
{
	return Global_1312737;
}

int func_40(int iParam0, var uParam1, var uParam2)//Position - 0xF86
{
	int iVar0;
...
void func_41(int iParam0)//Position - 0xFB7
{
	if (iParam0 == 1)
	{
...
void func_42(int iParam0, int iParam1, int iParam2)//Position - 0xFDA
{
	if (func_519() && func_44())
	{
...
void func_43(int iParam0)//Position - 0x109E
{
	if (iParam0 == 1)
	{
...
void func_45()//Position - 0x10DB
{
	...
	{
		case 0:
			if (func_59("NIGEL1B_MISSION_FAIL", 0))
			{
				HUD::CLEAR_PRINTS();
				HUD::CLEAR_HELP(1);
				func_22(1, 1);
				...
				func_59("NIGEL1B_MISSION_FAIL", 0);
				iLocal_97 = 1;
			}
			break;
...
void func_46(bool bParam0)//Position - 0x11B4
{
	...
	while (iVar0 <= 1)
	{
		if (func_30(Local_434[iVar0 /*14*/].f_8))
		{
	...
	while (iVar0 < 2)
	{
		func_51(&(Local_511[iVar0 /*9*/]), bParam0);
		iVar0++;
	}
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 3)
	{
		func_51(&(Local_483[iVar0 /*9*/]), bParam0);
		iVar0++;
	}
	func_48(&uLocal_803, bParam0);
	if (func_47(iLocal_804))
	{
	...
	func_48(&iLocal_804, bParam0);
	func_48(&iLocal_805, bParam0);
}

int func_47(int iParam0)//Position - 0x12E4
{
	if (func_451(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_48(var uParam0, bool bParam1)//Position - 0x130E
{
	if (bParam1)
	{
		func_50(uParam0);
...
void func_49(var uParam0)//Position - 0x132A
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_50(var uParam0)//Position - 0x1361
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam0))
...
void func_51(int iParam0, bool bParam1)//Position - 0x13FD
{
	if (bParam1)
	{
		func_53(iParam0);
...
void func_52(var uParam0, bool bParam1)//Position - 0x141A
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_53(var uParam0)//Position - 0x1455
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_55(char* sParam0, bool bParam1)//Position - 0x14AD
{
	func_56(sParam0);
	func_543(bParam1);
}

void func_56(char* sParam0)//Position - 0x14C1
{
...
void func_57()//Position - 0x14FF
{
	...
	while (iVar0 <= 1)
	{
		func_58(&(Local_434[iVar0 /*14*/]));
		iVar0++;
	}
	func_58(&Local_420);
}

void func_58(var uParam0)//Position - 0x1534
{
	bool bVar0;
	struct<8> Var1;
...
int func_59(char* sParam0, bool bParam1)//Position - 0x15A2
{
	if (bParam1)
	{
	...
	if (iParam0 == iLocal_401)
	{
		switch (iLocal_401)
		{
			...
			case 2:
				...
				{
					if (func_59("NIGEL1B_COPS_LOST", 0))
					{
						AUDIO::SET_AUDIO_FLAG("AllowScoreAndRadio", 1);
				...
				else if (func_59("NIGEL1B_MISSION_FAIL", 0))
				{
					iLocal_401 = 4;
				}
				break;
...
bool func_67(var uParam0, struct<2> Param1, var uParam3)//Position - 0x18C8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_68(bool bParam0)//Position - 0x1984
{
	if (bParam0)
	{
		Global_15748 = 1;
...
int func_69(int iParam0, bool bParam1)//Position - 0x199C
{
	...
	Var0 = { ENTITY::GET_ENTITY_COORDS(iParam0, 1) };
	if (func_70(iParam0, Local_761, 5.93f))
	{
...
bool func_70(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1AB5
{
...
void func_73(int iParam0, bool bParam1)//Position - 0x1B3B
{
	...
	{
		func_236(&(Global_96440[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), 0, 0);
	...
	func_223(0, 0);
	MemCopy(&uVar1, {func_221(iVar0)}, 4);
	...
	{
		func_75(iParam0, 406.38f, -1635.86f);
	}
	else if (iParam0 == 111)
	{
		func_75(iParam0, 1973.84f, 3814.89f);
	}
	else if (iParam0 != 322)
	{
		func_75(iParam0, 0, 0);
...
void func_75(int iParam0, int iParam1, int iParam2)//Position - 0x1CB2
{
	bool bVar0;
...
void func_76()//Position - 0x1D9A
{
	...
	{
		func_78(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_68245)
		{
			if (func_77() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
int func_77()//Position - 0x225B
{
	return Global_24444;
}

int func_78(int iParam0, int iParam1)//Position - 0x2266
{
	int iVar0;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x22B7
{
	int iVar0;
	int iVar1;
	var uVar2;
...
void func_82()//Position - 0x2589
{
	StringCopy(&Global_68477, "", 16);
	StringCopy(&Global_68481, "", 16);
}

void func_83()//Position - 0x25A1
{
	int iVar0;
...
void func_87(int iParam0)//Position - 0x2673
{
	if (iParam0 == 1)
	{
		Global_35462 = 1;
...
void func_88()//Position - 0x268C
{
	func_89(&Global_93588);
}

void func_89(var uParam0)//Position - 0x269C
{
	int iVar0;
	int iVar1;
...
void func_90(var uParam0)//Position - 0x2BE2
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_91(var uParam0)//Position - 0x2BFD
{
...
void func_92(var uParam0)//Position - 0x2C2C
{
	int iVar0;
...
void func_93(var uParam0)//Position - 0x2CDB
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_94(var uParam0)//Position - 0x2CF9
{
	int iVar0;
...
void func_95(var uParam0)//Position - 0x2DD8
{
	*uParam0 = -15;
}

void func_96()//Position - 0x2DE6
{
	StringCopy(&Global_91343, "", 32);
	func_89(&Global_91351);
}

void func_97()//Position - 0x2DFE
{
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x30F5
{
	int iVar0;
	...
	{
		if (!func_214(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_101(int iParam0)//Position - 0x3181
{
	switch (iParam0)
	{
...
void func_103(int iParam0, int iParam1, int iParam2)//Position - 0x39A9
{
	int iVar0;
	int iVar1;
...
int func_104(int iParam0, int iParam1, int iParam2)//Position - 0x3A33
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_105(int iParam0, int iParam1, int iParam2)//Position - 0x3B11
{
	Global_68106[1 /*14*/] = { func_149(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_106(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3B3B
{
	var uVar0;
	int iVar10;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x4137
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4271
{
	int iVar0;
...
int func_110(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x4578
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x512B
{
	int iVar0;
...
int func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x540F
{
	int iVar0;
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x56D6
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x570D
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, int iParam2)//Position - 0x5736
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_116(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5A00
{
	int iVar0;
...
int func_117(int iParam0, int iParam1, int iParam2)//Position - 0x5C8A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_118(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0x5DE1
{
	if (iParam2 == -1)
	{
...
int func_119(int iParam0, int iParam1, int iParam2)//Position - 0x5E0A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x602D
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_121(int iParam0, int iParam1)//Position - 0x6127
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_122(int iParam0)//Position - 0x64CE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_123(int iParam0, int iParam1, int iParam2)//Position - 0x652F
{
	var uVar0;
	var uVar1;
...
int func_124(int iParam0, int iParam1, int iParam2)//Position - 0x6924
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_125(int iParam0, int iParam1)//Position - 0x6C03
{
	int iVar0;
	int iVar1;
...
int func_126(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C49
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_127(int iParam0, int iParam1)//Position - 0x6D45
{
	int iVar0;
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6E83
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_129(int iParam0)//Position - 0x6F63
{
	switch (iParam0)
	{
		case 0:
...
int func_130(int iParam0, int iParam1)//Position - 0x6FE9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_131(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7049
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_132(int iParam0)//Position - 0x70CD
{
...
void func_133(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x7185
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x71CE
{
	int iVar0;
...
int func_135(var uParam0)//Position - 0x71F9
{
	int iVar0;
	int iVar1;
...
int func_136(int iParam0, int iParam1, int iParam2)//Position - 0x722D
{
	var uVar0;
	var uVar1;
...
bool func_137(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x725F
{
	int iVar0;
...
int func_138(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7900
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_139(int iParam0)//Position - 0x8821
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8872
{
	int iVar0;
	...
	{
		if (!func_214(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_141(int iParam0)//Position - 0x8908
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_142(int iParam0, int iParam1)//Position - 0x89B8
{
	int iVar0;
	struct<10> Var1;
...
void func_143(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x92E7
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_144(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9411
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_145(int iParam0, int iParam1)//Position - 0x9459
{
	int iVar0;
	struct<16> Var1;
...
void func_146(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB29C
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_147(int iParam0)//Position - 0xB44D
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xB4FD
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
struct<14> func_149(int iParam0, int iParam1, int iParam2)//Position - 0xB56E
{
	func_213();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_150(int iParam0, int iParam1)//Position - 0xB5C0
{
	switch (iParam0)
	{
		case 0:
...
void func_151(int iParam0)//Position - 0xB6B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xC8E9
{
	var uVar0;
	int iVar1;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_156(14))
			{
				...
				uVar0 = func_136(func_154(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_136(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
bool func_153(int iParam0, int iParam1, var uParam2)//Position - 0xCC6B
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_154(int iParam0, int iParam1)//Position - 0xD070
{
	switch (iParam1)
	{
		case 0:
...
int func_155(int iParam0, int iParam1)//Position - 0xD46B
{
	switch (iParam1)
	{
		case 0:
...
bool func_156(int iParam0)//Position - 0xD866
{
	return Global_34913 == iParam0;
}

int func_157(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD874
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(int iParam0)//Position - 0xD8B6
{
	switch (iParam0)
	{
		case -1:
...
void func_159(int iParam0, int iParam1, int iParam2)//Position - 0xD98A
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
...
void func_160(int iParam0)//Position - 0xDC04
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0xDD50
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0xE25C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0xE2CF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0xE341
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0xE427
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0xE768
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0xE96F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0xEB8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0xEC96
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0xF627
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1017F
{
	if (iParam0 < 136)
	{
		func_173(iParam0);
	...
	{
		func_159(3, iParam0, 242);
	}
}

void func_172(int iParam0)//Position - 0x101B3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x10DB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x11CB7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x11DE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0, int iParam1)//Position - 0x11ED9
{
	switch (iParam0)
	{
		case 0:
...
void func_177(int iParam0)//Position - 0x11FC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x13495
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x135DB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x13AE4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1414D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x141BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1428E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x14788
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_185(int iParam0)//Position - 0x14918
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x15106
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x1520E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x16130
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189(int iParam0)//Position - 0x16DDC
{
	if (iParam0 < 107)
	{
		func_192(iParam0);
	...
	if (Global_68106[0 /*14*/].f_2 == -1)
	{
		func_159(3, iParam0, 318);
	}
}

void func_190(int iParam0)//Position - 0x16E21
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_191(int iParam0)//Position - 0x178C5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_192(int iParam0)//Position - 0x186B4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_193(int iParam0)//Position - 0x192F3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_194(int iParam0)//Position - 0x1956A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_195(int iParam0, int iParam1)//Position - 0x196A5
{
	switch (iParam0)
	{
		case 0:
...
void func_196(int iParam0)//Position - 0x19795
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_197(int iParam0)//Position - 0x1A4F2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_198(int iParam0)//Position - 0x1A660
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_199(int iParam0)//Position - 0x1ABD0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x1B0F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_201(int iParam0)//Position - 0x1B169
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_202(int iParam0)//Position - 0x1B238
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x1B6E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x1B941
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x1BC00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x1BDBA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0)//Position - 0x1CB1E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x1D74F
{
	if (iParam0 < 60)
	{
		func_210(iParam0);
	...
	if (Global_68106[0 /*14*/].f_2 == -1)
	{
		func_159(3, iParam0, 181);
	}
}

void func_209(int iParam0)//Position - 0x1D783
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x1E516
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_211(int iParam0)//Position - 0x1EB98
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(int iParam0)//Position - 0x1EC7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213()//Position - 0x1ED73
{
...
int func_214(int iParam0, int iParam1, int iParam2)//Position - 0x1EDEB
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_214(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_214(iParam0, 14, uVar21[iVar3]))
							{
								iVar4 = 0;
								while (iVar4 <= 19)
								{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar31 <= 8)
		{
			if (!func_214(iParam0, 14, uVar32[iVar31]))
			{
				return 0;
			}
			iVar31++;
...
int func_215(int iParam0)//Position - 0x1F043
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0x1F080
{
	if (func_217(iParam0))
	{
...
bool func_217(int iParam0)//Position - 0x1F0AA
{
	return iParam0 < 3;
}

void func_218(var uParam0, var uParam1)//Position - 0x1F0B6
{
...
void func_220()//Position - 0x1F156
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_216(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_215(PLAYER::PLAYER_PED_ID());
			if (func_217(iVar0) && (!func_156(14) || Global_96306))
			{
				if (Global_97353.f_1729.f_539.f_3213 != iVar0 && func_217(Global_97353.f_1729.f_539.f_3213))
				{
...
struct<2> func_221(int iParam0)//Position - 0x1F253
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_222(int iParam0)//Position - 0x1F289
{
	struct<2> Var0;
...
void func_223(int iParam0, int iParam1)//Position - 0x1F6D4
{
...
void func_224(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1F71E
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_225(int iParam0, int iParam1, int iParam2)//Position - 0x1F7BB
{
	struct<4> Var0;
	var uVar32;
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&uVar32, {func_222(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar32, 0, Global_89999, 0);
		func_226(&uVar32, Var0.f_3, Global_89999, iParam1, iParam2);
	}
}

void func_226(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x1F7FA
{
...
void func_227(int iParam0, var uParam1)//Position - 0x1F83D
{
	switch (iParam0)
	{
		case 0:
...
int func_229(int iParam0)//Position - 0x20A44
{
	switch (iParam0)
	{
		case 0:
...
void func_230(int iParam0)//Position - 0x20D8A
{
	Global_35464 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_231()//Position - 0x20D9C
{
	if (Global_87679)
	{
		func_220();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_232(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
char* func_232(var uParam0)//Position - 0x20DCD
{
	uParam0 = uParam0;
	return "";
}

void func_233()//Position - 0x20DDB
{
	char cVar0[24];
...
void func_234(int iParam0, int iParam1)//Position - 0x20E1E
{
	Global_87674 = iParam0;
	Global_87675 = iParam1;
}

void func_235()//Position - 0x20E32
{
	if (Global_68499 != 6)
	{
	}
...
void func_236(var uParam0)//Position - 0x20E6A
{
	if (*uParam0 == -1)
	{
		return;
...
void func_237(int iParam0, bool bParam1)//Position - 0x20EA7
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_238(int iParam0)//Position - 0x2102C
{
	switch (iParam0)
	{
		case 0:
...
void func_239(int iParam0)//Position - 0x213B3
{
	func_241(iParam0, 1);
	Global_97353.f_16828[iParam0 /*6*/].f_3 = func_240();
	Global_97353.f_16828.f_380++;
}

int func_240()//Position - 0x213E9
{
	return (Global_97353.f_8270.f_21 + Global_97353.f_16828.f_380);
}

void func_241(var uParam0, bool bParam1)//Position - 0x21405
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_242(int iParam0)//Position - 0x21729
{
...
void func_243(int iParam0)//Position - 0x2175C
{
	switch (iParam0)
	{
		case 30:
...
void func_244(int iParam0, bool bParam1)//Position - 0x21791
{
	if (iParam0 == -1)
	{
		return;
...
void func_245(int iParam0, int iParam1, bool bParam2)//Position - 0x217EE
{
	if (iParam0 == -1)
	{
		return;
...
bool func_246(int iParam0, int iParam1)//Position - 0x21829
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_247(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2184C
{
	if (iParam0 != 198)
	{
		if (Global_68245)
		...
		func_250(iParam0, bParam3, iParam4, 0);
		func_248(iParam0, iParam1);
	}
}

void func_248(int iParam0, int iParam1)//Position - 0x218A7
{
	switch (iParam0)
	{
		case 12:
...
void func_249(int iParam0, bool bParam1)//Position - 0x21990
{
	if (bParam1)
	{
...
bool func_250(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x219B9
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_251()//Position - 0x222C8
{
	if ((func_77() == -1 || func_77() == 999) && !func_252() == 0)
	{
		return 1;
	}
	return 0;
...
int func_252()//Position - 0x222F8
{
	return Global_24445;
}

int func_253(var uParam0, int iParam1)//Position - 0x22303
{
	int iVar0;
...
int func_254(int iParam0)//Position - 0x259FA
{
	switch (iParam0)
	{
		case 46:
...
void func_255(int iParam0, bool bParam1)//Position - 0x25AEC
{
	switch (iParam0)
	{
		case 46:
...
void func_256(int iParam0, bool bParam1)//Position - 0x25B3D
{
	int iVar0;
...
void func_257(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x25BAA
{
	func_258(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_258(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x25BCA
{
	int iVar0;
...
void func_259()//Position - 0x25D9C
{
	int iVar0;
...
int func_260(int iParam0)//Position - 0x25EBC
{
	int iVar0;
	int iVar1;
...
void func_263(int iParam0, int iParam1)//Position - 0x260F5
{
...
int func_264(char* sParam0)//Position - 0x26132
{
	int iVar0;
...
int func_265()//Position - 0x26192
{
	return func_266(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_266(char* sParam0, int iParam1)//Position - 0x261A3
{
	int iVar0;
	var uVar1;
	int iVar33;
...
void func_267()//Position - 0x261EC
{
	...
	switch (iLocal_97)
	{
		case 0:
			...
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				func_283(&uLocal_159, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			}
			func_283(&uLocal_159, 3, 0, "NIGEL", 0, 1);
			func_283(&uLocal_159, 4, 0, "MRSTHORNHILL", 0, 1);
		...
		case 1:
			if (!iLocal_360)
			{
				if (func_282(iLocal_402, 2500))
				{
					if (func_272(&uLocal_159, 64, "NIG1BAU", "NIG1B_OP", 11, 1, 0, 0, 0))
					{
...
bool func_272(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2637D
{
	func_281(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_15740 = 0;
	Global_15699 = 1;
	Global_15706 = 0;
	Global_15701 = 0;
	...
	Global_2621441 = 0;
	return func_273(sParam3, iParam4, bParam8);
}

int func_273(char* sParam0, int iParam1, bool bParam2)//Position - 0x263DC
{
	Global_15693 = 0;
...
void func_274()//Position - 0x266A8
{
	int iVar0;
...
void func_275()//Position - 0x266D8
{
...
void func_277()//Position - 0x26806
{
	if (func_156(14))
	{
...
int func_278()//Position - 0x268A7
{
	func_220();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_279()//Position - 0x268C0
{
	int iVar0;
...
bool func_280(int iParam0, int iParam1)//Position - 0x26916
{
	switch (iParam0)
	{
		case 5:
...
void func_281(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x26951
{
...
bool func_282(int iParam0, int iParam1)//Position - 0x269A7
{
	return (MISC::GET_GAME_TIMER() - iParam0) > iParam1;
}

void func_283(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x269B9
{
...
void func_284()//Position - 0x26A54
{
	...
	if (func_30(Local_420.f_8))
	{
		...
		switch (iLocal_534)
		{
			case 0:
				...
				else if (Local_420.f_9 == 0)
				{
					...
					{
						if (func_70(Local_420.f_8, Local_728, 4f))
						{
							if (!AUDIO::HAS_SOUND_FINISHED(uLocal_395))
							{
								AUDIO::STOP_SOUND(uLocal_395);
					...
					{
						if (func_70(Local_420.f_8, Local_728, 2.5f))
						{
							if (!AUDIO::HAS_SOUND_FINISHED(uLocal_395))
							{
								AUDIO::STOP_SOUND(uLocal_395);
					...
					{
						if (!func_3() && !func_270("NULL"))
						{
							if (func_282(iLocal_404, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
							{
			...
			case 1:
				...
				else
				{
					...
					{
						if ((!func_308("NIG1B_GSP", 1) || func_305(Local_420.f_8, 1082130432)) || func_282(iLocal_409, 1250))
						{
							func_19(2, 1);
						}
					}
			...
			case 3:
				...
				if (!iLocal_332)
				{
					...
					else if (iLocal_536 == 3 || func_70(Local_420.f_8, Local_728, 5f))
					{
						func_22(0, 0);
		...
		{
			func_286(Local_420.f_8, &Local_420, -1, 0, 0, 0, -1082130432, 0);
		}
		else if (!bLocal_366)
		{
			if (iLocal_536 == 0 && !func_70(Local_420.f_8, Local_728, 35f))
			{
				func_58(&Local_420);
			}
			else
	...
	{
		if (func_451(Local_483[0 /*9*/]) && ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(Local_483[0 /*9*/]))
		{
...
void func_285(int iParam0)//Position - 0x2720D
{
	bool bVar0;
	int iVar1;
...
int func_286(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7)//Position - 0x2727E
{
	if (iParam3 == 0)
	{
	...
	if (func_30(Local_420.f_8))
	{
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_420.f_9)
			{
				...
				case 32:
					if (func_451(Local_483[0 /*9*/]) && ENTITY::IS_ENTITY_ATTACHED_TO_ENTITY(Local_483[0 /*9*/], Local_420.f_8))
					{
						ENTITY::DETACH_ENTITY(Local_483[0 /*9*/], 1, 1);
					}
					...
					if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_420.f_8, "rcmnigel1b", "idle_gardener", 3))
					{
						...
						else if (func_292(Local_420.f_8, 1785177548))
						{
				...
				case 33:
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_420.f_8, "rcmnigel1b", "exit_gardener", 3))
					{
						...
						{
							if (!func_292(Local_420.f_8, -875674219))
							{
				...
				case 35:
					if (!func_292(Local_420.f_8, -2017877118))
					{
						if (!PED::IS_PED_FACING_PED(Local_420.f_8, PLAYER::PLAYER_PED_ID(), 45f))
						{
							if (!func_292(Local_420.f_8, -875674219))
						...
						else if (func_282(Local_420.f_11, MISC::GET_RANDOM_INT_IN_RANGE(2000, 4000)))
						{
				...
				case 39:
					if (!func_292(Local_420.f_8, 242628503))
					{
						Local_420.f_9 = 38;
					}
					else if (func_451(Local_434[0 /*14*/].f_8))
					{
						if (!func_292(Local_420.f_8, 150319005))
						{
				...
				case 43:
					if (!PED::IS_PED_RAGDOLL(Local_420.f_8))
					{
						if (!func_292(Local_420.f_8, 474215631) && !func_292(Local_420.f_8, -1519143300))
						{
							if (((!ENTITY::IS_ENTITY_IN_WATER(Local_420.f_8) && !func_70(Local_420.f_8, Local_752, fLocal_383)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_420.f_8, Local_755, Local_758, fLocal_384, 0, 1, 0)) && !PED::IS_PED_CLIMBING(Local_420.f_8))
							{
								PED::SET_PED_COWER_HASH(Local_420.f_8, "CODE_HUMAN_STAND_COWER");
								TASK::TASK_COWER(Local_420.f_8, -1);
							}
							else if (!func_292(Local_420.f_8, 713668775))
							{
								TASK::CLEAR_PED_TASKS(Local_420.f_8);
								Var0 = { Local_745[0 /*3*/] };
								fVar3 = 201.7237f;
								if (func_290(Local_728, Var0, 1.5f))
								{
									Var0 = { Local_745[1 /*3*/] };
									fVar3 = 325.0476f;
								}
				...
				case 45:
					...
					else
					{
						...
						{
							if (!func_292(Local_420.f_8, -1519143300))
							{
								TASK::TASK_HANDS_UP(Local_420.f_8, -1, PLAYER::PLAYER_PED_ID(), -1, 0);
								PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_420.f_8, 1);
							}
				...
				case 46:
					if ((((ENTITY::IS_ENTITY_IN_WATER(Local_420.f_8) || func_70(Local_420.f_8, Local_752, fLocal_383)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_420.f_8, Local_755, Local_758, fLocal_384, 0, 1, 0)) || PED::IS_PED_CLIMBING(Local_420.f_8)) || PED::IS_PED_RAGDOLL(Local_420.f_8))
					{
						Local_420.f_9 = 44;
					}
					else
				...
				case 47:
					if (!PED::IS_PED_RAGDOLL(Local_420.f_8))
					{
						if (!func_292(Local_420.f_8, 474215631))
						{
							Local_420.f_9 = 46;
						}
				...
				case 50:
					if (!func_292(Local_420.f_8, 1805844857) && !func_292(Local_420.f_8, 2112745624))
					{
						Local_420.f_9 = 49;
					}
					break;
...
int func_288(int iParam0, bool bParam1)//Position - 0x27ED9
{
	...
	if (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
	{
		...
		{
			fVar0 = 40f;
			if (func_70(iParam0, Local_728, fVar0))
			{
...
bool func_290(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x280E4
{
...
int func_292(int iParam0, int iParam1)//Position - 0x28195
{
	if (func_30(iParam0))
	{
...
bool func_293(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x281C8
{
	...
	uVar0 = func_294(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_294(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x28289
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_295(int iParam0, int iParam1)//Position - 0x283B5
{
	int iVar0;
...
int func_297(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x284C4
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_299(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var3 = { func_299(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_298(struct<3> Param0, struct<3> Param3)//Position - 0x28555
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_299(struct<3> Param0)//Position - 0x28576
{
	float fVar0;
	float fVar1;
...
void func_300(var uParam0)//Position - 0x285B5
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
struct<6> func_304()//Position - 0x28683
{
	struct<6> Var0;
	int iVar6;
...
int func_305(int iParam0, float fParam1)//Position - 0x286C9
{
	if (func_30(iParam0))
	{
		...
		if (func_307(PLAYER::PLAYER_PED_ID(), iParam0, fParam1))
		{
...
bool func_307(int iParam0, int iParam1, float fParam2)//Position - 0x28756
{
...
struct<6> func_309()//Position - 0x287BE
{
	struct<6> Var0;
...
{
	func_281(uParam0, 145, sParam1, iParam4, iParam5, uParam6);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
	...
	Global_16689 = 0;
	Global_2621441 = 0;
	return func_273(sParam2, iParam3, 0);
}
...
int func_313(bool bParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x288BB
{
	...
	if (bParam3)
	{
		...
		{
			if (func_70(Local_420.f_8, Local_728, 7f))
			{
				return 1;
			}
		}
	...
	if (bParam2)
	{
		if (iLocal_535 == 4)
		{
			if (func_70(Local_420.f_8, Local_728, 3.5f))
			{
				return 1;
			}
		}
...
bool func_314(int iParam0, int iParam1)//Position - 0x289B6
{
...
void func_321()//Position - 0x28C34
{
	...
	{
		case 0:
			if ((iLocal_534 == 2 && func_30(Local_420.f_8)) && func_69(Local_420.f_8, 1))
			{
				iLocal_399 = MISC::GET_GAME_TIMER();
				func_15(2, 1);
			}
			else
			{
				...
				if (iLocal_536 == 2)
				{
					...
					else if (!func_308("NIG1B_IDLE", 1))
					{
						if (iLocal_354)
						{
							if (func_282(iLocal_400, 150000000))
							{
							}
						}
					}
		...
		case 2:
			if (iLocal_536 == 2)
			{
				if (!iLocal_346)
				{
					if (!func_282(iLocal_408, 2000))
					{
						if (func_282(iLocal_408, 500))
						{
							func_22(0, 0);
					...
					else if ((iLocal_534 == 2 && func_30(Local_420.f_8)) && func_69(Local_420.f_8, 1))
					{
						if (!bLocal_329)
						{
							func_22(0, 0);
		...
		case 4:
			...
			else
			{
				...
				else
				{
					...
					{
						if (func_282(iLocal_406, 3000))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 10) < 5)
							{
								if (func_30(Local_434[0 /*14*/].f_8))
								{
			...
			else
			{
				if (!bLocal_362)
				{
					if (!iLocal_347)
					{
						...
						else if (func_30(Local_434[1 /*14*/].f_8) && func_70(Local_434[1 /*14*/].f_8, Local_728, 50f))
						{
		...
		case 6:
			...
			else if (func_282(iLocal_405, 3000))
			{
...
void func_322(int iParam0)//Position - 0x29A33
{
	...
	if (func_30(Local_434[iParam0 /*14*/].f_8))
	{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_434[iParam0 /*14*/].f_9)
			{
				case 0:
					if (iParam0 == 0)
					{
						if (!func_292(Local_434[iParam0 /*14*/].f_8, -982327190))
						{
				...
				case 2:
					if (iParam0 == 0)
					{
						if (!func_292(Local_434[iParam0 /*14*/].f_8, 242628503))
						{
				...
				case 6:
					if (iParam0 == 0)
					{
						if (func_451(Local_434[1 /*14*/].f_8))
						{
							if (iLocal_386 == 1)
							{
								iVar2 = 0;
				...
				case 7:
					if (iParam0 == 0)
					{
						...
						if (func_451(Local_434[1 /*14*/].f_8))
						{
							if (!func_292(Local_434[iParam0 /*14*/].f_8, 242628503))
							{
								if (func_70(Local_434[iParam0 /*14*/].f_8, Local_712[iVar3 /*3*/], 2.5f))
								{
				...
				case 9:
					if (iParam0 == 0)
					{
						...
						if (func_70(Local_434[iParam0 /*14*/].f_8, Local_738[iVar5 /*3*/], fLocal_382))
						{
							if (func_292(Local_434[iParam0 /*14*/].f_8, 242628503))
							{
						...
						else if (!func_292(Local_434[iParam0 /*14*/].f_8, 242628503))
						{
							if (((!ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8) && !func_70(Local_434[iParam0 /*14*/].f_8, Local_752, fLocal_383)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0)) && !PED::IS_PED_CLIMBING(Local_434[iParam0 /*14*/].f_8))
							{
								TASK::CLEAR_PED_TASKS_IMMEDIATELY(Local_434[iParam0 /*14*/].f_8);
								Local_434[iParam0 /*14*/].f_9 = 10;
							}
				...
				case 15:
					if (iParam0 == 0)
					{
						if (!func_292(Local_434[iParam0 /*14*/].f_8, 242628503))
						{
							...
							if (func_70(Local_434[iParam0 /*14*/].f_8, Var13, 1f))
							{
				...
				case 17:
					if (iParam0 == 0)
					{
						if (func_292(Local_434[iParam0 /*14*/].f_8, -2017877118))
						{
							Local_434[iParam0 /*14*/].f_9 = 18;
						}
						else
				...
				case 22:
					if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(iLocal_410[3]) && !func_292(Local_434[iParam0 /*14*/].f_8, 1785177548))
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_541);
				...
				case 23:
					if (func_70(Local_434[iParam0 /*14*/].f_8, Local_709, 1.25f))
					{
						iLocal_358 = 1;
					}
					else if (!func_292(Local_434[iParam0 /*14*/].f_8, 242628503))
				...
				case 26:
					if ((ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8) || func_70(Local_434[iParam0 /*14*/].f_8, Local_752, fLocal_383)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0))
					{
						TASK::CLEAR_PED_TASKS(Local_434[iParam0 /*14*/].f_8);
						Var16 = { Local_745[0 /*3*/] };
						fVar19 = 201.7237f;
						if (func_290(Local_728, Var16, 2.5f))
						{
							Var16 = { Local_745[1 /*3*/] };
							fVar19 = 325.0476f;
						}
				...
				case 27:
					if (!func_292(Local_434[iParam0 /*14*/].f_8, 713668775))
					{
						Local_434[iParam0 /*14*/].f_9 = 26;
					}
					else if (!ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8))
					{
						if (!func_70(Local_434[iParam0 /*14*/].f_8, Local_752, fLocal_383))
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0))
							{
								...
								{
									if (!func_70(Local_434[iParam0 /*14*/].f_8, -1057.136f, 369.1722f, 69.18319f, 1.25f))
									{
										if (!func_70(Local_434[iParam0 /*14*/].f_8, -1057.108f, 354.7688f, 69.19383f, 1.25f))
										{
				...
				case 33:
					if (!func_292(Local_434[iParam0 /*14*/].f_8, -2017877118))
					{
						...
						{
							if (!func_292(Local_434[iParam0 /*14*/].f_8, -875674219))
							{
								Local_434[iParam0 /*14*/].f_9 = 32;
							}
						}
						else if ((func_282(Local_434[iParam0 /*14*/].f_11, MISC::GET_RANDOM_INT_IN_RANGE(750, 3000)) && !ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8)) && !ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0))
						{
							if (iParam0 == 1)
							{
				...
				case 36:
					if (func_451(Local_420.f_8) && iLocal_537 == 2)
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_434[iParam0 /*14*/].f_8, "rcmnigel1b", "wipehead", 3))
						{
							TASK::STOP_ANIM_TASK(Local_434[iParam0 /*14*/].f_8, "rcmnigel1b", "wipehead", -4f);
				...
				case 43:
					if (!PED::IS_PED_RAGDOLL(Local_434[iParam0 /*14*/].f_8))
					{
						if (!func_292(Local_434[iParam0 /*14*/].f_8, 474215631) && !func_292(Local_434[iParam0 /*14*/].f_8, -1519143300))
						{
							if ((ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8) || func_70(Local_434[iParam0 /*14*/].f_8, Local_752, fLocal_383)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0))
							{
								if (!func_292(Local_434[iParam0 /*14*/].f_8, 713668775))
								{
									...
									Var24 = { Local_745[0 /*3*/] };
									fVar27 = 201.7237f;
									if (func_290(Local_728, Var24, 1.5f))
									{
										Var24 = { Local_745[1 /*3*/] };
										fVar27 = 325.0476f;
									}
						...
						if ((!PED::IS_PED_RAGDOLL(Local_434[iParam0 /*14*/].f_8) && !TASK::IS_PED_GETTING_UP(Local_434[iParam0 /*14*/].f_8)) && !PED::IS_PED_CLIMBING(Local_434[iParam0 /*14*/].f_8))
						{
							if ((((ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0)) || func_70(Local_434[iParam0 /*14*/].f_8, -1057.136f, 369.1722f, 69.18319f, 1.25f)) || func_70(Local_434[iParam0 /*14*/].f_8, -1057.108f, 354.7688f, 69.19383f, 1.25f)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, -1051.34f, 358.4045f, 66.91455f, -1051.362f, 365.5106f, 71.91416f, 2.25f, 0, 1, 0))
							{
								if (!func_292(Local_434[iParam0 /*14*/].f_8, 713668775))
								{
									...
									Var28 = { Local_745[0 /*3*/] };
									fVar31 = 201.7237f;
									if (func_290(Local_728, Var28, 1.5f))
									{
										Var28 = { Local_745[1 /*3*/] };
										fVar31 = 325.0476f;
									}
				...
				case 45:
					if (!func_292(Local_434[iParam0 /*14*/].f_8, 713668775))
					{
						if (!func_292(Local_434[iParam0 /*14*/].f_8, -1519143300))
						{
				...
				case 46:
					if ((((ENTITY::IS_ENTITY_IN_WATER(Local_434[iParam0 /*14*/].f_8) || func_70(Local_434[iParam0 /*14*/].f_8, Local_752, fLocal_383)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_434[iParam0 /*14*/].f_8, Local_755, Local_758, fLocal_384, 0, 1, 0)) || PED::IS_PED_CLIMBING(Local_434[iParam0 /*14*/].f_8)) || PED::IS_PED_RAGDOLL(Local_434[iParam0 /*14*/].f_8))
					{
						Local_434[iParam0 /*14*/].f_9 = 44;
					}
					else
				...
				case 47:
					if (!PED::IS_PED_RAGDOLL(Local_434[iParam0 /*14*/].f_8))
					{
						if (!func_292(Local_434[iParam0 /*14*/].f_8, 474215631))
						{
				...
				case 50:
					if (!func_292(Local_434[iParam0 /*14*/].f_8, 1805844857) && !func_292(Local_434[iParam0 /*14*/].f_8, 2112745624))
					{
						Local_434[iParam0 /*14*/].f_9 = 49;
					}
					break;
		...
		{
			func_58(&(Local_434[iParam0 /*14*/]));
		}
		else if (iLocal_95 == 0)
		{
			func_286(Local_434[iParam0 /*14*/].f_8, &(Local_434[iParam0 /*14*/]), -1, 0, 0, 0, -1082130432, 0);
		}
		else if (iLocal_537 == 0 || iLocal_537 == 1)
		{
			if (iLocal_536 == 0 && !func_70(Local_434[iParam0 /*14*/].f_8, Local_728, 35f))
			{
				func_58(&(Local_434[iParam0 /*14*/]));
			}
			else
	...
	else
	{
		if (Local_434[iParam0 /*14*/].f_9 != 51)
		{
			if (iParam0 == 0)
			{
				if (!MISC::IS_BIT_SET(Global_97353.f_16828.f_382, 3))
				{
					MISC::SET_BIT(&(Global_97353.f_16828.f_382), 3);
				}
				RECORDING::_0x293220DA1B46CEBC(2.5f, 2f, 0);
			}
...
int func_323(int iParam0)//Position - 0x2B716
{
	if (iParam0 == 0)
	{
		if (func_30(Local_434[0 /*14*/].f_8))
		{
			...
			{
				if (!func_292(Local_434[iParam0 /*14*/].f_8, 1785177548))
				{
					return 1;
				}
			}
	...
	{
		if (func_30(Local_434[1 /*14*/].f_8))
		{
			if (!iLocal_367[1])
			{
				if (func_292(Local_434[1 /*14*/].f_8, 1785177548))
				{
					func_325(5);
				}
				iLocal_367[1] = 1;
...
var func_327(var uParam0)//Position - 0x2BAFA
{
	return uParam0;
}
...
int func_329(struct<3> Param0, float fParam3)//Position - 0x2BBD2
{
	...
	if (func_30(Local_434[iVar0 /*14*/].f_8))
	{
		...
		else if (func_70(Local_434[iVar0 /*14*/].f_8, Param0, fParam3))
		{
			return iVar0;
		}
	}
...
{
	if (func_30(Local_434[0 /*14*/].f_8) && func_30(Local_434[1 /*14*/].f_8))
	{
		if (!func_308(&Local_691, 1))
		{
			if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
			...
			else if (func_282(iLocal_396, MISC::GET_RANDOM_INT_IN_RANGE(2000, 4000)))
			{
				if (iLocal_536 == 2)
				{
					switch (iLocal_385)
...
bool func_335(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2C1CB
{
	func_281(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
		if (iParam4 < 12)
		{
	...
	Global_2621441 = 0;
	return func_273(sParam2, iParam4, 0);
}
...
int func_339(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0x2C3BD
{
	...
	if (bParam4)
	{
		if (iLocal_535 == 2 || iLocal_535 == 3)
		{
			if (func_70(iParam0, Local_728, 7f))
			{
				return 1;
			}
		}
	...
	if (bParam3)
	{
		if (iLocal_535 == 4)
		{
			if (func_70(iParam0, Local_728, 3.5f))
			{
				return 1;
			}
		}
...
struct<6> func_340()//Position - 0x2C499
{
	struct<6> Var0;
	int iVar6;
	int iVar7;
...
int func_341(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2C545
{
	...
	if (func_342(uParam0, sParam1, sParam2, sParam3, iParam4, iParam5, iParam6))
	{
		if (bVar0)
		{
			iLocal_539 = 3;
...
bool func_342(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2C59D
{
	func_281(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
	...
	if (Local_434[0 /*14*/].f_9 == 0)
	{
		if (func_30(Local_434[0 /*14*/].f_8))
		{
			...
			else if (iLocal_386 == 1)
			{
				...
				fVar3 = 3f;
				if (func_344(Local_728, Var0, fVar3))
				{
					iLocal_386 = 0;
...
bool func_344(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2C705
{
	struct<3> Var0;
...
void func_347()//Position - 0x2C7B4
{
	if (iLocal_95 >= 1)
	{
		if (iLocal_401 > 0 && iLocal_401 < 4)
		{
			...
			else if (func_282(iLocal_403, 5000))
			{
				AUDIO::SET_AUDIO_FLAG("AllowScoreAndRadio", 0);
				iLocal_401 = 4;
			}
		...
		case 1:
			...
			else if (bLocal_324)
			{
				...
				else if (!iLocal_327)
				{
					if (!func_3() && !func_270("NULL"))
					{
						if (!func_353("NIG1B_OBJ_04", 0, 0))
						{
							func_352("NIG1B_OBJ_04", 7500, 0);
							func_351();
							iLocal_327 = 1;
						}
					}
...
void func_350(var uParam0, int iParam1)//Position - 0x2CB30
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
{
	if ((MISC::GET_PROFILE_SETTING(203) != 0 && iLocal_539 != 1) && func_3())
	{
		iLocal_539 = 1;
	}
}

void func_352(char* sParam0, int iParam1, int iParam2)//Position - 0x2CB7A
{
	iParam2 = iParam2;
...
bool func_353(char* sParam0, int iParam1, int iParam2)//Position - 0x2CB93
{
...
int func_357(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2CE1F
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_360()//Position - 0x2CF06
{
	...
	switch (iLocal_97)
	{
		...
		case 1:
			...
			{
				if (!(MISC::ARE_STRINGS_EQUAL(sLocal_542, "NIG1B_DDG") && !func_30(Local_420.f_8)))
				{
					if (!func_333())
					{
						func_332();
		...
		case 2:
			...
			else if (MISC::ARE_STRINGS_EQUAL(sLocal_542, "NIG1B_DS") || (MISC::ARE_STRINGS_EQUAL(sLocal_542, "NIG1B_DDG") && !func_30(Local_420.f_8)))
			{
				func_350(&uLocal_159, 4);
				func_271(3);
			}
...
void func_361()//Position - 0x2D0CC
{
	...
	switch (iLocal_97)
	{
		...
		case 1:
			if (!func_290(Local_728, Local_719, 70f) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				iLocal_97 = 2;
			}
			break;
...
void func_362()//Position - 0x2D1AD
{
	...
	switch (iLocal_97)
	{
		case 0:
			...
			if (func_451(Local_420.f_8))
			{
				func_283(&uLocal_159, 4, Local_420.f_8, "Nigel1BGardener01", 0, 1);
			}
			if (func_451(Local_434[0 /*14*/].f_8))
			{
				func_283(&uLocal_159, 5, Local_434[0 /*14*/].f_8, "Nigel1BCelebMale01", 0, 1);
			}
			if (func_451(Local_434[1 /*14*/].f_8))
			{
				func_283(&uLocal_159, 6, Local_434[1 /*14*/].f_8, "Nigel1BCelebFemale01", 0, 1);
			}
			RECORDING::_0x293220DA1B46CEBC(3f, 10f, 1);
			func_352("NIG1B_OBJ_01", 7500, 0);
			func_351();
		...
		case 2:
			...
			func_363(1, "Leave the area", 1, 0, 0, 1);
			Global_89962.f_12[1] = iLocal_534;
			Global_89962.f_12[0] = iLocal_537;
			if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				iLocal_345 = 1;
				func_271(5);
...
void func_363(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D406
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_266(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_419(&(Global_89962.f_3));
				if (iVar10 > -1)
				{
...
void func_364(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2D57A
{
	func_365(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}

void func_365(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2D596
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_278();
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		func_394(&(uParam0->f_2161), 0);
		func_393(PLAYER::PLAYER_PED_ID());
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_386())
		{
			func_382(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_367(&(uParam0->f_2167), uParam0, iParam5, 1, 1, 0);
	}
	func_366(&(uParam0->f_2233));
	uParam3 = uParam3;
	uParam2 = uParam2;
}

int func_366(var uParam0)//Position - 0x2E41A
{
...
void func_367(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2E43C
{
	int iVar0;
...
int func_368(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2E4C3
{
...
int func_369(int iParam0)//Position - 0x2E503
{
	int iVar0;
...
void func_370(var uParam0, int iParam1, int iParam2)//Position - 0x2E531
{
	func_376(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_373(iParam1, 145, 0);
	uParam0->f_11 = func_372(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
...
int func_371(int iParam0)//Position - 0x2E60D
{
	int iVar0;
...
int func_372(int iParam0)//Position - 0x2E64F
{
	int iVar0;
...
int func_373(int iParam0, int iParam1, int iParam2)//Position - 0x2E6B2
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			if (Global_87698[iVar0] == iParam0)
			{
				...
				{
					if (iParam2 == 0 || ENTITY::GET_ENTITY_MODEL(iParam0) == func_374(iParam1, iParam2))
					{
						return 1;
					}
				}
...
int func_374(int iParam0, int iParam1)//Position - 0x2E740
{
	struct<58> Var0;
...
void func_375(int iParam0, var uParam1, int iParam2)//Position - 0x2E782
{
	int iVar0;
	struct<74> Var1;
...
void func_376(int iParam0, var uParam1)//Position - 0x2E9FA
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_377(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_377(int iParam0)//Position - 0x2ECA6
{
	switch (iParam0)
	{
		case 1:
...
int func_378(int iParam0, var uParam1, var uParam2)//Position - 0x2ED56
{
	int iVar0;
	int iVar1;
...
int func_379(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2EE30
{
	char* sVar0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(*uParam1))
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(*uParam1, 0))
				{
					if (iParam2 == 0 || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(*uParam1, 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 100f)
					{
						...
						if (func_380(*uParam1, func_278(), 1))
						{
...
int func_380(int iParam0, int iParam1, bool bParam2)//Position - 0x2EF5D
{
	int iVar0;
	char* sVar1;
	int iVar9;
	...
	iVar0 = 0;
	while (func_381(iParam1, iVar0, &sVar1, &iVar9))
	{
...
int func_381(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2EFCE
{
...
void func_382(int iParam0, var uParam1, int iParam2)//Position - 0x2F0A5
{
	int iVar0;
	int iVar1;
...
int func_383(int iParam0, int iParam1)//Position - 0x2F24F
{
	var uVar0;
	var uVar1;
...
void func_384(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2F27B
{
	int iVar0;
...
void func_385(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2F7C3
{
	int iVar0;
...
int func_386()//Position - 0x2FA04
{
	func_220();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_387(int iParam0, bool bParam1)//Position - 0x2FA1D
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = func_215(iParam0);
	if (func_217(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_388(iParam0, &(Global_97353.f_1729.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_388(int iParam0, var uParam1)//Position - 0x2FB10
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4.x = WEAPON::GET_PED_WEAPONTYPE_IN_SLOT(iParam0, func_392(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_389(Var9.f_1)) && iVar70 < 50)
			{
...
int func_389(int iParam0)//Position - 0x2FD74
{
...
int func_390(int iParam0, int iParam1)//Position - 0x2FE9A
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_391(int iParam0, var uParam1)//Position - 0x306B6
{
	int iVar0;
	int iVar1;
...
int func_392(int iParam0)//Position - 0x306F1
{
	int iVar0;
...
void func_393(int iParam0)//Position - 0x30965
{
	int iVar0;
...
void func_394(var uParam0, int iParam1)//Position - 0x309A1
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_395(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x30EFC
{
	int iVar0;
	int iVar1;
...
bool func_396(int iParam0, var uParam1, var uParam2)//Position - 0x30F40
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
	...
	return !func_397(*uParam1, 0f, 0f, 0f);
}

bool func_397(struct<3> Param0, struct<3> Param3)//Position - 0x31596
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_398(var uParam0)//Position - 0x315BF
{
...
bool func_399(int iParam0)//Position - 0x31618
{
	return func_400(iParam0, 0, 1);
}

int func_400(int iParam0, int iParam1, bool bParam2)//Position - 0x31628
{
	if (bParam2)
	{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_77() == 0)
		{
			return MISC::IS_BIT_SET(func_136(func_401(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_401(int iParam0)//Position - 0x31688
{
	switch (iParam0)
	{
		case 0:
...
int func_402(int iParam0)//Position - 0x31931
{
	return func_400(iParam0, 5, 1);
}

int func_403(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x31941
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_404(int iParam0)//Position - 0x319D8
{
	switch (iParam0)
	{
		case -1:
...
int func_405(int iParam0)//Position - 0x31EA9
{
	return func_400(iParam0, 0, 0);
}

int func_406(int iParam0)//Position - 0x31EB9
{
	switch (iParam0)
	{
		case -1:
...
bool func_407()//Position - 0x32112
{
	return Global_90014.f_290 > 0;
}

var func_408()//Position - 0x32123
{
	var uVar0;
...
void func_409(var uParam0, int iParam1)//Position - 0x32169
{
	if (iParam1 <= 0)
	{
		return;
...
void func_410(var uParam0, int iParam1)//Position - 0x321EF
{
...
void func_411(var uParam0, int iParam1)//Position - 0x32222
{
	int iVar0;
	int iVar1;
...
int func_412(int iParam0, int iParam1)//Position - 0x32273
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_413(var uParam0)//Position - 0x32315
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_414(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_414(bool bParam0, int iParam1, int iParam2)//Position - 0x3233A
{
	if (bParam0)
	{
		return iParam1;
...
int func_415(var uParam0)//Position - 0x32351
{
	return uParam0 & 15;
}

void func_416(var uParam0, int iParam1)//Position - 0x3235E
{
...
void func_417(var uParam0, int iParam1)//Position - 0x32398
{
...
void func_418(var uParam0, int iParam1)//Position - 0x323D3
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_419(char* sParam0)//Position - 0x3240F
{
...
int func_420(int iParam0)//Position - 0x32465
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_421(Global_97353.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_421(Global_97353.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_421(Global_97353.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_421(Global_97353.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_421(Global_97353.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}

int func_421(int iParam0)//Position - 0x32521
{
	switch (iParam0)
	{
		case 1:
...
int func_422(char* sParam0, bool bParam1)//Position - 0x32575
{
	int iVar0;
	int iVar1;
...
int func_423(int iParam0, bool bParam1)//Position - 0x3259F
{
	int iVar0;
...
void func_424(bool bParam0)//Position - 0x325D5
{
	int iVar0;
	int iVar1;
...
void func_425()//Position - 0x32857
{
	if (!HUD::DOES_BLIP_EXIST(Local_463.f_2))
	{
		...
		{
			Local_463.f_2 = func_426(Local_463);
		}
	}
	if (HUD::DOES_BLIP_EXIST(Local_463.f_2))
	{
...
int func_426(var uParam0)//Position - 0x3289B
{
	var uVar0;
	...
	HUD::SET_BLIP_SCALE(uVar0, func_427(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
	return uVar0;
}

float func_427(bool bParam0, float fParam1, float fParam2)//Position - 0x328D3
{
	if (bParam0)
	{
		return fParam1;
...
void func_428()//Position - 0x328EA
{
	...
	if (!func_7(0) && !PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
	{
		if (!iLocal_352)
		{
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1056.143f, 382.9233f, 67.74586f, -1054.965f, 382.899f, 70.98839f, 1.2f, 0, 1, 0))
			{
				if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
				{
					if (func_430(5))
					{
						...
						{
							if (func_429(PLAYER::PLAYER_PED_ID(), 87.9952f, 90f))
							{
								if (!MISC::IS_AREA_OCCUPIED(-1056.172f, 382.1909f, 68.08848f, -1054.682f, 383.8394f, 70.969f, 0, 1, 0, 0, 0, 0, 0))
								{
									...
									{
										if (!func_292(PLAYER::PLAYER_PED_ID(), 242628503))
										{
											TASK::OPEN_SEQUENCE_TASK(&uLocal_541);
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1040.537f, 383.5369f, 67.96313f, -1041.792f, 383.5614f, 70.99346f, 1.2f, 0, 1, 0))
			{
				if (PED::IS_PED_ON_FOOT(PLAYER::PLAYER_PED_ID()))
				{
					if (func_430(4))
					{
						if ((!PED::IS_PED_CLIMBING(PLAYER::PLAYER_PED_ID()) && !PED::IS_PED_JUMPING(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
						{
							if (func_429(PLAYER::PLAYER_PED_ID(), 277.6446f, 90f))
							{
...
int func_429(int iParam0, float fParam1, float fParam2)//Position - 0x32D64
{
	float fVar0;
	float fVar1;
...
void func_433()//Position - 0x32E7E
{
}
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_436(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_435(var uParam0)//Position - 0x3316B
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(uParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_436(int iParam0, int iParam1, int iParam2)//Position - 0x3317E
{
	struct<2> Var0;
	int iVar2;
...
char* func_437(int iParam0)//Position - 0x33253
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_438(int iParam0)//Position - 0x333A6
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_439(int iParam0)//Position - 0x333D8
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_440(int iParam0)//Position - 0x3340A
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_441(int iParam0)//Position - 0x3343C
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_442(int iParam0)//Position - 0x3346E
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_443(int iParam0)//Position - 0x334AA
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_444(int iParam0)//Position - 0x334DC
{
	struct<2> Var0;
...
int func_445(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x33545
{
	if (((!func_447(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_7(0)) || func_446(1))
			{
			}
			else
			{
...
bool func_446(bool bParam0)//Position - 0x3365D
{
	if (bParam0)
	{
...
int func_447(int iParam0)//Position - 0x33686
{
	if (Global_34913 == 15)
	{
		return 0;
...
bool func_448(int iParam0)//Position - 0x336A8
{
	return func_449(iParam0, Global_34913);
}

int func_449(int iParam0, int iParam1)//Position - 0x336B9
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_450(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x3389A
{
	if (func_451(iParam0))
	{
		if (bParam5)
...
int func_451(int iParam0)//Position - 0x338DC
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
bool func_452(bool bParam0)//Position - 0x338FC
{
...
void func_453(int iParam0, bool bParam1)//Position - 0x33927
{
	...
	if (!func_44())
	{
		if (iLocal_96 == 0)
		{
			if (func_451(PLAYER::PLAYER_PED_ID()))
			{
				func_450(PLAYER::PLAYER_PED_ID(), Local_800, fLocal_419, 1, 1);
				CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
				CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
				func_9(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), 50f, 13, 5000, 0, 0);
				iLocal_356 = 1;
...
{
	func_455(1, 0);
	while (!func_59("NIGEL1B_MISSION_FAIL", 0))
	{
		SYSTEM::WAIT(0);
	}
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
...
void func_455(bool bParam0, bool bParam1)//Position - 0x33A57
{
	...
	func_350(&uLocal_159, 2);
	func_350(&uLocal_159, 3);
	func_350(&uLocal_159, 4);
	func_350(&uLocal_159, 5);
	func_350(&uLocal_159, 6);
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), true, 0);
	}
...
void func_459(bool bParam0)//Position - 0x33D55
{
	if (bParam0)
	{
		func_460();
...
void func_460()//Position - 0x33DB8
{
...
void func_462(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x33E14
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(iVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_463(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
Vector3 func_463(var uParam0)//Position - 0x33FCA
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_464(bool bParam0)//Position - 0x33FDD
{
	int iVar0;
...
void func_465(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3401B
{
	if (func_519())
	{
...
void func_467(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x340DA
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_515(iParam6, iParam7, iParam8))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_502(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_397(Param1, 0f, 0f, 0f))
		{
...
int func_468(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x34262
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_492(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_492(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, Param2, fParam5, 1, 1);
				...
				func_492(iParam0, &(Var5.f_31), &(Var5.f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 1)
				{
...
void func_469(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x35048
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_217(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_473(*iParam1, 0, &uVar0))
		{
			func_378(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_472(*iParam1);
				...
				func_470(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_470(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_470(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x35C27
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_471(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x35C9A
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_472(int iParam0)//Position - 0x371DD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_473(int iParam0, bool bParam1, var uParam2)//Position - 0x3729B
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_475(iVar0, bParam1, uParam2))
	{
		return 0;
	}
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_474(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_474(int iParam0)//Position - 0x3733D
{
	int iVar0;
...
int func_475(int iParam0, bool bParam1, var uParam2)//Position - 0x37378
{
	if (!bParam1)
	{
...
int func_476(int iParam0)//Position - 0x37712
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_477(int iParam0, int iParam1)//Position - 0x3773B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_376(iParam0, &(Global_97353.f_18371.f_4742));
}

int func_478(int iParam0)//Position - 0x3793C
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_380(iParam0, 0, 0)) || func_380(iParam0, 1, 0)) || func_380(iParam0, 2, 0)) || func_372(iParam0) != 145) || func_488(iParam0)) || func_487(iParam0)) || func_474(iParam0)) || func_486(iParam0)) || !func_479(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_487(iParam0))
		{
		}
		...
		if (func_380(iParam0, 0, 0))
		{
		}
		if (func_380(iParam0, 1, 0))
		{
		}
		if (func_380(iParam0, 2, 0))
		{
		}
...
int func_479(int iParam0)//Position - 0x37A19
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_480(int iParam0)//Position - 0x37BC9
{
	int iVar0;
	struct<2> Var1;
	...
	{
		if ((((!func_484() && !func_483()) && !func_482()) && !func_481()) && !func_485())
		{
			return 0;
		}
	}
...
int func_481()//Position - 0x37D98
{
	return 0;
}

int func_482()//Position - 0x37DA1
{
	return 1;
}

int func_483()//Position - 0x37DAA
{
	return 1;
}

int func_484()//Position - 0x37DB3
{
...
int func_486(int iParam0)//Position - 0x37E4F
{
	int iVar0;
	char* sVar1;
...
int func_487(int iParam0)//Position - 0x37E95
{
	int iVar0;
...
int func_488(int iParam0)//Position - 0x37F11
{
	int iVar0;
...
void func_489(int iParam0, int iParam1)//Position - 0x37FF9
{
	int iVar0;
...
void func_490(var uParam0)//Position - 0x3807C
{
	if (!func_491(*uParam0))
	{
...
bool func_491(int iParam0)//Position - 0x380A7
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_492(var uParam0, var uParam1, var uParam2)//Position - 0x380B6
{
	int iVar0;
	int iVar1;
...
int func_493(int iParam0)//Position - 0x381E8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_494(var uParam0, var uParam1)//Position - 0x382C6
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_495(int iParam0, int iParam1)//Position - 0x38307
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_374(iParam0, iParam1))
				{
...
void func_496(struct<3> Param0, float fParam3, int iParam4)//Position - 0x383A8
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_501(&(Global_67138.f_555[0 /*21*/]), iVar0))
		{
...
void func_497(int iParam0)//Position - 0x383F8
{
	bool bVar0;
	...
	if (func_501(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_246(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_499(0, Global_67138.f_555[0 /*21*/].f_12) || !func_499(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_498(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
void func_498(struct<54> Param0, var uParam54)//Position - 0x3856D
{
...
int func_499(int iParam0, int iParam1)//Position - 0x38638
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_500(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_480(Global_97353.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}

int func_500(var uParam0)//Position - 0x386A9
{
	return *uParam0;
}

int func_501(var uParam0, int iParam1)//Position - 0x386B4
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_397(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_397(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_397(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
int func_502(struct<3> Param0, float fParam3)//Position - 0x39DA7
{
	return func_503(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_503(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x39DC1
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
		...
		if (func_510(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				if (uParam0->f_7 == 1)
				{
					...
					func_489(iVar0, uParam0->f_11);
				}
				else if ((!func_505(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_504(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_504(int iParam0)//Position - 0x3A06D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_505(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3A12F
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_506(iParam0, Global_67138.f_139[38], 0))
			{
				func_497(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_506(iParam0, Global_67138.f_139[43], 1))
			{
				func_497(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_506(iParam0, uVar1[iVar6], 1) && func_357(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_397(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_506(int iParam0, int iParam1, bool bParam2)//Position - 0x3A335
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_507(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3A395
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_509(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_508())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_492(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_377(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
bool func_508()//Position - 0x3A782
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_509(int iParam0)//Position - 0x3A793
{
	var uVar0;
...
int func_510(var uParam0)//Position - 0x3A7E1
{
	if (func_511(uParam0))
	{
...
int func_511(var uParam0)//Position - 0x3A816
{
	if (uParam0->f_12.f_42 == 0)
	{
		return 0;
	}
	if (!func_480(uParam0->f_12.f_42))
	{
		return 0;
	}
	return 1;
...
bool func_512()//Position - 0x3A83F
{
	return func_510(&(Global_93588.f_2167));
}

void func_513()//Position - 0x3A852
{
	func_514(&(Global_93588.f_2167));
}

void func_514(var uParam0)//Position - 0x3A865
{
	if (func_511(uParam0))
	{
...
int func_515(int iParam0, int iParam1, int iParam2)//Position - 0x3A883
{
	...
	if (iParam2 == 0 && func_517(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_517(int iParam0)//Position - 0x3A967
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_518()//Position - 0x3A9C0
{
	return func_511(&(Global_93588.f_2167));
}

int func_519()//Position - 0x3A9D3
{
	if (Global_89962 == 10 || Global_89962 == 9)
	{
		return 1;
...
void func_520()//Position - 0x3A9F7
{
	...
	func_522(64, 2, 0);
	MISC::CLEAR_BIT(&(Global_97353.f_16828.f_382), 3);
	func_521();
}
...
void func_522(int iParam0, int iParam1, bool bParam2)//Position - 0x3B20E
{
	Global_2949 = iParam0;
...
void func_523()//Position - 0x3B3B8
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
void func_527()//Position - 0x3B5EE
{
	...
	if (((func_519() || func_452(0)) || func_44()) || !bLocal_355)
	{
		VEHICLE::REMOVE_VEHICLES_FROM_GENERATORS_IN_AREA(Local_725, Local_722);
		MISC::CLEAR_AREA(Local_719, 35f, 1, 0, 0, 0);
		MISC::CLEAR_AREA_OF_VEHICLES(Local_719, 27f, 0, 0, 0, 0, 0);
...
void func_528()//Position - 0x3B714
{
	int iVar0;
...
void func_529()//Position - 0x3B734
{
	...
	func_532(&uLocal_543);
	func_531(&uLocal_543, -987.81f, 363.85f, 71.32f);
	func_531(&uLocal_543, -988.15f, 352.77f, 71.03f);
	func_531(&uLocal_543, -1030.05f, 342.06f, 67.88f);
	func_531(&uLocal_543, -1071.7f, 346.33f, 66.21f);
	func_531(&uLocal_543, -1070.97f, 379.39f, 67.96f);
	func_531(&uLocal_543, -1067.3f, 387.2f, 67.82f);
	func_531(&uLocal_543, -1059.75f, 390.57f, 67.96f);
	func_531(&uLocal_543, -1030.35f, 392.35f, 69.34f);
	func_531(&uLocal_543, -1016.2f, 378.02f, 70.67f);
	func_531(&uLocal_543, -1006f, 370.87f, 71.04f);
	func_530(&uLocal_543);
	func_532(&uLocal_595);
	func_531(&uLocal_595, -1025.32f, 380.54f, 70.79f);
	func_531(&uLocal_595, -1020.4f, 375.87f, 70.38f);
	func_531(&uLocal_595, -1012.08f, 369.8f, 71.1f);
	func_531(&uLocal_595, -1011.78f, 367.31f, 71.12f);
	func_531(&uLocal_595, -1006.72f, 364.41f, 71.28f);
	func_531(&uLocal_595, -1004.07f, 365.51f, 71.78f);
	func_531(&uLocal_595, -993.65f, 360.78f, 71.51f);
	func_531(&uLocal_595, -993.68f, 355.4f, 71.02f);
	func_531(&uLocal_595, -1008.25f, 350.7f, 70f);
	func_531(&uLocal_595, -1010.9f, 352.95f, 69.54f);
	func_531(&uLocal_595, -1018.94f, 351.08f, 69.9f);
	func_531(&uLocal_595, -1020.24f, 349.86f, 69.67f);
	func_531(&uLocal_595, -1020.85f, 347.65f, 68.93f);
	func_531(&uLocal_595, -1030.98f, 346.06f, 70.4f);
	func_531(&uLocal_595, -1036.05f, 346.14f, 70.45f);
	func_530(&uLocal_595);
	func_457();
}

void func_530(var uParam0)//Position - 0x3C063
{
	int iVar0;
	float fVar1;
...
void func_531(var uParam0, struct<3> Param1)//Position - 0x3C103
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_532(var uParam0)//Position - 0x3C134
{
	if (uParam0->f_51)
	{
	}
...
void func_534()//Position - 0x3C1A2
{
	...
	func_535(&Local_98, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_535(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x3C1C4
{
...
void func_536(var uParam0, bool bParam1)//Position - 0x3C1E4
{
	func_537(&(uParam0->f_41), bParam1);
}

void func_537(var uParam0, bool bParam1)//Position - 0x3C1F6
{
	int iVar0;
	...
	while (iVar0 <= (*uParam0 - 1))
	{
		...
		{
			func_52(uParam0[iVar0], 0);
		}
		iVar0++;
	}
}

void func_538(var uParam0, bool bParam1)//Position - 0x3C234
{
	func_539(&(uParam0->f_35), bParam1);
}

void func_539(var uParam0, bool bParam1)//Position - 0x3C246
{
	int iVar0;
...
void func_540(var uParam0, int iParam1)//Position - 0x3C283
{
	func_541(&(uParam0->f_28), iParam1);
}

void func_541(var uParam0, int iParam1)//Position - 0x3C295
{
	int iVar0;
...
void func_543(bool bParam0)//Position - 0x3C377
{
	int iVar0;
...
void func_544(char* sParam0, int iParam1)//Position - 0x3C447
{
	if (Global_89962 != 12)
	{
...
int func_545(char* sParam0, int iParam1, int iParam2)//Position - 0x3C46F
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
...
int func_546()//Position - 0x3C601
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_422(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_548()//Position - 0x3C675
{
	...
	{
		if (func_419(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_549(int iParam0)//Position - 0x3C6E1
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_550(int iParam0)//Position - 0x3C6F5
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_551(int iParam0)//Position - 0x3C732
{
	if (iParam0 == 1)
	{
...
void func_552()//Position - 0x3C76F
{
	Global_17098.f_5 = 1;
}

void func_553()//Position - 0x3C77D
{
	Global_17098.f_5 = 0;
}

void func_554()//Position - 0x3C78B
{
	Global_84543 = 0;
	Global_84544 = 0;
}

int func_555()//Position - 0x3C79D
{
	if (((Global_89962 == 13 || Global_89962 == 10) || Global_89962 == 11) || Global_89962 == 12)
	{
		return 0;
...
void func_556()//Position - 0x3C7DB
{
	Global_89997 = 1;
...
void func_557(char* sParam0)//Position - 0x3C8CC
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_558(var uParam0)//Position - 0x3C8DE
{
...
void func_559(var uParam0)//Position - 0x3C8FE
{
	int iVar0;
...
int func_560(int iParam0)//Position - 0x3C938
{
	if (!func_217(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
