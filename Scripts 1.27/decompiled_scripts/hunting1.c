...
void __EntryFunction__()//Position - 0x0
{
	...
	func_483(25);
	func_482();
	func_481(&uLocal_152, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	func_481(&uLocal_152, 3, iLocal_733, "CLETUS", 0, 1);
	while (true)
	{
...
void func_7()//Position - 0x97D
{
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			func_8(&(Local_498[iVar0 /*54*/][iVar1 /*17*/]));
			iVar1++;
		}
		iVar0++;
	}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_96(14))
			{
				iVar0 = func_76(func_95(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				iVar0 = func_76(func_94(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(iVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					iVar0 = func_76(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (func_285(PLAYER::PLAYER_PED_ID()))
				{
					...
					if (!func_209())
					{
						func_221(PLAYER::PLAYER_PED_ID(), Local_912, fLocal_915, 0, 1);
					}
					if (func_285(iLocal_733))
					{
...
void func_218(bool bParam0)//Position - 0x25848
{
	if (func_285(iLocal_733))
	{
		if (bParam0)
		{
			...
			{
				if (!PED::IS_PED_GROUP_MEMBER(iLocal_733, func_219()))
				{
					TASK::CLEAR_PED_TASKS(iLocal_733);
					PED::SET_PED_AS_GROUP_MEMBER(iLocal_733, func_219());
					PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_733, 1);
					ENTITY::FREEZE_ENTITY_POSITION(iLocal_733, 0);
				}
			}
		}
		else if (PED::IS_PED_GROUP_MEMBER(iLocal_733, func_219()))
		{
			TASK::CLEAR_PED_TASKS(iLocal_733);
...
int func_221(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x2593D
{
	bool bVar0;
	float fVar1;
...
void func_223(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x259B7
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_206(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
			...
			{
				iVar10 = func_279(&(Global_89962.f_3));
				if (iVar10 > -1)
				{
...
{
	func_225(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_225(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x25B48
{
	...
	*uParam0 = func_213();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_246())
		{
			func_242(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_227(&(uParam0->f_2167), uParam0, iParam5, 1, 1, 0);
	}
	func_226(&(uParam0->f_2233));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
{
	func_236(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_233(iParam1, 145, 0);
	uParam0->f_11 = func_232(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_231(iParam1);
		}
	}
	if (iParam2 == 1)
	{
...
void func_236(int iParam0, var uParam1)//Position - 0x26FAC
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_238(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_237(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_242(int iParam0, var uParam1, int iParam2)//Position - 0x27658
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_243(161, -1))
			{
				uParam1->f_59 = func_76(2035, Global_68104, 0);
			}
			else
			{
				uParam1->f_59 = func_76(740, Global_68104, 0);
			}
			uParam1->f_60 = func_76(741, Global_68104, 0);
			uParam1->f_61 = func_76(742, Global_68104, 0);
		}
...
int func_243(int iParam0, int iParam1)//Position - 0x27802
{
	...
	uVar0 = Global_2473393[iParam0 /*6*/][func_75(iParam1)];
...
void func_247(int iParam0, bool bParam1)//Position - 0x27FD0
{
	...
	if (func_157(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_248(iParam0, &(Global_97353.f_1729.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_248(int iParam0, var uParam1)//Position - 0x280C4
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_249(Var9.f_1)) && iVar70 < 50)
			{
...
int func_255(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x294B0
{
	int iVar0;
	int iVar1;
...
bool func_257(struct<3> Param0, struct<3> Param3)//Position - 0x29B4A
{
...
int func_263(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x29EF5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_280(int iParam0)//Position - 0x2AA19
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_281(Global_97353.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_281(Global_97353.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_281(Global_97353.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_281(Global_97353.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_281(Global_97353.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
void func_288()//Position - 0x2AF8B
{
	...
	if (((func_222(uLocal_974[0]) && func_222(uLocal_974[1])) && func_222(uLocal_974[2])) && func_222(uLocal_974[3]))
	{
		func_289();
	}
}
...
void func_291(bool bParam0, int iParam1)//Position - 0x2B133
{
	...
	{
		iLocal_609 = func_292(iLocal_733, 1, 1, 5);
	}
	if (HUD::DOES_BLIP_EXIST(iLocal_609))
	{
		if (!bParam0)
...
void func_299()//Position - 0x2B2FF
{
	...
	while (iVar0 < 2)
	{
		...
		while (iVar1 < 3)
		{
			...
			{
				if (!func_285(Local_498[iVar0 /*54*/][iVar1 /*17*/].f_6))
				{
				...
				else if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_498[iVar0 /*54*/][iVar1 /*17*/].f_6, 1), 2f, 0))
				{
					...
					while (iLocal_715 < 3)
					{
						if (func_222(Local_498[iVar0 /*54*/][iLocal_715 /*17*/].f_6))
						{
	...
	switch (Local_498[iParam0 /*54*/][iParam1 /*17*/].f_3)
	{
		...
		case 12:
			if (ENTITY::DOES_ENTITY_EXIST(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (iLocal_686[iParam0])
				{
					if (func_302(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_958[iParam0 /*3*/], 1) >= 45f)
					{
				...
				else if (func_302(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_498[iParam0 /*54*/][iParam1 /*17*/].f_14, 1) >= 45f)
				{
					if (Local_498[iParam0 /*54*/][iParam1 /*17*/].f_4 == 0)
					{
		...
		case 10:
			if (ENTITY::DOES_ENTITY_EXIST(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6) && !ENTITY::IS_ENTITY_DEAD(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6))
			{
				if (func_302(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6, Local_958[iParam0 /*3*/], 0) < 2f)
				{
					TASK::CLEAR_PED_TASKS(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6);
...
float func_302(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2BF7B
{
	struct<3> Var0;
...
void func_304(int iParam0)//Position - 0x2C010
{
	...
	if (func_317())
	{
		...
		{
			func_314(767);
			if (func_305(&uLocal_152, cLocal_738, "HUNT1_KILL", "HUNT1_KILL_1", 7, 0, 0))
			{
				iLocal_613 = 1;
			}
		}
...
{
	return Global_47002.f_37[iParam0];
}

int func_316()//Position - 0x2C6B8
{
	return Global_47002.f_36;
}

bool func_317()//Position - 0x2C6C5
{
	return Global_47002.f_36 > 0;
}
...
void func_318(int iParam0, int iParam1)//Position - 0x2C6D4
{
	if ((((ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0) && ENTITY::DOES_ENTITY_EXIST(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6)) && !ENTITY::IS_ENTITY_DEAD(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6)) && iLocal_632) && iLocal_723 < 3)
	{
		...
		{
			Local_498[iParam0 /*54*/][iParam1 /*17*/] = func_292(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6, 1, 0, 5);
			if (HUD::DOES_BLIP_EXIST(Local_498[iParam0 /*54*/][iParam1 /*17*/]))
			{
	...
	{
		func_8(&(Local_498[iParam0 /*54*/][iParam1 /*17*/]));
	}
}
...
void func_319(int iParam0, int iParam1)//Position - 0x2C7C9
{
	...
	if (!func_285(Local_498[iParam0 /*54*/][iParam1 /*17*/].f_6))
	{
		if (iParam1 == 1)
		{
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_209())
				{
					func_221(PLAYER::PLAYER_PED_ID(), Local_802, fLocal_805, 0, 1);
					func_325();
				}
				iLocal_320 = 2;
			}
...
void func_337()//Position - 0x2CF3E
{
	...
	while (iVar0 < 5)
	{
		...
		switch (Local_352[iVar0 /*29*/].f_13)
		{
			...
			case 4:
				if (func_285(Local_352[iVar0 /*29*/].f_12) && func_350(Local_352[iVar0 /*29*/].f_28))
				{
					if (!ENTITY::IS_ENTITY_AT_COORD(Local_352[iVar0 /*29*/].f_28, Local_352[iVar0 /*29*/].f_19, 10f, 10f, 10f, 0, 0, 0))
					{
						if (!func_349(Local_352[iVar0 /*29*/].f_12, -1817882002))
						{
							PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_352[iVar0 /*29*/].f_12, 1);
							TASK::TASK_VEHICLE_DRIVE_TO_COORD(Local_352[iVar0 /*29*/].f_12, Local_352[iVar0 /*29*/].f_28, Local_352[iVar0 /*29*/].f_19, 8f, 0, 0, 786599, 5f, 2f);
						}
			...
			case 6:
				if ((func_222(Local_352[iVar0 /*29*/].f_28) && func_285(Local_352[iVar0 /*29*/].f_12)) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_352[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
			...
			case 7:
				if (func_285(Local_352[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_352[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1))
				{
			...
			case 8:
				if ((func_285(Local_352[iVar0 /*29*/].f_12) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_352[iVar0 /*29*/].f_28, PLAYER::PLAYER_PED_ID(), 1)) && func_350(Local_352[iVar0 /*29*/].f_28))
				{
			...
			case 15:
				...
				if (ENTITY::DOES_ENTITY_EXIST(Local_352[iVar0 /*29*/].f_12))
				{
					...
					func_339(&(Local_352[iVar0 /*29*/].f_12), 1, 0, 1);
				}
				if (ENTITY::DOES_ENTITY_EXIST(Local_352[iVar0 /*29*/].f_28))
				{
					func_338(&(Local_352[iVar0 /*29*/].f_28));
				}
				Local_352[iVar0 /*29*/].f_13 = 1;
				break;
		}
		if (func_350(Local_352[iVar0 /*29*/].f_28) && func_285(Local_352[iVar0 /*29*/].f_12))
		{
...
void func_340(int iParam0)//Position - 0x2DEAC
{
	...
	if (func_285(iVar0))
	{
		if (func_350(Local_352[iParam0 /*29*/].f_28))
		{
...
{
	if (func_285(Local_352[iParam0 /*29*/].f_12))
	{
...
void func_343()//Position - 0x2E0A8
{
	...
	else if (MISC::GET_GAME_TIMER() > iLocal_703)
	{
		...
		{
			if (func_344(&uLocal_152, cLocal_738, "HUNT1_CARH", 7, 0, 0, 0))
			{
				iLocal_624 = 0;
			}
		}
...
int func_345()//Position - 0x2E154
{
	...
	if (func_285(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (func_285(iLocal_733))
		{
			...
			if (func_346(PLAYER::PLAYER_PED_ID(), iLocal_733, 0) <= 10f && MISC::ABSF((Var0.f_2 - Var3.f_2)) < 1.5f)
			{
				return 1;
			}
		}
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_209())
				{
					func_221(PLAYER::PLAYER_PED_ID(), Local_747, fLocal_690, 0, 1);
					func_325();
				}
				iLocal_320 = 2;
			}
...
void func_364()//Position - 0x2EBFC
{
	...
	{
		func_8(&iLocal_609);
		iLocal_608 = func_365(Local_744, 5, 1);
		func_296("HT_NXTLOC");
		iLocal_317 = 9;
	}
	if (func_334())
...
int func_365(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2EC5E
{
	int iVar0;
...
void func_366()//Position - 0x2EC8C
{
	...
	if (!bLocal_629)
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_744, 5f, 5f, 5f, 0, 1, 0) && func_367(1077936128, 1))
		{
...
void func_373()//Position - 0x2F081
{
	...
	while (iVar0 < 3)
	{
		if (!HUD::DOES_BLIP_EXIST(Local_321[iVar0 /*10*/].f_9))
		{
			if (func_222(Local_321[iVar0 /*10*/]))
			{
...
void func_378(int iParam0)//Position - 0x2F226
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_321[iParam0 /*10*/]) && !Local_321[iParam0 /*10*/].f_7)
	{
		...
		if (Local_321[iParam0 /*10*/].f_5 < 100)
		{
			...
			iLocal_623 = 0;
			func_8(&(Local_321[iParam0 /*10*/].f_9));
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_209())
				{
					func_221(PLAYER::PLAYER_PED_ID(), Local_741, fLocal_689, 0, 1);
				}
				func_8(&iLocal_608);
				func_220(1);
	...
	switch (iLocal_320)
	{
		...
		case 1:
			if (CAM::IS_SCREEN_FADED_OUT())
			{
				...
				if (!func_209())
				{
					func_221(PLAYER::PLAYER_PED_ID(), Local_809, fLocal_812, 0, 1);
					func_325();
				}
				func_220(1);
			...
			switch (iLocal_705)
			{
				case 0:
					if (func_409(1, 1093140480, 0))
					{
						...
						if (func_222(iLocal_733))
						{
							...
							iLocal_732 = func_408(iLocal_733, joaat("weapon_sniperrifle"), 1, 0, 0, 0, 0);
						}
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_732))
						{
						...
						func_400(Local_825, Local_828, 5f, Local_849, fLocal_699, 1, 1, 1, 0, 0);
						func_400(Local_831, Local_834, 5f, Local_849, fLocal_699, 1, 1, 1, 0, 0);
						func_400(Local_837, Local_840, 5f, Local_849, fLocal_699, 1, 1, 1, 0, 0);
						func_400(Local_843, Local_846, 5f, Local_849, fLocal_699, 1, 1, 1, 0, 0);
						if (func_222(iLocal_979))
						{
				...
				case 1:
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_740, joaat("p_cletus_necklace_s")))
					{
						if (!bLocal_622)
						{
							func_221(iLocal_733, Local_790, fLocal_697, 0, 1);
							iLocal_318 = 2;
							bLocal_622 = true;
						}
					}
...
void func_400(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x30062
{
	func_401(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_401(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x3008B
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_403(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3049B
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_404(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x30791
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_408(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)//Position - 0x30909
{
	...
	while (func_250(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_250(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_250(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
{
	if (!CAM::IS_GAMEPLAY_HINT_ACTIVE() && func_346(PLAYER::PLAYER_PED_ID(), iLocal_733, 1) > 3f)
	{
	...
	else if (func_285(iLocal_733) && func_285(PLAYER::PLAYER_PED_ID()))
	{
		if (MISC::GET_GAME_TIMER() > iLocal_710 || func_346(PLAYER::PLAYER_PED_ID(), iLocal_733, 1) <= 3f)
		{
			if (func_346(PLAYER::PLAYER_PED_ID(), iLocal_733, 1) <= 3f)
			{
			}
			iLocal_705 = 0;
			iLocal_320 = 0;
...
void func_415()//Position - 0x30DCB
{
	...
	if (func_496())
	{
		...
		{
			case 0:
				func_416(Local_809, fLocal_812, 1, 0);
				iLocal_317 = 3;
				break;
			
			case 1:
				func_416(Local_741, fLocal_689, 1, 0);
				iLocal_317 = 5;
				break;
			
			case 2:
				func_416(Local_747, fLocal_690, 1, 0);
				iLocal_317 = 12;
				break;
			
			case 3:
				func_416(Local_802, fLocal_805, 1, 0);
				iLocal_317 = 16;
				break;
			
			case 4:
				func_416(Local_912, fLocal_915, 1, 0);
				iLocal_317 = 20;
				break;
...
void func_416(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30F97
{
	if (func_496())
	{
		...
		switch (iLocal_318)
		{
			...
			case 4:
				...
				else if (!iLocal_658[0])
				{
					...
					{
						if (func_344(&uLocal_152, cLocal_738, "HUNT1_1", 7, 0, 0, 0))
						{
							iLocal_658[0] = 1;
						}
					}
				...
				{
					func_455(&uLocal_994, &uLocal_152, cLocal_738, &sLocal_995, &cLocal_1001);
				}
				break;
			...
			case 6:
				...
				else if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_756, Local_759, 7f, 0, 1, 0) && func_345())
				{
					...
					{
						func_353();
						if (func_344(&uLocal_152, cLocal_738, "HUNT1_DIARR", 7, 0, 0, 0))
						{
			...
			case 7:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_756, Local_759, 7f, 0, 1, 0))
				{
					...
					if (func_453())
					{
						func_353();
						func_377();
						if (iLocal_636 && !func_371("HT_SHDISH", 0, 0))
						{
							func_448(0);
						}
						if (iLocal_723 == 1 && func_447())
						{
							if (!iLocal_645[0])
							{
								...
								{
									if (func_305(&uLocal_152, cLocal_738, "HUNT1_DISH", "HUNT1_DISH_1", 7, 1, 0))
									{
										iLocal_615 = 0;
										func_458(0);
										iLocal_645[0] = 1;
								...
								else if (func_305(&uLocal_152, cLocal_738, "HUNT1_DISH", "HUNT1_DISH_1", 7, 0, 0))
								{
									iLocal_615 = 0;
									func_458(0);
									iLocal_645[0] = 1;
						...
						else if (iLocal_723 == 2 && func_447())
						{
							if (!iLocal_645[1])
							{
								if (func_305(&uLocal_152, cLocal_738, "HUNT1_DISH", "HUNT1_DISH_2", 7, 0, 0))
								{
									iLocal_615 = 0;
									func_458(0);
									iLocal_645[1] = 1;
						...
						else if (iLocal_723 == 3)
						{
							...
							{
								func_293();
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_1A", 7, 0, 0, 0))
								{
									RECORDING::_0x293220DA1B46CEBC(2f, 5f, 4);
									iLocal_615 = 0;
									iLocal_645[2] = 1;
				...
				{
					if (func_344(&uLocal_152, cLocal_738, "HUNT1_LAREA", 7, 1, 0, 0))
					{
						iLocal_658[2] = 1;
					}
				}
			...
			case 11:
				...
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_733, PLAYER::PLAYER_PED_ID(), Local_822, 0, 1, 0))
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) || VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
						{
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_ENCAR", 7, 0, 0, 0))
							{
								func_8(&iLocal_609);
								func_218(1);
			...
			case 12:
				if (func_344(&uLocal_152, cLocal_738, "HUNT1_TYARR", 7, 0, 0, 0))
				{
					if (iLocal_718 == -1)
					{
			...
			case 14:
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_733, 713668775) == 7)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_733, Local_780, 1.25f, 1.25f, 2.5f, 0, 1, 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_762, Local_765, 10f, 0, 1, 0))
					{
						if (func_453())
						{
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_HERE", 7, 0, 0, 0) || iLocal_713 == 1)
							{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_762, Local_765, 10f, 0, 1, 0))
				{
					...
					if (func_453())
					{
						...
						if (iLocal_628)
						{
							if (func_322())
							{
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_TYIN", 7, 0, 0, 0))
								{
									iLocal_628 = 0;
									iLocal_623 = 0;
								}
						...
						{
							if (func_305(&uLocal_152, cLocal_738, "HUNT1_TYRE", "HUNT1_TYRE_1", 7, 0, 0))
							{
								iLocal_645[0] = 1;
							}
						}
						...
						{
							if (func_305(&uLocal_152, cLocal_738, "HUNT1_TYRE", "HUNT1_TYRE_2", 7, 0, 0))
							{
								iLocal_645[1] = 1;
							}
						}
						else if (iLocal_723 == 3)
						{
							if (!iLocal_645[2])
							{
								if (iLocal_721 <= 6 && func_344(&uLocal_152, cLocal_738, "HUNT1_TYR2", 7, 0, 0, 0))
								{
									iLocal_645[2] = 1;
								}
								else if (iLocal_721 <= 10 && func_344(&uLocal_152, cLocal_738, "HUNT1_TRY3", 7, 0, 0, 0))
								{
									iLocal_645[2] = 1;
								}
								else if (func_344(&uLocal_152, cLocal_738, "HUNT1_TYR4", 7, 0, 0, 0))
								{
									iLocal_645[2] = 1;
								}
							}
			...
			case 17:
				...
				if (!iLocal_658[15])
				{
					if (func_345())
					{
						if (!func_215())
						{
							...
							{
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_3", 8, 0, 0, 0))
								{
									iLocal_658[15] = 1;
								}
							}
				...
				{
					case 0:
						if (func_302(iLocal_733, Local_945[0 /*3*/], 0) < 2f)
						{
					...
					case 1:
						if (func_302(iLocal_733, Local_945[1 /*3*/], 0) < 2f)
						{
					...
					case 2:
						if (func_302(iLocal_733, Local_945[2 /*3*/], 0) < 2f)
						{
					...
					case 3:
						if (func_302(iLocal_733, Local_945[3 /*3*/], 0) < 2f)
						{
			...
			case 18:
				if (func_285(PLAYER::PLAYER_PED_ID()))
				{
					...
					{
						if (func_344(&uLocal_152, cLocal_738, "HUNT_ROOF", 7, 0, 0, 0))
						{
							TASK::CLEAR_PED_TASKS(iLocal_733);
			...
			case 21:
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0))
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_733, 713668775) == 7)
					{
						if ((func_344(&uLocal_152, cLocal_738, "HUNT1_COARR", 7, 0, 0, 0) || iLocal_723 > 0) || iLocal_713 == 1)
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 5f, 4);
							iLocal_713 = 0;
							iLocal_658[17] = 1;
			...
			case 22:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_768, Local_771, 20f, 0, 1, 0))
				{
					...
					if (func_453())
					{
						...
						if (iLocal_723 == 1 && !iLocal_658[18])
						{
							if (!func_215())
							{
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_FIRST", 7, 0, 0, 0))
								{
									if (iLocal_627)
									{
										iLocal_627 = 0;
						...
						if (iLocal_723 == 2 && !iLocal_658[19])
						{
							if (!func_215())
							{
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_SEC", 7, 0, 0, 0))
								{
									if (iLocal_627)
									{
										iLocal_627 = 0;
						...
						if (iLocal_627)
						{
							if (!func_215())
							{
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_COYMIS", 7, 0, 0, 0))
								{
									iLocal_627 = 0;
								}
							}
				...
				if (bLocal_625)
				{
					...
					{
						func_293();
						if (func_344(&uLocal_152, cLocal_738, "HUNT1_FIN", 8, 0, 0, 0))
						{
							RECORDING::_0x293220DA1B46CEBC(3f, 4f, 4);
							func_458(0);
							iLocal_318 = 23;
			...
			case 25:
				if (!func_215())
				{
					if (!iLocal_658[21])
					{
						if (func_344(&uLocal_152, cLocal_738, "HUNT1_4", 7, 0, 0, 0))
						{
							iLocal_658[21] = 1;
						}
					}
				...
				if (func_222(iVar0) || !func_222(iVar0))
				{
					if (PED::IS_PED_MODEL(iVar0, iLocal_726))
					{
						if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iVar0, PLAYER::PLAYER_PED_ID(), 1))
						{
							...
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_COYTYR", 7, 0, 0, 0))
							{
								iLocal_658[12] = 1;
							}
						}
...
void func_431()//Position - 0x324C0
{
	if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_733, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_992)
		{
			if (func_345())
			{
				if (func_344(&uLocal_152, cLocal_738, "HUNT1_TYRBAN", 7, 0, 0, 0))
				{
					iLocal_658[10] = 1;
				}
			}
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_733, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_702)
			{
				if (!func_215())
				{
					if (!iLocal_658[8])
					{
						if (func_434(&uLocal_152, cLocal_738, "HUNT1_BANTER", &Local_981, 7, 0, 0))
						{
...
void func_435()//Position - 0x326CE
{
	...
	if (func_285(PLAYER::PLAYER_PED_ID()) && func_285(iLocal_733))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_733, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_222(iLocal_979))
			{
				if (PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0) == iLocal_979 && PED::GET_VEHICLE_PED_IS_IN(iLocal_733, 0) == iLocal_979)
				{
					...
					else
					{
						...
						{
							func_436();
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_DAMCAR", 8, 0, 0, 0))
							{
								iLocal_989 = 0;
							}
						}
		...
		if (!iLocal_658[7])
		{
			if (!func_215())
			{
				if (func_345())
				{
					...
					{
						if (func_344(&uLocal_152, cLocal_738, "HUNT1_CLVEH", 7, 0, 0, 0))
						{
							iLocal_658[7] = 1;
						}
					}
					...
					{
						if (func_344(&uLocal_152, cLocal_738, "HUNT1_OWNVEH", 7, 0, 0, 0))
						{
							iLocal_658[7] = 1;
						}
					}
	...
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_733, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_756, Local_759, 7f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_733, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				if (!iLocal_643)
				{
					if (!func_371("HT_NXTLOC", 0, 0) && iLocal_658[4])
					{
				...
				else if (MISC::GET_GAME_TIMER() > iLocal_717)
				{
					if (!func_215() && func_345())
					{
						if (!iLocal_658[6])
						{
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_NOVEH", 7, 0, 0, 0))
							{
								iLocal_658[6] = 1;
							}
						}
...
void func_442()//Position - 0x3294F
{
	if (!PED::IS_PED_DEAD_OR_DYING(iLocal_733, 1) && !PED::IS_PED_DEAD_OR_DYING(PLAYER::PLAYER_PED_ID(), 1))
	{
		if (!iLocal_987)
		{
			if (iLocal_682[1] && !func_371("HT_NXTLOC", 0, 0))
			{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_988)
		{
			if (!func_215() && func_345())
			{
				if (!iLocal_658[4])
				{
					if (func_344(&uLocal_152, cLocal_738, "HUNT1_2", 7, 0, 0, 0))
					{
						iLocal_658[4] = 1;
					}
				}
...
void func_443()//Position - 0x329E3
{
	...
	{
		if ((iLocal_682[1] && !func_371("HT_NXTLOC", 0, 0)) && !func_215())
		{
			if (!iLocal_642)
			{
			...
			else if (MISC::GET_GAME_TIMER() > iLocal_701)
			{
				...
				{
					if (func_344(&uLocal_152, cLocal_738, "HUNT1_WAIT", 7, 0, 0, 0))
					{
						iLocal_642 = 0;
					}
				}
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(iLocal_733, 1))
			{
				if (!VEHICLE::ARE_ANY_VEHICLE_SEATS_FREE(uLocal_993))
				{
					if (func_345())
					{
						if (!func_215())
						{
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_NOCAR", 7, 0, 0, 0))
							{
								iLocal_619 = 1;
							}
						}
...
void func_446()//Position - 0x32B59
{
		...
		if (MISC::IS_BULLET_IN_AREA(Local_321[iVar0 /*10*/].f_1, 10f, 1))
		{
			if (!func_215())
			{
				if (!func_371("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
				{
					if (!Local_321[iVar0 /*10*/].f_7)
					{
						if (func_344(&uLocal_152, cLocal_738, "HUNT_MISS", 7, 0, 0, 0))
						{
							iLocal_623 = 0;
						}
					}
	...
	if (MISC::IS_BULLET_IN_AREA(1793.305f, 3804.426f, 32.6374f, 10f, 1))
	{
		if (!func_215())
		{
			if (!func_371("HT_SHDISH", 0, 0) || MISC::GET_PROFILE_SETTING(203) == 0)
			{
				if (func_344(&uLocal_152, cLocal_738, "HUNT_MISS2", 6, 0, 0, 0))
				{
					iLocal_623 = 0;
				}
			}
...
void func_448(int iParam0)//Position - 0x32C61
{
	...
	if (((iLocal_723 < 3 && !func_371("HT_SHDISH", 0, 0)) && !func_371("HT_SHTYRE", 0, 0)) && !func_371("HT_SHCOY", 0, 0))
	{
		if (iLocal_623)
		{
			if (MISC::GET_GAME_TIMER() > iLocal_711)
			{
				...
				{
					if ((func_322() || iLocal_708 > 2) || iLocal_723 == 0)
					{
						if (func_344(&uLocal_152, cLocal_738, sVar0, 7, 0, 0, 0))
						{
							iLocal_623 = 0;
						}
					}
					else
					{
						...
						{
							case 0:
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_SAT", 7, 0, 0, 0))
								{
									iLocal_623 = 0;
									iLocal_708++;
								}
							...
							case 1:
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_SAT2", 7, 0, 0, 0))
								{
									iLocal_623 = 0;
									iLocal_708++;
								}
							...
							case 2:
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_SAT3", 7, 0, 0, 0))
								{
									iLocal_623 = 0;
									iLocal_708++;
								}
				...
				{
					if ((func_322() || iLocal_724 > 2) || iLocal_723 == 0)
					{
						if (func_344(&uLocal_152, cLocal_738, sVar0, 7, 0, 0, 0))
						{
							iLocal_623 = 0;
					...
					else
					{
						...
						{
							case 0:
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_BANT1", 7, 0, 0, 0))
								{
									iLocal_623 = 0;
									iLocal_724++;
								}
							...
							case 1:
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_BANT2", 7, 0, 0, 0))
								{
									iLocal_623 = 0;
									iLocal_724++;
								}
							...
							case 2:
								if (func_344(&uLocal_152, cLocal_738, "HUNT1_BANT3", 7, 0, 0, 0))
								{
									iLocal_623 = 0;
									iLocal_724++;
								}
				...
				else
				{
					...
					{
						case 0:
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_COYB1", 7, 0, 0, 0))
							{
								iLocal_623 = 0;
								iLocal_980++;
							}
						...
						case 1:
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_COYB2", 7, 0, 0, 0))
							{
								iLocal_623 = 0;
								iLocal_980++;
							}
						...
						case 2:
							if (func_344(&uLocal_152, cLocal_738, "HUNT1_COYB3", 7, 0, 0, 0))
							{
								iLocal_623 = 0;
								iLocal_980++;
							}
		...
		switch (iLocal_713)
		{
			case 0:
				switch (iParam0)
				{
					...
					case 1:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_733, Local_780, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_450(iLocal_733, fLocal_690, 30f))
						{
							iLocal_713 = 1;
						}
						break;
					...
					case 2:
						if (!ENTITY::IS_ENTITY_AT_COORD(iLocal_733, Local_787, 1.5f, 1.5f, 1.5f, 0, 1, 0) || !func_450(iLocal_733, fLocal_698, 30f))
						{
							iLocal_713 = 1;
						}
						break;
	...
	if (!func_215())
	{
		if (func_345())
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				if (!iLocal_634)
				{
					if (func_344(&uLocal_152, cLocal_738, "HUNT1_UGUN", 9, 0, 0, 0))
					{
						iLocal_634 = 1;
						iLocal_633 = 0;
					}
			...
			{
				if (func_344(&uLocal_152, cLocal_738, "HUNT_UGUN2", 9, 0, 0, 0))
				{
					iLocal_633 = 1;
					iLocal_634 = 0;
				}
...
void func_459(bool bParam0)//Position - 0x335E7
{
	...
	iVar1 = 0;
	if (func_285(iLocal_733) && func_285(PLAYER::PLAYER_PED_ID()))
	{
		if (func_430())
		{
			iVar1 = 0;
			...
			if (iLocal_706 == 1)
			{
				if (!iLocal_658[13])
				{
					if (func_305(&uLocal_152, cLocal_738, "HUNT1_INOC", "HUNT1_INOC_1", 8, 0, 0))
					{
						iLocal_658[13] = 1;
					}
				}
	...
	if (!PED::IS_PED_INJURED(iLocal_733))
	{
		...
		if (!iLocal_618)
		{
			if (func_462() || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_733))
			{
				...
				func_461(&uLocal_152, cLocal_738, "HUNT1_PTREAC", 6, 0, 0);
				iLocal_618 = 1;
			}
		}
		if (!bLocal_644)
...
int func_462()//Position - 0x33891
{
	if (func_285(iLocal_733))
	{
		if (iLocal_318 != 25)
		{
			if ((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && func_346(iLocal_733, PLAYER::PLAYER_PED_ID(), 1) <= 3f)
			{
				return 1;
			}
		}
		else if (((!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::IS_PED_IN_MELEE_COMBAT(PLAYER::PLAYER_PED_ID())) && PED::IS_PED_FACING_PED(PLAYER::PLAYER_PED_ID(), iLocal_733, 30f)) && func_346(iLocal_733, PLAYER::PLAYER_PED_ID(), 1) <= 2f)
		{
			return 1;
		}
	}
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_466(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_467(iVar2), 8);
					break;
			}
			break;
...
{
	if (((!func_478(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_480(iParam0, Global_34913);
}
...
int func_485(var uParam0)//Position - 0x3468A
{
	...
	switch (iLocal_78)
	{
		case 0:
			...
			func_495(&(uParam0->f_48), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_78 = 1;
			break;
		
		case 1:
			if ((!func_494(&iVar0) || !func_492(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_78 = 2;
		...
		case 2:
			...
			{
				if (func_489(&(uParam0->f_28[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
...
int func_489(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x34A76
{
	if (func_490(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_490(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0x34AD1
{
	int iVar0;
...
int func_511(char* sParam0, int iParam1, int iParam2)//Position - 0x350B5
{
	...
	if (func_514())
	{
		...
		{
			iVar33 = func_279(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_512()//Position - 0x35247
{
	...
	iVar0 = func_282(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_514()//Position - 0x352BB
{
	...
	{
		if (func_279(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
