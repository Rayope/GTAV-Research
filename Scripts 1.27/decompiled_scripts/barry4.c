...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_303())
	{
		Global_68490 = 1;
		iLocal_78 = 0;
		while (!func_302(&Local_82))
		{
			SYSTEM::WAIT(0);
		}
		func_240(&iVar0, 236.1378f, -369.3902f, 43.2497f, 251.2f, 0, 0, 0, 1, 0, joaat("asterope"), 0, 145);
		Global_68490 = 0;
	}
	while (true)
	{
...
void func_1()//Position - 0x11D
{
	switch (iLocal_81)
	{
		case 0:
			if (func_303())
			{
				func_222(243.367f, -387.3153f, 44.4046f, 175.2f, 1, 0);
				func_220(0, -1, 1);
			}
			func_219(500, 1);
			iLocal_81 = 1;
		...
		case 1:
			...
			func_213(&uLocal_144, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_213(&uLocal_144, 3, 0, "BARRY", 0, 1);
			iLocal_143 = 0;
			iLocal_81 = 2;
			break;
		...
		case 2:
			if (!iLocal_143)
			{
				if (func_201(&uLocal_144, 49, "BARR4AU", "BAR4_RCM_LI", 11, 1, 0, 0, 0))
				{
...
void func_3(int iParam0, bool bParam1)//Position - 0x216
{
	int iVar0;
	var uVar1;
...
bool func_5(bool bParam0)//Position - 0x38D
{
...
void func_6(int iParam0, int iParam1, int iParam2)//Position - 0x3B8
{
	bool bVar0;
...
int func_8()//Position - 0x961
{
	return Global_24444;
}

int func_9(int iParam0, int iParam1)//Position - 0x96C
{
	int iVar0;
...
int func_10(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9BD
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_11()//Position - 0xC18
{
	return Global_1312737;
}

void func_12()//Position - 0xC24
{
	func_29();
	func_21();
	func_17();
...
void func_13(int iParam0)//Position - 0xC7D
{
	if (iParam0 == 1)
	{
...
void func_15()//Position - 0xCC4
{
	StringCopy(&Global_68477, "", 16);
	StringCopy(&Global_68481, "", 16);
}

void func_16()//Position - 0xCDE
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0xDB0
{
	if (iParam0 == 1)
	{
		Global_35462 = 1;
...
void func_21()//Position - 0xDC9
{
	func_22(&Global_93588);
}

void func_22(var uParam0)//Position - 0xDD9
{
	int iVar0;
	int iVar1;
...
void func_23(var uParam0)//Position - 0x131F
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_24(var uParam0)//Position - 0x133A
{
...
void func_25(var uParam0)//Position - 0x1369
{
	int iVar0;
...
void func_26(var uParam0)//Position - 0x1419
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_27(var uParam0)//Position - 0x1437
{
	int iVar0;
...
void func_28(var uParam0)//Position - 0x1517
{
	*uParam0 = -15;
}

void func_29()//Position - 0x1525
{
	StringCopy(&Global_91343, "", 32);
	func_22(&Global_91351);
}

void func_30()//Position - 0x153E
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x167C
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x1835
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x18C1
{
	switch (iParam0)
	{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x18FC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, int iParam2)//Position - 0x20E9
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x2173
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, int iParam2)//Position - 0x2251
{
	Global_68106[1 /*14*/] = { func_82(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x227B
{
	var uVar0;
	int iVar10;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x2876
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x290F
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x29B0
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2CB7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x386A
{
	int iVar0;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3B4E
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3E15
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3E4C
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x3E75
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4141
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x43CB
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_51(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0x4522
{
	if (iParam2 == -1)
	{
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x454B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_54(int iParam0, int iParam1)//Position - 0x4868
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_55(int iParam0)//Position - 0x4C0F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x4C70
{
	var uVar0;
	var uVar1;
...
int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x5065
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_58(int iParam0, int iParam1)//Position - 0x5344
{
	int iVar0;
	int iVar1;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x538A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0, int iParam1)//Position - 0x5486
{
	int iVar0;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55C4
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_62(int iParam0)//Position - 0x56A4
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0, int iParam1)//Position - 0x572A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x578A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_65(int iParam0)//Position - 0x580E
{
...
void func_66(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x58C6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x590F
{
	int iVar0;
...
int func_68(var uParam0)//Position - 0x593A
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x596E
{
	var uVar0;
	var uVar1;
...
bool func_70(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x59A0
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6041
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_72(int iParam0)//Position - 0x6F5F
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6FB0
{
	int iVar0;
...
int func_74(int iParam0)//Position - 0x7046
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_75(int iParam0, int iParam1)//Position - 0x70F6
{
	int iVar0;
	struct<10> Var1;
...
void func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7A25
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7B4F
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_78(int iParam0, int iParam1)//Position - 0x7B97
{
	int iVar0;
	struct<16> Var1;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x99DB
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_80(int iParam0)//Position - 0x9B8C
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9C3C
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
struct<14> func_82(int iParam0, int iParam1, int iParam2)//Position - 0x9CAD
{
	func_146();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_83(int iParam0, int iParam1)//Position - 0x9CFF
{
	switch (iParam0)
	{
		case 0:
...
void func_84(int iParam0)//Position - 0x9DEF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_85(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xB01D
{
	var uVar0;
	int iVar1;
...
bool func_86(int iParam0, int iParam1, var uParam2)//Position - 0xB39F
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_87(int iParam0, int iParam1)//Position - 0xB7A4
{
	switch (iParam1)
	{
		case 0:
...
int func_88(int iParam0, int iParam1)//Position - 0xBB9F
{
	switch (iParam1)
	{
		case 0:
...
bool func_89(int iParam0)//Position - 0xBF9A
{
	return Global_34913 == iParam0;
}

int func_90(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xBFA8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0)//Position - 0xBFEA
{
	switch (iParam0)
	{
		case -1:
...
void func_92(int iParam0, int iParam1, int iParam2)//Position - 0xC0CD
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
...
void func_93(int iParam0)//Position - 0xC347
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0xC493
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xC99F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xCA12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xCA84
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xCB6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xCEAB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xD0B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xD2D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xD3D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xDD6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xE8C1
{
	if (iParam0 < 136)
	{
		func_106(iParam0);
...
void func_105(int iParam0)//Position - 0xE8F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xF4F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x103F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x10525
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0, int iParam1)//Position - 0x1061B
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0)//Position - 0x1070B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x11BD7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x11D1D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x12226
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x1288E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x12900
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x129CF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x12EC9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x13059
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x13847
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x1394F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0x14873
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0x1551F
{
	if (iParam0 < 107)
	{
		func_125(iParam0);
...
void func_123(int iParam0)//Position - 0x15564
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0x16008
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0x16DF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0x17A35
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0x17CAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0, int iParam1)//Position - 0x17DE7
{
	switch (iParam0)
	{
		case 0:
...
void func_129(int iParam0)//Position - 0x17ED7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
bool func_201(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x24B5E
{
	func_212(uParam0, iParam1, sParam2, iParam6, iParam7, 0);
	Global_15740 = 0;
	Global_15699 = 1;
	Global_15706 = 0;
	Global_15701 = 0;
	...
	Global_2621441 = 0;
	return func_202(sParam3, iParam4, bParam8);
}

int func_202(char* sParam0, int iParam1, bool bParam2)//Position - 0x24BBD
{
	Global_15693 = 0;
...
void func_203()//Position - 0x24E89
{
	int iVar0;
...
void func_204()//Position - 0x24EBA
{
...
void func_207()//Position - 0x2500F
{
	if (func_89(14))
	{
...
int func_208()//Position - 0x250B0
{
	func_153();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_209()//Position - 0x250C9
{
	int iVar0;
...
bool func_210(int iParam0, int iParam1)//Position - 0x25120
{
	switch (iParam0)
	{
		case 5:
...
void func_211()//Position - 0x2515B
{
...
void func_212(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x251B2
{
...
void func_213(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x25208
{
...
void func_214()//Position - 0x252A3
{
	Global_14558 = 0;
	func_215();
}

void func_215()//Position - 0x252B3
{
...
void func_216()//Position - 0x252EA
{
	Global_14558 = 0;
	func_217();
}

void func_217()//Position - 0x252FA
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_219(int iParam0, bool bParam1)//Position - 0x2533D
{
...
void func_220(int iParam0, int iParam1, int iParam2)//Position - 0x25379
{
	if (func_303() && func_221())
	{
...
bool func_221()//Position - 0x2543D
{
	return MISC::IS_BIT_SET(Global_89962.f_20, 13);
}

void func_222(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x25451
{
	if (func_303())
	{
...
void func_223(struct<6> Param0, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x254E6
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_225(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
float func_224(var uParam0)//Position - 0x257CB
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(uParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_225(int iParam0, int iParam1, int iParam2)//Position - 0x257DE
{
	struct<2> Var0;
	int iVar2;
...
char* func_226(int iParam0)//Position - 0x258B4
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_227(int iParam0)//Position - 0x25A07
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_228(int iParam0)//Position - 0x25A3A
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_229(int iParam0)//Position - 0x25A6D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_230(int iParam0)//Position - 0x25AA0
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_231(int iParam0)//Position - 0x25AD3
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_232(int iParam0)//Position - 0x25B10
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_233(int iParam0)//Position - 0x25B43
{
	struct<2> Var0;
...
int func_234(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x25BAC
{
	if (((!func_237(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
bool func_235(bool bParam0)//Position - 0x25CC4
{
	if (bParam0)
	{
...
int func_236(int iParam0)//Position - 0x25CED
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
int func_237(int iParam0)//Position - 0x25D47
{
	if (Global_34913 == 15)
	{
		return 0;
...
bool func_238(int iParam0)//Position - 0x25D69
{
	return func_239(iParam0, Global_34913);
}

int func_239(int iParam0, int iParam1)//Position - 0x25D7A
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_240(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x25F5B
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_303() || !func_301())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_298(iParam6, iParam7, iParam8))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_284(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		...
		func_277(Param1, 5f, 0);
		if (func_150(iParam12))
		{
			func_275(iParam12, 0);
			while (!func_241(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_241(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x260E3
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_271(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_271(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, Param2, fParam5, 1, 1);
				...
				func_271(iParam0, &(Var5.f_31), &(Var5.f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 1)
				{
...
void func_242(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x26EC9
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_247(*iParam1, 0, &uVar0))
		{
			func_246(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_245(*iParam1);
				...
				func_243(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_243(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_243(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x27AA8
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_244(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_244(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x27B1B
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_245(int iParam0)//Position - 0x2900E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_246(int iParam0, var uParam1, var uParam2)//Position - 0x290CC
{
	int iVar0;
	int iVar1;
...
int func_247(int iParam0, bool bParam1, var uParam2)//Position - 0x291A6
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	if (!func_249(iVar0, bParam1, uParam2))
	{
		return 0;
	}
	...
	{
		if ((func_248(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_248(int iParam0)//Position - 0x29248
{
	int iVar0;
...
int func_249(int iParam0, bool bParam1, var uParam2)//Position - 0x29283
{
	if (!bParam1)
	{
...
int func_250(int iParam0)//Position - 0x2961D
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_251(int iParam0, int iParam1)//Position - 0x29646
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_252(iParam0, &(Global_97353.f_18371.f_4742));
}

void func_252(int iParam0, var uParam1)//Position - 0x29847
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_253(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_253(int iParam0)//Position - 0x29AF3
{
	switch (iParam0)
	{
		case 1:
...
int func_254(int iParam0)//Position - 0x29BA3
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_266(iParam0, 0, 0)) || func_266(iParam0, 1, 0)) || func_266(iParam0, 2, 0)) || func_265(iParam0) != 145) || func_264(iParam0)) || func_263(iParam0)) || func_248(iParam0)) || func_262(iParam0)) || !func_255(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_263(iParam0))
		{
		}
...
int func_255(int iParam0)//Position - 0x29C80
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_256(int iParam0)//Position - 0x29E30
{
	int iVar0;
	struct<2> Var1;
...
int func_257()//Position - 0x29FFF
{
	return 0;
}

int func_258()//Position - 0x2A008
{
	return 1;
}

int func_259()//Position - 0x2A011
{
	return 1;
}

int func_260()//Position - 0x2A01A
{
...
int func_262(int iParam0)//Position - 0x2A0B6
{
	int iVar0;
	char* sVar1;
...
int func_263(int iParam0)//Position - 0x2A0FB
{
	int iVar0;
...
int func_264(int iParam0)//Position - 0x2A177
{
	int iVar0;
...
int func_265(int iParam0)//Position - 0x2A25F
{
	int iVar0;
...
int func_266(int iParam0, int iParam1, bool bParam2)//Position - 0x2A2C2
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_267(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2A333
{
...
void func_268(int iParam0, int iParam1)//Position - 0x2A40B
{
	int iVar0;
...
void func_269(var uParam0)//Position - 0x2A48D
{
	if (!func_270(*uParam0))
	{
...
bool func_270(int iParam0)//Position - 0x2A4B8
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_271(var uParam0, var uParam1, var uParam2)//Position - 0x2A4C7
{
	int iVar0;
	int iVar1;
...
int func_272(int iParam0)//Position - 0x2A5F9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_273(var uParam0, var uParam1)//Position - 0x2A6D5
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_274(int iParam0, var uParam1, int iParam2)//Position - 0x2A716
{
	int iVar0;
	struct<74> Var1;
...
void func_275(int iParam0, int iParam1)//Position - 0x2A98E
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_276(iParam0, iParam1))
				{
...
int func_276(int iParam0, int iParam1)//Position - 0x2AA2F
{
	struct<58> Var0;
...
void func_277(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2AA71
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_282(&(Global_67138.f_555[0 /*21*/]), iVar0))
		{
...
void func_278(int iParam0)//Position - 0x2AAC1
{
	bool bVar0;
	...
	if (func_282(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_179(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_280(0, Global_67138.f_555[0 /*21*/].f_12) || !func_280(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_279(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
void func_279(struct<54> Param0, var uParam54)//Position - 0x2AC36
{
...
int func_280(int iParam0, int iParam1)//Position - 0x2AD01
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_281(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_256(Global_97353.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}

int func_281(var uParam0)//Position - 0x2AD72
{
	return *uParam0;
}

int func_282(var uParam0, int iParam1)//Position - 0x2AD7D
{
	int iVar0;
	int iVar1;
...
bool func_283(struct<3> Param0, struct<3> Param3)//Position - 0x2C472
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_284(struct<3> Param0, float fParam3)//Position - 0x2C49B
{
	return func_285(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_285(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2C4B5
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_294(uParam0))
	{
		...
		if (func_293(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_290(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
					{
						...
						{
							func_275(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_275(uParam0->f_11, 2);
						}
					}
					...
					func_268(iVar0, uParam0->f_11);
				}
				else if ((!func_287(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_286(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_286(int iParam0)//Position - 0x2C760
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_287(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2C822
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_289(iParam0, Global_67138.f_139[38], 0))
			{
				func_278(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_289(iParam0, Global_67138.f_139[43], 1))
			{
				func_278(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_289(iParam0, uVar1[iVar6], 1) && func_288(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_283(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_288(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2CA28
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_289(int iParam0, int iParam1, bool bParam2)//Position - 0x2CA74
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_290(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x2CAD4
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_292(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_291())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_271(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_253(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
bool func_291()//Position - 0x2CEC1
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_292(int iParam0)//Position - 0x2CED2
{
	var uVar0;
...
int func_293(var uParam0)//Position - 0x2CF1D
{
	if (func_294(uParam0))
	{
...
int func_294(var uParam0)//Position - 0x2CF52
{
	if (uParam0->f_12.f_42 == 0)
	{
		return 0;
	}
	if (!func_256(uParam0->f_12.f_42))
	{
		return 0;
	}
	return 1;
...
bool func_295()//Position - 0x2CF7B
{
	return func_293(&(Global_93588.f_2167));
}

void func_296()//Position - 0x2CF8E
{
	func_297(&(Global_93588.f_2167));
}

void func_297(var uParam0)//Position - 0x2CFA1
{
	if (func_294(uParam0))
	{
...
int func_298(int iParam0, int iParam1, int iParam2)//Position - 0x2CFBF
{
	...
	if (iParam2 == 0 && func_300(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_300(int iParam0)//Position - 0x2D0A3
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_301()//Position - 0x2D0FC
{
	return func_294(&(Global_93588.f_2167));
}

int func_302(var uParam0)//Position - 0x2D10F
{
	uParam0->f_16 = 3;
...
void func_304()//Position - 0x2D15E
{
	if (func_320())
	{
	}
	func_305(&Local_82, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_305(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x2D17A
{
...
void func_306(var uParam0, bool bParam1)//Position - 0x2D19A
{
	func_307(&(uParam0->f_41), bParam1);
}

void func_307(var uParam0, bool bParam1)//Position - 0x2D1AC
{
	int iVar0;
...
void func_308(var uParam0, bool bParam1)//Position - 0x2D1EA
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_309(var uParam0)//Position - 0x2D225
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_310(var uParam0, bool bParam1)//Position - 0x2D250
{
	func_311(&(uParam0->f_35), bParam1);
}

void func_311(var uParam0, bool bParam1)//Position - 0x2D262
{
	int iVar0;
...
void func_312(var uParam0)//Position - 0x2D29F
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_313(var uParam0)//Position - 0x2D2D6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_314(int iParam0)//Position - 0x2D372
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
...
int func_315(int iParam0)//Position - 0x2D392
{
	if (func_314(uParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
...
void func_316(var uParam0, int iParam1)//Position - 0x2D3BC
{
	func_317(&(uParam0->f_28), iParam1);
}

void func_317(var uParam0, int iParam1)//Position - 0x2D3CE
{
	int iVar0;
...
void func_318(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2D40F
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_319(var uParam0)//Position - 0x2D45E
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_321(bool bParam0)//Position - 0x2D53E
{
	int iVar0;
	...
	if (!func_340())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_322(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_96440[iVar0 /*10*/].f_9 == -1)
...
void func_322(char* sParam0, int iParam1)//Position - 0x2D60E
{
	if (Global_89962 != 12)
	{
		if (func_323(sParam0, 6, iParam1))
		{
...
int func_323(char* sParam0, int iParam1, int iParam2)//Position - 0x2D636
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_329())
	{
		...
		{
			iVar33 = func_324(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_324(char* sParam0)//Position - 0x2D7C8
{
...
int func_326(char* sParam0, bool bParam1)//Position - 0x2D842
{
	int iVar0;
	int iVar1;
...
int func_327(int iParam0, bool bParam1)//Position - 0x2D86C
{
	int iVar0;
...
int func_329()//Position - 0x2D8F2
{
	...
	{
		if (func_324(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_330(int iParam0)//Position - 0x2D95E
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_331(int iParam0)//Position - 0x2D972
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_332(int iParam0)//Position - 0x2D9AF
{
	if (iParam0 == 1)
	{
...
void func_333()//Position - 0x2D9EC
{
	Global_17098.f_5 = 1;
}

void func_334()//Position - 0x2D9FA
{
	Global_17098.f_5 = 0;
}

void func_335(bool bParam0)//Position - 0x2DA08
{
	if (bParam0)
	{
		func_336();
...
void func_336()//Position - 0x2DA6B
{
...
void func_337(int iParam0)//Position - 0x2DA94
{
	if (Global_14551)
	{
		func_338(0, 0);
...
void func_338(bool bParam0, bool bParam1)//Position - 0x2DB04
{
	if (bParam0)
	{
		if (func_236(0))
...
void func_339()//Position - 0x2DB78
{
	Global_84543 = 0;
	Global_84544 = 0;
}

int func_340()//Position - 0x2DB8A
{
	if (((Global_89962 == 13 || Global_89962 == 10) || Global_89962 == 11) || Global_89962 == 12)
	{
		return 0;
...
void func_341()//Position - 0x2DBC8
{
	Global_89997 = 1;
...
void func_342(char* sParam0)//Position - 0x2DCB5
{
...
void func_343()//Position - 0x2DCC7
{
	int iVar0;
...
void func_344(var uParam0)//Position - 0x2DCE7
{
	func_345(&(uParam0->f_28));
	func_345(&(uParam0->f_35));
	func_345(&(uParam0->f_41));
}

void func_345(var uParam0)//Position - 0x2DD07
{
	int iVar0;
...
int func_346(int iParam0)//Position - 0x2DD41
{
	if (!func_150(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
