...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_29 = 180f;
	iLocal_32 = 3;
	uLocal_77 = func_346(49);
	Local_80 = { ScriptParam_247 };
	func_344(&Local_80);
	func_343();
	...
	while (true)
	{
		...
		func_223(Local_80.f_9, 0, 0, 0, 0, 0);
		switch (iLocal_78)
		{
			case 0:
				func_1();
...
void func_1()//Position - 0x11D
{
	switch (iLocal_79)
	{
		...
		case 1:
			...
			func_213(&uLocal_82, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
			func_213(&uLocal_82, 3, 0, "BARRY", 0, 1);
			iLocal_81 = 0;
			iLocal_79 = 2;
			break;
		...
		case 2:
			if (!iLocal_81)
			{
				if (func_201(&uLocal_82, 49, "BARR4AU", "BAR4_RCM_LI", 11, 1, 0, 0, 0))
				{
...
void func_222(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x25451
{
	if (func_303())
	{
...
void func_223(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x254E6
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_10B93 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_225(Global_10B94, Global_10B96, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar1)
			{
				...
				default:
					StringCopy(&Var0, func_226(iVar1), 8);
					break;
			}
			break;
...
{
	if (((!func_237(0) || Global_10BA2) || Global_10B97 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_10B93)
...
{
	return func_239(iParam0, Global_8861);
}
...
void func_240(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x25F5B
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_298(iParam4, iParam5, iParam6))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_284(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_275(iParam10, 0);
			while (!func_241(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_241(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x260E3
{
	var uVar0;
	var uVar1;
	struct<73> Var2;
		...
		if (Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_271(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_39));
		...
		else if (Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_271(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, 1, 1);
				...
				func_271(iParam0, &(Var2.f_1F), &(Var2.f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 1)
				{
...
void func_242(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x26EC9
{
	...
	if ((func_150(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_246(iParam1, &(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_39));
			if (bParam3)
			{
				...
				Global_17C49.f_5B2F[iParam0 /*43*/].f_1F = func_245(*iParam1);
				...
				func_243(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_1));
				...
				func_243(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_243(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x27AA8
{
	...
	iVar0 = 0;
	while (func_244(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
void func_251(int iParam0, int iParam1)//Position - 0x29646
{
	...
	func_252(iParam0, &(Global_17C49.f_47C3.f_1286));
}
...
void func_252(int iParam0, var uParam1)//Position - 0x29847
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_246(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_35), func_253(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_275(int iParam0, int iParam1)//Position - 0x2A98E
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15692[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_15692[iVar0]) == func_276(iParam0, iParam1))
				{
...
void func_277(struct<3> Param0, float fParam1, int iParam2)//Position - 0x2AA71
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_282(&(Global_10642.f_22B[0 /*21*/]), iVar0))
		{
...
void func_278(int iParam0)//Position - 0x2AAC1
{
	...
	if (func_282(&(Global_10642.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_179(iParam0, 0)) && Global_109CF.f_2A == 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] != 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] > 3) && (!func_280(0, Global_10642.f_22B[0 /*21*/].f_C) || !func_280(1, Global_10642.f_22B[0 /*21*/].f_C)))
			{
				func_279(Global_17C49.f_47C3.f_45[Global_10642.f_22B[0 /*21*/].f_E /*54*/], &Global_109CF);
...
void func_279(struct<54> Param0, var uParam1)//Position - 0x2AC36
{
...
int func_280(int iParam0, int iParam1)//Position - 0x2AD01
{
	...
	if (iParam0 < 0 || iParam0 >= func_281(&(Global_17C49.f_47C3.f_113E[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_256(Global_17C49.f_47C3.f_113E[iVar0 /*109*/][iParam0 /*54*/].f_2A);
}
...
bool func_283(struct<3> Param0, struct<3> Param1)//Position - 0x2C472
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_284(struct<3> Param0, float fParam1)//Position - 0x2C49B
{
	return func_285(&(Global_16D94.f_877), Param0, fParam1, 0);
}

int func_285(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2C4B5
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_294(uParam0))
	{
		...
		if (func_293(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_290(iVar0, &(uParam0->f_C), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_275(uParam0->f_B, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_275(uParam0->f_B, 2);
						}
					}
					...
					func_268(iVar0, uParam0->f_B);
				}
				else if ((!func_287(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar4 = func_286(iVar0);
					if (iVar4 == -1)
					{
						uParam0->f_A = 0;
					}
...
int func_287(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x2C822
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_289(iParam0, Global_10642.f_8B[38], 0))
			{
				func_278(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_289(iParam0, Global_10642.f_8B[43], 1))
			{
				func_278(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_289(iParam0, uVar1[iVar3], 1) && func_288(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam2 || func_283(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_288(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2CA28
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_290(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x2CAD4
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_35, 15) || func_292(iParam0)) || (((uParam1->f_26 == 0 && uParam1->f_27 == 0) && uParam1->f_28 == 0) && uParam1->f_9[20] > 0)) && func_291())
		{
			uParam1->f_26 = 0;
			uParam1->f_27 = 0;
			uParam1->f_28 = 0;
		...
		if (bParam3)
		{
			func_271(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_2A) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_2A))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_35, func_253(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
{
	return func_293(&(Global_16D94.f_877));
}

void func_296()//Position - 0x2CF8E
{
	func_297(&(Global_16D94.f_877));
}
...
int func_298(int iParam0, int iParam1, int iParam2)//Position - 0x2CFBF
{
	...
	if (iParam2 == 0 && func_300(Global_16D94.f_877.f_C.f_2A))
	{
		return 0;
	}
	if (iParam0 == 1)
...
{
	return func_294(&(Global_16D94.f_877));
}
...
int func_323(char* sParam0, int iParam1, int iParam2)//Position - 0x2D636
{
	...
	if (func_329())
	{
		...
		{
			iVar2 = func_324(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_329()//Position - 0x2D8F2
{
	...
	{
		if (func_324(&(Global_15F6A.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_345(&(uParam0->f_1C));
	func_345(&(uParam0->f_23));
	func_345(&(uParam0->f_29));
}
