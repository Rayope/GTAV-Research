#region Local Var
	...
	int iLocal_199 = 0;
	int iLocal_200 = 0;
	char* sLocal_201[3] = { NULL, NULL, NULL };
...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_187 = "FBIPRD";
	Local_193 = { 0f, 0f, 0f };
	Local_194 = { -1335.314f, -1277.943f, 3.8649f };
	Local_195 = { -1336.378f, -1279.056f, 3.855f };
	iLocal_198 = -1;
	sLocal_202 = "FBIPRAU";
	...
	if (func_215(0))
	{
		Global_17C49.f_6C1.f_21B.f_657[0] = -99;
		Global_17C49.f_6C1.f_21B.f_657[1] = -99;
		Global_17C49.f_6C1.f_21B.f_657[2] = -99;
		func_188();
	}
	while (true)
	{
...
void func_1()//Position - 0x1CD
{
	switch (iLocal_80)
	{
		case 0:
			...
			HUD::CLEAR_HELP(1);
			func_20();
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_186))
			{
				if (MISC::ARE_STRINGS_EQUAL(sLocal_186, "PRE_FKICKOFF"))
				{
					while ((MISC::GET_GAME_TIMER() - iLocal_198) < 3000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_4(int iParam0)//Position - 0x289
{
	int iVar0;
	
	if (Global_17C49.f_1CAD || func_215(0))
	{
		iVar0 = func_17();
		if (!func_5(iVar0))
		{
...
int func_5(int iParam0)//Position - 0x2CE
{
	int iVar0;
	int iVar1;
...
void func_6(var uParam0, int iParam1)//Position - 0x3E5
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_7(var uParam0)//Position - 0x5AE
{
	*uParam0 = -15;
}

int func_8(int iParam0, var uParam1, float fParam2)//Position - 0x5BC
{
	switch (iParam0)
	{
		case 11:
...
void func_9(int iParam0, bool bParam1)//Position - 0xF2B
{
	if (bParam1)
	{
...
int func_11()//Position - 0x1050
{
	func_12();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_12()//Position - 0x1069
{
	int iVar0;
...
bool func_13(int iParam0)//Position - 0x1166
{
	return Global_8861 == iParam0;
}

bool func_14(int iParam0)//Position - 0x1174
{
	return iParam0 < 3;
}

int func_15(int iParam0)//Position - 0x1180
{
	int iVar0;
	int iVar1;
...
int func_16(int iParam0)//Position - 0x11BD
{
	if (func_14(iParam0))
	{
...
void func_18(char* sParam0)//Position - 0x121C
{
	func_19(sParam0);
	func_4(0);
}

void func_19(char* sParam0)//Position - 0x122F
{
...
void func_20()//Position - 0x126E
{
	func_21(&uLocal_191);
}

void func_21(var uParam0)//Position - 0x127C
{
...
void func_22()//Position - 0x129C
{
	switch (iLocal_80)
	{
		...
		case 1:
			if (func_86(PLAYER::PLAYER_PED_ID(), Local_195, 2f) && func_80(21))
			{
			...
			else
			{
				...
				else if (!func_86(PLAYER::PLAYER_PED_ID(), Local_194, 75f))
				{
					if (!iLocal_200)
					{
						func_21(&uLocal_191);
					...
					func_77(&uLocal_191, Local_195, 1, 1, "PRD_SHOP");
				}
				else if (func_86(PLAYER::PLAYER_PED_ID(), Local_195, 12f))
				{
					if (iLocal_200)
					{
						func_21(&uLocal_191);
					...
					func_77(&uLocal_191, Local_195, 1, 1, "PRD_BLIP");
					if (HUD::DOES_BLIP_EXIST(uLocal_191))
					{
						HUD::SET_BLIP_COLOUR(uLocal_191, 2);
						HUD::SET_BLIP_ROUTE_COLOUR(uLocal_191, 2);
					}
				}
			}
			break;
		...
		case 2:
			if ((MISC::GET_GAME_TIMER() - iLocal_197) > 2000)
			{
				func_21(&uLocal_191);
				if (func_41(&uLocal_372, &cLocal_368, &uLocal_203))
				{
					func_40(0, -1);
					if ((Global_17C49.f_6C1.f_21B.f_657[0] == 38 && Global_17C49.f_6C1.f_21B.f_657[1] == 33) && Global_17C49.f_6C1.f_21B.f_657[2] == 54)
					{
						func_39(821);
					}
					func_36();
		...
		case 3:
			Global_17C49.f_6C1.f_21B.f_657[0] = 38;
			Global_17C49.f_6C1.f_21B.f_657[1] = 33;
			Global_17C49.f_6C1.f_21B.f_657[2] = 54;
			func_23(1, 1, 1);
			iLocal_80 = 2;
			break;
	}
...
void func_23(int iParam0, int iParam1, int iParam2)//Position - 0x1499
{
...
void func_24(int iParam0, bool bParam1)//Position - 0x14CD
{
...
void func_25(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1509
{
	var uVar0;
...
int func_26(int iParam0)//Position - 0x15B0
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x15D0
{
	if (bParam0)
	{
...
int func_28(int iParam0)//Position - 0x16A1
{
...
bool func_29()//Position - 0x16E2
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_30(int iParam0, int iParam1)//Position - 0x16F3
{
	bool bVar0;
...
int func_31(int iParam0, bool bParam1)//Position - 0x173E
{
	int iVar0;
	int iVar1;
...
int func_32()//Position - 0x177F
{
	return Global_1407E1;
}

int func_33(int iParam0, var uParam1, var uParam2)//Position - 0x178B
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0x17E3
{
	if (iParam0 == 1)
	{
...
void func_37(bool bParam0, int iParam1)//Position - 0x181C
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_215(0) && Global_10B8B.f_1 == 1) && func_38(Global_10B8B))
		{
		}
		else
		{
...
int func_38(int iParam0)//Position - 0x18F2
{
	switch (iParam0)
	{
		case 71:
...
void func_39(int iParam0)//Position - 0x1930
{
	bool bVar0;
	int iVar1;
...
void func_40(bool bParam0, int iParam1)//Position - 0x19A1
{
	int iVar0;
...
int func_41(var uParam0, char* sParam1, var uParam2)//Position - 0x1A3B
{
	switch (*uParam0)
	{
		case 0:
...
void func_42(int iParam0, int iParam1)//Position - 0x1BB0
{
...
int func_43(int iParam0)//Position - 0x1BED
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
void func_45(bool bParam0)//Position - 0x1C6A
{
...
void func_46(char* sParam0, char* sParam1)//Position - 0x1C7E
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_3D85 = 1;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1D1B
{
	struct<15> Var0;
	int iVar1;
...
void func_50(int iParam0)//Position - 0x1E6C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_51(int iParam0)//Position - 0x1F30
{
	switch (iParam0)
	{
		case 0:
...
int func_53()//Position - 0x20C0
{
	return Global_10B9B;
}

int func_54(int iParam0, int iParam1)//Position - 0x20CC
{
	int iVar0;
...
int func_55(int iParam0)//Position - 0x2128
{
	if (iParam0 > 3)
	{
		return 0;
	...
	return Global_15725[func_56(iParam0)];
}

int func_56(int iParam0)//Position - 0x2159
{
	if (iParam0 == 0)
	{
		return 0;
...
struct<4> func_57(bool bParam0)//Position - 0x2194
{
	struct<4> Var0;
...
bool func_58(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)//Position - 0x21FA
{
...
int func_59(char* sParam0, int iParam1, bool bParam2)//Position - 0x2262
{
	Global_3D4D = 0;
...
bool func_65(int iParam0, int iParam1)//Position - 0x2785
{
	switch (iParam0)
	{
		case 5:
...
void func_67(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2817
{
	Global_3B2A = { *uParam0 };
	Global_62B = uParam1;
...
void func_70(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x29AE
{
...
void func_71(int iParam0, int iParam1)//Position - 0x2A49
{
...
void func_72(bool bParam0)//Position - 0x2A8E
{
	if (bParam0)
	{
...
int func_74(int iParam0)//Position - 0x2B2A
{
...
int func_76(int iParam0)//Position - 0x2B9E
{
	if (iParam0 == 144 || iParam0 == -1)
	{
		return 0;
...
void func_77(var uParam0, struct<3> Param1, int iParam2, bool bParam3, char* sParam4)//Position - 0x2BCB
{
	if (!HUD::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_78(Param1, 5, iParam2);
		if (bParam3)
		{
...
int func_78(struct<3> Param0, int iParam1, int iParam2)//Position - 0x2BFA
{
	int iVar0;
...
bool func_79(char* sParam0, int iParam1, int iParam2)//Position - 0x2C28
{
...
int func_80(int iParam0)//Position - 0x2C46
{
	return func_81(iParam0, 6, 1);
}

int func_81(int iParam0, int iParam1, bool bParam2)//Position - 0x2C56
{
	if (bParam2)
	{
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x2CB6
{
	var uVar0;
	var uVar1;
...
int func_83(var uParam0)//Position - 0x2CE8
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0)//Position - 0x2D1C
{
	switch (iParam0)
	{
		case 0:
...
int func_85()//Position - 0x2FC5
{
	return Global_5F7C;
}

bool func_86(int iParam0, struct<3> Param1, float fParam2)//Position - 0x2FD0
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Param1) <= (fParam2 * fParam2);
}

int func_87(int iParam0, bool bParam1)//Position - 0x2FED
{
	func_92();
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_88(PLAYER::PLAYER_PED_ID(), -1339.786f, -1277.51f, 3.8874f, 261.2839f);
				bLocal_27 = false;
				func_23(1, 1, 1);
			}
			else
		...
		case 2:
			if (bParam1)
			{
				func_88(PLAYER::PLAYER_PED_ID(), Local_195, 261.2839f);
				bLocal_27 = false;
				func_23(1, 1, 1);
			}
			else
...
void func_88(var uParam0, struct<3> Param1, float fParam2)//Position - 0x3098
{
	if (func_187(uParam0))
	{
		TASK::CLEAR_PED_TASKS(uParam0);
	}
	func_89(uParam0, Param1, fParam2, 0, 1);
}

int func_89(var uParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4)//Position - 0x30BE
{
	bool bVar0;
	float fVar1;
...
int func_90(int iParam0, struct<3> Param1, float fParam2)//Position - 0x3118
{
	switch (iParam0)
	{
		case 0:
			if (func_91(Param1, Local_193, 1056964608) && fParam2 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_187, 0);
...
int func_91(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x317F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_92()//Position - 0x31CB
{
	func_93(&uLocal_203);
}

void func_93(var uParam0)//Position - 0x31D9
{
	int iVar0;
	char* sVar1;
	...
	func_70(uParam0, iVar0, PLAYER::PLAYER_PED_ID(), sVar1, 0, 1);
}

void func_94()//Position - 0x322F
{
	switch (iLocal_80)
	{
		case 0:
		...
		case 1:
			if (!iLocal_196)
			{
				if (func_86(PLAYER::PLAYER_PED_ID(), Local_194, 60f))
				{
		...
		case 3:
			func_88(PLAYER::PLAYER_PED_ID(), Local_195, 0f);
			func_23(1, 1, 1);
			iLocal_80 = 1;
			break;
	}
...
void func_95(bool bParam0)//Position - 0x3377
{
	func_96(iLocal_79);
...
void func_96(int iParam0)//Position - 0x33AA
{
	switch (iParam0)
	{
		case 0:
...
void func_97(int iParam0, bool bParam1)//Position - 0x33C2
{
	int iVar0;
...
bool func_98(int iParam0)//Position - 0x340C
{
	return func_81(iParam0, 5, 1);
}

void func_99(char* sParam0, int iParam1)//Position - 0x341C
{
	if (!*iParam1)
	{
...
void func_100(char* sParam0, int iParam1, int iParam2)//Position - 0x3439
{
	iParam2 = iParam2;
		...
		case 0:
			if (func_87(iLocal_79, 0))
			{
				...
				if (func_217())
				{
					...
					while (!func_103(21) && (MISC::GET_GAME_TIMER() - iVar0) < 2000)
					{
						SYSTEM::WAIT(0);
					}
					func_24(500, 1);
...
void func_102(int iParam0)//Position - 0x3576
{
...
bool func_103(int iParam0)//Position - 0x35AD
{
	return func_81(iParam0, 0, 1);
}

void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x35BD
{
...
void func_105(int iParam0)//Position - 0x3681
{
	if (iParam0 == 1)
	{
...
bool func_106()//Position - 0x36AA
{
	return MISC::IS_BIT_SET(Global_15F6A.f_14, 13);
}

void func_107(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x36BE
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_168(iParam4, iParam5, iParam6))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_155(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_143(iParam10, 0);
			while (!func_108(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_108(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x3846
{
	var uVar0;
	var uVar1;
	struct<73> Var2;
		...
		if (Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_139(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_39));
		...
		else if (Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_139(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, 1, 1);
				...
				func_139(iParam0, &(Var2.f_1F), &(Var2.f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 1)
				{
...
void func_109(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x462D
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_114(*iParam1, 0, &uVar0))
		{
			func_113(iParam1, &(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_39));
			if (bParam3)
			{
				...
				Global_17C49.f_5B2F[iParam0 /*43*/].f_1F = func_112(*iParam1);
				...
				func_110(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_1));
				...
				func_110(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_110(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x520C
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_111(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_111(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x527F
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_112(int iParam0)//Position - 0x6771
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_113(int iParam0, var uParam1, var uParam2)//Position - 0x682F
{
	int iVar0;
	int iVar1;
...
int func_114(int iParam0, bool bParam1, var uParam2)//Position - 0x6909
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	{
		if ((func_115(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_115(int iParam0)//Position - 0x69AB
{
	int iVar0;
...
int func_116(int iParam0, bool bParam1, var uParam2)//Position - 0x69E6
{
	if (!bParam1)
	{
...
int func_117(int iParam0)//Position - 0x6D80
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_118(int iParam0, int iParam1)//Position - 0x6DA9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_119(iParam0, &(Global_17C49.f_47C3.f_1286));
}

void func_119(int iParam0, var uParam1)//Position - 0x6FAA
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_35), func_120(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_120(int iParam0)//Position - 0x7256
{
	switch (iParam0)
	{
		case 1:
...
void func_121(var uParam0)//Position - 0x7306
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0x73B6
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_134(iParam0, 0, 0)) || func_134(iParam0, 1, 0)) || func_134(iParam0, 2, 0)) || func_133(iParam0) != 145) || func_132(iParam0)) || func_131(iParam0)) || func_115(iParam0)) || func_130(iParam0)) || !func_123(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_131(iParam0))
		{
		}
...
int func_123(int iParam0)//Position - 0x7493
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_124(int iParam0)//Position - 0x7643
{
	int iVar0;
	struct<2> Var1;
...
int func_125()//Position - 0x7812
{
	return 0;
}

int func_126()//Position - 0x781B
{
	return 1;
}

int func_127()//Position - 0x7824
{
	return 1;
}

int func_128()//Position - 0x782D
{
...
int func_130(int iParam0)//Position - 0x78C9
{
	int iVar0;
	var uVar1;
...
int func_131(int iParam0)//Position - 0x790E
{
	int iVar0;
...
int func_132(int iParam0)//Position - 0x798A
{
	int iVar0;
...
int func_133(int iParam0)//Position - 0x7A72
{
	int iVar0;
...
int func_134(int iParam0, int iParam1, bool bParam2)//Position - 0x7AD5
{
	int iVar0;
	char* sVar1;
	int iVar2;
	...
	iVar0 = 0;
	while (func_135(iParam1, iVar0, &sVar1, &iVar2))
	{
...
int func_135(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7B46
{
...
void func_136(int iParam0, int iParam1)//Position - 0x7C1E
{
	int iVar0;
...
void func_137(var uParam0)//Position - 0x7CA0
{
	if (!func_138(*uParam0))
	{
...
bool func_138(int iParam0)//Position - 0x7CCB
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_139(var uParam0, var uParam1, var uParam2)//Position - 0x7CDA
{
	int iVar0;
	int iVar1;
...
int func_140(int iParam0)//Position - 0x7E0C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_141(var uParam0, var uParam1)//Position - 0x7EE8
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_142(int iParam0, var uParam1, int iParam2)//Position - 0x7F29
{
	int iVar0;
	struct<74> Var1;
...
void func_143(int iParam0, int iParam1)//Position - 0x81A2
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15692[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_15692[iVar0]) == func_144(iParam0, iParam1))
				{
...
int func_144(int iParam0, int iParam1)//Position - 0x8243
{
	struct<58> Var0;
...
void func_145(struct<3> Param0, float fParam1, int iParam2)//Position - 0x8285
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_153(&(Global_10642.f_22B[0 /*21*/]), iVar0))
		{
...
void func_146(int iParam0)//Position - 0x82D5
{
	bool bVar0;
	...
	if (func_153(&(Global_10642.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_152(iParam0, 0)) && Global_109CF.f_2A == 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] != 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] > 3) && (!func_150(0, Global_10642.f_22B[0 /*21*/].f_C) || !func_150(1, Global_10642.f_22B[0 /*21*/].f_C)))
			{
				func_149(Global_17C49.f_47C3.f_45[Global_10642.f_22B[0 /*21*/].f_E /*54*/], &Global_109CF);
...
void func_147(int iParam0, bool bParam1)//Position - 0x844A
{
	if (iParam0 == -1)
	{
		return;
...
void func_148(int iParam0, int iParam1, bool bParam2)//Position - 0x84A7
{
	if (iParam0 == -1)
	{
		return;
...
void func_149(struct<54> Param0, var uParam1)//Position - 0x84E2
{
...
int func_150(int iParam0, int iParam1)//Position - 0x85AD
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_151(&(Global_17C49.f_47C3.f_113E[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_124(Global_17C49.f_47C3.f_113E[iVar0 /*109*/][iParam0 /*54*/].f_2A);
}

int func_151(var uParam0)//Position - 0x861E
{
	return *uParam0;
}

bool func_152(int iParam0, int iParam1)//Position - 0x8629
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_153(var uParam0, int iParam1)//Position - 0x864C
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_154(Global_17C49.f_47C3.f_520[uParam0->f_E /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_154(Global_17C49.f_6C1.f_21B.f_9E0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_154(Global_17C49.f_6C1.f_21B.f_9E0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f))
		{
...
bool func_154(struct<3> Param0, struct<3> Param1)//Position - 0x9D40
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_155(struct<3> Param0, float fParam1)//Position - 0x9D69
{
	return func_156(&(Global_16D94.f_877), Param0, fParam1, 0);
}

int func_156(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x9D83
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
	...
	if (func_164(uParam0))
	{
		...
		if (func_163(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_160(iVar0, &(uParam0->f_C), 0, 1);
				bVar2 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_143(uParam0->f_B, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_143(uParam0->f_B, 2);
						}
					}
				...
				else if ((!func_158(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_157(int iParam0)//Position - 0xA02E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_158(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xA0F0
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_159(iParam0, Global_10642.f_8B[38], 0))
			{
				func_146(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_159(iParam0, Global_10642.f_8B[43], 1))
			{
				func_146(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_159(iParam0, uVar1[iVar3], 1) && func_91(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam2 || func_154(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
int func_159(int iParam0, int iParam1, bool bParam2)//Position - 0xA2F6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_160(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xA356
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_35, 15) || func_162(iParam0)) || (((uParam1->f_26 == 0 && uParam1->f_27 == 0) && uParam1->f_28 == 0) && uParam1->f_9[20] > 0)) && func_161())
		{
			uParam1->f_26 = 0;
			uParam1->f_27 = 0;
			uParam1->f_28 = 0;
		...
		if (bParam3)
		{
			func_139(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_2A) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_2A))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_35, func_120(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
bool func_161()//Position - 0xA743
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_162(int iParam0)//Position - 0xA754
{
	var uVar0;
...
int func_163(var uParam0)//Position - 0xA79F
{
	if (func_164(uParam0))
	{
...
int func_164(var uParam0)//Position - 0xA7D4
{
	if (uParam0->f_C.f_2A == 0)
	{
		return 0;
	}
	if (!func_124(uParam0->f_C.f_2A))
	{
		return 0;
	}
	return 1;
...
bool func_165()//Position - 0xA7FD
{
	return func_163(&(Global_16D94.f_877));
}

void func_166()//Position - 0xA810
{
	func_167(&(Global_16D94.f_877));
}

void func_167(var uParam0)//Position - 0xA823
{
	if (func_164(uParam0))
	{
...
int func_168(int iParam0, int iParam1, int iParam2)//Position - 0xA841
{
	...
	if (iParam2 == 0 && func_170(Global_16D94.f_877.f_C.f_2A))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_170(int iParam0)//Position - 0xA925
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_171()//Position - 0xA97E
{
	return func_164(&(Global_16D94.f_877));
}

void func_172(int iParam0)//Position - 0xA991
{
	Global_150CE = 0;
	switch (iParam0)
	{
...
void func_173(int iParam0)//Position - 0xAA1F
{
	MISC::SET_BIT(&Global_150CE, iParam0);
}

void func_174()//Position - 0xAA31
{
	if (!bLocal_27 && iLocal_79 != 3)
	{
		if (iLocal_79 > 0)
		{
			...
			if (!bLocal_189)
			{
				if (!func_86(PLAYER::PLAYER_PED_ID(), Local_194, 150f))
				{
					func_180(2);
				}
				else if (!func_86(PLAYER::PLAYER_PED_ID(), Local_194, 75f))
...
int func_176(bool bParam0, int iParam1)//Position - 0xAB28
{
	int iVar0;
...
int func_177(int iParam0, int iParam1)//Position - 0xAB74
{
	int iVar0;
...
int func_178(int iParam0)//Position - 0xAB89
{
	return Global_CAD5[iParam0];
}

bool func_179(int iParam0)//Position - 0xAB98
{
	return func_81(iParam0, 1, 1);
}

void func_180(int iParam0)//Position - 0xABA8
{
	HUD::CLEAR_PRINTS();
	func_181();
	switch (iParam0)
...
void func_181()//Position - 0xAC0A
{
	Global_38DE = 0;
	func_66();
}

int func_182()//Position - 0xAC1A
{
	func_183();
	if (iLocal_190 >= 3)
	{
...
void func_183()//Position - 0xAC5F
{
	if (func_185())
	{
		...
		{
			case 0:
				if (Global_17C49.f_6C1.f_21B.f_657[0] == -99)
				{
					func_184(sLocal_201[0], sLocal_201[1], sLocal_201[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_657[1] == -99)
				{
					func_184(sLocal_201[1], sLocal_201[0], sLocal_201[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_657[2] == -99)
				{
					func_184(sLocal_201[2], sLocal_201[1], sLocal_201[0]);
				}
				break;
			
			case 1:
				if (Global_17C49.f_6C1.f_21B.f_657[1] == -99)
				{
					func_184(sLocal_201[1], sLocal_201[0], sLocal_201[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_657[0] == -99)
				{
					func_184(sLocal_201[0], sLocal_201[1], sLocal_201[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_657[2] == -99)
			...
			case 2:
				if (Global_17C49.f_6C1.f_21B.f_657[2] == -99)
				{
					func_184(sLocal_201[2], sLocal_201[1], sLocal_201[0]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_657[0] == -99)
...
void func_184(var uParam0, var uParam1, var uParam2)//Position - 0xAE15
{
...
bool func_185()//Position - 0xAE51
{
	return MISC::GET_GAME_TIMER() <= Global_4354.f_140A + 100;
}

int func_186()//Position - 0xAE66
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 <= 2)
	{
		if (Global_17C49.f_6C1.f_21B.f_657[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
int func_187(int iParam0)//Position - 0xAEA2
{
	if (func_26(uParam0))
	{
...
void func_189(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xAF12
{
	int iVar0;
	int iVar1;
	...
	func_190(Global_17C49.f_744E[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_190(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xAFF9
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_191(bool bParam0)//Position - 0xB5F8
{
	int iVar0;
	int iVar1;
...
void func_192(int iParam0)//Position - 0xB87A
{
	int iVar0;
...
void func_193(int iParam0)//Position - 0xB8D4
{
	bool bVar0;
	char cVar1[64];
	...
	else if (MISC::IS_BIT_SET(Global_17C49.f_5CED.f_1D7, iParam0) || MISC::IS_BIT_SET(Global_200000[func_195() /*8053*/].f_167C.f_A, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_17C49.f_5CED.f_1D7), iParam0);
		MISC::CLEAR_BIT(&(Global_200000[func_195() /*8053*/].f_167C.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_194(int iParam0)//Position - 0xB996
{
	switch (iParam0)
	{
		case 0:
...
void func_196(int iParam0)//Position - 0xBA1D
{
	func_213(93, iParam0);
	func_213(29, iParam0);
	func_213(30, iParam0);
...
bool func_197(int iParam0)//Position - 0xBA3D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return MISC::IS_BIT_SET(Global_17C49.f_5CED.f_1D7, iParam0);
	}
	return MISC::IS_BIT_SET(Global_200000[func_195() /*8053*/].f_167C.f_A, iParam0);
}

int func_198(bool bParam0)//Position - 0xBA79
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_199(int iParam0, int iParam1)//Position - 0xBB30
{
	if (iParam0 >= 61)
	{
		return 0;
...
int func_200(int iParam0, int iParam1)//Position - 0xBB4B
{
	...
	if (func_210(&Global_26D4DB))
	{
		if (func_208(&Global_26D4DB, iParam0))
		{
			return 0;
		}
		if (func_201(&Global_26D4DB, iParam0))
		{
			return 1;
		}
	}
...
int func_201(var uParam0, int iParam1)//Position - 0xBBCF
{
	int iVar0;
	var uVar1[61];
...
int func_202(var uParam0, int iParam1)//Position - 0xBC55
{
	int iVar0;
...
bool func_203(var uParam0, int iParam1)//Position - 0xBCA5
{
	return (*uParam0)[iParam1] == 61;
}

void func_204(var uParam0)//Position - 0xBCB6
{
	int iVar0;
	...
	func_205(&(uParam0->f_3E), (8f - 0.5f));
}

void func_205(var uParam0, float fParam1)//Position - 0xBCED
{
	uParam0->f_1 = (func_206(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
	MISC::SET_BIT(uParam0, 1);
	MISC::CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}

float func_206(bool bParam0)//Position - 0xBD1B
{
	int iVar0;
...
void func_207(var uParam0, int iParam1)//Position - 0xBD63
{
	(*uParam0)[iParam1] = 61;
}

bool func_208(var uParam0, int iParam1)//Position - 0xBD73
{
	return func_209(uParam0, iParam1) != -1;
}

int func_209(var uParam0, int iParam1)//Position - 0xBD85
{
	int iVar0;
...
bool func_210(var uParam0)//Position - 0xBDB2
{
	return uParam0->f_44 == 1;
}

int func_211(int iParam0, int iParam1)//Position - 0xBDC0
{
	int iVar0;
...
void func_212(int iParam0, int iParam1)//Position - 0xBE11
{
	int iVar0;
...
void func_213(int iParam0, int iParam1)//Position - 0xBE34
{
	int iVar0;
...
bool func_215(bool bParam0)//Position - 0xBF06
{
...
void func_216(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0xBF31
{
	if (func_217())
	{
...
int func_219(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xC33D
{
	Global_10A0A[1 /*14*/] = { func_221(iParam0, iParam1, iParam2) };
	if (MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_220(iParam1, Global_10A0A[1 /*14*/].f_5, Global_10A0A[1 /*14*/].f_2, 0, Global_10A0A[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_220(iParam1, Global_10A0A[1 /*14*/].f_5, Global_10A0A[1 /*14*/].f_2, 0, Global_10A0A[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_220(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC3D8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_221(int iParam0, int iParam1, int iParam2)//Position - 0xD2F6
{
	func_286();
...
void func_222(int iParam0, int iParam1)//Position - 0xD348
{
	switch (iParam0)
	{
		case 0:
...
void func_223(int iParam0)//Position - 0xD438
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_224(&(Global_10A0A[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_224(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE6AE
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_228(Global_280004, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_228(Global_280004, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_13(14))
			{
				uVar0 = func_82(func_227(iParam1, uParam0->f_2), Global_10A08, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_82(func_226(iParam1, uParam0->f_2), Global_10A08, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
...
bool func_225(int iParam0, int iParam1, var uParam2)//Position - 0xEA31
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_226(int iParam0, int iParam1)//Position - 0xEE36
{
	switch (iParam1)
	{
		case 0:
...
int func_227(int iParam0, int iParam1)//Position - 0xF231
{
	switch (iParam1)
	{
		case 0:
...
int func_228(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF62C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_229(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xF66E
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xFD0F
{
	switch (iParam0)
	{
		case -1:
...
void func_231(int iParam0, int iParam1, int iParam2)//Position - 0xFDE3
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_224(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_224(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_224(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 6, -1, 0, -1, func_232(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_224(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
int func_232(int iParam0)//Position - 0x10060
{
	switch (iParam0)
	{
		case 0:
...
void func_233(int iParam0)//Position - 0x10110
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_234(int iParam0)//Position - 0x10266
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_235(int iParam0)//Position - 0x10773
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_236(int iParam0)//Position - 0x107E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_237(int iParam0)//Position - 0x1085A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_238(int iParam0)//Position - 0x10940
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_239(int iParam0)//Position - 0x10CA2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_240(int iParam0)//Position - 0x10EB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_241(int iParam0)//Position - 0x110E1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_242(int iParam0)//Position - 0x111F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_243(int iParam0)//Position - 0x11B8E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_244(int iParam0)//Position - 0x12700
{
	if (iParam0 < 136)
	{
		func_246(iParam0);
...
void func_245(int iParam0)//Position - 0x12734
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_246(int iParam0)//Position - 0x13338
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_247(int iParam0)//Position - 0x14248
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_248(int iParam0)//Position - 0x14374
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_249(int iParam0, int iParam1)//Position - 0x14471
{
	switch (iParam0)
	{
		case 0:
...
void func_250(int iParam0)//Position - 0x14561
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_251(int iParam0)//Position - 0x15A51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252(int iParam0)//Position - 0x15BA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x160AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x16718
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x1678B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0)//Position - 0x1685A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x16D89
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x16F1F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x1771C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x1782B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x18758
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x19414
{
	if (iParam0 < 107)
	{
		func_265(iParam0);
...
void func_263(int iParam0)//Position - 0x19459
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x19EFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x1ACED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1B936
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1BBAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0, int iParam1)//Position - 0x1BCF3
{
	switch (iParam0)
	{
		case 0:
...
void func_269(int iParam0)//Position - 0x1BDE3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1CD61
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1CEDA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1D450
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1D979
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1D9EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1DABB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1DF92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1E1FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1E4CF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1E697
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1F1EA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1FE33
{
	if (iParam0 < 60)
	{
		func_283(iParam0);
...
void func_282(int iParam0)//Position - 0x1FE67
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x20D79
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x21405
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x214EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286()//Position - 0x215E8
{
...
void func_287()//Position - 0x21661
{
	func_296();
	func_295();
	func_288();
...
void func_288()//Position - 0x21675
{
	struct<3> Var0[8];
...
void func_289(var uParam0, int iParam1)//Position - 0x216E2
{
	int iVar0;
...
void func_290(var uParam0, var uParam1, float fParam2)//Position - 0x21726
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_2E)
	{
		...
		if (func_291(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
...
bool func_291(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x21833
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_292(var uParam0)//Position - 0x218EF
{
	int iVar0;
	float fVar1;
...
void func_293(var uParam0, struct<3> Param1)//Position - 0x2198F
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_294(var uParam0)//Position - 0x219C0
{
	if (uParam0->f_33)
	{
	}
...
void func_295()//Position - 0x219E7
{
	sLocal_201[0] = "PRD_BUYM";
	sLocal_201[1] = "PRD_BUYF";
	sLocal_201[2] = "PRD_BUYT";
}

void func_296()//Position - 0x21A07
{
}

void func_297()//Position - 0x21A0F
{
	func_308(1);
	func_307();
	func_298(0);
...
void func_298(bool bParam0)//Position - 0x21A29
{
	if (bParam0)
	{
	}
	...
	if (CAM::DOES_CAM_EXIST(uLocal_192))
	{
		CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		CAM::DESTROY_CAM(uLocal_192, 0);
	}
}

void func_299()//Position - 0x21A94
{
}

void func_300()//Position - 0x21A9C
{
	Global_38DE = 0;
	func_301();
}

void func_301()//Position - 0x21AAC
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_302()//Position - 0x21ACD
{
}

void func_303()//Position - 0x21AD5
{
}

void func_304()//Position - 0x21ADD
{
}

void func_305()//Position - 0x21AE5
{
}

void func_306(bool bParam0, int iParam1, int iParam2)//Position - 0x21AED
{
	bool bVar0;
...
void func_307()//Position - 0x21B4C
{
	Global_150CE = 0;
}

void func_308(bool bParam0)//Position - 0x21B59
{
...
void func_309()//Position - 0x21BA0
{
	int iVar0;
...
void func_311()//Position - 0x21C4F
{
	Global_17C49.f_6C1.f_21B.f_657[0] = -99;
	Global_17C49.f_6C1.f_21B.f_657[1] = -99;
	Global_17C49.f_6C1.f_21B.f_657[2] = -99;
