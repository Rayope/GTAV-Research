		...
		switch (iLocal_283)
		{
			...
			case 1:
				...
				else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15691))
				{
					...
					if (!ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_293, &cLocal_311, 2))
					{
						TASK::CLEAR_PED_TASKS(*uParam0);
						ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(*uParam0, -16f, 1);
						PED::SET_PED_MOVE_ANIMS_BLEND_OUT(*uParam0);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_289 + Local_291, 1f, -1, (fLocal_292 * 0.1f), 0, 1193033728);
					...
					else
					{
						...
						if (!ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_293, &cLocal_311, "WalkInterruptible", &fVar1, &uVar2))
						{
						}
						else
						{
							if (fLocal_331 >= 0f)
							{
								if (fVar0 >= fLocal_331)
								{
									func_112(*uParam0, "DISMISS_MICHAEL", "AMANDA_NORMAL", 24);
									fLocal_331 = -1f;
								}
							}
							if (fVar0 >= fVar1)
				...
				else if (iLocal_92 != 151)
				{
					TASK::CLEAR_PED_TASKS(*uParam0);
					if (MISC::IS_STRING_NULL_OR_EMPTY(&cLocal_320))
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Local_289 + Local_291, 1f, -1, (fLocal_292 * 0.1f), 0, 1193033728);
						PED::FORCE_PED_MOTION_STATE(*uParam0, -668482597, 0, 0, 0);
						PED::CLEAR_RAGDOLL_BLOCKING_FLAGS(*uParam0, 2);
					...
					{
						TASK::TASK_START_SCENARIO_AT_POSITION(*uParam0, &cLocal_320, Local_289 + Local_329, (fLocal_290 + fLocal_330), 0, 0, 1);
			...
			case 3:
				...
				{
					if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_289 + Local_291) < (fLocal_292 * fLocal_292))
					{
						if (fLocal_292 == 0f)
						{
							fLocal_292 = (SYSTEM::VMAG(Local_291) * 0.75f);
						}
						TASK::TASK_WANDER_IN_AREA(*uParam0, Local_289 + Local_291, fLocal_292, 1077936128, 1086324736);
						func_113(4, 0);
						return 1;
					}
				}
			...
			case 4:
				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Local_289 + Local_291) < (fLocal_292 * fLocal_292))
				{
					if (TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_289 + Local_291, fLocal_292, 1))
					{
						TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD(*uParam0, Local_289 + Local_291, fLocal_292, 0);
			...
			case 5:
				...
				else
				{
					...
					Var4 = { func_4(Local_289 + Local_291, (fLocal_292 * 0.9f), 0f) };
					if (PATHFIND::GET_SAFE_COORD_FOR_PED(Var4, 0, &Var5, 14))
					{
						if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(*uParam0, 1), Var5) > 100f)
						{
							TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(*uParam0, Var5, 1f, -1, 0.25f, 0, 1193033728);
							Var6 = { ENTITY::GET_ENTITY_COORDS(*uParam0, 1) - Vector(2f, 2f, 2f) };
							Var7 = { ENTITY::GET_ENTITY_COORDS(*uParam0, 1) + Vector(2f, 2f, 2f) };
							uLocal_332 = PED::ADD_SCENARIO_BLOCKING_AREA(Var6, Var7, 0, 0, 1, 1);
			...
			case 7:
				...
				func_7(*uParam0);
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_293, &cLocal_302, 2))
				{
				}
				else if (ENTITY::IS_ENTITY_PLAYING_ANIM(*uParam0, &cLocal_293, &cLocal_311, 2))
				{
				}
				break;
...
Vector3 func_4(struct<3> Param0, float fParam1, float fParam2)//Position - 0x86E
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
Vector3 func_5(struct<3> Param0, float fParam1, float fParam2)//Position - 0x8E7
{
	struct<3> Var0;
	float fVar1;
...
Vector3 func_6(struct<3> Param0, float fParam1)//Position - 0x92F
{
	float fVar0;
...
void func_7(var uParam0)//Position - 0x966
{
	...
	if (PED::IS_PED_INJURED(uParam0))
	{
		if (!iLocal_335 && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0, PLAYER::PLAYER_PED_ID(), 1))
		{
			...
			if (iVar2 != -1)
			{
				...
				if (iVar3 != 0)
				{
					if (!func_103(iVar2) || func_95(iVar2) == 6)
					{
						func_94(75, ENTITY::GET_ENTITY_COORDS(uParam0, 0), 250f, -1);
						if (func_40(Global_15055, iVar0, 2, 0, iVar3, iVar2, 75))
						{
							iLocal_335 = 1;
						}
					}
	...
	func_10(uParam0, 138, &uLocal_93, "FMMAUD", &uLocal_258, &uLocal_279, 3);
	...
	else
	{
		...
		if (iLocal_333 > 0)
		{
			if (iLocal_334 == 0)
			{
				if (iLocal_333 + 15000 < MISC::GET_GAME_TIMER())
				{
			...
			else if (iLocal_333 + 10000 < MISC::GET_GAME_TIMER())
			{
...
void func_8(var uParam0, char* sParam1, int iParam2)//Position - 0xABE
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_NATIVE(uParam0, sParam1, func_9(iParam2), 1);
}

int func_9(int iParam0)//Position - 0xAD5
{
	int iVar0;
...
void func_11(var uParam0)//Position - 0x1070
{
	func_12(uParam0, 0f);
}

void func_12(var uParam0, float fParam1)//Position - 0x107F
{
...
void func_15(int iParam0)//Position - 0x120C
{
	Global_413F = iParam0;
}

bool func_16(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1219
{
...
int func_17(char* sParam0, int iParam1, bool bParam2)//Position - 0x1267
{
	Global_3D4D = 0;
...
bool func_23(int iParam0)//Position - 0x1759
{
	return Global_8861 == iParam0;
}

void func_24()//Position - 0x1767
{
	int iVar0;
...
bool func_25(int iParam0, int iParam1)//Position - 0x17BD
{
	switch (iParam0)
	{
		case 5:
...
void func_27(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x184F
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
int func_28(var uParam0, int iParam1)//Position - 0x18A5
{
...
void func_30(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1906
{
...
int func_32(int iParam0)//Position - 0x2045
{
...
int func_33(var uParam0)//Position - 0x2072
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x2193
{
	if (func_35(iParam0))
	{
...
bool func_35(int iParam0)//Position - 0x21BD
{
	return iParam0 < 3;
}

int func_36(int iParam0)//Position - 0x21C9
{
	if (!func_35(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
...
int func_37()//Position - 0x21F4
{
	func_38();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_38()//Position - 0x220D
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_34(Global_17C49.f_6C1.f_21B.f_C8D) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_35(iVar0) && (!func_23(14) || Global_17832))
			{
...
int func_39(var uParam0)//Position - 0x230A
{
	int iVar0;
	int iVar1;
...
int func_40(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2347
{
	...
	if (iParam3 == 0)
	{
		if (func_91(iVar1, iParam2, -1, &iVar4, &iVar5))
		{
			if (iParam5 == -1)
			{
				return 0;
			...
			if (func_87(iParam5, iVar4, iVar5, iVar0, iVar2, iParam1, iVar3, 10000, iParam6, iParam4, iVar7, iVar6, 1))
			{
				return 1;
			}
			else
	...
	else if (func_83(iVar1, iParam2, -1, &sVar8))
	{
		if (func_71(iParam1, &sVar8, 1, 0, 0, 0, 0, 1, 0, 1))
		{
			if (iParam4 != 0)
			{
				switch (iParam4)
...
int func_42(int iParam0, int iParam1, int iParam2)//Position - 0x2533
{
	...
	return func_43(Global_17C49.f_744E[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_43(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x257C
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_44(bool bParam0)//Position - 0x2B7B
{
	int iVar0;
	int iVar1;
...
void func_45(int iParam0)//Position - 0x2DFD
{
	int iVar0;
...
void func_46(int iParam0)//Position - 0x2E57
{
	bool bVar0;
	char cVar1[64];
	...
	else if (MISC::IS_BIT_SET(Global_17C49.f_5CED.f_1D7, iParam0) || MISC::IS_BIT_SET(Global_200000[func_48() /*8053*/].f_167C.f_A, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_17C49.f_5CED.f_1D7), iParam0);
		MISC::CLEAR_BIT(&(Global_200000[func_48() /*8053*/].f_167C.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_47(int iParam0)//Position - 0x2F18
{
	switch (iParam0)
	{
		case 0:
...
void func_49(int iParam0)//Position - 0x2F9E
{
	func_64(93, iParam0);
	func_64(29, iParam0);
	func_64(30, iParam0);
...
bool func_50(int iParam0)//Position - 0x2FBE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return MISC::IS_BIT_SET(Global_17C49.f_5CED.f_1D7, iParam0);
	}
	return MISC::IS_BIT_SET(Global_200000[func_48() /*8053*/].f_167C.f_A, iParam0);
}

int func_51(bool bParam0)//Position - 0x2FFA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_52(int iParam0, int iParam1)//Position - 0x30B1
{
	if (iParam0 >= 61)
	{
		return 0;
...
int func_53(int iParam0, int iParam1)//Position - 0x30CC
{
...
int func_54(var uParam0, int iParam1)//Position - 0x3150
{
	int iVar0;
	var uVar1[61];
...
int func_55(var uParam0, int iParam1)//Position - 0x31D6
{
	int iVar0;
...
bool func_56(var uParam0, int iParam1)//Position - 0x3226
{
	return (*uParam0)[iParam1] == 61;
}

void func_57(var uParam0)//Position - 0x3237
{
	int iVar0;
	...
	func_12(&(uParam0->f_3E), (8f - 0.5f));
}

void func_58(var uParam0, int iParam1)//Position - 0x326E
{
	(*uParam0)[iParam1] = 61;
}

bool func_59(var uParam0, int iParam1)//Position - 0x327E
{
	return func_60(uParam0, iParam1) != -1;
}

int func_60(var uParam0, int iParam1)//Position - 0x3290
{
	int iVar0;
...
bool func_61(var uParam0)//Position - 0x32BD
{
	return uParam0->f_44 == 1;
}

int func_62(int iParam0, int iParam1)//Position - 0x32CB
{
	int iVar0;
...
void func_63(int iParam0, int iParam1)//Position - 0x331C
{
	int iVar0;
...
void func_64(int iParam0, int iParam1)//Position - 0x333F
{
	int iVar0;
...
int func_66(int iParam0)//Position - 0x3411
{
	var uVar0;
...
void func_70()//Position - 0x352F
{
	...
	if (iVar1 > 10000)
	{
		func_42(iVar0, 123, 5000);
	}
	else if (iVar1 >= 10)
	{
		func_42(iVar0, 123, (iVar1 / 10));
	}
}

int func_71(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9)//Position - 0x3571
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_72(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x3609
{
	int iVar0;
	...
	if (!Global_38D8)
	{
		...
		{
			func_76(Global_3826, "SET_DATA_SLOT_EMPTY", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
			func_73(1);
			func_76(Global_3826, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_3825), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}

void func_73(int iParam0)//Position - 0x3AC0
{
	int iVar0;
	int iVar1;
	int iVar2;
					...
					if (iVar0 == Global_8DE[iVar1 /*15*/].f_4)
					{
						if (Global_B10[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_74(Global_3826, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8DE[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_4178), -1f, &(Global_8DE[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_10A95)
								{
									...
									func_74(Global_3826, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8DE[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar5), -1f, &(Global_8DE[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_3839)
									...
									func_74(Global_3826, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8DE[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_8DE[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
								func_74(Global_3826, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8DE[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(Global_4173), -1f, &(Global_8DE[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 20)
							{
								GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_3826, "SET_DATA_SLOT");
							...
							{
								func_74(Global_3826, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_8DE[iVar1 /*15*/].f_A), SYSTEM::TO_FLOAT(0), -1f, &(Global_8DE[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_B10[iVar0] = 1;
						}
					}
...
void func_74(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6, char* sParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3F56
{
...
void func_75(var uParam0)//Position - 0x400B
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(uParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_76(var uParam0, char* sParam1, float fParam2, float fParam3, float fParam4, float fParam5, float fParam6)//Position - 0x401D
{
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uParam0, sParam1);
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(SYSTEM::ROUND(fParam2));
	if (fParam3 != -1f)
...
bool func_77()//Position - 0x4080
{
	return Global_14143C;
}

void func_78(int iParam0)//Position - 0x408C
{
	var uVar0;
	var uVar1;
...
void func_79(int iParam0)//Position - 0x40AB
{
	var uVar0;
	var uVar1;
	var uVar2;
...
void func_80()//Position - 0x413D
{
	...
	while (iVar2 < iVar1)
	{
		if (!func_81(Global_17C49.f_306B[iVar2 /*104*/].f_12, Global_17C49.f_306B[Global_4177 /*104*/].f_12))
		{
			Global_4177 = iVar2;
		}
		iVar2++;
...
int func_81(struct<6> Param0, struct<6> Param1)//Position - 0x4208
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_83(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x444A
{
	struct<4> Var0;
	struct<4> Var1[2];
	int iVar2;
	...
	else
	{
		...
		StringConCat(&Var0, func_86(iParam0), 16);
		...
		if (iParam2 == -1)
		{
			...
			if (func_84(&(Var1[0 /*4*/]), iVar2))
			{
				iParam2 = 1;
			}
			else if (func_84(&(Var1[1 /*4*/]), iVar2))
			{
				iParam2 = 0;
			}
			else
...
int func_84(char* sParam0, int iParam1)//Position - 0x4582
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0)//Position - 0x45F6
{
	switch (iParam0)
	{
		case 0:
...
char* func_86(int iParam0)//Position - 0x4658
{
	switch (iParam0)
	{
		case 0:
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x46CB
{
	struct<14> Var0;
...
void func_88(int iParam0)//Position - 0x4809
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_89(int iParam0)//Position - 0x48CD
{
	switch (iParam0)
	{
		case 0:
...
bool func_90(bool bParam0)//Position - 0x4937
{
...
int func_91(int iParam0, int iParam1, int iParam2, var uParam3, var uParam4)//Position - 0x4962
{
	struct<4> Var0[2];
	int iVar1;
	...
	else
	{
		...
		if (iParam2 == -1)
		{
			if (func_83(iParam0, iParam1, 0, &(Var0[0 /*4*/])) && func_83(iParam0, iParam1, 1, &(Var0[1 /*4*/])))
			{
				iVar1 = func_85(iParam0);
				if (func_84(&(Var0[0 /*4*/]), iVar1))
				{
					iParam2 = 1;
				}
				else if (func_84(&(Var0[1 /*4*/]), iVar1))
				{
					iParam2 = 0;
				}
				else
		...
		*uParam4 = func_92(iParam1, iParam2);
		return 1;
	}
	return 0;
}

int func_92(int iParam0, int iParam1)//Position - 0x4A64
{
...
int func_93(int iParam0)//Position - 0x4B12
{
	switch (iParam0)
	{
		case 0:
...
void func_94(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x4B49
{
	if (iParam0 == iParam3)
	{
		return;
...
int func_96(int iParam0, int iParam1)//Position - 0x4C48
{
	...
	bVar1 = false;
	if (MISC::IS_BIT_SET(Var0.f_2, func_97()))
	{
		bVar1 = true;
	}
	if (Var0.f_4 > iParam1)
	...
	if (bVar1)
	{
		if (Var0.f_3 < Global_17C49.f_1738.f_397[func_97()])
		{
			return 5;
		}
	}
...
int func_97()//Position - 0x4CE0
{
	func_38();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

struct<10> func_98(int iParam0)//Position - 0x4CF9
{
	int iVar0;
	struct<10> Var1;
...
struct<14> func_100(int iParam0)//Position - 0x4DD7
{
	int iVar0;
	struct<14> Var1;
...
struct<15> func_102(int iParam0)//Position - 0x4ED1
{
	int iVar0;
	struct<15> Var1;
...
int func_103(int iParam0)//Position - 0x4F19
{
	int iVar0;
...
int func_105(struct<3> Param0, bool bParam1)//Position - 0x50A8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_106(int iParam0)//Position - 0x5125
{
	if (iParam0 == 0)
	{
		return 2091854273;
...
int func_107(int iParam0)//Position - 0x5191
{
	if (iParam0 == 145)
	{
		return 7;
...
int func_108(var uParam0)//Position - 0x51EC
{
	int iVar0;
	int iVar1;
...
bool func_111(struct<3> Param0, struct<3> Param1)//Position - 0x52DA
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

void func_112(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x5303
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_9(iParam3), 0);
}
...
int func_114()//Position - 0x532D
{
	if (!func_116())
	{
		func_30(&uLocal_93, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		switch (func_33(Global_15E94))
		{
			case 0:
				func_30(&uLocal_93, 1, Global_15E94, func_115(0), 0, 1);
				break;
			
			case 1:
				func_30(&uLocal_93, 2, Global_15E94, func_115(1), 0, 1);
				break;
			
			case 2:
				func_30(&uLocal_93, 3, Global_15E94, func_115(2), 0, 1);
				break;
	...
	if (iLocal_286 != 0)
	{
		if (!ENTITY::DOES_ENTITY_EXIST(uLocal_285))
		{
			uLocal_285 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_289 + Local_287, 1f, iLocal_286, 1, 0, 1);
			if (ENTITY::DOES_ENTITY_EXIST(uLocal_285))
			{
				ENTITY::SET_ENTITY_COORDS(uLocal_285, Local_289 + Local_287, 1, 0, 0, 1);
				ENTITY::SET_ENTITY_ROTATION(uLocal_285, Vector(fLocal_290, 0f, 0f) + Local_288, 2, 1);
				ENTITY::FREEZE_ENTITY_POSITION(uLocal_285, 1);
			}
		}
	}
	return 0;
...
char* func_115(int iParam0)//Position - 0x542D
{
	switch (iParam0)
	{
		case 0:
...
int func_117(int iParam0, int iParam1)//Position - 0x5583
{
	struct<3> Var0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_118(Global_15E94) && iParam1 != 0)
		{
			Global_15E94 = 0;
		}
	}
...
int func_118(var uParam0)//Position - 0x5666
{
	return uParam0;
}

bool func_119(var uParam0, var uParam1)//Position - 0x5670
{
	return (uParam0 && uParam1) != 0;
}

int func_120()//Position - 0x567F
{
	func_38();
...
void func_122()//Position - 0x570D
{
	...
	if (iLocal_284 != 0)
	{
		VEHICLE::REQUEST_VEHICLE_ASSET(iLocal_284, 3);
	}
	iVar0 = 0;
	bVar1 = false;
	while (!bVar1 && iVar0 < 400)
	{
		...
		if (iLocal_284 != 0)
		{
			if (!VEHICLE::HAS_VEHICLE_ASSET_LOADED(iLocal_284))
			{
				bVar1 = false;
			}
		}
	...
	func_123(&Global_15E94, Global_14D7A);
	PED::SET_PED_CONFIG_FLAG(Global_15E94, 132, 1);
	PED::SET_PED_CONFIG_FLAG(Global_15E94, 317, 1);
}

void func_123(var uParam0, int iParam1)//Position - 0x57A3
{
...
void func_124()//Position - 0x57D9
{
	...
	func_137(iLocal_92, &Local_289, &fLocal_290, &cVar0);
	switch (iLocal_92)
	{
		case 98:
			Local_291 = { -25f, -35f, 0f };
			fLocal_292 = 30f;
			fLocal_331 = 0.73f;
			break;
		
		case 99:
			Local_291 = { Vector(24.3224f, -700.7733f, -1306.836f) - Local_289 };
			fLocal_292 = 40f;
			iLocal_283 = 2;
			break;
		
		case 100:
			Local_291 = { Vector((82.0206f + 1f), 272.6104f, -566.2225f) - Local_289 };
			fLocal_292 = 30f;
			iLocal_283 = 2;
			break;
		
		case 101:
			Local_291 = { Vector((53.6418f + 1f), -217.321f, 77.2686f) - Local_289 };
			fLocal_292 = 25f;
			iLocal_283 = 2;
			break;
		
		case 102:
			Local_291 = { Vector((102.0191f + 1f), 313.2252f, 412.1519f) - Local_289 };
			fLocal_292 = 15f;
			iLocal_283 = 2;
			break;
		
		case 170:
			Local_291 = { Vector((37.8417f + 1f), -275.1926f, -616.7041f) - Local_289 };
			fLocal_292 = 30f;
			break;
		
		case 171:
			Local_291 = { Vector((56.8469f + 1f), -125.1416f, -106.3491f) - Local_289 };
			fLocal_292 = 25f;
			break;
		...
		case 94:
			Local_291 = { Vector((112.1615f + 1f), 328.301f, -16.8925f) - Local_289 };
			fLocal_292 = 25f;
			break;
		...
		case 152:
			Local_291 = { 0f, 0f, 0f };
			fLocal_292 = 0f;
			StringCopy(&cLocal_320, "PROP_HUMAN_SEAT_SUNLOUNGER", 64);
			Local_329 = { 1.358f, 2.385f, -0.608f };
			fLocal_330 = 160f;
			iLocal_286 = joaat("prop_patio_lounger1");
			Local_287 = { Vector(63.082f, 357.697f, -1352.644f) - Vector(64.08f, 355.1845f, -1353.791f) };
			Local_288 = { 0f, 0f, (54.35f - 72f) };
			break;
		
		case 151:
			Local_291 = { 0f, 0f, 0f };
			fLocal_292 = 0f;
			iLocal_286 = joaat("prop_chateau_chair_01");
			Local_287 = { 0.8706f, 2.0176f, -0.4948f };
			Local_288 = { 0f, 0f, 0f };
			break;
		
		default:
			Local_291 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-50f, 50f), 0f };
			fLocal_292 = (SYSTEM::VMAG(Local_291) * 0.75f);
			break;
	}
	if ((iLocal_92 != 94 && iLocal_92 != 152) && iLocal_92 != 151)
	{
		Var1.f_B = 12;
		Var1.f_1F = 25;
		Var1.f_39 = 2;
		if (func_127(0, iLocal_92, &Var1, &uVar2, &uVar3, &uVar4, &uVar5))
		{
			iLocal_284 = Var1;
		}
	}
	...
	if (iLocal_283 == 0)
	{
		func_125(iLocal_92, &cLocal_293, &cLocal_302, &cLocal_311, &uVar6, &uVar7);
		iLocal_283 = 0;
	}
	else
	{
		StringCopy(&cLocal_293, "", 64);
		StringCopy(&cLocal_302, "", 64);
		StringCopy(&cLocal_311, "", 64);
		iLocal_283 = 2;
	}
}

int func_125(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x5B12
{
	*uParam4 = 9;
	*uParam5 = 8;
	switch (iParam0)
	{
		...
		case joaat("mpsv_lp0_31"):
			func_126(sParam1, sParam2, sParam3, "SWITCH@MICHAEL@SITTING", "IDLE", "EXIT_FORWARD");
			*uParam4 |= 1024;
			*uParam5 |= 1024;
			return 1;
			break;
		...
		case 206:
		case 207:
			if (func_125(205, sParam1, sParam2, sParam3, uParam4, uParam5))
			{
				return 1;
			}
			break;
		...
		case 289:
			func_126(sParam1, sParam2, sParam3, "SWITCH@MICHAEL@PIER", "pier_lean_smoke_idle", "pier_lean_smoke_idle");
			return 1;
			break;
...
void func_126(char* sParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5)//Position - 0x622C
{
...
int func_127(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x6246
{
	uParam2->f_3 = 1000;
	uParam2->f_1 = 0;
	uParam2->f_3C = 255;
	...
	switch (iParam1)
	{
		...
		case 9:
			return func_127(iParam0, 8, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 23:
			return func_127(iParam0, 208, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 113:
			if (func_127(iParam0, 112, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam3 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
				*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
				return 1;
		...
		case 119:
			if (func_127(iParam0, 118, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam5 = { 5f, 20f, 0f };
				*uParam6 = 5f;
				return 1;
		...
		case 106:
			return func_127(iParam0, 105, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 100:
			return func_127(iParam0, 99, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 93:
			if (func_127(iParam0, 91, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 136:
			if (func_127(iParam0, 135, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam3 = { MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-5f, 5f), 0f };
				*uParam4 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
				return 1;
		...
		case 140:
			if (func_127(iParam0, 142, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				*uParam5 = { 0f, 15f, 0f };
				*uParam6 = 10f;
				return 1;
		...
		case 151:
			if (func_127(iParam0, 94, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 162:
			if (func_127(iParam0, 115, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 166:
			return func_127(iParam0, 98, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 213:
			if (func_127(iParam0, 211, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 194:
			if (func_127(iParam0, 193, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 223:
			if (func_127(iParam0, 222, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 224:
			return func_127(iParam0, 222, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
		...
		case 251:
			if (func_127(iParam0, 250, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
		...
		case 282:
			if (func_127(iParam0, 281, uParam2, uParam3, uParam4, uParam5, uParam6))
			{
				return 1;
			}
			break;
		...
		case 276:
			return func_127(iParam0, 275, uParam2, uParam3, uParam4, uParam5, uParam6);
			break;
...
void func_128(int iParam0, var uParam1, int iParam2)//Position - 0x96BC
{
	int iVar0;
	struct<74> Var1;
...
int func_129(int iParam0, var uParam1, int iParam2)//Position - 0x9934
{
	if (Global_15D9F[iParam0 /*74*/] == 0)
	{
		func_128(iParam0, uParam1, iParam2);
	...
	if (!func_130(Global_15D9F[iParam0 /*74*/]))
	{
		func_128(iParam0, uParam1, iParam2);
		uParam1->f_43 = iParam2;
		return 1;
...
int func_130(int iParam0)//Position - 0x9B6A
{
	int iVar0;
	struct<2> Var1;
...
int func_131()//Position - 0x9D39
{
	return 0;
}

int func_132()//Position - 0x9D42
{
	return 1;
}

int func_133()//Position - 0x9D4B
{
	return 1;
}

int func_134()//Position - 0x9D54
{
...
int func_136(int iParam0)//Position - 0x9DF0
{
...
int func_137(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0xA070
{
	int iVar0;
	
	if (func_139(iParam0, uParam2, sParam3))
	{
		switch (iParam0)
		{
			case 0:
...
bool func_138(var uParam0)//Position - 0xA25B
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
...
int func_139(int iParam0, var uParam1, char* sParam2)//Position - 0xA315
{
	struct<3> Var0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[0];
			StringCopy(sParam2, func_143(Global_17C49.f_6C1.f_21B.f_606[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[1];
			StringCopy(sParam2, func_143(Global_17C49.f_6C1.f_21B.f_606[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[2];
			StringCopy(sParam2, func_143(Global_17C49.f_6C1.f_21B.f_606[2]), 32);
			return 1;
			break;
		
		case 11:
			if (func_142(iParam0, &Var0, uParam1))
			{
		...
		case 9:
			return func_139(8, uParam1, sParam2);
			break;
		...
		case 23:
			return func_139(208, uParam1, sParam2);
			break;
	...
	switch (iParam0)
	{
		...
		case 224:
			return func_139(222, uParam1, sParam2);
			break;
		...
		case 294:
			return func_139(293, uParam1, sParam2);
			break;
		
		case 295:
			return func_139(292, uParam1, sParam2);
			break;
		...
		case 300:
			return func_139(303, uParam1, sParam2);
			break;
...
int func_140(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xC723
{
	switch (iParam1)
	{
		case 0:
			switch (iParam0)
			{
				...
				case 1:
					if (func_140(0, iParam1, uParam2, uParam3))
					{
		...
		case 21:
			...
			{
				case 0:
					if (func_140(0, 5, uParam2, uParam3))
					{
		...
		case 33:
			...
			{
				case 1:
					if (func_140(1, 32, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
						*uParam3 = (*uParam3 + 0f);
						return 1;
		...
		case 46:
			return func_140(iParam0, 26, uParam2, uParam3);
			break;
		...
		case 60:
			if (func_140(iParam0, 59, uParam2, uParam3))
			{
		...
		case 77:
			if (func_140(iParam0, 47, uParam2, uParam3))
			{
				*uParam2 = { *uParam2 + Vector(0f, 0f, 0f) };
				*uParam3 = (*uParam3 + 0f);
				return 1;
		...
		case 131:
			...
			{
				case 13:
					if (func_140(iParam0, 130, uParam2, uParam3))
					{
						*uParam2 = { *uParam2 + Vector(0f, MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f), MISC::GET_RANDOM_FLOAT_IN_RANGE(-1f, 1f)) };
						*uParam3 = (*uParam3 + MISC::GET_RANDOM_FLOAT_IN_RANGE(-10f, 10f));
						return 1;
...
int func_142(int iParam0, var uParam1, var uParam2)//Position - 0xE691
{
	switch (iParam0)
	{
		case 11:
		...
		case 9:
			return func_142(8, uParam1, uParam2);
			break;
...
char* func_143(int iParam0)//Position - 0xF000
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_144()//Position - 0xF091
{
	if (iLocal_284 != 0)
	{
		VEHICLE::REMOVE_VEHICLE_ASSET(iLocal_284);
	}
