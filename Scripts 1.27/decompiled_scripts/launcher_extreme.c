...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_252(&Var0, 1);
	}
	...
	while (true)
	{
		...
		else if (Var0 == 19)
		{
			...
			if ((((((!func_170() && func_169(Var0.f_28[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_28[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_95)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_95, "DOM_BREATHING", Var0.f_28[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_94 == 0 && func_169(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var61, Var0.f_15, Var0.f_15, Var0.f_15, 0, 0, 0))
			{
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5750
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5DEA
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x61A0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_148(struct<3> Param0, int iParam3)//Position - 0x9E78
{
	var uVar0;
...
int func_171(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xB234
{
	var uVar0;
	
	if ((((func_169(PLAYER::PLAYER_PED_ID()) && func_169(iParam0->f_28[0])) && !func_170()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_175(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_175(int iParam0, struct<3> Param1, int iParam4)//Position - 0xB3E8
{
	struct<3> Var0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_194(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_203(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC9C1
{
	...
	{
		Var3 = { func_205(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_204(struct<3> Param0, struct<3> Param3)//Position - 0xCA52
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_212(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xCDD0
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_232(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xD576
{
...
int func_233(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0xD5D1
{
	int iVar0;
...
void func_236(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xD9A9
{
	func_237(uParam0);
...
int func_249(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xDF58
{
	int iVar0;
...
int func_250(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xDFBD
{
	int iVar0;
	struct<7> Var1;
...
int func_251(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xE03A
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
