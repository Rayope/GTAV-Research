...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_51 = func_268(52);
	iLocal_52 = joaat("a_c_retriever");
	iLocal_53 = -1;
	uLocal_55 = AUDIO::GET_SOUND_ID();
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_252(&Var0, 1);
	}
	if (!func_249(&iVar2, &Var0, Var1, 1f))
	{
		func_248();
	...
	if (Var0 == 17)
	{
		uLocal_56 = PED::ADD_SCENARIO_BLOCKING_AREA(Var1 - Vector(40f, 40f, 40f), Var1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
		uLocal_56 = PED::ADD_SCENARIO_BLOCKING_AREA(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		func_184(Var0);
		func_177(&iLocal_53, &(Var0.f_9), Var1);
		if (Var0 == 18)
		{
			func_176(&Var0);
			func_171(&Var0, Var1, "EXT2AU", "EXT2_AMB", 3, "DOM", 5000, 1101004800);
		}
		else if (Var0 == 19)
		{
			func_176(&Var0);
			if (AUDIO::HAS_SOUND_FINISHED(uLocal_55))
			{
				func_171(&Var0, Var1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_170() && func_169(Var0.f_1C[0])) && !AUDIO::IS_ANY_SPEECH_PLAYING(Var0.f_1C[0])) && AUDIO::HAS_SOUND_FINISHED(uLocal_55)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_A", 0)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_B", 0)) && AUDIO::REQUEST_SCRIPT_AUDIO_BANK("EXTREME_04_DOM_C", 0))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(uLocal_55, "DOM_BREATHING", Var0.f_1C[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_54 == 0 && func_169(PLAYER::PLAYER_PED_ID())) && ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var1, Var0.f_F, Var0.f_F, Var0.f_F, 0, 0, 0))
			{
...
int func_1(int iParam0)//Position - 0x3E4
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x4C5
{
	func_21(sParam1);
...
void func_6(int iParam0)//Position - 0x791
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xB79
{
	Global_D5D7 = 1;
	Global_D5DA = 1;
	if (Global_1051D > 15)
...
void func_8(int iParam0)//Position - 0xBC4
{
...
struct<2> func_9(int iParam0)//Position - 0xBF8
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xCEA
{
	Global_D67D = 0;
}

void func_14()//Position - 0xCF6
{
	Global_D5F1 = 0;
...
var func_15(int iParam0)//Position - 0xD4A
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xD88
{
...
void func_21(char* sParam0)//Position - 0xE41
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xE54
{
	MISC::CLEAR_BIT(&(Global_15F6A.f_14), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE71
{
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1B46
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x29CA
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x29EC
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A73
{
...
int func_29(int iParam0)//Position - 0x2AB3
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2AE1
{
...
int func_31(int iParam0)//Position - 0x2BBD
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2BFF
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2C62
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2CF0
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2D32
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2FAA
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2FB6
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3262
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3312
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x33EC
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x349D
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x35CA
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x363B
{
...
int func_44(int iParam0)//Position - 0x3714
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x3751
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x377B
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x3925
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x3957
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x398B
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x3997
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x39C3
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3F0B
{
	int iVar0;
...
int func_53()//Position - 0x414D
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x4166
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x4263
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x4271
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x4364
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x45C8
{
...
int func_59(int iParam0, int iParam1)//Position - 0x46EE
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4F0A
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4F45
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x51B9
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x51F5
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5750
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x5794
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5DEA
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5E13
{
...
bool func_68(int iParam0)//Position - 0x5E6C
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5E7C
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5EDC
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x6185
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x6190
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x61A0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x6237
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x6708
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x6718
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x6971
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x6982
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x69C8
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x6A4E
{
...
void func_81(var uParam0, int iParam1)//Position - 0x6A81
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x6AD2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x6B74
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6B99
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6BB0
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6BBD
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6BF7
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6C32
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6C6E
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6C87
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6CE0
{
...
bool func_92(bool bParam0)//Position - 0x6D22
{
...
struct<2> func_93(int iParam0)//Position - 0x6D4D
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x719A
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x8475
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x87BB
{
	var uVar0;
...
void func_98(int iParam0)//Position - 0x885F
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x88FA
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x8958
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x89B1
{
...
int func_103(int iParam0)//Position - 0x8A34
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x8A65
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x8A79
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8B21
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x8B3C
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8B88
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8BD1
{
	if (func_169(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8BF1
{
	switch (iParam0)
	{
		case 5:
...
int func_113(int iParam0)//Position - 0x8CC1
{
	switch (iParam0)
	{
		case 5:
...
void func_114(var uParam0, int iParam1, bool bParam2)//Position - 0x8D14
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_169(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_169(uParam0->f_29[iVar0]))
		{
...
int func_115(int iParam0)//Position - 0x8E08
{
	switch (iParam0)
	{
		case 5:
...
void func_116(bool bParam0)//Position - 0x8E73
{
	var uVar0;
...
void func_117(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8EAF
{
	if (bParam0)
	{
...
int func_118(int iParam0)//Position - 0x8F80
{
...
bool func_119()//Position - 0x8FC1
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_120(int iParam0, int iParam1)//Position - 0x8FD2
{
	bool bVar0;
...
int func_121(int iParam0, bool bParam1)//Position - 0x901D
{
	int iVar0;
	int iVar1;
...
int func_122(int iParam0, var uParam1, var uParam2)//Position - 0x905E
{
	int iVar0;
...
void func_124(int iParam0)//Position - 0x90B6
{
	if (iParam0 == 1)
	{
...
int func_125(char* sParam0)//Position - 0x90D9
{
...
void func_126()//Position - 0x9116
{
	Global_38DE = 0;
	func_127();
}

void func_127()//Position - 0x9126
{
...
void func_129()//Position - 0x9191
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_130(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1))
			{
...
int func_130(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x91E8
{
...
void func_133(int iParam0)//Position - 0x93E3
{
	if (Global_38D7)
	{
		func_134(0, 0);
...
void func_134(bool bParam0, bool bParam1)//Position - 0x9453
{
	if (bParam0)
	{
		if (func_135(0))
...
int func_135(int iParam0)//Position - 0x94C7
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_136(int iParam0)//Position - 0x9521
{
...
int func_137(int iParam0)//Position - 0x9562
{
	int iVar0;
	...
	iVar0 = func_139(&(Global_178B8[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_138(int iParam0)//Position - 0x95A7
{
...
int func_139(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x95D9
{
	int iVar0;
...
void func_140(var uParam0, int iParam1)//Position - 0x9710
{
	int iVar0;
...
bool func_141(int iParam0)//Position - 0x975F
{
	return func_142(iParam0, Global_8861);
}

int func_142(int iParam0, int iParam1)//Position - 0x9770
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_143(int iParam0)//Position - 0x9951
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_144()//Position - 0x9973
{
	return func_145(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_145(var uParam0, int iParam1)//Position - 0x9984
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_147(int iParam0, var uParam1)//Position - 0x99F1
{
	switch (iParam0)
	{
		case 0:
...
var func_148(struct<3> Param0, int iParam1)//Position - 0x9E78
{
	var uVar0;
...
float func_149(bool bParam0, float fParam1, float fParam2)//Position - 0x9EA4
{
	if (bParam0)
	{
		return fParam1;
...
int func_150(int iParam0)//Position - 0x9EBB
{
	switch (iParam0)
	{
		case 0:
...
int func_151(var uParam0)//Position - 0x9F4A
{
	if (*uParam0 == 18)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, 1, 0))
		{
			...
			else if ((!func_152(PLAYER::PLAYER_PED_ID(), -828834893) && func_169(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && func_130(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 3f, 1, 1056964608, 0, 1))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_152(int iParam0, int iParam1)//Position - 0x9FF0
{
	if (func_110(iParam0))
	{
...
int func_153(var uParam0, int iParam1)//Position - 0xA023
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_169(uParam0->f_1C[0]))
				{
					if (func_155(uParam0))
					{
						if (func_159(2))
		...
		case 5:
			if (*uParam0 == 6)
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (func_169(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
					{
...
void func_154()//Position - 0xA805
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_155(var uParam0)//Position - 0xA820
{
	float fVar0;
...
void func_156(int iParam0, int iParam1)//Position - 0xA8AE
{
	if (iParam0 == 1)
	{
		if (!func_113(iParam1))
...
int func_157(bool bParam0)//Position - 0xA911
{
	int iVar0;
...
int func_158(int iParam0)//Position - 0xA9A8
{
	if (func_169(uParam0))
	{
...
int func_159(int iParam0)//Position - 0xA9D2
{
	int iVar0;
...
var func_160()//Position - 0xB0EF
{
	return Global_15F91.f_1;
}

int func_161()//Position - 0xB0FD
{
	if (Global_154F9 != -1)
	{
...
bool func_164()//Position - 0xB167
{
	return Global_15F9E.f_123 > 0;
}

bool func_165(int iParam0, int iParam1)//Position - 0xB178
{
	switch (iParam0)
	{
		case 5:
...
var func_166()//Position - 0xB1B3
{
	return Global_14143C;
}

int func_167()//Position - 0xB1BF
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_168(char* sParam0, int iParam1)//Position - 0xB1DB
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

int func_169(int iParam0)//Position - 0xB1F2
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
...
int func_171(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xB234
{
	var uVar0;
	
	if ((((func_169(PLAYER::PLAYER_PED_ID()) && func_169(iParam0->f_1C[0])) && !func_170()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_175(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_174(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
		func_172(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_172(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB2BC
{
...
void func_173(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB2F7
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_174(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xB34D
{
...
float func_175(int iParam0, struct<3> Param1, int iParam2)//Position - 0xB3E8
{
	struct<3> Var0;
...
void func_176(int iParam0)//Position - 0xB421
{
	...
	{
		if (func_169(iParam0->f_1C[0]))
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("Dom", iParam0->f_1C[0], 0);
		}
	}
}

void func_177(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xB44E
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_175(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_180(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_175(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_182(iParam0);
				}
			}
...
void func_178(int iParam0, bool bParam1)//Position - 0xB53F
{
	if (iParam0 == -1)
	{
		return;
...
int func_179(int iParam0)//Position - 0xB57B
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_180(int iParam0, int iParam1)//Position - 0xB5B4
{
	bool bVar0;
	int iVar1;
...
bool func_181()//Position - 0xB652
{
	return Global_1567C;
}

void func_182(int iParam0)//Position - 0xB65E
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_183(iParam0);
...
void func_183(int iParam0)//Position - 0xB675
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_184(int iParam0)//Position - 0xB75D
{
	if (iParam0 == -1)
	{
		iParam0 = func_144();
...
int func_185(var uParam0, bool bParam1)//Position - 0xB785
{
	...
	if ((func_222(*uParam0) || func_220(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_189(&(uParam0->f_30)) && bParam1)
	{
		func_186(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_186(int iParam0, var uParam1, int iParam2)//Position - 0xB9F8
{
	var uVar0;
	var uVar1;
	...
	if (func_169(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_188(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_187(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_188(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_187(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_187(int iParam0)//Position - 0xBD4D
{
...
int func_188(var uParam0)//Position - 0xBD6D
{
...
int func_189(var uParam0)//Position - 0xBD85
{
...
void func_190(var uParam0)//Position - 0xBDAA
{
	int iVar0;
	var uVar1;
	...
	if (*uParam0 == 52)
	{
		func_191(&(uParam0->f_29[1]));
		func_191(&(uParam0->f_29[2]));
	}
...
void func_191(var uParam0)//Position - 0xC0AF
{
...
void func_192(var uParam0)//Position - 0xC0DA
{
	int iVar0;
...
int func_193(var uParam0, bool bParam1, bool bParam2)//Position - 0xC15A
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_194(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
...
int func_194(int iParam0, int iParam1)//Position - 0xC317
{
	int iVar0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_214(*uParam0))
					{
						if (!func_136(*uParam0))
						{
							if (func_209(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_190(uParam0);
						...
						if (func_197(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_190(uParam0);
...
int func_196(int iParam0)//Position - 0xC603
{
...
int func_197(int iParam0, float fParam1)//Position - 0xC637
{
	...
	if (func_169(PLAYER::PLAYER_PED_ID()) && func_169(iParam0))
	{
...
bool func_199(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC6C5
{
	...
	iVar2 = func_207(iParam0, iParam1);
	if (!func_169(iParam0) || !func_169(iParam1))
	{
		if (iVar2 != -1)
		{
			func_206(&(Local_36[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_200(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_200(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xC786
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_203(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC9C1
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_205(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_205(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_204(Var1, Var0);
...
float func_204(struct<3> Param0, struct<3> Param1)//Position - 0xCA52
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_205(struct<3> Param0)//Position - 0xCA73
{
	float fVar0;
	float fVar1;
...
void func_206(var uParam0)//Position - 0xCAB2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_208(var uParam0)//Position - 0xCB0C
{
...
int func_209(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xCB34
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_169(PLAYER::PLAYER_PED_ID()) && func_169(uParam0))
	{
...
int func_210(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xCC2F
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_211(var uParam0, float fParam1)//Position - 0xCD3B
{
	var uVar0;
	struct<3> Var1;
...
int func_212(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xCDD0
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_205(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_213(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xCE5E
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_214(int iParam0)//Position - 0xCEA6
{
...
void func_215(int iParam0)//Position - 0xCEF0
{
	var uVar0;
...
int func_216(int iParam0)//Position - 0xCF8D
{
	if (iParam0 == -1)
	{
		iParam0 = func_144();
...
int func_217(int iParam0)//Position - 0xD025
{
...
int func_220(int iParam0)//Position - 0xD0A7
{
	if ((func_221() && Global_15F6A.f_B == 6) && iParam0 == func_145(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_222(int iParam0)//Position - 0xD119
{
	if (func_92(0))
	{
...
int func_224(var uParam0)//Position - 0xD1B6
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_230(&(uParam0->f_30), "rcmextreme4", "idle_a", "idle_c");
			iLocal_50 = 1;
			break;
		
		case 1:
			if (!func_229(&iVar0) || !func_228(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			func_225(&(uParam0->f_1C[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
void func_225(var uParam0, struct<3> Param1, float fParam2)//Position - 0xD2BA
{
	func_226(uParam0, iLocal_52, Param1, fParam2, 26);
...
void func_226(var uParam0, int iParam1, struct<3> Param2, var uParam3, int iParam4)//Position - 0xD2EC
{
	func_227(uParam0);
	*uParam0 = PED::CREATE_PED(iParam4, iParam1, Param2, uParam3, 0, 0);
}

void func_227(var uParam0)//Position - 0xD30D
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_228(var uParam0)//Position - 0xD34C
{
	if (func_189(uParam0))
	{
...
int func_229(int iParam0)//Position - 0xD376
{
	int iVar0;
...
void func_230(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xD3A7
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_231(var uParam0)//Position - 0xD3E3
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_230(&(uParam0->f_30), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_50 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_232(&(uParam0->f_1C[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 118, 0);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 208, 1);
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_1C[0], joaat("gadget_parachute"), 1, 0, 0);
...
int func_232(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xD576
{
	if (func_233(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
int func_233(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)//Position - 0xD5D1
{
	int iVar0;
...
int func_234(var uParam0, int iParam1)//Position - 0xD65F
{
	int iVar0;
...
int func_235(var uParam0)//Position - 0xD6A5
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_230(&(uParam0->f_30), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_50 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_232(&(uParam0->f_1C[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_1C[0], -954.2f, -2760.05f, 14.04f, 1, 0, 1);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 118, 0);
					PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[0], 208, 1);
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_1C[0], 1);
					ENTITY::SET_ENTITY_COLLISION(uParam0->f_1C[0], 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 8, 1, 0, 0);
					TASK::TASK_PLAY_ANIM(uParam0->f_1C[0], uParam0->f_30, uParam0->f_30.f_1, 8f, -8f, -1, 33281, 0, 0, 0, 0);
					if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
					{
						TASK::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], PLAYER::PLAYER_PED_ID(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_236(&(uParam0->f_23[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[0], 2);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[0], 0);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(uParam0->f_23[0], 0f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[1]))
			{
				func_236(&(uParam0->f_23[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[1], 2);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[1], 1);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(uParam0->f_23[1], 0f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[2]))
			{
				func_236(&(uParam0->f_23[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[2], 2);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[2], 2);
				VEHICLE::SET_VEHICLE_DIRT_LEVEL(uParam0->f_23[2], 0f);
				VEHICLE::SET_VEHICLE_IS_CONSIDERED_BY_PLAYER(uParam0->f_23[2], 0);
				VEHICLE::SET_VEHICLE_AUTOMATICALLY_ATTACHES(uParam0->f_23[2], 0, 0);
			}
			if (bVar2)
			{
				iLocal_50 = 3;
...
void func_236(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xD9A9
{
	func_237(uParam0);
...
void func_237(var uParam0)//Position - 0xD9E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam0))
...
int func_238(var uParam0)//Position - 0xDA80
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_230(&(uParam0->f_30), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_50 = 1;
			break;
		...
		case 2:
			func_225(&(uParam0->f_1C[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar1]);
...
int func_239(int iParam0)//Position - 0xDB6C
{
	struct<27> Var0;
	int iVar1;
...
int func_240(int iParam0)//Position - 0xDBC0
{
	char* sVar0;
...
int func_241(int iParam0)//Position - 0xDC57
{
	var uVar0;
...
int func_242(int iParam0)//Position - 0xDD18
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_243(int iParam0, char* sParam1)//Position - 0xDD9D
{
...
bool func_244(int iParam0)//Position - 0xDE7F
{
...
bool func_245(int iParam0)//Position - 0xDEAD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_246(int iParam0)//Position - 0xDEDB
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_247(int iParam0)//Position - 0xDF09
{
	if (func_217(iParam0))
	{
		return 0;
...
void func_248()//Position - 0xDF3E
{
	func_265("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_249(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xDF58
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_250((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_250((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_250(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xDFBD
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_251(Var1.f_6, Param1, fParam2))
	{
...
int func_251(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xE03A
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_252(int iParam0, bool bParam1)//Position - 0xE086
{
	if (*iParam0 == 18)
	{
		if (func_169(iParam0->f_23[0]))
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_23[0], 1);
		}
		if (func_169(iParam0->f_23[1]))
		{
			VEHICLE::SET_VEHICLE_DOORS_LOCKED(iParam0->f_23[1], 1);
		}
	}
	if (bParam1)
	{
...
int func_253(var uParam0)//Position - 0xE167
{
	if (func_189(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_254(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xE19D
{
...
void func_255(var uParam0, bool bParam1)//Position - 0xE1BD
{
	func_256(&(uParam0->f_29), bParam1);
}

void func_256(var uParam0, bool bParam1)//Position - 0xE1CF
{
	int iVar0;
...
void func_257(var uParam0, bool bParam1)//Position - 0xE20D
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_258(var uParam0, bool bParam1)//Position - 0xE248
{
	func_259(&(uParam0->f_23), bParam1);
}

void func_259(var uParam0, bool bParam1)//Position - 0xE25A
{
	int iVar0;
...
void func_260(var uParam0)//Position - 0xE297
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_261(var uParam0, int iParam1)//Position - 0xE2CE
{
	func_262(&(uParam0->f_1C), iParam1);
}

void func_262(var uParam0, int iParam1)//Position - 0xE2E0
{
	int iVar0;
...
void func_263(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE321
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_264(var uParam0)//Position - 0xE370
{
	if (*uParam0 == -1)
	{
		return;
...
void func_265(char* sParam0)//Position - 0xE3AD
{
...
void func_266(var uParam0)//Position - 0xE3BF
{
	*uParam0 = -1;
...
void func_267()//Position - 0xE3F2
{
	func_265("Running start routines.");
	Global_17B2F++;
}

int func_268(int iParam0)//Position - 0xE40C
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
