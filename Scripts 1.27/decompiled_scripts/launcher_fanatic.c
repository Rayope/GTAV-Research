...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_269(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_254(&Var0, 1);
	}
	if (!func_251(&iVar2, &Var0, Var1, 1f))
	{
		func_250();
	...
	while (true)
	{
		...
		func_186(Var0);
		func_179(&iLocal_53, &(Var0.f_9), Var1);
		if (iLocal_54 == 0)
		{
			if (Var0 == 22)
			{
				...
				{
					if (func_178(Var0.f_1C[1]))
					{
						func_270("Trying to set Mary Ann boyfriend component variation");
						CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED("MaryAnnes_Friend", Var0.f_1C[1], 0);
		...
		if (Var0 == 21)
		{
			func_175(&Var0, Var1, "FAN1AU", "FAN1_AMB", 3, "MARYANN", 1500);
		}
		else if (Var0 == 22)
		{
			func_170(&Var0, Var1, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23)
		{
			if (iLocal_55 == 0)
			{
				if (func_175(&Var0, Var1, "FAN3AUD", "FAN3_AMB", 3, "MARYANN", 50))
				{
					iLocal_55 = 1;
				}
			}
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5642
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5CDC
{
...
int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6092
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_114(var uParam0, int iParam1, bool bParam2)//Position - 0x8C05
{
	...
	while (iVar0 < 6)
	{
		if (func_178(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_178(uParam0->f_29[iVar0]))
		{
...
var func_149(struct<3> Param0, int iParam1)//Position - 0x9D8B
{
	var uVar0;
	...
	switch (iParam0->f_10)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_178(iParam0->f_1C[0]))
				{
					if (func_154(iParam0))
					{
						if (func_158(2))
...
void func_167(int iParam0)//Position - 0xB015
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_56) >= 900)
	{
		if (func_178(iParam0->f_1C[0]))
		{
			if (!func_128())
			{
				func_168(iParam0->f_1C[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_56 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
int func_170(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xB273
{
	var uVar0;
	
	if ((((func_178(PLAYER::PLAYER_PED_ID()) && func_178(iParam0->f_1C[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
...
float func_174(int iParam0, struct<3> Param1, int iParam2)//Position - 0xB427
{
	struct<3> Var0;
...
int func_175(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xB460
{
	var uVar0;
	...
	if (func_158(2))
	{
		if (!func_128())
		{
			if (((func_178(PLAYER::PLAYER_PED_ID()) && func_178(iParam0->f_1C[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_173(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
				func_171(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_187(var uParam0, bool bParam1)//Position - 0xB8BD
{
	...
	if ((func_224(*uParam0) || func_222(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_191(&(uParam0->f_30)) && bParam1)
	{
		func_188(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}
...
void func_192(var uParam0)//Position - 0xBEE2
{
	...
	if (*uParam0 == 52)
	{
		func_193(&(uParam0->f_29[1]));
		func_193(&(uParam0->f_29[2]));
	}
	if (func_178(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_196(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_216(*uParam0))
					{
						if (!func_137(*uParam0))
						{
							if (func_211(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_192(uParam0);
						...
						if (func_199(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_192(uParam0);
...
bool func_201(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC7FD
{
	...
	uVar0 = func_202(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_202(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xC8BE
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
int func_205(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xCAF9
{
	...
	{
		Var1 = { func_207(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_206(Var1, Var0);
...
float func_206(struct<3> Param0, struct<3> Param1)//Position - 0xCB8A
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_214(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xCF08
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
{
	if ((func_223() && Global_15F6A.f_B == 6) && iParam0 == func_146(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_227(var uParam0)//Position - 0xD32C
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_233(&(uParam0->f_30), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_50 = 1;
			break;
		
		case 1:
			if (!func_232(&iVar0) || !func_231(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			{
				if (func_228(&(uParam0->f_1C[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_228(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xD6EA
{
	if (func_229(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_229(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)//Position - 0xD745
{
	int iVar0;
...
int func_234(var uParam0)//Position - 0xD8B0
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_233(&(uParam0->f_30), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_50 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_228(&(uParam0->f_1C[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_238(&(uParam0->f_1C[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_178(uParam0->f_1C[1]))
				{
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 4, 1, 0, 0);
					PED::SET_PED_PROP_INDEX(uParam0->f_1C[1], 0, 0, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_1C[1], 1);
					PED::SET_PED_LOD_MULTIPLIER(uParam0->f_1C[1], 3.5f);
				}
				else
				{
					bVar2 = false;
			...
			{
				func_236(&(uParam0->f_23[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[1]))
			{
				func_236(&(uParam0->f_23[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar2)
			{
				iLocal_50 = 3;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_178(uParam0->f_23[iVar1]))
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[iVar1], iVar1);
				}
				iVar1++;
			}
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_178(uParam0->f_1C[1]))
				{
					TASK::TASK_PLAY_ANIM(uParam0->f_1C[1], "rcm_fanatic2", "ef_2_rcm__maryann_biking_cyclist", 8f, -8f, -1, 1, 0, 0, 0, 0);
...
void func_236(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xDBF4
{
	func_237(uParam0);
...
void func_238(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xDCCB
{
	func_239(uParam0);
...
int func_240(var uParam0)//Position - 0xDD2B
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_233(&(uParam0->f_30), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_228(&(uParam0->f_1C[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_251(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xE271
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_252((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_252((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_252(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xE2D6
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_253(Var1.f_6, Param1, fParam2))
	{
...
int func_253(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xE353
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
