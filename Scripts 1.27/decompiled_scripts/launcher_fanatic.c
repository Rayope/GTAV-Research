	...
	while (true)
	{
		...
		if (iLocal_94 == 0)
		{
			if (Var0 == 22)
			{
				...
				{
					if (func_178(Var0.f_28[1]))
					{
						func_270("Trying to set Mary Ann boyfriend component variation");
		...
		{
			func_170(&Var0, Var61, "FAN2AU", "FAN2_AMB", 3, "MARYANN", 5000, 1101004800);
		}
		else if (Var0 == 23)
		{
			if (iLocal_95 == 0)
...
int func_1(int iParam0)//Position - 0x2D7
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x3B7
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1A38
{
	int iVar0;
	int iVar1;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2965
{
...
int func_29(int iParam0)//Position - 0x29A5
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29D3
{
...
int func_31(int iParam0)//Position - 0x2AAF
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AF1
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B54
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BE2
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2C24
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E9C
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2EA8
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3154
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3204
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x32DE
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x338F
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x34BC
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x352D
{
...
int func_44(int iParam0)//Position - 0x3606
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x3643
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x366D
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x3817
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x3849
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x387D
{
	return Global_1312737;
}

int func_50(int iParam0, int iParam1)//Position - 0x3889
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x38B5
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3DFD
{
	int iVar0;
...
int func_53()//Position - 0x403F
{
	func_54();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_54()//Position - 0x4058
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x4155
{
	return Global_34913 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x4163
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x4256
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x44BA
{
...
int func_59(int iParam0, int iParam1)//Position - 0x45E0
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4DFC
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4E37
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x50AB
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x50E7
{
	int iVar0;
	struct<3> Var1;
	var uVar4;
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5642
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x5686
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5CDC
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_67(var uParam0)//Position - 0x5D05
{
...
bool func_68(int iParam0)//Position - 0x5D5E
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5D6E
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5DCE
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x6077
{
	return Global_24444;
}

int func_72(int iParam0)//Position - 0x6082
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x6092
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x6129
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x65FA
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x660A
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x6863
{
	return Global_90014.f_290 > 0;
}

var func_78()//Position - 0x6874
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x68BA
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x6940
{
...
void func_81(var uParam0, int iParam1)//Position - 0x6973
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x69C4
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x6A66
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6A8B
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6AA2
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6AAF
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6AE9
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6B24
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6B60
{
	func_54();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_90(int iParam0)//Position - 0x6B79
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6BD2
{
...
bool func_92(bool bParam0)//Position - 0x6C14
{
...
struct<2> func_93(int iParam0)//Position - 0x6C3F
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x708C
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x8366
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x86AC
{
	var uVar0;
...
void func_98(int iParam0)//Position - 0x8750
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x87EB
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x8849
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x88A2
{
...
int func_103(int iParam0)//Position - 0x8925
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x8956
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x896A
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8A12
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x8A2D
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8A79
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8AC2
{
	if (func_178(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8AE2
{
	switch (iParam0)
	{
		case 5:
...
int func_113(int iParam0)//Position - 0x8BB2
{
	switch (iParam0)
	{
		case 5:
...
void func_114(var uParam0, int iParam1, bool bParam2)//Position - 0x8C05
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_178(uParam0->f_28[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_178(uParam0->f_41[iVar0]))
		{
...
int func_115(int iParam0)//Position - 0x8CF9
{
	switch (iParam0)
	{
		case 5:
...
void func_116(bool bParam0)//Position - 0x8D64
{
	var uVar0;
...
void func_117(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8DA0
{
	if (bParam0)
	{
...
int func_118(int iParam0)//Position - 0x8E71
{
...
bool func_119()//Position - 0x8EB2
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_120(int iParam0, int iParam1)//Position - 0x8EC3
{
	bool bVar0;
...
int func_121(int iParam0, bool bParam1)//Position - 0x8F0E
{
	int iVar0;
	int iVar1;
...
int func_122(int iParam0, var uParam1, var uParam2)//Position - 0x8F4F
{
	int iVar0;
...
void func_124(int iParam0)//Position - 0x8FA7
{
	if (iParam0 == 1)
	{
...
int func_125(char* sParam0)//Position - 0x8FCA
{
...
void func_126()//Position - 0x9007
{
	Global_14558 = 0;
	func_127();
}

void func_127()//Position - 0x9017
{
...
int func_131(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x90FB
{
...
void func_134(int iParam0)//Position - 0x92F6
{
	if (Global_14551)
	{
		func_135(0, 0);
...
void func_135(bool bParam0, bool bParam1)//Position - 0x9366
{
	if (bParam0)
	{
		if (func_136(0))
...
int func_136(int iParam0)//Position - 0x93DA
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
int func_137(int iParam0)//Position - 0x9434
{
...
int func_138(int iParam0)//Position - 0x9475
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0x94BA
{
...
int func_140(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x94EC
{
	int iVar0;
...
void func_141(var uParam0, int iParam1)//Position - 0x9623
{
	int iVar0;
...
bool func_142(int iParam0)//Position - 0x9672
{
	return func_143(iParam0, Global_34913);
}

int func_143(int iParam0, int iParam1)//Position - 0x9683
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_144(int iParam0)//Position - 0x9864
{
	if (Global_34913 == 15)
	{
		return 0;
...
int func_145()//Position - 0x9886
{
	return func_146(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_146(var uParam0, int iParam1)//Position - 0x9897
{
	int iVar0;
	var uVar1;
	int iVar33;
...
void func_148(int iParam0, var uParam1)//Position - 0x9904
{
	switch (iParam0)
	{
		case 0:
...
var func_149(struct<3> Param0, int iParam3)//Position - 0x9D8B
{
	var uVar0;
...
float func_150(bool bParam0, float fParam1, float fParam2)//Position - 0x9DB7
{
	if (bParam0)
	{
		return fParam1;
...
int func_151(int iParam0)//Position - 0x9DCE
{
	switch (iParam0)
	{
		case 0:
...
int func_152(int iParam0, int iParam1)//Position - 0x9E5D
{
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_178(iParam0->f_28[0]))
				{
					if (func_154(iParam0))
					{
						if (func_158(2))
...
void func_153()//Position - 0xA63F
{
	func_27(&(Global_91351.f_2167), &Global_91351, 0, 1, 1, 0);
}

int func_154(var uParam0)//Position - 0xA65A
{
	float fVar0;
...
void func_155(int iParam0, int iParam1)//Position - 0xA6E8
{
	if (iParam0 == 1)
	{
		if (!func_113(iParam1))
...
int func_156(bool bParam0)//Position - 0xA74B
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0xA7E2
{
	if (func_178(uParam0))
	{
...
int func_158(int iParam0)//Position - 0xA80C
{
	int iVar0;
...
var func_159()//Position - 0xAF29
{
	return Global_90001.f_1;
}

int func_160()//Position - 0xAF37
{
	if (Global_87289 != -1)
	{
...
bool func_163()//Position - 0xAFA1
{
	return Global_90014.f_291 > 0;
}

bool func_164(int iParam0, int iParam1)//Position - 0xAFB2
{
	switch (iParam0)
	{
		case 5:
...
var func_165()//Position - 0xAFED
{
	return Global_1315900;
}

int func_166()//Position - 0xAFF9
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_167(int iParam0)//Position - 0xB015
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_96) >= 900)
	{
		if (func_178(iParam0->f_28[0]))
		{
			if (!func_128())
			{
				func_168(iParam0->f_28[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_96 = MISC::GET_GAME_TIMER();
			}
		}
	}
...
void func_168(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xB065
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(uParam0, sParam1, sParam2, func_169(iParam3), 0);
}

int func_169(int iParam0)//Position - 0xB07E
{
	int iVar0;
...
int func_170(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xB273
{
	var uVar0;
	
	if ((((func_178(PLAYER::PLAYER_PED_ID()) && func_178(iParam0->f_28[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_171(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB2FB
{
...
void func_172(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB336
{
...
void func_173(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xB38C
{
...
float func_174(int iParam0, struct<3> Param1, int iParam4)//Position - 0xB427
{
	struct<3> Var0;
...
int func_175(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xB460
{
	...
	if (func_158(2))
	{
		if (!func_128())
		{
			if (((func_178(PLAYER::PLAYER_PED_ID()) && func_178(iParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_173(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
				func_171(&uVar0, cParam4, sParam5, 7, 0, 0);
...
int func_176(char* sParam0)//Position - 0xB522
{
	struct<6> Var0;
...
struct<6> func_177()//Position - 0xB542
{
	struct<6> Var0;
...
int func_178(int iParam0)//Position - 0xB566
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
...
void func_179(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xB586
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_180(int iParam0, bool bParam1)//Position - 0xB677
{
	if (iParam0 == -1)
	{
		return;
...
int func_181(int iParam0)//Position - 0xB6B3
{
	if (Global_68241 == iParam0)
	{
		if (Global_68242 == -1)
...
void func_182(int iParam0, int iParam1)//Position - 0xB6EC
{
	bool bVar0;
	int iVar1;
...
bool func_183()//Position - 0xB78A
{
	return Global_87676;
}

void func_184(int iParam0)//Position - 0xB796
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_185(iParam0);
...
void func_185(int iParam0)//Position - 0xB7AD
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_186(int iParam0)//Position - 0xB895
{
	if (iParam0 == -1)
	{
		iParam0 = func_145();
...
void func_188(int iParam0, var uParam1, int iParam2)//Position - 0xBB30
{
	var uVar0;
	var uVar1;
	...
	if (func_178(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_190(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_189(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_190(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_189(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_189(int iParam0)//Position - 0xBE85
{
...
int func_190(var uParam0)//Position - 0xBEA5
{
...
int func_191(var uParam0)//Position - 0xBEBD
{
...
void func_192(var uParam0)//Position - 0xBEE2
{
	int iVar0;
	var uVar1;
...
void func_193(var uParam0)//Position - 0xC1E7
{
...
void func_194(var uParam0)//Position - 0xC212
{
	int iVar0;
...
int func_195(var uParam0, bool bParam1, bool bParam2)//Position - 0xC292
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_196(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_196(int iParam0, int iParam1)//Position - 0xC44F
{
	int iVar0;
...
int func_198(int iParam0)//Position - 0xC73B
{
...
int func_199(int iParam0, float fParam1)//Position - 0xC76F
{
	...
	if (func_178(PLAYER::PLAYER_PED_ID()) && func_178(iParam0))
	{
		if (func_210(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_201(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC7FD
{
	...
	if (!func_178(iParam0) || !func_178(iParam1))
	{
		if (iVar4 != -1)
		{
			func_208(&(Local_36[iVar4 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_202(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_202(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xC8BE
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_203(int iParam0, int iParam1)//Position - 0xC9EA
{
	int iVar0;
...
int func_205(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xCAF9
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_207(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
float func_206(struct<3> Param0, struct<3> Param3)//Position - 0xCB8A
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_207(struct<3> Param0)//Position - 0xCBAB
{
	float fVar0;
	float fVar1;
...
void func_208(var uParam0)//Position - 0xCBEA
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_210(var uParam0)//Position - 0xCC44
{
...
int func_211(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xCC6C
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_178(PLAYER::PLAYER_PED_ID()) && func_178(uParam0))
	{
...
int func_212(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xCD67
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_213(var uParam0, float fParam1)//Position - 0xCE73
{
	var uVar0;
	struct<3> Var1;
...
int func_214(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xCF08
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_207(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
...
int func_215(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xCF96
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_216(int iParam0)//Position - 0xCFDE
{
...
void func_217(int iParam0)//Position - 0xD028
{
	var uVar0;
...
int func_218(int iParam0)//Position - 0xD0C5
{
	if (iParam0 == -1)
	{
		iParam0 = func_145();
...
int func_219(int iParam0)//Position - 0xD15D
{
...
int func_222(int iParam0)//Position - 0xD1DF
{
	if ((func_223() && Global_89962.f_11 == 6) && iParam0 == func_146(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_224(int iParam0)//Position - 0xD251
{
	if (func_92(0))
	{
...
int func_227(var uParam0)//Position - 0xD32C
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_233(&(uParam0->f_48), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_90 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_228(&(uParam0->f_28[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_228(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xD6EA
{
...
int func_229(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0xD745
{
	int iVar0;
...
int func_230(var uParam0, int iParam1)//Position - 0xD7D3
{
	int iVar0;
...
int func_231(var uParam0)//Position - 0xD819
{
	if (func_191(uParam0))
	{
...
int func_232(int iParam0)//Position - 0xD843
{
	int iVar0;
...
void func_233(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD874
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_234(var uParam0)//Position - 0xD8B0
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_233(&(uParam0->f_48), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_90 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_228(&(uParam0->f_28[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_238(&(uParam0->f_28[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_178(uParam0->f_28[1]))
				{
			...
			{
				func_236(&(uParam0->f_35[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[1]))
			{
				func_236(&(uParam0->f_35[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar5)
			{
				iLocal_90 = 3;
		...
		case 3:
			...
			while (iVar4 <= 1)
			{
				if (func_178(uParam0->f_35[iVar4]))
				{
			...
			if (STREAMING::HAS_ANIM_DICT_LOADED("rcm_fanatic2"))
			{
				if (func_178(uParam0->f_28[1]))
				{
					...
					func_270("Playing Mary Ann's friend anim...");
				}
			}
			func_235();
			iVar4 = 0;
...
void func_236(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xDBF4
{
	func_237(uParam0);
...
void func_237(var uParam0)//Position - 0xDC2F
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_238(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xDCCB
{
	func_239(uParam0);
	*uParam0 = PED::CREATE_PED(iParam6, uParam1, Param2, fParam5, 0, 0);
}

void func_239(var uParam0)//Position - 0xDCEC
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
int func_240(var uParam0)//Position - 0xDD2B
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_233(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_228(&(uParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_241(int iParam0)//Position - 0xDE85
{
	struct<27> Var0;
	int iVar32;
...
int func_242(int iParam0)//Position - 0xDED9
{
	char* sVar0;
...
int func_243(int iParam0)//Position - 0xDF70
{
	var uVar0;
...
int func_244(int iParam0)//Position - 0xE031
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_245(int iParam0, char* sParam1)//Position - 0xE0B6
{
...
bool func_246(int iParam0)//Position - 0xE198
{
...
bool func_247(int iParam0)//Position - 0xE1C6
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_248(int iParam0)//Position - 0xE1F4
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_249(int iParam0)//Position - 0xE222
{
	if (func_219(iParam0))
	{
		return 0;
...
void func_250()//Position - 0xE257
{
	func_270("Running end routines.");
	Global_97071 = (Global_97071 - 1);
}

int func_251(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE271
{
	int iVar0;
...
int func_252(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xE2D6
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_253(Var1.f_6, Param1, fParam4))
	{
...
int func_253(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xE353
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_255(char* sParam0)//Position - 0xE443
{
...
void func_256()//Position - 0xE462
{
	Global_14558 = 0;
	func_257();
}

void func_257()//Position - 0xE472
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_258(var uParam0)//Position - 0xE493
{
	if (func_191(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_259(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xE4C9
{
...
void func_260(var uParam0, bool bParam1)//Position - 0xE4E9
{
	func_261(&(uParam0->f_41), bParam1);
}

void func_261(var uParam0, bool bParam1)//Position - 0xE4FB
{
	int iVar0;
...
void func_262(var uParam0, bool bParam1)//Position - 0xE539
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_263(var uParam0, bool bParam1)//Position - 0xE574
{
	func_264(&(uParam0->f_35), bParam1);
}

void func_264(var uParam0, bool bParam1)//Position - 0xE586
{
	int iVar0;
...
void func_265(var uParam0)//Position - 0xE5C3
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_266(var uParam0, int iParam1)//Position - 0xE5FA
{
	func_267(&(uParam0->f_28), iParam1);
}

void func_267(var uParam0, int iParam1)//Position - 0xE60C
{
	int iVar0;
...
void func_268(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE64D
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_269(var uParam0)//Position - 0xE69C
{
	if (*uParam0 == -1)
	{
		return;
...
void func_270(char* sParam0)//Position - 0xE6D9
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_271(var uParam0)//Position - 0xE6EB
{
	*uParam0 = -1;
...
void func_272()//Position - 0xE71E
{
	func_270("Running start routines.");
	Global_97071++;
}

int func_273(int iParam0)//Position - 0xE738
{
	if (!func_36(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
