...
void func_2()//Position - 0x364
{
	...
	switch (iLocal_190)
	{
		case 0:
			...
			if (bLocal_223)
			{
				func_15(&uLocal_594, 3, Local_173, "JIMMYBOSTON", 0, 1);
				func_15(&uLocal_594, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			}
			switch (iLocal_263)
			{
				case 4:
...
void func_8(struct<3> Param0, float fParam3)//Position - 0x734
{
	func_9(&(Global_93588.f_2167), Param0, fParam3);
}

void func_9(var uParam0, struct<3> Param1, var uParam4)//Position - 0x74D
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_10(struct<3> Param0, float fParam3)//Position - 0x763
{
...
bool func_11(struct<3> Param0, struct<3> Param3)//Position - 0x78E
{
	...
	switch (iLocal_190)
	{
		...
		case 1:
			...
			else
			{
				...
				if (func_231())
				{
					if (func_230(PLAYER::PLAYER_PED_ID(), Local_155.x, 1) > 300f && !ENTITY::IS_ENTITY_ON_SCREEN(Local_155.x))
					{
					...
					if (((((!func_22() && !PED::IS_PED_FLEEING(Local_173)) && !PED::IS_PED_RAGDOLL(Local_173)) && !PED::IS_PED_PRONE(Local_173)) && !PED::IS_PED_INJURED(Local_173)) && !PED::IS_PED_IN_ANY_VEHICLE(Local_173, 0))
					{
						if (func_230(Local_173, PLAYER::PLAYER_PED_ID(), 1) <= 2.3f)
						{
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x2312
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_96(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_96(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_57(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2592
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_96(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_87(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_96(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_96(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5403
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_96(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6259
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_96(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_83(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_102(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_102(Var16.f_2)] = func_83(iParam1, Var16.x, func_102(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_111(14))
			{
				...
				uVar0 = func_91(func_109(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_91(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_114(int iParam0, int iParam1, int iParam2)//Position - 0xCD9F
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_107(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_96(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_107(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_169(int iParam0, int iParam1, int iParam2)//Position - 0x1E5E6
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_96(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_96(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_175()//Position - 0x1E951
{
	...
	{
		if (func_171(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_186()//Position - 0x20672
{
	...
	{
		func_175();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_187(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_232()//Position - 0x262AC
{
	if (func_447(Local_173))
	{
		...
		else if ((func_233(PLAYER::PLAYER_PED_ID(), Local_173, 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(Local_173, 1), 3f, 0)) || PED::IS_PED_BEING_JACKED(Local_173))
		{
			if (iLocal_189 != 5 && iLocal_189 != 3)
			{
				bLocal_232 = true;
...
int func_240(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x267A6
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_244(struct<3> Param0, struct<3> Param3)//Position - 0x26A72
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_253(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x26E37
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	switch (iLocal_189)
	{
		...
		case 2:
			...
			if (func_231())
			{
				if (!func_260())
				{
					func_265(ENTITY::GET_ENTITY_COORDS(Local_155.x, 1), 200f, 12, 5000, 0, 0);
				}
				if (func_231())
				{
		...
		case 3:
			...
			func_264(55);
			while (((!STREAMING::HAS_MODEL_LOADED(iLocal_760) || !STREAMING::HAS_MODEL_LOADED(Local_162.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_173.f_6)) || !func_263(55))
			{
		...
		case 4:
			...
			if (!func_260())
			{
				while (((((!STREAMING::HAS_MODEL_LOADED(Local_162.f_1) || !CUTSCENE::HAS_CUTSCENE_LOADED()) || !STREAMING::HAS_MODEL_LOADED(Local_155.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_173.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_263(55))
				{
			...
			{
				while ((((!STREAMING::HAS_MODEL_LOADED(Local_162.f_1) || !STREAMING::HAS_MODEL_LOADED(Local_155.f_1)) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_173.f_6)) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff")) || !func_263(55))
				{
					func_490("WAITING FOR MS_ENDCUTSCENE RESOURCES");
					SYSTEM::WAIT(0);
				}
...
void func_265(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x276FD
{
	var uVar0;
	int iVar1;
	...
	switch (iLocal_189)
	{
		case 0:
			...
			if (func_447(Local_181))
			{
				...
				PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_181, uLocal_759);
				PED::SET_PED_CONFIG_FLAG(Local_181, 132, 1);
				func_15(&uLocal_264, 4, Local_181, "TOM", 1, 1);
			}
			break;
...
int func_274(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x28015
{
	bool bVar0;
	float fVar1;
...
void func_275()//Position - 0x2806F
{
	switch (iLocal_189)
	{
		...
		case 4:
			...
			{
				func_274(Local_173, Local_173.f_2, Local_173.f_5, 0, 1);
				if (func_447(Local_173))
				{
					TASK::TASK_PLAY_ANIM(Local_173, Local_173.f_6, Local_173.f_7, 8f, -8f, -1, 49, 0, 0, 0, 0);
					PED::SET_PED_PROP_INDEX(Local_173, 1, 0, 0, false);
		...
		case 5:
			if (!bLocal_209)
			{
				if (!func_447(Local_173))
				{
					...
					{
						Local_173.f_1 = func_277(Local_173, 1, 1, 9);
					}
					if (func_447(Local_173) && func_231())
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_260);
				...
				{
					func_274(Local_173, 1683.76f, 3270.74f, 39.78f, 168.3395f, 0, 1);
					if (!HUD::DOES_BLIP_EXIST(Local_173.f_1))
					{
						Local_173.f_1 = func_277(Local_173, 1, 1, 9);
					}
...
int func_279(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2843D
{
...
int func_280(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x28498
{
	int iVar0;
...
void func_282()//Position - 0x2856C
{
	switch (iLocal_189)
	{
		...
		case 2:
			if (!func_260())
			{
				if (func_447(PLAYER::PLAYER_PED_ID()) && func_450(Local_155.x))
				{
					if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, 0))
					{
						PED::SET_PED_INTO_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, -1);
...
{
	func_285(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_285(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2884A
{
	...
	*uParam0 = func_226();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_306())
		{
			func_302(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_297(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_308(int iParam0, var uParam1)//Position - 0x2ADC6
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_309(Var9.f_1)) && iVar70 < 50)
			{
...
int func_315(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C1B6
{
	int iVar0;
	int iVar1;
...
int func_322(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2CBD2
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_344()//Position - 0x2DAE8
{
	switch (iLocal_190)
	{
		...
		case 2:
			...
			func_274(Local_155.x, 1684.78f, 3255.58f, 41.78f, 284.26f, 0, 1);
...
void func_354()//Position - 0x2E1DD
{
	if (func_447(Local_173))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			...
			if (func_447(Local_173) && func_231())
			{
				func_274(Local_173, 1682.13f, 3268.65f, 39.75f, 183.3768f, 0, 1);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_260);
				TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, 1682.44f, 3258.81f, 39.81f, 2f, 20000, 7.5f, 1, 1193033728);
				TASK::TASK_ENTER_VEHICLE(0, Local_155.x, 20000, -1, 1073741824, 1, 0);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_260);
...
int func_355()//Position - 0x2E294
{
	if (func_447(PLAYER::PLAYER_PED_ID()))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Michael", 0))
		{
			...
			func_274(Local_162, Local_162.f_3, Local_162.f_6, 1, 1);
			if (func_450(Local_162))
			{
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(Local_162, 1);
			}
...
void func_361(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2E592
{
	func_362(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_362(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2E5BC
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_364(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2E9CC
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_365(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2ECC2
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_374()//Position - 0x2F12A
{
	switch (iLocal_190)
	{
		case 0:
			...
			VEHICLE::REQUEST_VEHICLE_RECORDING(501, "Eps6_Takeoff");
			while ((((!func_263(55) || !STREAMING::HAS_ANIM_DICT_LOADED(Local_173.f_6)) || !STREAMING::HAS_MODEL_LOADED(Local_162.f_1)) || !STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01"))) || !VEHICLE::HAS_VEHICLE_RECORDING_BEEN_LOADED(501, "Eps6_Takeoff"))
			{
				SYSTEM::WAIT(0);
			}
			if (iLocal_208)
		...
		case 1:
			...
			if (func_447(Local_173))
			{
				if (func_230(PLAYER::PLAYER_PED_ID(), Local_173, 1) < 100f)
				{
				...
				else if (func_230(PLAYER::PLAYER_PED_ID(), Local_173, 1) > 120f)
				{
					if (CUTSCENE::HAS_CUTSCENE_LOADED())
					{
			...
			if (func_231())
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					...
					if (func_375(PLAYER::PLAYER_PED_ID(), Local_173, 13f))
					{
				...
				else if (func_375(PLAYER::PLAYER_PED_ID(), Local_173, 5f))
				{
					if (func_447(PLAYER::PLAYER_PED_ID()) && func_447(Local_173))
					{
...
{
	if (func_230(PLAYER::PLAYER_PED_ID(), Local_173, 1) <= 15f)
	{
		if (!STREAMING::IS_STREAMVOL_ACTIVE())
		{
			if (!STREAMING::STREAMVOL_HAS_LOADED(uLocal_259))
			{
				...
				uLocal_259 = STREAMING::STREAMVOL_CREATE_FRUSTUM(1684.85f, 3276.16f, 39.93f, func_377(-2.1719f, 0f, -78.5672f), 50f, 12, 127);
			}
		}
	}
...
void func_378()//Position - 0x2F5AA
{
	...
	if (func_447(Local_173) && func_447(PLAYER::PLAYER_PED_ID()))
	{
...
void func_380()//Position - 0x2F6EF
{
	if (func_447(Local_173))
	{
		...
		else if (func_230(PLAYER::PLAYER_PED_ID(), Local_173, 1) <= 25f && func_22())
		{
			if (!PED::IS_PED_HEADTRACKING_PED(Local_173, PLAYER::PLAYER_PED_ID()))
			{
		...
		else if (PED::IS_PED_HEADTRACKING_PED(Local_173, PLAYER::PLAYER_PED_ID()) && !func_22())
		{
	...
	if (!func_22() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_447(Local_173) && func_447(PLAYER::PLAYER_PED_ID()))
		{
			if (func_375(PLAYER::PLAYER_PED_ID(), Local_173, 25f))
			{
	...
	switch (iLocal_190)
	{
		...
		case 1:
			...
			if (func_231())
			{
				if (iLocal_228 == 0)
				{
					if (func_395(Local_155.x, Local_169, 1) < 1100f)
					{
						func_283(1, "Landing stage", 0, 0, 0, 1);
						iLocal_228 = 1;
				...
				if (iLocal_229 == 0)
				{
					if (func_395(Local_155.x, Local_169, 1) < 350f)
					{
						STREAMING::REQUEST_MODEL(Local_162.f_1);
						func_264(55);
						STREAMING::REQUEST_ANIM_DICT(Local_173.f_6);
						...
						if (((STREAMING::HAS_MODEL_LOADED(Local_162.f_1) && func_263(55)) && STREAMING::HAS_ANIM_DICT_LOADED(Local_173.f_6)) && STREAMING::HAS_MODEL_LOADED(joaat("p_amb_phone_01")))
						{
							func_275();
							func_262();
							func_15(&uLocal_594, 3, Local_173, "JIMMYBOSTON", 0, 1);
				...
				else
				{
					...
					{
						Local_155.f_2 = func_391(Local_155.x, 1, 5);
					...
					{
						if (func_395(Local_155.x, 1654.72f, 3239.21f, 39.55f, 1) >= 50f)
						{
							if (!iLocal_213)
							{
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(Local_155.x, Local_252, Local_255, 33.25f, 0, 1, 2))
				{
					...
					if (VEHICLE::GET_LANDING_GEAR_STATE(Local_155.x) == 0 || VEHICLE::GET_LANDING_GEAR_STATE(Local_155.x) == 2)
					{
						...
						if (func_387() && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, 0))
						{
							...
							func_385("*** Plane engine health: ", VEHICLE::GET_VEHICLE_ENGINE_HEALTH(Local_155.x));
							func_385("*** Plane petrol tank health: ", VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(Local_155.x));
...
void func_392()//Position - 0x302E9
{
	if (func_447(Local_173))
	{
		if (func_230(Local_173, Local_155.x, 1) < 17f)
		{
			if (!bLocal_223)
			{
				if (!func_22())
		...
		if (func_230(Local_173, Local_155.x, 1) < 12f)
		{
			func_234();
			iLocal_263 = 5;
			iLocal_190 = 0;
...
int func_394(struct<3> Param0, int iParam3, int iParam4)//Position - 0x30441
{
	int iVar0;
...
float func_395(int iParam0, struct<3> Param1, int iParam4)//Position - 0x3046F
{
	struct<3> Var0;
	...
	switch (iLocal_193)
	{
		case 0:
			...
			else if (iLocal_194 == 1)
			{
				...
				{
					case 0:
						if (func_230(PLAYER::PLAYER_PED_ID(), Local_181, 1) < 50f)
						{
							if (!func_22())
							{
				...
				if (func_447(PLAYER::PLAYER_PED_ID()) && func_450(Local_155.x))
				{
					if (func_230(PLAYER::PLAYER_PED_ID(), Local_181, 1) < 10f || func_230(PLAYER::PLAYER_PED_ID(), Local_155.x, 1) < 10f)
					{
		...
		case 1:
			...
			{
				if ((func_447(PLAYER::PLAYER_PED_ID()) && func_450(Local_155.x)) && func_448(Local_181))
				{
					if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						if (func_230(PLAYER::PLAYER_PED_ID(), Local_181, 1) < 15f || func_230(PLAYER::PLAYER_PED_ID(), Local_155.x, 1) < 10f)
						{
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -2915.73f, 3195.936f, 7.80361f, -2897.807f, 3171.756f, 12.6042f, 16f, 0, 1, 0))
							{
								func_256(2);
			...
			else if (iLocal_194 == 1)
			{
				...
				else if ((MISC::GET_GAME_TIMER() - iLocal_247) > 1000 || iLocal_247 == 0)
				{
					...
					if (func_389("EPS6_SPOT"))
					{
						...
						{
							if (func_403(Local_181, PLAYER::PLAYER_PED_ID()) > 10f)
							{
								func_20();
								bLocal_227 = true;
							}
				...
				if (func_450(Local_155.x) && func_447(Local_181))
				{
		...
		case 3:
			if (iLocal_194 == 0)
			{
				...
				if (iLocal_233 == 0)
				{
					func_401(Local_181, "AIMED_AT_BY_PLAYER", "TOM", 4);
					if (!func_372(Local_181, -1519143300))
					{
						TASK::CLEAR_PED_TASKS(Local_181);
		...
		case 5:
			...
			else if (iLocal_194 == 1)
			{
				if (iLocal_210 == 0)
				{
					if ((!HUD::IS_MESSAGE_BEING_DISPLAYED() && !func_22()) && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, 1))
					{
						RECORDING::_0x293220DA1B46CEBC(3f, 10f, 1);
		...
		case 4:
			if (iLocal_194 == 0)
			{
				if (func_448(Local_181))
				{
					if (func_395(Local_181, -2884.934f, 3200.156f, 10.7036f, 1) > 2f)
					{
						TASK::CLEAR_PED_TASKS(Local_181);
			...
			else if (iLocal_194 == 1)
			{
				if (iLocal_189 == 0)
				{
					if (iLocal_210 == 0)
					{
						if ((!func_389("EPS6_SPOT") && !PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, 1)) && !PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
						{
							func_400("EPS6_GETIN", 7500, 1);
...
{
	if (func_231() && func_447(Local_181))
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, 1))
		{
...
void func_407()//Position - 0x31457
{
	if (iLocal_193 == 2)
	{
		switch (iLocal_195)
		{
			...
			case 1:
				if (func_447(Local_181) && func_447(PLAYER::PLAYER_PED_ID()))
				{
					TASK::CLEAR_PED_TASKS(Local_181);
					Local_763 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					TASK::OPEN_SEQUENCE_TASK(&uLocal_260);
			...
			case 2:
				if (func_447(Local_181) && func_447(PLAYER::PLAYER_PED_ID()))
				{
					if (func_230(Local_181, PLAYER::PLAYER_PED_ID(), 1) < 5f || TASK::GET_SCRIPT_TASK_STATUS(Local_181, 242628503) == 7)
					{
						TASK::CLEAR_PED_TASKS(Local_181);
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(Local_181, PLAYER::PLAYER_PED_ID(), -1);
						iLocal_195 = 0;
...
void func_412()//Position - 0x315A9
{
	if (func_447(Local_181))
	{
		switch (iLocal_196)
		{
			...
			case 1:
				if (!func_372(Local_181, 713668775))
				{
			...
			case 2:
				if (func_395(Local_181, Local_198[iLocal_197 /*3*/], 1) <= 1.2f)
				{
					iLocal_196 = 3;
...
{
	if (func_447(PLAYER::PLAYER_PED_ID()) && func_447(Local_181))
	{
		if (func_250(Local_181, 0, 0, 0, 0))
		{
...
{
	if ((func_236(Local_181, 0, 1116471296, 1126825984, 0, 0, 0, 0) || func_233(PLAYER::PLAYER_PED_ID(), Local_181, 0)) || func_405())
	{
		if (func_236(Local_181, 0, 1116471296, 1126825984, 0, 0, 0, 0))
		{
			func_490("Player threatened cultist");
		}
		if (func_233(PLAYER::PLAYER_PED_ID(), Local_181, 0))
		{
		...
		if (func_448(Local_181))
		{
			...
			func_401(Local_181, "FIGHT_RUN", "TOM", 4);
		}
		return 1;
	}
	return 0;
...
void func_416()//Position - 0x319D9
{
	if (bLocal_231 == 0)
	{
		if (func_448(Local_181) && func_447(PLAYER::PLAYER_PED_ID()))
		{
			if (iLocal_230 == 0)
			{
...
void func_419()//Position - 0x31B49
{
	switch (iLocal_190)
	{
		case 0:
			...
			func_15(&uLocal_429, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
			func_15(&uLocal_264, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		...
		case 1:
			...
			if (func_231())
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_155.x, 0))
				{
					...
					if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
					{
						if (func_395(PLAYER::PLAYER_PED_ID(), Local_169, 0) < 2300f)
						{
							iLocal_190 = 2;
						}
					}
...
void func_422()//Position - 0x31F58
{
	...
	switch (iLocal_190)
	{
		case 0:
			...
			{
				Local_181.f_1 = func_277(Local_181, 1, 1, 5);
			}
			if (func_231())
			{
				func_386("*** Plane 'entity' health: ", ENTITY::GET_ENTITY_HEALTH(Local_155.x));
...
{
	if (((!func_436(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_443(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x32E44
{
	if (func_456())
	{
...
int func_451(var uParam0)//Position - 0x3324A
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_454(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar5))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (func_447(uParam0->f_28[0]) && func_448(PLAYER::PLAYER_PED_ID()))
			{
...
void func_452(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x33586
{
	func_4(uParam0);
	*uParam0 = PED::CREATE_PED(iParam6, uParam1, Param2, fParam5, 0, 0);
}

void func_453(var uParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x335A7
{
	func_5(uParam0);
