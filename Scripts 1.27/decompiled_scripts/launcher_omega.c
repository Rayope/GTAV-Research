...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_247(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_182(Var0);
		func_175(&iLocal_92, &(Var0.f_9), Var61);
		if (Var0 == 44)
		{
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x55C9
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5C63
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x6019
{
	int iVar0;
	float fVar1;
	float fVar2;
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_111(iParam0->f_28[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_155(2))
							{
								if (func_153(iParam0->f_27))
								{
									func_152(iParam0->f_27, *iParam0);
...
void func_164(int iParam0)//Position - 0xAA63
{
	...
	{
		if (func_111(iParam0->f_28[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_28[0]))
		{
			if (func_111(PLAYER::PLAYER_PED_ID()) && !func_165(PLAYER::PLAYER_PED_ID(), iParam0->f_28[0], 50f))
			{
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xAC5D
{
	...
	if (!*uParam8 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_28[0])) && func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
			...
			if (func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
float func_174(int iParam0, struct<3> Param1, int iParam4)//Position - 0xAEFC
{
	struct<3> Var0;
...
int func_183(int iParam0, bool bParam1)//Position - 0xB26C
{
	...
	func_94(*iParam0, &Var0);
	if ((func_220(*iParam0) || func_218(*iParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_187(&(iParam0->f_48)) && bParam1)
	{
		func_184(iParam0->f_28[0], &(iParam0->f_48), *iParam0);
	}
	return 1;
}
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_212(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_207(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_188(uParam0);
...
bool func_197(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC1AD
{
	...
	uVar0 = func_198(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_198(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xC26E
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC4A9
{
	...
	{
		Var3 = { func_203(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_202(Var3, Var0);
...
float func_202(struct<3> Param0, struct<3> Param3)//Position - 0xC53A
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_210(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xC8B8
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_219() && Global_89962.f_11 == 6) && iParam0 == func_147(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_224(var uParam0)//Position - 0xCCE6
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_232(&(uParam0->f_48), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_90 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_227(&(uParam0->f_28[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar4 = false;
				}
			}
			...
			{
				func_225(&(uParam0->f_35[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar4)
			{
				iLocal_90 = 3;
...
void func_225(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xCEB3
{
	func_226(uParam0);
...
int func_227(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xCF8A
{
...
int func_228(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0xCFE5
{
	int iVar0;
...
int func_233(var uParam0)//Position - 0xD150
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_232(&(uParam0->f_48), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_90 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_227(&(uParam0->f_28[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar5 = false;
				}
			}
			...
			if ((func_111(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
...
int func_244(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xD7BE
{
	int iVar0;
...
int func_245(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xD823
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_246(Var1.f_6, Param1, fParam4))
	{
...
int func_246(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xD8A0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
