...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_247(&Var0, 1);
	}
	if (!func_244(&iVar2, &Var0, Var1, 1f))
	{
		func_243();
	...
	while (true)
	{
		...
		func_182(Var0);
		func_175(&iLocal_52, &(Var0.f_9), Var1);
		if (Var0 == 44)
		{
			func_167(&Var0, Var1, "SCRAPAU", "SCRAP_1_AMB", 3, "OMEGA", &uLocal_53);
			func_166();
		}
		else if (Var0 == 45)
		{
			func_167(&Var0, Var1, "SCRAPAU", "SCRAP_2_AMB", 3, "OMEGA", &uLocal_54);
			func_164(&Var0);
		}
		if (func_149(&Var0, 0))
		{
...
int func_1(int iParam0)//Position - 0x25D
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x33C
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19BD
{
	int iVar0;
	int iVar1;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28EA
{
...
int func_29(int iParam0)//Position - 0x292A
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2958
{
...
int func_31(int iParam0)//Position - 0x2A34
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A76
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2AD9
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2B67
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BA9
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E21
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E2D
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x30D9
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3189
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x3263
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3314
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x3441
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34B2
{
...
int func_44(int iParam0)//Position - 0x358B
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x35C8
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x35F2
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x379C
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x37CE
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x3802
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x380E
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x383A
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D82
{
	int iVar0;
...
int func_53()//Position - 0x3FC3
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x3FDC
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x40DC
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x40EA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x41DD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x4441
{
...
int func_59(int iParam0, int iParam1)//Position - 0x4567
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4D83
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4DBE
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x5032
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x506E
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x55C9
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x560D
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5C63
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5C8C
{
...
bool func_68(int iParam0)//Position - 0x5CE5
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5CF5
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5D55
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x5FFE
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x6009
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6019
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x60B0
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x6581
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x6591
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x67EA
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x67FB
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x6841
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x68C7
{
...
void func_81(var uParam0, int iParam1)//Position - 0x68FA
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x694B
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x69ED
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6A12
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6A29
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6A36
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6A70
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6AAB
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6AE7
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6B00
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6B59
{
...
bool func_92(bool bParam0)//Position - 0x6B9B
{
...
struct<2> func_93(int iParam0)//Position - 0x6BC6
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x7013
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x82ED
{
	switch (iParam0)
	{
		case 0:
...
int func_97(int iParam0)//Position - 0x8633
{
	var uVar0;
...
void func_98(int iParam0)//Position - 0x86D7
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x8772
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x87D0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x8829
{
...
int func_103(int iParam0)//Position - 0x88AC
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x88DD
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x88F1
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8999
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x89B4
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8A00
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8A49
{
	if (func_111(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8A69
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_112(int iParam0)//Position - 0x8A89
{
	switch (iParam0)
	{
		case 5:
...
int func_114(int iParam0)//Position - 0x8B59
{
	switch (iParam0)
	{
		case 5:
...
void func_115(var uParam0, int iParam1, bool bParam2)//Position - 0x8BAC
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x8CA0
{
	switch (iParam0)
	{
		case 5:
...
void func_117(bool bParam0)//Position - 0x8D0B
{
	var uVar0;
...
void func_118(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8D47
{
	if (bParam0)
	{
...
int func_119(int iParam0)//Position - 0x8E18
{
...
bool func_120()//Position - 0x8E59
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_121(int iParam0, int iParam1)//Position - 0x8E6A
{
	bool bVar0;
...
int func_122(int iParam0, bool bParam1)//Position - 0x8EB5
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, var uParam1, var uParam2)//Position - 0x8EF6
{
	int iVar0;
...
void func_125(int iParam0)//Position - 0x8F4E
{
	if (iParam0 == 1)
	{
...
int func_126(char* sParam0)//Position - 0x8F71
{
...
void func_127()//Position - 0x8FAE
{
	Global_38DE = 0;
	func_128();
}

void func_128()//Position - 0x8FBE
{
...
int func_132(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x90A2
{
...
void func_135(int iParam0)//Position - 0x929D
{
	if (Global_38D7)
	{
		func_136(0, 0);
...
void func_136(bool bParam0, bool bParam1)//Position - 0x930D
{
	if (bParam0)
	{
		if (func_137(0))
...
int func_137(int iParam0)//Position - 0x9381
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_138(int iParam0)//Position - 0x93DB
{
...
int func_139(int iParam0)//Position - 0x941C
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0x9461
{
...
int func_141(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x9493
{
	int iVar0;
...
void func_142(var uParam0, int iParam1)//Position - 0x95CA
{
	int iVar0;
...
bool func_143(int iParam0)//Position - 0x9619
{
	return func_144(iParam0, Global_8861);
}

int func_144(int iParam0, int iParam1)//Position - 0x962A
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_145(int iParam0)//Position - 0x980B
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_146()//Position - 0x982D
{
	return func_147(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_147(var uParam0, int iParam1)//Position - 0x983E
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1)//Position - 0x98AB
{
	switch (iParam0->f_10)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_111(iParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0->f_1C[0], 1), 1) < 3f)
						{
							if (func_155(2))
							{
								if (func_153(iParam0->f_1B))
								{
									func_152(iParam0->f_1B, *iParam0);
...
void func_150()//Position - 0xA08D
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_151(var uParam0)//Position - 0xA0A8
{
	float fVar0;
...
void func_152(int iParam0, int iParam1)//Position - 0xA136
{
	if (iParam0 == 1)
	{
		if (!func_114(iParam1))
...
int func_153(bool bParam0)//Position - 0xA199
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0xA230
{
	if (func_111(uParam0))
	{
...
int func_155(int iParam0)//Position - 0xA25A
{
	int iVar0;
...
var func_156()//Position - 0xA977
{
	return Global_15F91.f_1;
}

int func_157()//Position - 0xA985
{
	if (Global_154F9 != -1)
	{
...
bool func_160()//Position - 0xA9EF
{
	return Global_15F9E.f_123 > 0;
}

bool func_161(int iParam0, int iParam1)//Position - 0xAA00
{
	switch (iParam0)
	{
		case 5:
...
var func_162()//Position - 0xAA3B
{
	return Global_14143C;
}

int func_163()//Position - 0xAA47
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_164(int iParam0)//Position - 0xAA63
{
	...
	if ((MISC::GET_GAME_TIMER() - iLocal_57) > 1250)
	{
		if (func_111(iParam0->f_1C[0]) && !ENTITY::IS_ENTITY_ON_SCREEN(iParam0->f_1C[0]))
		{
			if (func_111(PLAYER::PLAYER_PED_ID()) && !func_165(PLAYER::PLAYER_PED_ID(), iParam0->f_1C[0], 50f))
			{
				Var0 = { ENTITY::GET_ENTITY_COORDS(iParam0->f_1C[0], 1) };
				...
				ENTITY::SET_ENTITY_HEADING(iParam0->f_1C[0], fVar2);
			}
		}
...
bool func_165(int iParam0, int iParam1, float fParam2)//Position - 0xAB4B
{
...
void func_166()//Position - 0xAB6B
{
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_55, "SET_COLOUR");
	...
	GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(uLocal_55, "SET_DISTANCE");
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_FLOAT(10f);
	GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
	HUD::SET_TEXT_RENDER_ID(uLocal_56);
	fVar0 = 0.1f;
	fVar1 = 0.24f;
	fVar2 = 0.21f;
	fVar3 = 0.51f;
	...
	GRAPHICS::DRAW_SCALEFORM_MOVIE(uLocal_55, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((MISC::GET_GAME_TIMER() - iLocal_57) > 1250)
	{
		AUDIO::PLAY_SOUND_FROM_COORD(uLocal_58, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_57 = MISC::GET_GAME_TIMER();
	}
}

int func_167(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)//Position - 0xAC5D
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_155(2))
		{
			if (!func_129())
			{
				if ((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_1C[0])) && func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					func_264("start conversation");
					uVar0 = 16;
					if (*uParam6 == 0)
					{
						func_173(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
						func_171(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam6 = 2;
					}
					else if (*uParam6 == 2)
					{
						func_264("conversation ended");
						*uParam6 = 3;
						return 1;
					}
				}
			}
			else if (func_169(sParam3))
			{
				if (!*uParam6 == 1)
				{
					if (func_111(PLAYER::PLAYER_PED_ID()))
					{
						if (func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
						{
							func_264("pause conversation");
							func_168(1);
							*uParam6 = 1;
						}
					}
			...
			if (func_174(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam6 == 1)
			{
				func_264("unpause conversation");
				func_168(0);
				*uParam6 = 2;
			}
		}
...
void func_168(int iParam0)//Position - 0xAD7F
{
	Global_413F = iParam0;
}

int func_169(char* sParam0)//Position - 0xAD8C
{
	struct<6> Var0;
...
struct<6> func_170()//Position - 0xADAC
{
	struct<6> Var0;
...
void func_171(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xADD0
{
...
void func_172(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAE0B
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_173(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xAE61
{
...
float func_174(int iParam0, struct<3> Param1, int iParam2)//Position - 0xAEFC
{
	struct<3> Var0;
...
void func_175(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xAF35
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_174(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_178(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_174(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_180(iParam0);
				}
			}
...
void func_176(int iParam0, bool bParam1)//Position - 0xB026
{
	if (iParam0 == -1)
	{
		return;
...
int func_177(int iParam0)//Position - 0xB062
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_178(int iParam0, int iParam1)//Position - 0xB09B
{
	bool bVar0;
	int iVar1;
...
bool func_179()//Position - 0xB139
{
	return Global_1567C;
}

void func_180(int iParam0)//Position - 0xB145
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_181(iParam0);
...
void func_181(int iParam0)//Position - 0xB15C
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_182(int iParam0)//Position - 0xB244
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_183(int iParam0, bool bParam1)//Position - 0xB26C
{
	...
	func_94(*iParam0, &Var0);
	if ((func_220(*iParam0) || func_218(*iParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_187(&(iParam0->f_30)) && bParam1)
	{
		func_184(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_184(int iParam0, var uParam1, int iParam2)//Position - 0xB4DF
{
	var uVar0;
	var uVar1;
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_186(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_185(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_186(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_185(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_185(int iParam0)//Position - 0xB834
{
...
int func_186(var uParam0)//Position - 0xB854
{
...
int func_187(var uParam0)//Position - 0xB86C
{
...
void func_188(var uParam0)//Position - 0xB891
{
	int iVar0;
	var uVar1;
	...
	if (*uParam0 == 52)
	{
		func_189(&(uParam0->f_29[1]));
		func_189(&(uParam0->f_29[2]));
	}
	if (func_111(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
void func_189(var uParam0)//Position - 0xBB95
{
...
void func_190(var uParam0)//Position - 0xBBC0
{
	int iVar0;
...
int func_191(var uParam0, bool bParam1, bool bParam2)//Position - 0xBC40
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_192(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
...
int func_192(int iParam0, int iParam1)//Position - 0xBDFD
{
	int iVar0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_212(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_207(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_188(uParam0);
						...
						if (func_195(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_188(uParam0);
...
int func_194(int iParam0)//Position - 0xC0EB
{
...
int func_195(int iParam0, float fParam1)//Position - 0xC11F
{
	...
	{
		if (func_206(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_197(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC1AD
{
	...
	iVar2 = func_205(iParam0, iParam1);
	if (!func_111(iParam0) || !func_111(iParam1))
	{
		if (iVar2 != -1)
		{
			func_204(&(Local_36[iVar2 /*4*/]));
		}
		return 0;
	}
	if (!func_201(iParam0, iParam1, fParam2, iParam3))
	{
		return 0;
	}
	if (iVar2 == -1)
	...
	uVar0 = func_198(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_198(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xC26E
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_199(int iParam0, int iParam1)//Position - 0xC39A
{
	int iVar0;
...
int func_201(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC4A9
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_203(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_203(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_202(Var1, Var0);
...
float func_202(struct<3> Param0, struct<3> Param1)//Position - 0xC53A
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_203(struct<3> Param0)//Position - 0xC55B
{
	float fVar0;
	float fVar1;
...
void func_204(var uParam0)//Position - 0xC59A
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_206(var uParam0)//Position - 0xC5F4
{
...
int func_207(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC61C
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_111(PLAYER::PLAYER_PED_ID()) && func_111(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_211(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_208(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
		else
		{
			...
			else
			{
				...
				if (func_211(iParam0, bParam1, fVar0, fVar1))
				{
					return 1;
				}
			}
			if (func_208(iParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_208(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC717
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_209(var uParam0, float fParam1)//Position - 0xC823
{
	var uVar0;
	struct<3> Var1;
	...
	{
		if (func_210(uParam0, Var1, 90f, 0))
		{
			return 1;
		}
	}
...
int func_210(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xC8B8
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_203(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_211(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xC946
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_212(int iParam0)//Position - 0xC98E
{
...
void func_213(int iParam0)//Position - 0xC9D8
{
	var uVar0;
...
int func_214(int iParam0)//Position - 0xCA75
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_215(int iParam0)//Position - 0xCB0D
{
...
int func_218(int iParam0)//Position - 0xCB8F
{
	if ((func_219() && Global_15F6A.f_B == 6) && iParam0 == func_147(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_220(int iParam0)//Position - 0xCC01
{
	if (func_92(0))
	{
...
{
	uLocal_55 = unk_0x67D02A194A2FC2BD("digiscanner");
	...
	if (HUD::IS_NAMED_RENDERTARGET_REGISTERED("digiscanner"))
	{
		uLocal_56 = HUD::GET_NAMED_RENDERTARGET_RENDER_ID("digiscanner");
	}
	uLocal_58 = AUDIO::GET_SOUND_ID();
	iLocal_57 = MISC::GET_GAME_TIMER();
}
...
int func_224(var uParam0)//Position - 0xCCE6
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_232(&(uParam0->f_30), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_50 = 1;
			break;
		
		case 1:
			if (!func_231(&iVar0) || !func_230(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			{
				if (!func_227(&(uParam0->f_1C[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_225(&(uParam0->f_23[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar2)
			{
				iLocal_50 = 3;
...
void func_225(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xCEB3
{
	func_226(uParam0);
...
void func_226(var uParam0)//Position - 0xCEEE
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_227(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xCF8A
{
...
int func_228(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)//Position - 0xCFE5
{
	int iVar0;
...
int func_229(var uParam0, int iParam1)//Position - 0xD073
{
	int iVar0;
...
int func_230(var uParam0)//Position - 0xD0B9
{
	if (func_187(uParam0))
	{
...
int func_231(int iParam0)//Position - 0xD0E3
{
	int iVar0;
...
void func_232(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD114
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_233(var uParam0)//Position - 0xD150
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_232(&(uParam0->f_30), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_50 = 1;
			break;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_227(&(uParam0->f_1C[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			if ((func_111(uParam0->f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0])) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
			{
...
int func_234(int iParam0)//Position - 0xD3D2
{
	struct<27> Var0;
	int iVar1;
...
int func_235(int iParam0)//Position - 0xD426
{
	char* sVar0;
...
int func_236(int iParam0)//Position - 0xD4BD
{
	var uVar0;
...
int func_237(int iParam0)//Position - 0xD57E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_238(int iParam0, char* sParam1)//Position - 0xD603
{
...
bool func_239(int iParam0)//Position - 0xD6E5
{
...
bool func_240(int iParam0)//Position - 0xD713
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_241(int iParam0)//Position - 0xD741
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_242(int iParam0)//Position - 0xD76F
{
	if (func_215(iParam0))
	{
		return 0;
...
void func_243()//Position - 0xD7A4
{
	func_264("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_244(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xD7BE
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_245((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_245((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_245(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xD823
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_246(Var1.f_6, Param1, fParam2))
	{
...
int func_246(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xD8A0
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_247(int iParam0, bool bParam1)//Position - 0xD8EC
{
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && ENTITY::DOES_ENTITY_EXIST(iParam0->f_29[1]))
		{
			ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(iParam0->f_29[1]));
		}
...
void func_248(char* sParam0)//Position - 0xD9BC
{
...
void func_249()//Position - 0xD9DB
{
	Global_38DE = 0;
	func_250();
}

void func_250()//Position - 0xD9EB
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_251(var uParam0)//Position - 0xDA0C
{
	if (func_187(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_252(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xDA42
{
...
void func_253(var uParam0, bool bParam1)//Position - 0xDA62
{
	func_254(&(uParam0->f_29), bParam1);
}

void func_254(var uParam0, bool bParam1)//Position - 0xDA74
{
	int iVar0;
...
void func_255(var uParam0, bool bParam1)//Position - 0xDAB2
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_256(var uParam0, bool bParam1)//Position - 0xDAED
{
	func_257(&(uParam0->f_23), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xDAFF
{
	int iVar0;
...
void func_258(var uParam0)//Position - 0xDB3C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_259(var uParam0, int iParam1)//Position - 0xDB73
{
	func_260(&(uParam0->f_1C), iParam1);
}

void func_260(var uParam0, int iParam1)//Position - 0xDB85
{
	int iVar0;
...
void func_261(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDBC6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_262(var uParam0)//Position - 0xDC15
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
void func_263(var uParam0)//Position - 0xDC54
{
	if (*uParam0 == -1)
	{
		return;
...
void func_264(char* sParam0)//Position - 0xDC91
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_265(var uParam0)//Position - 0xDCA3
{
	*uParam0 = -1;
...
void func_266()//Position - 0xDCD6
{
	func_264("Running start routines.");
	Global_17B2F++;
}

int func_267(int iParam0)//Position - 0xDCF0
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
