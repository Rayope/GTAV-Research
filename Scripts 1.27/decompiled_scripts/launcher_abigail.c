	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_268(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_251(&Var0, 1);
	}
...
int func_1(int iParam0)//Position - 0x29A
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x379
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19FA
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x287E
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28A0
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2927
{
...
int func_29(int iParam0)//Position - 0x2967
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2995
{
...
int func_31(int iParam0)//Position - 0x2A71
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AB3
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B16
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BA4
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BE6
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E5E
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E6A
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3116
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31C6
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x32A0
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3351
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x347E
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34EF
{
...
int func_44(int iParam0)//Position - 0x35C8
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x3605
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x362F
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x37D9
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x380B
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x383F
{
	return Global_1312737;
}

int func_50(int iParam0, int iParam1)//Position - 0x384B
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3877
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3DBF
{
	int iVar0;
...
int func_97(int iParam0)//Position - 0x866E
{
	var uVar0;
...
int func_168(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xAFF7
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(uParam0->f_28[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_172(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
void func_169(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB07F
{
...
void func_170(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB0BA
{
...
void func_171(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xB110
{
...
float func_172(int iParam0, struct<3> Param1, int iParam4)//Position - 0xB1AB
{
	struct<3> Var0;
...
{
	if (func_111(*uParam1) && func_111(PLAYER::PLAYER_PED_ID()))
	{
		switch (*iParam0)
		{
			case 0:
			...
			case 1:
				if (MISC::GET_GAME_TIMER() > iParam0->f_166)
				{
					...
					else if (func_181(PLAYER::PLAYER_PED_ID(), *uParam1, 1) < 15f)
					{
						*iParam0 = 4;
					}
				}
...
bool func_174(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB4E0
{
...
int func_175(char* sParam0, int iParam1, bool bParam2)//Position - 0xB52E
{
	Global_15693 = 0;
...
float func_181(int iParam0, int iParam1, int iParam2)//Position - 0xBA53
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_182(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xBAAF
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_183(int iParam0, bool bParam1)//Position - 0xBBA0
{
	if (iParam0 == -1)
	{
		return;
...
int func_184(int iParam0)//Position - 0xBBDC
{
	if (Global_68241 == iParam0)
	{
		if (Global_68242 == -1)
...
void func_185(int iParam0, int iParam1)//Position - 0xBC15
{
	bool bVar0;
	int iVar1;
...
bool func_186()//Position - 0xBCB3
{
	return Global_87676;
}

void func_187(int iParam0)//Position - 0xBCBF
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_188(iParam0);
...
void func_188(int iParam0)//Position - 0xBCD6
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_189(int iParam0)//Position - 0xBDBE
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
void func_191(int iParam0, var uParam1, int iParam2)//Position - 0xC059
{
	var uVar0;
	var uVar1;
...
int func_192(int iParam0)//Position - 0xC3AE
{
...
int func_193(var uParam0)//Position - 0xC3CE
{
...
int func_194(var uParam0)//Position - 0xC3E6
{
...
void func_195(var uParam0)//Position - 0xC40B
{
	int iVar0;
	var uVar1;
...
void func_196(var uParam0)//Position - 0xC709
{
...
void func_197(var uParam0)//Position - 0xC734
{
	int iVar0;
...
int func_198(var uParam0, bool bParam1, bool bParam2)//Position - 0xC7B4
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_199(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
int func_199(int iParam0, int iParam1)//Position - 0xC971
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0xCC5D
{
...
int func_205(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xCDE0
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_206(int iParam0, int iParam1)//Position - 0xCF0C
{
	int iVar0;
...
int func_208(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD01B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	{
		Var3 = { func_210(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_209(struct<3> Param0, struct<3> Param3)//Position - 0xD0AC
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_210(struct<3> Param0)//Position - 0xD0CD
{
	float fVar0;
	float fVar1;
...
void func_211(var uParam0)//Position - 0xD10C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_213(var uParam0)//Position - 0xD166
{
...
int func_214(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD18E
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_215(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xD289
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_216(var uParam0, float fParam1)//Position - 0xD395
{
	var uVar0;
	struct<3> Var1;
...
int func_217(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xD42A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_218(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xD4B8
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_219(int iParam0)//Position - 0xD500
{
...
void func_220(int iParam0)//Position - 0xD54A
{
	var uVar0;
...
int func_221(int iParam0)//Position - 0xD5E7
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_222(int iParam0)//Position - 0xD67F
{
...
int func_225(int iParam0)//Position - 0xD701
{
...
int func_227(int iParam0)//Position - 0xD773
{
	if (func_92(0))
	{
...
int func_229(var uParam0)//Position - 0xD7E2
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_235(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(cLocal_98))
			{
				return 0;
			}
			iLocal_90 = 2;
...
void func_230(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xD994
{
	func_231(uParam0);
...
void func_231(var uParam0)//Position - 0xD9CF
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_232(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xDA6B
{
...
int func_233(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0xDAC6
{
	int iVar0;
...
int func_234(var uParam0, int iParam1)//Position - 0xDB54
{
	int iVar0;
...
int func_235(int iParam0)//Position - 0xDB9A
{
	int iVar0;
...
void func_236(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xDBCB
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_238(int iParam0)//Position - 0xDD12
{
	struct<27> Var0;
	int iVar32;
...
int func_239(int iParam0)//Position - 0xDD66
{
	char* sVar0;
...
int func_240(int iParam0)//Position - 0xDDFD
{
	var uVar0;
...
int func_241(int iParam0)//Position - 0xDEBE
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
bool func_242(int iParam0, char* sParam1)//Position - 0xDF43
{
...
bool func_243(int iParam0)//Position - 0xE025
{
...
bool func_244(int iParam0)//Position - 0xE053
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_245(int iParam0)//Position - 0xE081
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_246(int iParam0)//Position - 0xE0AF
{
	if (func_222(iParam0))
	{
		return 0;
...
void func_247()//Position - 0xE0E4
{
	func_269("Running end routines.");
	Global_97071 = (Global_97071 - 1);
}

int func_248(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE0FE
{
	int iVar0;
...
int func_249(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xE163
{
	int iVar0;
	struct<7> Var1;
...
int func_250(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xE1E0
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_252(char* sParam0)//Position - 0xE2B3
{
...
void func_253()//Position - 0xE2D2
{
	Global_14558 = 0;
	func_254();
}

void func_254()//Position - 0xE2E2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_255(char* sParam0)//Position - 0xE303
{
	struct<6> Var0;
...
struct<6> func_256()//Position - 0xE323
{
	struct<6> Var0;
...
void func_257(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xE347
{
...
void func_258(var uParam0, bool bParam1)//Position - 0xE367
{
	func_259(&(uParam0->f_41), bParam1);
}

void func_259(var uParam0, bool bParam1)//Position - 0xE379
{
	int iVar0;
...
void func_260(var uParam0, bool bParam1)//Position - 0xE3B7
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_261(var uParam0, bool bParam1)//Position - 0xE3F2
{
	func_262(&(uParam0->f_35), bParam1);
}

void func_262(var uParam0, bool bParam1)//Position - 0xE404
{
	int iVar0;
...
void func_263(var uParam0)//Position - 0xE441
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_264(var uParam0, int iParam1)//Position - 0xE478
{
	func_265(&(uParam0->f_28), iParam1);
}

void func_265(var uParam0, int iParam1)//Position - 0xE48A
{
	int iVar0;
...
void func_266(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE4CB
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_267(var uParam0)//Position - 0xE51A
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
void func_268(var uParam0)//Position - 0xE559
{
	if (*uParam0 == -1)
	{
		return;
...
void func_269(char* sParam0)//Position - 0xE596
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_270(var uParam0)//Position - 0xE5A8
{
	*uParam0 = -1;
...
void func_271()//Position - 0xE5DB
{
	func_269("Running start routines.");
	Global_97071++;
}

int func_272(int iParam0)//Position - 0xE5F5
{
	if (!func_36(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
