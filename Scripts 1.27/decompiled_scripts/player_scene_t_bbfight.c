...
void __EntryFunction__()//Position - 0x0
{
	...
	while (iLocal_274 && func_42(5, 0))
	{
		...
		{
			if (iLocal_108 == 258 && func_39(13) == 2)
			{
				func_59();
			}
		}
			...
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_492))
			{
				if (!iLocal_497)
				{
					...
					else
					{
						...
						{
							func_15(&uLocal_109, func_16(), PLAYER::PLAYER_PED_ID(), &Local_484, 0, 1);
						}
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_488))
						{
							func_15(&uLocal_109, 4, iLocal_275[0], &Local_488, 0, 1);
						}
						if (func_3(&uLocal_109, "PRSAUD", &Local_492, 3, 0, 0, 0))
						{
							iLocal_497 = 1;
						}
					}
...
void func_17()//Position - 0x954
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_19(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_10(14) || Global_96306))
			{
...
int func_26(int iParam0)//Position - 0x1689
{
	...
	while (iVar1 < 1)
	{
		if (!func_28(Local_312[iVar1 /*3*/], 0f, 0f, 0f))
		{
...
bool func_28(struct<3> Param0, struct<3> Param3)//Position - 0x1832
{
...
int func_32(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x1AF7
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	{
		Var3 = { func_34(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_33(Var3, Var0);
...
float func_33(struct<3> Param0, struct<3> Param3)//Position - 0x1B85
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_42(int iParam0, int iParam1)//Position - 0x1DC6
{
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_43(Global_89748) && iParam1 != 0)
		{
			Global_89748 = 0;
		}
	}
...
void func_48()//Position - 0x21B2
{
	...
	func_52(iLocal_108, &Local_294, &fLocal_297, &cVar0);
	func_50(iLocal_108, &sLocal_318, &cLocal_334, &cLocal_350, &uVar8, &uVar9);
	...
	switch (iLocal_108)
	{
		...
		case 165:
			...
			Local_492 = { func_49("MICS3_IG_2", 3) };
			fLocal_496 = 0.2f;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_97353.f_1729.f_539.f_1538[0];
			StringCopy(sParam2, func_58(Global_97353.f_1729.f_539.f_1542[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_97353.f_1729.f_539.f_1538[1];
			StringCopy(sParam2, func_58(Global_97353.f_1729.f_539.f_1542[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_97353.f_1729.f_539.f_1538[2];
			StringCopy(sParam2, func_58(Global_97353.f_1729.f_539.f_1542[2]), 32);
			return 1;
			break;
