#region Local Var
	...
	var uLocal_269 = 0;
	int iLocal_270 = 0;
	int iLocal_271[2] = { 0, 0 };
	int iLocal_272[2] = { 0, 0 };
	...
	float fLocal_279 = 0f;
	struct<3> Local_280[2];
	float fLocal_281[2] = { 0f, 0f };
	struct<3> Local_282[1];
	struct<3> Local_283[1];
	float fLocal_284[1] = { 0f };
	...
	var uLocal_340 = 0;
	var uLocal_341 = 0;
	struct<16> Local_342[2];
	struct<16> Local_343[2];
	struct<16> Local_344[2];
	int iLocal_345[2] = { 0, 0 };
	struct<2> Local_346 = { 0, 0 } ;
	var uLocal_347 = 0;
	var uLocal_348 = 0;
	struct<2> Local_349 = { 0, 0 } ;
	var uLocal_350 = 0;
	var uLocal_351 = 0;
	struct<2> Local_352 = { 0, 0 } ;
	var uLocal_353 = 0;
	var uLocal_354 = 0;
	float fLocal_355 = 0f;
	int iLocal_356 = 0;
...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_104 = 318;
	iLocal_270 = 1;
	StringCopy(&Local_346, "", 16);
	StringCopy(&Local_349, "", 16);
	StringCopy(&Local_352, "", 16);
	fLocal_355 = 0f;
	...
	while (iLocal_270 && func_42(5, 0))
	{
		...
		{
			if (iLocal_104 == 258 && func_39(13) == 2)
			{
				func_59();
			}
		}
...
int func_2()//Position - 0x14E
{
	...
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15691))
	{
		...
		if (func_20(iVar1))
		{
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_352))
			{
				if (!iLocal_356)
				{
					if (fVar0 < fLocal_355)
					...
					{
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_346))
						{
							func_15(&uLocal_105, func_16(), PLAYER::PLAYER_PED_ID(), &Local_346, 0, 1);
						}
						if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_349))
						{
							func_15(&uLocal_105, 4, iLocal_271[0], &Local_349, 0, 1);
						}
						if (func_3(&uLocal_105, "PRSAUD", &Local_352, 3, 0, 0, 0))
						{
							iLocal_356 = 1;
						}
					}
	...
	if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_278) > 100f)
	{
		return 1;
	}
	return 0;
...
bool func_3(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x214
{
...
int func_4(char* sParam0, int iParam1, bool bParam2)//Position - 0x262
{
	Global_3D4D = 0;
...
bool func_10(int iParam0)//Position - 0x754
{
	return Global_8861 == iParam0;
}

void func_11()//Position - 0x762
{
	int iVar0;
...
bool func_12(int iParam0, int iParam1)//Position - 0x7B8
{
	switch (iParam0)
	{
		case 5:
...
void func_14(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x84A
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_15(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x8A0
{
...
int func_16()//Position - 0x93B
{
	func_17();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_17()//Position - 0x954
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_19(Global_17C49.f_6C1.f_21B.f_C8D) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_20(iVar0) && (!func_10(14) || Global_17832))
			{
...
int func_18(var uParam0)//Position - 0xA51
{
	int iVar0;
	int iVar1;
...
int func_19(int iParam0)//Position - 0xA8E
{
	if (func_20(iParam0))
	{
...
bool func_20(int iParam0)//Position - 0xAB8
{
	return iParam0 < 3;
}

var func_21()//Position - 0xAC4
{
	func_17();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}
		...
		if (!PED::IS_PED_INJURED((*iParam0)[iVar0]))
		{
			switch ((*iParam1)[iVar0])
			{
				case 100:
					...
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_15690, &cLocal_333, &(Local_342[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
						(*iParam1)[iVar0] = 101;
					}
				...
				case 101:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15691))
					{
						TASK::TASK_SYNCHRONIZED_SCENE((*iParam0)[iVar0], Global_15691, &cLocal_333, &(Local_343[iVar0 /*16*/]), 8f, -1000f, 0, 0, 1148846080, 0);
				...
				case 102:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_333) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_333, &(Local_343[iVar0 /*16*/]), 2))
					{
						sVar1 = "victim_fall";
						fVar2 = -1f;
						fVar3 = -1f;
						if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_333, &(Local_343[iVar0 /*16*/]), sVar1, &fVar2, &fVar3))
						{
							if (fVar2 < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_15691))
							{
						...
						if (iLocal_104 == 165)
						{
							if (!MISC::IS_STRING_NULL_OR_EMPTY(&(Local_344[iVar0 /*16*/])))
							{
								sVar4 = "AMB@WORLD_HUMAN_CLIPBOARD@MALE@BASE";
								STREAMING::REQUEST_ANIM_DICT(sVar4);
								if (0.95f < PED::GET_SYNCHRONIZED_SCENE_PHASE(Global_15691))
								{
									if (STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
									{
										TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_344[iVar0 /*16*/]), 0, 0);
				...
				case 200:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15690))
					{
						TASK::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_333, &(Local_342[iVar0 /*16*/]), 8f, -1000f, -1, 0, 0, 0, 0, 0);
						(*iParam1)[iVar0] = 201;
					}
					else if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15691))
					{
				...
				case 201:
					if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(Global_15691))
					{
						TASK::TASK_PLAY_ANIM((*iParam0)[iVar0], &cLocal_333, &(Local_343[iVar0 /*16*/]), 8f, -1.5f, -1, 32768, 0, 0, 0, 0);
				...
				case 202:
					if (STREAMING::HAS_ANIM_DICT_LOADED(&cLocal_333) && ENTITY::IS_ENTITY_PLAYING_ANIM((*iParam0)[iVar0], &cLocal_333, &(Local_343[iVar0 /*16*/]), 1))
					{
						sVar5 = "victim_fall";
						fVar6 = -1f;
						fVar7 = -1f;
						if (ENTITY::FIND_ANIM_EVENT_PHASE(&cLocal_333, &(Local_343[iVar0 /*16*/]), sVar5, &fVar6, &fVar7))
						{
							if (fVar6 < ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_333, &(Local_343[iVar0 /*16*/])))
							{
								if (!PED::IS_PED_RUNNING_RAGDOLL_TASK((*iParam0)[iVar0]))
								{
									TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
						...
						if (iLocal_104 == 108 || iLocal_104 == 109)
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME((*iParam0)[iVar0], &cLocal_333, &(Local_343[iVar0 /*16*/])) > 0.954f)
							{
								if (iLocal_104 == 108)
								{
									Local_280[iVar0 /*3*/] = { Vector(224.5948f, 1213.466f, 199.6328f) - Local_278 };
								}
								else if (iLocal_104 == 109)
								{
									Local_280[iVar0 /*3*/] = { Vector(5.9049f, -717.1404f, -1908.287f) - Local_278 };
								}
								TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_278 + Local_280[iVar0 /*3*/], 1f, -1, 1048576000, 0, 1193033728);
				...
				case 0:
					...
					Var9 = { Local_278 + Local_280[iVar0 /*3*/] + Vector(1f, 0f, 0f) };
					...
					fVar12 = (fLocal_279 + fLocal_281[iVar0]);
					if (fVar12 < 0f)
					{
						fVar12 = (fVar12 + 360f);
					}
				...
				case 1:
					Var14 = { ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1) };
					Var15 = { Local_278 + Local_280[iVar0 /*3*/] + Vector(1f, 0f, 0f) };
					...
					{
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Var15, 0.5f, -1, 1048576000, 0, 1193033728);
						break;
					}
					break;
				...
				case 10:
					if (TASK::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 7 || TASK::GET_SCRIPT_TASK_STATUS((*iParam0)[iVar0], -71340211) == 1)
					{
						...
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_274, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_274);
				...
				case 11:
					if (SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_278) > 50f && SYSTEM::VDIST(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS((*iParam0)[iVar0], 1)) > 50f)
					{
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_274, 1862763509);
						PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, 1862763509, iLocal_274);
						TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
						TASK::TASK_FOLLOW_NAV_MESH_TO_COORD((*iParam0)[iVar0], Local_278 + Local_280[iVar0 /*3*/], 0.5f, -1, 1048576000, 0, 1193033728);
						(*iParam1)[iVar0] = 1;
					}
				...
				case 5:
					if (func_26((*iParam0)[iVar0]))
					{
						if (ENTITY::DOES_ENTITY_EXIST(uLocal_275[iVar0]))
						{
							OBJECT::DELETE_OBJECT(&(uLocal_275[iVar0]));
							ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_275[iVar0]));
						}
						TASK::CLEAR_PED_TASKS((*iParam0)[iVar0]);
					...
					{
						if (MISC::ARE_STRINGS_EQUAL(&(Local_344[iVar0 /*16*/]), "any"))
						{
							if (TASK::DOES_SCENARIO_EXIST_IN_AREA(Local_278 + Local_280[iVar0 /*3*/], 20f, 1))
							{
								TASK::TASK_USE_NEAREST_SCENARIO_TO_COORD((*iParam0)[iVar0], Local_278 + Local_280[iVar0 /*3*/], 20f, 0);
								iLocal_345[iVar0] = MISC::GET_GAME_TIMER();
							}
						}
						else
						{
							...
							TASK::TASK_START_SCENARIO_IN_PLACE((*iParam0)[iVar0], &(Local_344[iVar0 /*16*/]), 0, iVar18);
							iLocal_345[iVar0] = MISC::GET_GAME_TIMER();
						}
					}
					else if (ENTITY::DOES_ENTITY_EXIST(uLocal_275[iVar0]))
					{
						if (iLocal_345[iVar0] > 0)
						{
							if (MISC::GET_GAME_TIMER() > iLocal_345[iVar0] + 1000)
							{
								OBJECT::DELETE_OBJECT(&(uLocal_275[iVar0]));
								ENTITY::SET_OBJECT_AS_NO_LONGER_NEEDED(&(uLocal_275[iVar0]));
							}
...
int func_23(var uParam0, float fParam1)//Position - 0x155F
{
	...
	while (iVar0 < 262)
	{
		...
		{
			if (Global_60AC[iVar0 /*23*/].f_10 == 9)
			{
			}
			else
			{
				Var1 = { func_25(iVar0, 0) };
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Var1) < (fParam1 * fParam1))
				{
					return 1;
				}
				if (MISC::IS_BIT_SET(Global_60AC[iVar0 /*23*/].f_B, 19))
				{
					iVar3 = 3;
					iVar2 = 0;
					while (iVar2 < iVar3)
					{
						Var4 = { func_25(iVar0, iVar2) };
						if (!func_24(Var4))
						{
							if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Var4) < (fParam1 * fParam1))
							{
								return 1;
							}
						}
...
int func_24(struct<3> Param0)//Position - 0x1621
{
...
Vector3 func_25(int iParam0, int iParam1)//Position - 0x164B
{
	int iVar0;
...
int func_26(int iParam0)//Position - 0x1689
{
	...
	iVar0 = 0;
	while (iVar0 < iLocal_271)
	{
		if (iParam0 != iLocal_271[iVar0])
		{
			if (iLocal_272[iVar0] < 0)
			{
				return 1;
			}
		}
	...
	while (iVar1 < 1)
	{
		if (!func_28(Local_283[iVar1 /*3*/], 0f, 0f, 0f))
		{
			if (func_27(PLAYER::PLAYER_PED_ID(), Local_278 + Local_282[iVar1 /*3*/], Local_283[iVar1 /*3*/], (fLocal_279 + fLocal_284[iVar1]), 0, 1, 0))
			{
				fVar2 = 50f;
...
int func_27(var uParam0, struct<3> Param1, struct<3> Param2, float fParam3, int iParam4, int iParam5, int iParam6)//Position - 0x17AE
{
	struct<3> Var0;
	struct<3> Var1;
	...
	if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(uParam0, Var0, Var1, (Param2.f_1 * 2f), iParam4, iParam5, iParam6))
	{
		return 1;
	}
	return 0;
...
bool func_28(struct<3> Param0, struct<3> Param1)//Position - 0x1832
{
...
int func_29(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x185B
{
	...
	if (func_36(PLAYER::PLAYER_PED_ID()) && func_36(uParam0))
	{
		...
		if (!bParam2)
		{
			...
			if (func_30(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_30(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x1956
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_31(var uParam0, float fParam1)//Position - 0x1A62
{
	var uVar0;
	struct<3> Var1;
...
int func_32(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x1AF7
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_34(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	...
	{
		Var1 = { func_34(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_33(Var1, Var0);
...
float func_33(struct<3> Param0, struct<3> Param1)//Position - 0x1B85
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_34(struct<3> Param0)//Position - 0x1BA6
{
	float fVar0;
	float fVar1;
...
int func_36(var uParam0)//Position - 0x1C2D
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
...
int func_39(int iParam0)//Position - 0x1CC2
{
...
int func_40()//Position - 0x1CD5
{
	...
	if (Global_24F57C.f_48)
	{
		return 1;
	}
	if (Global_15725.f_2C == 1)
	{
		if (Global_15725.f_2E == 0)
		{
			return 1;
		}
	}
...
int func_42(int iParam0, int iParam1)//Position - 0x1DC6
{
	struct<3> Var0;
	float fVar1;
	...
	if (!STREAMING::IS_PLAYER_SWITCH_IN_PROGRESS())
	{
		...
		else if (iParam1 == func_43(Global_15E94) && iParam1 != 0)
		{
			Global_15E94 = 0;
		}
	}
...
int func_43(var uParam0)//Position - 0x1EA9
{
	return uParam0;
}

bool func_44(var uParam0, var uParam1)//Position - 0x1EB3
{
	return (uParam0 && uParam1) != 0;
}

int func_45()//Position - 0x1EC2
{
	func_17();
...
void func_47()//Position - 0x1F50
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_271)
		{
			if (iLocal_273[iVar0] != 0)
			{
				STREAMING::REQUEST_MODEL(iLocal_273[iVar0]);
				if (!STREAMING::HAS_MODEL_LOADED(iLocal_273[iVar0]))
				{
					bVar2 = false;
					STREAMING::REQUEST_MODEL(iLocal_273[iVar0]);
				}
			...
			{
				STREAMING::REQUEST_MODEL(iLocal_276[iVar0]);
				if (!STREAMING::HAS_MODEL_LOADED(iLocal_276[iVar0]))
				{
					bVar2 = false;
					STREAMING::REQUEST_MODEL(iLocal_276[iVar0]);
				}
	...
	PED::ADD_RELATIONSHIP_GROUP("FIGHTERS", &iLocal_274);
	iVar0 = 0;
	while (iVar0 < iLocal_271)
	{
		if (iLocal_273[iVar0] != 0)
		{
			iLocal_271[iVar0] = PED::CREATE_PED(26, iLocal_273[iVar0], Local_278 + Local_280[iVar0 /*3*/], 0, 1, 1);
			ENTITY::SET_ENTITY_HEADING(iLocal_271[iVar0], (fLocal_279 + fLocal_281[iVar0]));
			PED::SET_PED_RANDOM_COMPONENT_VARIATION(iLocal_271[iVar0], 0);
			if (iLocal_273[iVar0] == joaat("s_m_y_baywatch_01"))
			{
				if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_271[iVar0], 3) == 0)
				{
					if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_271[iVar0], 10) != 1)
					{
						PED::SET_PED_COMPONENT_VARIATION(iLocal_271[iVar0], 10, 1, 0, 0);
					}
				}
				else if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_271[iVar0], 10) == 1)
				{
					if (PED::GET_PED_DRAWABLE_VARIATION(iLocal_271[iVar0], 10) != 0)
					{
						PED::SET_PED_COMPONENT_VARIATION(iLocal_271[iVar0], 10, 0, 0, 0);
					}
				}
			}
			PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_271[iVar0], iLocal_274);
			TASK::TASK_STAND_STILL(iLocal_271[iVar0], -1);
			if (iLocal_104 == 285)
			{
				ENTITY::SET_ENTITY_MAX_HEALTH(iLocal_271[iVar0], 105);
				ENTITY::SET_ENTITY_HEALTH(iLocal_271[iVar0], 105);
			}
		}
		if (iLocal_276[iVar0] != 0)
		{
			uLocal_275[iVar0] = OBJECT::CREATE_OBJECT(iLocal_276[iVar0], Local_278 + Local_280[iVar0 /*3*/], 1, 1, 0);
			ENTITY::SET_ENTITY_HEADING(uLocal_275[iVar0], (fLocal_279 + fLocal_281[iVar0]));
			ENTITY::ATTACH_ENTITY_TO_ENTITY(uLocal_275[iVar0], iLocal_271[iVar0], PED::GET_PED_BONE_INDEX(iLocal_271[iVar0], iLocal_277[iVar0]), 0f, 0f, 0f, 0f, 0f, 0f, 0, 0, 0, 0, 2, 1);
		}
		iVar0++;
	}
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(2, iLocal_274, 1862763509);
...
void func_48()//Position - 0x21B2
{
	...
	iLocal_104 = Global_15D9E;
	func_52(iLocal_104, &Local_278, &fLocal_279, &cVar0);
	func_50(iLocal_104, &sLocal_285, &cLocal_301, &cLocal_317, &uVar1, &uVar2);
	Local_282[0 /*3*/] = { 0f, 0f, 0f };
	Local_283[0 /*3*/] = { 0f, 0f, 0f };
	fLocal_284[0] = 0f;
	switch (iLocal_104)
	{
		case 108:
			Local_280[0 /*3*/] = { -0.88f, 0.8016f, -1f };
			fLocal_281[0] = -150f;
			iLocal_273[0] = joaat("s_m_y_ranger_01");
			iLocal_272[0] = 200;
			StringCopy(&cLocal_333, "SWITCH@MICHAEL@PARKBENCH_SMOKE_RANGER", 64);
			StringCopy(&(Local_342[0 /*16*/]), "Ranger_Nervous_Loop", 64);
			StringCopy(&(Local_343[0 /*16*/]), "PARKBENCH_SMOKE_RANGER_EXIT_RANGER", 64);
			StringCopy(&(Local_344[0 /*16*/]), "any", 64);
			break;
		
		case 109:
			Local_280[0 /*3*/] = { -1.1832f, -0.3745f, -1f };
			fLocal_281[0] = -147f;
			iLocal_273[0] = joaat("s_m_y_baywatch_01");
			iLocal_272[0] = 200;
			StringCopy(&cLocal_333, "SWITCH@MICHAEL@PARKBENCH_SMOKE_RANGER", 64);
			StringCopy(&(Local_342[0 /*16*/]), "Ranger_Nervous_Loop", 64);
			StringCopy(&(Local_343[0 /*16*/]), "PARKBENCH_SMOKE_RANGER_EXIT_RANGER", 64);
		...
		case 157:
			Local_280[0 /*3*/] = { -0.8296f, 1.1365f, -0.9999f };
			fLocal_281[0] = -176.3014f;
			iLocal_273[0] = joaat("s_m_m_bouncer_01");
			iLocal_272[0] = 100;
			StringCopy(&cLocal_333, "SWITCH@MICHAEL@REJECTED_ENTRY", 64);
			StringCopy(&(Local_342[0 /*16*/]), "001396_01_MICS3_6_REJECTED_ENTRY_IDLE_BOUNCER", 64);
			StringCopy(&(Local_343[0 /*16*/]), "001396_01_MICS3_6_REJECTED_ENTRY_EXIT_BOUNCER", 64);
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		
		case 166:
			Local_280[0 /*3*/] = { Vector(36.037f, -476.663f, -1050.724f) - Local_278 };
			fLocal_281[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_273[0] = joaat("s_m_m_security_01");
			iLocal_272[0] = 100;
			StringCopy(&cLocal_333, "SWITCH@MICHAEL@TALKS_TO_GUARD", 64);
			StringCopy(&(Local_342[0 /*16*/]), "001393_02_MICS3_3_TALKS_TO_GUARD_IDLE_GUARD", 64);
			StringCopy(&(Local_343[0 /*16*/]), "001393_02_MICS3_3_TALKS_TO_GUARD_EXIT_GUARD", 64);
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_CLIPBOARD", 64);
			break;
		
		case 165:
			Local_280[0 /*3*/] = { 0.1366f, -1.2192f, -1f };
			fLocal_281[0] = 85.6329f;
			iLocal_273[0] = joaat("s_m_y_grip_01");
			iLocal_272[0] = 100;
			StringCopy(&cLocal_333, "SWITCH@MICHAEL@BAR_EMPLOYEE_CONVO", 64);
			StringCopy(&(Local_342[0 /*16*/]), "001387_03_MICS3_2_BAR_EMPLOYEE_CONVO_IDLE_STAFF", 64);
			StringCopy(&(Local_343[0 /*16*/]), "001387_03_MICS3_2_BAR_EMPLOYEE_CONVO_EXIT_STAFF", 64);
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_CLIPBOARD", 64);
			iLocal_276[0] = joaat("p_cs_clipboard");
			iLocal_277[0] = 60309;
			StringCopy(&Local_346, "MICHAEL", 16);
			StringCopy(&Local_349, "PREMPLOYEE", 16);
			Local_352 = { func_49("MICS3_IG_2", 3) };
			fLocal_355 = 0.2f;
			break;
		
		case 246:
			Local_280[0 /*3*/] = { Vector(4.6f, -1570.924f, -1194.77f) - Local_278 + Vector(-1f, 0f, 0f) };
			fLocal_281[0] = (0.61f - fLocal_279);
			Local_280[1 /*3*/] = { -1.3617f, 6.7273f, -1f };
			fLocal_281[1] = -3.6142f;
			iLocal_273[0] = joaat("a_m_y_musclbeac_01");
			iLocal_273[1] = joaat("a_m_y_musclbeac_01");
			iLocal_272[0] = 100;
			iLocal_272[1] = 100;
			StringCopy(&cLocal_333, "SWITCH@TREVOR@PUSHES_BODYBUILDER", 64);
			StringCopy(&(Local_342[0 /*16*/]), "001426_03_TRVS_5_PUSHES_BODYBUILDER_IDLE_BB1", 64);
			StringCopy(&(Local_342[1 /*16*/]), "001426_03_TRVS_5_PUSHES_BODYBUILDER_IDLE_BB2", 64);
			StringCopy(&(Local_343[0 /*16*/]), "001426_03_TRVS_5_PUSHES_BODYBUILDER_EXIT_BB1", 64);
			StringCopy(&(Local_343[1 /*16*/]), "001426_03_TRVS_5_PUSHES_BODYBUILDER_EXIT_BB2", 64);
			StringCopy(&(Local_344[0 /*16*/]), "any", 64);
			StringCopy(&(Local_344[1 /*16*/]), "WORLD_HUMAN_MUSCLE_FREE_WEIGHTS", 64);
			break;
		
		case 256:
			Local_280[0 /*3*/] = { -4.7f, -0.2f, 0f };
			fLocal_281[0] = 143f;
			iLocal_273[0] = joaat("a_m_m_business_01");
			iLocal_272[0] = 0;
			iLocal_272[1] = 0;
			Local_282[0 /*3*/] = { -3.65f, -1.2f, 1.5f };
			Local_283[0 /*3*/] = { 2.5f, 1.25f, 2f };
			fLocal_284[0] = -12f;
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		
		case 257:
			Local_280[0 /*3*/] = { Vector(7.1578f, -978.6192f, -1666.374f) - Local_278 };
			fLocal_281[0] = -149.0587f;
			iLocal_273[0] = joaat("a_m_m_business_01");
			iLocal_272[0] = 0;
			iLocal_272[1] = 0;
			Local_282[0 /*3*/] = { 0.4f, -4.1f, 1.8f };
			Local_283[0 /*3*/] = { 2.5f, 1.5f, 2f };
			fLocal_284[0] = 57f;
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		
		case 258:
			Local_280[0 /*3*/] = { 1.5f, 5.7035f, 0f };
			Local_280[1 /*3*/] = { 4.2393f, 4.1781f, 0f };
			fLocal_281[0] = 145.8f;
			fLocal_281[1] = 130.32f;
			iLocal_273[0] = joaat("a_m_m_salton_01");
			iLocal_273[1] = joaat("a_m_m_salton_01");
			iLocal_272[0] = 0;
			iLocal_272[1] = 0;
			Local_282[0 /*3*/] = { 2.1f, 4.3f, 2f };
			Local_283[0 /*3*/] = { 2.5f, 1.75f, 2f };
			fLocal_284[0] = 33f;
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			StringCopy(&(Local_344[1 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		...
		case 259:
			...
			fLocal_281[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			fLocal_281[1] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			iLocal_273[0] = joaat("a_m_m_malibu_01");
			iLocal_272[0] = 100;
			iLocal_272[1] = 100;
			StringCopy(&cLocal_333, "SWITCH@TREVOR@YELLS_AT_DOORMAN", 64);
			StringCopy(&(Local_342[0 /*16*/]), "001430_01_TRVS_21_YELLS_AT_DOORMAN_IDLE_DMAN1", 64);
			StringCopy(&(Local_342[1 /*16*/]), "001430_01_TRVS_21_YELLS_AT_DOORMAN_IDLE_DMAN2", 64);
			StringCopy(&(Local_343[0 /*16*/]), "001430_01_TRVS_21_YELLS_AT_DOORMAN_EXIT_DMAN1", 64);
			StringCopy(&(Local_343[1 /*16*/]), "001430_01_TRVS_21_YELLS_AT_DOORMAN_EXIT_DMAN2", 64);
			StringCopy(&(Local_344[0 /*16*/]), "", 64);
			StringCopy(&(Local_344[1 /*16*/]), "", 64);
			break;
		
		case 285:
			Local_280[0 /*3*/] = { -3.264f, -3.7895f, 14.1815f };
			fLocal_281[0] = 0f;
			iLocal_273[0] = joaat("g_m_y_lost_01");
			iLocal_272[0] = 100;
			StringCopy(&cLocal_333, "SWITCH@TREVOR@BRIDGE", 64);
			StringCopy(&(Local_342[0 /*16*/]), "HOLD_LOOP_victim", 64);
			StringCopy(&(Local_343[0 /*16*/]), "THROW_EXIT_victim", 64);
			StringCopy(&(Local_344[0 /*16*/]), "", 64);
			StringCopy(&Local_346, "TREVOR", 16);
			StringCopy(&Local_349, "DropGuy", 16);
			StringCopy(&Local_352, "TRVS_IG_29G", 16);
			fLocal_355 = 0.75f;
			break;
		
		case 260:
			Local_280[0 /*3*/] = { 0.219f, 5.8091f, 0.6f };
			Local_280[1 /*3*/] = { 2.4f, 4.6336f, 0.6f };
			fLocal_281[0] = -164.16f;
			fLocal_281[1] = 166.32f;
			iLocal_273[0] = joaat("a_m_m_business_01");
			iLocal_273[1] = joaat("a_m_m_business_01");
			iLocal_272[0] = 0;
			iLocal_272[1] = 0;
			Local_282[0 /*3*/] = { 4f, 8f, 2f };
			Local_283[0 /*3*/] = { 10.5f, 5.5f, 2f };
			fLocal_284[0] = 0f;
			break;
		
		case 261:
			Local_280[0 /*3*/] = { 3.2998f, -1.8338f, 0.1366f };
			Local_280[1 /*3*/] = { 2.0737f, -3.6041f, 0.1348f };
			fLocal_281[0] = -169.9514f;
			fLocal_281[1] = 156.719f;
			iLocal_272[0] = 0;
			iLocal_272[1] = 0;
			iLocal_273[0] = joaat("s_m_m_bouncer_01");
			iLocal_273[1] = joaat("s_m_m_bouncer_01");
			Local_282[0 /*3*/] = { 3f, -3f, 2f };
			Local_283[0 /*3*/] = { 4.5f, 2.5f, 2f };
			fLocal_284[0] = 9f;
			break;
		
		case 239:
			Local_280[0 /*3*/] = { Vector(113.05f, 354.39f, -52.2f) - Local_278 + Vector(-1f, 0f, 0f) };
			Local_280[1 /*3*/] = { Vector(113.05f, 354.08f, -53.18f) - Local_278 + Vector(-1f, 0f, 0f) };
			fLocal_281[0] = -100f;
			fLocal_281[1] = -100f;
			iLocal_273[0] = joaat("a_m_m_business_01");
			iLocal_273[1] = joaat("a_m_m_business_01");
			Local_282[0 /*3*/] = { 1.6187f, -0.82f, 1f };
			Local_283[0 /*3*/] = { (2.5f + 0.5f), 8f, 2f };
			fLocal_284[0] = 6f;
			iLocal_272[0] = 100;
			iLocal_272[1] = 100;
			StringCopy(&cLocal_333, "SWITCH@TREVOR@ESCORTED_OUT", 64);
			StringCopy(&(Local_342[0 /*16*/]), "001215_02_TRVS_12_ESCORTED_OUT_IDLE_GUARD1", 64);
			StringCopy(&(Local_342[1 /*16*/]), "001215_02_TRVS_12_ESCORTED_OUT_IDLE_GUARD2", 64);
			StringCopy(&(Local_343[0 /*16*/]), "001215_02_TRVS_12_ESCORTED_OUT_EXIT_GUARD1", 64);
			StringCopy(&(Local_343[1 /*16*/]), "001215_02_TRVS_12_ESCORTED_OUT_EXIT_GUARD2", 64);
			StringCopy(&(Local_344[0 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			StringCopy(&(Local_344[1 /*16*/]), "WORLD_HUMAN_GUARD_STAND", 64);
			break;
		...
		default:
			...
			Local_283[0 /*3*/] = { 1f, 1f, 1f };
			fLocal_284[0] = MISC::GET_RANDOM_FLOAT_IN_RANGE(-180f, 180f);
			break;
	}
}

struct<4> func_49(char* sParam0, int iParam1)//Position - 0x2B5B
{
	struct<4> Var0;
...
int func_50(int iParam0, char* sParam1, char* sParam2, char* sParam3, var uParam4, var uParam5)//Position - 0x2BB7
{
	*uParam4 = 9;
	*uParam5 = 0;
	switch (iParam0)
...
void func_51(int iParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0x42F3
{
...
int func_52(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x4313
{
	int iVar0;
...
bool func_53(var uParam0)//Position - 0x44FE
{
	int iVar0;
	struct<3> Var1;
	float fVar2;
...
int func_54(int iParam0, var uParam1, char* sParam2)//Position - 0x45B8
{
	struct<3> Var0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[0];
			StringCopy(sParam2, func_58(Global_17C49.f_6C1.f_21B.f_606[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[1];
			StringCopy(sParam2, func_58(Global_17C49.f_6C1.f_21B.f_606[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_17C49.f_6C1.f_21B.f_602[2];
			StringCopy(sParam2, func_58(Global_17C49.f_6C1.f_21B.f_606[2]), 32);
			return 1;
			break;
		
		case 11:
			if (func_57(iParam0, &Var0, uParam1))
			{
...
int func_55(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0x69C4
{
	switch (iParam1)
	{
		case 0:
...
int func_57(int iParam0, var uParam1, var uParam2)//Position - 0x8934
{
	switch (iParam0)
	{
		case 11:
...
char* func_58(int iParam0)//Position - 0x92A3
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_59()//Position - 0x9334
{
	...
	iVar0 = 0;
	while (iVar0 < iLocal_273)
	{
		if (iLocal_273[iVar0] != 0)
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_273[iVar0]);
		}
		iVar0++;
	}
