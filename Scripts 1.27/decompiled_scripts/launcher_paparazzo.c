...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_263("Force cleanup [TERMINATING]");
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				func_263("Relinquishing candidate id...");
				func_262(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_250(&Var0, 1);
	}
	if (!func_247(&iVar2, &Var0, Var1, 5f))
	{
		func_246();
		func_263("SCRIPT TERMINATED");
	...
	while (!func_220(&Var0))
	{
		...
		{
			func_263("Player out of range [TERMINATING]");
			func_250(&Var0, 1);
		}
	}
	if (Var0 == 47)
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_177(&Var0, Var1, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_177(&Var0, Var1, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_176(Var0);
		func_168(&iLocal_54, &(Var0.f_9), Var1);
		if (func_153(&Var0, 0))
		{
			if (func_152(Var0))
			{
				func_149(Var0, &uLocal_56);
			}
			if (!func_2(&Var0))
			{
				func_250(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x299
{
...
int func_2(int iParam0)//Position - 0x2B7
{
	...
	if (!func_148())
	{
		while (!func_139(*iParam0))
		{
			...
			{
				func_263("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_97(iParam0))
	{
		func_263("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
void func_3(int iParam0, char* sParam1)//Position - 0x378
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19F9
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x287D
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x289F
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2926
{
...
int func_29(int iParam0)//Position - 0x2966
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2994
{
...
int func_31(int iParam0)//Position - 0x2A70
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AB2
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B15
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BA3
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2BE5
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E5D
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E69
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3115
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31C5
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x329F
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3350
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x347D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34EE
{
...
int func_44(int iParam0)//Position - 0x35C7
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x3604
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x362E
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x37D8
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x380A
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x383E
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x384A
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3876
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3DBE
{
	int iVar0;
...
int func_53()//Position - 0x3FFF
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x4019
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x4116
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x4124
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x4217
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x447B
{
...
int func_59(int iParam0, int iParam1)//Position - 0x45A1
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4DBD
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4DF8
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x506C
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x50A8
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5603
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x5647
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5C9D
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5CC6
{
...
bool func_68(int iParam0)//Position - 0x5D1F
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5D2F
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5D8F
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x6038
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x6043
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6053
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x60EA
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x65BB
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x65CB
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x6824
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x6835
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x687B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x6901
{
...
void func_81(var uParam0, int iParam1)//Position - 0x6934
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x6985
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x6A27
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6A4C
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6A63
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6A70
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6AAA
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6AE5
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6B21
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6B3A
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6B93
{
...
bool func_92(bool bParam0)//Position - 0x6BD5
{
...
struct<2> func_93(int iParam0)//Position - 0x6C00
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x704D
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x8328
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x866E
{
	var uVar0;
	...
	if (func_126(&(uParam0->f_1)))
	{
		...
		{
			func_263("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::_0x8D9DF6ECA8768583(uVar0);
		}
		else
		{
			func_263("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_98(int iParam0)//Position - 0x8712
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x87AD
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x880B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x8864
{
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x8918
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x892C
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x89D4
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x89EF
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8A3B
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8A84
{
	if (func_111(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8AA4
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_112(int iParam0)//Position - 0x8AC4
{
	switch (iParam0)
	{
		case 5:
...
int func_114(int iParam0)//Position - 0x8B94
{
	switch (iParam0)
	{
		case 5:
...
void func_115(var uParam0, int iParam1, bool bParam2)//Position - 0x8BE7
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x8CDB
{
	switch (iParam0)
	{
		case 5:
...
void func_117(bool bParam0)//Position - 0x8D46
{
	var uVar0;
...
void func_118(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8D82
{
	if (bParam0)
	{
...
int func_119(int iParam0)//Position - 0x8E53
{
...
bool func_120()//Position - 0x8E94
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_121(int iParam0, int iParam1)//Position - 0x8EA5
{
	bool bVar0;
...
int func_122(int iParam0, bool bParam1)//Position - 0x8EF0
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, var uParam1, var uParam2)//Position - 0x8F31
{
	int iVar0;
...
void func_125(int iParam0)//Position - 0x8F89
{
	if (iParam0 == 1)
	{
...
int func_126(char* sParam0)//Position - 0x8FAC
{
	...
	func_263("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_127()//Position - 0x8FE9
{
	Global_38DE = 0;
	func_128();
}

void func_128()//Position - 0x8FF9
{
...
int func_132(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x90DD
{
...
void func_135(int iParam0)//Position - 0x92D8
{
	if (Global_38D7)
	{
		func_136(0, 0);
...
void func_136(bool bParam0, bool bParam1)//Position - 0x9348
{
	if (bParam0)
	{
		if (func_137(0))
...
int func_137(int iParam0)//Position - 0x93BC
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_138(int iParam0)//Position - 0x9416
{
...
int func_139(int iParam0)//Position - 0x9457
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0x949C
{
...
int func_141(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x94CE
{
	int iVar0;
...
void func_142(var uParam0, int iParam1)//Position - 0x9605
{
	int iVar0;
...
bool func_143(int iParam0)//Position - 0x9654
{
	return func_144(iParam0, Global_8861);
}

int func_144(int iParam0, int iParam1)//Position - 0x9665
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_145(int iParam0)//Position - 0x9846
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_146()//Position - 0x9868
{
	return func_147(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_147(var uParam0, int iParam1)//Position - 0x9879
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_149(int iParam0, var uParam1)//Position - 0x98E6
{
	switch (iParam0)
	{
		case 0:
...
var func_150(struct<3> Param0, int iParam1)//Position - 0x9D6D
{
	var uVar0;
...
float func_151(bool bParam0, float fParam1, float fParam2)//Position - 0x9D99
{
	if (bParam0)
	{
		return fParam1;
...
int func_152(int iParam0)//Position - 0x9DB0
{
	switch (iParam0)
	{
		case 0:
...
int func_153(var uParam0, int iParam1)//Position - 0x9E3F
{
	switch (uParam0->f_10)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_111(uParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_1C[0], 1), 1) < 3f)
						{
							if (func_159(2))
							{
								if (func_157(uParam0->f_1B))
								{
									func_156(uParam0->f_1B, *uParam0);
									func_263("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_159(2))
						{
							...
							{
								func_156(uParam0->f_1B, *uParam0);
								func_263("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_159(2))
					{
						...
						{
							func_156(1, *uParam0);
							func_263("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_159(2))
							{
								...
								{
									func_156(uParam0->f_1B, *uParam0);
									func_263("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_154()//Position - 0xA621
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_155(var uParam0)//Position - 0xA63C
{
	float fVar0;
...
void func_156(int iParam0, int iParam1)//Position - 0xA6CA
{
	if (iParam0 == 1)
	{
		if (!func_114(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			func_263("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_263("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_157(bool bParam0)//Position - 0xA72D
{
	int iVar0;
...
int func_158(int iParam0)//Position - 0xA7C4
{
	if (func_111(uParam0))
	{
...
int func_159(int iParam0)//Position - 0xA7EE
{
	int iVar0;
...
var func_160()//Position - 0xAF0B
{
	return Global_15F91.f_1;
}

int func_161()//Position - 0xAF19
{
	if (Global_154F9 != -1)
	{
...
bool func_164()//Position - 0xAF83
{
	return Global_15F9E.f_123 > 0;
}

bool func_165(int iParam0, int iParam1)//Position - 0xAF94
{
	switch (iParam0)
	{
		case 5:
...
var func_166()//Position - 0xAFCF
{
	return Global_14143C;
}

int func_167()//Position - 0xAFDB
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
void func_168(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xAFF7
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_172(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_171(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_172(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_174(iParam0);
				}
			}
...
void func_169(int iParam0, bool bParam1)//Position - 0xB0E8
{
	if (iParam0 == -1)
	{
		return;
...
int func_170(int iParam0)//Position - 0xB124
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_171(int iParam0, int iParam1)//Position - 0xB15D
{
	bool bVar0;
	int iVar1;
...
float func_172(int iParam0, struct<3> Param1, int iParam2)//Position - 0xB1FB
{
	struct<3> Var0;
...
bool func_173()//Position - 0xB234
{
	return Global_1567C;
}

void func_174(int iParam0)//Position - 0xB240
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_175(iParam0);
...
void func_175(int iParam0)//Position - 0xB257
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_176(int iParam0)//Position - 0xB33F
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_177(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xB367
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_1C[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_172(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_180(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
		func_178(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_178(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB3EF
{
...
void func_179(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB42A
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_180(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xB480
{
...
int func_181(var uParam0, bool bParam1)//Position - 0xB51B
{
	...
	if (Global_10A95)
	{
		func_263("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_94(*uParam0, &Var0);
	if ((func_218(*uParam0) || func_216(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_263("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_212(*uParam0))
	{
		if (*uParam0 == 19)
		{
			func_211(uParam0->f_1C[0]);
		}
		func_263("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_19 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_263("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_263("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
...
void func_182(int iParam0, var uParam1, int iParam2)//Position - 0xB78E
{
	var uVar0;
	var uVar1;
...
int func_183(int iParam0)//Position - 0xBAE3
{
...
int func_184(var uParam0)//Position - 0xBB03
{
...
int func_185(var uParam0)//Position - 0xBB1B
{
...
void func_186(var uParam0)//Position - 0xBB40
{
	int iVar0;
	var uVar1;
	...
	if (*uParam0 == 52)
	{
		func_187(&(uParam0->f_29[1]));
		func_187(&(uParam0->f_29[2]));
	}
...
void func_187(var uParam0)//Position - 0xBE44
{
...
void func_188(var uParam0)//Position - 0xBE6F
{
	int iVar0;
...
int func_189(var uParam0, bool bParam1, bool bParam2)//Position - 0xBEEF
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (func_110(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				{
					func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_23[iVar0], 0))
				{
					func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_23[iVar0], PLAYER::PLAYER_PED_ID(), 0))
				{
					func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_23[iVar0]) < 850)
				{
					func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_158(uVar2))
						{
							if (ENTITY::GET_ENTITY_MODEL(uVar2) == joaat("towtruck") || ENTITY::GET_ENTITY_MODEL(iVar2) == joaat("towtruck2"))
							{
								if (func_158(uParam0->f_23[iVar0]))
								{
									...
									{
										func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_158(iVar3))
						{
							...
							{
								func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							if (func_190(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
								func_263("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_190(int iParam0, int iParam1)//Position - 0xC0AC
{
	int iVar0;
	...
	if (func_110(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_1C[iVar0]))
						{
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_1C[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_1C[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_1C[iVar0]))
					{
						...
						func_263("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_1C[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_1C[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
						{
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_210(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_205(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_186(uParam0);
								...
								func_263("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_1C[iVar0], 1), 15f))
						{
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_193(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_186(uParam0);
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_192(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_263("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_263("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_111(uParam0->f_29[0]))
						{
...
int func_192(int iParam0)//Position - 0xC398
{
...
int func_193(int iParam0, float fParam1)//Position - 0xC3CC
{
	...
	{
		if (func_204(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_195(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC45A
{
	...
	iVar2 = func_203(iParam0, iParam1);
	if (!func_111(iParam0) || !func_111(iParam1))
	{
		if (iVar2 != -1)
		{
			func_202(&(Local_36[iVar2 /*4*/]));
		}
		return 0;
	}
	...
	uVar0 = func_196(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_196(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xC51B
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_197(int iParam0, int iParam1)//Position - 0xC647
{
	int iVar0;
...
int func_199(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC756
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_201(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_201(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_200(Var1, Var0);
...
float func_200(struct<3> Param0, struct<3> Param1)//Position - 0xC7E7
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_201(struct<3> Param0)//Position - 0xC808
{
	float fVar0;
	float fVar1;
...
void func_202(var uParam0)//Position - 0xC847
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_204(var uParam0)//Position - 0xC8A1
{
...
int func_205(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC8C9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_206(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC9C4
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_207(var uParam0, float fParam1)//Position - 0xCAD0
{
	var uVar0;
	struct<3> Var1;
...
int func_208(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xCB65
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_201(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_209(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xCBF3
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_210(int iParam0)//Position - 0xCC3B
{
...
void func_211(int iParam0)//Position - 0xCC85
{
	var uVar0;
...
int func_212(int iParam0)//Position - 0xCD22
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_213(int iParam0)//Position - 0xCDBA
{
...
int func_216(int iParam0)//Position - 0xCE3C
{
	if ((func_217() && Global_15F6A.f_B == 6) && iParam0 == func_147(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_218(int iParam0)//Position - 0xCEAE
{
	if (func_92(0))
	{
...
int func_220(int iParam0)//Position - 0xCF04
{
	...
	func_263("Created initial scene");
	return 1;
}
...
int func_221(var uParam0)//Position - 0xCFA7
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_230(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			{
				if (func_227(&(uParam0->f_1C[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
					...
					uVar3 = PED::CREATE_SYNCHRONIZED_SCENE(-490.809f, 232.39f, 82.018f, 0f, 0f, 33.84f, 2);
					PED::SET_SYNCHRONIZED_SCENE_LOOPED(uVar3, 1);
					PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uVar3, 0);
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uVar3, "rcmpaparazzo_4", "pap_4_rcm_leadin", 8f, -8f, 1, 16, 1148846080, 0);
				}
				else
				{
					bVar4 = false;
			...
			{
				func_225(&(uParam0->f_1C[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
				if (func_110(uParam0->f_1C[1]))
				{
					PED::SET_PED_NAME_DEBUG(uParam0->f_1C[1], "Camera Man");
					TASK::TASK_PLAY_ANIM(uParam0->f_1C[1], "rcmpaparazzo_4", "Idle_Camman", 8f, -8f, -1, 57, 0, 0, 0, 0);
					...
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 3, 0, 0, 1);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[2]))
			{
				func_225(&(uParam0->f_1C[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
				if (func_110(uParam0->f_1C[2]))
				{
					PED::SET_PED_NAME_DEBUG(uParam0->f_1C[2], "Makeup Woman");
					TASK::TASK_PLAY_ANIM(uParam0->f_1C[2], "rcmpaparazzo_4", "Idle_Prod", 8f, -8f, -1, 57, 0, 0, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_1C[2], 1);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 0, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 2, 3, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 4, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 8, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 9, 0, 0, 0);
				}
				else
				{
					bVar4 = false;
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_223(&(uParam0->f_23[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_158(uParam0->f_23[0]))
				{
					VEHICLE::LOWER_CONVERTIBLE_ROOF(uParam0->f_23[0], 1);
			...
			{
				func_223(&(uParam0->f_23[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_158(uParam0->f_23[1]))
				{
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[1], 1);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[1], 2);
					VEHICLE::SET_VEHICLE_LIVERY(uParam0->f_23[1], 0);
				}
				else
				{
					bVar4 = false;
			...
			{
				func_222(&(uParam0->f_29[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_111(uParam0->f_1C[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_29[0], uParam0->f_1C[0], PED::GET_PED_BONE_INDEX(uParam0->f_1C[0], 57005), 0.1561f, -0.003f, -0.0344f, 202.8703f, -124.43f, -121.5398f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar4 = false;
			...
			{
				func_222(&(uParam0->f_29[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_111(uParam0->f_1C[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
				{
					ENTITY::ATTACH_ENTITY_TO_ENTITY(uParam0->f_29[1], uParam0->f_1C[1], PED::GET_PED_BONE_INDEX(uParam0->f_1C[1], 57005), 0.1181f, 0.2229f, -0.1535f, 259.2501f, 24.08f, -51.2899f, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar4 = false;
...
void func_222(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xD56A
{
	func_187(uParam0);
...
void func_223(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xD591
{
	func_224(uParam0);
...
void func_224(var uParam0)//Position - 0xD5CC
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_225(var uParam0, var uParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xD668
{
	func_226(uParam0);
	*uParam0 = PED::CREATE_PED(iParam4, uParam1, Param2, fParam3, 0, 0);
}

void func_226(var uParam0)//Position - 0xD689
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_227(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xD6C8
{
	if (func_228(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
int func_228(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xD723
{
	int iVar0;
...
int func_229(var uParam0, int iParam1)//Position - 0xD7B1
{
	int iVar0;
...
int func_230(int iParam0)//Position - 0xD7F7
{
	int iVar0;
...
int func_232(var uParam0)//Position - 0xD85C
{
	...
	switch (iLocal_50)
	{
		...
		case 2:
			func_223(&(uParam0->f_23[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
			VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[0], 2);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_233(var uParam0)//Position - 0xD947
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_230(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_227(&(uParam0->f_1C[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_1C[0], 1);
			...
			if (func_110(uParam0->f_1C[0]))
			{
				...
				{
					func_222(&(uParam0->f_29[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_111(uParam0->f_29[3]))
					{
		...
		case 3:
			if (func_111(uParam0->f_29[0]))
			{
				uLocal_53 = PED::CREATE_SYNCHRONIZED_SCENE(ENTITY::GET_ENTITY_COORDS(uParam0->f_29[0], 1), ENTITY::GET_ENTITY_ROTATION(uParam0->f_29[0], 2), 2);
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[0], uLocal_53, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_53, 1);
				if (func_111(uParam0->f_1C[0]))
				{
					TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uLocal_53, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_111(uParam0->f_29[1]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[1], uLocal_53, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_111(uParam0->f_29[2]))
				{
					ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[2], uLocal_53, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_234(var uParam0)//Position - 0xDE86
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_230(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmpaparazzo_2"))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_227(&(uParam0->f_1C[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 9, 1, 0, 0);
				}
			...
			if (func_110(uParam0->f_1C[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[0]))
				{
					func_222(&(uParam0->f_29[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_111(uParam0->f_29[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_223(&(uParam0->f_23[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[0], 7);
				...
				VEHICLE::SET_VEHICLE_NUMBER_PLATE_TEXT(uParam0->f_23[0], "P4P4R4Z0");
		...
		case 3:
			if (func_111(uParam0->f_1C[0]) && func_111(PLAYER::PLAYER_PED_ID()))
			{
				TASK::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				uLocal_53 = PED::CREATE_SYNCHRONIZED_SCENE(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uLocal_53, 1);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uLocal_53, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
int func_235(var uParam0)//Position - 0xE1C7
{
	...
	switch (iLocal_50)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_227(&(uParam0->f_1C[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_223(&(uParam0->f_23[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_158(uParam0->f_23[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_23[0], 62, 62);
				}
				else
				{
					bVar2 = false;
...
int func_237(int iParam0)//Position - 0xE574
{
	struct<27> Var0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0xE5C8
{
	char* sVar0;
	
	if (Global_10A95)
	{
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!func_239(iParam0))
	{
		Global_178B8[iParam0 /*10*/].f_1 = 1;
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_15F6A.f_B == 6)
	{
		if (Global_15F6A < 9)
		{
			...
			{
				func_263("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_178B8[iParam0 /*10*/].f_1 = 1;
		func_263("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_239(int iParam0)//Position - 0xE65F
{
	var uVar0;
...
int func_240(int iParam0)//Position - 0xE720
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_241(int iParam0, char* sParam1)//Position - 0xE7A5
{
...
bool func_242(int iParam0)//Position - 0xE887
{
...
bool func_243(int iParam0)//Position - 0xE8B5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_244(int iParam0)//Position - 0xE8E3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_245(int iParam0)//Position - 0xE911
{
	if (func_213(iParam0))
	{
		return 0;
...
void func_246()//Position - 0xE946
{
	func_263("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_247(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xE960
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_248((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_248((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_263("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_248(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xE9C5
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_249(Var1.f_6, Param1, fParam2))
	{
...
int func_249(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xEA42
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_250(int iParam0, bool bParam1)//Position - 0xEA8E
{
	if (bParam1)
	{
		func_263("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		switch (*iParam0)
		{
			case 46:
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_52);
			...
			case 48:
				...
				func_187(&(iParam0->f_29[3]));
				func_252(iParam0, 1, 0, 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_PAPARAZZI", 1);
				break;
	...
	if (iLocal_54 != -1)
	{
		func_263("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_175(&iLocal_54);
	}
	func_251(&(iParam0->f_30));
	if (!bParam1)
	{
		if (*iParam0 == 48)
		{
			func_263("SCRIPT TERMINATING: Holding on to launcher until Paparazzo 3 cleans up...");
...
int func_251(var uParam0)//Position - 0xEBFC
{
	if (func_185(uParam0))
	{
...
void func_252(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEC32
{
...
void func_253(var uParam0, bool bParam1)//Position - 0xEC52
{
	func_254(&(uParam0->f_29), bParam1);
}

void func_254(var uParam0, bool bParam1)//Position - 0xEC64
{
	int iVar0;
...
void func_255(var uParam0, bool bParam1)//Position - 0xECA2
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_256(var uParam0, bool bParam1)//Position - 0xECDD
{
	func_257(&(uParam0->f_23), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xECEF
{
	int iVar0;
...
void func_258(var uParam0)//Position - 0xED2C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_259(var uParam0, int iParam1)//Position - 0xED63
{
	func_260(&(uParam0->f_1C), iParam1);
}

void func_260(var uParam0, int iParam1)//Position - 0xED75
{
	int iVar0;
...
void func_261(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEDB6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_262(var uParam0)//Position - 0xEE05
{
	if (*uParam0 == -1)
	{
		return;
...
void func_263(char* sParam0)//Position - 0xEE42
{
...
void func_264(var uParam0)//Position - 0xEE54
{
	*uParam0 = -1;
...
void func_265()//Position - 0xEE87
{
	func_263("Running start routines.");
	Global_17B2F++;
}

int func_266(int iParam0)//Position - 0xEEA1
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
