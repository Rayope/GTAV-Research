...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_262(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_250(&Var0, 1);
	}
	if (!func_247(&iVar64, &Var0, Var61, 5f))
	{
		func_246();
	...
	while (true)
	{
		...
		if (Var0 == 47)
		{
			func_177(&Var0, Var61, "PAP2AUD", "PAP2_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		else if (Var0 == 51)
		{
			func_177(&Var0, Var61, "PAP4AUD", "PAP4_AMB", 3, "BEVERLY", 5000, 1101004800);
		}
		func_176(Var0);
		func_168(&iLocal_94, &(Var0.f_9), Var61);
		if (func_153(&Var0, 0))
		{
			if (func_152(Var0))
			{
				func_149(Var0, &uLocal_96);
			}
			if (!func_2(&Var0))
			{
				func_250(&Var0, 1);
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5603
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5C9D
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x6053
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_150(struct<3> Param0, int iParam3)//Position - 0x9D6D
{
	var uVar0;
...
float func_172(int iParam0, struct<3> Param1, int iParam4)//Position - 0xB1FB
{
	struct<3> Var0;
...
int func_177(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xB367
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_28[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_172(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_180(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
int func_181(var uParam0, bool bParam1)//Position - 0xB51B
{
	...
	if ((func_218(*uParam0) || func_216(*uParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_190(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
bool func_195(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC45A
{
	...
	uVar0 = func_196(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_196(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xC51B
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_199(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC756
{
	...
	{
		Var3 = { func_201(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_200(struct<3> Param0, struct<3> Param3)//Position - 0xC7E7
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_208(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xCB65
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_217() && Global_89962.f_11 == 6) && iParam0 == func_147(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_221(var uParam0)//Position - 0xCFA7
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_230(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			{
				if (func_227(&(uParam0->f_28[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_225(&(uParam0->f_28[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_225(&(uParam0->f_28[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_223(&(uParam0->f_35[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_158(uParam0->f_35[0]))
				{
			...
			{
				func_223(&(uParam0->f_35[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_158(uParam0->f_35[1]))
				{
			...
			{
				func_222(&(uParam0->f_41[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_111(uParam0->f_28[0]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
			...
			{
				func_222(&(uParam0->f_41[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_111(uParam0->f_28[1]) && ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
				{
...
void func_222(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xD56A
{
	func_187(uParam0);
...
void func_223(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xD591
{
	func_224(uParam0);
...
void func_225(var uParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xD668
{
	func_226(uParam0);
...
int func_227(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xD6C8
{
...
int func_228(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xD723
{
	int iVar0;
...
int func_232(var uParam0)//Position - 0xD85C
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			func_223(&(uParam0->f_35[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
...
int func_233(var uParam0)//Position - 0xD947
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_230(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_227(&(uParam0->f_28[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], 1);
			...
			if (func_110(uParam0->f_28[0]))
			{
				...
				{
					func_222(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_111(uParam0->f_41[3]))
					{
...
int func_234(var uParam0)//Position - 0xDE86
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_227(&(uParam0->f_28[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (func_110(uParam0->f_28[0]))
			{
				if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
				{
					func_222(&(uParam0->f_41[0]), iVar0[2], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
					if (func_111(uParam0->f_41[0]))
					{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_223(&(uParam0->f_35[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_111(PLAYER::PLAYER_PED_ID()))
			{
...
int func_235(var uParam0)//Position - 0xE1C7
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_230(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			func_236(46, 1);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_227(&(uParam0->f_28[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_28[0]);
					PED::SET_PED_COMPONENT_VARIATION(uParam0->f_28[0], 9, 1, 0, 0);
				}
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_223(&(uParam0->f_35[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_158(uParam0->f_35[0]))
				{
...
int func_247(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xE960
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_248((*iParam0)[0], Param2, fParam5, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_248((*iParam0)[iVar0], Param2, fParam5, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_248(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xE9C5
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_249(Var1.f_6, Param1, fParam4))
	{
...
int func_249(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xEA42
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
