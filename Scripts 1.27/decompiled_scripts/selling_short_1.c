...
void func_1(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0xD9
{
...
void func_3(char* sParam0)//Position - 0x1D0
{
...
void func_5()//Position - 0x245
{
}

void func_6()//Position - 0x24D
{
}

bool func_7(var uParam0)//Position - 0x255
{
...
void func_8(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x272
{
	if (bParam0)
	{
...
int func_9(int iParam0)//Position - 0x343
{
...
bool func_10()//Position - 0x384
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_11(int iParam0, int iParam1)//Position - 0x395
{
	bool bVar0;
...
int func_12(int iParam0, bool bParam1)//Position - 0x3E0
{
	int iVar0;
	int iVar1;
...
int func_13()//Position - 0x421
{
	return Global_1312737;
}

int func_14(int iParam0, var uParam1, var uParam2)//Position - 0x42D
{
	int iVar0;
...
void func_16(int iParam0)//Position - 0x485
{
	if (iParam0 == 1)
	{
...
void func_17(bool bParam0)//Position - 0x4A8
{
	int iVar0;
...
void func_18(int iParam0)//Position - 0x7DC
{
	switch (iParam0)
	{
		case 0:
...
void func_19(int iParam0, int iParam1, int iParam2)//Position - 0x94C
{
	Local_23[iParam0] = iParam1;
	Local_23.f_17[iParam0] = iParam2;
}

void func_20(var uParam0, int iParam1)//Position - 0x966
{
	uParam0->f_22 = 0;
...
void func_21(var uParam0, int iParam1)//Position - 0x98E
{
	uParam0->f_22 = 0;
...
void func_22(var uParam0, int iParam1)//Position - 0x9B6
{
	struct<3> Var0;
...
void func_23(var uParam0, struct<3> Param1, struct<3> Param4, int iParam7, float fParam8, float fParam9)//Position - 0x235B
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param4 };
	uParam0->f_7 = iParam7;
...
void func_24(var uParam0, int iParam1, struct<3> Param2, struct<3> Param5, int iParam8, int iParam9, int iParam10)//Position - 0x238D
{
...
void func_25(var uParam0, var uParam1, struct<3> Param2, struct<3> Param5, var uParam8, var uParam9, var uParam10)//Position - 0x23C8
{
	*uParam0 = { Param2 };
	uParam0->f_3 = { Param5 };
	uParam0->f_6 = uParam8;
...
float func_26(float fParam0)//Position - 0x23FA
{
	return (fParam0 * 57.29578f);
}

void func_27(var uParam0)//Position - 0x240A
{
	uParam0->f_154 = 0;
...
int func_28(char* sParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2427
{
	int iVar0;
...
int func_29(char* sParam0, var uParam1, int iParam2)//Position - 0x248C
{
	int iVar0;
...
int func_30(char* sParam0, int iParam1)//Position - 0x24F4
{
	int iVar0;
...
char* func_31(int iParam0)//Position - 0x254F
{
	char* sVar0;
...
void func_32(var uParam0, int iParam1)//Position - 0x261F
{
...
void func_33(int iParam0)//Position - 0x26ED
{
...
void func_34(bool bParam0)//Position - 0x2747
{
	if (bParam0)
	{
		func_38();
...
void func_35(int iParam0)//Position - 0x27AA
{
	if (Global_14551)
	{
		func_36(0, 0);
...
void func_36(bool bParam0, bool bParam1)//Position - 0x281A
{
	if (bParam0)
	{
		if (func_37(0))
...
int func_37(int iParam0)//Position - 0x288E
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
void func_41(var uParam0)//Position - 0x2A1C
{
...
void func_42(var uParam0)//Position - 0x2A7F
{
	STREAMING::REMOVE_ANIM_DICT(uParam0);
}

void func_43(int iParam0)//Position - 0x2A8D
{
	if (iParam0 != 0)
	{
...
void func_44(var uParam0)//Position - 0x2AA1
{
	int iVar0;
	var uVar1;
	var uVar2;
...
char* func_45(int iParam0)//Position - 0x2B15
{
	char* sVar0;
...
char* func_46(int iParam0)//Position - 0x2B2B
{
	char* sVar0;
...
void func_47(var uParam0)//Position - 0x2B40
{
	int iVar0;
...
void func_48(var uParam0)//Position - 0x2B8C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_49(var uParam0)//Position - 0x2BCB
{
	int iVar0;
...
void func_50(var uParam0)//Position - 0x2BF4
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
