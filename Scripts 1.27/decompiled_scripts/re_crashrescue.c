...
void func_1()//Position - 0x259
{
	switch (iLocal_282)
	{
		...
		case 1:
			if (func_19(iLocal_74))
			{
				if (func_8(&uLocal_87, "RECRAAU", sLocal_284, 3, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_283)
				{
					iLocal_282++;
				}
			}
		...
		case 4:
			if ((MISC::GET_GAME_TIMER() > iLocal_283 && func_8(&uLocal_87, "RECRAAU", sLocal_284, 3, 0, 0, 0)) || MISC::GET_GAME_TIMER() > iLocal_283 + 6000)
			{
				func_308();
			}
			break;
...
int func_2()//Position - 0x49C
{
	func_3();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_3()//Position - 0x4B5
{
	int iVar0;
...
bool func_4(int iParam0)//Position - 0x5B2
{
	return Global_34913 == iParam0;
}

bool func_5(int iParam0)//Position - 0x5C0
{
	return iParam0 < 3;
}

int func_6(int iParam0)//Position - 0x5CC
{
	int iVar0;
	int iVar1;
...
int func_7(int iParam0)//Position - 0x609
{
	if (func_5(iParam0))
	{
...
bool func_8(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x633
{
...
int func_9(char* sParam0, int iParam1, bool bParam2)//Position - 0x681
{
	Global_15693 = 0;
...
void func_18(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC5F
{
...
int func_19(int iParam0)//Position - 0xCB5
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_74) && !PED::IS_PED_INJURED(iLocal_75))
			{
				if (PED::IS_PED_IN_GROUP(iLocal_74) || ENTITY::IS_ENTITY_AT_COORD(iLocal_74, Local_59, Global_21, 0, 1, 0))
				{
					...
					{
						if (func_193(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 5f, 1, 1056964608, 0, 1))
						{
							iVar0 = 1;
						}
					}
...
void func_22()//Position - 0x10D5
{
	func_23();
}

int func_23()//Position - 0x10E2
{
	if (func_24(0))
	{
		return 0;
...
bool func_24(bool bParam0)//Position - 0x112D
{
...
void func_25(int iParam0, int iParam1)//Position - 0x1158
{
	...
	if (iParam1 <= func_42(iParam0))
	{
		...
		{
			func_27(func_33(iParam0, iParam1), Local_47.x, Local_47.f_1);
		}
...
void func_26(int iParam0)//Position - 0x125C
{
	Global_97339 = iParam0;
}

void func_27(int iParam0, var uParam1, var uParam2)//Position - 0x126A
{
	bool bVar0;
...
int func_29()//Position - 0x1813
{
	return Global_24444;
}

int func_30(int iParam0, int iParam1)//Position - 0x181E
{
	int iVar0;
...
int func_31(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x186F
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_32()//Position - 0x1ACC
{
	return Global_1312737;
}

int func_33(int iParam0, int iParam1)//Position - 0x1AD8
{
	switch (iParam0)
	{
		case 0:
...
int func_34(int iParam0)//Position - 0x1E4C
{
	switch (iParam0)
	{
		case 29:
...
void func_35(int iParam0)//Position - 0x1E7B
{
	int iVar0;
	int iVar1;
...
void func_36(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1EBD
{
	func_37(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_37(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1EDF
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x2219
{
	int iVar0;
	int iVar1;
...
void func_41(int iParam0, int iParam1)//Position - 0x225C
{
	MISC::SET_BIT(&(Global_97353.f_28192.f_8[iParam0]), iParam1);
}

int func_42(int iParam0)//Position - 0x2277
{
	int iVar0;
...
int func_44(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2345
{
...
int func_45()//Position - 0x251F
{
	return 1;
}

void func_46(int iParam0, bool bParam1)//Position - 0x2528
{
	int iVar0;
	var uVar1;
...
var func_47(int iParam0)//Position - 0x2626
{
	return func_48(iParam0);
}

char* func_48(int iParam0)//Position - 0x2634
{
	switch (iParam0)
	{
		case 1:
...
int func_49(int iParam0)//Position - 0x2717
{
...
int func_51(int iParam0)//Position - 0x27CE
{
	if (func_19(iParam0))
	{
...
int func_53(int iParam0)//Position - 0x282F
{
...
void func_55(int iParam0)//Position - 0x28AB
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
Vector3 func_57()//Position - 0x2960
{
	return 2.55f, 5.59f, 2.55f;
}

void func_58(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x2977
{
	if (bParam0)
	{
...
int func_59(int iParam0)//Position - 0x2A48
{
...
bool func_60()//Position - 0x2A89
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_61(int iParam0, int iParam1)//Position - 0x2A9A
{
	bool bVar0;
...
int func_62(int iParam0, bool bParam1)//Position - 0x2AE5
{
	int iVar0;
	int iVar1;
...
void func_63(int iParam0)//Position - 0x2B26
{
	if (iParam0 == 1)
	{
...
bool func_64(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2B49
{
...
void func_66(int iParam0, bool bParam1)//Position - 0x2D53
{
...
Vector3 func_67(var uParam0)//Position - 0x2D8F
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

int func_68(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2DA2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x358F
{
	int iVar0;
...
int func_70(int iParam0)//Position - 0x361B
{
	switch (iParam0)
	{
...
void func_71(int iParam0, int iParam1, int iParam2)//Position - 0x3656
{
	int iVar0;
	int iVar1;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x36E0
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_73(int iParam0, int iParam1, int iParam2)//Position - 0x37BE
{
	Global_68106[1 /*14*/] = { func_117(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_74(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x37E8
{
	var uVar0;
	int iVar10;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x3DE3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3E7C
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x3F12
{
	int iVar0;
	int iVar1;
...
int func_78(int iParam0)//Position - 0x3FB3
{
	switch (iParam0)
	{
		case 0:
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x40A9
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x43B0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4F63
{
	int iVar0;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5247
{
	int iVar0;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x550E
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5545
{
	int iVar0;
...
int func_85(int iParam0, int iParam1, int iParam2)//Position - 0x556E
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5838
{
	int iVar0;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0x5AC2
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_88(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0x5C19
{
	if (iParam2 == -1)
	{
...
struct<10> func_89(int iParam0, int iParam1)//Position - 0x5C42
{
	int iVar0;
	struct<10> Var1;
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6571
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x669B
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_92(int iParam0, int iParam1)//Position - 0x677B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_93(int iParam0)//Position - 0x6B22
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x6B83
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_95(int iParam0, int iParam1)//Position - 0x6BCB
{
	int iVar0;
	struct<16> Var1;
...
void func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8A11
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_97(int iParam0)//Position - 0x8BC2
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x8C72
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x8CE3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_100(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8F06
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_101(int iParam0, int iParam1, int iParam2)//Position - 0x9000
{
	var uVar0;
	var uVar1;
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0x93F5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_103(int iParam0, int iParam1)//Position - 0x96D4
{
	int iVar0;
	int iVar1;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x971A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_105(int iParam0, int iParam1)//Position - 0x9816
{
	int iVar0;
...
int func_106(int iParam0)//Position - 0x9954
{
	switch (iParam0)
	{
		case 0:
...
int func_107(int iParam0, int iParam1)//Position - 0x99DA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9A3A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0)//Position - 0x9ABE
{
...
void func_110(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x9B76
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9BBF
{
	int iVar0;
...
int func_112(var uParam0)//Position - 0x9BEA
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0, int iParam1, int iParam2)//Position - 0x9C1E
{
	var uVar0;
	var uVar1;
...
bool func_114(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x9C50
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xA2F1
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_116(int iParam0)//Position - 0xB20F
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_117(int iParam0, int iParam1, int iParam2)//Position - 0xB260
{
	func_180();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_118(int iParam0, int iParam1)//Position - 0xB2B2
{
	switch (iParam0)
	{
		case 0:
...
void func_119(int iParam0)//Position - 0xB3A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xC618
{
	var uVar0;
	int iVar1;
...
bool func_121(int iParam0, int iParam1, var uParam2)//Position - 0xC99B
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_122(int iParam0, int iParam1)//Position - 0xCDA0
{
	switch (iParam1)
	{
		case 0:
...
int func_123(int iParam0, int iParam1)//Position - 0xD19B
{
	switch (iParam1)
	{
		case 0:
...
int func_124(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xD596
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_125(int iParam0)//Position - 0xD5D8
{
	switch (iParam0)
	{
		case -1:
...
void func_126(int iParam0, int iParam1, int iParam2)//Position - 0xD6AC
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
...
void func_127(int iParam0)//Position - 0xD927
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xDA7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xDF8A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xDFFE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0xE071
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0xE157
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0xE4B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0xE6C9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0xE8F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0xEA07
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0xF3A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0xFF17
{
	if (iParam0 < 136)
	{
		func_140(iParam0);
...
void func_139(int iParam0)//Position - 0xFF4B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x1EE4D
{
	func_185(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_185(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x1EE76
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_186(struct<3> Param0)//Position - 0x1F25C
{
...
int func_187(int iParam0, int iParam1, bool bParam2)//Position - 0x1F286
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_188(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1F2F7
{
...
int func_189(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x1F3D0
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_190(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x1F6C6
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_191(struct<3> Param0)//Position - 0x1F77A
{
	float fVar0;
	float fVar1;
...
void func_192(int iParam0)//Position - 0x1F7B9
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
int func_193(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x1F81E
{
...
int func_194(int iParam0, int iParam1, int iParam2)//Position - 0x1F9A0
{
	int iVar0;
	...
	if (!PED::IS_PED_INJURED(iLocal_74))
	{
		...
		else if (MISC::GET_GAME_TIMER() < iLocal_283)
		{
			...
			if (func_207())
			{
				if (iLocal_77)
				{
					if (!func_206(PLAYER::PLAYER_PED_ID(), 1935.53f, 6291.888f, 41.144f, 100f))
					{
				...
				if (bLocal_255)
				{
					...
					else if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_75, PLAYER::PLAYER_PED_ID(), 1) || func_200(iLocal_75, PLAYER::PLAYER_PED_ID(), 1.25f))
					{
			...
			else
			{
				...
				if (!func_200(PLAYER::PLAYER_PED_ID(), iLocal_74, 200f))
				{
					iLocal_53 = 2;
					iLocal_282 = 5;
				}
...
{
	if (!bLocal_255 && func_206(PLAYER::PLAYER_PED_ID(), Local_59, 150f))
	{
...
void func_199(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1FECB
{
...
bool func_200(int iParam0, int iParam1, float fParam2)//Position - 0x1FF66
{
...
int func_202(struct<3> Param0, var uParam3)//Position - 0x1FF98
{
	...
	HUD::SET_BLIP_SCALE(iVar0, func_203(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
	HUD::SET_BLIP_ROUTE(iVar0, uParam3);
	return iVar0;
}

float func_203(bool bParam0, float fParam1, float fParam2)//Position - 0x1FFC4
{
	if (bParam0)
	{
		return fParam1;
...
void func_205(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2002B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
		if (!PED::IS_PED_INJURED(*iParam0))
...
bool func_206(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2007A
{
...
int func_211(int iParam0, bool bParam1, bool bParam2)//Position - 0x201FC
{
	int iVar0;
	...
	{
		HUD::SET_BLIP_SCALE(iVar0, func_203(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(iVar0, bParam1);
	}
	else if (ENTITY::IS_ENTITY_AN_OBJECT(iParam0))
	{
...
var func_215(int iParam0, bool bParam1, int iParam2)//Position - 0x202DE
{
	var uVar0;
...
void func_219()//Position - 0x20488
{
	switch (iLocal_55)
	{
		...
		case 4:
			if (iLocal_66 == 0)
			{
				if (MISC::GET_GAME_TIMER() > iLocal_65 && !func_325())
				{
					if (func_207())
					{
	...
	switch (iLocal_70)
	{
		...
		case 1:
			if (!PED::IS_PED_INJURED(iLocal_74))
			{
				...
				uLocal_279 = GRAPHICS::ADD_DECAL(1110, Local_271, 0f, 0f, -1f, func_191(0f, 1f, 0f), 1f, 1f, 0.196f, 0f, 0f, 1f, -1f, 0, 0, 0);
...
void func_224(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4)//Position - 0x2146E
{
...
float func_226(float fParam0, float fParam1, float fParam2)//Position - 0x215C7
{
	float fVar0;
...
Vector3 func_227()//Position - 0x21609
{
	return 0f, 0f, 0f;
}
...
void func_228()//Position - 0x21614
{
	if (!PED::IS_PED_INJURED(iLocal_74) && !func_246())
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_74, 80f, 80f, 15f, 0, 1, 0))
		{
			...
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_74, 2.5f, 2.5f, 2.5f, 0, 1, 1) && func_243(1, 0, 1))
			{
				PED::SET_PED_AS_GROUP_MEMBER(iLocal_74, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
			...
			else if (func_200(PLAYER::PLAYER_PED_ID(), iLocal_74, 15f) && ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 4f)
			{
				if (func_325())
				{
					func_241();
...
int func_229(int iParam0)//Position - 0x217FF
{
	if (func_233())
	{
		Global_97343 = 1;
...
void func_230(int iParam0)//Position - 0x21852
{
	switch (iParam0)
	{
		case 0:
...
void func_231(var uParam0, int iParam1)//Position - 0x21933
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(uParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

char* func_232(int iParam0)//Position - 0x2194A
{
	char* sVar0;
...
int func_233()//Position - 0x2198E
{
	switch (func_234(&Global_24503, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
int func_234(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x219C4
{
	int iVar0;
...
void func_235(var uParam0, int iParam1)//Position - 0x21AFB
{
	int iVar0;
...
bool func_236(int iParam0)//Position - 0x21B4A
{
	return func_237(iParam0, Global_34913);
}

int func_237(int iParam0, int iParam1)//Position - 0x21B5B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_238(int iParam0)//Position - 0x21D3C
{
	if (Global_34913 == 15)
	{
		return 0;
...
int func_240(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x21D89
{
	int iVar0;
	bool bVar1;
...
void func_241()//Position - 0x21DDB
{
	Global_14558 = 0;
	func_242();
}

void func_242()//Position - 0x21DEB
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_243(bool bParam0, bool bParam1, bool bParam2)//Position - 0x21E0F
{
	int iVar0;
...
void func_245(bool bParam0)//Position - 0x21F09
{
	if (bParam0)
	{
...
void func_247()//Position - 0x21FDB
{
	...
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_257) && STREAMING::HAS_MODEL_LOADED(iLocal_259)) && STREAMING::HAS_MODEL_LOADED(iLocal_258)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_260)) && STREAMING::HAS_CLIP_SET_LOADED(sLocal_261)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_264)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_265)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_266)) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_263)) && STREAMING::HAS_PTFX_ASSET_LOADED())
	{
		...
		if (func_2() == 0)
		{
			func_199(&uLocal_87, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		}
		else if (func_2() == 1)
		{
			func_199(&uLocal_87, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
		}
		else if (func_2() == 2)
		{
			func_199(&uLocal_87, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		}
...
int func_248()//Position - 0x2246F
{
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_255())
		{
			return 0;
		}
	}
...
int func_249(float fParam0, bool bParam1)//Position - 0x224D1
{
	struct<27> Var0;
	int iVar32;
	int iVar33;
...
void func_250(int iParam0, var uParam1)//Position - 0x22588
{
	switch (iParam0)
	{
		case 0:
...
int func_252(int iParam0)//Position - 0x23860
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_253(int iParam0)//Position - 0x23BA6
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_254(int iParam0)//Position - 0x23BDE
{
	struct<2> Var0;
...
bool func_257()//Position - 0x2407A
{
	return Global_97071 > 0;
}

int func_258()//Position - 0x24088
{
	if (Global_87289 != -1)
	{
		return 1;
...
void func_261()//Position - 0x24149
{
}

void func_262(int iParam0)//Position - 0x24151
{
	if (iParam0 == -1)
	{
		iParam0 = func_43();
...
void func_263()//Position - 0x24187
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
...
void func_264(int iParam0)//Position - 0x241C4
{
...
bool func_266(struct<3> Param0, struct<3> Param3)//Position - 0x2456B
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

bool func_267(int iParam0)//Position - 0x24594
{
	int iVar0;
...
int func_268(int iParam0)//Position - 0x245B5
{
	return func_269(iParam0, 1);
}

int func_269(int iParam0, int iParam1)//Position - 0x245C4
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_270(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x24617
{
	func_271(func_281(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_271(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x24635
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar4 < 0)
	{
		...
		iVar3 = (iVar3 - 1);
		iVar0 = SYSTEM::ROUND(func_226(SYSTEM::TO_FLOAT(iVar0 + 1), 0f, 12f));
	}
	while (iVar3 < 0)
	{
		iVar3 += 12;
...
int func_272(int iParam0, int iParam1)//Position - 0x24836
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_273(int iParam0)//Position - 0x248D8
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_274(int iParam0)//Position - 0x248EB
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_275(int iParam0)//Position - 0x248FE
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_276(int iParam0)//Position - 0x24911
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_277(int iParam0)//Position - 0x24923
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_278(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_278(bool bParam0, int iParam1, int iParam2)//Position - 0x24948
{
	if (bParam0)
	{
		return iParam1;
...
int func_279(int iParam0)//Position - 0x2495F
{
	return iParam0 & 15;
}

int func_280(int iParam0, int iParam1)//Position - 0x2496C
{
	int iVar0;
	int iVar1;
...
int func_281()//Position - 0x24A78
{
	...
	func_284(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_283(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_282(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_282(var uParam0, int iParam1)//Position - 0x24ABE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_283(var uParam0, int iParam1)//Position - 0x24B44
{
...
void func_284(var uParam0, int iParam1)//Position - 0x24B77
{
	int iVar0;
	int iVar1;
...
void func_285(var uParam0, int iParam1)//Position - 0x24BC8
{
...
void func_286(var uParam0, int iParam1)//Position - 0x24C02
{
...
void func_287(var uParam0, int iParam1)//Position - 0x24C3D
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_288(int iParam0)//Position - 0x24C79
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_289(int iParam0, int iParam1)//Position - 0x24D55
{
...
int func_290(int iParam0)//Position - 0x24D78
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_298()) || Global_96400) || Global_24446) || func_297()) || func_16(8, -1)) || func_296()) || func_295()) || func_294()) || func_293()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_298()) || Global_24446) || func_297()) || func_16(8, -1)) || func_294()) || func_296()) || func_295()) || func_293()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_298()) || Global_96400) || Global_24446) || func_297()) || func_16(8, -1)) || func_294()) || func_296()) || func_295()) || func_293()) || Global_97353.f_5944.f_919[iVar0] == 5) || Global_35460 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_298()) || Global_96400) || Global_24446) || func_297()) || func_16(8, -1)) || func_296()) || func_295()) || func_293()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_298() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_16(8, -1)) || func_293()) || func_292()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_298()) || Global_24446) || func_297()) || func_16(8, -1)) || func_295()) || func_294()) || func_293()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_298()) || func_295()) || Global_96400) || Global_24446) || func_297()) || Global_35957) || func_16(8, -1)) || func_294()) || func_292()) || func_293()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_298()) || Global_96400) || Global_24446) || func_297()) || func_16(8, -1)) || func_294()) || func_292()) || func_296()) || func_295()) || func_293())
						{
							return 0;
						}
						break;
...
var func_291()//Position - 0x25495
{
	return Global_90001.f_1;
}

int func_292()//Position - 0x254A3
{
	if (Global_87289 != -1)
	{
...
bool func_295()//Position - 0x2550D
{
	return Global_90014.f_291 > 0;
}

bool func_296()//Position - 0x2551E
{
	return Global_90014.f_290 > 0;
}

var func_297()//Position - 0x2552F
{
	return Global_1315900;
}

int func_298()//Position - 0x2553B
{
...
bool func_300(int iParam0)//Position - 0x2557F
{
	return func_280(func_281(), iParam0);
}

int func_301(int iParam0, int iParam1, int iParam2)//Position - 0x25591
{
	int iVar0;
	int iVar1;
...
int func_302(int iParam0)//Position - 0x25675
{
	if (!func_5(iParam0))
	{
		return 7;
...
bool func_303(int iParam0)//Position - 0x25699
{
	int iVar0;
	bool bVar1;
...
void func_309(int iParam0)//Position - 0x258C0
{
	char cVar0[64];
...
void func_310(var uParam0)//Position - 0x25975
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_311(int iParam0, bool bParam1)//Position - 0x259B2
{
	switch (iParam0)
	{
		case 0:
...
void func_312(int iParam0)//Position - 0x25BFB
{
	Global_35464 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_313(int iParam0)//Position - 0x25C0D
{
	func_314(iParam0, 0, func_319(iParam0));
}

void func_314(int iParam0, int iParam1, int iParam2)//Position - 0x25C22
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_315(var uParam0)//Position - 0x25C51
{
	struct<16> Var0;
	int iVar16;
...
void func_316(int iParam0, var uParam1)//Position - 0x25D22
{
	Global_97353.f_28192.f_43[iParam0] = *uParam1;
}

void func_317(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25D3A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_318(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25EBC
{
...
int func_319(int iParam0)//Position - 0x25EF4
{
	int iVar0;
...
void func_320(var uParam0, bool bParam1)//Position - 0x26097
{
...
void func_321()//Position - 0x260D2
{
	Global_14558 = 0;
	func_322();
}

void func_322()//Position - 0x260E2
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
