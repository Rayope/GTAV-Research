...
void func_1()//Position - 0x572
{
	...
	if (func_273(iLocal_603) && func_273(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if ((func_30(iLocal_603, 1126825984) && !ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_603, PLAYER::PLAYER_PED_ID(), 1)) && !func_22(iLocal_603, 1, 0, 0, 0))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_603))
				{
					PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_603, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
		...
		if ((iLocal_888 == 1 && MISC::GET_GAME_TIMER() > iLocal_905) && func_21(PLAYER::PLAYER_PED_ID(), iLocal_603, 10f))
		{
			if (func_20())
			{
...
int func_25(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x122E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	{
		Var3 = { func_27(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_26(struct<3> Param0, struct<3> Param3)//Position - 0x12BC
{
...
int func_33(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x14D3
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
void func_40()//Position - 0x1821
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_603))
	{
		...
		{
			if (func_273(iLocal_603) && !PED::IS_PED_FLEEING(iLocal_603))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_603))
				{
					PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_603, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
			...
			if (func_273(iLocal_604) && !PED::IS_PED_FLEEING(iLocal_604))
			{
	...
	{
		if (func_273(iLocal_604) && func_273(PLAYER::PLAYER_PED_ID()))
		{
			if (!func_21(PLAYER::PLAYER_PED_ID(), iLocal_604, 100f))
			{
				iLocal_515 = 5;
				iLocal_521 = 0;
				iLocal_520 = 10;
			...
			{
				if (!func_21(PLAYER::PLAYER_PED_ID(), iLocal_604, 50f))
				{
					func_349(789);
					iLocal_873 = 1;
				}
...
void func_58()//Position - 0x1F5E
{
	switch (iLocal_521)
	{
		case 0:
			...
			{
				if (func_62(iLocal_603, PLAYER::PLAYER_PED_ID()) < 30f)
				{
		...
		case 1:
			if (!func_20())
			{
				...
				else if (MISC::GET_GAME_TIMER() > iLocal_949)
				{
					...
					func_60(&uLocal_700, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	...
	switch (iLocal_521)
	{
		case 0:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_933, Local_936, fLocal_939, 0, 1, 0))
			{
				...
				func_80(PLAYER::PLAYER_PED_ID(), Local_940);
		...
		case 1:
			if (((iLocal_883 == 0 && PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_615)) && PED::GET_SYNCHRONIZED_SCENE_PHASE(uLocal_615) >= 0.75f) && func_273(iLocal_604))
			{
				AUDIO::PLAY_SOUND_FROM_ENTITY(-1, "COLLAR", iLocal_604, "NIGEL_1C_SOUNDSET", 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(iLocal_604, 3, 1, 0, 0);
				iLocal_883 = 1;
			}
			else if (!PED::IS_SYNCHRONIZED_SCENE_RUNNING(uLocal_615) && !func_20())
			{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_107(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_113(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_113(Var16.f_2)] = func_107(iParam1, Var16.x, func_113(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_136(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
		...
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_136(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_199(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x1EE34
{
	func_200(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_200(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x1EE5E
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_204(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x1F3B7
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_205(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x1F6AD
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_214(float fParam0)//Position - 0x1FA4E
{
	...
	if (func_273(PLAYER::PLAYER_PED_ID()) && func_273(iLocal_604))
	{
		...
		if ((ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_604, Local_926, Local_929, fLocal_932, 0, 1, 0) && func_215(PLAYER::PLAYER_PED_ID(), ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(iLocal_604, 0f, 1f, 0f), 1.5f)) && !ENTITY::HAS_ENTITY_COLLIDED_WITH_ANYTHING(iLocal_604))
		{
		...
		if (func_21(iLocal_604, PLAYER::PLAYER_PED_ID(), (0.8f + fParam0)))
		{
...
bool func_215(int iParam0, struct<3> Param1, float fParam4)//Position - 0x1FB82
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_216()//Position - 0x1FBB7
{
	if (Local_522[0 /*16*/].f_14)
	{
		if (iLocal_880 == 0)
		{
			if ((func_273(Local_522[0 /*16*/]) && func_273(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_522[0 /*16*/]))
			{
				if (func_218() || func_21(Local_522[0 /*16*/], PLAYER::PLAYER_PED_ID(), 5f))
				{
					if (func_21(Local_522[0 /*16*/], PLAYER::PLAYER_PED_ID(), 12f))
					{
	...
	if (iLocal_882 == 1)
	{
		if ((func_273(Local_522[2 /*16*/]) && func_273(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_522[2 /*16*/]))
		{
			func_60(&uLocal_700, 4, Local_522[2 /*16*/], "ShockedBusinessMan", 0, 1);
			if (func_21(Local_522[2 /*16*/], PLAYER::PLAYER_PED_ID(), 50f))
			{
	...
	if (Local_522[1 /*16*/].f_14 == 1)
	{
		if (iLocal_886 == 1)
		{
			if ((func_273(Local_522[1 /*16*/]) && func_273(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FLEEING(Local_522[1 /*16*/]))
			{
				if (func_21(Local_522[1 /*16*/], PLAYER::PLAYER_PED_ID(), 8f))
				{
	...
	if (iLocal_885)
	{
		if (func_273(iLocal_604) && func_273(PLAYER::PLAYER_PED_ID()))
		{
			if (func_21(PLAYER::PLAYER_PED_ID(), iLocal_604, 10f))
			{
	...
	if (iLocal_878 == 0)
	{
		if (func_211(Local_658) && func_273(iLocal_604))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_658))
			{
				...
				if (iLocal_876 == 0)
				{
					if (func_21(Local_658, iLocal_604, 6f))
					{
	...
	if (iLocal_877 == 0)
	{
		if (func_211(Local_642) && func_273(iLocal_604))
		{
			if (VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_642))
			{
				...
				if (iLocal_875 == 0)
				{
					if (func_21(Local_642, iLocal_604, 6f))
					{
...
void func_224()//Position - 0x201CC
{
			...
			switch (iLocal_513)
			{
				...
				case 2:
					if ((VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_634) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_666)) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(Local_626))
					{
						...
						if (func_21(Local_634, Local_666, 7f))
						{
							iLocal_513 = 3;
						}
					}
	...
	else if ((func_48(Local_634) && func_48(Local_626)) && func_48(Local_666))
	{
...
{
	if ((func_273(Local_666.f_1) && func_29(Local_666)) && func_273(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_518)
		{
			case 0:
			...
			case 1:
				...
				{
					if (((!func_21(Local_666.f_1, Local_666, 20f) && !func_21(PLAYER::PLAYER_PED_ID(), Local_666, 20f)) && !func_21(PLAYER::PLAYER_PED_ID(), Local_666.f_1, 10f)) && !PED::IS_PED_FLEEING(Local_666.f_1))
					{
						TASK::CLEAR_PED_TASKS(Local_666.f_1);
			...
			case 2:
				if (func_63(PLAYER::PLAYER_PED_ID(), Local_666.f_1, 1) < 8f)
				{
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_666.f_1, 5, 1);
					TASK::TASK_COMBAT_PED(Local_666.f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
					iLocal_518 = 1;
				}
				if (func_63(PLAYER::PLAYER_PED_ID(), Local_666.f_1, 1) > 20f)
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_865);
			...
			case 3:
				if (func_21(PLAYER::PLAYER_PED_ID(), Local_666.f_1, 8f))
				{
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_666.f_1, 5, 1);
					TASK::TASK_COMBAT_PED(Local_666.f_1, PLAYER::PLAYER_PED_ID(), 0, 16);
					iLocal_518 = 1;
...
{
	if ((func_273(iLocal_603) && func_236(iLocal_603, Local_608, 1) < 5f) && func_236(PLAYER::PLAYER_PED_ID(), Local_608, 1) < 25f)
	{
		if (iLocal_612)
		{
		...
		else if (MISC::GET_GAME_TIMER() > iLocal_613 && !func_20())
		{
...
float func_236(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2187D
{
	struct<3> Var0;
...
void func_240()//Position - 0x21F71
{
	...
	switch (iLocal_521)
	{
		...
		case 1:
			...
			{
				bVar0 = false;
				if ((func_273(iLocal_603) && func_273(PLAYER::PLAYER_PED_ID())) && func_21(iLocal_603, PLAYER::PLAYER_PED_ID(), 35f))
				{
...
int func_244()//Position - 0x22303
{
	if (func_273(PLAYER::PLAYER_PED_ID()) && func_273(iLocal_604))
	{
		if (func_21(iLocal_604, PLAYER::PLAYER_PED_ID(), 6.5f))
		{
			return 1;
		}
...
void func_245()//Position - 0x2236B
{
	...
	switch (iLocal_516)
	{
		...
		case 2:
			if (MISC::GET_GAME_TIMER() > iLocal_948 && func_273(iLocal_603))
			{
				if (PED::IS_PED_USING_ANY_SCENARIO(iLocal_603))
				{
					PED::SET_PED_PANIC_EXIT_SCENARIO(iLocal_603, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1));
		...
		case 5:
			func_247();
			if (MISC::GET_GAME_TIMER() > iLocal_948 && func_273(iLocal_604))
			{
...
bool func_246(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2264E
{
...
{
	if (((!func_267(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_270(struct<3> Param0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2377A
{
	var uVar0;
	int iVar1;
...
void func_279()//Position - 0x23ADC
{
	...
	{
		func_281(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
void func_314()//Position - 0x26611
{
	...
	{
		func_10();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_315(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_354(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x2C089
{
	int iVar0;
...
int func_355(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2C211
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_367(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_387(int iParam0, int iParam1)//Position - 0x3099B
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_388(iParam0, iParam1))
				{
...
void func_389(struct<3> Param0, float fParam3, int iParam4)//Position - 0x30A7E
{
	int iVar0;
...
void func_391(struct<54> Param0, var uParam54)//Position - 0x30C43
{
...
bool func_395(struct<3> Param0, struct<3> Param3)//Position - 0x3247E
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_396(struct<3> Param0, float fParam3)//Position - 0x324A7
{
	return func_397(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_397(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x324C1
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_406(uParam0))
	{
		...
		if (func_405(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_399(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_399(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x3282F
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_401(iParam0, uVar1[iVar6], 1) && func_400(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_395(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_400(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x32A35
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_402(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x32AE1
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_404(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_403())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_367(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
void func_430(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x33EAB
{
	if (func_434())
	{
...
int func_432(var uParam0)//Position - 0x33F6A
{
	...
	switch (iLocal_81)
	{
		...
		case 1:
			if (!func_433(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_81 = 2;
...
int func_453(char* sParam0, int iParam1, int iParam2)//Position - 0x348DB
{
	...
	if (func_459())
	{
		...
		{
			iVar33 = func_454(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
