...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_51 = func_271(68);
	iLocal_52 = joaat("landstalker");
	Local_53 = { -1473.376f, 517.8441f, 116.8854f };
	fLocal_54 = 97.3011f;
	iLocal_55 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_267(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_249(&Var0, 1);
	}
	iVar2[0] = 8;
	if (!func_246(&iVar2, &Var0, Var1, 1f))
	{
		func_245();
	...
	while (true)
	{
		...
		func_178(Var0);
		func_171(&iLocal_55, &(Var0.f_9), Var1);
		if (Var0 == 8)
		{
			func_167(&Var0, Var1, "DREY1AU", "DREY1_IDLE", 3, "DREYFUSS", 5000, 1101004800);
		}
		if (func_161(&Var0, 0) || func_149())
		{
			if (!func_2(&Var0))
			{
				func_249(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x250
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x32F
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x19B0
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x2834
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2856
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28DD
{
...
int func_29(int iParam0)//Position - 0x291D
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x294B
{
...
int func_31(int iParam0)//Position - 0x2A27
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A69
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2ACC
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2B5A
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2B9C
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E14
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E20
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x30CC
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x317C
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x3256
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3307
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x3434
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x34A5
{
...
int func_44(int iParam0)//Position - 0x357E
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x35BB
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x35E5
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x378F
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x37C1
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x37F5
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x3801
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x382D
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D75
{
	int iVar0;
...
int func_53()//Position - 0x3FB6
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x3FCF
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x40CD
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x40DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x41CE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x4432
{
...
int func_59(int iParam0, int iParam1)//Position - 0x4558
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4D74
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4DAF
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x5023
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x505F
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x55BA
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x55FE
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5C54
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5C7D
{
...
bool func_68(int iParam0)//Position - 0x5CD6
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5CE6
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5D46
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x5FEF
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x5FFA
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x600A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x60A1
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x6572
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x6582
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x67DB
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x67EC
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x6832
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x68B8
{
...
void func_81(var uParam0, int iParam1)//Position - 0x68EB
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x693C
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x69DE
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6A03
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6A1A
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6A27
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6A61
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6A9C
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6AD8
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6AF1
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6B4A
{
...
bool func_92(bool bParam0)//Position - 0x6B8C
{
...
struct<2> func_93(int iParam0)//Position - 0x6BB7
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x7004
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x82DE
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x8624
{
	var uVar0;
...
void func_98(int iParam0)//Position - 0x86C8
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x8763
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x87C1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x881A
{
...
int func_103(int iParam0)//Position - 0x889D
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x88CE
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x88E2
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x898A
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x89A5
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x89F1
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8A3A
{
	if (func_111(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8A5A
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_112(int iParam0)//Position - 0x8A7A
{
	switch (iParam0)
	{
		case 5:
...
int func_114(int iParam0)//Position - 0x8B4A
{
	switch (iParam0)
	{
		case 5:
...
void func_115(var uParam0, int iParam1, bool bParam2)//Position - 0x8B9D
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x8C91
{
	switch (iParam0)
	{
		case 5:
...
void func_117(bool bParam0)//Position - 0x8CFC
{
	var uVar0;
...
void func_118(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8D38
{
	if (bParam0)
	{
...
int func_119(int iParam0)//Position - 0x8E09
{
...
bool func_120()//Position - 0x8E4A
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_121(int iParam0, int iParam1)//Position - 0x8E5B
{
	bool bVar0;
...
int func_122(int iParam0, bool bParam1)//Position - 0x8EA6
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, var uParam1, var uParam2)//Position - 0x8EE7
{
	int iVar0;
...
void func_125(int iParam0)//Position - 0x8F3F
{
	if (iParam0 == 1)
	{
...
int func_126(char* sParam0)//Position - 0x8F62
{
...
void func_127()//Position - 0x8F9F
{
	Global_38DE = 0;
	func_128();
}

void func_128()//Position - 0x8FAF
{
...
int func_132(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x9093
{
...
void func_135(int iParam0)//Position - 0x928E
{
	if (Global_38D7)
	{
		func_136(0, 0);
...
void func_136(bool bParam0, bool bParam1)//Position - 0x92FE
{
	if (bParam0)
	{
		if (func_137(0))
...
int func_137(int iParam0)//Position - 0x9372
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_138(int iParam0)//Position - 0x93CC
{
...
int func_139(int iParam0)//Position - 0x940D
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0x9452
{
...
int func_141(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x9484
{
	int iVar0;
...
void func_142(var uParam0, int iParam1)//Position - 0x95BB
{
	int iVar0;
...
bool func_143(int iParam0)//Position - 0x960A
{
	return func_144(iParam0, Global_8861);
}

int func_144(int iParam0, int iParam1)//Position - 0x961B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_145(int iParam0)//Position - 0x97FC
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_146()//Position - 0x981E
{
	return func_147(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_147(char* sParam0, int iParam1)//Position - 0x982F
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_149()//Position - 0x989C
{
	if (func_152(2))
	{
		if (func_151(PLAYER::PLAYER_PED_ID(), -1459.68f, 485.26f, 116.22f, 1) < 6f && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				func_268("Special launching Dreyfuss1");
				return 1;
			}
			else if ((!func_150(PLAYER::PLAYER_PED_ID(), -828834893) && func_111(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0))) && func_132(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 1f, 1, 1056964608, 0, 1))
			{
				TASK::TASK_LEAVE_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0, 0);
			}
		}
...
int func_150(int iParam0, int iParam1)//Position - 0x993C
{
	if (func_110(iParam0))
	{
...
float func_151(int iParam0, struct<3> Param1, int iParam2)//Position - 0x996F
{
	struct<3> Var0;
...
int func_152(int iParam0)//Position - 0x99A8
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_17890) || Global_5F7E) || func_159()) || func_158(8, -1)) || func_77()) || func_157()) || func_156()) || func_155()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_160()) || Global_5F7E) || func_159()) || func_158(8, -1)) || func_156()) || func_77()) || func_157()) || func_155()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_17890) || Global_5F7E) || func_159()) || func_158(8, -1)) || func_156()) || func_77()) || func_157()) || func_155()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_160()) || Global_17890) || Global_5F7E) || func_159()) || func_158(8, -1)) || func_77()) || func_157()) || func_155()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_160() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_158(8, -1)) || func_155()) || func_154()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 5:
						if ((((func_158(8, -1) || func_77()) || func_157()) || func_154()) || func_153())
						{
							return 0;
						}
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_5F7E) || func_159()) || func_158(8, -1)) || func_157()) || func_156()) || func_155()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_160()) || func_157()) || Global_17890) || Global_5F7E) || func_159()) || Global_8C75) || func_158(8, -1)) || func_156()) || func_154()) || func_155()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_160()) || Global_17890) || Global_5F7E) || func_159()) || func_158(8, -1)) || func_156()) || func_154()) || func_77()) || func_157()) || func_155())
						{
							return 0;
						}
						break;
...
var func_153()//Position - 0xA0C5
{
	return Global_15F91.f_1;
}

int func_154()//Position - 0xA0D3
{
	if (Global_154F9 != -1)
	{
...
bool func_157()//Position - 0xA13D
{
	return Global_15F9E.f_123 > 0;
}

bool func_158(int iParam0, int iParam1)//Position - 0xA14E
{
	switch (iParam0)
	{
		case 5:
...
var func_159()//Position - 0xA189
{
	return Global_14143C;
}

int func_160()//Position - 0xA195
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_161(int iParam0, int iParam1)//Position - 0xA1B1
{
	switch (iParam0->f_10)
	{
		case 0:
				...
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_111(iParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0->f_1C[0], 1), 1) < 3f)
						{
							if (func_152(2))
							{
								if (func_165(iParam0->f_1B))
								{
									func_164(iParam0->f_1B, *iParam0);
...
void func_162()//Position - 0xA993
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_163(var uParam0)//Position - 0xA9AE
{
	float fVar0;
...
void func_164(int iParam0, int iParam1)//Position - 0xAA3C
{
	if (iParam0 == 1)
	{
		if (!func_114(iParam1))
...
int func_165(bool bParam0)//Position - 0xAA9F
{
	int iVar0;
...
int func_166(int iParam0)//Position - 0xAB36
{
	if (func_111(uParam0))
	{
...
int func_167(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xAB60
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_1C[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_151(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_170(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
		func_168(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_168(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xABE8
{
...
void func_169(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAC23
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_170(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xAC79
{
...
void func_171(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xAD14
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam1))
		{
			...
			{
				if (func_151(PLAYER::PLAYER_PED_ID(), Param2, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_151(PLAYER::PLAYER_PED_ID(), Param2, 1) > 120f)
				{
					func_176(iParam0);
				}
			}
...
void func_172(int iParam0, bool bParam1)//Position - 0xAE05
{
	if (iParam0 == -1)
	{
		return;
...
int func_173(int iParam0)//Position - 0xAE41
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_174(int iParam0, int iParam1)//Position - 0xAE7A
{
	bool bVar0;
	int iVar1;
...
bool func_175()//Position - 0xAF18
{
	return Global_1567C;
}

void func_176(int iParam0)//Position - 0xAF24
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_177(iParam0);
...
void func_177(int iParam0)//Position - 0xAF3B
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_178(int iParam0)//Position - 0xB023
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
void func_180(int iParam0, var uParam1, int iParam2)//Position - 0xB2BE
{
	var uVar0;
	var uVar1;
...
int func_181(int iParam0)//Position - 0xB613
{
...
int func_182(var uParam0)//Position - 0xB633
{
...
int func_183(var uParam0)//Position - 0xB64B
{
...
void func_184(var uParam0)//Position - 0xB670
{
	int iVar0;
	var uVar1;
...
void func_185(var uParam0)//Position - 0xB974
{
...
void func_186(var uParam0)//Position - 0xB99F
{
	int iVar0;
...
int func_187(var uParam0, bool bParam1, bool bParam2)//Position - 0xBA1F
{
	int iVar0;
	int iVar1;
	var uVar2;
				...
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						if (func_166(uVar2))
						{
							...
							{
								if (func_166(uParam0->f_23[iVar0]))
								{
...
int func_188(int iParam0, int iParam1)//Position - 0xBBDC
{
	int iVar0;
...
int func_190(int iParam0)//Position - 0xBEC8
{
...
int func_194(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xC04D
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_195(int iParam0, int iParam1)//Position - 0xC179
{
	int iVar0;
...
int func_197(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC288
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_198(struct<3> Param0, struct<3> Param1)//Position - 0xC319
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_199(struct<3> Param0)//Position - 0xC33A
{
	float fVar0;
	float fVar1;
...
void func_200(var uParam0)//Position - 0xC379
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_202(var uParam0)//Position - 0xC3D3
{
...
int func_203(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC3FB
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_204(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC4F6
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_205(var uParam0, float fParam1)//Position - 0xC602
{
	var uVar0;
	struct<3> Var1;
...
int func_206(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xC697
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_207(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xC725
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_208(int iParam0)//Position - 0xC76D
{
...
void func_209(int iParam0)//Position - 0xC7B7
{
	var uVar0;
...
int func_210(int iParam0)//Position - 0xC854
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_211(int iParam0)//Position - 0xC8EC
{
...
int func_214(int iParam0)//Position - 0xC96E
{
...
int func_216(int iParam0)//Position - 0xC9E0
{
	if (func_92(0))
	{
...
int func_219(var uParam0)//Position - 0xCA55
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_235(&(uParam0->f_30), "rcmcollect_paperleadinout@", "meditiate_idle", 0);
			iLocal_50 = 1;
			break;
		
		case 1:
			if (!func_234(&iVar0) || !func_233(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			{
				if (!func_230(&(uParam0->f_1C[0]), 68, -1459.68f, 485.26f, 116.22f, -131.3f, "DREYFUSS LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
...
void func_221(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xCCC0
{
	if (iParam0 != 198)
	{
		if (Global_10A95)
...
void func_222(int iParam0, int iParam1)//Position - 0xCD1B
{
	switch (iParam0)
	{
		case 12:
...
void func_223(int iParam0, bool bParam1)//Position - 0xCE04
{
	if (bParam1)
	{
...
bool func_224(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xCE2D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_225()//Position - 0xD768
{
	if ((func_71() == -1 || func_71() == 999) && !func_226() == 0)
	{
		return 1;
	}
	return 0;
...
int func_226()//Position - 0xD798
{
	return Global_5F7D;
}

int func_227(var uParam0, int iParam1)//Position - 0xD7A3
{
	int iVar0;
...
void func_228(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0x10FE4
{
	func_229(uParam0);
...
void func_229(var uParam0)//Position - 0x1101F
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_230(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0x110BB
{
	if (func_231(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_231(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)//Position - 0x11116
{
	int iVar0;
...
int func_232(var uParam0, int iParam1)//Position - 0x111A4
{
	int iVar0;
...
int func_233(var uParam0)//Position - 0x111EA
{
	if (func_183(uParam0))
	{
...
int func_234(int iParam0)//Position - 0x11214
{
	int iVar0;
...
void func_235(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x11245
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_236(int iParam0)//Position - 0x11281
{
	struct<27> Var0;
	int iVar1;
...
int func_237(int iParam0)//Position - 0x112D5
{
	char* sVar0;
...
int func_238(int iParam0)//Position - 0x1136C
{
	var uVar0;
...
int func_239(int iParam0)//Position - 0x1142D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_240(int iParam0, char* sParam1)//Position - 0x114B2
{
...
bool func_241(int iParam0)//Position - 0x11594
{
...
bool func_242(int iParam0)//Position - 0x115C2
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_243(int iParam0)//Position - 0x115F0
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_244(int iParam0)//Position - 0x1161E
{
	if (func_211(iParam0))
	{
		return 0;
...
void func_245()//Position - 0x11653
{
	func_268("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_246(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x1166D
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_247((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_247((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_247(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x116D2
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_248(Var1.f_6, Param1, fParam2))
	{
...
int func_248(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x1174F
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_249(int iParam0, bool bParam1)//Position - 0x1179B
{
	...
	func_250(sVar0);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_52, 0);
...
void func_250(char* sParam0)//Position - 0x11820
{
...
void func_251()//Position - 0x1183F
{
	Global_38DE = 0;
	func_252();
}

void func_252()//Position - 0x1184F
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_253(char* sParam0)//Position - 0x11870
{
	struct<6> Var0;
...
struct<6> func_254()//Position - 0x11890
{
	struct<6> Var0;
...
int func_255(var uParam0)//Position - 0x118B4
{
	if (func_183(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_256(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x118EA
{
...
void func_257(var uParam0, bool bParam1)//Position - 0x1190A
{
	func_258(&(uParam0->f_29), bParam1);
}

void func_258(var uParam0, bool bParam1)//Position - 0x1191C
{
	int iVar0;
...
void func_259(var uParam0, bool bParam1)//Position - 0x1195A
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_260(var uParam0, bool bParam1)//Position - 0x11995
{
	func_261(&(uParam0->f_23), bParam1);
}

void func_261(var uParam0, bool bParam1)//Position - 0x119A7
{
	int iVar0;
...
void func_262(var uParam0)//Position - 0x119E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_263(var uParam0, int iParam1)//Position - 0x11A1B
{
	func_264(&(uParam0->f_1C), iParam1);
}

void func_264(var uParam0, int iParam1)//Position - 0x11A2D
{
	int iVar0;
...
void func_265(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11A6E
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_266(var uParam0)//Position - 0x11ABD
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
void func_267(var uParam0)//Position - 0x11AFC
{
	if (*uParam0 == -1)
	{
		return;
...
void func_268(char* sParam0)//Position - 0x11B39
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_269(var uParam0)//Position - 0x11B4B
{
	*uParam0 = -1;
...
void func_270()//Position - 0x11B7E
{
	func_268("Running start routines.");
	Global_17B2F++;
}

int func_271(int iParam0)//Position - 0x11B98
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
