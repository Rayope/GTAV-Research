...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_173 = func_425(0);
	AUDIO::REGISTER_SCRIPT_WITH_AUDIO(0);
	if (func_436() || func_435(0))
	{
		func_424(&Local_95, 0, 1);
		if (func_423(iLocal_348))
		{
...
void func_1()//Position - 0x39E
{
	...
	switch (iLocal_156)
	{
		case 0:
			...
			{
				if (func_17(&uLocal_182, "FAN1AU", "FAN1_AGGRO", 9, 0, 0, 0))
				{
			...
			else
			{
				...
				func_15();
				func_13(&uLocal_182, "FAN1AU", "FAN1_AGGRO", 8, 0, 0);
			}
			func_12(&iLocal_349);
			func_12(&iLocal_671);
			func_12(&iLocal_672);
...
void func_5()//Position - 0x591
{
	...
	func_8(&iLocal_627);
	func_8(&iLocal_648);
	func_8(&(Local_575[0 /*12*/]));
	func_8(&(Local_575[1 /*12*/]));
	func_8(&(Local_575[2 /*12*/]));
	func_8(&(Local_575[3 /*12*/]));
	func_8(&Local_548);
	func_8(&(Local_548.f_1));
	func_8(&Local_562);
	func_8(&(Local_562.f_1));
	func_6(&(Local_548.f_2));
	func_6(&(Local_562.f_2));
	func_6(&iLocal_630);
	func_6(&iLocal_448);
}
...
void func_25()//Position - 0xE37
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_27(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_3(iVar0) && (!func_28(14) || Global_96306))
			{
	...
	switch (iLocal_156)
	{
		case 0:
			...
			if (iLocal_347 == 0)
			{
				if (iVar0 == 1)
				{
					func_17(&uLocal_182, "FAN1AU", "FAN1_LOSE", 8, 0, 0, 0);
					func_33("Doing 'FAN1_LOSE'");
				}
				else
				{
					func_17(&uLocal_182, "FAN1AU", "FAN1_LOSE2", 8, 0, 0, 0);
	...
	switch (iLocal_156)
	{
		case 0:
			...
			if (bLocal_169)
			{
				...
				func_283();
				if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) > 32f)
				{
			...
			while (iVar5 <= 3)
			{
				if (func_297(Local_575[iVar5 /*12*/]))
				{
					if ((PED::IS_PED_IN_MELEE_COMBAT(Local_575[iVar5 /*12*/]) || PED::IS_PED_RESPONDING_TO_EVENT(Local_575[iVar5 /*12*/], 54)) || PED::IS_PED_RESPONDING_TO_EVENT(Local_575[iVar5 /*12*/], 41))
					{
						...
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_181);
						func_278(&(Local_575[iVar5 /*12*/]), 1, 0, 1);
					}
				}
				iVar5++;
			}
		...
		case 1:
			...
			else if (func_423(iLocal_348))
			{
				...
				if (iLocal_454 > 1)
				{
					if (func_34())
					{
						if (func_38(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) > 15f)
						{
							if (!bLocal_170)
							{
...
void func_39()//Position - 0x1E0F
{
	if ((((iLocal_157 != 7 && iLocal_157 != 10) && iLocal_157 != 8) && iLocal_157 != 10) && iLocal_157 != 9)
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (func_40(iLocal_348, 1126825984) || func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) < 7f)
			{
...
bool func_41(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x1ED7
{
	...
	uVar0 = func_42(&(Local_39[iVar4 /*4*/]), Var1, iParam1, &(Local_39[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_39[iVar4 /*4*/].f_3) < iParam4);
}

int func_42(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x1F98
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_45(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x21D3
{
	...
	{
		Var3 = { func_47(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_46(struct<3> Param0, struct<3> Param3)//Position - 0x2264
{
...
void func_51()//Position - 0x2335
{
	...
	{
		if ((func_56(iLocal_348, 1, 0, 0, 0) || func_52(iLocal_348, 1, 1116471296, 1126825984, 0, 0, 0, 0)) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_348, 1), 10f, 0))
		{
			if (func_34())
			{
...
int func_59(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x28C0
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_64(int iParam0, bool bParam1)//Position - 0x2A51
{
	...
	{
		func_224(&(Global_96440[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_67()//Position - 0x2CB0
{
	...
	{
		func_69(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
void func_82(var uParam0)//Position - 0x35ED
{
	...
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_87(&(uParam0->f_25[0 /*223*/][iVar1 /*74*/]));
		func_87(&(uParam0->f_25[1 /*223*/][iVar1 /*74*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_86(&(uParam0->f_2161));
	func_84(&(uParam0->f_2167));
	func_83(&(uParam0->f_2233));
}
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0x3E93
{
	...
	Global_68106[1 /*14*/] = { func_142(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_68106[1 /*14*/] = { func_142(iVar0, iParam1, uVar30[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_134(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_134(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_134(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_93(int iParam0, int iParam1, int iParam2)//Position - 0x404E
{
	...
	{
		if (!func_206(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x4115
{
	...
	if (iParam5 == 0)
	{
		Global_68106[1 /*14*/] = { func_142(iVar10, iParam1, iParam2) };
		if (!func_132(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_68106[1 /*14*/] = { func_142(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_68106[1 /*14*/] = { func_142(iVar10, 14, uVar27[iVar1]) };
							func_111(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
							func_125(14);
							if (Global_68105 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_134(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_134(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_134(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_125(iVar0);
						if (Global_68105 == 1)
						{
			...
			{
				Global_68106[1 /*14*/] = { func_142(iVar10, iVar0, func_101(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_68106[1 /*14*/] = { func_142(iVar10, 14, uVar67[iVar1]) };
			func_111(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
			func_125(14);
			if (Global_68105 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_134(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_134(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_134(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
{
	Global_68106[1 /*14*/] = { func_142(iParam0, iParam1, iParam2) };
...
int func_113(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F85
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_134(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_121(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7DDB
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_134(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_133(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x97C8
{
	...
	{
		if (!func_206(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_121(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_141(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[0], Global_97353.f_1729.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_141(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[1], Global_97353.f_1729.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_141(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[2], Global_97353.f_1729.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_140(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_140(Var16.f_2)] = func_121(iParam1, Var16.x, func_140(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
void func_144(int iParam0)//Position - 0xC607
{
	...
	func_145(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_28(14))
			{
				uVar0 = func_129(func_148(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_129(func_147(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
...
void func_151(int iParam0, int iParam1, int iParam2)//Position - 0xE911
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_145(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_145(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_145(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_134(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_145(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_206(int iParam0, int iParam1, int iParam2)//Position - 0x1FE7B
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_206(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_206(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_68106[2 /*14*/] = { func_142(iVar0, 14, iVar4) };
									if (Global_68106[2 /*14*/].f_12 == iVar3)
									{
										if (func_206(iParam0, 14, iVar4))
										{
											if (!func_99(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_68106[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_68106[2 /*14*/] = { func_142(iVar0, iVar2, iVar1) };
						if (!func_99(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_68106[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_134(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_134(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_213(int iParam0, int iParam1, int iParam2)//Position - 0x206E1
{
	...
	if (iParam0 != -1)
	{
		...
		func_214(&uVar32, Var0.f_3, Global_89999, iParam1, iParam2);
	}
}
...
void func_219()//Position - 0x21D95
{
	...
	{
		func_25();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_220(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_225(int iParam0, bool bParam1)//Position - 0x21EA4
{
	...
	if (Var0.f_22 != 0)
	{
		func_251(Var0.f_22, 0);
	}
	func_243(iParam0, Global_68514);
	if (!bParam1)
	{
...
{
	func_229(iParam0, 1);
	Global_97353.f_16828[iParam0 /*6*/].f_3 = func_228();
...
void func_266()//Position - 0x278AE
{
	...
	if (func_423(iLocal_348))
	{
		...
		{
			Var3 = { func_47(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) - ENTITY::GET_ENTITY_COORDS(iLocal_348, 1)) };
			Var6 = { ENTITY::GET_ENTITY_FORWARD_VECTOR(iLocal_348) };
			fVar9 = 0.25f;
			Var0 = { Var6 + Var3 - Var6 * Vector(fVar9, fVar9, fVar9) };
			ENTITY::SET_ENTITY_HEADING(iLocal_348, func_267(0f, 0f, 0f, Var0, 1));
		}
	}
}

float func_267(struct<2> Param0, float fParam2, struct<2> Param3, var uParam5, int iParam6)//Position - 0x27928
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_269(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, char* sParam8, char* sParam9, int iParam10, int iParam11, int iParam12)//Position - 0x27AF9
{
	...
	return func_270(&uVar0, &uVar11, iParam10, 0);
}
...
void func_277()//Position - 0x28101
{
	...
	while (iVar0 <= 1)
	{
		if (func_297(Local_575[iVar0 /*12*/]) && PED::IS_PED_RAGDOLL(Local_575[iVar0 /*12*/]))
		{
			TASK::CLEAR_PED_TASKS(Local_575[iVar0 /*12*/]);
			TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
			if (func_38(Local_575[iVar0 /*12*/], PLAYER::PLAYER_PED_ID(), 1) < func_38(Local_575[iVar0 /*12*/], iLocal_348, 1))
			{
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
			}
		...
		if (func_423(Local_575[iVar0 /*12*/]))
		{
			if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_575[iVar0 /*12*/]))
			{
				...
				func_278(&(Local_575[iVar0 /*12*/]), 1, 0, 1);
			}
		}
		iVar0++;
	}
	if (iLocal_625 == 0)
	{
		if (iLocal_657 > 114)
		{
			if (func_297(Local_575[2 /*12*/]) && func_297(Local_575[3 /*12*/]))
			{
				iVar1 = 2;
				while (iVar1 <= 3)
				{
	...
	else
	{
		...
		while (iVar2 <= 3)
		{
			if (func_297(Local_575[iVar2 /*12*/]) && PED::IS_PED_RAGDOLL(Local_575[iVar2 /*12*/]))
			{
				TASK::CLEAR_PED_TASKS(Local_575[iVar2 /*12*/]);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
				if (func_38(Local_575[iVar2 /*12*/], PLAYER::PLAYER_PED_ID(), 1) < func_38(Local_575[iVar2 /*12*/], iLocal_348, 1))
				{
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				}
			...
			if (func_423(Local_575[iVar2 /*12*/]))
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_575[iVar2 /*12*/]))
				{
					...
					func_278(&(Local_575[iVar2 /*12*/]), 1, 0, 1);
				}
			}
			iVar2++;
		}
...
void func_288(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x287BA
{
	func_289(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_289(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x287E4
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			else
			{
				...
				{
					if (func_293(iVar0, Param0, Param3, fParam6))
					{
						bVar1 = true;
					}
				}
...
int func_293(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x28D3E
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		if (((((((((((((((func_294(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var9) || func_294(Var18[0 /*3*/], Var18[1 /*3*/], Var9, Var15)) || func_294(Var18[0 /*3*/], Var18[1 /*3*/], Var12, Var15)) || func_294(Var18[0 /*3*/], Var18[1 /*3*/], Var6, Var12)) || func_294(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var9)) || func_294(Var18[1 /*3*/], Var18[3 /*3*/], Var9, Var15)) || func_294(Var18[1 /*3*/], Var18[3 /*3*/], Var12, Var15)) || func_294(Var18[1 /*3*/], Var18[3 /*3*/], Var6, Var12)) || func_294(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var9)) || func_294(Var18[3 /*3*/], Var18[2 /*3*/], Var9, Var15)) || func_294(Var18[3 /*3*/], Var18[2 /*3*/], Var12, Var15)) || func_294(Var18[3 /*3*/], Var18[2 /*3*/], Var6, Var12)) || func_294(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var9)) || func_294(Var18[2 /*3*/], Var18[0 /*3*/], Var9, Var15)) || func_294(Var18[2 /*3*/], Var18[0 /*3*/], Var12, Var15)) || func_294(Var18[2 /*3*/], Var18[0 /*3*/], Var6, Var12))
		{
			return 1;
		}
	}
...
int func_294(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x29034
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_298()//Position - 0x29184
{
	switch (iLocal_156)
	{
		...
		case 1:
			if (iLocal_361)
			{
				if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) < 4f)
				{
					TASK::CLEAR_PED_TASKS(iLocal_348);
			...
			else if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) > 5f)
			{
				TASK::CLEAR_PED_TASKS(iLocal_348);
				TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(iLocal_348, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0f, 3f, -1, 3f, 1);
				iLocal_361 = 1;
...
void func_299()//Position - 0x29352
{
	switch (iLocal_156)
	{
		case 0:
			...
			{
				iLocal_349 = func_301(iLocal_348, 1, 1, 5);
...
void func_302()//Position - 0x2942F
{
	...
	switch (iLocal_156)
	{
		...
		case 1:
			...
			{
				if (func_315() && func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) < 25f)
				{
					if (func_17(&uLocal_182, "FAN1AU", Local_428.x, 7, 0, 0, 0))
					{
						Local_428.f_2 = 1;
			...
			if (func_313(Local_428.x))
			{
				if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) > 30f)
				{
					func_15();
				}
			}
...
int func_303(char* sParam0, char* sParam1, bool bParam2, var uParam3)//Position - 0x2958D
{
	if (iLocal_347 == 0 && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (bParam2)
		{
			...
			if (func_304(&uLocal_182, "FAN1AU", sParam0, sParam1, 7, 0, 0))
			{
				return 1;
			}
		}
...
void func_305()//Position - 0x29658
{
	switch (iLocal_722)
	{
		...
		case 1:
			if (iLocal_708 >= 7)
			{
				if (func_7(iLocal_630))
				{
					if (func_297(iLocal_626) && func_297(iLocal_627))
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
		...
		case 2:
			if (func_297(iLocal_626) && func_297(iLocal_627))
			{
				...
				if (func_38(iLocal_627, iLocal_626, 1) < 2f)
				{
		...
		case 5:
			if (func_297(iLocal_626) && !PED::IS_PED_FLEEING(iLocal_626))
			{
				TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
			...
			if (func_297(iLocal_628) && !PED::IS_PED_FLEEING(iLocal_628))
			{
				TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
				TASK::TASK_PAUSE(0, 200);
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
			...
			if (func_297(iLocal_629) && !PED::IS_PED_FLEEING(iLocal_629))
			{
				TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
				TASK::TASK_PAUSE(0, 500);
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 80f, -1, 0, 0);
		...
		case 6:
			if (func_297(iLocal_626))
			{
				...
				TASK::TASK_TURN_PED_TO_FACE_ENTITY(0, PLAYER::PLAYER_PED_ID(), 0);
				TASK::TASK_LOOK_AT_ENTITY(0, iLocal_627, -1, 0, 2);
				if (func_38(iLocal_626, iLocal_627, 1) > 2f)
				{
...
void func_311()//Position - 0x2A547
{
	if (!func_423(Local_575[0 /*12*/]))
	{
		...
		if ((STREAMING::HAS_MODEL_LOADED(iLocal_624) && STREAMING::HAS_MODEL_LOADED(joaat("a_m_y_beach_01"))) && STREAMING::HAS_MODEL_LOADED(joaat("a_f_y_beach_01")))
		{
			...
			else if (func_297(Local_575[2 /*12*/]))
			{
			...
			else if (func_297(Local_575[3 /*12*/]))
			{
...
{
	if ((iLocal_347 == 0 && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !func_34())
	{
		return 1;
	}
	return 0;
...
void func_316()//Position - 0x2AAB2
{
	switch (iLocal_156)
	{
		case 0:
			...
			if (func_297(Local_548))
			{
				TASK::CLEAR_PED_TASKS(Local_548);
				func_278(&Local_548, 1, 0, 1);
			}
			if (func_7(Local_548.f_2))
			{
				func_322(&(Local_548.f_2));
			}
	...
	if (iLocal_167 == 0)
	{
		if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1827.53f, -538.1213f, 21.83124f, -1805.926f, -555.6239f, 31.77323f, 2f, 0, 1, 0))
		{
			if (iLocal_347 == 0)
			{
				...
				if (func_17(&uLocal_182, "FAN1AU", "FAN1_5", 7, 0, 0, 0))
				{
					iLocal_160 = 1;
					iLocal_167 = 1;
				}
			}
			Global_97353.f_16828.f_386 = 1;
		}
	}
}
...
{
	if ((!func_34() && iLocal_347 == 0) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_17(&uLocal_182, "FAN1AU", "FAN1_ONELIN", 7, 0, 0, 0))
		{
			iLocal_393++;
...
void func_321()//Position - 0x2AD3A
{
	if (iLocal_655 == 2)
	{
		if ((!func_34() && iLocal_347 == 0) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
		{
			if (func_17(&uLocal_182, "FAN1AU", "FAN1_TAUNT", 7, 0, 0, 0))
			{
				iLocal_393++;
				iLocal_394 = MISC::GET_GAME_TIMER();
			}
...
void func_323()//Position - 0x2ADBF
{
	...
	switch (iLocal_156)
	{
		case 0:
			...
			if (func_7(Local_562.f_2) && func_297(Local_562))
			{
			...
			if (func_315())
			{
				if (Local_418.f_2 == 0)
				{
					...
					if (iVar0 <= 52)
					{
						...
						{
							func_17(&uLocal_182, "FAN1AU", Local_418.x, 7, 0, 0, 0);
						}
						else
						{
							func_328(&uLocal_182, "FAN1AU", Local_418.x, "FAN1_RD1_3", 7, 0, 0);
						}
						Local_418.f_2 = 1;
					}
				}
				...
				if (func_423(iLocal_348))
				{
					...
					if (iVar4 != 0)
					{
						if ((iLocal_347 == 0 && iLocal_396 > 2000) && iLocal_395 < 5)
						{
							if (!func_34())
							{
								if (func_17(&uLocal_182, "FAN1AU", "FAN1_RD3", 7, 0, 0, 0))
								{
									iLocal_395++;
									iLocal_396 = MISC::GET_GAME_TIMER();
								}
...
{
	if ((func_297(Local_548.f_1) && func_7(Local_548.f_2)) && func_297(Local_548))
	{
		switch (iLocal_561)
		{
			case 0:
				...
				if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_548.f_2, 1), ENTITY::GET_ENTITY_COORDS(iLocal_348, 1), 1) <= 45f)
				{
					...
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(Local_548.f_2, 1), ENTITY::GET_ENTITY_COORDS(iLocal_348, 1), 1) <= 20f)
					{
						...
						if (iLocal_347 == 0)
						{
							...
							{
								if (func_17(&uLocal_182, "FAN1AU", Local_423.x, 9, 0, 0, 0))
								{
									Local_423.f_2 = 1;
						...
						else if (func_17(&uLocal_182, "FAN1AU", Local_423.x, 9, 1, 0, 0))
						{
							Local_423.f_2 = 1;
							func_33("Doing Mary Ann's anim...");
							TASK::TASK_PLAY_ANIM(iLocal_348, "rcmfanatic1yell", "yell_d", 8f, -8f, -1, 48, 0, 0, 0, 0);
			...
			case 6:
				if ((MISC::GET_GAME_TIMER() - iLocal_713) > 3000)
				{
					...
					func_278(&(Local_548.f_1), 1, 0, 1);
					func_278(&Local_562, 1, 0, 1);
					if (func_297(Local_562.f_1))
					{
						func_33("*** Clearing driveby task and releasing");
						TASK::CLEAR_PED_TASKS(Local_562.f_1);
						func_278(&(Local_562.f_1), 1, 0, 1);
					}
					func_322(&(Local_562.f_2));
				}
				break;
			}
	}
...
void func_329()//Position - 0x2B495
{
	...
	switch (iLocal_156)
	{
		case 0:
			...
			func_332(&uLocal_182, 3, iLocal_348, "MARYANN", 0, 1);
			func_258(1, 0, 1, 1);
			func_424(&Local_95, 0, 1);
			if (func_423(iLocal_348))
			{
		...
		case 1:
			if (!Global_97353.f_16828.f_384)
			{
				if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED())
				{
					func_50("FAN_HELP", -1);
					Global_97353.f_16828.f_384 = 1;
				}
			}
			if (iLocal_168 == 1)
			{
							...
							if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1798.076f, -468.2297f, 39.02536f, -1816.664f, -484.317f, 43.64211f, 12.5f, 0, 1, 0))
							{
								...
								if (func_303(Local_438.x, Local_438.f_1, 0, &(Local_413.f_4)))
								{
									if (Local_413.f_4 != -1)
									{
										...
										func_331("*** startRunConversation will restart on line: ", Local_413.f_4);
									}
									iLocal_160 = 1;
									iLocal_165 = 1;
									Local_438.f_2 = 1;
			...
			if (iLocal_165 == 1)
			{
				if (Local_443.f_2 == 0)
				{
					if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) < 10f)
					{
			...
			if (func_315())
			{
				...
				{
					func_17(&uLocal_182, "FAN1AU", Local_413, 7, 0, 0, 0);
				...
				else if (Local_413.f_3 == 1)
				{
					if (Local_443.f_2 == 1)
					{
						...
						if (func_328(&uLocal_182, "FAN1AU", Local_413, &Local_376, 7, 0, 0))
						{
							Local_413.f_3 = 0;
						}
					}
...
float func_330(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2B9E4
{
	struct<3> Var0;
...
void func_334()//Position - 0x2BE69
{
	if (func_423(iLocal_348))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Mary_Ann", joaat("ig_maryann")))
		{
			...
			if (bLocal_162)
			{
				func_335(iLocal_348, -1867.64f, -446.01f, 45.16f, 229.3557f, 0, 1);
			}
			TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
			TASK::TASK_SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(0, 1);
			TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
...
int func_335(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x2BF24
{
	bool bVar0;
	float fVar1;
...
void func_343()//Position - 0x2C2AD
{
	...
	switch (iLocal_156)
	{
		case 0:
			if (!func_436())
			{
				if (func_38(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) <= 1.2f)
				{
					if (func_34())
					{
						func_31();
					...
					if (func_423(iLocal_348))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 3))
						{
							if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(iLocal_348, "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base") < 0.1f)
							{
								...
								func_332(&uLocal_182, 3, iLocal_348, "MARYANN", 0, 1);
								func_332(&uLocal_182, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		...
		case 1:
			if (func_297(iLocal_348))
			{
				...
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_348, "rcmfanatic1", "ef_1_rcm_mary_ann_leadin", 3))
				{
					if (iLocal_161 == 0)
					{
						if (func_17(&uLocal_182, "FAN1AU", "FAN1_LDI", 8, 0, 0, 0))
						{
				...
				if (func_38(PLAYER::PLAYER_PED_ID(), iLocal_348, 1) <= 4f)
				{
		...
		if (!func_34())
		{
			if (Local_386.f_1 <= 3)
			{
				if (iLocal_391 == 0)
				{
					...
					{
						func_331("Said OvertakeLines #", Local_386.f_1);
						Local_386.f_1++;
						iLocal_390 = 0;
						iLocal_391 = 1;
						iLocal_389 = MISC::GET_GAME_TIMER();
...
int func_347(char* sParam0)//Position - 0x2C658
{
	if (iLocal_347 == 0 && !HUD::IS_MESSAGE_BEING_DISPLAYED())
	{
		if (func_17(&uLocal_182, "FAN1AU", sParam0, 7, 0, 0, 0))
		{
			return 1;
		}
	}
...
void func_348()//Position - 0x2C689
{
	if (func_297(iLocal_348))
	{
		...
		{
			if (!func_340(iLocal_348, 242628503) && !bLocal_170)
			{
				if (func_7(iLocal_448))
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_181);
		...
		func_359();
		if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) > 80f)
		{
			if (iLocal_360 == 0)
			{
				ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_348, 1);
		...
		if ((iLocal_157 != 8 && iLocal_157 != 7) && iLocal_157 != 9)
		{
			if (iLocal_347 != 1)
			{
				if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) > 25f)
				{
					func_358(1);
				}
			}
		...
		if (iLocal_347 != 0)
		{
			if (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) < 24f)
			{
				func_358(0);
			}
		}
...
void func_351(int iParam0)//Position - 0x2C9E1
{
	...
	fVar3 = func_267(Var0, Var4, 1);
	func_335(iLocal_348, Var0, fVar3, 1, 1);
	if (iParam0 < 6)
	{
		iLocal_709 = 1;
	}
...
void func_354()//Position - 0x2CC32
{
	...
	{
		TASK::WAYPOINT_RECORDING_GET_COORD(sLocal_654, iLocal_658 + 1, &Var0);
		if (func_330(PLAYER::PLAYER_PED_ID(), Var0, 1) < func_330(iLocal_348, Var0, 1))
		{
			func_356();
		}
		else
...
void func_355()//Position - 0x2CC91
{
	...
	fVar0 = (4.5f - (func_282(PLAYER::PLAYER_PED_ID(), iLocal_348) / 2f));
	if (fVar0 < 1.8f)
	{
		fVar0 = 1.8f;
	}
...
void func_357()//Position - 0x2CD5E
{
	...
	if (func_423(iLocal_348))
	{
		if (iLocal_655 == 2)
		{
			fVar0 = func_38(PLAYER::PLAYER_PED_ID(), iLocal_348, 1);
			if (fVar0 < 15f)
			{
				fVar1 = (fVar0 / 100f);
				if (fLocal_357 > 2.42f)
		...
		{
			fVar2 = func_38(PLAYER::PLAYER_PED_ID(), iLocal_348, 1);
			fVar3 = (fVar2 / 300f);
			if (fVar2 < 10f)
			{
...
void func_359()//Position - 0x2CEC5
{
	if (iLocal_347 == 2)
	{
		if (iLocal_366 < 2)
		{
			...
			{
				if (func_304(&uLocal_182, "FAN1AU", "FAN1_FALLB", sLocal_367[iLocal_366], 8, 0, 0))
				{
					iLocal_366++;
					iLocal_347 = 1;
	...
	else if (iLocal_347 == 3)
	{
		if (iLocal_370 < 2)
		{
			if ((Local_433.f_2 || Local_438.f_2) && iLocal_157 == 2)
			{
				if (iLocal_392 == 0)
				{
					if (func_17(&uLocal_182, "FAN1AU", "FAN1_CATCHC", 8, 0, 0, 0))
					{
						iLocal_392 = 1;
						iLocal_165 = 0;
					}
					...
					if (uVar0[0] == iLocal_348)
					{
						...
						if (!func_34())
						{
							if (Local_380.f_1 <= 3)
							{
								...
								{
									func_331("Saying MikePushMALine #", Local_380.f_1);
									Local_380.f_1++;
								}
							}
						}
						...
						if (!PED::IS_PED_IN_ANY_VEHICLE(uVar0[0], 0))
						{
							...
							if (!func_34())
							{
								if (Local_383.f_1 <= 3)
								{
									...
									{
										func_331("Said MikePushPedLine #", Local_383.f_1);
										Local_383.f_1++;
									}
								}
							}
		...
		if (iLocal_157 < 8 && iLocal_157 > 1)
		{
			...
			if (iLocal_657 > iLocal_658)
			{
				if (iLocal_655 != 1)
				{
					...
					{
						func_331("Can't do overtake line, overtake timer is = ", (MISC::GET_GAME_TIMER() - iLocal_389));
					}
				}
			}
			else if (iLocal_657 < iLocal_658)
...
void func_365(var uParam0, char* sParam1, var uParam2, int iParam3, var uParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2D589
{
	...
	if (iVar0 > -1)
	{
		...
		Global_1328872.f_3132.f_138[iVar0] = uParam2;
...
void func_378()//Position - 0x2DDF9
{
	...
	if (iLocal_708 < iLocal_676)
	{
		...
		{
			if (func_330(PLAYER::PLAYER_PED_ID(), Local_668, 1) < 4f)
			{
				if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (iLocal_673 != 0)
...
void func_382()//Position - 0x2E421
{
	...
	{
		if (func_330(iLocal_348, Local_668, 1) < 3f)
		{
...
void func_383()//Position - 0x2E460
{
	...
	if (iLocal_657 < iLocal_658)
	{
		...
		else if (Local_174.f_1 == 0 && !func_386(Local_176, 0, 0))
		{
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_390(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_391(iVar2), 8);
					break;
			}
			break;
...
{
	if (((!func_401(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_403(iParam0, Global_34913);
}
...
void func_404(int iParam0)//Position - 0x2F074
{
	...
	switch (iParam0)
	{
		...
		case 4:
			...
			if (func_407(1))
			{
				func_17(&uLocal_182, "FAN1AU", "FAN1_BCHB", 7, 0, 0, 0);
			}
			else
			{
				func_17(&uLocal_182, "FAN1AU", "FAN1_BCHA", 7, 0, 0, 0);
			}
			func_350(5, 1);
			break;
...
void func_422(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x308F1
{
	if (func_436())
	{
...
int func_427(var uParam0)//Position - 0x30AE3
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			func_434(&(uParam0->f_48), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			{
				if (func_428(&(uParam0->f_28[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_428(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x30C40
{
...
int func_429(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x30C9B
{
	int iVar0;
...
void func_437()//Position - 0x30E7A
{
	...
	func_278(&Local_548, 1, 0, 1);
	if (func_423(Local_548.f_1))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_548.f_1, 3, 1);
		func_278(&(Local_548.f_1), 1, 0, 1);
	}
	func_322(&(Local_548.f_2));
	func_278(&iLocal_648, 1, 0, 1);
...
{
	func_278(&iLocal_626, 1, 0, 1);
	func_278(&iLocal_627, 1, 0, 1);
	func_278(&iLocal_628, 1, 0, 1);
	func_278(&iLocal_629, 1, 0, 1);
...
int func_451(char* sParam0, int iParam1, int iParam2)//Position - 0x3144D
{
	...
	if (func_457())
	{
		...
		{
			iVar33 = func_452(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_453()//Position - 0x31639
{
	...
	iVar0 = func_454(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_457()//Position - 0x3170D
{
	...
	{
		if (func_452(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_470(&(uParam0->f_28));
	func_470(&(uParam0->f_35));
	func_470(&(uParam0->f_41));
}
