...
void __EntryFunction__()//Position - 0x0
{
	...
	while (!func_47(&uLocal_40) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		func_50();
		func_53(PLAYER::PLAYER_PED_ID());
		SYSTEM::WAIT(0);
	}
	if (func_53(PLAYER::GET_PLAYERS_LAST_VEHICLE()))
	{
	...
	SYSTEM::WAIT(0);
	func_15();
	if (func_53(PLAYER::PLAYER_PED_ID()) && func_53(Local_867.f_9))
	{
	...
	if (func_53(PLAYER::PLAYER_PED_ID()))
	{
		...
		func_14(&Local_892, Var1, ENTITY::GET_ENTITY_ROTATION(Local_867.f_9, 2), 50f, Local_892.f_20, Local_892.f_21, 3, 1101004800, 0, 0, -1082130432, 0);
		CAM::ATTACH_CAM_TO_ENTITY(Local_892, PLAYER::PLAYER_PED_ID(), 0f, 0f, 0.5f, 1);
	}
	SYSTEM::WAIT(0);
	if (func_53(PLAYER::PLAYER_PED_ID()) && func_53(Local_879.f_9))
	{
		func_12(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(Local_879.f_9, 1), &fVar10, &fVar11, 1);
...
void func_1(int iParam0, bool bParam1)//Position - 0x769
{
...
void func_2()//Position - 0x79B
{
	Global_17098.f_6 = 1;
}

float func_3(struct<3> Param0, struct<3> Param3)//Position - 0x7A9
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_4(struct<3> Param0)//Position - 0x7CA
{
	float fVar0;
	float fVar1;
...
float func_7(float fParam0, float fParam1, float fParam2)//Position - 0x95D
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_8(char* sParam0, int iParam1)//Position - 0x984
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

void func_9(var uParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4, float fParam5, bool bParam6)//Position - 0x99B
{
	int iVar0[4];
	float fVar5;
	float fVar6;
	...
	{
		uParam0->f_14 = (uParam0->f_14 + func_7((((Var10.x - uParam0->f_14) * 0.05f) * fVar9), -3f, 3f));
...
int func_10(int iParam0, int iParam1, int iParam2)//Position - 0xE44
{
	if (iParam0 > iParam2)
	{
		return iParam2;
...
void func_11(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xE69
{
...
void func_12(struct<3> Param0, struct<3> Param3, var uParam6, var uParam7, int iParam8)//Position - 0xF6D
{
	struct<3> Var0;
...
void func_13(struct<3> Param0, var uParam3, var uParam4, int iParam5)//Position - 0xF90
{
	float fVar0;
...
void func_14(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7, var uParam8, var uParam9, int iParam10, int iParam11, int iParam12, int iParam13, float fParam14, bool bParam15)//Position - 0x1035
{
	uParam0->f_1 = { Param1 };
	uParam0->f_4 = { Param4 };
	uParam0->f_7 = fParam7;
...
void func_16(int iParam0, int iParam1)//Position - 0x1152
{
	...
	func_12(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(iParam1, 1), &uVar0, &uVar1, 1);
...
void func_20(bool bParam0)//Position - 0x146B
{
	if (bParam0)
	{
		func_25();
...
void func_21(int iParam0)//Position - 0x14CE
{
	if (Global_14551)
	{
		func_23(0, 0);
...
void func_23(bool bParam0, bool bParam1)//Position - 0x1565
{
	if (bParam0)
	{
		if (func_24(0))
...
int func_24(int iParam0)//Position - 0x15D9
{
	if (iParam0 == 1)
	{
...
void func_30(int iParam0)//Position - 0x29EF
{
	if (iParam0 > 0)
	{
	}
...
int func_34(struct<3> Param0)//Position - 0x2E8F
{
...
int func_35(int iParam0, int iParam1, bool bParam2)//Position - 0x2EB9
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_36(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x2F2A
{
...
int func_37()//Position - 0x2FFE
{
	func_38();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_38()//Position - 0x3017
{
	int iVar0;
...
bool func_39(int iParam0)//Position - 0x3114
{
	return Global_34913 == iParam0;
}

bool func_40(int iParam0)//Position - 0x3122
{
	return iParam0 < 3;
}

int func_41(int iParam0)//Position - 0x312E
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0)//Position - 0x316B
{
	if (func_40(iParam0))
	{
...
int func_43(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3195
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_44(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x348B
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_45(int iParam0)//Position - 0x353F
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
...
bool func_47(var uParam0)//Position - 0x3601
{
	int iVar0;
	int iVar1;
...
int func_48(var uParam0, int iParam1)//Position - 0x3675
{
...
int func_49(var uParam0, int iParam1)//Position - 0x387A
{
...
int func_51(var uParam0, int iParam1, int iParam2)//Position - 0x3A67
{
	if (MISC::IS_BIT_SET(uParam0->f_113, iParam1) || MISC::IS_BIT_SET(uParam0->f_114, iParam1))
	{
		return 1;
...
void func_52(var uParam0)//Position - 0x3AB6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
bool func_53(int iParam0)//Position - 0x3ADB
{
...
void func_54(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x3AF8
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_57(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_55(int iParam0, bool bParam1)//Position - 0x3CAE
{
...
int func_56(int iParam0)//Position - 0x3CEA
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
...
Vector3 func_57(var uParam0)//Position - 0x3D0A
{
...
int func_58(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3D1D
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_68(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_68(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_68(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_99(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_68(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_68(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_68(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_60(int iParam0)//Position - 0x4597
{
	switch (iParam0)
	{
...
void func_61(int iParam0, int iParam1, int iParam2)//Position - 0x45D2
{
	int iVar0;
	int iVar1;
...
int func_62(int iParam0, int iParam1, int iParam2)//Position - 0x465C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_63(int iParam0, int iParam1, int iParam2)//Position - 0x473A
{
	Global_68106[1 /*14*/] = { func_108(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_64(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4764
{
	var uVar0;
	int iVar10;
...
int func_65(int iParam0, int iParam1, int iParam2)//Position - 0x4D5F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_68(int iParam0)//Position - 0x4F2F
{
	switch (iParam0)
	{
		case 0:
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4FDF
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5E99
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x617D
{
	int iVar0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6444
{
	int iVar0;
	int iVar1;
...
int func_74(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x647B
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x64A4
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x676E
{
	int iVar0;
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x69F8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_78(var uParam0, var uParam1, int iParam2, var uParam3)//Position - 0x6B4F
{
	if (iParam2 == -1)
	{
...
struct<10> func_79(int iParam0, int iParam1)//Position - 0x6B78
{
	int iVar0;
	struct<10> Var1;
...
void func_80(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x74A7
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
int func_81(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x75D1
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_68(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_82(int iParam0, int iParam1)//Position - 0x76B1
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_83(int iParam0)//Position - 0x7A58
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_84(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7AB9
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_85(int iParam0, int iParam1)//Position - 0x7B01
{
	int iVar0;
	struct<16> Var1;
...
void func_86(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9947
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					...
					{
						(*iParam0)[func_87(Var16.f_2)] = func_81(iParam1, Var16.x, func_87(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_87(int iParam0)//Position - 0x9AF8
{
	switch (iParam0)
	{
		case 0:
...
void func_88(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9BA8
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
int func_89(int iParam0, int iParam1, int iParam2)//Position - 0x9C19
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 3), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 1, 3), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 4), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 1, 4), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9E3C
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_68(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_91(int iParam0, int iParam1, int iParam2)//Position - 0x9F36
{
	var uVar0;
	var uVar1;
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0xA32B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 3), joaat("GLASSES"), 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_90(iParam0, iParam2, 14, 4), joaat("GLASSES"), 1);
				}
			}
			break;
	}
...
int func_93(int iParam0, int iParam1)//Position - 0xA60A
{
	int iVar0;
	int iVar1;
...
int func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA650
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_95(int iParam0, int iParam1)//Position - 0xA74C
{
	int iVar0;
...
int func_96(int iParam0)//Position - 0xA88A
{
	switch (iParam0)
	{
		case 0:
...
int func_97(int iParam0, int iParam1)//Position - 0xA910
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_98(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA970
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_99(int iParam0)//Position - 0xA9F4
{
...
void func_100(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xAAAC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAAF5
{
	int iVar0;
...
int func_102(var uParam0)//Position - 0xAB20
{
	int iVar0;
	int iVar1;
...
int func_103()//Position - 0xAB54
{
	return Global_1312737;
}

int func_104(int iParam0, int iParam1, int iParam2)//Position - 0xAB60
{
	int iVar0;
	var uVar1;
...
bool func_105(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xAB92
{
	int iVar0;
...
int func_106(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xB233
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_107(int iParam0)//Position - 0xC152
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_108(int iParam0, int iParam1, int iParam2)//Position - 0xC1A3
{
	func_171();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_109(int iParam0, int iParam1)//Position - 0xC1F5
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0)//Position - 0xC2E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xD55B
{
	var uVar0;
	int iVar1;
...
bool func_112(int iParam0, int iParam1, var uParam2)//Position - 0xD8DE
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_113(int iParam0, int iParam1)//Position - 0xDCE3
{
	switch (iParam1)
	{
		case 0:
...
int func_114(int iParam0, int iParam1)//Position - 0xE0DE
{
	switch (iParam1)
	{
		case 0:
...
int func_115(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE4D9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_116(int iParam0)//Position - 0xE51B
{
	switch (iParam0)
	{
		case -1:
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xE5EF
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_68(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
...
void func_118(int iParam0)//Position - 0xE86A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0xE9C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0xEECD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0xEF41
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0xEFB4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0xF09A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0xF3FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0xF60C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0xF83B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xF94A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0x102EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0x10E5D
{
	if (iParam0 < 136)
	{
		func_131(iParam0);
...
void func_130(int iParam0)//Position - 0x10E91
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x11A95
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x129A3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x12ACF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0, int iParam1)//Position - 0x12BCC
{
	switch (iParam0)
	{
		case 0:
...
void func_135(int iParam0)//Position - 0x12CBC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x141AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x142FD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x14807
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x14E74
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x14EE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x14FB6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x154E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x1567B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x15E78
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x15F87
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x16EB1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x17B6D
{
	if (iParam0 < 107)
	{
		func_150(iParam0);
...
void func_148(int iParam0)//Position - 0x17BB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x18659
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x19448
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1A091
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x1A309
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0, int iParam1)//Position - 0x1A44E
{
	switch (iParam0)
	{
		case 0:
...
void func_154(int iParam0)//Position - 0x1A53E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1B2C7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1B440
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x1B9B6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x1BEDF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1BF52
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1C021
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1C4F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1C760
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1CA35
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1CBFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1D750
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1E399
{
	if (iParam0 < 60)
	{
		func_168(iParam0);
...
void func_167(int iParam0)//Position - 0x1E3CD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1F16D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1F7F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1F8DF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171()//Position - 0x1F9DC
{
...
int func_172(int iParam0, int iParam1, int iParam2)//Position - 0x1FA55
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_68(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_68(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_173(bool bParam0)//Position - 0x1FCAD
{
	var uVar0;
...
void func_174(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1FCE9
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_175(PLAYER::PLAYER_ID()))
		{
...
int func_175(int iParam0)//Position - 0x1FDBA
{
...
bool func_176()//Position - 0x1FDFB
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_177(int iParam0, int iParam1)//Position - 0x1FE0C
{
	bool bVar0;
...
int func_178(int iParam0, bool bParam1)//Position - 0x1FE57
{
	int iVar0;
	int iVar1;
...
int func_179(int iParam0, var uParam1, var uParam2)//Position - 0x1FE98
{
	int iVar0;
...
void func_180(int iParam0)//Position - 0x1FEC9
{
	if (iParam0 == 1)
	{
...
void func_182(var uParam0)//Position - 0x20021
{
	int iVar0;
...
int func_183(var uParam0, int iParam1)//Position - 0x20046
{
...
int func_184(int iParam0, int iParam1, int iParam2)//Position - 0x20239
{
...
int func_185(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x20282
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_186(bool bParam0)//Position - 0x20881
{
	int iVar0;
	int iVar1;
...
void func_187(int iParam0)//Position - 0x20B03
{
	int iVar0;
...
void func_188(int iParam0)//Position - 0x20B5D
{
	bool bVar0;
	char cVar1[64];
	...
	else if (MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_190() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_97353.f_23789.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_190() /*8053*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
...
char* func_189(int iParam0)//Position - 0x20C1F
{
	switch (iParam0)
	{
		case 0:
...
void func_191(int iParam0)//Position - 0x20CA6
{
	func_208(93, iParam0);
	func_208(29, iParam0);
	func_208(30, iParam0);
...
bool func_192(int iParam0)//Position - 0x20CC6
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0);
	}
	return MISC::IS_BIT_SET(Global_2097152[func_190() /*8053*/].f_5756.f_10, iParam0);
}

int func_193(bool bParam0)//Position - 0x20D02
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_194(int iParam0, int iParam1)//Position - 0x20DB9
{
	if (iParam0 >= 61)
	{
		return 0;
...
int func_195(int iParam0, int iParam1)//Position - 0x20DD4
{
...
int func_196(var uParam0, int iParam1)//Position - 0x20E58
{
	int iVar0;
	var uVar1[61];
...
int func_197(var uParam0, int iParam1)//Position - 0x20EDE
{
	int iVar0;
...
bool func_198(var uParam0, int iParam1)//Position - 0x20F2E
{
	return (*uParam0)[iParam1] == 61;
}

void func_199(var uParam0)//Position - 0x20F3F
{
	int iVar0;
...
void func_200(var uParam0, float fParam1)//Position - 0x20F76
{
...
float func_201(bool bParam0)//Position - 0x20FA4
{
	var uVar0;
...
void func_202(var uParam0, int iParam1)//Position - 0x20FEC
{
	(*uParam0)[iParam1] = 61;
}

bool func_203(var uParam0, int iParam1)//Position - 0x20FFC
{
	return func_204(uParam0, iParam1) != -1;
}

int func_204(var uParam0, int iParam1)//Position - 0x2100E
{
	int iVar0;
...
bool func_205(var uParam0)//Position - 0x2103B
{
	return uParam0->f_68 == 1;
}

int func_206(int iParam0, int iParam1)//Position - 0x21049
{
	int iVar0;
...
void func_207(int iParam0, int iParam1)//Position - 0x2109A
{
	int iVar0;
...
void func_208(int iParam0, int iParam1)//Position - 0x210BD
{
	int iVar0;
...
void func_209()//Position - 0x2111A
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0x21236
{
	if (func_56(uParam0))
	{
		if (!PED::IS_PED_INJURED(uParam0))
...
void func_214(var uParam0, bool bParam1)//Position - 0x213CD
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_215(int iParam0)//Position - 0x21408
{
	if (*iParam0 != -1)
	{
...
void func_216(var uParam0, int iParam1, bool bParam2)//Position - 0x21429
{
	if (CAM::DOES_CAM_EXIST(*uParam0))
	{
		if (bParam2)
...
void func_217(int iParam0, int iParam1, int iParam2)//Position - 0x214C3
{
	bool bVar0;
...
void func_218()//Position - 0x215AB
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	{
		func_206(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
	if (!DATAFILE::DATAFILE_IS_SAVE_PENDING())
	{
		if (!Global_68245)
		{
			if (func_221() == 2 == 0 && !NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
			{
...
bool func_220(bool bParam0)//Position - 0x21AB7
{
...
int func_221()//Position - 0x21AE2
{
	return Global_24444;
}

int func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21AED
{
	int iVar0;
	int iVar1;
	var uVar2;
