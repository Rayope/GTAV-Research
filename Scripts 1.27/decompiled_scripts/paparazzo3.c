...
int func_222(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x256B4
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_226(struct<3> Param0, struct<3> Param3)//Position - 0x25980
{
...
int func_235(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x25D45
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_217(Local_84.f_28[0]))
	{
...
void func_254(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x26866
{
	func_255(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_255(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2688F
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_259(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x26DE8
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_260(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x270DE
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_278()//Position - 0x2826D
{
	...
	switch (iLocal_83)
	{
		case 0:
			...
			if (func_216(Local_84.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
			{
...
void func_287()//Position - 0x287C1
{
	...
	func_295(&uLocal_162, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
...
int func_290(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x289BB
{
	bool bVar0;
	float fVar1;
...
{
	if (func_217(Local_84.f_28[0]) && ENTITY::DOES_ENTITY_EXIST(iLocal_147))
	{
		uLocal_331 = PED::CREATE_SYNCHRONIZED_SCENE(Local_332, Local_335, 2);
		TASK::TASK_SYNCHRONIZED_SCENE(Local_84.f_28[0], uLocal_331, sLocal_160, "leadout_pap_3_rcm_beverly", 1000f, -8f, 4, 32, 1148846080, 0);
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_147))
...
{
	if (((!func_316(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_320(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x298D8
{
	int iVar0;
...
int func_321(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x29A60
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
...
void func_355(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2E2A6
{
	int iVar0;
...
void func_357(struct<54> Param0, var uParam54)//Position - 0x2E46B
{
...
bool func_361(struct<3> Param0, struct<3> Param3)//Position - 0x2FCA6
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_362(struct<3> Param0, float fParam3)//Position - 0x2FCCF
{
	return func_363(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_363(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2FCE9
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_365(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x30058
{
	int iVar0;
	var uVar1[3];
	int iVar5;
...
int func_366(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x3025E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_380(var uParam0)//Position - 0x30945
{
	...
	switch (iLocal_78)
	{
		...
		case 1:
			if (!func_385(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar30))
			{
				return 0;
			}
			iLocal_78 = 2;
		...
		case 2:
			...
			if (func_216(uParam0->f_28[0]))
			{
				...
				{
					func_381(&(uParam0->f_41[3]), iVar0[1], ENTITY::GET_OFFSET_FROM_ENTITY_IN_WORLD_COORDS(uParam0->f_28[0], 0f, 0f, 2.5f), 0f);
...
void func_381(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0x30E83
{
	func_249(uParam0);
...
int func_382(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x30EAA
{
...
int func_383(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0x30F05
{
	int iVar0;
