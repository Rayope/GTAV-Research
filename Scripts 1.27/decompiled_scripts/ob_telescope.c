		...
		if (ENTITY::DOES_ENTITY_EXIST(iLocal_76))
		{
			...
			if (BRAIN::IS_OBJECT_WITHIN_BRAIN_ACTIVATION_RANGE(iLocal_76))
			{
				switch (iLocal_51)
				{
					...
					case 1:
						if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && func_290())
						{
							func_4();
						}
...
int func_2(int iParam0)//Position - 0x274
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_3(int iParam0)//Position - 0x295
{
	int iVar0;
...
void func_4()//Position - 0x2DE
{
	...
	else
	{
		...
		if (MISC::IS_BIT_SET(Global_97353.f_7341.f_99.f_217[iVar3], iVar4))
		{
			return;
		}
	}
	...
	switch (iLocal_52)
	{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var0, (Var5.x * 2f), (Var5.f_1 * 2f), Var5.f_2, 0, 1, 0))
				{
					if (INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_76))
					{
						...
						if (bLocal_64)
						{
							if (!func_288("TELECSH"))
							{
								if (func_282(func_283()) > 0 || MISC::GET_GAME_TIMER() < (iLocal_55 + 60000))
								{
									iLocal_52 = 1;
								}
							}
		...
		case 1:
			...
			if (func_281(1, 0, 1) && func_278(PLAYER::PLAYER_ID()))
			{
				...
				if ((((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var0, Var5.x, Var5.f_1, Var5.f_2, 0, 1, 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0)) && func_276(Var0)) && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == INTERIOR::GET_INTERIOR_FROM_ENTITY(iLocal_76)) && func_275()) && func_274()) && !bLocal_102)
				{
					if ((func_271() || MISC::GET_GAME_TIMER() < (iLocal_55 + 60000)) || !bLocal_64)
					{
						if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID()))
						{
							...
							if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Var0, Var5, 0, 1, 0) && !func_269(8, -1)) && !func_268())
							{
								if (iLocal_54 == -1)
								{
								...
								if (func_264(iLocal_54, 1))
								{
									...
									else
									{
										...
										func_245();
										func_241(PLAYER::PLAYER_ID(), 0, 66048, 1);
										Global_2446554.f_4379 = 1;
									}
									if (CAM::GET_FOLLOW_PED_CAM_VIEW_MODE() == 4)
									{
										PED::SET_PED_DESIRED_HEADING(PLAYER::PLAYER_PED_ID(), func_240(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iLocal_76, 1)));
		...
		case 2:
			if (func_278(PLAYER::PLAYER_ID()))
			{
				...
				if (Global_68245)
				{
					...
					if (func_82(ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()), 14, func_263(PLAYER::PLAYER_PED_ID(), 14, 0)))
					{
						PED::CLEAR_PED_PROP(PLAYER::PLAYER_PED_ID(), 0);
					}
					func_50(PLAYER::PLAYER_PED_ID(), 4, -1, -1);
					if (func_49(PLAYER::PLAYER_PED_ID(), 7))
					{
				...
				else if (SYSTEM::TIMERA() > 2500)
				{
					...
					{
						func_44();
						func_241(PLAYER::PLAYER_ID(), 1, 0, 1);
						func_262(0, 0, 1);
...
void func_5(char* sParam0)//Position - 0xE2D
{
...
int func_7(int iParam0, int iParam1, int iParam2)//Position - 0xEAE
{
...
int func_8(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xEF7
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_9(bool bParam0)//Position - 0x14F6
{
	int iVar0;
	int iVar1;
...
void func_10(int iParam0)//Position - 0x1778
{
	int iVar0;
...
void func_11(int iParam0)//Position - 0x17D2
{
	bool bVar0;
	char cVar1[64];
	...
	else if (MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_13() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_97353.f_23789.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_13() /*8053*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
		StringCopy(&cVar1, "CHAR_LIFEINVADER", 64);
		HUD::BEGIN_TEXT_COMMAND_THEFEED_POST("COUP_RED");
		HUD::ADD_TEXT_COMPONENT_SUBSTRING_TEXT_LABEL(func_12(iParam0));
		HUD::END_TEXT_COMMAND_THEFEED_POST_MESSAGETEXT(&cVar1, &cVar1, 1, 0, "", 0);
	}
}

char* func_12(int iParam0)//Position - 0x1895
{
	switch (iParam0)
	{
		case 0:
...
void func_14(int iParam0)//Position - 0x191D
{
	func_31(93, iParam0);
	func_31(29, iParam0);
	func_31(30, iParam0);
...
bool func_15(int iParam0)//Position - 0x193D
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0);
	}
	return MISC::IS_BIT_SET(Global_2097152[func_13() /*8053*/].f_5756.f_10, iParam0);
}

int func_16(bool bParam0)//Position - 0x1979
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_17(int iParam0, int iParam1)//Position - 0x1A30
{
	if (iParam0 >= 61)
	{
		return 0;
...
int func_18(int iParam0, int iParam1)//Position - 0x1A4B
{
...
int func_19(var uParam0, int iParam1)//Position - 0x1ACF
{
	int iVar0;
	var uVar1[61];
...
int func_20(var uParam0, int iParam1)//Position - 0x1B55
{
	int iVar0;
...
bool func_21(var uParam0, int iParam1)//Position - 0x1BA5
{
	return (*uParam0)[iParam1] == 61;
}

void func_22(var uParam0)//Position - 0x1BB6
{
	int iVar0;
...
void func_23(var uParam0, float fParam1)//Position - 0x1BED
{
...
float func_24(bool bParam0)//Position - 0x1C1B
{
	int iVar0;
...
void func_25(var uParam0, int iParam1)//Position - 0x1C63
{
	(*uParam0)[iParam1] = 61;
}

bool func_26(var uParam0, int iParam1)//Position - 0x1C73
{
	return func_27(uParam0, iParam1) != -1;
}

int func_27(var uParam0, int iParam1)//Position - 0x1C85
{
	int iVar0;
...
bool func_28(var uParam0)//Position - 0x1CB2
{
	return uParam0->f_68 == 1;
}

int func_29(int iParam0, int iParam1)//Position - 0x1CC0
{
	int iVar0;
...
void func_30(int iParam0, int iParam1)//Position - 0x1D11
{
	int iVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x1D34
{
	int iVar0;
...
void func_33(int iParam0, int iParam1, var uParam2, bool bParam3, bool bParam4)//Position - 0x1E06
{
	int iVar0;
...
int func_34(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7)//Position - 0x209E
{
	bool bVar0;
	int iVar1;
	bool bVar2;
...
void func_35(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4)//Position - 0x2212
{
	switch (iParam1)
	{
		case 1704445500:
...
void func_36(int iParam0)//Position - 0x2249
{
	bool bVar0;
	struct<69> Var1;
...
int func_37(int iParam0)//Position - 0x22AA
{
...
void func_38(int iParam0, var uParam1)//Position - 0x22D2
{
	Global_2437132 = uParam1;
	Global_2437131 = iParam0;
}

int func_39(int iParam0, var uParam1, var uParam2, var uParam3, int iParam4, var uParam5, bool bParam6, var uParam7, var uParam8)//Position - 0x22E6
{
	int iVar0;
...
int func_40()//Position - 0x23BA
{
	return Global_1312737;
}

int func_41()//Position - 0x23C6
{
...
void func_42(int iParam0, int iParam1, int iParam2, float fParam3)//Position - 0x23DA
{
	int iVar0;
	int iVar1;
	float fVar2;
...
void func_43(int iParam0, bool bParam1)//Position - 0x245D
{
	if (bParam1)
	{
	}
...
void func_44()//Position - 0x246E
{
	Global_2422140.f_600.f_10 = 0;
}

void func_45()//Position - 0x2480
{
	Global_17098.f_6 = 1;
}
...
int func_47(int iParam0, bool bParam1)//Position - 0x2593
{
	struct<4> Var0;
	bool bVar17;
...
int func_48(int iParam0)//Position - 0x25F6
{
	int iVar0;
	int iVar1;
...
int func_49(int iParam0, int iParam1)//Position - 0x26A0
{
	int iVar0;
...
void func_51(bool bParam0, bool bParam1)//Position - 0x28F0
{
...
void func_52(bool bParam0)//Position - 0x2950
{
	func_53(192, bParam0, -1, 1);
}

void func_53(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2962
{
	int iVar0;
...
int func_54(var uParam0)//Position - 0x2994
{
	int iVar0;
	int iVar1;
...
int func_55()//Position - 0x29C8
{
	return 1;
	return 0;
}

void func_56(int iParam0)//Position - 0x29D5
{
...
void func_57(int iParam0, int iParam1)//Position - 0x29EC
{
	struct<10> Var0;
	int iVar10;
	int iVar11;
...
void func_58(int iParam0, int iParam1, bool bParam2)//Position - 0x2B2C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_59(var uParam0, int iParam1, bool bParam2)//Position - 0x2C61
{
	float fVar0;
...
void func_60(int iParam0, var uParam1, var uParam2)//Position - 0x2CA0
{
	int iVar0;
...
int func_61(int iParam0, int iParam1)//Position - 0x2CC1
{
	var uVar0;
	var uVar1;
...
int func_62(int iParam0)//Position - 0x2CEC
{
	switch (iParam0)
	{
		case 2:
...
int func_63(int iParam0)//Position - 0x2D38
{
	switch (iParam0)
	{
		case 2:
...
int func_64(int iParam0, int iParam1)//Position - 0x2D84
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_65(int iParam0, int iParam1, int iParam2)//Position - 0x2FAF
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_66(int iParam0)//Position - 0x2FF5
{
	int iVar0;
...
int func_67(int iParam0, int iParam1)//Position - 0x316F
{
	int iVar0;
...
int func_68(int iParam0)//Position - 0x32C1
{
	switch (iParam0)
	{
		case 3:
...
int func_69(int iParam0)//Position - 0x3360
{
	switch (iParam0)
	{
		case 3:
...
int func_70(int iParam0)//Position - 0x340C
{
	switch (iParam0)
	{
		case 0:
...
float func_71(int iParam0, int iParam1)//Position - 0x34A3
{
	var uVar0;
	var uVar1;
...
int func_72(int iParam0)//Position - 0x34CE
{
	switch (iParam0)
	{
		case 0:
...
float func_73(int iParam0, int iParam1)//Position - 0x35BA
{
	var uVar0;
	var uVar1;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x35E6
{
	int iVar0;
	var uVar1;
...
int func_75(int iParam0, int iParam1)//Position - 0x3618
{
	var uVar0;
	var uVar1;
...
bool func_76()//Position - 0x3644
{
	return Global_1315874;
}

int func_77(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0x3650
{
	struct<5> Var0;
	struct<5> Var17;
	bool bVar34;
...
int func_79(var uParam0, int iParam1, int iParam2)//Position - 0x66D7
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_80()//Position - 0x6812
{
	return Global_2428891.f_5516;
}

int func_81(int iParam0)//Position - 0x6821
{
	if (iParam0 <= -1)
	{
		return -1;
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x683E
{
	switch (iParam0)
	{
		case joaat("mp_m_freemode_01"):
			...
			{
				case 14:
					if ((iParam2 >= 131 && iParam2 <= 154) || (iParam2 >= 327 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 3), joaat("HELMET"), 1)))
					{
						return 1;
					}
					break;
		...
		case joaat("mp_f_freemode_01"):
			...
			{
				case 14:
					if ((iParam2 >= 131 && iParam2 <= 154) || (iParam2 >= 327 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 4), joaat("HELMET"), 1)))
					{
						return 1;
					}
					break;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x68F8
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_85(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_84(int iParam0, int iParam1)//Position - 0x69F2
{
	switch (iParam0)
	{
...
int func_85(int iParam0)//Position - 0x6D99
{
	switch (iParam0)
	{
		case 0:
...
int func_86(int iParam0)//Position - 0x6E49
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, bool bParam11)//Position - 0x6EAA
{
		...
		while (iVar0 <= 14)
		{
			if (uVar15[iVar0] != -99)
			{
				if (iVar0 == 10)
				{
					...
					if (iParam4 == -1)
					{
						PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_85(iVar0)));
					}
					else
					{
						PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
					}
	...
	else
	{
		if (iParam1 == 11)
		{
			if (iParam5 == 0)
			{
				...
				iVar76 = -1;
				if ((iVar5 == joaat("mp_f_freemode_01") && iParam2 >= 256) && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iVar5, iParam2, 11, 4), joaat("VEST"), 0))
				{
					iVar70 = func_167(iParam0, 11);
					if (iVar70 >= 256)
					{
					...
					{
						iVar77 = func_162(iVar5, iVar70, iParam2, PED::GET_PED_TEXTURE_VARIATION(iParam0, 11));
						if (iVar77 != -99)
						{
				...
				else if (func_161(iVar5, iParam2))
				{
					...
					if (!func_161(iVar5, iVar70))
					{
						...
						{
							iVar78 = func_162(iVar5, iVar70, iParam2, PED::GET_PED_TEXTURE_VARIATION(iParam0, 11));
							if (iVar78 != -99)
							{
		...
		else if (iParam1 == 9)
		{
			if (iParam2 >= 1 && iParam2 <= 41)
			{
				...
				{
					PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(7), 0, 0, 0);
				}
			}
		}
		else if (iParam1 == 1)
		...
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_85(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_85(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (iParam5 == 0)
		{
			if (Global_68105 == 1)
			...
			if (iParam1 == 11 || iParam1 == 8)
			{
				...
				{
					PED::SET_PED_COMPONENT_VARIATION(iParam0, 5, func_105(iParam0, iVar98), func_104(iParam0, iVar98), func_103(iParam0, iVar98));
				}
				if (iParam0 == PLAYER::PLAYER_PED_ID())
				{
					PLAYER::SET_PLAYER_PARACHUTE_VARIATION_OVERRIDE(PLAYER::PLAYER_ID(), 5, func_105(PLAYER::PLAYER_PED_ID(), iVar98), func_104(PLAYER::PLAYER_PED_ID(), iVar98), 0);
					PLAYER::SET_PLAYER_PARACHUTE_PACK_TINT_INDEX(PLAYER::PLAYER_ID(), func_103(PLAYER::PLAYER_PED_ID(), iVar98));
					func_100(PLAYER::PLAYER_ID(), iVar98);
				}
			}
	...
	if (iVar11 != -1)
	{
		iVar105 = func_164(iVar5, PED::GET_PED_DRAWABLE_VARIATION(iParam0, 3), iVar11);
		if (iVar105 != -1)
		{
			if (iVar5 == joaat("mp_m_freemode_01"))
			{
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7F6E
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_85(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
void func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8164
{
	int iVar0;
...
int func_91()//Position - 0x818F
{
	return Global_1315831;
}

int func_92()//Position - 0x819B
{
...
var func_93(int iParam0)//Position - 0x81B9
{
	return Global_1312369[iParam0];
}

var func_94()//Position - 0x81C9
{
	return func_93(func_40() + 1);
}

void func_95(int iParam0)//Position - 0x81DB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_96(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x8790
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x8839
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_98(int iParam0, int iParam1, int iParam2)//Position - 0x88E1
{
	switch (iParam0)
	{
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 4:
					if (iParam2 >= 256)
					{
						if (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 4, 4), joaat("DRESS_LEGS"), 0))
						{
							return 1;
						}
					}
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x892D
{
	switch (iParam0)
	{
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 11:
					if (iParam2 >= 256)
					{
						return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 11, 4), joaat("DRESS"), 0);
					}
					break;
			}
			break;
...
void func_100(int iParam0, int iParam1)//Position - 0x8976
{
	if (func_102())
	{
		if (iParam1 > 46)
...
bool func_101()//Position - 0x89ED
{
	return DLC::IS_DLC_PRESENT(1428761799);
}

bool func_102()//Position - 0x89FE
{
	return DLC::IS_DLC_PRESENT(-1005876368);
}

int func_103(int iParam0, int iParam1)//Position - 0x8A0F
{
	return 0;
}

int func_104(int iParam0, int iParam1)//Position - 0x8A18
{
	if (iParam1 > 46)
	{
		return (iParam1 - 47);
...
int func_105(int iParam0, int iParam1)//Position - 0x8A56
{
	int iVar0;
	bool bVar1;
	int iVar2;
...
int func_106(int iParam0, int iParam1)//Position - 0x92C1
{
	int iVar0;
...
int func_107(int iParam0, int iParam1)//Position - 0x9461
{
	int iVar0;
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x95A5
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	{
		if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_85(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_85(iParam1)))
		{
			return 1;
		}
		if (iParam1 == 4)
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x9916
{
	var uVar0;
	int iVar10;
...
int func_110(int iParam0, int iParam1, int iParam2)//Position - 0x9F11
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 3), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 1, 3), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 4), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 1, 4), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_111(int iParam0, int iParam1, int iParam2)//Position - 0xA134
{
	var uVar0;
	var uVar1;
...
int func_112(int iParam0, int iParam1, int iParam2)//Position - 0xA529
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 3), joaat("GLASSES"), 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam2, 14, 4), joaat("GLASSES"), 1);
				}
			}
			break;
	}
...
int func_113(int iParam0, int iParam1, int iParam2)//Position - 0xA808
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_114(int iParam0, int iParam1)//Position - 0xA8A1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0)//Position - 0xAC8F
{
	int iVar0;
...
int func_116(int iParam0, int iParam1)//Position - 0xACE1
{
	int iVar0;
	int iVar1;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAD27
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_118(int iParam0, int iParam1)//Position - 0xAE23
{
	int iVar0;
...
int func_119(int iParam0)//Position - 0xAF61
{
	switch (iParam0)
	{
		case 0:
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0xAFE7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam0 == joaat("mp_m_freemode_01"))
	{
		...
		{
			if (iParam9 >= 327 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam9, 14, 3), joaat("PILOT_SUIT"), 1))
			{
			}
		...
		else if ((iParam9 >= 327 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam9, 14, 3), joaat("PILOT_SUIT"), 1)) && iParam1 != 0)
		{
			return 0;
		}
		...
		else if (iParam1 >= 92 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar2, joaat("SLACK_TIE"), 0))
		{
			...
			{
				if (((iParam4 >= 192 && iParam4 <= 207) || func_121(iVar6)) || (iVar6 != -1 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar6, joaat("DRAW_12"), 0)))
				{
				}
				else
				{
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		...
		{
			if (iParam9 >= 327 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam9, 14, 4), joaat("PILOT_SUIT"), 1))
			{
			}
			else if (iParam2 == 14 || (iParam2 == 1 && iParam10 != 0))
			{
		...
		else if ((iParam9 >= 327 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam9, 14, 4), joaat("PILOT_SUIT"), 1)) && iParam1 != 0)
		{
			return 0;
		}
		...
		else if (((iParam1 >= 37 && iParam1 <= 42) || iVar7 == 7) || (iParam1 >= 55 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar8, joaat("LONG_NECKLACE"), 0)))
		{
			...
			{
				if (iParam4 >= 136 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam4, 8, 4), joaat("VEST_SHIRT"), 0))
				{
					if (iParam1 >= 55 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(iVar8, joaat("LONG_NECKLACE"), 0))
					{
						return 0;
...
int func_121(int iParam0)//Position - 0xD435
{
	if (iParam0 != -1)
	{
		return 0;
...
int func_122(int iParam0, int iParam1)//Position - 0xD516
{
	int iVar0;
	int iVar1;
...
void func_125(int iParam0, int iParam1, int iParam2)//Position - 0xD829
{
	switch (iParam1)
	{
...
int func_126(char* sParam0, int iParam1, bool bParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0xD8DC
{
	int iVar0;
...
bool func_127(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xDB2E
{
	int iVar0;
	int iVar1;
	...
	switch (iParam2)
	{
		...
		case 4:
			...
			{
				case 0:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_008", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(20000) * Global_262145.f_2877)), 0);
					break;
				
				case 1:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_009", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1400) * Global_262145.f_2878)), 2);
					break;
				
				case 2:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_010", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(9750) * Global_262145.f_2879)), 3);
					break;
				
				case 3:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_011", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2150) * Global_262145.f_2880)), 0);
					break;
				
				case 4:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_012", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2881)), 0);
					break;
				
				case 54:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_013", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12400) * Global_262145.f_2882)), 1);
					break;
				
				case 5:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_014", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2883)), 0);
					break;
				
				case 6:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_015", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2884)), 2);
					break;
				
				case 55:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_016", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1350) * Global_262145.f_2885)), 1);
					break;
				
				case 7:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_017", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1450) * Global_262145.f_2886)), 0);
					break;
				
				case 8:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_018", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2700) * Global_262145.f_2887)), 7);
					break;
				
				case 9:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_019", "multiplayer_overlays", "011", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1200) * Global_262145.f_2888)), 0);
					break;
				
				case 10:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_020", "multiplayer_overlays", "012", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1500) * Global_262145.f_2889)), 0);
					break;
				
				case 11:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_021", "multiplayer_overlays", "013", "rank", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2650) * Global_262145.f_2890)), 0);
					break;
				
				case 56:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_022", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2891)), 1);
					break;
				
				case 12:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_023", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2892)), 2);
					break;
				
				case 57:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_024", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2893)), 1);
					break;
				
				case 58:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_025", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2894)), 1);
					break;
				
				case 59:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_026", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7400) * Global_262145.f_2895)), 1);
					break;
				
				case 60:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_027", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2896)), 1);
					break;
				
				case 17:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_201", "multiplayer_overlays", "005", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2400) * Global_262145.f_2901)), 2);
					break;
				
				case 18:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_202", "multiplayer_overlays", "006", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2902)), 2);
					break;
				
				case 19:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_203", "multiplayer_overlays", "015", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3600) * Global_262145.f_2903)), 2);
					break;
				
				case 20:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_204", "multiplayer_overlays", "000", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2904)), 3);
					break;
				
				case 21:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_205", "multiplayer_overlays", "001", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12500) * Global_262145.f_2905)), 3);
					break;
				
				case 22:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_206", "multiplayer_overlays", "003", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2906)), 3);
					break;
				
				case 23:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_207", "multiplayer_overlays", "014", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2907)), 3);
					break;
				
				case 24:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_208", "multiplayer_overlays", "018", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2908)), 3);
					break;
				
				case 25:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_209", "multiplayer_overlays", "002", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2909)), 2);
					break;
				
				case 26:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_210", "multiplayer_overlays", "007", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3750) * Global_262145.f_2910)), 3);
					break;
				
				case 27:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_211", "multiplayer_overlays", "008", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4800) * Global_262145.f_2911)), 3);
					break;
				
				case 28:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_212", "multiplayer_overlays", "017", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3500) * Global_262145.f_2912)), 3);
					break;
				
				case 61:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_213", "multiplayer_overlays", "009", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12350) * Global_262145.f_2913)), 1);
					break;
				
				case 62:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_214", "multiplayer_overlays", "011", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1900) * Global_262145.f_2914)), 1);
					break;
				
				case 63:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_215", "multiplayer_overlays", "013", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4500) * Global_262145.f_2915)), 1);
					break;
				
				case 64:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_216", "multiplayer_overlays", "016", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2916)), 1);
					break;
				
				case 65:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_217", "multiplayer_overlays", "019", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12300) * Global_262145.f_2917)), 1);
					break;
				
				case 29:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_218", "multiplayer_overlays", "010", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2918)), 0);
					break;
				
				case 30:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_219", "multiplayer_overlays", "004", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2919)), 0);
					break;
				
				case 31:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_220", "multiplayer_overlays", "012", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2920)), 0);
					break;
				
				case 66:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_221", "multiplayer_overlays", "020", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2921)), 1);
					break;
				
				case 32:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_222", "multiplayer_overlays", "021", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2922)), 2);
					break;
				
				case 33:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_223", "multiplayer_overlays", "022", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2923)), 3);
					break;
				
				case 34:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_224", "multiplayer_overlays", "023", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7250) * Global_262145.f_2924)), 2);
					break;
				
				case 35:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_225", "multiplayer_overlays", "024", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(11900) * Global_262145.f_2925)), 0);
					break;
				
				case 36:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_226", "multiplayer_overlays", "025", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2750) * Global_262145.f_2926)), 0);
					break;
				
				case 37:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_227", "multiplayer_overlays", "026", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1750) * Global_262145.f_2927)), 0);
					break;
				
				case 38:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_228", "multiplayer_overlays", "027", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7300) * Global_262145.f_2928)), 3);
					break;
				
				case 39:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_229", "multiplayer_overlays", "028", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(3250) * Global_262145.f_2929)), 2);
					break;
				
				case 40:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_230", "multiplayer_overlays", "029", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1000) * Global_262145.f_2930)), 0);
					break;
				
				case 67:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_231", "multiplayer_overlays", "030", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2931)), 1);
					break;
				
				case 41:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_232", "multiplayer_overlays", "031", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2932)), 2);
					break;
				
				case 68:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_233", "multiplayer_overlays", "032", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2933)), 1);
					break;
				
				case 42:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_234", "multiplayer_overlays", "033", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5050) * Global_262145.f_2934)), 0);
					break;
				
				case 43:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_235", "multiplayer_overlays", "034", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2450) * Global_262145.f_2935)), 2);
					break;
				
				case 44:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_236", "multiplayer_overlays", "035", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(4950) * Global_262145.f_2936)), 0);
					break;
				
				case 45:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_237", "multiplayer_overlays", "036", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5100) * Global_262145.f_2937)), 0);
					break;
				
				case 46:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_238", "multiplayer_overlays", "037", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(12250) * Global_262145.f_2938)), 0);
					break;
				
				case 47:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_239", "multiplayer_overlays", "038", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(1150) * Global_262145.f_2939)), 3);
					break;
				
				case 48:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_240", "multiplayer_overlays", "039", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2940)), 3);
					break;
				
				case 49:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_241", "multiplayer_overlays", "040", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7600) * Global_262145.f_2941)), 3);
					break;
				
				case 50:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_242", "multiplayer_overlays", "041", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2600) * Global_262145.f_2942)), 2);
					break;
				
				case 51:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_243", "multiplayer_overlays", "042", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2943)), 3);
					break;
				
				case 52:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_244", "multiplayer_overlays", "043", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7450) * Global_262145.f_2944)), 3);
					break;
				
				case 53:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_245", "multiplayer_overlays", "044", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(7500) * Global_262145.f_2945)), 0);
					break;
				
				case 69:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_246", "multiplayer_overlays", "045", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2946)), 1);
					break;
				
				case 70:
					func_134(sParam0, iParam1, iParam3, "TAT_FM_247", "multiplayer_overlays", "047", "", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(2500) * Global_262145.f_2947)), 2);
					break;
			}
			if (iVar0 == joaat("mp_m_freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_134(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2948)), 0);
						break;
					
					case 88:
						func_134(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2949)), 0);
						break;
					
					case 89:
						func_134(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2950)), 0);
						break;
					...
					case 13:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_100", "multiplayer_overlays", "000_A", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2897)), 0);
						break;
					
					case 14:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2898)), 0);
						break;
					
					case 15:
						func_134(sParam0, iParam1, iParam3, "TAT_FMM_CLB", "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2899)), 2);
						break;
					
					case 16:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_100", "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2900)), 0);
						break;
					
					case 71:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_E", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2900)), 0);
						break;
					
					case 72:
						func_134(sParam0, iParam1, iParam3, "TAT_FMM_CLB", "multiplayer_overlays", "000_F", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2900)), 0);
						break;
				}
			}
			else if (iVar0 == joaat("mp_f_freemode_01"))
			{
				switch (iParam1)
				{
					...
					case 87:
						func_134(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_000", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2948)), 0);
						break;
					
					case 88:
						func_134(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_001", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2949)), 0);
						break;
					
					case 89:
						func_134(sParam0, iParam1, iParam3, "NO_LABEL", "multiplayer_overlays", "FM_Tshirt_Award_F_002", "torsoDecal", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(100) * Global_262145.f_2950)), 0);
						break;
					...
					case 14:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_100", "multiplayer_overlays", "000_B", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(5000) * Global_262145.f_2898)), 0);
						break;
					
					case 15:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_C", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2899)), 2);
						break;
					
					case 16:
						func_134(sParam0, iParam1, iParam3, "TAT_FM_101", "multiplayer_overlays", "000_D", "crewLogo", iParam2, SYSTEM::ROUND((SYSTEM::TO_FLOAT(10000) * Global_262145.f_2900)), 0);
						break;
					}
			}
			break;
...
void func_128(char* sParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10C1A
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
...
int func_132()//Position - 0x10E73
{
	return 1;
}

int func_133()//Position - 0x10E7C
{
	return 1;
}

void func_134(char* sParam0, int iParam1, int iParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, int iParam7, int iParam8, int iParam9)//Position - 0x10E85
{
	char cVar0[32];
...
bool func_135(int iParam0, int iParam1)//Position - 0x1113C
{
	var uVar0;
	int iVar1;
...
int func_136(int iParam0)//Position - 0x1115E
{
	return (iParam0 % 32);
}

int func_137(var uParam0, int iParam1)//Position - 0x1116B
{
	int iVar0;
...
int func_138(var uParam0)//Position - 0x11184
{
	int iVar0;
	int iVar1;
...
int func_139()//Position - 0x112D1
{
	return Global_24445;
}

int func_140()//Position - 0x112DC
{
	return Global_24444;
}

int func_141(int iParam0)//Position - 0x112E7
{
	return (iParam0 / 32);
}
...
int func_143(int iParam0)//Position - 0x11426
{
	int iVar0;
...
int func_144(int iParam0)//Position - 0x1149B
{
...
int func_146(int iParam0)//Position - 0x11A71
{
	struct<5> Var0;
	bool bVar17;
	int iVar18;
...
int func_147(int iParam0)//Position - 0x11AD4
{
...
int func_148(int iParam0, int iParam1)//Position - 0x11B29
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_149(int iParam0, int iParam1)//Position - 0x128FA
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_150(int iParam0, var uParam1)//Position - 0x1296B
{
	int iVar0;
...
int func_151(int iParam0, var uParam1)//Position - 0x137A0
{
	int iVar0;
...
void func_153(int iParam0, int iParam1)//Position - 0x14B1C
{
	int iVar0;
...
int func_154(int iParam0, int iParam1, int iParam2)//Position - 0x14B4F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_155(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14E2B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_156(int iParam0, int iParam1)//Position - 0x1568B
{
	var uVar0;
	int iVar1;
...
var func_157(var uParam0, int iParam1)//Position - 0x156BD
{
	var uVar0;
...
int func_158(var uParam0)//Position - 0x156D6
{
	int iVar0;
	int iVar1;
...
int func_159(int iParam0)//Position - 0x15823
{
	int iVar0;
...
int func_160(int iParam0, int iParam1, int iParam2)//Position - 0x15985
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_161(int iParam0, int iParam1)//Position - 0x15C7C
{
	switch (iParam0)
	{
		case joaat("mp_m_freemode_01"):
			if ((((((iParam1 >= 48 && iParam1 < 64) || (iParam1 >= 64 && iParam1 < 80)) || (iParam1 >= 96 && iParam1 < 108)) || (iParam1 >= 108 && iParam1 < 124)) || (iParam1 >= 156 && iParam1 < 172)) || (iParam1 >= 237 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam1, 11, 3), joaat("JACKET"), 0)))
			{
				return 1;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if ((((((iParam1 >= 16 && iParam1 < 32) || (iParam1 >= 96 && iParam1 < 112)) || (iParam1 >= 112 && iParam1 < 128)) || (iParam1 >= 128 && iParam1 < 144)) || (iParam1 >= 160 && iParam1 < 176)) || (iParam1 >= 256 && FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_83(iParam0, iParam1, 11, 4), joaat("JACKET"), 0)))
			{
				return 1;
			}
			break;
...
int func_162(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x15DBD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_163()//Position - 0x16E56
{
	return DLC::IS_DLC_PRESENT(42019760);
}

int func_164(int iParam0, int iParam1, int iParam2)//Position - 0x16E67
{
	switch (iParam0)
	{
		case joaat("mp_f_freemode_01"):
...
int func_165(int iParam0, int iParam1, int iParam2)//Position - 0x17D57
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_166(int iParam0, int iParam1, int iParam2)//Position - 0x18329
{
	int iVar0;
...
int func_167(int iParam0, int iParam1)//Position - 0x18743
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_168(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x187A3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_169(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x18827
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_170(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x19BB5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_172(int iParam0, int iParam1)//Position - 0x19FA0
{
	int iVar0;
	struct<6> Var1;
...
void func_173(int iParam0, bool bParam1, int iParam2)//Position - 0x19FF7
{
	if (bParam1)
	{
...
void func_174(int iParam0, bool bParam1, int iParam2)//Position - 0x1A030
{
	int iVar0;
	int iVar1;
...
void func_176(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x1A0ED
{
	if (iParam2 == -1)
	{
...
struct<10> func_177(int iParam0, int iParam1)//Position - 0x1A116
{
	int iVar0;
	struct<10> Var1;
...
void func_178(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1AA45
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_88(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
void func_179(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x1AB6F
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_180(int iParam0, int iParam1)//Position - 0x1ABB7
{
	int iVar0;
	struct<16> Var1;
...
void func_181(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1C9FB
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_182(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_182(Var16.f_2)] = func_88(iParam1, Var16.x, func_182(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_182(int iParam0)//Position - 0x1CBAC
{
	switch (iParam0)
	{
		case 0:
...
void func_183(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1CC5C
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
int func_185(int iParam0, int iParam1, int iParam2)//Position - 0x1DBC9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_186(int iParam0, int iParam1, var uParam2)//Position - 0x1DEBE
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
void func_187(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1E2C3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_188(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x1E30C
{
	int iVar0;
...
int func_189(int iParam0)//Position - 0x1E9AD
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_190(int iParam0, int iParam1, int iParam2)//Position - 0x1E9FE
{
	func_231();
	if (iParam0 == joaat("mp_m_freemode_01"))
	{
...
void func_191(int iParam0, int iParam1)//Position - 0x1EA3B
{
	switch (iParam0)
	{
		case 2:
...
void func_192(int iParam0)//Position - 0x1EB2B
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_193(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x1ECE6
{
	var uVar0;
	int iVar1;
...
int func_194(int iParam0, int iParam1)//Position - 0x1F069
{
	switch (iParam1)
	{
		case 0:
...
int func_195(int iParam0, int iParam1)//Position - 0x1F464
{
	switch (iParam1)
	{
		case 0:
...
bool func_196(int iParam0)//Position - 0x1F85F
{
	return Global_34913 == iParam0;
}

int func_197(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1F86D
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_198(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x2078D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_199(int iParam0)//Position - 0x207CF
{
	switch (iParam0)
	{
		case -1:
...
void func_200(int iParam0)//Position - 0x208A3
{
	int iVar0;
...
void func_201(int iParam0, int iParam1, int iParam2)//Position - 0x208C1
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_193(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		FILES::INIT_SHOP_PED_COMPONENT(&Var41);
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_85(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			FILES::GET_SHOP_PED_QUERY_COMPONENT(iVar58, &Var41);
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_193(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_202(int iParam0)//Position - 0x20B3C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_203(int iParam0)//Position - 0x20C3D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_204(int iParam0)//Position - 0x20F1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_205(int iParam0)//Position - 0x23CCC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_206(int iParam0)//Position - 0x23DCF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_207(int iParam0)//Position - 0x245AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_208(int iParam0)//Position - 0x2488E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_209(int iParam0)//Position - 0x25EB3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_210(int iParam0)//Position - 0x27510
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_211(int iParam0)//Position - 0x27669
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_212(int iParam0)//Position - 0x278E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_213(int iParam0)//Position - 0x28CAC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_214(int iParam0)//Position - 0x2A43A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_215(int iParam0, int iParam1)//Position - 0x2B309
{
	switch (iParam0)
	{
		case 2:
...
void func_216(int iParam0)//Position - 0x2B3F9
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_217(int iParam0)//Position - 0x2B5C3
{
	int iVar0;
...
void func_218(int iParam0)//Position - 0x2B5E1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_219(int iParam0)//Position - 0x2B6E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_220(int iParam0)//Position - 0x2B991
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_221(int iParam0)//Position - 0x2E72E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_222(int iParam0)//Position - 0x2E84D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_223(int iParam0)//Position - 0x2F143
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_224(int iParam0)//Position - 0x2F3F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_225(int iParam0)//Position - 0x30A34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_226(int iParam0)//Position - 0x32065
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_227(int iParam0)//Position - 0x321BA
{
	bool bVar0;
	int iVar1;
	char* sVar2;
...
void func_228(int iParam0)//Position - 0x324D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_229(int iParam0)//Position - 0x349E9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_230(int iParam0)//Position - 0x35F9E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_231()//Position - 0x36E56
{
...
void func_232(int iParam0, int iParam1, int iParam2)//Position - 0x36ECF
{
	int iVar0;
	...
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && func_236(PLAYER::PLAYER_ID(), 1))
	{
		return;
	}
...
bool func_234()//Position - 0x36FC8
{
	return Global_2435308;
}

bool func_235()//Position - 0x36FD4
{
	return Global_2435880;
}

int func_236(int iParam0, bool bParam1)//Position - 0x36FE0
{
	if (bParam1)
	{
		if (func_237(iParam0))
...
bool func_237(int iParam0)//Position - 0x3700C
{
	return func_238(iParam0);
}

bool func_238(int iParam0)//Position - 0x3701A
{
	return MISC::IS_BIT_SET(Global_1582596[iParam0 /*324*/].f_13.f_1, 0);
}

void func_239(char* sParam0, int iParam1)//Position - 0x37034
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

var func_240(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5)//Position - 0x3704B
{
	return MISC::GET_HEADING_FROM_VECTOR_2D((Param3 - Param0), (Param3.f_1 - Param0.f_1));
}

void func_241(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x37065
{
	int iVar0;
	bool bVar1;
	bool bVar2;
	...
	else
	{
		...
		if (NETWORK::NETWORK_IS_PLAYER_ACTIVE(iParam0) && PLAYER::IS_PLAYER_PLAYING(iParam0))
		{
			...
			if (bParam1)
			{
				if (!func_244(iVar23) && !ENTITY::IS_ENTITY_ATTACHED_TO_ANY_VEHICLE(iVar23))
				{
					if (!bVar21)
					{
...
void func_242()//Position - 0x373E4
{
	struct<2> Var0;
...
void func_243()//Position - 0x37421
{
...
int func_244(int iParam0)//Position - 0x3744E
{
	int iVar0;
...
void func_245()//Position - 0x3747F
{
	Global_2422140.f_600.f_10 = 1;
}

void func_246(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x37491
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_247(PLAYER::PLAYER_ID()))
		{
...
int func_247(int iParam0)//Position - 0x37562
{
...
bool func_248()//Position - 0x375A3
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_249(int iParam0, int iParam1)//Position - 0x375B4
{
	bool bVar0;
...
int func_250(int iParam0, bool bParam1)//Position - 0x375FF
{
	int iVar0;
	int iVar1;
...
void func_252(int iParam0)//Position - 0x37667
{
	if (iParam0 == 1)
	{
...
void func_256(var uParam0)//Position - 0x37C45
{
	uParam0->f_1 = 0;
}

int func_257(var uParam0, int iParam1, bool bParam2)//Position - 0x37C52
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_258(var uParam0, bool bParam1, bool bParam2)//Position - 0x37CB0
{
	if (uParam0->f_1 == 0)
	{
...
bool func_259(var uParam0)//Position - 0x37CF5
{
	return uParam0->f_1;
}

void func_260(var uParam0, var uParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x37D01
{
...
int func_262(int iParam0, int iParam1, int iParam2)//Position - 0x37E5E
{
	int iVar0;
...
int func_264(int iParam0, bool bParam1)//Position - 0x37F30
{
	int iVar0;
...
int func_265(int iParam0)//Position - 0x37FE8
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
int func_266(int iParam0)//Position - 0x38043
{
	int iVar0;
...
void func_267(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4)//Position - 0x3807E
{
	int iVar0;
...
bool func_268()//Position - 0x38189
{
	return HUD::GET_PAUSE_MENU_STATE() != 0;
}

bool func_269(int iParam0, int iParam1)//Position - 0x38197
{
	switch (iParam0)
	{
		case 5:
...
void func_270(int iParam0)//Position - 0x381D2
{
	int iVar0;
...
int func_272(int iParam0)//Position - 0x3825C
{
	if (iParam0 > -1)
	{
		if (iParam0 == PLAYER::PLAYER_ID())
...
int func_273(int iParam0)//Position - 0x3829F
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_278(int iParam0)//Position - 0x38411
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((!func_280(iParam0, 1, 1) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || func_279())
		{
			return 0;
		}
		return 1;
...
int func_280(int iParam0, bool bParam1, bool bParam2)//Position - 0x384AB
{
	int iVar0;
...
int func_281(bool bParam0, bool bParam1, bool bParam2)//Position - 0x384EF
{
	int iVar0;
...
int func_282(int iParam0)//Position - 0x385CF
{
	var uVar0;
...
int func_283()//Position - 0x38627
{
	func_284();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_284()//Position - 0x38640
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_287(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_286(PLAYER::PLAYER_PED_ID());
...
bool func_285(int iParam0)//Position - 0x3873D
{
	return iParam0 < 3;
}

int func_286(int iParam0)//Position - 0x38749
{
	int iVar0;
	int iVar1;
...
int func_287(int iParam0)//Position - 0x38786
{
	if (func_285(iParam0))
	{
...
bool func_288(char* sParam0)//Position - 0x387B0
{
...
void func_294()//Position - 0x3889E
{
}
