...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		func_249("Force cleanup [TERMINATING]");
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				func_249("Relinquishing candidate id...");
				func_248(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
	if (!func_232(&iVar2, &Var0, Var1, 1f))
	{
		func_231();
		func_249("SCRIPT TERMINATED");
	...
	while (!func_217(&Var0))
	{
		...
		{
			func_249("Player out of range [TERMINATING]");
			func_235(&Var0, 1);
		}
	}
	...
	while (true)
	{
		...
		func_178(Var0);
		func_171(&iLocal_52, &uLocal_53, &(Var0.f_9), Var1, -1295.84f, 4641.98f, 105.33f, -1301.43f, 4641.21f, 105.62f);
		func_164(&Var0, Var1, "SAS1AUD", "SAS1_AMB", 4, "HUNTER", 10000);
		if (func_149(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_1(int iParam0)//Position - 0x22B
{
...
int func_2(var uParam0)//Position - 0x249
{
	...
	if (!func_148())
	{
		while (!func_139(*uParam0))
		{
			...
			{
				func_249("LAUNCH_RC_MISSION - NOT IS_RC_FINE_AND_IN_RANGE() [TERMINATING]");
				return 0;
			}
			SYSTEM::WAIT(0);
		}
	...
	if (!func_97(uParam0))
	{
		func_249("STEP_7_COMMON_LaunchMission - Trying to launch a null script string name");
		return 0;
	}
...
void func_3(int iParam0, char* sParam1)//Position - 0x30A
{
	func_21(sParam1);
...
void func_25(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x198B
{
	int iVar0;
	int iVar1;
...
int func_26(var uParam0)//Position - 0x280F
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2831
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x28B8
{
...
int func_29(int iParam0)//Position - 0x28F8
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2926
{
...
int func_31(int iParam0)//Position - 0x2A02
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2A44
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2AA7
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2B35
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2B77
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2DEF
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2DFB
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x30A7
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x3157
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x3231
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x32E2
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x340F
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3480
{
...
int func_44(int iParam0)//Position - 0x3559
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x3596
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x35C0
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x376A
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x379C
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x37D0
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x37DC
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3808
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3D50
{
	int iVar0;
...
int func_53()//Position - 0x3F91
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x3FAA
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x40A8
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x40B6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x41A9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x440D
{
...
int func_59(int iParam0, int iParam1)//Position - 0x4533
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4D4F
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4D8A
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x4FFE
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x503A
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5595
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x55D9
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5C2F
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5C58
{
...
bool func_68(int iParam0)//Position - 0x5CB1
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5CC1
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5D21
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x5FCA
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x5FD5
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5FE5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x607C
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x654D
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x655D
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x67B6
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x67C7
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x680D
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x6893
{
...
void func_81(var uParam0, int iParam1)//Position - 0x68C6
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x6917
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x69B9
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x69DE
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x69F5
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6A02
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6A3C
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6A77
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6AB3
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6ACC
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6B25
{
...
bool func_92(bool bParam0)//Position - 0x6B67
{
...
struct<2> func_93(int iParam0)//Position - 0x6B92
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x6FDF
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x82B9
{
	switch (iParam0)
	{
		case 0:
...
int func_97(var uParam0)//Position - 0x85FF
{
	var uVar0;
	...
	if (func_126(&(uParam0->f_1)))
	{
		...
		{
			func_249("Initial cutscene loaded and passing to RC mission.");
			CUTSCENE::_0x8D9DF6ECA8768583(uVar0);
		}
		else
		{
			func_249("Initial cutscene wasn't loaded in time to pass to RC mission.");
...
void func_98(int iParam0)//Position - 0x86A3
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x873E
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x879C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x87F5
{
...
int func_103(int iParam0)//Position - 0x8878
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x88A9
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x88BD
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8965
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x8980
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x89CC
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8A15
{
	if (func_111(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8A35
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_112(int iParam0)//Position - 0x8A55
{
	switch (iParam0)
	{
		case 5:
...
int func_114(int iParam0)//Position - 0x8B25
{
	switch (iParam0)
	{
		case 5:
...
void func_115(var uParam0, int iParam1, bool bParam2)//Position - 0x8B78
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x8C6C
{
	switch (iParam0)
	{
		case 5:
...
void func_117(bool bParam0)//Position - 0x8CD7
{
	var uVar0;
...
void func_118(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8D13
{
	if (bParam0)
	{
...
int func_119(int iParam0)//Position - 0x8DE4
{
...
bool func_120()//Position - 0x8E25
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_121(int iParam0, int iParam1)//Position - 0x8E36
{
	bool bVar0;
...
int func_122(int iParam0, bool bParam1)//Position - 0x8E81
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0, var uParam1, var uParam2)//Position - 0x8EC2
{
	int iVar0;
...
void func_125(int iParam0)//Position - 0x8F1A
{
	if (iParam0 == 1)
	{
...
int func_126(char* sParam0)//Position - 0x8F3D
{
	...
	func_249("Attempting to launch invalid script file [TERMINATING]");
	return 0;
}

void func_127()//Position - 0x8F7A
{
	Global_38DE = 0;
	func_128();
}

void func_128()//Position - 0x8F8A
{
...
int func_132(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x906E
{
...
void func_135(int iParam0)//Position - 0x9269
{
	if (Global_38D7)
	{
		func_136(0, 0);
...
void func_136(bool bParam0, bool bParam1)//Position - 0x92D9
{
	if (bParam0)
	{
		if (func_137(0))
...
int func_137(int iParam0)//Position - 0x934D
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_138(int iParam0)//Position - 0x93A7
{
...
int func_139(int iParam0)//Position - 0x93E8
{
	int iVar0;
...
void func_140(int iParam0)//Position - 0x942D
{
...
int func_141(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x945F
{
	int iVar0;
...
void func_142(var uParam0, int iParam1)//Position - 0x9596
{
	int iVar0;
...
bool func_143(int iParam0)//Position - 0x95E5
{
	return func_144(iParam0, Global_8861);
}

int func_144(int iParam0, int iParam1)//Position - 0x95F6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_145(int iParam0)//Position - 0x97D7
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_146()//Position - 0x97F9
{
	return func_147(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_147(var uParam0, int iParam1)//Position - 0x980A
{
	int iVar0;
	var uVar1;
	int iVar2;
...
int func_149(var uParam0, int iParam1)//Position - 0x9877
{
	switch (uParam0->f_10)
	{
		case 0:
						...
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(uParam0->f_1C[0], 1), 1) < 3f)
						{
							if (func_155(2))
							{
								if (func_153(uParam0->f_1B))
								{
									...
									func_249("ARE_RC_TRIGGER_CONDITIONS_MET: RC_TRIG_CHAR - Used special case Eps 4 trigger.");
									return 1;
								}
							}
						}
				...
				if (TASK::GET_PED_DESIRED_MOVE_BLEND_RATIO(PLAYER::PLAYER_PED_ID()) >= 2f)
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 245.8885f, 371.9034f, 103.9884f, 241.5898f, 359.6458f, 107.3461f, 1.25f, 0, 1, 0))
					{
						if (func_155(2))
						{
							...
							{
								func_152(uParam0->f_1B, *uParam0);
								func_249("RC5_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - Eps 2 special case trigger used");
								return 1;
							}
						}
					}
			...
			else if (*uParam0 == 31)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 2728.948f, 4143.44f, 42.29295f, 2722.213f, 4144.521f, 45.43182f, 10f, 0, 1, 0))
				{
					if (func_155(2))
					{
						...
						{
							func_152(1, *uParam0);
							func_249("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_MAUDE_1 special case vehicle launch area");
							return 1;
						}
					}
				}
					...
					if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.5426f, 369.1104f, 68.46017f, -1028.566f, 395.4613f, 94.57245f, 15f, 0, 1, 0))
					{
						if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -983.875f, 346.7556f, 68.02096f, -1021.451f, 336.3458f, 93.18714f, 14.5f, 0, 1, 0))
						{
							if (func_155(2))
							{
								...
								{
									func_152(uParam0->f_1B, *uParam0);
									func_249("RC_IN_ACTIVATION_RANGE: RC_TRIG_LOCATE_NONAXIS - RC_NIGEL_1B special case vehicle launch area");
									return 1;
								}
							}
						}
...
void func_150()//Position - 0xA059
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_151(var uParam0)//Position - 0xA074
{
	float fVar0;
...
void func_152(int iParam0, int iParam1)//Position - 0xA102
{
	if (iParam0 == 1)
	{
		if (!func_114(iParam1))
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			func_249("RC_STOP_PLAYER_VEHICLE_CHECK: Stopping player's vehicle.");
			if (PED::IS_PED_IN_ANY_HELI(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_ANY_PLANE(PLAYER::PLAYER_PED_ID()))
			{
				func_249("RC_STOP_PLAYER_VEHICLE_CHECK: Turning off engine for plane or helicopter.");
...
int func_153(bool bParam0)//Position - 0xA165
{
	int iVar0;
...
int func_154(int iParam0)//Position - 0xA1FC
{
	if (func_111(uParam0))
	{
...
int func_155(int iParam0)//Position - 0xA226
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_163()) || Global_17890) || Global_5F7E) || func_162()) || func_161(8, -1)) || func_77()) || func_160()) || func_159()) || func_158()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_163()) || Global_5F7E) || func_162()) || func_161(8, -1)) || func_159()) || func_77()) || func_160()) || func_158()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_163()) || Global_17890) || Global_5F7E) || func_162()) || func_161(8, -1)) || func_159()) || func_77()) || func_160()) || func_158()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_163()) || Global_17890) || Global_5F7E) || func_162()) || func_161(8, -1)) || func_77()) || func_160()) || func_158()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_163() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_161(8, -1)) || func_158()) || func_157()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_163()) || Global_5F7E) || func_162()) || func_161(8, -1)) || func_160()) || func_159()) || func_158()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_163()) || func_160()) || Global_17890) || Global_5F7E) || func_162()) || Global_8C75) || func_161(8, -1)) || func_159()) || func_157()) || func_158()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_163()) || Global_17890) || Global_5F7E) || func_162()) || func_161(8, -1)) || func_159()) || func_157()) || func_77()) || func_160()) || func_158())
						{
							return 0;
						}
						break;
...
var func_156()//Position - 0xA943
{
	return Global_15F91.f_1;
}

int func_157()//Position - 0xA951
{
	if (Global_154F9 != -1)
	{
...
bool func_160()//Position - 0xA9BB
{
	return Global_15F9E.f_123 > 0;
}

bool func_161(int iParam0, int iParam1)//Position - 0xA9CC
{
	switch (iParam0)
	{
		case 5:
...
var func_162()//Position - 0xAA07
{
	return Global_14143C;
}

int func_163()//Position - 0xAA13
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_164(var uParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xAA2F
{
	var uVar0;
	...
	if (func_155(2))
	{
		if (!func_129())
		{
			if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(uParam0->f_1C[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_3C) > iParam6) && func_170(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
				func_169(&uVar0, iParam4, uParam0->f_1C[0], sParam5, 0, 1);
				func_167(&uVar0, cParam2, sParam3, 7, 0, 0);
				uParam0->f_3C = MISC::GET_GAME_TIMER();
				return 1;
			}
		}
		else if (func_165(sParam3))
		{
			if (func_111(PLAYER::PLAYER_PED_ID()))
			{
				if (func_170(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
				{
					func_127();
				}
			}
...
int func_165(char* sParam0)//Position - 0xAAF1
{
	struct<6> Var0;
...
struct<6> func_166()//Position - 0xAB11
{
	struct<6> Var0;
...
void func_167(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB35
{
...
void func_168(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB70
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_169(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xABC6
{
...
float func_170(int iParam0, struct<3> Param1, int iParam2)//Position - 0xAC61
{
	struct<3> Var0;
...
void func_171(int iParam0, var uParam1, var uParam2, struct<3> Param3, struct<3> Param4, struct<3> Param5)//Position - 0xAC9A
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam2))
		{
			...
			{
				if (func_170(PLAYER::PLAYER_PED_ID(), Param3, 1) <= 100f)
				{
					func_174(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_170(PLAYER::PLAYER_PED_ID(), Param4, 1);
					fVar1 = func_170(PLAYER::PLAYER_PED_ID(), Param5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
				...
				if (func_170(PLAYER::PLAYER_PED_ID(), Param3, 1) > 120f)
				{
					func_175(iParam0);
				}
			}
...
void func_172(int iParam0, bool bParam1)//Position - 0xADB8
{
	if (iParam0 == -1)
	{
		return;
...
int func_173(int iParam0)//Position - 0xADF4
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_174(int iParam0, int iParam1)//Position - 0xAE2D
{
	bool bVar0;
	int iVar1;
...
void func_175(int iParam0)//Position - 0xAECB
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_176(iParam0);
...
void func_176(int iParam0)//Position - 0xAEE2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_177()//Position - 0xAFCA
{
	return Global_1567C;
}

void func_178(int iParam0)//Position - 0xAFD6
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_179(var uParam0, bool bParam1)//Position - 0xAFFE
{
	...
	if (Global_10A95)
	{
		func_249("IS_RC_FINE_AND_IN_RANGE(): The game is running Multiplayer [TERMINATING]");
		return 0;
	}
	func_94(*uParam0, &Var0);
	if ((func_216(*uParam0) || func_214(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	{
		func_249("IS_RC_FINE_AND_IN_RANGE(): Player out of range [TERMINATING]");
		return 0;
	}
	if (func_210(*uParam0))
	{
		if (*uParam0 == 19)
		{
			func_209(uParam0->f_1C[0]);
		}
		func_249("IS_RC_FINE_AND_IN_RANGE(): Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (uParam0->f_19 == 1)
	{
	...
	if (*uParam0 == 10)
	{
		...
		{
			func_249("IS_RC_FINE_AND_IN_RANGE(): Explosion near mission trigger [TERMINATING]");
			return 0;
		}
	}
	if (Var0.f_4 != 17)
	{
		...
		{
			func_249("IS_RC_FINE_AND_IN_RANGE(): No longer a valid player character to launch mission");
			return 0;
		}
	}
	if (func_183(&(uParam0->f_30)) && bParam1)
	{
		func_180(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_180(int iParam0, var uParam1, int iParam2)//Position - 0xB271
{
	var uVar0;
	var uVar1;
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_182(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_181(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_182(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_181(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_181(int iParam0)//Position - 0xB5C6
{
...
int func_182(var uParam0)//Position - 0xB5E6
{
...
int func_183(var uParam0)//Position - 0xB5FE
{
...
void func_184(var uParam0)//Position - 0xB623
{
	int iVar0;
	var uVar1;
	...
	if (*uParam0 == 52)
	{
		func_185(&(uParam0->f_29[1]));
		func_185(&(uParam0->f_29[2]));
	}
	if (func_111(PLAYER::PLAYER_PED_ID()))
	{
		iVar0 = 0;
...
void func_185(var uParam0)//Position - 0xB927
{
...
void func_186(var uParam0)//Position - 0xB952
{
	int iVar0;
...
int func_187(var uParam0, bool bParam1, bool bParam2)//Position - 0xB9D2
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (func_110(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				{
					func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is dead [TERMINATING]");
					return 0;
				}
				if (!VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0->f_23[iVar0], 0))
				{
					func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is not driveable [TERMINATING]");
					return 0;
				}
				if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_23[iVar0], PLAYER::PLAYER_PED_ID(), 0))
				{
					func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has been damaged by player [TERMINATING]");
					return 0;
				}
				if (ENTITY::GET_ENTITY_HEALTH(uParam0->f_23[iVar0]) < 850)
				{
					func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle health is less than 850 [TERMINATING]");
					return 0;
				}
				if (bParam2)
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
					{
						...
						{
							func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player vehicle at speed [TERMINATING]");
							return 0;
						}
						...
						if (func_154(uVar2))
						{
							...
							{
								if (func_154(uParam0->f_23[iVar0]))
								{
									if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(iVar2, uParam0->f_23[iVar0]))
									{
										func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle is being towed by player [TERMINATING]");
										return 0;
									}
								}
							}
					...
					else
					{
						...
						if (func_154(iVar3))
						{
							...
							{
								func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Random character vehicle has collided with the player's last known vehicle at speed (player bailed out?) [TERMINATING]");
								return 0;
							}
						}
						if (*uParam0 == 16)
						{
							...
							{
								func_249("STEP_5_COMMON_RCfineAndInRange - CHECK_VEHICLES_OK() - Player attempting to jack Epsilon vehicle [TERMINATING]");
								return 0;
							}
						}
					}
...
int func_188(int iParam0, int iParam1)//Position - 0xBB8F
{
	int iVar0;
	...
	if (func_110(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= iVar1)
		{
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					if (PED::IS_PED_SITTING_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID()))
					{
						if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), uParam0->f_1C[iVar0]))
						{
							...
							func_249("STEP_5_COMMON_RCfineAndInRange - Random character is being pushed by car [TERMINATING]");
							return 0;
						}
					}
					if ((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_PED(uParam0->f_1C[iVar0]) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(uParam0->f_1C[iVar0])) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_OBJECT(uParam0->f_1C[iVar0]))
					{
						...
						func_249("STEP_5_COMMON_RCfineAndInRange - Random character has been damaged by something [TERMINATING]");
						return 0;
					}
					if (PED::IS_PED_RAGDOLL(uParam0->f_1C[iVar0]))
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(uParam0->f_1C[iVar0], PLAYER::PLAYER_PED_ID(), 3f, 3f, 3f, 0, 1, 0))
						{
							...
							func_249("STEP_5_COMMON_RCfineAndInRange - Random character is in ragdoll [TERMINATING]");
							return 0;
						}
					}
					if (func_208(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_203(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								...
								func_249("STEP_5_COMMON_RCfineAndInRange - Player is shooting near the Random Character [TERMINATING]");
								return 0;
							}
						}
						if (FIRE::IS_EXPLOSION_IN_SPHERE(-1, ENTITY::GET_ENTITY_COORDS(uParam0->f_1C[iVar0], 1), 15f))
						{
							...
							func_249("STEP_5_COMMON_RCfineAndInRange - There was an explosion near the Random Character [TERMINATING]");
							return 0;
						}
						if (func_191(uParam0->f_1C[iVar0], 1126825984))
						{
							...
							func_249("STEP_5_COMMON_RCfineAndInRange - Random character is in combat [TERMINATING]");
							return 0;
						}
					}
					if (!func_190(*uParam0))
					{
						...
						if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0)
						{
							...
							func_249("STEP_5_COMMON_RCfineAndInRange - Player has a wanted level [TERMINATING]");
							return 0;
						}
					}
				}
				...
				{
					func_249("STEP_5_COMMON_RCfineAndInRange - Random character injured / dead [TERMINATING]");
					if (*uParam0 == 34)
					{
						if (func_111(uParam0->f_29[0]))
						{
...
int func_190(int iParam0)//Position - 0xBE7B
{
...
int func_194(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xBFFE
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_195(int iParam0, int iParam1)//Position - 0xC12C
{
	int iVar0;
...
int func_197(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC23B
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_198(struct<3> Param0, struct<3> Param1)//Position - 0xC2CC
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_199(struct<3> Param0)//Position - 0xC2ED
{
	float fVar0;
	float fVar1;
...
void func_200(var uParam0)//Position - 0xC32C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_202(var uParam0)//Position - 0xC386
{
...
int func_203(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC3AE
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_204(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC4A9
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_205(var uParam0, float fParam1)//Position - 0xC5B5
{
	var uVar0;
	struct<3> Var1;
...
int func_206(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xC64A
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_207(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xC6D8
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_208(int iParam0)//Position - 0xC720
{
...
void func_209(int iParam0)//Position - 0xC76A
{
	var uVar0;
...
int func_210(int iParam0)//Position - 0xC807
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_214(int iParam0)//Position - 0xC921
{
	if ((func_215() && Global_15F6A.f_B == 6) && iParam0 == func_147(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_216(int iParam0)//Position - 0xC993
{
	if (func_92(0))
	{
...
int func_217(int iParam0)//Position - 0xC9BB
{
	...
	func_249("Created initial scene");
	return 1;
}
...
int func_218(var uParam0)//Position - 0xC9DA
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (((!func_221(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmlastone1")) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_pumpshotgun"))) || !WEAPON::HAS_WEAPON_ASSET_LOADED(joaat("weapon_sniperrifle")))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			bVar2 = true;
			uParam0->f_1C[0] = PED::CREATE_PED(25, iLocal_51, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, 1);
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_219(&(uParam0->f_23[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
				{
...
void func_219(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xCBC6
{
	func_220(uParam0);
...
void func_220(var uParam0)//Position - 0xCC01
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_221(int iParam0)//Position - 0xCC9D
{
	int iVar0;
...
int func_222(int iParam0)//Position - 0xCCCE
{
	struct<27> Var0;
	int iVar1;
...
int func_223(int iParam0)//Position - 0xCD22
{
	char* sVar0;
	
	if (Global_10A95)
	{
		func_249("STEP_3_COMMON_CanRCLaunch - Script denied. Multiplayer is running [TERMINATING]");
		return 0;
	}
	if (!func_224(iParam0))
	{
		Global_178B8[iParam0 /*10*/].f_1 = 1;
		func_249("STEP_3_COMMON_CanRCLaunch - Script denied by RC Controller [TERMINATING]");
		return 0;
	}
	if (Global_15F6A.f_B == 6)
	{
		if (Global_15F6A < 9)
		{
			...
			{
				func_249("STEP_3_COMMON_CanRCLaunch - Script denied as a replay for this RC is being configured. [TERMINATING]");
				return 0;
			}
		}
	}
	...
	{
		Global_178B8[iParam0 /*10*/].f_1 = 1;
		func_249("STEP_3_COMMON_CanRCLaunch - Script denied as candidate_controller is not running. [TERMINATING]");
		return 0;
	}
	return 1;
}

int func_224(int iParam0)//Position - 0xCDB9
{
	var uVar0;
...
int func_225(int iParam0)//Position - 0xCE7A
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_226(int iParam0, char* sParam1)//Position - 0xCEFF
{
...
bool func_227(int iParam0)//Position - 0xCFE1
{
...
bool func_228(int iParam0)//Position - 0xD00F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_229(int iParam0)//Position - 0xD03D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_230(int iParam0)//Position - 0xD06B
{
	if (func_211(iParam0))
	{
		return 0;
...
void func_231()//Position - 0xD0A0
{
	func_249("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_232(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xD0BA
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_233((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_233((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
	...
	func_249("DETERMINE_RC_TO_LAUNCH - Unable to find mission to launch [TERMINATING]");
	return 0;
}

int func_233(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xD11F
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_234(Var1.f_6, Param1, fParam2))
	{
...
int func_234(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xD19C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_235(int iParam0, bool bParam1)//Position - 0xD1E8
{
	if (bParam1)
	{
		func_249("SCRIPT TERMINATING: Cleaning up entities in Launcher");
		func_237(iParam0, 0, 0, 0);
	}
	func_236(&(iParam0->f_30));
	if (iLocal_52 != -1)
	{
		func_249("SCRIPT TERMINATING: Ending off-mission cutscene request");
		func_176(&iLocal_52);
	}
	if (bParam1)
	{
...
int func_236(var uParam0)//Position - 0xD23E
{
	if (func_183(uParam0))
	{
...
void func_237(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xD274
{
...
void func_238(var uParam0, bool bParam1)//Position - 0xD294
{
	func_239(&(uParam0->f_29), bParam1);
}

void func_239(var uParam0, bool bParam1)//Position - 0xD2A6
{
	int iVar0;
...
void func_240(var uParam0, bool bParam1)//Position - 0xD2E4
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_241(var uParam0, bool bParam1)//Position - 0xD31F
{
	func_242(&(uParam0->f_23), bParam1);
}

void func_242(var uParam0, bool bParam1)//Position - 0xD331
{
	int iVar0;
...
void func_243(var uParam0)//Position - 0xD36E
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_244(var uParam0, int iParam1)//Position - 0xD3A5
{
	func_245(&(uParam0->f_1C), iParam1);
}

void func_245(var uParam0, int iParam1)//Position - 0xD3B7
{
	int iVar0;
...
void func_246(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD3F8
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_247(var uParam0)//Position - 0xD447
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_248(var uParam0)//Position - 0xD486
{
	if (*uParam0 == -1)
	{
		return;
...
void func_249(char* sParam0)//Position - 0xD4C3
{
...
void func_250(var uParam0)//Position - 0xD4D5
{
	*uParam0 = -1;
...
void func_251()//Position - 0xD508
{
	func_249("Running start routines.");
	Global_17B2F++;
}
