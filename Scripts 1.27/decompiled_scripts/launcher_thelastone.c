	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_248(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_235(&Var0, 1);
	}
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5595
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5C2F
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x5FE5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_164(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8)//Position - 0xAA2F
{
	...
	if (func_155(2))
	{
		if (!func_129())
		{
			if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(uParam0->f_28[0])) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_170(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
			{
				uVar0 = 16;
...
float func_170(int iParam0, struct<3> Param1, int iParam4)//Position - 0xAC61
{
	struct<3> Var0;
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (!MISC::IS_STRING_NULL_OR_EMPTY(uParam2))
		{
			...
			else
			{
				...
				{
					fVar0 = func_170(PLAYER::PLAYER_PED_ID(), Param6, 1);
					fVar1 = func_170(PLAYER::PLAYER_PED_ID(), Param9, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
...
int func_194(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xBFFE
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_198(struct<3> Param0, struct<3> Param3)//Position - 0xC2CC
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_206(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xC64A
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_218(var uParam0)//Position - 0xC9DA
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_219(&(uParam0->f_35[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
				{
...
void func_219(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xCBC6
{
	func_220(uParam0);
...
int func_232(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xD0BA
{
	int iVar0;
...
int func_233(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xD11F
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_234(Var1.f_6, Param1, fParam4))
	{
...
int func_234(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xD19C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
