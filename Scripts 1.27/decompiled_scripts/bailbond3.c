...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_460())
	{
		...
		{
			case 0:
				func_421(&iLocal_706, 509.6743f, 5532.435f, 776.0009f, 153.1431f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
			...
			case 1:
				func_421(&iLocal_706, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
	...
	else if (func_408(0))
	{
		...
		{
			func_406(PLAYER::PLAYER_PED_ID(), Local_691, fLocal_456, 0, 0);
		...
		switch (iLocal_97)
		{
			case 0:
				if (iLocal_99 == 1)
				{
					if (!func_67())
					{
						func_18(PLAYER::PLAYER_PED_ID(), Local_694, fLocal_457, 0, 1);
			...
			case 1:
				...
				if (iLocal_99 == 1)
				{
					if (!func_67())
					{
						func_18(PLAYER::PLAYER_PED_ID(), Local_697, fLocal_458, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_443 == 0)
						{
			...
			case 2:
				...
				if (iLocal_99 == 1)
				{
					...
					if (!func_67())
					{
						...
						func_406(PLAYER::PLAYER_PED_ID(), Local_685 + Vector(0f, -2f, -1f), -27.29f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_443 == 0)
						{
			...
			case 3:
				...
				if (iLocal_99 == 1)
				{
					...
					if (!func_67())
					{
						func_406(PLAYER::PLAYER_PED_ID(), Local_676, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_443 == 0)
						{
...
bool func_4(struct<3> Param0, var uParam3, var uParam4, int iParam5)//Position - 0x692
{
	var uVar0;
	struct<3> Var1;
...
void func_10(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x768
{
	var uVar0;
	int iVar1;
...
void func_17(int iParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x972
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_18(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x9D1
{
	bool bVar0;
	float fVar1;
...
int func_34()//Position - 0xE34
{
	if (func_56(Local_679, Local_384.f_1, 210f))
	{
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_404))
		{
			...
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_404.f_1, 10f, func_45(), 0))
				{
					Local_404 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_404.f_1, 10f, func_45(), 1, 0, 1);
					if (func_407(Local_404))
					{
						ENTITY::SET_ENTITY_COORDS(Local_404, func_44(), 1, 0, 0, 1);
						ENTITY::SET_ENTITY_HEADING(Local_404, func_43());
		...
		if (!ENTITY::DOES_ENTITY_EXIST(Local_410))
		{
			...
			{
				if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_410.f_1, 10f, func_42(), 0))
				{
					Local_410 = OBJECT::GET_CLOSEST_OBJECT_OF_TYPE(Local_410.f_1, 10f, func_42(), 1, 0, 1);
				}
			}
		}
	}
...
void func_46()//Position - 0x1162
{
	...
	if (func_21(Local_384))
	{
		if (func_407(Local_392))
		{
			if (func_55(2))
			{
				...
				TASK::TASK_SYNCHRONIZED_SCENE(Local_384, uVar0, func_38(), func_48(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(Local_392, uVar0, func_47(), func_38(), 1000f, -8f, iVar1, 1148846080);
...
int func_51(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x128A
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x135D
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
bool func_56(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x1433
{
		...
		case 0:
			...
			if (iLocal_101 == 4)
			{
				if (func_21(Local_384))
				{
					...
					func_107(Local_384, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_384))
					{
						if (func_106(Local_384, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
							AUDIO::STOP_PED_SPEAKING(Local_384, 0);
							func_104(Local_384, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
			...
			else
			{
				if (!iLocal_433)
				{
					...
					if (iLocal_101 == 4)
					{
						if (func_21(Local_384))
						{
							if (func_106(Local_384, Local_679, 35f))
							{
								func_87(&uLocal_498, 4, Local_384, "MAUDE", 0, 1);
				...
				if (iLocal_101 == 4)
				{
					...
					else if (func_21(Local_384))
					{
						if (!func_61(Local_384, 1805844857))
						{
							if (!PED::IS_PED_FLEEING(Local_384))
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_384, func_103(), func_70(), 3))
								{
									func_69(&Local_384);
...
void func_94(struct<3> Param0, float fParam3)//Position - 0x27B0
{
	func_95(&(Global_93588.f_2167), Param0, fParam3);
}

void func_95(var uParam0, struct<3> Param1, var uParam4)//Position - 0x27C9
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_96(struct<3> Param0, float fParam3)//Position - 0x27DF
{
...
bool func_97(struct<3> Param0, struct<3> Param3)//Position - 0x280A
{
...
bool func_106(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2C8B
{
...
void func_117()//Position - 0x2FF1
{
	...
	{
		func_120(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
void func_125(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3AE9
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_91351.f_4))
	{
		...
		{
			if (func_172(24) != Global_91351.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_169(ENTITY::GET_ENTITY_COORDS(Global_91351.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_126(Global_91351.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_126(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3B64
{
	struct<54> Var0;
...
void func_127(int iParam0, int iParam1, int iParam2)//Position - 0x3C8F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97353.f_18371.f_4249 = func_143();
			}
...
void func_128(int iParam0, int iParam1)//Position - 0x3DAC
{
	...
	func_164(iParam0, &(Global_97353.f_18371.f_4742));
}
...
int func_154(var uParam0, int iParam1)//Position - 0x4ADA
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_97(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_97(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_97(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_157(int iParam0, struct<54> Param1, struct<3> Param55, float fParam58, int iParam59)//Position - 0x6488
{
	if (func_154(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_162(iParam0);
			func_161(Param1, &(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_161(struct<54> Param0, var uParam54)//Position - 0x6645
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_165(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_169(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x6CFA
{
	int iVar0;
...
int func_170(struct<3> Param0, int iParam3, int iParam4)//Position - 0x6E10
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_173(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x6ED3
{
	func_174(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_174(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x6EFC
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_176(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x730C
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_177(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x7602
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_180(struct<3> Param0, int iParam3)//Position - 0x775A
{
	return func_181(Global_91351.f_2167.f_12.f_42, Param0, iParam3);
}

int func_181(int iParam0, struct<3> Param1, int iParam4)//Position - 0x7777
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_187(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x7A0F
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_197(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_197(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_197(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_228(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_197(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_197(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_197(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_188(int iParam0, int iParam1, int iParam2)//Position - 0x81FD
{
	...
	{
		if (!func_300(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_195(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8AEA
{
	...
	{
		if (!func_300(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_210(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
int func_210(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB2C3
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_197(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_217(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[0], Global_97353.f_1729.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_217(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[1], Global_97353.f_1729.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_217(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[2], Global_97353.f_1729.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_216(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_216(Var16.f_2)] = func_210(iParam1, Var16.x, func_216(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDB2C
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_197(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
void func_230(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE7E5
{
	...
	iVar0 = Global_2454605[iParam0 /*6*/][func_231(iParam2)];
	if (iVar0 != 0)
	{
...
int func_232(int iParam0, int iParam1, int iParam2)//Position - 0xE844
{
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_231(iParam1)];
...
void func_245(int iParam0, int iParam1, int iParam2)//Position - 0x122E2
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_239(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_197(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_239(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_300(int iParam0, int iParam1, int iParam2)//Position - 0x23749
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_197(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_197(iParam1)))
	{
		return 1;
	}
	return 0;
				...
				if (!iLocal_447)
				{
					...
					if (Local_111.f_10 == 22 || Local_111.f_10 == 23)
					{
						...
						else
						{
							...
							{
								if (func_114(iLocal_461, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_106(Local_111.f_9, Local_679, 30f))
									{
...
void func_310(int iParam0, struct<3> Param1, int iParam4, float fParam5)//Position - 0x24078
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_314(int iParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x24348
{
	int iVar0;
...
int func_315(int iParam0, struct<3> Param1, float fParam4, float fParam5)//Position - 0x244BE
{
...
void func_319(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2458B
{
...
void func_320(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x245C3
{
	int iVar0;
	int iVar1;
...
void func_328(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x24CAF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_21(Local_111.f_9))
	{
		if (iLocal_252 == 0)
		{
			...
			if (func_352())
			{
				if (iLocal_447 || iLocal_97 == 7)
				{
					if (bLocal_453)
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_111.f_9, func_351(), 1048576000);
						iLocal_252 = 2;
					}
					else
					{
						PED::SET_PED_MOVEMENT_CLIPSET(Local_111.f_9, func_350(), 1048576000);
						iLocal_252 = 1;
					}
				}
			}
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_111.f_10)
			{
				...
				case 3:
					if (func_114(Local_111.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
				...
				case 7:
					if (func_114(Local_111.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 1000)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_111.f_9))
						{
							PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_111.f_9);
				...
				case 40:
					if (func_114(Local_111.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 750)))
					{
				...
				case 22:
					if (func_114(Local_111.f_18, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_111.f_9))
						{
				...
				case 23:
					if (!func_61(Local_111.f_9, 1805844857) && !PED::IS_PED_FLEEING(Local_111.f_9))
					{
						Local_111.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						Local_111.f_10 = 22;
					}
				...
				case 24:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_253[0 /*6*/], 0) && func_106(Local_253[0 /*6*/], Local_253[0 /*6*/].f_1, 3f)) && func_349(ENTITY::GET_ENTITY_HEADING(Local_253[0 /*6*/]), Local_253[0 /*6*/].f_4, 20f))
						{
							if (PED::IS_PED_IN_VEHICLE(Local_111.f_9, Local_253[0 /*6*/], 0) && !PED::IS_PED_BEING_JACKED(Local_111.f_9))
							{
								Local_111.f_10 = 25;
							}
							else if (func_114(Local_111.f_18, MISC::GET_RANDOM_INT_IN_RANGE(250, 350)))
							{
								if (PED::IS_PED_USING_ANY_SCENARIO(Local_111.f_9))
								{
									PED::SET_PED_PANIC_EXIT_SCENARIO(Local_111.f_9, Local_679);
				...
				case 25:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_253[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_111.f_9)) || !func_106(Local_253[0 /*6*/], Local_253[0 /*6*/].f_1, 3f)) || !func_349(ENTITY::GET_ENTITY_HEADING(Local_253[0 /*6*/]), Local_253[0 /*6*/].f_4, 20f))
					{
						Local_111.f_10 = 22;
					}
				...
				case 26:
					if (func_92(Local_253[0 /*6*/]) && PED::IS_PED_SITTING_IN_VEHICLE(Local_111.f_9, Local_253[0 /*6*/]))
					{
				...
				case 30:
					...
					else if (PED::DOES_GROUP_EXIST(func_345()))
					{
						...
						if (!PED::IS_PED_GROUP_MEMBER(Local_111.f_9, func_345()))
						{
							PED::SET_PED_AS_GROUP_MEMBER(Local_111.f_9, func_345());
						}
...
int func_356(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x27082
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_360(struct<3> Param0, struct<3> Param3)//Position - 0x2734E
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
{
	if (func_56(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_676, 100f))
	{
		if (!func_364())
		{
	...
	{
		if (!func_56(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_676, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
int func_366(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)//Position - 0x27784
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
			...
			else
			{
				...
				else if (Local_111.f_10 == 33 && func_61(Local_111.f_9, -1519143300))
				{
					if (func_106(Local_111.f_9, Local_679, 25f))
					{
						...
						{
							if (func_114(iLocal_462, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_59())
								{
									func_5();
				...
				else
				{
					...
					if (!func_59())
					{
						if (func_114(iLocal_461, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_106(Local_111.f_9, Local_679, 20f))
							{
			...
			case 1:
				if (!iLocal_448)
				{
					...
					else
					{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_106(PLAYER::PLAYER_PED_ID(), Local_676, 6.5f))
							{
								iLocal_99 = 2;
							}
						}
						else if (func_106(PLAYER::PLAYER_PED_ID(), Local_676, 2.5f))
						{
							iLocal_99 = 2;
						}
					}
...
bool func_374(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2821D
{
	struct<3> Var0;
...
int func_375(struct<3> Param0, int iParam3, int iParam4)//Position - 0x28247
{
	int iVar0;
...
void func_383()//Position - 0x28EDB
{
	if (iLocal_477 < 10)
	{
		...
		{
			if (func_114(iLocal_478, MISC::GET_RANDOM_INT_IN_RANGE(2500, 4000)))
			{
				iLocal_430 = 0;
			}
		}
...
int func_386(int iParam0, struct<3> Param1, float fParam4)//Position - 0x28FFC
{
	struct<3> Var0;
	float fVar3;
...
int func_401(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x29B43
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_406(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x29CCF
{
...
void func_420(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2A1A6
{
	if (func_460())
	{
...
void func_421(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x2A23B
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_455(iParam6, iParam7, iParam8))
		{
			iVar0 = 0;
		}
	}
...
int func_422(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2A3C3
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_433(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_433(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
...
void func_423(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2B1A9
{
	...
	if ((func_80(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_166(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_426(*iParam1);
				...
				func_424(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_424(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
void func_436(int iParam0, int iParam1)//Position - 0x2DD0D
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_155(iParam0, iParam1))
				{
...
void func_437(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2DDAE
{
	int iVar0;
...
void func_438(int iParam0)//Position - 0x2DDFE
{
	...
	if (func_154(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_67138.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_160(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_439(0, Global_67138.f_555[0 /*21*/].f_12) || !func_439(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_161(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
int func_439(int iParam0, int iParam1)//Position - 0x2DF73
{
	...
	if (iParam0 < 0 || iParam0 >= func_440(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_131(Global_97353.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}
...
int func_441(struct<3> Param0, float fParam3)//Position - 0x2DFEF
{
	return func_442(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_442(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2E009
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_444(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2E376
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_446(iParam0, uVar1[iVar6], 1) && func_445(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_97(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_445(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2E57C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_447(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x2E628
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_449(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_448())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_165(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
{
	return func_450(&(Global_93588.f_2167));
}

void func_453()//Position - 0x2EAE2
{
	func_454(&(Global_93588.f_2167));
}
...
int func_455(int iParam0, int iParam1, int iParam2)//Position - 0x2EB13
{
	...
	if (iParam2 == 0 && func_457(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
{
	return func_451(&(Global_93588.f_2167));
}
...
void func_461()//Position - 0x2ECB1
{
	...
	if (func_21(PLAYER::PLAYER_PED_ID()))
	{
		func_87(&uLocal_498, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
int func_465(var uParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6, bool bParam7)//Position - 0x2F342
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_53(iParam6))
...
int func_466(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2F3B3
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
Vector3 func_467(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x2F44C
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_468(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x2F4C0
{
	switch (Param0.f_4)
	{
		case 0:
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_484()) || Global_96400) || Global_24446) || func_490()) || func_85(8, -1)) || func_489()) || func_488()) || func_482()) || func_483()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_484()) || Global_24446) || func_490()) || func_85(8, -1)) || func_482()) || func_489()) || func_488()) || func_483()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_484()) || Global_96400) || Global_24446) || func_490()) || func_85(8, -1)) || func_482()) || func_489()) || func_488()) || func_483()) || Global_97353.f_5944.f_919[iVar0] == 5) || Global_35460 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_484()) || Global_96400) || Global_24446) || func_490()) || func_85(8, -1)) || func_489()) || func_488()) || func_483()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_484() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_85(8, -1)) || func_483()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_484()) || Global_24446) || func_490()) || func_85(8, -1)) || func_488()) || func_482()) || func_483()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_484()) || func_488()) || Global_96400) || Global_24446) || func_490()) || Global_35957) || func_85(8, -1)) || func_482()) || func_487()) || func_483()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_484()) || Global_96400) || Global_24446) || func_490()) || func_85(8, -1)) || func_482()) || func_487()) || func_489()) || func_488()) || func_483())
						{
							return 0;
						}
						break;
