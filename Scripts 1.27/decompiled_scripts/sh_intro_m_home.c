		...
		switch (iLocal_37)
		{
			case 0:
				if (func_192(0, 1093140480, 0))
				{
					...
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[1 /*3*/], Var7[1 /*3*/], fVar14[1], iVar21, 0, 0, 2);
					}
			...
			case 1:
				...
				Var17 = { func_57(Var7[0 /*3*/]) };
				fVar20 = 12f;
				if (((((((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && INTERIOR::IS_VALID_INTERIOR(uLocal_50)) && INTERIOR::IS_VALID_INTERIOR(uLocal_51)) && INTERIOR::IS_INTERIOR_READY(uLocal_50)) && INTERIOR::IS_INTERIOR_READY(uLocal_51)) && (MISC::GET_GAME_TIMER() - iLocal_47) > iVar21) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar22)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
			...
			case 2:
				...
				Var17 = { func_57(Var7[0 /*3*/]) };
				fVar20 = 10f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_47) > iVar21) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar22)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var7[0 /*3*/], fVar14[0], iVar21, 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[1 /*3*/], Var7[1 /*3*/], fVar14[1], iVar21, 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 3:
				...
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_47) > iVar21) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar22)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var7[0 /*3*/], fVar14[0], (iVar21 / 2), 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[1 /*3*/], Var7[1 /*3*/], fVar14[1], (iVar21 / 2), 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 4:
				...
				Var17 = { func_57(Var7[0 /*3*/]) };
				fVar20 = 12f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_47) > (iVar21 / 2)) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar22)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var7[0 /*3*/], fVar14[0], (iVar21 / 2), 1, 1, 2);
			...
			case 5:
				if (iLocal_43 == 0)
				{
					if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(CAM::_GET_CAM_ACTIVE_VIEW_MODE_CONTEXT()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_47) >= (iVar21 - 300))
					{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_47) > iVar21)
				{
					iLocal_37 = 6;
				}
				break;
...
void func_11(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x10ED
{
	struct<54> Var0;
...
void func_44(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x3A34
{
	if (func_40(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
...
void func_48(struct<54> Param0, var uParam54)//Position - 0x3BF1
{
...
bool func_51(struct<3> Param0, struct<3> Param3)//Position - 0x3D99
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_53(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_58(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x42FE
{
	int iVar0;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x4503
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_102(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_71(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_71(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7DB6
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_90(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_90(Var16.f_2)] = func_84(iParam1, Var16.x, func_90(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA61F
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_71(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_118(14))
			{
				...
				uVar0 = func_107(func_116(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_107(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_121(int iParam0, int iParam1, int iParam2)//Position - 0xEDE0
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_114(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_71(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_114(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_176(int iParam0, int iParam1, int iParam2)//Position - 0x20246
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_71(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_71(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_178()//Position - 0x204B7
{
	...
	{
		if (func_180(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
bool func_211(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2113D
{
	struct<3> Var0;
...
bool func_212(var uParam0, struct<2> Param1, var uParam3)//Position - 0x21167
{
	bool bVar0;
	int iVar1;
	int iVar2;
