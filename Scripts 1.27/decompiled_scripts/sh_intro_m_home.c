...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_46 = -1;
	iLocal_42 = 0;
	uLocal_50 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-809.1374f, 179.9676f, 71.1531f, "v_michael");
	uLocal_51 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-812.1f, 188.2f, 73.2f, "v_michael_garage");
	iLocal_40 = 0;
	iLocal_41 = 0;
	func_215(&uLocal_52);
		...
		switch (iLocal_36)
		{
			...
			case 2:
				if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					...
					Var0 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
					if (func_211(Var0, Var1, 100f) || iLocal_39)
					{
						if (func_208() || iLocal_39)
						{
							...
							if (INTERIOR::IS_VALID_INTERIOR(uLocal_51))
							{
								if (!INTERIOR::IS_INTERIOR_READY(uLocal_51))
								{
									INTERIOR::PIN_INTERIOR_IN_MEMORY(uLocal_51);
									iLocal_41 = 1;
								}
							}
							if (Global_17890)
							...
							if ((Var0.f_2 > 59f && Var0.f_2 < 90f) || iLocal_39)
							{
								if (func_212(&uLocal_52, Var0) || iLocal_39)
								{
									if (func_202() || iLocal_39)
									{
										...
										if (STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() || iLocal_42)
										{
											if ((iLocal_42 || STREAMING::IS_NEW_LOAD_SCENE_LOADED()) || (MISC::GET_GAME_TIMER() - iLocal_49) > 12000)
											{
												STREAMING::NEW_LOAD_SCENE_STOP();
												iLocal_49 = MISC::GET_GAME_TIMER();
												func_201(1);
			...
			case 3:
				if ((((INTERIOR::IS_VALID_INTERIOR(uLocal_50) && INTERIOR::IS_INTERIOR_READY(uLocal_50)) && INTERIOR::IS_VALID_INTERIOR(uLocal_51)) && INTERIOR::IS_INTERIOR_READY(uLocal_51)) || (MISC::GET_GAME_TIMER() - iLocal_49) > 500)
				{
					STREAMING::NEW_LOAD_SCENE_STOP();
					iLocal_49 = MISC::GET_GAME_TIMER();
					iLocal_37 = 0;
			...
			case 5:
				func_1(25);
				MISC::SET_BIT(&(Global_280007[17]), 1);
				MISC::SET_BIT(&(Global_280007[18]), 1);
				MISC::SET_BIT(&(Global_280007[19]), 1);
				func_216();
				break;
		}
		SYSTEM::WAIT(0);
...
int func_1(int iParam0)//Position - 0x578
{
	int iVar0;
	int iVar1;
	...
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		switch (iLocal_37)
		{
			case 0:
				if (func_192(0, 1093140480, 0))
				{
					...
					fVar2[1] = 39.8f;
					Var3 = { func_57(Var1[0 /*3*/]) };
					if (!CAM::DOES_CAM_EXIST(uLocal_45))
					{
						uLocal_45 = CAM::CREATE_CAM("DEFAULT_SCRIPTED_CAMERA", 1);
					}
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], iVar5, 0, 0, 2);
					}
			...
			case 1:
				...
				Var3 = { func_57(Var1[0 /*3*/]) };
				fVar4 = 12f;
				if (((((((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && INTERIOR::IS_VALID_INTERIOR(uLocal_50)) && INTERIOR::IS_VALID_INTERIOR(uLocal_51)) && INTERIOR::IS_INTERIOR_READY(uLocal_50)) && INTERIOR::IS_INTERIOR_READY(uLocal_51)) && (MISC::GET_GAME_TIMER() - iLocal_47) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
			...
			case 2:
				...
				Var3 = { func_57(Var1[0 /*3*/]) };
				fVar4 = 10f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_47) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], iVar5, 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], iVar5, 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 3:
				...
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_47) > iVar5) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], (iVar5 / 2), 1, 1, 2);
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[1 /*3*/], Var1[1 /*3*/], fVar2[1], (iVar5 / 2), 1, 1, 2);
						STREAMING::NEW_LOAD_SCENE_STOP();
			...
			case 4:
				...
				Var3 = { func_57(Var1[0 /*3*/]) };
				fVar4 = 12f;
				if (((STREAMING::IS_NEW_LOAD_SCENE_ACTIVE() && STREAMING::IS_NEW_LOAD_SCENE_LOADED()) && (MISC::GET_GAME_TIMER() - iLocal_47) > (iVar5 / 2)) || (MISC::GET_GAME_TIMER() - iLocal_49) > iVar6)
				{
					if (CAM::DOES_CAM_EXIST(uLocal_45))
					{
						CAM::SET_CAM_PARAMS(uLocal_45, Var0[0 /*3*/], Var1[0 /*3*/], fVar2[0], (iVar5 / 2), 1, 1, 2);
			...
			case 5:
				if (iLocal_43 == 0)
				{
					if (CAM::GET_CAM_VIEW_MODE_FOR_CONTEXT(CAM::_GET_CAM_ACTIVE_VIEW_MODE_CONTEXT()) == 4 && (MISC::GET_GAME_TIMER() - iLocal_47) >= (iVar5 - 300))
					{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_47) > iVar5)
				{
					iLocal_37 = 6;
				}
				break;
			...
			case 6:
				...
				if (CAM::DOES_CAM_EXIST(uLocal_45))
				{
					CAM::SET_CAM_ACTIVE(uLocal_45, 0);
					CAM::DESTROY_CAM(uLocal_45, 0);
				}
				...
				if (iLocal_41)
				{
					if (INTERIOR::IS_VALID_INTERIOR(uLocal_51))
					{
						INTERIOR::UNPIN_INTERIOR(uLocal_51);
					}
					iLocal_41 = 0;
				}
				STREAMING::NEW_LOAD_SCENE_STOP();
		...
		if (iLocal_37 > 0 && iLocal_37 < 6)
		{
			...
			if (!iLocal_44)
			{
				if (func_4(1000))
				{
					if ((MISC::GET_GAME_TIMER() - iLocal_48) > 1000)
					{
						iLocal_44 = 1;
					}
				}
...
int func_4(int iParam0)//Position - 0xE53
{
...
void func_6(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xECF
{
	var uVar0;
...
int func_7(int iParam0)//Position - 0xF76
{
	if (func_8(uParam0))
	{
...
int func_8(int iParam0)//Position - 0xF96
{
...
void func_9(char* sParam0, var uParam1)//Position - 0xFB6
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, uParam1);
}

void func_10()//Position - 0xFCD
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iVar0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iVar0, 0))
		{
			...
			{
				ENTITY::SET_ENTITY_HEALTH(iVar0, 10);
			}
...
void func_11(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x10ED
{
	struct<54> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_44(iParam3, Var0, Param1, fParam2, func_50(iParam0));
		func_12(iParam3, iParam0, 0);
	}
}

void func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1218
{
	int iVar0;
...
void func_13(int iParam0, int iParam1)//Position - 0x1335
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_52(iParam0, &(Global_17C49.f_47C3.f_1286));
}

int func_14(int iParam0)//Position - 0x1536
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_26(iParam0, 0, 0)) || func_26(iParam0, 1, 0)) || func_26(iParam0, 2, 0)) || func_50(iParam0) != 145) || func_25(iParam0)) || func_24(iParam0)) || func_23(iParam0)) || func_22(iParam0)) || !func_15(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_24(iParam0))
		{
		}
...
int func_15(int iParam0)//Position - 0x1613
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_16(int iParam0)//Position - 0x17C3
{
	int iVar0;
	struct<2> Var1;
...
int func_17()//Position - 0x1992
{
	return 0;
}

int func_18()//Position - 0x199B
{
	return 1;
}

int func_19()//Position - 0x19A4
{
	return 1;
}

int func_20()//Position - 0x19AD
{
...
int func_22(int iParam0)//Position - 0x1A49
{
	int iVar0;
	char* sVar1;
...
int func_23(int iParam0)//Position - 0x1A8D
{
	int iVar0;
...
int func_24(int iParam0)//Position - 0x1AC8
{
	int iVar0;
...
int func_25(int iParam0)//Position - 0x1B44
{
	int iVar0;
...
int func_26(int iParam0, int iParam1, bool bParam2)//Position - 0x1C2C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_27(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x1C9D
{
...
int func_28(int iParam0)//Position - 0x1D72
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_30(var uParam0, int iParam1)//Position - 0x1DD4
{
	if (iParam1 <= 0)
	{
		return;
...
void func_31(var uParam0, int iParam1)//Position - 0x1E5A
{
...
void func_32(var uParam0, int iParam1)//Position - 0x1E8D
{
	int iVar0;
	int iVar1;
...
int func_33(int iParam0, int iParam1)//Position - 0x1EDE
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_34(var uParam0)//Position - 0x1F80
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_35(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_35(bool bParam0, int iParam1, int iParam2)//Position - 0x1FA5
{
	if (bParam0)
	{
		return iParam1;
...
int func_36(var uParam0)//Position - 0x1FBC
{
	return uParam0 & 15;
}

void func_37(var uParam0, int iParam1)//Position - 0x1FC9
{
...
void func_38(var uParam0, int iParam1)//Position - 0x2003
{
...
void func_39(var uParam0, int iParam1)//Position - 0x203E
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_40(var uParam0, int iParam1)//Position - 0x207A
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_51(Global_17C49.f_47C3.f_520[uParam0->f_E /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_51(Global_17C49.f_6C1.f_21B.f_9E0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_51(Global_17C49.f_6C1.f_21B.f_9E0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f))
		{
...
int func_41(int iParam0, int iParam1)//Position - 0x376E
{
	struct<58> Var0;
...
void func_42(int iParam0, var uParam1, int iParam2)//Position - 0x37B0
{
	int iVar0;
	struct<74> Var1;
...
bool func_43(int iParam0)//Position - 0x3A28
{
	return iParam0 < 3;
}

void func_44(int iParam0, struct<54> Param1, struct<3> Param2, var uParam3, int iParam4)//Position - 0x3A34
{
	if (func_40(&(Global_10642.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_49(iParam0);
			func_48(Param1, &(Global_17C49.f_47C3.f_45[Global_10642.f_22B[0 /*21*/].f_E /*54*/]));
...
void func_45(int iParam0, bool bParam1)//Position - 0x3B36
{
	if (iParam0 == -1)
	{
		return;
...
void func_46(int iParam0, int iParam1, bool bParam2)//Position - 0x3B93
{
	if (iParam0 == -1)
	{
		return;
...
bool func_47(int iParam0, int iParam1)//Position - 0x3BCE
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_48(struct<54> Param0, var uParam1)//Position - 0x3BF1
{
...
void func_49(int iParam0)//Position - 0x3CBC
{
	if (iParam0 == -1)
	{
		return;
...
int func_50(int iParam0)//Position - 0x3D36
{
	int iVar0;
...
bool func_51(struct<3> Param0, struct<3> Param1)//Position - 0x3D99
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

void func_52(int iParam0, var uParam1)//Position - 0x3DC2
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_54(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_35), func_53(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_53(int iParam0)//Position - 0x4070
{
	switch (iParam0)
	{
		case 1:
...
int func_54(int iParam0, var uParam1, var uParam2)//Position - 0x4120
{
	int iVar0;
	int iVar1;
...
void func_55(var uParam0)//Position - 0x41FA
{
	int iVar0;
...
void func_56(int iParam0)//Position - 0x42AA
{
...
Vector3 func_57(struct<3> Param0)//Position - 0x42D1
{
	return (-SYSTEM::SIN(Param0.f_2) * SYSTEM::COS(Param0.x)), (SYSTEM::COS(Param0.f_2) * SYSTEM::COS(Param0.x)), SYSTEM::SIN(Param0.x);
}

void func_58(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x42FE
{
	int iVar0;
...
void func_59(int iParam0, bool bParam1)//Position - 0x44B4
{
	if (CAM::IS_SCREEN_FADED_OUT() || CAM::IS_SCREEN_FADING_OUT())
	{
...
Vector3 func_60(var uParam0)//Position - 0x44F0
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x4503
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_10A0A[1 /*14*/] = { func_111(iVar10, iParam1, iParam2) };
		if (!func_110(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_10A0A[1 /*14*/] = { func_111(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_10A0A[1 /*14*/] = { func_111(iVar10, 14, uVar12[iVar1]) };
			...
			{
				Global_10A0A[1 /*14*/] = { func_111(iVar10, iVar0, func_70(iParam0, iVar0, -1)) };
		...
		if (iParam7 == 1)
		{
			...
			Var14 = { func_111(iVar10, 14, iVar7) };
			if (iVar7 != -99)
			{
			...
			Var14 = { func_111(iVar10, 14, iVar8) };
			if (iVar8 != -99)
			{
			...
			Var14 = { func_111(iVar10, 14, iVar9) };
			if (iVar9 != -99)
			{
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_10A0A[1 /*14*/] = { func_111(iVar10, 14, uVar15[iVar1]) };
			func_81(iParam0, Global_10A0A[1 /*14*/].f_C, Global_10A0A[1 /*14*/].f_3, Global_10A0A[1 /*14*/].f_4);
			func_102(14);
			if (Global_10A09 == 1)
			{
...
int func_62(var uParam0, int iParam1, int iParam2)//Position - 0x4CF0
{
	int iVar0;
	...
	{
		if (!func_176(uParam0, Global_17C49.f_6C1.f_21B[iVar0 /*65*/].f_40, Global_17C49.f_6C1.f_21B[iVar0 /*65*/].f_3F))
		{
...
void func_64(int iParam0, int iParam1, int iParam2)//Position - 0x4DB7
{
	int iVar0;
	int iVar1;
...
int func_65(int iParam0, int iParam1, int iParam2)//Position - 0x4E41
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_66(int iParam0, int iParam1, int iParam2)//Position - 0x4F1F
{
	Global_10A0A[1 /*14*/] = { func_111(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 2);
}

int func_67(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x4F49
{
	var uVar0;
	int iVar1;
...
int func_68(int iParam0, int iParam1, int iParam2)//Position - 0x5544
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_69(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55DD
{
	int iVar0;
	...
	{
		if (!func_176(uParam0, Global_17C49.f_6C1.f_21B[iVar0 /*65*/].f_3D, Global_17C49.f_6C1.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
int func_70(int iParam0, int iParam1, int iParam2)//Position - 0x5673
{
	int iVar0;
	int iVar1;
...
int func_71(int iParam0)//Position - 0x5714
{
	switch (iParam0)
	{
		case 0:
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57C4
{
	int iVar0;
...
int func_73(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x5ACB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_74(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x667E
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6962
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C29
{
	int iVar0;
	int iVar1;
...
int func_77(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C60
{
	int iVar0;
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x6C89
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6F53
{
	int iVar0;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x71DD
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_81(var uParam0, var uParam1, int iParam2, var uParam3)//Position - 0x7334
{
	if (iParam2 == -1)
	{
...
struct<10> func_82(int iParam0, int iParam1)//Position - 0x735D
{
	int iVar0;
	struct<10> Var1;
...
void func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7C8C
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
int func_84(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7DB6
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_85(int iParam0, int iParam1)//Position - 0x7E96
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_86(int iParam0)//Position - 0x823E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_87(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x829F
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_88(int iParam0, int iParam1)//Position - 0x82E7
{
	int iVar0;
	struct<16> Var1;
...
void func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA12A
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_90(int iParam0)//Position - 0xA2DB
{
	switch (iParam0)
	{
		case 0:
...
void func_91(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA38B
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
int func_92(int iParam0, int iParam1, int iParam2)//Position - 0xA3FC
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA61F
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_94(int iParam0, int iParam1, int iParam2)//Position - 0xA719
{
	var uVar0;
	var uVar1;
...
int func_95(int iParam0, int iParam1, int iParam2)//Position - 0xAB0E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_96(int iParam0, int iParam1)//Position - 0xADED
{
	int iVar0;
	int iVar1;
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAE33
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_98(int iParam0, int iParam1)//Position - 0xAF2F
{
	int iVar0;
...
int func_99(int iParam0)//Position - 0xB06D
{
	switch (iParam0)
	{
		case 0:
...
int func_100(int iParam0, int iParam1)//Position - 0xB0F3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_101(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB153
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0xB1D7
{
	if (MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 1) && !MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 6))
	{
		func_109(iParam0, Global_10A0A[1 /*14*/].f_5, Global_10A0A[1 /*14*/].f_2, 2, Global_10A0A[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_103(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xB28F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_104(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0xB2D8
{
	int iVar0;
...
int func_105(var uParam0)//Position - 0xB303
{
	int iVar0;
	int iVar1;
...
int func_106()//Position - 0xB337
{
	return Global_1407E1;
}

int func_107(int iParam0, int iParam1, int iParam2)//Position - 0xB343
{
	var uVar0;
	var uVar1;
...
bool func_108(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xB375
{
	int iVar0;
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xBA16
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_110(int iParam0)//Position - 0xC935
{
	if (!MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_111(int iParam0, int iParam1, int iParam2)//Position - 0xC986
{
	func_175();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_112(int iParam0, int iParam1)//Position - 0xC9D8
{
	switch (iParam0)
	{
		case 0:
...
void func_113(int iParam0)//Position - 0xCAC8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_121(iVar7, iParam0, 155);
			return;
			break;
	}
	func_114(&(Global_10A0A[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_114(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xDD3E
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_118(14))
			{
				uVar0 = func_107(func_117(iParam1, uParam0->f_2), Global_10A08, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_107(func_116(iParam1, uParam0->f_2), Global_10A08, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_107(iVar1, Global_10A08, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
bool func_115(int iParam0, int iParam1, var uParam2)//Position - 0xE0C1
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_116(int iParam0, int iParam1)//Position - 0xE4C6
{
	switch (iParam1)
	{
		case 0:
...
int func_117(int iParam0, int iParam1)//Position - 0xE8C1
{
	switch (iParam1)
	{
		case 0:
...
bool func_118(int iParam0)//Position - 0xECBC
{
	return Global_8861 == iParam0;
}

int func_119(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xECCA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_120(int iParam0)//Position - 0xED0C
{
	switch (iParam0)
	{
		case -1:
...
void func_121(int iParam0, int iParam1, int iParam2)//Position - 0xEDE0
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_114(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_114(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_114(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
		...
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_114(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_122(int iParam0)//Position - 0xF05B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0xF1B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0xF6BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0xF732
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0xF7A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xF88B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xFBED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xFDFD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0x1002D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_131(int iParam0)//Position - 0x1013C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0x10ADA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x1164C
{
	if (iParam0 < 136)
	{
		func_135(iParam0);
...
void func_134(int iParam0)//Position - 0x11680
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0)//Position - 0x12284
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_136(int iParam0)//Position - 0x13192
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x132BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0, int iParam1)//Position - 0x133BB
{
	switch (iParam0)
	{
		case 0:
...
void func_139(int iParam0)//Position - 0x134AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x1499C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x14AEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x14FF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x15663
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x156D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x157A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x15CD4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x15E6A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x16667
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x16776
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x176A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x1835D
{
	if (iParam0 < 107)
	{
		func_154(iParam0);
...
void func_152(int iParam0)//Position - 0x183A2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x18E47
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x19C36
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x1A87F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1AAF7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0, int iParam1)//Position - 0x1AC3C
{
	switch (iParam0)
	{
		case 0:
...
void func_158(int iParam0)//Position - 0x1AD2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1BAB5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1BC2E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1C1A5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1C6CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1C741
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1C810
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1CCE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1CF4F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1D224
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1D3EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1DF3F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1EB88
{
	if (iParam0 < 60)
	{
		func_172(iParam0);
...
void func_171(int iParam0)//Position - 0x1EBBC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172(int iParam0)//Position - 0x1F95C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1FFE8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x200D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175()//Position - 0x201CD
{
...
int func_176(int iParam0, int iParam1, int iParam2)//Position - 0x20246
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = ENTITY::GET_ENTITY_MODEL(iParam0);
	Global_10A0A[1 /*14*/] = { func_111(iVar0, iParam1, iParam2) };
	if (!MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_176(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_176(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_10A0A[2 /*14*/] = { func_111(iVar0, 14, iVar4) };
					...
					else
					{
						...
						Global_10A0A[2 /*14*/] = { func_111(iVar0, iVar2, iVar1) };
...
int func_177()//Position - 0x2049E
{
	func_178();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_178()//Position - 0x204B7
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_180(Global_17C49.f_6C1.f_21B.f_C8D) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_179(PLAYER::PLAYER_PED_ID());
			if (func_43(iVar0) && (!func_118(14) || Global_17832))
			{
...
int func_179(int iParam0)//Position - 0x205B4
{
	int iVar0;
	int iVar1;
...
int func_180(int iParam0)//Position - 0x205F1
{
	if (func_43(iParam0))
	{
...
void func_181(bool bParam0)//Position - 0x2061B
{
	int iVar0;
...
void func_182(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x20657
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_183(PLAYER::PLAYER_ID()))
		{
...
int func_183(int iParam0)//Position - 0x20728
{
...
bool func_184()//Position - 0x20769
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_185(int iParam0, int iParam1)//Position - 0x2077A
{
	bool bVar0;
...
int func_186(int iParam0, bool bParam1)//Position - 0x207C5
{
	int iVar0;
	int iVar1;
...
int func_187(int iParam0, var uParam1, var uParam2)//Position - 0x20806
{
	int iVar0;
...
void func_189(int iParam0)//Position - 0x2085E
{
	if (iParam0 == 1)
	{
...
void func_190()//Position - 0x20881
{
	Global_38DE = 0;
	func_191();
}

void func_191()//Position - 0x20891
{
...
int func_192(int iParam0, int iParam1, int iParam2)//Position - 0x208B2
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_199(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iParam1, 1, 1056964608, 0, 1))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
			{
				iVar0 = 0;
				if (!func_198(PLAYER::PLAYER_PED_ID(), -828834893))
				{
...
bool func_193()//Position - 0x20985
{
	bool bVar0;
...
void func_194()//Position - 0x209A8
{
	Global_38DE = 0;
	func_195();
}

void func_195()//Position - 0x209B8
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
...
void func_197()//Position - 0x20A31
{
...
int func_198(var uParam0, int iParam1)//Position - 0x20A82
{
	if (func_7(uParam0))
	{
...
int func_199(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x20AB5
{
...
void func_200()//Position - 0x20C37
{
	if (iLocal_40)
	{
		if (INTERIOR::IS_VALID_INTERIOR(uLocal_50))
...
void func_201(bool bParam0)//Position - 0x20C6D
{
	if (bParam0)
	{
		if (!iLocal_39)
...
int func_203(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x20CE7
{
	int iVar0;
...
void func_204(var uParam0, int iParam1)//Position - 0x20E1E
{
	int iVar0;
...
bool func_205(int iParam0)//Position - 0x20E6D
{
	return func_206(iParam0, Global_8861);
}

int func_206(int iParam0, int iParam1)//Position - 0x20E7E
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_207(int iParam0)//Position - 0x2105F
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_208()//Position - 0x21081
{
	...
	if (Global_8A84 != -1)
	{
		if (Global_17C49.f_1738[Global_8A84 /*15*/].f_3 >= 2)
		{
			return 0;
		}
	}
...
bool func_211(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2113D
{
	struct<3> Var0;
...
bool func_212(var uParam0, struct<2> Param1, var uParam2)//Position - 0x21167
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_213(var uParam0)//Position - 0x21223
{
	int iVar0;
	float fVar1;
...
void func_214(var uParam0, struct<3> Param1)//Position - 0x212C3
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_215(var uParam0)//Position - 0x212F4
{
	if (uParam0->f_33)
	{
	}
...
void func_216()//Position - 0x2131B
{
	if (iLocal_46 != -1)
	{
		if (iLocal_38)
...
void func_217(int iParam0)//Position - 0x21396
{
	if (*iParam0 == -1)
	{
		return;
...
int func_218(int iParam0)//Position - 0x213D3
{
	int iVar0;
	int iVar1;
