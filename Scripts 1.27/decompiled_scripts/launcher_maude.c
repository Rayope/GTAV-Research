...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_249(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_233(&Var0, 1);
	}
	iVar2[0] = 31;
	if (!func_230(&iVar2, &Var0, Var1, 1f))
	{
		func_229();
	...
	while (true)
	{
		...
		func_172(Var0);
		func_164(&iLocal_52, &(Var0.f_9), Var1);
		if (func_149(&Var0, 0))
		{
			if (!func_2(&Var0))
			{
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5550
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5BEA
{
...
int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x5FA0
{
	int iVar0;
	float fVar1;
	float fVar2;
...
float func_168(int iParam0, struct<3> Param1, int iParam2)//Position - 0xABED
{
	struct<3> Var0;
...
int func_188(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xBD59
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
float func_192(struct<3> Param0, struct<3> Param1)//Position - 0xC027
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
int func_200(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xC3A5
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_212(var uParam0)//Position - 0xC735
{
	...
	switch (iLocal_50)
	{
		...
		case 2:
			...
			{
				func_216(&(uParam0->f_29[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_29[1]))
			{
				func_216(&(uParam0->f_29[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_213(&(uParam0->f_1C[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_110(uParam0->f_1C[0]) && func_111(uParam0->f_29[0]))
			{
				uParam0->f_3B = PED::CREATE_SYNCHRONIZED_SCENE(2727.4f, 4145.56f, 43.68f, 0f, 0f, -92.17f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_3B, 1);
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uParam0->f_3B, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uParam0->f_3B, "special_ped@maude@base", "base", 1000f, -4f, 4688, 0, 1148846080, 0);
				...
				iVar3 += 512;
				iVar3 += 4096;
				ENTITY::PLAY_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[0], uParam0->f_3B, "base_chair", "special_ped@maude@base", 1000f, -8f, iVar3, 1148846080);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_213(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xC9CD
{
	if (func_214(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_214(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)//Position - 0xCA28
{
	int iVar0;
...
void func_216(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xCAFC
{
	func_179(uParam0);
...
void func_218(int iParam0, bool bParam1, bool bParam2)//Position - 0xCB54
{
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				uLocal_51 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, 0, 1, 1, 1);
...
int func_230(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xD06A
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_231((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_231((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_231(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xD0CF
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_232(Var1.f_6, Param1, fParam2))
	{
...
int func_232(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xD14C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_247(var uParam0)//Position - 0xD4E1
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_3B))
	{
		...
		{
			if (func_248(uParam0->f_1C[0], 1785177548))
			{
		...
		if (func_111(uParam0->f_29[0]))
		{
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_29[0], -1000f, 1);
		}
	}
}
