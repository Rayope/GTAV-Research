...
void __EntryFunction__()//Position - 0x0
{
	...
	Local_58 = { 1492.31f, 2136.53f, 89.15f };
	Local_59 = { 1408.24f, 2522.803f, 41.0419f };
	Local_97 = { 370.2576f, -1597.488f, 35.94954f };
	Local_98 = { 824.992f, -1289.267f, 27.24564f };
	Local_99 = { 450.1889f, -981.6754f, 42.69174f };
	Local_100 = { -1088.37f, -842.2911f, 30.27554f };
	Local_101 = { 608.9076f, 0.806411f, 100.2497f };
	Local_102 = { -562.0159f, -130.8113f, 37.4369f };
	Local_103 = { 1855.237f, 3683.236f, 33.29165f };
	Local_104 = { -443.5063f, 6016.231f, 30.71787f };
	Local_105 = { 1693.518f, 2579.21f, 44.95713f };
	Local_56 = { ScriptParam_278.f_1[0 /*3*/] };
	func_185();
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_63))
			{
				PED::REMOVE_PED_FROM_GROUP(iLocal_63);
			}
		}
		func_170();
	}
	...
	if (func_128(Local_56, 22, iLocal_60, 0, 0))
	{
		func_125(22);
	}
	else
	...
	{
		SYSTEM::WAIT(0);
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || iLocal_79)
		{
			if (!func_124())
			{
				if (func_123())
								...
								switch (iLocal_52)
								{
									...
									case 1:
										if (iLocal_53 == 0)
										{
											if (!PED::IS_PED_INJURED(iLocal_63))
											{
												if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 100f, 100f, 100f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_63)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0))
												{
													func_101();
													if (!func_124())
													{
												...
												if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0))
												{
													if (HUD::DOES_BLIP_EXIST(uLocal_88))
													{
														HUD::SHOW_HEIGHT_ON_BLIP(uLocal_88, 1);
													}
													func_89();
													if (!func_88())
													{
														if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_63, "random@prisoner_lift", "arms_waving", 3) || ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_63, "random@prisoner_lift", "loop2_idlelook2", 3))
														{
										...
										else if (iLocal_53 == 1)
										{
											if (!PED::IS_PED_INJURED(iLocal_63))
											{
												if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 105f, 105f, 105f, 0, 1, 0) && !ENTITY::IS_ENTITY_OCCLUDED(iLocal_63)) || ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0))
												{
													func_101();
													if (!func_124())
													{
												...
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_63))
												{
													if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0))
													{
														if (HUD::DOES_BLIP_EXIST(uLocal_88))
												...
												if (bLocal_82)
												{
													...
													if (SYSTEM::TIMERA() > 3000)
													{
														if (!iLocal_85)
														{
															if (!func_83())
															{
																func_72(&uLocal_113, "PRI2AU", "PRI2_ASK", 4, 0, 0, 0);
																iLocal_85 = 1;
															}
														}
													}
												...
												if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
												{
													if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
													{
														...
														{
															if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::GET_PLAYERS_LAST_VEHICLE(), iLocal_63, 40f, 40f, 20f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_63, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 17))
															{
																TASK::CLEAR_PED_TASKS(iLocal_63);
																...
																TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_63, PLAYER::GET_PLAYERS_LAST_VEHICLE(), PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, 1);
																PED::SET_PED_KEEP_TASK(iLocal_63, 1);
																iLocal_52 = 13;
															}
															else if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 17))
															{
																func_72(&uLocal_113, "PRI2AU", "PRI2_FLEE", 4, 0, 0, 0);
																func_86();
															}
														}
														else
											...
											if (func_70())
											{
												if (!ENTITY::IS_ENTITY_DEAD(iLocal_63))
												{
													...
													{
														if (func_69(PLAYER::PLAYER_PED_ID(), iLocal_63) < 2.5f)
														{
															if (ENTITY::GET_ENTITY_SPEED(uLocal_66) < 1f)
															{
																func_68();
															}
														}
													}
													else if (func_69(PLAYER::PLAYER_PED_ID(), iLocal_63) < 10f)
													{
														if (ENTITY::GET_ENTITY_SPEED(uLocal_66) < 1f)
														{
															func_68();
										...
										if (!PED::IS_PED_INJURED(iLocal_63))
										{
											PED::SET_PED_CAN_PLAY_AMBIENT_BASE_ANIMS(iLocal_63, 0);
										}
										break;
									...
									case 6:
										if (!iLocal_87 && !PED::IS_PED_INJURED(iLocal_63))
										{
											...
											TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_76, 1f, -1, 0.25f, 0, 333.9002f);
											TASK::TASK_START_SCENARIO_IN_PLACE(0, "WORLD_HUMAN_SMOKING", 0, 1);
											TASK::CLOSE_SEQUENCE_TASK(uLocal_65);
											TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_65);
											TASK::CLEAR_SEQUENCE_TASK(&uLocal_65);
											PED::SET_PED_KEEP_TASK(iLocal_63, 1);
											func_72(&uLocal_113, "PRI1AU", "PRI1_THK", 4, 0, 0, 0);
											PED::REMOVE_PED_FROM_GROUP(iLocal_63);
											iLocal_87 = 1;
										}
										if (func_64())
										{
											if (!PED::IS_PED_INJURED(iLocal_63))
											{
												...
												func_51();
												SYSTEM::WAIT(0);
												func_72(&uLocal_113, "PRI1AU", "PRI1_SOB", 4, 0, 0, 0);
												TASK::TASK_SMART_FLEE_COORD(iLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 300f, -1, 0, 0);
												PED::SET_PED_KEEP_TASK(iLocal_63, 1);
												SYSTEM::WAIT(0);
											}
											func_86();
									...
									case 10:
										...
										if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
										{
											...
											{
												uLocal_61 = func_6(Local_73, 1);
											}
											if (func_72(&uLocal_113, "PRI1AU", "PRI1_LOS", 4, 0, 0, 0))
											{
												iLocal_52 = 3;
											}
										}
										if (bLocal_83)
										{
											if (ENTITY::DOES_ENTITY_EXIST(uLocal_72))
											{
												if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) || func_5(PLAYER::PLAYER_PED_ID(), uLocal_72, 1) > 200f)
												{
													ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_71[0]));
													ENTITY::SET_PED_AS_NO_LONGER_NEEDED(&(uLocal_71[1]));
													ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&uLocal_72);
												}
											}
										}
										if (func_64())
									...
									case 11:
										...
										if (VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_66, 0))
										{
											if (!func_71(iLocal_66))
											{
												if (!iLocal_84)
												{
													if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !PED::IS_PED_IN_ANY_VEHICLE(iLocal_63, 0))
													{
														if (!PED::IS_PED_INJURED(iLocal_63))
														{
															if (!iLocal_86)
															{
																func_72(&uLocal_113, "PRI2AU", "PRI2_STEAL", 4, 0, 0, 0);
																iLocal_86 = 1;
															}
															TASK::TASK_ENTER_VEHICLE(iLocal_63, iLocal_66, -1, -1, 2f, 1, 0);
															PED::SET_PED_KEEP_TASK(iLocal_63, 1);
															iLocal_52 = 12;
														}
													}
													if (!PED::IS_PED_INJURED(iLocal_63))
													{
														if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 1) || (PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_63) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))) || (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_63) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))) || (ENTITY::GET_ENTITY_SPEED(iLocal_66) > 2.5f && PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_66, 0)))
														{
										...
										if (!PED::IS_PED_INJURED(iLocal_63))
										{
											if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 150f, 150f, 150f, 0, 1, 0))
											{
												TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
												TASK::TASK_SMART_FLEE_COORD(0, 1449.05f, 2507.258f, 44.8843f, 1000f, -1, 0, 0);
												TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 300f, -1, 0, 0);
									...
									case 12:
										...
										if (!PED::IS_PED_INJURED(iLocal_63))
										{
											if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 1))
											{
												if (HUD::DOES_BLIP_EXIST(uLocal_88))
												{
													HUD::SET_BLIP_AS_FRIENDLY(uLocal_88, 0);
													ENTITY::CLEAR_ENTITY_LAST_DAMAGE_ENTITY(iLocal_63);
												}
											}
											if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
											{
												if (!func_71(iLocal_66))
												{
													if (PED::IS_PED_IN_VEHICLE(iLocal_63, iLocal_66, 0))
													{
														if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_66))
														{
															ENTITY::SET_ENTITY_AS_MISSION_ENTITY(iLocal_66, 1, 0);
														}
														TASK::TASK_VEHICLE_MISSION_PED_TARGET(iLocal_63, iLocal_66, PLAYER::PLAYER_PED_ID(), 8, 22f, 786469, 1f, 1f, 1);
														PED::SET_PED_KEEP_TASK(iLocal_63, 1);
														iLocal_52 = 13;
													}
													...
													else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, -1794415470) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, -1794415470) != 0)
													{
														if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 780511057) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 780511057) != 0)
														{
														}
														else
														{
									...
									case 13:
										...
										if (!PED::IS_PED_INJURED(iLocal_63))
										{
											if (PED::IS_PED_BEING_JACKED(iLocal_63))
											{
												func_51();
											}
											if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_63, 0))
											{
												if (HUD::DOES_BLIP_EXIST(uLocal_88))
												{
													HUD::SET_BLIP_AS_FRIENDLY(uLocal_88, 0);
												}
												if (VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0), joaat("towtruck")) || VEHICLE::IS_VEHICLE_MODEL(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0), joaat("towtruck2")))
												{
													uLocal_70 = VEHICLE::GET_ENTITY_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0));
													if (ENTITY::DOES_ENTITY_EXIST(uLocal_70))
													{
														iLocal_69 = ENTITY::GET_VEHICLE_INDEX_FROM_ENTITY_INDEX(uLocal_70);
														if (!ENTITY::IS_ENTITY_DEAD(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0)) && !ENTITY::IS_ENTITY_DEAD(iLocal_69))
														{
															if (VEHICLE::IS_VEHICLE_ATTACHED_TO_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0), iLocal_69))
															{
																VEHICLE::DETACH_VEHICLE_FROM_TOW_TRUCK(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0), iLocal_69);
															}
														}
													}
												}
												if (PED::IS_PED_ON_SPECIFIC_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0)))
												{
													TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
												...
												if (!iLocal_96)
												{
													if ((func_1(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0)) || !VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0), 0)) || func_71(PED::GET_VEHICLE_PED_IS_IN(iLocal_63, 0)))
													{
														if (HUD::DOES_BLIP_EXIST(uLocal_88))
														{
															HUD::SET_BLIP_AS_FRIENDLY(uLocal_88, 0);
												...
												if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 245f, 245f, 245f, 0, 1, 0))
												{
													func_86();
												}
											}
											else if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 242628503) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 242628503) != 0)
											{
												iLocal_52 = 11;
											}
											else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 200f, 200f, 200f, 0, 1, 0))
											{
												func_16();
											}
										}
...
var func_6(struct<3> Param0, int iParam1)//Position - 0x1208
{
	var uVar0;
...
void func_8()//Position - 0x124B
{
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (!func_88())
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 1227113341) != 1 && TASK::GET_SCRIPT_TASK_STATUS(iLocal_63, 1227113341) != 0)
				{
					TASK::TASK_GO_TO_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), -1, 6f, 2f, 1073741824, 0);
				}
				if (PED::IS_PED_IN_ANY_VEHICLE(iLocal_63, 0))
				{
					TASK::TASK_LEAVE_ANY_VEHICLE(iLocal_63, 0, 0);
				}
				if (!iLocal_94)
				{
					if (!func_83())
					{
						if (func_9())
						{
							func_72(&uLocal_113, "PRI1AU", "PRI1_UVH2", 4, 0, 0, 0);
						}
						else
						{
							func_72(&uLocal_113, "PRI1AU", "PRI1_UVH", 4, 0, 0, 0);
						}
						iLocal_94 = 1;
					}
				}
...
void func_10()//Position - 0x1392
{
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					if (PED::IS_PED_IN_VEHICLE(iLocal_63, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
					{
						if (HUD::DOES_BLIP_EXIST(uLocal_88))
						{
							HUD::REMOVE_BLIP(&uLocal_88);
			...
			else if (HUD::DOES_BLIP_EXIST(uLocal_61))
			{
		...
		else
		{
			if (!HUD::DOES_BLIP_EXIST(uLocal_88))
			{
				uLocal_88 = func_11(iLocal_63, 0, 145);
			}
			if (HUD::DOES_BLIP_EXIST(uLocal_61))
			{
				HUD::REMOVE_BLIP(&uLocal_61);
	...
	switch (iLocal_89)
	{
		case 0:
			if (func_14())
			{
				...
				func_51();
				SYSTEM::WAIT(0);
				func_72(&uLocal_113, "PRI1AU", "PRI1_STA", 4, 0, 0, 0);
				SYSTEM::SETTIMERA(0);
				iLocal_89++;
			}
			break;
		...
		case 1:
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 500)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
					{
						VEHICLE::SET_VEHICLE_STEER_BIAS(iLocal_66, -1f);
						if (HUD::DOES_BLIP_EXIST(uLocal_61))
						{
							HUD::REMOVE_BLIP(&uLocal_61);
						}
			...
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 2000)
				{
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
					{
						...
						TASK::TASK_VEHICLE_TEMP_ACTION(PLAYER::PLAYER_PED_ID(), iLocal_66, 24, 2000);
						iLocal_89++;
					}
				}
			}
			...
			if (func_14())
			{
				if (SYSTEM::TIMERA() > 4000)
				{
					...
					if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
					{
						...
						{
							PED::REMOVE_PED_FROM_GROUP(iLocal_63);
							VEHICLE::SET_VEHICLE_STEER_BIAS(iLocal_66, 0f);
							TASK::TASK_LEAVE_VEHICLE(iLocal_63, iLocal_66, 320);
							if (!HUD::DOES_BLIP_EXIST(uLocal_88))
							{
								uLocal_88 = func_11(iLocal_63, 1, 145);
							}
							iLocal_89++;
						}
					}
		...
		case 4:
			if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
			{
				if (!PED::IS_PED_INJURED(iLocal_63) && !PED::IS_PED_IN_VEHICLE(iLocal_63, iLocal_66, 0))
				{
					TASK::TASK_SMART_FLEE_COORD(iLocal_63, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 300f, -1, 0, 0);
					PED::SET_PED_KEEP_TASK(iLocal_63, 1);
					func_51();
...
int func_14()//Position - 0x1734
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
		{
			if (!PED::IS_PED_INJURED(iLocal_63))
			{
				if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_63, iLocal_66))
				{
					return 1;
				}
			}
...
{
	if ((!iLocal_87 && !PED::IS_PED_INJURED(iLocal_63)) && VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
	{
		PED::REMOVE_PED_FROM_GROUP(iLocal_63);
		TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
		TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 5000, 2048, 2);
...
void func_16()//Position - 0x1880
{
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_63, 0);
	}
	while (!func_50())
	{
		SYSTEM::WAIT(0);
...
void func_35()//Position - 0x2A08
{
	...
	{
		if (func_39(Global_17C49.f_6C1.f_21B.f_C8D) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_38(PLAYER::PLAYER_PED_ID());
			if (func_37(iVar0) && (!func_36(14) || Global_17832))
			{
...
void func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2F7B
{
	...
	iVar0 = Global_25744D[iParam0 /*6*/][func_47(iParam2)];
	if (iVar0 != 0)
	{
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x2FDA
{
	...
	uVar0 = Global_25744D[iParam0 /*6*/][func_47(iParam1)];
...
void func_53()//Position - 0x305F
{
	if (HUD::DOES_BLIP_EXIST(uLocal_61))
	{
		HUD::SET_BLIP_ROUTE(uLocal_61, 0);
		HUD::REMOVE_BLIP(&uLocal_61);
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			HUD::CLEAR_PRINTS();
			func_51();
			SYSTEM::WAIT(0);
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_THK", 4, 0, 0, 0))
			{
			}
		}
	}
...
void func_54()//Position - 0x30B4
{
	...
	if (!iLocal_80 && !iLocal_81)
	{
		if (func_49() == 0)
		{
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_CHAT1", 4, 0, 0, 0))
			{
				iLocal_80 = 1;
			}
		}
		...
		{
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_CHAT2", 4, 0, 0, 0))
			{
				iLocal_80 = 1;
			}
		}
	...
	if (iLocal_80 && !iLocal_81)
	{
		if (func_49() == 0)
		{
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_CHAT1b", 4, 0, 0, 0))
			{
				iLocal_81 = 1;
			}
		}
		...
		{
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_CHAT2b", 4, 0, 0, 0))
			{
				iLocal_81 = 1;
			}
		}
	...
	if (iLocal_80 && iLocal_81)
	{
		if (func_49() == 0)
		{
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_CHAT1c", 4, 0, 0, 0))
			{
				iLocal_80 = 0;
			}
		}
		...
		{
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_CHAT2c", 4, 0, 0, 0))
			{
				iLocal_80 = 0;
			}
		}
	...
	if (func_59(PLAYER::PLAYER_PED_ID(), Local_56, 1) > 200f)
	{
		if (!bLocal_83)
		{
			...
			{
				uLocal_72 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[0 /*3*/], func_57(Var0[0 /*3*/], func_58(PLAYER::PLAYER_ID())), 1, 1);
				uLocal_71[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
				uLocal_71[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[0], joaat("weapon_pistol"), -1, 0, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[1], joaat("weapon_pistol"), -1, 0, 1);
			...
			{
				uLocal_72 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[1 /*3*/], func_57(Var0[1 /*3*/], func_58(PLAYER::PLAYER_ID())), 1, 1);
				uLocal_71[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
				uLocal_71[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[0], joaat("weapon_pistol"), -1, 0, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[1], joaat("weapon_pistol"), -1, 0, 1);
			...
			{
				uLocal_72 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[2 /*3*/], func_57(Var0[2 /*3*/], func_58(PLAYER::PLAYER_ID())), 1, 1);
				uLocal_71[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
				uLocal_71[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[0], joaat("weapon_pistol"), -1, 0, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[1], joaat("weapon_pistol"), -1, 0, 1);
			...
			{
				uLocal_72 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), Var0[3 /*3*/], func_57(Var0[3 /*3*/], func_58(PLAYER::PLAYER_ID())), 1, 1);
				uLocal_71[0] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), -1, 1, 1);
				uLocal_71[1] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_72, 6, joaat("s_m_y_ranger_01"), 0, 1, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[0], joaat("weapon_pistol"), -1, 0, 1);
				WEAPON::GIVE_WEAPON_TO_PED(uLocal_71[1], joaat("weapon_pistol"), -1, 0, 1);
	...
	if (!ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_68, 0), 10f, 10f, 10f, 0, 0, 0) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
	{
		func_56();
	}
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (((!PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iLocal_63, 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, 0, 1, 0)) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 990.7705f, -105.594f, 73.3055f, 954.8849f, -145.3864f, 79.1073f, 8.8125f, 0, 1, 0)) || (ENTITY::IS_ENTITY_AT_COORD(iLocal_63, Local_73, Global_12, 1, 1, 0) && func_55(1, 0, 1)))
		{
			SYSTEM::SETTIMERA(0);
			if (func_14())
			{
...
void func_56()//Position - 0x3730
{
	...
	if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
	{
		if (func_14())
		{
			func_51();
			SYSTEM::WAIT(0);
			if (func_72(&uLocal_113, "PRI1AU", "PRI1_POL", 4, 0, 0, 0))
			{
				iLocal_52 = 10;
			}
		}
...
var func_57(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3)//Position - 0x391E
{
...
float func_59(int iParam0, struct<3> Param1, int iParam2)//Position - 0x394B
{
	struct<3> Var0;
...
void func_60()//Position - 0x3984
{
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (PED::IS_PED_ON_FOOT(iLocal_63))
		{
			if (!iLocal_107)
			{
	...
	if ((iLocal_109 - iLocal_108) > 120000)
	{
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_63))
			{
				if (func_72(&uLocal_113, "PRI1AU", "PRI1_WLK", 4, 0, 0, 0))
				{
					PED::REMOVE_PED_FROM_GROUP(iLocal_63);
					func_86();
				}
...
void func_61()//Position - 0x39FA
{
	...
	if ((iLocal_112 - iLocal_111) > 60000)
	{
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			if (PED::IS_PED_IN_GROUP(iLocal_63))
			{
				if (func_72(&uLocal_113, "PRI1AU", "PRI1_SLO", 4, 0, 0, 0))
				{
					PED::REMOVE_PED_FROM_GROUP(iLocal_63);
					func_86();
				}
...
int func_62()//Position - 0x3A68
{
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (PED::IS_PED_IN_GROUP(iLocal_63))
		{
			if ((((((((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_97, 50f, 50f, 50f, 0, 1, 0) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_98, 50f, 50f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_99, 50f, 50f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_100, 50f, 50f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_101, 50f, 50f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_102, 50f, 50f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_103, 50f, 50f, 50f, 0, 1, 0)) || ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_104, 50f, 50f, 50f, 0, 1, 0)) || func_59(PLAYER::PLAYER_PED_ID(), Local_105, 1) < 205f)
			{
				return 1;
			}
		}
...
{
	if (!PED::IS_PED_INJURED(iLocal_63) && func_88())
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
		{
			if (PED::IS_PED_SITTING_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)) && PED::IS_PED_SITTING_IN_VEHICLE(iLocal_63, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
			{
				SYSTEM::SETTIMERA(0);
				if (!PED::IS_PED_IN_GROUP(iLocal_63))
				{
					PED::SET_PED_AS_GROUP_MEMBER(iLocal_63, PLAYER::GET_PLAYER_GROUP(PLAYER::PLAYER_ID()));
					PED::SET_PED_GROUP_MEMBER_PASSENGER_INDEX(iLocal_63, 0);
					PED::SET_PED_NEVER_LEAVES_GROUP(iLocal_63, 1);
				}
				if (iLocal_53 == 0)
				{
					if (!func_83())
					{
						if (func_72(&uLocal_113, "PRI1AU", "PRI1_CH", 4, 0, 0, 0))
						{
							if (!HUD::DOES_BLIP_EXIST(uLocal_61))
							{
								uLocal_61 = func_6(Local_73, 1);
							}
							MISC::CLEAR_BIT(&uLocal_77, 3);
							iLocal_79 = 1;
							iLocal_52 = 3;
						}
					}
				...
				else if (iLocal_53 == 1)
				{
					if (func_49() == 0)
					{
						func_72(&uLocal_113, "PRI2AU", "PRI2_WHTM", 4, 0, 0, 0);
					}
					else if (func_49() == 1)
					{
						func_72(&uLocal_113, "PRI2AU", "PRI2_WHTF", 4, 0, 0, 0);
					}
					else if (func_49() == 2)
					{
						func_72(&uLocal_113, "PRI2AU", "PRI2_WHTT", 4, 0, 0, 0);
					}
					PED::SET_PED_FLEE_ATTRIBUTES(iLocal_63, 2, 1);
					iLocal_52 = 3;
				}
			}
		}
...
int func_64()//Position - 0x3CE9
{
	...
	if (!PED::IS_PED_INJURED(iLocal_63))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(PLAYER::GET_PLAYERS_LAST_VEHICLE(), 0))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_63, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1))
			{
				func_51();
				return 1;
			}
		...
		if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 250f, 250f, 250f, 0, 1, 0))
		{
			return 1;
		}
		if (iLocal_53 == 0)
		...
		if (iLocal_52 < 2)
		{
			if (PED::HAS_PED_RECEIVED_EVENT(iLocal_63, 126))
			{
				return 1;
			}
			if (iLocal_53 == 0)
			{
				...
				{
					if (((PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) + Vector(0f, 0f, 45f) - Vector(40f, 40f, 40f), ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) + Vector(0f, 0f, 45f) + Vector(40f, 40f, 40f)) || PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) - Vector(0f, 0f, 45f) - Vector(40f, 40f, 40f), ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) - Vector(0f, 0f, 45f) + Vector(40f, 40f, 40f))) || PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) + Vector(0f, 45f, 0f) - Vector(40f, 40f, 40f), ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) + Vector(0f, 45f, 0f) + Vector(40f, 40f, 40f))) || PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) - Vector(0f, 45f, 0f) - Vector(40f, 40f, 40f), ENTITY::GET_ENTITY_COORDS(iLocal_68, 0) - Vector(0f, 45f, 0f) + Vector(40f, 40f, 40f)))
					{
						TASK::TASK_SMART_FLEE_PED(iLocal_63, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
						PED::SET_PED_KEEP_TASK(iLocal_63, 1);
						return 1;
					}
				}
			...
			{
				if (PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_63, 0) - Vector(70f, 70f, 70f), ENTITY::GET_ENTITY_COORDS(iLocal_63, 0) + Vector(70f, 70f, 70f)))
				{
					return 1;
				}
			}
			if (MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), 20f, 1))
			{
				return 1;
			}
			if ((MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63, 1) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63, 1) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || MISC::IS_PROJECTILE_TYPE_IN_AREA(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1) - Vector(15f, 15f, 15f), ENTITY::GET_ENTITY_COORDS(iLocal_63, 1) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1))
			{
				return 1;
			}
			if (GRAPHICS::GET_IS_PETROL_DECAL_IN_RANGE(ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), 3f))
			{
				return 1;
			}
			if (PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0))
			...
			if ((ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0) && ENTITY::HAS_ENTITY_CLEAR_LOS_TO_ENTITY_IN_FRONT(iLocal_63, PLAYER::PLAYER_PED_ID())) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				if (PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_63) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_63))
				{
					return 1;
				}
			}
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
	{
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			if (!func_83())
			{
				if (func_9())
				{
					func_72(&uLocal_113, "PRI2AU", "PRI2_THREAT", 4, 0, 0, 0);
				}
				else
				{
					func_72(&uLocal_113, "PRI2AU", "PRI2_HIJ", 4, 0, 0, 0);
				}
				if (HUD::DOES_BLIP_EXIST(uLocal_88))
				{
					HUD::SET_BLIP_AS_FRIENDLY(uLocal_88, false);
				}
				TASK::CLEAR_PED_TASKS(iLocal_63);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
...
void func_84()//Position - 0x48F9
{
	...
	{
		if (!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), iLocal_68, 0) && !VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_68, -1))
		{
			AUDIO::_0x9D3AF56E94C9AE98(iLocal_68, 60000f);
			AUDIO::_SOUND_VEHICLE_HORN_THIS_FRAME(iLocal_68);
		}
	}
}
	...
	switch (iLocal_91)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_63))
			{
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 20f, 20f, 8f, 0, 1, 0))
				{
					if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 2.5f || !(PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_63, 15f, 15f, 8f, 0, 1, 0)))
					{
						TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
						...
						TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_65);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_65);
						if (func_72(&uLocal_113, "PRI1AU", "PRI1_ASK", 4, 0, 0, 0))
						{
							bLocal_82 = true;
							iLocal_91++;
						}
		...
		case 1:
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1))
			{
				...
				{
					iLocal_66 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
					if (ENTITY::GET_ENTITY_SPEED(iLocal_66) < 9f)
					{
						if (!PED::IS_PED_INJURED(iLocal_63))
						{
							if (ENTITY::IS_ENTITY_AT_ENTITY(iLocal_63, iLocal_66, 20f, 20f, 5f, 0, 1, 0))
							{
								iLocal_91++;
							}
						}
				...
				{
					fLocal_92 = func_5(iLocal_63, PLAYER::PLAYER_PED_ID(), 1);
					TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), 7000, 2048, 2);
					TASK::TASK_GO_TO_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, (fLocal_92 - 3f), 1f, 1073741824, 0);
					TASK::CLOSE_SEQUENCE_TASK(uLocal_65);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_65);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_65);
					if (!func_83())
		...
		case 2:
			...
			if (!iLocal_95)
			{
				if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) < 2.5f)
				{
					...
					{
						TASK::CLEAR_PED_TASKS(iLocal_63);
						TASK::TASK_OPEN_VEHICLE_DOOR(iLocal_63, iLocal_66, -1, 0, 1f);
						iLocal_95 = 1;
					}
				}
				if (!func_83())
			...
			{
				iLocal_66 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				if (ENTITY::GET_ENTITY_SPEED(iLocal_66) < 2.5f)
				{
					if (ENTITY::IS_ENTITY_AT_COORD(iLocal_66, ENTITY::GET_ENTITY_COORDS(iLocal_63, 1), 20f, 20f, 5f, 0, 1, 0))
					{
						if (iLocal_53 == 0)
						{
							if (!func_83())
							{
								if (func_49() == 0)
								{
									if (func_9())
									{
										func_72(&uLocal_113, "PRI1AU", "PRI1_GETONM", 4, 0, 0, 0);
									}
									else
									{
										func_72(&uLocal_113, "PRI1AU", "PRI1_JIM", 4, 0, 0, 0);
									}
								}
								else if (func_49() == 1)
								{
									if (func_9())
									{
										func_72(&uLocal_113, "PRI1AU", "PRI1_GETONF", 4, 0, 0, 0);
									}
									else
									{
										func_72(&uLocal_113, "PRI1AU", "PRI1_JIF", 4, 0, 0, 0);
									}
								}
								else if (func_49() == 2)
								{
									func_72(&uLocal_113, "PRI1AU", "PRI1_JIT", 4, 0, 0, 0);
								}
								iLocal_91++;
							}
						}
		...
		case 3:
			...
			{
				iLocal_66 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
				if (ENTITY::GET_ENTITY_SPEED(iLocal_66) < 0.5f)
				{
					if (!PED::IS_PED_INJURED(iLocal_63))
					{
						TASK::CLEAR_PED_TASKS(iLocal_63);
		...
		case 4:
			if (iLocal_53 == 0)
			{
				if (!func_83())
				{
					if (func_72(&uLocal_113, "PRI1AU", "PRI1_SH", 4, 0, 0, 0))
					{
						iLocal_91++;
					}
				}
		...
		case 5:
			if (func_88())
			{
				if (VEHICLE::IS_VEHICLE_DRIVEABLE(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 0))
				{
					if (!PED::IS_PED_INJURED(iLocal_63))
					{
						if (PED::IS_PED_SITTING_IN_VEHICLE(iLocal_63, PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0)))
						{
							if (HUD::DOES_BLIP_EXIST(uLocal_88))
							{
								HUD::REMOVE_BLIP(&uLocal_88);
	...
	switch (*uParam0)
	{
		case 0:
			if (!PED::IS_PED_INJURED(iLocal_63))
			{
				...
				{
					TASK::TASK_TURN_PED_TO_FACE_ENTITY(iLocal_63, PLAYER::PLAYER_PED_ID(), 0);
					*uParam0++;
				}
			}
			break;
...
void func_89()//Position - 0x4E92
{
	...
	{
		iLocal_66 = PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0);
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0) && !PED::IS_PED_INJURED(iLocal_63)) && !bLocal_82)
		{
			fLocal_92 = func_5(iLocal_63, PLAYER::PLAYER_PED_ID(), 1);
			if (fLocal_92 > 5f)
			{
				fLocal_92 = (fLocal_92 - 2.5f);
			}
			else
			{
				fLocal_92 = (fLocal_92 - 1f);
			}
			TASK::CLEAR_PED_TASKS(iLocal_63);
			TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
			if (iLocal_53 == 0)
			{
				TASK::TASK_LOOK_AT_ENTITY(0, iLocal_66, 10000, 2048, 2);
				TASK::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0, 0, 0, 0);
				TASK::TASK_GO_TO_ENTITY_WHILE_AIMING_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), PLAYER::PLAYER_PED_ID(), 1f, 0, fLocal_92, 1f, 1, 0, -957453492);
			}
			else if (iLocal_53 == 1)
			{
				TASK::TASK_LOOK_AT_ENTITY(0, iLocal_66, 10000, 2052, 2);
				TASK::TASK_PLAY_ANIM(0, "random@prisoner_lift", "arms_waving", 2f, -2f, -1, 49, 0, 0, 0, 0);
			...
			if (iLocal_53 == 0)
			{
				func_72(&uLocal_113, "PRI1AU", "PRI1_STO", 4, 0, 0, 0);
				SYSTEM::SETTIMERA(0);
				bLocal_82 = true;
			}
			else if (iLocal_53 == 1)
			{
				if (func_72(&uLocal_113, "PRI2AU", "PRI2_STO", 4, 0, 0, 0))
				{
					SYSTEM::SETTIMERA(0);
					bLocal_82 = true;
				}
...
int func_91(int iParam0)//Position - 0x500F
{
	if (func_95())
	{
		...
		if (func_29(Global_17C3E))
		{
			func_92(0);
		}
		HUD::SET_MISSION_NAME(1, "RE_TITLE");
		if (iParam0 && func_29(Global_17C3E))
		{
...
{
	switch (func_96(&Global_5FB7, 0, 5, 0, SCRIPT::GET_ID_OF_THIS_THREAD()))
	{
		case 1:
			return 1;
			break;
...
{
	return func_99(iParam0, Global_8861);
}
...
void func_101()//Position - 0x556D
{
	...
	{
		uLocal_88 = func_11(iLocal_63, 0, 145);
		HUD::SHOW_HEIGHT_ON_BLIP(uLocal_88, 0);
	}
}
...
void func_102()//Position - 0x55A0
{
	...
	iLocal_63 = PED::CREATE_PED(26, iLocal_75, Local_67, fLocal_74, 1, 1);
	PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(iLocal_63, 1);
	PED::SET_PED_CONFIG_FLAG(iLocal_63, 134, 1);
	PED::SET_PED_CONFIG_FLAG(iLocal_63, 137, 1);
	PED::ADD_RELATIONSHIP_GROUP("PedPrisoner", &iLocal_64);
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(iLocal_63, iLocal_64);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, joaat("COP"), iLocal_64);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_64, joaat("COP"));
	TASK::TASK_PLAY_ANIM(iLocal_63, "random@prisoner_lift", "loop2_idlelook2", 2f, -2f, -1, 1, 0, 0, 0, 0);
	PED::SET_PED_MONEY(iLocal_63, 0);
	PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_63, 8, 0);
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_63, 128, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_63, 2, 1);
	PED::SET_PED_FLEE_ATTRIBUTES(iLocal_63, 1, 0);
	MISC::SET_BIT(&uLocal_77, 3);
	MISC::SET_BIT(&uLocal_77, 5);
	MISC::SET_BIT(&uLocal_77, 0);
	if (iLocal_53 == 0)
	{
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_63, "REPRI1Lost");
		func_103(&uLocal_113, 3, iLocal_63, "REPRI1Lost", 0, 1);
		MISC::CLEAR_AREA_OF_PEDS(Local_67, 50f, 0);
		MISC::CLEAR_AREA(Local_67, 10f, 0, 0, 0, 0);
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_67 - Vector(50f, 50f, 50f), Local_67 + Vector(50f, 50f, 50f), 0, 1, 1, 1);
		PED::ADD_SCENARIO_BLOCKING_AREA(Local_73 - Vector(10f, 10f, 10f), Local_73 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_67 - Vector(10f, 10f, 10f), Local_67 + Vector(10f, 10f, 10f), 0, 1);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, iLocal_64, -1865950624);
		PED::SET_RELATIONSHIP_BETWEEN_GROUPS(1, -1865950624, iLocal_64);
		PED::SET_PED_COMBAT_ATTRIBUTES(iLocal_63, 17, 1);
		iLocal_68 = VEHICLE::CREATE_VEHICLE(joaat("sheriff"), 1524.332f, 2173.347f, 79.0619f, 201.6806f, 1, 1);
		VEHICLE::SET_VEHICLE_ENGINE_HEALTH(iLocal_68, 0f);
		VEHICLE::SET_VEHICLE_DOOR_OPEN(iLocal_68, 4, 0, 0);
		VEHICLE::SET_VEHICLE_TYRE_BURST(iLocal_68, 0, 0, 1148846080);
		VEHICLE::_0x0AD9E8F87FF7C16F(iLocal_68, 0);
		...
		uVar0 = PED::CREATE_PED_INSIDE_VEHICLE(iLocal_68, 26, joaat("s_m_y_ranger_01"), -1, 1, 1);
	...
	else if (iLocal_53 == 1)
	{
		...
		AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_63, "G_M_Y_STREETPUNK02_BLACK_MINI_04");
		func_103(&uLocal_113, 3, iLocal_63, "REPRI2Prisoner", 0, 1);
		WEAPON::GIVE_WEAPON_TO_PED(iLocal_63, joaat("weapon_pistol"), -1, 0, 1);
	}
	if (func_49() == 0)
	{
		func_103(&uLocal_113, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
	}
	else if (func_49() == 1)
	{
		func_103(&uLocal_113, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	}
	else if (func_49() == 2)
	{
		func_103(&uLocal_113, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	}
	iLocal_52 = 1;
}
...
void func_109()//Position - 0x5DD5
{
	...
	if (STREAMING::HAS_MODEL_LOADED(iLocal_75) && STREAMING::HAS_ANIM_DICT_LOADED("random@prisoner_lift"))
	{
		if (iLocal_53 == 0)
		{
...
void func_110()//Position - 0x5EA8
{
	if (iLocal_57 == 1)
	{
		iLocal_75 = joaat("g_m_y_lost_02");
		Local_67 = { 1538.09f, 2172.344f, 77.826f };
		fLocal_74 = 142.0201f;
		Local_76 = { 984.3975f, -106.9935f, 73.3531f };
		Local_73 = { 960.1481f, -139.4141f, 73.476f };
	}
	if (iLocal_57 == 2)
	{
		iLocal_75 = joaat("s_m_y_prisoner_01");
		Local_67 = { 1401.692f, 2528.085f, 40.3762f };
		fLocal_74 = 301.2458f;
		Local_76 = { 938.5384f, -2167.42f, 29.5153f };
		Local_73 = { 928.9882f, -2173.248f, 29.2873f };
	}
	iLocal_55 = 1;
}
...
{
	if ((Global_17C3E == func_43() && MISC::GET_RANDOM_EVENT_FLAG()) && Global_17C3F)
	{
		return 1;
	}
	return 0;
...
int func_128(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x7C3F
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_164(Global_17C49.f_6E20.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_129(struct<3> Param0, struct<3> Param1)//Position - 0x7FD8
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_162()) || Global_17890) || Global_5F7E) || func_161()) || func_80(8, -1)) || func_160()) || func_159()) || func_158()) || func_157()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_162()) || Global_5F7E) || func_161()) || func_80(8, -1)) || func_158()) || func_160()) || func_159()) || func_157()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_162()) || Global_17890) || Global_5F7E) || func_161()) || func_80(8, -1)) || func_158()) || func_160()) || func_159()) || func_157()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_162()) || Global_17890) || Global_5F7E) || func_161()) || func_80(8, -1)) || func_160()) || func_159()) || func_157()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_162() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_80(8, -1)) || func_157()) || func_156()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_162()) || func_159()) || Global_17890) || Global_5F7E) || func_161()) || Global_8C75) || func_80(8, -1)) || func_158()) || func_156()) || func_157()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
void func_170()//Position - 0x9262
{
	if (iLocal_106)
	{
		...
		VEHICLE::SET_ALL_VEHICLE_GENERATORS_ACTIVE_IN_AREA(Local_67 - Vector(10f, 10f, 10f), Local_67 + Vector(10f, 10f, 10f), 1, 1);
		...
		if (!PED::IS_PED_INJURED(iLocal_63))
		{
			...
			if (iLocal_53 == 0)
			{
				PED::SET_PED_CONFIG_FLAG(iLocal_63, 317, 1);
				if (PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
					TASK::TASK_SMART_FLEE_COORD(0, 1449.05f, 2507.258f, 44.8843f, 1000f, -1, 0, 0);
			...
			else if (iLocal_53 == 1)
			{
				...
				else if (VEHICLE::IS_VEHICLE_DRIVEABLE(iLocal_66, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_65);
					TASK::TASK_ENTER_VEHICLE(0, iLocal_66, -1, -1, 2f, 9, 0);
					TASK::TASK_SMART_FLEE_COORD(0, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 300f, -1, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(uLocal_65);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_63, uLocal_65);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_65);
...
void func_171(int iParam0)//Position - 0x94AF
{
	...
	if (func_124())
	{
		...
		func_174(30000);
		StringCopy(&cVar0, func_173(Global_17C3E, 1), 64);
		if (func_42(Global_17C3E) > 0)
		{
...
Vector3 func_185()//Position - 0x9CDC
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_58, 1);
		iLocal_57 = 1;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_59, 1) < fVar0)
		{
			fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_59, 1);
			iLocal_57 = 2;
		}
		if (iLocal_57 == 1)
		{
