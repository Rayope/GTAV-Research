...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_40 = 49;
	iLocal_41 = 64;
	Local_46 = { ScriptParam_237.f_1[0 /*3*/] };
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(11))
	{
		func_165();
	}
	if (func_123(Local_46, -1, 0, 0, 0))
	{
		func_120(-1);
	}
	else
	...
	{
		SYSTEM::WAIT(0);
		if (BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE() || bLocal_228)
		{
			if (!func_119())
			{
				if (func_118())
			...
			switch (iLocal_43)
			{
				...
				case 1:
					if (!bLocal_228)
					{
						...
						{
							PED::SET_PED_RESET_FLAG(iLocal_54, 247, 1);
						}
					}
					else
					{
					...
					{
						PED::SET_PED_RESET_FLAG(iLocal_55, 156, 1);
					}
					func_35();
					func_34();
					func_1();
...
void func_1()//Position - 0x18E
{
	if (bLocal_228)
	{
		...
		{
			if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 100f, 100f, 100f, 0, 1, 0))
			{
				func_2();
			}
		}
		else if (!ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 100f, 100f, 100f, 0, 1, 0))
		{
			func_3();
		}
	}
	else
	{
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), 1) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ANY_VEHICLE(iLocal_54))
			{
				func_2();
			}
		}
		if (PED::IS_PED_INJURED(iLocal_54))
		{
			if (!PED::IS_PED_INJURED(iLocal_55))
			{
				...
				TASK::TASK_PERFORM_SEQUENCE(iLocal_55, uLocal_60);
		...
		if (PED::IS_PED_INJURED(iLocal_55))
		{
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				...
				TASK::TASK_SMART_FLEE_PED(0, PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
				TASK::TASK_PERFORM_SEQUENCE(iLocal_54, uLocal_60);
...
bool func_6(bool bParam0)//Position - 0x397
{
...
void func_7(int iParam0, int iParam1)//Position - 0x3C2
{
	...
	if (iParam1 <= func_29(iParam0))
	{
		...
		{
			func_9(func_15(iParam0, iParam1), Local_42.x, Local_42.f_1);
		}
...
int func_11()//Position - 0xA7C
{
	return Global_5F7C;
}

int func_12(int iParam0, int iParam1)//Position - 0xA87
{
	int iVar0;
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAD8
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_14()//Position - 0xD33
{
	return Global_1407E1;
}

int func_15(int iParam0, int iParam1)//Position - 0xD3F
{
	switch (iParam0)
	{
		case 0:
...
int func_16(int iParam0)//Position - 0x10B3
{
	switch (iParam0)
	{
		case 29:
...
void func_17(int iParam0)//Position - 0x10E2
{
	int iVar0;
	int iVar1;
...
void func_18(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1124
{
	func_19(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_19(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1145
{
	int iVar0;
...
bool func_23(int iParam0)//Position - 0x157B
{
	return Global_8861 == iParam0;
}

bool func_24(int iParam0)//Position - 0x1589
{
	return iParam0 < 3;
}

int func_25(int iParam0)//Position - 0x1595
{
	int iVar0;
	int iVar1;
...
int func_26(int iParam0)//Position - 0x15D2
{
	if (func_24(iParam0))
	{
...
int func_27(int iParam0)//Position - 0x15FC
{
	int iVar0;
	int iVar1;
...
void func_28(int iParam0, int iParam1)//Position - 0x163F
{
	MISC::SET_BIT(&(Global_17C49.f_6E20.f_8[iParam0]), iParam1);
}

int func_29(int iParam0)//Position - 0x165A
{
	int iVar0;
...
int func_31(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1728
{
...
int func_32()//Position - 0x1902
{
	return 1;
}

int func_33()//Position - 0x190B
{
...
void func_35()//Position - 0x1935
{
	...
	else if (!iLocal_231 && !bLocal_229)
	{
		if ((func_50() || WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6)) || !ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), ENTITY::GET_ENTITY_COORDS(iLocal_55, 0), 12f, 12f, 5f, 0, 1, 0))
		{
			...
			if (!PED::IS_PED_INJURED(iLocal_55))
			{
				...
				if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55, 15f, 15f, 15f, 0, 1, 0))
				{
					func_48();
					SYSTEM::WAIT(0);
					func_36(&uLocal_61, "lurinau", "lurin_fucked", 4, 0, 0, 0);
				}
			}
			if (!PED::IS_PED_INJURED(iLocal_54))
			{
				TASK::CLEAR_PED_TASKS(iLocal_54);
				TASK::TASK_COMBAT_PED(iLocal_54, PLAYER::PLAYER_PED_ID(), 0, 16);
			}
			iLocal_231 = 1;
		}
	}
...
bool func_36(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1AB2
{
...
int func_37(char* sParam0, int iParam1, bool bParam2)//Position - 0x1B00
{
	Global_3D4D = 0;
...
int func_43()//Position - 0x1FF3
{
	func_22();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_44()//Position - 0x200C
{
	int iVar0;
...
bool func_45(int iParam0, int iParam1)//Position - 0x2063
{
	switch (iParam0)
	{
		case 5:
...
void func_47(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x20F5
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_48()//Position - 0x214B
{
	Global_38DE = 0;
	func_49();
}

void func_49()//Position - 0x215B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_50()//Position - 0x217C
{
	...
	{
		if (MISC::IS_BULLET_IN_AREA(PED::GET_PED_BONE_COORDS(iLocal_54, 31086, 0f, 0f, 0f), 30f, 1))
		{
			return 1;
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 30f, 30f, 30f, 0, 1, 0) && WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
		{
			if (((PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_54) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), iLocal_55)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_54)) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iLocal_55))
			{
				if (PED::CAN_PED_SEE_HATED_PED(iLocal_54, PLAYER::PLAYER_PED_ID()) || PED::CAN_PED_SEE_HATED_PED(iLocal_55, PLAYER::PLAYER_PED_ID()))
				{
					func_48();
					SYSTEM::WAIT(0);
					func_36(&uLocal_61, "lurinau", "lurin_gun", 4, 0, 0, 0);
					return 1;
				}
			}
		}
		Var0 = { Var0 + PED::GET_PED_BONE_COORDS(iLocal_54, 31086, 0f, 0f, 0f) };
		Var1 = { Var1 + PED::GET_PED_BONE_COORDS(iLocal_54, 31086, 0f, 0f, 0f) };
		...
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54) || ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_55))
				{
					return 1;
				}
			}
		...
		if (PED::IS_COP_PED_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_54, 0) - Local_48, ENTITY::GET_ENTITY_COORDS(iLocal_54, 0) + Local_48) || VEHICLE::IS_COP_VEHICLE_IN_AREA_3D(ENTITY::GET_ENTITY_COORDS(iLocal_54, 0) - Local_48, ENTITY::GET_ENTITY_COORDS(iLocal_54, 0) + Local_48))
		{
			return 1;
		}
	}
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 894.1762f, -1048.294f, 41.828f, 15f, 21.5625f, 10f, 0, 1, 0))
	{
		func_48();
		SYSTEM::WAIT(0);
		func_36(&uLocal_61, "lurinau", "lurin_other", 4, 0, 0, 0);
		return 1;
	}
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_46, 15f, 15f, 15f, 0, 1, 0))
	{
	...
	if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_46, 40f, 40f, 40f, 0, 1, 0))
	{
...
void func_52()//Position - 0x25C9
{
	if (!bLocal_229)
	{
		if (!PED::IS_PED_INJURED(iLocal_55))
		{
			if (TASK::GET_SCRIPT_TASK_STATUS(iLocal_55, 242628503) == 7 && ENTITY::IS_ENTITY_AT_ENTITY(iLocal_55, PLAYER::PLAYER_PED_ID(), 2.8f, 2.8f, 2.8f, 0, 1, 0))
			{
				if (!iLocal_230)
				{
					iLocal_235 = 500;
					func_48();
					SYSTEM::WAIT(0);
					if (func_78(func_43()) >= iLocal_235)
					{
						func_53(func_43(), 1, iLocal_235);
						iLocal_236 = iLocal_235;
						func_36(&uLocal_61, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
					else if (func_78(func_43()) <= 0)
					{
						iLocal_236 = 0;
						func_36(&uLocal_61, "lurinau", "lurin_mugnom", 4, 0, 0, 0);
					}
					else
					{
						iLocal_236 = func_78(func_43());
						func_53(func_43(), 1, func_78(func_43()));
						func_36(&uLocal_61, "lurinau", "lurin_mugtha", 4, 0, 0, 0);
					}
					if (!PED::IS_PED_INJURED(iLocal_55))
					{
						PED::SET_PED_MONEY(iLocal_55, iLocal_236);
					}
					iLocal_230 = 1;
				}
				if (!PED::IS_PED_INJURED(iLocal_55))
...
int func_53(int iParam0, int iParam1, int iParam2)//Position - 0x274D
{
	...
	return func_54(Global_17C49.f_744E[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_54(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x2796
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_55(bool bParam0)//Position - 0x2D95
{
	int iVar0;
	int iVar1;
...
void func_56(int iParam0)//Position - 0x3017
{
	int iVar0;
...
void func_57(int iParam0)//Position - 0x3071
{
	bool bVar0;
	char cVar1[64];
...
char* func_58(int iParam0)//Position - 0x3131
{
	switch (iParam0)
	{
		case 0:
...
void func_60(int iParam0)//Position - 0x31B0
{
	func_76(93, iParam0);
	func_76(29, iParam0);
	func_76(30, iParam0);
...
bool func_61(int iParam0)//Position - 0x31D0
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_62(bool bParam0)//Position - 0x320C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_63(int iParam0, int iParam1)//Position - 0x32C3
{
	if (iParam0 >= 61)
	{
		return 0;
...
int func_64(int iParam0, int iParam1)//Position - 0x32DE
{
...
int func_65(var uParam0, int iParam1)//Position - 0x3362
{
	int iVar0;
	var uVar1[61];
...
int func_66(var uParam0, int iParam1)//Position - 0x33E8
{
	int iVar0;
...
bool func_67(var uParam0, int iParam1)//Position - 0x3438
{
	return (*uParam0)[iParam1] == 61;
}

void func_68(var uParam0)//Position - 0x3449
{
	int iVar0;
...
void func_69(var uParam0, float fParam1)//Position - 0x3480
{
	uParam0->f_1 = (func_70(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
	MISC::SET_BIT(uParam0, 1);
	MISC::CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}

float func_70(bool bParam0)//Position - 0x34AE
{
	int iVar0;
...
void func_71(var uParam0, int iParam1)//Position - 0x34F6
{
	(*uParam0)[iParam1] = 61;
}

bool func_72(var uParam0, int iParam1)//Position - 0x3506
{
	return func_73(uParam0, iParam1) != -1;
}

int func_73(var uParam0, int iParam1)//Position - 0x3518
{
	int iVar0;
...
bool func_74(var uParam0)//Position - 0x3545
{
	return uParam0->f_44 == 1;
}

void func_75(int iParam0, int iParam1)//Position - 0x3553
{
	int iVar0;
...
void func_76(int iParam0, int iParam1)//Position - 0x3576
{
	int iVar0;
...
int func_78(int iParam0)//Position - 0x3648
{
	var uVar0;
	...
	if (!PED::IS_PED_INJURED(iLocal_55))
	{
		if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), 873.9561f, -1050.806f, 33.0066f, 4.75f, 1.9f, 1f, 0, 1, 0))
		{
			if (!WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6))
			{
				...
				PED::SET_PED_DUCKING(iLocal_55, 0);
				WEAPON::GIVE_WEAPON_TO_PED(iLocal_55, joaat("weapon_pistol"), 200, 1, 1);
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
				{
					func_48();
					SYSTEM::WAIT(0);
				...
				uLocal_57 = func_85(iLocal_55, 1, 145);
				AUDIO::TRIGGER_MUSIC_EVENT("RE35_OS");
				SYSTEM::WAIT(500);
				if (!PED::IS_PED_INJURED(iLocal_54))
				{
					TASK::TASK_LOOK_AT_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1, 2048, 2);
					WEAPON::GIVE_WEAPON_TO_PED(iLocal_54, joaat("weapon_pistol"), 200, 1, 1);
					TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
					TASK::TASK_GO_TO_COORD_WHILE_AIMING_AT_ENTITY(0, Local_51, PLAYER::PLAYER_PED_ID(), 2f, 0, 0f, 4f, 1, 512, 0, -957453492, 20000);
				...
				if (!PED::IS_PED_INJURED(iLocal_55))
				{
					...
					TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
					TASK::TASK_PERFORM_SEQUENCE(PLAYER::PLAYER_PED_ID(), uLocal_60);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
					func_80(1);
				}
				func_48();
				SYSTEM::WAIT(0);
				func_36(&uLocal_61, "lurinau", "lurin_mugger", 4, 0, 0, 0);
				SYSTEM::SETTIMERA(0);
				bLocal_228 = true;
			}
			else
...
void func_80(bool bParam0)//Position - 0x393D
{
	if (bParam0)
	{
		func_84();
...
void func_81(int iParam0)//Position - 0x39A0
{
	if (Global_38D7)
	{
		func_82(0, 0);
...
void func_82(bool bParam0, bool bParam1)//Position - 0x3A10
{
	if (bParam0)
	{
		if (func_83(0))
...
int func_83(int iParam0)//Position - 0x3A84
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
var func_85(int iParam0, bool bParam1, int iParam2)//Position - 0x3B07
{
	var uVar0;
...
int func_86(int iParam0, bool bParam1, bool bParam2)//Position - 0x3B59
{
	var uVar0;
	...
	{
		HUD::SET_BLIP_SCALE(uVar0, func_87(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(uVar0, func_87(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
float func_87(bool bParam0, float fParam1, float fParam2)//Position - 0x3BFD
{
	if (bParam0)
	{
		return fParam1;
		...
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 15f, 15f, 15f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (!func_33())
				{
					if (iLocal_234 == 0)
					{
						func_36(&uLocal_61, "lurinau", "lurin_girlta", 4, 0, 0, 0);
						TASK::TASK_LOOK_AT_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						iLocal_234++;
						SYSTEM::SETTIMERB(0);
					}
					if ((SYSTEM::TIMERB() > 3500 && iLocal_234 == 1) && !func_33())
					{
						func_36(&uLocal_61, "lurinau", "lurin_girltb", 4, 0, 0, 0);
						TASK::TASK_LOOK_AT_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						iLocal_234++;
						SYSTEM::SETTIMERB(0);
					}
					if ((SYSTEM::TIMERB() > 7000 && iLocal_234 == 2) && !func_33())
					{
						SYSTEM::SETTIMERB(0);
						TASK::TASK_LOOK_AT_ENTITY(iLocal_54, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
						func_36(&uLocal_61, "lurinau", "lurin_girlch", 4, 0, 0, 0);
					}
				}
			}
			else
...
void func_89()//Position - 0x3D2B
{
	if (!PED::IS_PED_INJURED(iLocal_54))
	{
		if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (WEAPON::IS_PED_ARMED(PLAYER::PLAYER_PED_ID(), 6) && PED::CAN_PED_SEE_HATED_PED(iLocal_54, PLAYER::PLAYER_PED_ID()))
			{
				TASK::CLEAR_PED_TASKS(iLocal_54);
				TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
				TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2052, 2);
...
void func_90()//Position - 0x3E39
{
	if (!func_119())
	{
		if (!ENTITY::IS_ENTITY_DEAD(iLocal_54))
		{
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_46, 65f, 60f, 60f, 0, 1, 0) || Global_17C44)
			{
				if (HUD::DOES_BLIP_EXIST(uLocal_58))
				{
					HUD::REMOVE_BLIP(&uLocal_58);
				}
				uLocal_56 = func_85(iLocal_54, 0, 145);
	...
	if (!iLocal_226)
	{
		if (!PED::IS_PED_INJURED(iLocal_54))
		{
			if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 25f, 25f, 25f, 0, 1, 0) && func_119())
			{
				if (func_36(&uLocal_61, "lurinau", "lurin_help2", 4, 0, 0, 0))
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
	...
	if (!ENTITY::IS_ENTITY_DEAD(iLocal_54))
	{
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 15f, 15f, 15f, 0, 1, 0) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			WEAPON::SET_CURRENT_PED_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_unarmed"), 1);
		}
		if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_54, 8f, 8f, 8f, 0, 1, 0))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				iLocal_227 = 1;
				...
				TASK::CLEAR_PED_TASKS(iLocal_54);
				func_36(&uLocal_61, "lurinau", "lurin_help", 4, 0, 0, 0);
				if (!ENTITY::IS_ENTITY_DEAD(iLocal_54))
				{
					SYSTEM::SETTIMERB(0);
					TASK::CLEAR_PED_SECONDARY_TASK(iLocal_54);
					TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
					TASK::TASK_LOOK_AT_ENTITY(0, PLAYER::PLAYER_PED_ID(), -1, 2064, 2);
					TASK::TASK_STAND_STILL(0, 1000);
					TASK::TASK_FOLLOW_NAV_MESH_TO_COORD(0, Local_50, 2f, -1, 0.25f, 512, 80.1325f);
					TASK::TASK_PLAY_ANIM(0, "random@gang_intimidation@", "001445_01_gangintimidation_1_female_idle_b", 4f, -4f, -1, 1, 0, 0, 0, 0);
					TASK::CLOSE_SEQUENCE_TASK(uLocal_60);
					TASK::TASK_PERFORM_SEQUENCE(iLocal_54, uLocal_60);
					TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
					Local_48 = { 40f, 40f, 30f };
				}
			}
			else if (!iLocal_233)
			{
				...
				if (!func_33())
				{
					if (!PED::IS_PED_INJURED(iLocal_54))
					{
						func_36(&uLocal_61, "lurinau", "lurin_girlca", 4, 0, 0, 0);
						TASK::OPEN_SEQUENCE_TASK(&uLocal_60);
...
void func_91()//Position - 0x40D6
{
	Global_38DE = 0;
	func_92();
}

void func_92()//Position - 0x40E6
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
int func_93(int iParam0)//Position - 0x410A
{
	if (func_97())
	{
		Global_17C3F = 1;
...
void func_94(int iParam0)//Position - 0x415D
{
	switch (iParam0)
	{
		case 0:
...
void func_95(var uParam0, int iParam1)//Position - 0x423E
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(uParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

char* func_96(int iParam0)//Position - 0x4255
{
	char* sVar0;
...
int func_98(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x42CE
{
	int iVar0;
...
void func_99(var uParam0, int iParam1)//Position - 0x4405
{
	int iVar0;
...
bool func_100(int iParam0)//Position - 0x4454
{
	return func_101(iParam0, Global_8861);
}

int func_101(int iParam0, int iParam1)//Position - 0x4465
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_102(int iParam0)//Position - 0x4646
{
	if (Global_8861 == 15)
	{
		return 0;
...
void func_103()//Position - 0x4668
{
	...
	PED::ADD_SCENARIO_BLOCKING_AREA(Local_46 - Vector(10f, 30f, 30f), Local_46 + Vector(10f, 30f, 30f), 0, 1, 1, 1);
	PED::ADD_RELATIONSHIP_GROUP("mugger", &uLocal_53);
	iLocal_54 = PED::CREATE_PED(19, joaat("a_f_m_skidrow_01"), Local_49, 79.765f, 1, 1);
	...
	TASK::TASK_PERFORM_SEQUENCE(iLocal_54, uLocal_60);
	TASK::CLEAR_SEQUENCE_TASK(&uLocal_60);
	iLocal_55 = PED::CREATE_PED(7, joaat("a_m_m_tramp_01"), Local_47, fLocal_52, 1, 1);
	AUDIO::SET_AMBIENT_VOICE_NAME(iLocal_55, "A_M_M_TRAMP_01_BLACK_MINI_01");
	...
	func_104(&uLocal_61, 0, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
	func_104(&uLocal_61, 4, iLocal_54, "HOBOFEMALE", 0, 1);
	func_104(&uLocal_61, 5, iLocal_55, "HOBOMALE", 0, 1);
	iLocal_44 = 1;
}

void func_104(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x4851
{
...
{
	Local_47 = { 879.8144f, -1047.433f, 32.0067f };
	fLocal_52 = 237.0934f;
	Local_49 = { 862.9633f, -1049.857f, 28.5362f };
	Local_48 = { 15f, 15f, 15f };
	Local_50 = { 881.1367f, -1050.706f, 32.0067f };
	Local_51 = { 876.7977f, -1052.52f, 32.0067f };
}
...
int func_106()//Position - 0x495A
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		...
		if (SYSTEM::VMAG2(ENTITY::GET_ENTITY_VELOCITY(PLAYER::PLAYER_PED_ID())) > 1369f && !func_117())
		{
			return 0;
		}
	}
...
int func_107(float fParam0, bool bParam1)//Position - 0x49E0
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_108(int iParam0, var uParam1)//Position - 0x4A97
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x5CDD
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_111(int iParam0)//Position - 0x6023
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_112(int iParam0)//Position - 0x605A
{
	struct<2> Var0;
...
bool func_114()//Position - 0x64D8
{
	return Global_17B2F > 0;
}

int func_115()//Position - 0x64E6
{
	if (Global_154F9 != -1)
	{
		return 1;
...
void func_120(int iParam0)//Position - 0x65CB
{
	if (iParam0 == -1)
	{
		iParam0 = func_30();
...
void func_122(int iParam0)//Position - 0x663E
{
	Global_17C3E = iParam0;
}

int func_123(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x664C
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (func_24(func_43()))
		{
			if (!func_160(iParam1, iParam2, 145))
			{
				return 0;
			}
		}
		if (!func_159(Global_17C49.f_6E20.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_124(struct<3> Param0, struct<3> Param1)//Position - 0x69E5
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

bool func_125(int iParam0)//Position - 0x6A0E
{
	int iVar0;
...
int func_126(int iParam0)//Position - 0x6A2F
{
	return func_127(iParam0, 1);
}

int func_127(int iParam0, int iParam1)//Position - 0x6A3E
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_128(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x6A91
{
	func_129(func_140(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_129(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x6AAF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_130(float fParam0, float fParam1, float fParam2)//Position - 0x6CB0
{
	float fVar0;
...
int func_131(int iParam0, int iParam1)//Position - 0x6CF2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_132(int iParam0)//Position - 0x6D94
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_133(int iParam0)//Position - 0x6DA7
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_134(int iParam0)//Position - 0x6DBA
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_135(int iParam0)//Position - 0x6DCD
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_136(int iParam0)//Position - 0x6DDF
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_137(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_137(bool bParam0, int iParam1, int iParam2)//Position - 0x6E04
{
	if (bParam0)
	{
		return iParam1;
...
int func_138(int iParam0)//Position - 0x6E1B
{
	return iParam0 & 15;
}

int func_139(int iParam0, int iParam1)//Position - 0x6E28
{
	int iVar0;
	int iVar1;
...
void func_141(var uParam0, int iParam1)//Position - 0x6F7A
{
	if (iParam1 <= 0)
	{
		return;
...
void func_142(var uParam0, int iParam1)//Position - 0x7000
{
...
void func_143(var uParam0, int iParam1)//Position - 0x7033
{
	int iVar0;
	int iVar1;
...
void func_144(var uParam0, int iParam1)//Position - 0x7084
{
...
void func_145(var uParam0, int iParam1)//Position - 0x70BE
{
...
void func_146(var uParam0, int iParam1)//Position - 0x70F9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_147(int iParam0)//Position - 0x7135
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_148(int iParam0, int iParam1)//Position - 0x7211
{
...
int func_149(int iParam0)//Position - 0x7234
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_157()) || Global_17890) || Global_5F7E) || func_156()) || func_45(8, -1)) || func_155()) || func_154()) || func_153()) || func_152()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_157()) || Global_5F7E) || func_156()) || func_45(8, -1)) || func_153()) || func_155()) || func_154()) || func_152()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_157()) || Global_17890) || Global_5F7E) || func_156()) || func_45(8, -1)) || func_153()) || func_155()) || func_154()) || func_152()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_157()) || Global_17890) || Global_5F7E) || func_156()) || func_45(8, -1)) || func_155()) || func_154()) || func_152()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_157() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_45(8, -1)) || func_152()) || func_151()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_157()) || func_154()) || Global_17890) || Global_5F7E) || func_156()) || Global_8C75) || func_45(8, -1)) || func_153()) || func_151()) || func_152()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
bool func_154()//Position - 0x79C9
{
	return Global_15F9E.f_123 > 0;
}

bool func_155()//Position - 0x79DA
{
	return Global_15F9E.f_122 > 0;
}

var func_156()//Position - 0x79EB
{
	return Global_14143C;
}

int func_157()//Position - 0x79F7
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
bool func_159(int iParam0)//Position - 0x7A3B
{
	return func_139(func_140(), iParam0);
}

int func_160(int iParam0, int iParam1, int iParam2)//Position - 0x7A4D
{
	int iVar0;
	int iVar1;
...
int func_161(int iParam0)//Position - 0x7B31
{
	if (!func_24(iParam0))
	{
		return 7;
...
bool func_162(int iParam0)//Position - 0x7B55
{
	int iVar0;
	bool bVar1;
...
void func_166(int iParam0)//Position - 0x7D2D
{
	char cVar0[64];
	...
	if (func_119())
	{
		...
		func_169(30000);
		StringCopy(&cVar0, func_168(Global_17C3E, 1), 64);
	...
	func_167(&Global_5FB7);
	Global_17C3F = 0;
	func_122(-1);
}

void func_167(var uParam0)//Position - 0x7DE2
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_168(int iParam0, bool bParam1)//Position - 0x7E1F
{
	switch (iParam0)
	{
		case 0:
...
void func_169(int iParam0)//Position - 0x806A
{
	Global_8A88 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_170(int iParam0)//Position - 0x807C
{
	func_171(iParam0, 0, func_176(iParam0));
}

void func_171(int iParam0, int iParam1, int iParam2)//Position - 0x8091
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_172(var uParam0)//Position - 0x80C0
{
	struct<16> Var0;
	int iVar1;
...
void func_173(int iParam0, var uParam1)//Position - 0x8190
{
	Global_17C49.f_6E20.f_2B[iParam0] = *uParam1;
}

void func_174(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x81A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_175(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x832A
{
...
int func_176(int iParam0)//Position - 0x8362
{
	int iVar0;
