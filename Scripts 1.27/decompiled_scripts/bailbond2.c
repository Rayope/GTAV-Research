#region Local Var
	...
	int iLocal_343 = 0;
	struct<8> Local_344 = { 0, 0, 0, 0, 0, 0, -1, 0 } ;
#endregion
...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_151 = "Trevor";
	sLocal_152 = "Maude";
	sLocal_153 = "maude_criminal_2";
	sLocal_154 = "maude_chair";
	sLocal_155 = "maude_laptop";
	StringCopy(&Local_322, "", 24);
	StringCopy(&cLocal_326, "PostKilled_BailBond2", 24);
	StringCopy(&cLocal_330, "MAUDE_MCS_3", 24);
	StringCopy(&Local_334, "", 24);
	Local_62 = { ScriptParam_344 };
	...
	if (func_464())
	{
		...
		{
			case 0:
				if (VEHICLE::IS_THIS_MODEL_A_PLANE(Global_16D94.f_877.f_C.f_2A))
				{
					func_425(&iLocal_343, 225.012f, 2310.695f, 77.257f, 218.1301f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
				}
				else
				{
					func_425(&iLocal_343, 232.0044f, 2314.844f, 76.9871f, 173.0429f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
				}
				func_424(Local_338, fLocal_118, 1, 0);
				iLocal_60 = 2;
				func_413(1, 0);
				break;
			
			case 1:
				func_425(&iLocal_343, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
				func_424(Local_335, 254.9762f, 0, 0);
				func_413(4, 0);
				break;
	...
	else if (func_412(0))
	{
		...
		{
			func_410(PLAYER::PLAYER_PED_ID(), Local_338, fLocal_118, 0, 0);
	...
	while (true)
	{
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
		{
			...
			Local_336 = { ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1) };
			func_399();
			func_398();
			switch (iLocal_57)
			{
		...
		switch (iLocal_57)
		{
			case 0:
				if (iLocal_59 == 1)
				{
					if (!func_67())
					{
						func_18(PLAYER::PLAYER_PED_ID(), Local_339, fLocal_119, 0, 1);
			...
			case 1:
				...
				if (iLocal_59 == 1)
				{
					if (!func_67())
					{
						func_18(PLAYER::PLAYER_PED_ID(), Local_340, fLocal_120, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_103 == 0)
						{
			...
			case 2:
				...
				if (iLocal_59 == 1)
				{
					...
					if (iLocal_133 > 0)
					{
						...
						{
							if (func_21(Local_68[iVar0 /*20*/]))
							{
								PED::EXPLODE_PED_HEAD(Local_68[iVar0 /*20*/], joaat("weapon_sniperrifle"));
								ENTITY::SET_ENTITY_HEALTH(Local_68[iVar0 /*20*/], 0);
							}
							iVar0++;
						}
					}
			...
			case 3:
				...
				if (iLocal_59 == 1)
				{
					func_410(Local_67.f_9, Local_335, 0f, 0, 0);
					if (!func_67())
					{
						func_410(PLAYER::PLAYER_PED_ID(), Local_335, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_103 == 0)
						{
...
void func_3()//Position - 0x69E
{
	Global_38DE = 0;
	func_4();
}

void func_4()//Position - 0x6AE
{
...
int func_5(int iParam0, float fParam1)//Position - 0x6CF
{
	struct<3> Var0;
	
	if (func_21(iParam0))
	{
		if (func_6(ENTITY::GET_ENTITY_COORDS(iParam0, 1), &Var0, fParam1, 0))
		{
...
bool func_6(struct<3> Param0, var uParam1, var uParam2, int iParam3)//Position - 0x717
{
	var uVar0;
	struct<3> Var1;
...
void func_7()//Position - 0x761
{
	...
	while (iVar0 <= (iLocal_133 - 1))
	{
		Local_68[iVar0 /*20*/].f_F = 0;
		Local_68[iVar0 /*20*/].f_10 = 0;
		Local_68[iVar0 /*20*/].f_11 = 0;
		iVar0++;
	}
}
...
void func_9(var uParam0)//Position - 0x7D2
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_10(struct<3> Param0, float fParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x7ED
{
	var uVar0;
	int iVar1;
...
void func_11()//Position - 0x85C
{
	Global_42CA.f_6 = 1;
}

void func_12()//Position - 0x86A
{
...
void func_13(int iParam0)//Position - 0x892
{
	if (Global_38D7)
	{
		func_15(0, 0);
...
void func_15(bool bParam0, bool bParam1)//Position - 0x929
{
	if (bParam0)
	{
		if (func_16(0))
...
int func_16(int iParam0)//Position - 0x99D
{
	if (iParam0 == 1)
	{
...
void func_17(int iParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x9F7
{
	struct<3> Var0;
	float fVar1;
	float fVar2;
...
int func_18(int iParam0, struct<3> Param1, float fParam2, bool bParam3, int iParam4)//Position - 0xA56
{
	bool bVar0;
	float fVar1;
...
void func_19()//Position - 0xAB0
{
	Global_38DE = 0;
	func_20();
}

void func_20()//Position - 0xAC0
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
...
int func_21(int iParam0)//Position - 0xB17
{
	if (func_411(iParam0))
	{
...
void func_22(int iParam0, bool bParam1)//Position - 0xB37
{
...
void func_25(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xC4E
{
	if (bParam0)
	{
...
int func_26(int iParam0)//Position - 0xD1F
{
...
bool func_27()//Position - 0xD60
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_28(int iParam0, int iParam1)//Position - 0xD71
{
	bool bVar0;
...
int func_29(int iParam0, bool bParam1)//Position - 0xDBC
{
	int iVar0;
	int iVar1;
...
int func_30()//Position - 0xDFD
{
	return Global_1407E1;
}

int func_31(int iParam0, var uParam1, var uParam2)//Position - 0xE09
{
	int iVar0;
...
void func_32(int iParam0)//Position - 0xE3A
{
	if (iParam0 == 1)
	{
...
{
	if (func_56(Local_336, Local_74.f_1, 210f))
	{
		if (!iLocal_112)
		{
		...
		{
			if (func_56(Local_336, Local_78.f_1, 150f))
			{
		...
		{
			if (func_56(Local_336, Local_79.f_1, 150f))
			{
...
void func_35(int iParam0, bool bParam1)//Position - 0x106E
{
	if (bParam1)
	{
		func_37(iParam0);
...
void func_36(var uParam0, bool bParam1)//Position - 0x108B
{
...
void func_37(var uParam0)//Position - 0x10C6
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
char* func_38()//Position - 0x10F1
{
	return "special_ped@maude@base";
}

void func_39(int iParam0, bool bParam1)//Position - 0x10FC
{
	if (bParam1)
	{
		func_41(iParam0);
...
void func_40(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x111B
{
...
void func_41(var uParam0)//Position - 0x116A
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_42()//Position - 0x11A9
{
	return joaat("prop_radio_01");
}

float func_43()//Position - 0x11B6
{
	return -92.17f;
}

Vector3 func_44()//Position - 0x11C3
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_45()//Position - 0x11DA
{
...
char* func_47()//Position - 0x12D3
{
	return "base_chair";
}

char* func_48()//Position - 0x12DE
{
	return "base";
}

Vector3 func_49()//Position - 0x12E9
{
	return 0f, 0f, -92.17f;
}

Vector3 func_50()//Position - 0x12F8
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_51(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x130F
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
void func_52(int iParam0, bool bParam1)//Position - 0x1391
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_53(int iParam0)//Position - 0x13BC
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x13E2
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
bool func_56(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x14B8
{
	return SYSTEM::VDIST2(Param0, Param1) <= (fParam2 * fParam2);
}

int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x14D2
{
	int iVar0;
...
int func_61(int iParam0, int iParam1)//Position - 0x163B
{
	if (func_21(iParam0))
	{
...
int func_62(int iParam0, var uParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x166E
{
...
{
	if (func_411(Local_67.f_9))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_153, Local_67.f_9, 0);
		}
	}
	if (func_411(Local_74))
	{
		if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
		{
			CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION_FROM_PED(sLocal_152, Local_74, 0);
		}
	}
}

void func_64(char[4] cParam0)//Position - 0x1832
{
	func_25(1, 1, 0, 0);
	CUTSCENE::REQUEST_CUTSCENE(cParam0, 8);
}

void func_65(int iParam0, int iParam1, int iParam2)//Position - 0x184A
{
	if (func_464() && func_67())
	{
...
void func_66(int iParam0)//Position - 0x190E
{
	if (iParam0 == 1)
	{
	...
	switch (iLocal_59)
	{
		case 0:
			...
			if (iLocal_61 == 4)
			{
				...
				if (func_97(&Local_74, &Local_76, &iLocal_140))
				{
					iLocal_104 = 1;
				}
			}
			...
			{
				iLocal_94 = 0;
				StringCopy(&Local_322, "BBC_T12", 24);
			}
			if (func_21(Local_67.f_9))
			{
			...
			iVar1 = 0;
			while (iVar1 <= (iLocal_133 - 1))
			{
				func_96(Local_68[iVar1 /*20*/], 1);
				iVar1++;
			}
			switch (iLocal_61)
			{
			...
			else
			{
				if (!iLocal_94)
				{
					...
					if (iLocal_61 == 4)
					{
						if (func_21(Local_74))
						{
							if (func_102(Local_74, Local_336, 35f))
							{
								func_87(&uLocal_156, 4, Local_74, "MAUDE", 0, 1);
								if (func_71(&uLocal_156, cLocal_150, &Local_322, 4, 0, 0, 0))
								{
									iLocal_94 = 1;
								}
							}
					...
					else if (func_71(&uLocal_156, cLocal_150, &Local_322, 4, 0, 0, 0))
					{
						iLocal_94 = 1;
					}
				}
...
void func_69(int iParam0)//Position - 0x1C01
{
	if (func_21(*iParam0))
	{
...
char* func_70()//Position - 0x1C6A
{
	return "female_Flee_Table_Left_Maude";
}

int func_71(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1C75
{
	if (iParam4 == 0)
	{
...
bool func_72(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1CB2
{
...
int func_73(char* sParam0, int iParam1, bool bParam2)//Position - 0x1D00
{
	Global_3D4D = 0;
...
int func_78()//Position - 0x21CC
{
	func_79();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_79()//Position - 0x21E5
{
	int iVar0;
...
bool func_80(int iParam0)//Position - 0x22E2
{
	return iParam0 < 3;
}
...
int func_82(int iParam0)//Position - 0x232B
{
	if (func_80(iParam0))
	{
...
bool func_83(int iParam0)//Position - 0x2355
{
	return Global_8861 == iParam0;
}

void func_84()//Position - 0x2363
{
	int iVar0;
...
bool func_85(int iParam0, int iParam1)//Position - 0x23BA
{
	switch (iParam0)
	{
		case 5:
...
void func_86(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x23F5
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_87(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x244B
{
	...
	if (iLocal_133 > 0)
	{
		...
		while (iVar0 <= (iLocal_133 - 1))
		{
			if (iLocal_66 == 4)
			{
				if (func_21(Local_68[iVar0 /*20*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_68[iVar0 /*20*/], -2065892691);
					PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68[iVar0 /*20*/], 0);
					if (Global_17741 == 0)
					{
						PED::SET_PED_KEEP_TASK(Local_68[iVar0 /*20*/], 0);
					}
					else
					{
						PED::SET_PED_KEEP_TASK(Local_68[iVar0 /*20*/], 1);
					}
				}
			}
			func_39(&(Local_68[iVar0 /*20*/]), bParam0);
			iVar0++;
		}
	}
	if (iLocal_130 > 0)
...
void func_89(var uParam0, bool bParam1)//Position - 0x26B9
{
	if (bParam1)
	{
		func_91(uParam0);
...
void func_90(var uParam0)//Position - 0x26D5
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_91(var uParam0)//Position - 0x270C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_A_MISSION_ENTITY(*uParam0))
...
int func_92(int iParam0)//Position - 0x27A8
{
	if (func_411(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_93(var uParam0)//Position - 0x27D2
{
...
void func_95(char* sParam0)//Position - 0x2818
{
...
void func_96(int iParam0, bool bParam1)//Position - 0x2857
{
	if (func_21(iParam0))
	{
		PED::SET_PED_COMBAT_ATTRIBUTES(iParam0, 5, 0);
...
int func_97(int iParam0, int iParam1, int iParam2)//Position - 0x28D2
{
	int iVar0;
...
char* func_98()//Position - 0x2A1E
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_99()//Position - 0x2A2A
{
	return "special_ped@maude@exit_flee";
}

void func_100(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2A36
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_101(iParam3), 0);
}

int func_101(int iParam0)//Position - 0x2A4F
{
	int iVar0;
...
bool func_102(int iParam0, struct<3> Param1, float fParam2)//Position - 0x2C44
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Param1) <= (fParam2 * fParam2);
}

void func_103(int iParam0, bool bParam1)//Position - 0x2C61
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_104(var uParam0, int iParam1)//Position - 0x2CD2
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_106(var uParam0)//Position - 0x2D13
{
	bool bVar0;
	struct<8> Var1;
...
void func_107(var uParam0)//Position - 0x2D81
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
void func_108(int iParam0)//Position - 0x2DA1
{
	...
	{
		func_106(&(Local_68[iVar0 /*20*/].f_6));
		iVar0++;
	}
}
...
void func_109()//Position - 0x2DCA
{
	...
	switch (iLocal_59)
	{
		case 0:
			...
			func_105();
			func_39(&Local_74, 1);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_321);
			PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_321, 1862763509);
			iVar0 = 0;
			while (iVar0 <= (iLocal_133 - 1))
			{
				if (func_21(Local_68[iVar0 /*20*/]))
				{
					PED::SET_PED_RELATIONSHIP_GROUP_HASH(Local_68[iVar0 /*20*/], iLocal_321);
					if (!PED::IS_PED_FLEEING(Local_68[iVar0 /*20*/]))
					{
						func_111(iVar0);
					}
				}
		...
		case 1:
			if (func_110(iLocal_137, 500))
			{
				if (!iLocal_95)
				{
					...
					if (func_71(&uLocal_156, cLocal_150, "BBC_PK1", 4, 0, 0, 0))
					{
						iLocal_95 = 1;
					}
				}
				if (!iLocal_105)
				{
					SCRIPT::REQUEST_SCRIPT(&cLocal_326);
					if (SCRIPT::HAS_SCRIPT_LOADED(&cLocal_326))
					{
						iVar0 = 0;
						while (iVar0 <= (iLocal_133 - 1))
						{
						...
						while (iVar0 <= (iLocal_130 - 1))
						{
							if (iVar0 < Var1.f_5)
							{
								Var1.f_5[iVar0] = Local_70[iVar0 /*6*/];
							}
							iVar0++;
						}
						SYSTEM::START_NEW_SCRIPT_WITH_ARGS(&cLocal_326, &Var1, 9, 512);
						SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED(&cLocal_326);
						iLocal_105 = 1;
					}
				}
				if (iLocal_95 && iLocal_105)
				{
					func_112(2);
				}
				if (func_110(iLocal_137, 1500))
				{
					func_112(2);
				}
			}
...
bool func_110(int iParam0, int iParam1)//Position - 0x2F6F
{
...
{
	if (func_21(Local_68[iParam0 /*20*/]))
	{
		TASK::CLEAR_PED_SECONDARY_TASK(Local_68[iParam0 /*20*/]);
		TASK::CLEAR_PED_TASKS(Local_68[iParam0 /*20*/]);
		TASK::TASK_CLEAR_LOOK_AT(Local_68[iParam0 /*20*/]);
		PED::SET_PED_HEARING_RANGE(Local_68[iParam0 /*20*/], 30f);
		PED::SET_PED_SEEING_RANGE(Local_68[iParam0 /*20*/], 30f);
		PED::SET_PED_ID_RANGE(Local_68[iParam0 /*20*/], 30f);
		PED::SET_PED_COMBAT_RANGE(Local_68[iParam0 /*20*/], 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iParam0 /*20*/], 1, 0);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iParam0 /*20*/], 3, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iParam0 /*20*/], 5, 1);
		PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iParam0 /*20*/], 0, 1);
		PED::SET_PED_FLEE_ATTRIBUTES(Local_68[iParam0 /*20*/], 512, 1);
		PED::SET_PED_ACCURACY(Local_68[iParam0 /*20*/], MISC::GET_RANDOM_INT_IN_RANGE(10, 20));
		PED::SET_PED_SHOOT_RATE(Local_68[iParam0 /*20*/], MISC::GET_RANDOM_INT_IN_RANGE(15, 20));
		PED::SET_PED_FIRING_PATTERN(Local_68[iParam0 /*20*/], 445831135);
		if (MISC::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_68[iParam0 /*20*/], ENTITY::GET_ENTITY_COORDS(Local_68[iParam0 /*20*/], 1), 45f, 0, 0);
		}
		else
		{
			PED::SET_PED_SPHERE_DEFENSIVE_AREA(Local_68[iParam0 /*20*/], ENTITY::GET_ENTITY_COORDS(Local_68[iParam0 /*20*/], 1), 35f, 0, 0);
		}
		TASK::TASK_LOOK_AT_ENTITY(Local_68[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
		TASK::TASK_COMBAT_PED(Local_68[iParam0 /*20*/], PLAYER::PLAYER_PED_ID(), 0, 16);
		PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_68[iParam0 /*20*/], 0);
		Local_68[iParam0 /*20*/].f_E = 2;
	}
}
...
void func_113(int iParam0, int iParam1, int iParam2)//Position - 0x310D
{
	bool bVar0;
...
int func_116()//Position - 0x3701
{
	return Global_5F7C;
}

int func_117(int iParam0, int iParam1)//Position - 0x370C
{
	int iVar0;
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x375D
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_119(int iParam0)//Position - 0x39BA
{
	int iVar0;
	...
	switch (iLocal_59)
	{
		case 0:
			...
			if (func_34())
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), sLocal_151, 0, 0, 0);
					if (func_411(Local_74))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_74, sLocal_152, 0, 0, 0);
					}
					if (func_411(Local_67.f_9))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_67.f_9, sLocal_153, 0, 0, 0);
					}
					if (func_411(Local_76))
					{
						CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_76, sLocal_154, 0, 0, 0);
					}
					if (func_411(Local_77))
					{
		...
		case 1:
			if (func_411(Local_76))
			{
				if (func_21(Local_74))
				{
					if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_152, 0) && CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_154, 0))
					{
						func_46();
					}
				}
			}
			if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY(sLocal_151, 0))
			{
...
void func_122(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x3D13
{
	struct<3> Var0;
	var uVar1;
...
void func_123(int iParam0, struct<3> Param1, float fParam2, int iParam3, bool bParam4)//Position - 0x3D8E
{
	struct<54> Var0;
...
void func_124(int iParam0, int iParam1, int iParam2)//Position - 0x3EB9
{
	int iVar0;
...
void func_125(int iParam0, int iParam1)//Position - 0x3FD6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_126(int iParam0)//Position - 0x41D9
{
...
int func_127(int iParam0)//Position - 0x42B6
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_128(int iParam0)//Position - 0x4466
{
	int iVar0;
	struct<2> Var1;
...
int func_129()//Position - 0x4635
{
	return 0;
}

int func_130()//Position - 0x463E
{
	return 1;
}

int func_131()//Position - 0x4647
{
	return 1;
}

int func_132()//Position - 0x4650
{
...
int func_134(int iParam0)//Position - 0x46EC
{
	int iVar0;
	char* sVar1;
...
int func_135(int iParam0)//Position - 0x4731
{
	int iVar0;
...
int func_136(int iParam0)//Position - 0x476C
{
	int iVar0;
...
int func_137(int iParam0)//Position - 0x47E8
{
	int iVar0;
...
int func_138(int iParam0, int iParam1, bool bParam2)//Position - 0x48D0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_139(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x4941
{
...
void func_141(var uParam0, int iParam1)//Position - 0x4A5F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_142(var uParam0, int iParam1)//Position - 0x4AE5
{
...
void func_143(var uParam0, int iParam1)//Position - 0x4B18
{
	int iVar0;
	int iVar1;
...
int func_144(int iParam0, int iParam1)//Position - 0x4B69
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_145(int iParam0)//Position - 0x4C0B
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_146(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_146(bool bParam0, int iParam1, int iParam2)//Position - 0x4C30
{
	if (bParam0)
	{
		return iParam1;
...
int func_147(var uParam0)//Position - 0x4C47
{
	return uParam0 & 15;
}

void func_148(var uParam0, int iParam1)//Position - 0x4C54
{
...
void func_149(var uParam0, int iParam1)//Position - 0x4C8E
{
...
void func_150(var uParam0, int iParam1)//Position - 0x4CC9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_151(var uParam0, int iParam1)//Position - 0x4D05
{
	int iVar0;
	int iVar1;
...
int func_152(int iParam0, int iParam1)//Position - 0x63F9
{
	struct<58> Var0;
...
void func_153(int iParam0, var uParam1, int iParam2)//Position - 0x643B
{
	int iVar0;
	struct<74> Var1;
...
void func_154(int iParam0, struct<54> Param1, struct<3> Param2, float fParam3, int iParam4)//Position - 0x66B3
{
	if (func_151(&(Global_10642.f_22B[0 /*21*/]), iParam0))
	{
...
void func_155(int iParam0, bool bParam1)//Position - 0x67B5
{
	if (iParam0 == -1)
	{
		return;
...
void func_156(int iParam0, int iParam1, bool bParam2)//Position - 0x6812
{
	if (iParam0 == -1)
	{
		return;
...
bool func_157(int iParam0, int iParam1)//Position - 0x684D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_158(struct<54> Param0, var uParam1)//Position - 0x6870
{
...
void func_159(int iParam0)//Position - 0x693B
{
	if (iParam0 == -1)
	{
		return;
...
int func_160(int iParam0)//Position - 0x69B5
{
	int iVar0;
...
bool func_161(struct<3> Param0, struct<3> Param1)//Position - 0x6A18
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

void func_162(int iParam0, var uParam1)//Position - 0x6A41
{
	int iVar0;
...
int func_163(int iParam0)//Position - 0x6CED
{
	switch (iParam0)
	{
		case 1:
...
int func_164(int iParam0, var uParam1, var uParam2)//Position - 0x6D9D
{
	int iVar0;
	int iVar1;
...
void func_165(var uParam0)//Position - 0x6E77
{
	int iVar0;
...
void func_166(int iParam0)//Position - 0x6F27
{
...
int func_167(struct<3> Param0, int iParam1, var uParam2, var uParam3)//Position - 0x6F4E
{
	int iVar0;
...
int func_168(struct<3> Param0, int iParam1, int iParam2)//Position - 0x7064
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_169(int iParam0)//Position - 0x70F3
{
	return MISC::IS_BIT_SET(Global_17C49.f_156E[iParam0], 0);
}

int func_170(int iParam0)//Position - 0x710B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_171(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x7127
{
	func_172(Param0, Param1, fParam2, Param3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_172(struct<3> Param0, struct<3> Param1, float fParam2, struct<3> Param3, float fParam4, struct<3> Param5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x7150
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_173(struct<3> Param0)//Position - 0x7536
{
...
int func_174(int iParam0, struct<3> Param1, struct<3> Param2, float fParam3)//Position - 0x7560
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_175(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x7856
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_176(struct<3> Param0)//Position - 0x790A
{
	float fVar0;
	float fVar1;
...
void func_177(int iParam0)//Position - 0x7949
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_178(struct<3> Param0, int iParam1)//Position - 0x79AE
{
	return func_179(Global_164D7.f_877.f_C.f_2A, Param0, iParam1);
}

int func_179(int iParam0, struct<3> Param1, int iParam2)//Position - 0x79CB
{
	struct<3> Var0;
	struct<3> Var1;
...
Vector3 func_180()//Position - 0x7A35
{
	return 2.55f, 5.59f, 2.55f;
}

Vector3 func_181()//Position - 0x7A4C
{
	return 3.01f, 11.01f, 6.01f;
}

int func_182(var uParam0, var uParam1, var uParam2)//Position - 0x7A63
{
...
void func_183(struct<3> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x7A9A
{
	int iVar0;
...
Vector3 func_184(var uParam0)//Position - 0x7C50
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

int func_185(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x7C63
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_186(int iParam0, int iParam1, int iParam2)//Position - 0x8451
{
	int iVar0;
...
int func_187(int iParam0)//Position - 0x84DD
{
	switch (iParam0)
	{
...
void func_188(int iParam0, int iParam1, int iParam2)//Position - 0x8518
{
	int iVar0;
	int iVar1;
...
int func_189(int iParam0, int iParam1, int iParam2)//Position - 0x85A2
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_190(int iParam0, int iParam1, int iParam2)//Position - 0x8680
{
	Global_10A0A[1 /*14*/] = { func_234(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 2);
}

int func_191(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x86AA
{
	var uVar0;
	int iVar1;
...
int func_192(int iParam0, int iParam1, int iParam2)//Position - 0x8CA5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_193(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8D3E
{
	int iVar0;
...
int func_194(int iParam0, int iParam1, int iParam2)//Position - 0x8DD4
{
	int iVar0;
	int iVar1;
...
int func_195(int iParam0)//Position - 0x8E75
{
	switch (iParam0)
	{
		case 0:
...
int func_196(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8F25
{
	int iVar0;
...
int func_197(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x922C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_198(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x9DDF
{
	int iVar0;
...
int func_199(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA0C3
{
	int iVar0;
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA38A
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA3C1
{
	int iVar0;
...
int func_202(int iParam0, int iParam1, int iParam2)//Position - 0xA3EA
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA6B4
{
	int iVar0;
...
int func_204(int iParam0, int iParam1, int iParam2)//Position - 0xA93E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_205(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0xAA95
{
	if (iParam2 == -1)
	{
...
struct<10> func_206(int iParam0, int iParam1)//Position - 0xAABE
{
	int iVar0;
	struct<10> Var1;
...
void func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB3ED
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var2;
...
int func_208(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB517
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_209(int iParam0, int iParam1)//Position - 0xB5F7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_210(int iParam0)//Position - 0xB99E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_211(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xB9FF
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_212(int iParam0, int iParam1)//Position - 0xBA47
{
	int iVar0;
	struct<16> Var1;
...
void func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD88C
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var2;
...
int func_214(int iParam0)//Position - 0xDA3D
{
	switch (iParam0)
	{
		case 0:
...
void func_215(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xDAED
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
int func_216(int iParam0, int iParam1, int iParam2)//Position - 0xDB5E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDD81
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0xDE7B
{
	var uVar0;
	var uVar1;
...
int func_219(int iParam0, int iParam1, int iParam2)//Position - 0xE270
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_220(int iParam0, int iParam1)//Position - 0xE54F
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE595
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_222(int iParam0, int iParam1)//Position - 0xE691
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0xE7CF
{
	switch (iParam0)
	{
		case 0:
...
int func_224(int iParam0, int iParam1)//Position - 0xE855
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_225(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xE8B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_226(int iParam0)//Position - 0xE939
{
...
void func_227(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xE9F1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEA3A
{
	int iVar0;
...
int func_229(var uParam0)//Position - 0xEA65
{
	int iVar0;
	int iVar1;
...
int func_230(int iParam0, int iParam1, int iParam2)//Position - 0xEA99
{
	var uVar0;
	var uVar1;
...
bool func_231(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xEACB
{
	int iVar0;
...
int func_232(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xF16C
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_233(int iParam0)//Position - 0x1008E
{
	if (!MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_234(int iParam0, int iParam1, int iParam2)//Position - 0x100DF
{
	func_297();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_235(int iParam0, int iParam1)//Position - 0x10131
{
	switch (iParam0)
	{
		case 0:
...
void func_236(int iParam0)//Position - 0x10221
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_237(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x11497
{
	var uVar0;
	int iVar1;
...
bool func_238(int iParam0, int iParam1, var uParam2)//Position - 0x1181A
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_239(int iParam0, int iParam1)//Position - 0x11C1F
{
	switch (iParam1)
	{
		case 0:
...
int func_240(int iParam0, int iParam1)//Position - 0x1201A
{
	switch (iParam1)
	{
		case 0:
...
int func_241(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x12415
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_242(int iParam0)//Position - 0x12457
{
	switch (iParam0)
	{
		case -1:
...
void func_243(int iParam0, int iParam1, int iParam2)//Position - 0x1252B
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
...
void func_244(int iParam0)//Position - 0x127A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_245(int iParam0)//Position - 0x128FC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_246(int iParam0)//Position - 0x12E09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_247(int iParam0)//Position - 0x12E7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_248(int iParam0)//Position - 0x12EF0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_249(int iParam0)//Position - 0x12FD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_250(int iParam0)//Position - 0x13338
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_251(int iParam0)//Position - 0x13548
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252(int iParam0)//Position - 0x13777
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x13886
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x14225
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x14D97
{
	if (iParam0 < 136)
	{
		func_257(iParam0);
...
void func_256(int iParam0)//Position - 0x14DCB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x159CF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x168DD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x16A09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0, int iParam1)//Position - 0x16B06
{
	switch (iParam0)
	{
		case 0:
...
void func_261(int iParam0)//Position - 0x16BF6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x180E7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x18237
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x18741
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x18DAE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x18E21
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x18EF0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1941F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x195B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x19DB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x19EC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1ADEB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1BAA7
{
	if (iParam0 < 107)
	{
		func_276(iParam0);
...
void func_274(int iParam0)//Position - 0x1BAEC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1C592
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1D381
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1DFCA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1E242
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0, int iParam1)//Position - 0x1E387
{
	switch (iParam0)
	{
		case 0:
...
void func_280(int iParam0)//Position - 0x1E477
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1F200
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1F379
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1F8EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1FE18
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1FE8B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1FF5A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x204AF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x20717
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x209EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x20BB4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x21707
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x22350
{
	if (iParam0 < 60)
	{
		func_294(iParam0);
...
void func_293(int iParam0)//Position - 0x22384
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x23124
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x237B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x23896
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297()//Position - 0x23993
{
...
int func_298(int iParam0, int iParam1, int iParam2)//Position - 0x23A0C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_299(bool bParam0)//Position - 0x23C64
{
	int iVar0;
...
void func_300()//Position - 0x23CA0
{
	...
	if (func_21(Local_67.f_9))
	{
		...
		func_360(Local_67.f_9, &iLocal_134, 1126825984, 7);
		...
		switch (iLocal_59)
		{
			case 0:
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_321);
				PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_321, 1862763509);
				iLocal_138 = ENTITY::GET_ENTITY_HEALTH(Local_67.f_9);
				Local_341 = { ENTITY::GET_ENTITY_COORDS(Local_67.f_9, 0) };
				func_339(&Local_342, Local_341);
				...
				func_336(&(Local_67.f_8), "", "", &iLocal_126, iLocal_127, 0);
				iLocal_59 = 1;
				break;
			...
			case 1:
				if (!iLocal_108)
				{
					...
					if (Local_67.f_A == 13 || Local_67.f_A == 14)
					{
						...
						else if (func_110(iLocal_135, 8000))
						{
							bVar0 = true;
						}
						if (func_312(Local_67.f_9, Local_336, bVar0, 0, 1, iLocal_138))
						{
							if ((func_110(iLocal_136, 5000) || func_161(Local_342, 0f, 0f, 0f)) || (!func_56(Var1, Local_342, 8.5f) && !func_56(Var1, Local_341, 8.5f)))
							{
								func_311();
						...
						else
						{
							if (!iLocal_80)
							{
								if (!func_110(iLocal_123, 2500))
								{
									if (!func_59())
									{
										if (func_102(Local_67.f_9, Local_336, 30f))
										{
											if (func_71(&uLocal_156, cLocal_149, "BB2_J7", 4, 0, 0, 0))
											{
												iLocal_123 = MISC::GET_GAME_TIMER();
												iLocal_80 = 1;
											}
							...
							{
								if (func_110(iLocal_123, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_102(Local_67.f_9, Local_336, 30f))
									{
										if (PED::IS_PED_FLEEING(Local_67.f_9))
										{
											...
											{
												if (func_71(&uLocal_156, cLocal_150, "BBC_T13", 4, 0, 0, 0))
												{
													iLocal_123 = MISC::GET_GAME_TIMER();
												}
											}
											else if (func_71(&uLocal_156, cLocal_149, "BB2_FLEE", 4, 0, 0, 0))
											{
												iLocal_123 = MISC::GET_GAME_TIMER();
											}
										}
							...
							func_308(Local_67.f_9, Local_336, iLocal_136, 925353388);
						}
					}
					else
					{
				...
				{
					func_311();
					if (!func_102(Local_67.f_9, Local_336, 10f))
					{
						if (!iLocal_97)
						{
							if (!func_306(sLocal_147, 1))
							{
								func_304(&(Local_67.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_126, &iLocal_127, 1, 1);
								iLocal_97 = 1;
							}
						}
						else
						{
							func_336(&(Local_67.f_8), "BBS_APPSUS", "BBS_APPSUS2", &iLocal_126, iLocal_127, 1);
						}
					}
					else
					{
						if (!iLocal_81)
						{
							if (!PED::IS_PED_RAGDOLL(Local_67.f_9) && !PED::IS_PED_IN_ANY_VEHICLE(Local_67.f_9, 0))
							{
								...
								if (func_71(&uLocal_156, cLocal_149, sLocal_147, 4, 0, 0, 0))
								{
									iLocal_81 = 1;
								}
							}
			...
			case 2:
				...
				iLocal_81 = 1;
				func_311();
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_321);
				PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_321, 1862763509);
				func_107(&(Local_67.f_8));
				iLocal_81 = 1;
				Local_67.f_11 = MISC::GET_GAME_TIMER();
				func_309(&uLocal_43, 0, 0);
...
int func_301(var uParam0)//Position - 0x2417C
{
	struct<3> Var0;
...
int func_302(var uParam0)//Position - 0x241C1
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
bool func_303(char* sParam0, int iParam1, int iParam2)//Position - 0x241F9
{
...
void func_304(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x24217
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
		if (bParam5)
...
void func_305(char* sParam0, int iParam1, int iParam2)//Position - 0x242C3
{
	iParam2 = iParam2;
...
int func_306(char* sParam0, bool bParam1)//Position - 0x242DC
{
	struct<6> Var0;
...
struct<6> func_307()//Position - 0x24317
{
	struct<6> Var0;
...
void func_308(int iParam0, struct<3> Param1, int iParam2, float fParam3)//Position - 0x2433B
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_309(var uParam0, int iParam1, int iParam2)//Position - 0x24420
{
	char* sVar0;
...
bool func_310(char* sParam0)//Position - 0x244FD
{
...
int func_312(int iParam0, struct<3> Param1, bool bParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x2460B
{
	int iVar0;
...
int func_313(int iParam0, struct<3> Param1, float fParam2, float fParam3)//Position - 0x24781
{
...
int func_314(int iParam0, struct<3> Param1)//Position - 0x247B9
{
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
...
void func_315(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x24817
{
	func_316(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_316(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x24831
{
	func_317(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_317(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x2484E
{
...
void func_318(var uParam0, int iParam1, struct<3> Param2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x24886
{
	int iVar0;
	int iVar1;
...
void func_319(var uParam0)//Position - 0x24BF3
{
...
int func_320(var uParam0)//Position - 0x24C5C
{
	int iVar0;
...
int func_321(bool bParam0)//Position - 0x24C87
{
	switch (Global_8861)
	{
		case 0:
...
void func_322(char* sParam0, int iParam1)//Position - 0x24D31
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

int func_323(char* sParam0)//Position - 0x24D48
{
	if (!func_324(1, 1, 0))
	{
...
int func_324(bool bParam0, bool bParam1, bool bParam2)//Position - 0x24DE1
{
	if (bParam0)
	{
...
bool func_325()//Position - 0x24F5D
{
	return MISC::GET_GAME_TIMER() <= Global_4354.f_140A + 100;
}

void func_326(var uParam0, int iParam1, struct<3> Param2, int iParam3)//Position - 0x24F72
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_327()//Position - 0x25075
{
	return func_328(PLAYER::PLAYER_ID());
}

int func_328(int iParam0)//Position - 0x25085
{
...
int func_329(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x250A4
{
	if (uParam0->f_1)
	{
		if (MISC::GET_GAME_TIMER() >= (uParam0->f_8 + uParam0->f_9))
...
int func_330(bool bParam0, bool bParam1, bool bParam2)//Position - 0x25410
{
...
int func_331(bool bParam0, bool bParam1, bool bParam2)//Position - 0x25462
{
	if (!func_324(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_332(bool bParam0, bool bParam1, bool bParam2)//Position - 0x254AB
{
	if (!func_324(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_333(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2550A
{
	if (!func_324(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_334(int iParam0)//Position - 0x25560
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
void func_335()//Position - 0x255BB
{
	MISC::SET_BIT(&Global_8D8, 4);
}

void func_336(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x255CB
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
int func_337(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x256C6
{
	int iVar0;
	bool bVar1;
...
{
	PED::SET_PED_RELATIONSHIP_GROUP_HASH(uParam0, iLocal_321);
...
void func_339(var uParam0, struct<3> Param1)//Position - 0x25767
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_340()//Position - 0x25844
{
	...
	if (func_21(Local_67.f_9))
	{
		if (iLocal_69 == 0)
		{
			func_351(&(Local_67.f_9), &bLocal_115);
			if (func_350())
			{
				if (iLocal_108 || iLocal_57 == 7)
				{
					if (bLocal_115)
					{
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			...
			{
				case 0:
					if (func_102(Local_67.f_9, Local_336, 20f))
					{
				...
				case 6:
					if (!func_102(Local_67.f_9, Local_336, 3.5f))
					{
				...
				case 29:
					if (func_110(Local_67.f_12, MISC::GET_RANDOM_INT_IN_RANGE(250, 500)))
					{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 14, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 28, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 37, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 43, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 45, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 50, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 51, 0);
						PED::SET_PED_COMBAT_RANGE(Local_67.f_9, 2);
						...
						TASK::TASK_COMBAT_PED(Local_67.f_9, PLAYER::PLAYER_PED_ID(), 0, 16);
						TASK::TASK_SET_SPHERE_DEFENSIVE_AREA(Local_67.f_9, Local_337, 30f);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_67.f_9, 1);
						Local_67.f_A = 30;
					}
					break;
				...
				case 13:
					if (func_110(Local_67.f_12, MISC::GET_RANDOM_INT_IN_RANGE(0, 500)))
					{
						if (PED::IS_PED_USING_ANY_SCENARIO(Local_67.f_9))
						{
							PED::SET_PED_PANIC_EXIT_SCENARIO(Local_67.f_9, Local_336);
						}
						WEAPON::GET_CURRENT_PED_WEAPON(Local_67.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
						...
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 5, 0);
						PED::SET_PED_COMBAT_ATTRIBUTES(Local_67.f_9, 17, 1);
						TASK::OPEN_SEQUENCE_TASK(&uLocal_144);
						...
						TASK::CLOSE_SEQUENCE_TASK(uLocal_144);
						TASK::TASK_PERFORM_SEQUENCE(Local_67.f_9, uLocal_144);
						TASK::CLEAR_SEQUENCE_TASK(&uLocal_144);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_67.f_9, 1);
						PED::SET_PED_KEEP_TASK(Local_67.f_9, 1);
						Local_67.f_A = 14;
					}
				...
				case 14:
					if (!func_61(Local_67.f_9, 1805844857) && !PED::IS_PED_FLEEING(Local_67.f_9))
					{
						Local_67.f_12 = (MISC::GET_GAME_TIMER() - 5000);
						Local_67.f_A = 13;
					}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_342())
							{
								...
								if (!PED::IS_PED_IN_VEHICLE(Local_67.f_9, iVar1, 0))
								{
									...
									if (fVar3 < 1.75f && func_102(Local_67.f_9, Local_336, 8f))
									{
				...
				case 23:
					if (func_345(Local_67.f_9, Local_67.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_344())
					{
						...
						{
							TASK::TASK_LOOK_AT_ENTITY(Local_67.f_9, PLAYER::PLAYER_PED_ID(), -1, 0, 2);
							if ((!func_341(Local_67.f_13, 10) && func_102(Local_67.f_9, Local_336, 50f)) || !func_110(iLocal_141, 2000))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_67.f_9, 1))
								{
									TASK::TASK_LEAVE_ANY_VEHICLE(Local_67.f_9, 0, 0);
					...
					if (func_345(Local_67.f_9, Local_67.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_344())
					{
						if (!func_61(Local_67.f_9, -1519143300))
						{
							if (!func_61(Local_67.f_9, -875674219))
							{
								if (PED::IS_PED_IN_ANY_VEHICLE(Local_67.f_9, 0))
								{
									if (!func_341(Local_67.f_13, 10) && func_102(Local_67.f_9, Local_336, 50f))
									{
										TASK::TASK_LEAVE_ANY_VEHICLE(Local_67.f_9, 0, 0);
										Local_67.f_A = 23;
									}
							...
							else if (!func_341(Local_67.f_13, 10) && func_102(Local_67.f_9, Local_336, 50f))
							{
...
bool func_341(int iParam0, int iParam1)//Position - 0x269AB
{
	return (MISC::GET_FRAME_COUNT() - iParam0) > iParam1;
}

int func_342()//Position - 0x269BD
{
	int iVar0;
	int iVar1;
...
int func_345(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x26AC0
{
	...
	if (func_21(iParam0))
	{
		...
		if (func_102(iParam0, Local_336, fParam2))
		{
...
int func_346(bool bParam0, bool bParam1, bool bParam2)//Position - 0x26C76
{
	int iVar0;
...
int func_347(float fParam0, float fParam1, float fParam2)//Position - 0x26D6D
{
...
char* func_348()//Position - 0x26D89
{
	return "move_m@bail_bond_not_tazered";
}

char* func_349()//Position - 0x26D95
{
	return "move_m@bail_bond_tazered";
}

int func_350()//Position - 0x26DA1
{
...
void func_351(var uParam0, bool bParam1)//Position - 0x26DD6
{
...
int func_354(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x26EDA
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_355(int iParam0, int iParam1)//Position - 0x27006
{
	int iVar0;
...
int func_357(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x27115
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
float func_358(struct<3> Param0, struct<3> Param1)//Position - 0x271A6
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}
...
{
	if (func_56(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_335, 100f))
	{
		if (!func_362())
		{
			CUTSCENE::REQUEST_CUTSCENE(&cLocal_330, 8);
			func_63();
			iLocal_113 = 1;
		}
	}
	...
	{
		if (!func_56(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_335, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
...
bool func_362()//Position - 0x272BC
{
	return Global_1567C;
}
		...
		switch (iLocal_59)
		{
			...
			case 1:
				if (!iLocal_109)
				{
					...
					func_107(&(Local_67.f_8));
					if (!func_102(Local_67.f_9, Local_336, 25f))
					{
						...
						if (func_341(iLocal_134, 10))
						{
							if (!func_59())
							{
								if (func_71(&uLocal_156, cLocal_150, "BBC_T9", 4, 0, 0, 0))
								{
									iLocal_123 = MISC::GET_GAME_TIMER();
								}
							}
					...
					else if (!iLocal_82)
					{
						if (!func_306(sLocal_147, 1))
						{
							if (func_71(&uLocal_156, cLocal_150, "BBC_T5", 4, 0, 0, 0))
							{
								iLocal_82 = 1;
							}
						}
				...
				else if (func_102(Local_67.f_9, Local_336, 8f))
				{
					...
					if (!func_59())
					{
						if (Local_67.f_A == 21 || Local_67.f_A == 22)
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 2) == 0)
							{
								if (func_71(&uLocal_156, cLocal_150, "BBC_T10", 4, 0, 0, 0))
								{
									iLocal_123 = MISC::GET_GAME_TIMER();
								}
							}
							else if (func_71(&uLocal_156, cLocal_149, "BB2_J5", 4, 0, 0, 0))
							{
								iLocal_123 = MISC::GET_GAME_TIMER();
							}
						}
...
void func_364()//Position - 0x275C4
{
	...
	if (func_21(Local_67.f_9))
	{
		...
		if (!iLocal_84)
		{
			if (func_71(&uLocal_156, cLocal_149, "BB2_J6", 4, 0, 0, 0))
			{
				iLocal_84 = 1;
			}
		}
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(Local_67.f_9, 0) && PED::GET_VEHICLE_PED_IS_IN(Local_67.f_9, 0) == iVar0)
			{
					...
					if (ENTITY::DOES_ENTITY_EXIST(iVar0))
					{
						if (ENTITY::GET_ENTITY_SPEED(iVar0) < 0.5f)
						{
							if (!iLocal_93)
							{
								if (!func_59())
								{
									if (func_110(iLocal_139, 3500))
									{
										if (func_71(&uLocal_156, cLocal_149, "BB2_STOP", 4, 0, 0, 0))
										{
											iLocal_93 = 1;
										}
									}
				...
				{
					if (func_71(&uLocal_156, cLocal_149, "BB2_J9", 4, 0, 0, 0))
					{
						iLocal_83 = 1;
					}
				}
			...
			if (PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID()))
			{
				...
				if (!iLocal_88)
				{
					if (func_342())
					{
						if (!PED::IS_PED_IN_ANY_VEHICLE(Local_67.f_9, 0))
						{
							...
							{
								if (func_71(&uLocal_156, cLocal_150, "BBC_T6", 4, iVar1, 0, 0))
								{
									iLocal_88 = 1;
								}
							}
					...
					else if (!func_306("BBC_T8", 1) && !func_306("BB2_WTF", 1))
					{
						...
						{
							if (func_71(&uLocal_156, cLocal_150, "BBC_T8", 4, iVar1, 0, 0))
							{
								iLocal_88 = 1;
							}
						}
						else if (func_71(&uLocal_156, cLocal_149, "BB2_WTF", 4, iVar1, 0, 0))
						{
							iLocal_88 = 1;
						}
					}
				...
				else if (!iLocal_92)
				{
					if (func_365(&iVar0))
					{
						...
						{
							if (func_71(&uLocal_156, cLocal_149, "BB2_JACK", 4, iVar1, 0, 0))
							{
								iLocal_92 = 1;
							}
						}
			...
			else
			{
				...
				if (PED::IS_PED_IN_ANY_VEHICLE(Local_67.f_9, 0))
				{
					if (!iLocal_89)
					{
						if (!func_306("BBC_T7", 1) && !func_306("BB2_OUT", 1))
						{
							if (MISC::GET_RANDOM_INT_IN_RANGE(0, 11) < 5)
							{
								if (func_71(&uLocal_156, cLocal_150, "BBC_T7", 4, iVar1, 0, 0))
								{
									iLocal_89 = 1;
								}
							}
							else if (func_71(&uLocal_156, cLocal_149, "BB2_OUT", 4, iVar1, 0, 0))
							{
								iLocal_89 = 1;
							}
						}
				...
				else if (Local_67.f_A == 24 && func_61(Local_67.f_9, -1519143300))
				{
					if (func_102(Local_67.f_9, Local_336, 25f))
					{
						...
						{
							if (func_110(iLocal_124, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_59())
								{
									func_3();
								}
								if (func_71(&uLocal_156, cLocal_149, "BB2_J10", 4, 0, 0, 0))
								{
				...
				else
				{
					...
					if (!func_59())
					{
						if (func_110(iLocal_123, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_102(Local_67.f_9, Local_336, 20f))
							{
								if (func_71(&uLocal_156, cLocal_149, "BB2_J4", 4, 0, 0, 0))
								{
									iLocal_123 = MISC::GET_GAME_TIMER();
								}
							}
...
int func_365(int iParam0)//Position - 0x27A40
{
	int iVar0;
...
void func_366(char* sParam0, int iParam1)//Position - 0x27A79
{
	if (func_310(sParam0))
	{
...
void func_367(int iParam0)//Position - 0x27A90
{
	...
	{
		if (func_71(&uLocal_156, cLocal_149, sLocal_148[iParam0], 4, 0, 0, 0))
		{
			iLocal_85[iParam0] = 1;
			iLocal_107 = 0;
			iLocal_122 = 0;
		...
		switch (iLocal_59)
		{
			...
			case 1:
				if (!iLocal_109)
				{
					...
					{
						if (!HUD::DOES_BLIP_EXIST(uLocal_116))
						{
							if (iLocal_96)
							{
								uLocal_116 = func_373(Local_335, 5, 1);
							}
						}
						if (!iLocal_82)
						{
						...
						{
							func_364();
							func_371(&Local_74, Local_336, &iLocal_125, 5000, 1101004800);
						}
						if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_335, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_102(PLAYER::PLAYER_PED_ID(), Local_335, 6.5f))
							{
								iLocal_59 = 2;
							}
						}
						else if (func_102(PLAYER::PLAYER_PED_ID(), Local_335, 2.5f))
						{
							iLocal_59 = 2;
						}
					}
				...
				else
				{
					...
					if (func_102(Local_67.f_9, Local_336, 8f))
					{
						if (Local_67.f_A == 25 || Local_67.f_A == 26)
						{
							Local_67.f_12 = MISC::GET_GAME_TIMER();
				...
				if (!bLocal_106)
				{
					bLocal_106 = func_369(Local_336, Local_62, 180f);
				}
				if (func_301(&(Local_67.f_9)))
				{
					iLocal_114 = 1;
			...
			case 2:
				...
				else
				{
					...
					if (!bLocal_106)
					{
						bLocal_106 = func_369(Local_336, Local_62, 0f);
					}
					func_121(4);
				}
				break;
...
int func_369(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x27EB8
{
	int iVar0;
	
	if (!func_370(Param0, Param1, fParam2))
	{
		...
		if (iLocal_133 > 0)
		{
			...
			while (iVar0 <= (iLocal_133 - 1))
			{
				func_40(&(Local_68[iVar0 /*20*/]), 1, 0, 1);
				iVar0++;
			}
		}
		if (iLocal_130 > 0)
...
bool func_370(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x27FAA
{
	struct<3> Var0;
...
int func_371(int iParam0, struct<3> Param1, int iParam2, int iParam3, float fParam4)//Position - 0x27FD4
{
	struct<3> Var0;
	var uVar1;
	char[] cVar2[8];
		...
		if (!func_59())
		{
			...
			if (SYSTEM::VDIST2(Param1, Var0) < (fParam4 * fParam4))
			{
				if (MISC::GET_GAME_TIMER() - *iParam2) > (iParam3 + MISC::GET_RANDOM_INT_IN_RANGE(0, 2000))
				{
					...
					cVar2 = "BBCAUD";
					sVar3 = "BBC_loiter";
					func_372(&uVar1, cVar2, sVar3, 4, 0, 0);
...
void func_372(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28061
{
...
int func_373(struct<3> Param0, int iParam1, int iParam2)//Position - 0x2809C
{
	int iVar0;
...
void func_374()//Position - 0x280CA
{
	...
	if (func_21(Local_67.f_9))
	{
		...
		{
			case 0:
				if (Local_67.f_A != 29 && Local_67.f_A != 30)
				{
					Local_67.f_12 = MISC::GET_GAME_TIMER();
					Local_67.f_A = 29;
				}
				...
				if (!iLocal_108)
				{
					...
					if (!iLocal_80)
					{
						if (func_102(Local_67.f_9, Local_336, 30f))
						{
							if (!func_59())
							{
								if (func_71(&uLocal_156, cLocal_149, sLocal_146, 4, 0, 0, 0))
								{
									Local_67.f_11 = MISC::GET_GAME_TIMER();
									iLocal_123 = MISC::GET_GAME_TIMER();
									iLocal_80 = 1;
					...
					if (Local_67.f_A == 13 || Local_67.f_A == 14)
					{
						...
						else if (func_110(iLocal_135, 5000))
						{
							bVar0 = true;
						}
						if (func_312(Local_67.f_9, Local_336, bVar0, 0, 1, 170))
						{
							func_311();
							func_376(iLocal_133);
							Local_67.f_11 = MISC::GET_GAME_TIMER();
					...
					else if ((iLocal_128 > 0 && func_102(Local_67.f_9, Local_336, 85f)) || ENTITY::GET_ENTITY_HEALTH(Local_67.f_9) < 200)
					{
						Local_67.f_A = 13;
						Local_67.f_12 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_135 = MISC::GET_GAME_TIMER();
					...
					{
						if (func_110(iLocal_123, MISC::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_102(Local_67.f_9, Local_336, 30f))
							{
								if (MISC::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
								{
									if (func_71(&uLocal_156, cLocal_150, "BBC_T2", 4, 0, 0, 0))
									{
										iLocal_123 = MISC::GET_GAME_TIMER();
									}
								}
								else if (func_71(&uLocal_156, cLocal_149, "BB2_SHOOT", 4, 0, 0, 0))
								{
									iLocal_123 = MISC::GET_GAME_TIMER();
								}
							}
...
void func_375(bool bParam0, var uParam1)//Position - 0x285AB
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_376(int iParam0)//Position - 0x28697
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (Local_68[iVar0 /*20*/].f_E != 5)
		{
			func_96(Local_68[iVar0 /*20*/], 1);
			Local_68[iVar0 /*20*/].f_E = 4;
			func_106(&(Local_68[iVar0 /*20*/].f_6));
		}
		iVar0++;
	}
...
void func_377(int iParam0)//Position - 0x286E0
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_21(Local_68[iVar0 /*20*/]))
		{
			func_352(Local_68[iVar0 /*20*/], &(Local_68[iVar0 /*20*/].f_11), 1126825984, 7);
			switch (Local_68[iVar0 /*20*/].f_E)
			{
				case 0:
					break;
				...
				case 1:
					...
					if (func_110(Local_68[iVar0 /*20*/].f_F, iVar2))
					{
						func_111(iVar0);
					}
					break;
				...
				case 2:
					func_378(Local_68[iVar0 /*20*/], &(Local_68[iVar0 /*20*/].f_6), -1, 0, 0, 0, -1082130432, 0);
					break;
				
				case 3:
					if (!func_61(Local_68[iVar0 /*20*/], -2017877118))
					{
						func_111(iVar0);
					}
					break;
				...
				case 4:
					if (!func_61(Local_68[iVar0 /*20*/], 1805844857))
					{
						func_96(Local_68[iVar0 /*20*/], 1);
					}
					func_106(&(Local_68[iVar0 /*20*/].f_6));
...
int func_378(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, int iParam7)//Position - 0x28867
{
	if (iParam3 == 0)
	{
...
void func_379(int iParam0)//Position - 0x28986
{
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_21(Local_68[iVar0 /*20*/]))
		{
			Local_68[iVar0 /*20*/].f_F = MISC::GET_GAME_TIMER();
			Local_68[iVar0 /*20*/].f_E = 1;
		}
		iVar0++;
	}
}
...
void func_380()//Position - 0x289C5
{
	if (func_21(Local_67.f_9))
	{
		func_360(Local_67.f_9, &iLocal_134, 1126825984, 1);
		func_352(Local_67.f_9, &(Local_67.f_13), 1126825984, 7);
		func_340();
		switch (iLocal_59)
		{
			case 0:
				...
				func_304(&(Local_67.f_8), "", "", &iLocal_126, &iLocal_127, 1, 0);
				iLocal_59 = 1;
				break;
				...
				switch (iLocal_60)
				{
					case 2:
						if (!iLocal_87)
						{
							...
							if (func_71(&uLocal_156, cLocal_150, "BBC_T14", 4, 0, 0, 0))
							{
								Local_67.f_11 = MISC::GET_GAME_TIMER();
								iLocal_87 = 1;
							}
						...
						else if (!iLocal_98)
						{
							...
							{
								func_304(&(Local_67.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_126, &iLocal_127, 1, 1);
								iLocal_98 = 1;
							}
						}
						else
						{
							func_336(&(Local_67.f_8), "BBS_APHEND", "BBS_APHEND2", &iLocal_126, iLocal_127, 1);
							if (func_102(Local_67.f_9, Local_336, 22f) && func_390(Local_67.f_9, Local_336, 10f))
							{
								if (PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_IN_COVER(PLAYER::PLAYER_PED_ID(), 0))
								{
									if (func_389(&(Local_67.f_13)))
									{
										iLocal_60 = 1;
										iLocal_90 = 0;
								...
								else if (func_388(Local_67.f_9, iLocal_134, 0, 1102053376, 1086324736))
								{
									iLocal_60 = 0;
								}
								else if (func_102(Local_67.f_9, Local_336, 5f))
								{
									iLocal_60 = 0;
								}
								else if (func_389(&(Local_67.f_13)))
								{
									if (func_102(Local_67.f_9, Local_336, (22f - 1.5f)))
									{
										iLocal_60 = 1;
										iLocal_90 = 0;
										if (Local_67.f_A != 3 && Local_67.f_A != 4)
						...
						if (func_345(Local_67.f_9, Local_67.f_13, 22f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_59 = 2;
						}
						break;
					...
					case 1:
						if (!iLocal_90)
						{
							...
							if (func_71(&uLocal_156, cLocal_149, "BB2_J2", 4, 0, 0, 0))
							{
								Local_67.f_11 = MISC::GET_GAME_TIMER();
								iLocal_123 = MISC::GET_GAME_TIMER();
								iLocal_90 = 1;
						...
						else if (!iLocal_86)
						{
							if (!func_306("BBC_T14", 1) && !func_306("BB2_J2", 1))
							{
								...
								if (func_71(&uLocal_156, cLocal_150, "BBC_T1", 4, 0, 0, 0))
								{
									Local_67.f_11 = MISC::GET_GAME_TIMER();
									iLocal_86 = 1;
								}
...
void func_382()//Position - 0x28EC8
{
	Global_38DE = 0;
	func_383();
}

void func_383()//Position - 0x28ED8
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
void func_384()//Position - 0x28EFC
{
	if (!iLocal_91)
	{
		if (!func_59())
		{
			if (func_102(Local_67.f_9, Local_336, (22f + 5f)))
			{
				iLocal_117 = 0;
				if (HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
				...
				if (MISC::IS_STRING_NULL_OR_EMPTY(&Local_334))
				{
					if (func_71(&uLocal_156, cLocal_149, "BB2_AMB", 1, iLocal_117, 0, 0))
					{
						iLocal_91 = 1;
					}
				}
				else if (func_386(&uLocal_156, cLocal_149, "BB2_AMB", &Local_334, 1, iLocal_117, 0))
				{
					iLocal_91 = 1;
					StringCopy(&Local_334, "", 24);
				}
	...
	{
		if (!func_102(Local_67.f_9, Local_336, (22f + 10f)))
		{
			Local_334 = { func_385() };
			if (!MISC::IS_STRING_NULL_OR_EMPTY(&Local_334))
			{
...
struct<6> func_385()//Position - 0x29021
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
bool func_387(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2910A
{
...
int func_388(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2915E
{
	if (func_411(iParam0))
	{
		if (!func_341(iParam1, 10))
		{
			if (bParam2)
			{
				if (!func_102(Local_67.f_9, Local_336, fParam3))
				{
					return 0;
				}
				if (!func_390(iParam0, Local_336, fParam4))
				{
					return 0;
				}
			}
...
int func_389(var uParam0)//Position - 0x291C4
{
...
int func_390(int iParam0, struct<3> Param1, float fParam2)//Position - 0x291DE
{
	struct<3> Var0;
	float fVar1;
...
void func_392(var uParam0, var uParam1)//Position - 0x2943A
{
	if (!uParam0->f_7)
	{
...
char* func_393(int iParam0)//Position - 0x294CB
{
	switch (iParam0)
	{
		case 0:
...
char* func_394(int iParam0)//Position - 0x29510
{
	switch (iParam0)
	{
		case 0:
...
int func_395(int iParam0, int iParam1, int iParam2)//Position - 0x29553
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_396(int iParam0)//Position - 0x2963D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_397(int iParam0)//Position - 0x296A1
{
	switch (iParam0)
	{
		case 0:
...
void func_400()//Position - 0x29784
{
	...
	if (iLocal_57 == 0)
	{
		if (!SYSTEM::VDIST2(Local_336, Local_62) <= ((Local_62.f_3 + 25f) * (Local_62.f_3 + 25f)))
		{
	...
	else if (ENTITY::DOES_ENTITY_EXIST(Local_67.f_9))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_67.f_9) && !PED::IS_PED_INJURED(Local_67.f_9))
		{
			...
			{
				if (!func_102(Local_67.f_9, Local_336, 150f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_67.f_9))
					{
						iLocal_61 = 2;
			...
			{
				if (!func_102(Local_67.f_9, Local_336, 80f))
				{
					if (ENTITY::IS_ENTITY_OCCLUDED(Local_67.f_9))
					{
						iLocal_61 = 2;
...
int func_401(bool bParam0)//Position - 0x298C1
{
	if (func_21(Local_74))
	{
		...
		if (func_407(Local_74, 1126825984))
		{
			return 1;
		}
		if (func_402(Local_74, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_402(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x29A19
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_411(PLAYER::PLAYER_PED_ID()) && func_411(iParam0))
	{
...
int func_403(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x29B14
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_404(int iParam0, float fParam1)//Position - 0x29C20
{
	var uVar0;
	struct<3> Var1;
...
int func_405(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0x29CB5
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
...
int func_406(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x29D43
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_407(int iParam0, float fParam1)//Position - 0x29D8B
{
	...
	if (func_411(PLAYER::PLAYER_PED_ID()) && func_411(iParam0))
	{
		if (func_409(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
int func_409(int iParam0)//Position - 0x29E19
{
...
void func_410(int iParam0, struct<3> Param1, float fParam2, bool bParam3, bool bParam4)//Position - 0x29E41
{
...
int func_411(int iParam0)//Position - 0x29E6F
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
bool func_412(bool bParam0)//Position - 0x29E8F
{
...
void func_414()//Position - 0x29F49
{
	...
	func_19();
	PED::REMOVE_RELATIONSHIP_GROUP(iLocal_321);
	func_465();
	func_121(0);
}
...
void func_415(bool bParam0, bool bParam1)//Position - 0x29FBB
{
	...
	if (iLocal_57 > 2)
	{
		func_375(0, &uLocal_143);
	}
	PED::REMOVE_SCENARIO_BLOCKING_AREA(uLocal_142, 0);
	PED::CLEAR_PED_NON_CREATION_AREA();
	func_104(&uLocal_156, 2);
	func_104(&uLocal_156, 3);
	func_104(&uLocal_156, 4);
	func_309(&uLocal_43, 0, 0);
...
void func_417()//Position - 0x2A0FF
{
...
void func_419(int iParam0)//Position - 0x2A176
{
	Global_15679 = iParam0;
}

void func_420(bool bParam0)//Position - 0x2A184
{
	if (bParam0)
	{
...
void func_421(bool bParam0)//Position - 0x2A260
{
	if (bParam0)
	{
		func_422();
...
void func_422()//Position - 0x2A2C3
{
...
void func_424(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0x2A31F
{
	if (func_464())
	{
...
void func_425(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x2A3B4
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_459(iParam4, iParam5, iParam6))
		{
			iVar0 = 0;
		}
	}
	...
	else if (iParam7 == 1)
	{
		...
		{
			func_440(iParam10, 0);
			while (!func_426(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_426(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x2A53C
{
	var uVar0;
	var uVar1;
	struct<73> Var2;
		...
		if (Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_437(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_39));
		...
		else if (Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_437(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, 1, 1);
				...
				func_437(iParam0, &(Var2.f_1F), &(Var2.f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 1)
				{
...
void func_427(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2B322
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_80(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_431(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_17C49.f_5B2F[iParam0 /*43*/].f_1F = func_430(*iParam1);
				...
				func_428(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_1));
				...
				func_428(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_428(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2BF01
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_429(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
bool func_429(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2BF74
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_430(int iParam0)//Position - 0x2D4DF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_431(int iParam0, bool bParam1, var uParam2)//Position - 0x2D59D
{
	int iVar0;
...
int func_432(int iParam0, bool bParam1, var uParam2)//Position - 0x2D63F
{
	if (!bParam1)
	{
...
int func_433(int iParam0)//Position - 0x2D9D9
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_434(int iParam0, int iParam1)//Position - 0x2DA02
{
	int iVar0;
...
void func_435(var uParam0)//Position - 0x2DA84
{
	if (!func_436(*uParam0))
	{
...
bool func_436(int iParam0)//Position - 0x2DAAF
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_437(var uParam0, var uParam1, var uParam2)//Position - 0x2DABE
{
	int iVar0;
	int iVar1;
...
int func_438(int iParam0)//Position - 0x2DBF0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_439(var uParam0, var uParam1)//Position - 0x2DCCC
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_440(int iParam0, int iParam1)//Position - 0x2DD0D
{
	int iVar0;
...
void func_441(struct<3> Param0, float fParam1, int iParam2)//Position - 0x2DDAE
{
	int iVar0;
...
void func_442(int iParam0)//Position - 0x2DDFE
{
	bool bVar0;
	...
	if (func_151(&(Global_10642.f_22B[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_10642.f_22B[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_157(iParam0, 0)) && Global_109CF.f_2A == 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] != 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] > 3) && (!func_443(0, Global_10642.f_22B[0 /*21*/].f_C) || !func_443(1, Global_10642.f_22B[0 /*21*/].f_C)))
			{
...
int func_443(int iParam0, int iParam1)//Position - 0x2DF73
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_444(&(Global_17C49.f_47C3.f_113E[iVar0 /*109*/])))
	{
		return 0;
	}
...
int func_444(var uParam0)//Position - 0x2DFE4
{
	return *uParam0;
}

int func_445(struct<3> Param0, float fParam1)//Position - 0x2DFEF
{
	return func_446(&(Global_16D94.f_877), Param0, fParam1, 0);
}

int func_446(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x2E009
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam3)
					{
						...
						{
							func_440(uParam0->f_B, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_440(uParam0->f_B, 2);
						}
					}
				...
				else if ((!func_448(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_447(int iParam0)//Position - 0x2E2B4
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_448(int iParam0, struct<3> Param1, bool bParam2)//Position - 0x2E376
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_450(iParam0, Global_10642.f_8B[38], 0))
			{
				func_442(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_450(iParam0, Global_10642.f_8B[43], 1))
			{
				func_442(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_450(iParam0, uVar1[iVar3], 1) && func_449(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
...
int func_449(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2E57C
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_450(int iParam0, int iParam1, bool bParam2)//Position - 0x2E5C8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_451(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x2E628
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_35, 15) || func_453(iParam0)) || (((uParam1->f_26 == 0 && uParam1->f_27 == 0) && uParam1->f_28 == 0) && uParam1->f_9[20] > 0)) && func_452())
		{
			uParam1->f_26 = 0;
			uParam1->f_27 = 0;
			uParam1->f_28 = 0;
		...
		if (bParam3)
		{
			func_437(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		}
...
bool func_452()//Position - 0x2EA15
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_453(int iParam0)//Position - 0x2EA26
{
	var uVar0;
...
int func_454(var uParam0)//Position - 0x2EA71
{
	if (func_455(uParam0))
	{
...
int func_455(var uParam0)//Position - 0x2EAA6
{
...
bool func_456()//Position - 0x2EACF
{
	return func_454(&(Global_16D94.f_877));
}

void func_457()//Position - 0x2EAE2
{
	func_458(&(Global_16D94.f_877));
}

void func_458(var uParam0)//Position - 0x2EAF5
{
	if (func_455(uParam0))
	{
...
int func_459(int iParam0, int iParam1, int iParam2)//Position - 0x2EB13
{
	...
	if (iParam2 == 0 && func_461(Global_16D94.f_877.f_C.f_2A))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_461(int iParam0)//Position - 0x2EBF7
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_462()//Position - 0x2EC50
{
	return func_455(&(Global_16D94.f_877));
}

int func_463()//Position - 0x2EC63
{
...
void func_465()//Position - 0x2ECB1
{
	...
	PED::ADD_RELATIONSHIP_GROUP("ENEMIES", &iLocal_321);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, 1862763509, iLocal_321);
	PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, iLocal_321, 1862763509);
	Var0 = { func_472(Local_62) };
	Var1 = { func_471(Local_62) };
	PED::SET_PED_NON_CREATION_AREA(Var0, Var1);
	uLocal_142 = PED::ADD_SCENARIO_BLOCKING_AREA(Var0, Var1, 0, 1, 1, 1);
	MISC::CLEAR_AREA(Local_62, 15f, 0, 0, 0, 0);
	...
	if (func_21(PLAYER::PLAYER_PED_ID()))
	{
		func_87(&uLocal_156, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(PLAYER::PLAYER_PED_ID(), 1);
	}
	if (func_21(Local_67.f_9))
	{
		func_87(&uLocal_156, 3, Local_67.f_9, sLocal_145, 0, 1);
...
void func_466()//Position - 0x2EDF6
{
	...
	if (func_21(Local_67.f_9))
	{
		...
		if (Local_67.f_C != 0)
		{
			WEAPON::GIVE_WEAPON_TO_PED(Local_67.f_9, Local_67.f_C, -1, 1, 1);
		}
		func_338(Local_67.f_9);
		func_467(Local_67.f_9, "TARGET_", 0);
		Local_67.f_A = 0;
		PED::SET_PED_COMPONENT_VARIATION(Local_67.f_9, 0, 0, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_67.f_9, 2, 0, 1, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_67.f_9, 3, 1, 0, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_67.f_9, 4, 0, 2, 0);
		PED::SET_PED_COMPONENT_VARIATION(Local_67.f_9, 8, 0, 0, 0);
		TASK::OPEN_SEQUENCE_TASK(&uLocal_144);
		...
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "base", 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK::TASK_PLAY_ANIM(0, "oddjobs@bailbond_surf_farm", "idle_a", 8f, -4f, -1, 0, 0, 0, 0, 0);
		TASK::SET_SEQUENCE_TO_REPEAT(uLocal_144, 1);
		TASK::CLOSE_SEQUENCE_TASK(uLocal_144);
		TASK::TASK_PERFORM_SEQUENCE(Local_67.f_9, uLocal_144);
		TASK::CLEAR_SEQUENCE_TASK(&uLocal_144);
	}
	...
	while (iVar0 <= 5)
	{
		if (func_21(Local_68[iVar0 /*20*/]))
		{
			func_338(Local_68[iVar0 /*20*/]);
			if (Local_68[iVar0 /*20*/].f_5 != 0)
			{
				WEAPON::GIVE_WEAPON_TO_PED(Local_68[iVar0 /*20*/], Local_68[iVar0 /*20*/].f_5, -1, 1, 1);
			}
			PED::SET_PED_CONFIG_FLAG(Local_68[iVar0 /*20*/], 137, 1);
			func_467(Local_68[iVar0 /*20*/], "BACKUP_", iVar0);
			if (func_92(Local_70[0 /*6*/]))
			{
				if (iVar0 == 1)
				{
					PED::SET_PED_INTO_VEHICLE(Local_68[iVar0 /*20*/], Local_70[0 /*6*/], -1);
					PED::SET_PED_COMBAT_ATTRIBUTES(Local_68[iVar0 /*20*/], 1, 0);
				}
				else if (iVar0 == 2)
				{
					PED::SET_PED_INTO_VEHICLE(Local_68[iVar0 /*20*/], Local_70[0 /*6*/], 2);
				}
				else if (iVar0 == 3)
				{
					PED::SET_PED_INTO_VEHICLE(Local_68[iVar0 /*20*/], Local_70[0 /*6*/], 1);
			...
			{
				case 0:
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 0, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 2, 1, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 3, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 4, 0, 0, 0);
					break;
				
				case 1:
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 0, 0, 3, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 2, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 3, 2, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 4, 0, 1, 0);
					break;
				
				case 2:
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 0, 1, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 2, 0, 1, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 3, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 4, 0, 2, 0);
					break;
				
				case 3:
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 0, 0, 0, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 2, 0, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 3, 1, 2, 0);
					PED::SET_PED_COMPONENT_VARIATION(Local_68[iVar0 /*20*/], 4, 0, 2, 0);
					break;
			}
			if (iVar0 == 0)
			{
				...
				TASK::SET_SEQUENCE_TO_REPEAT(uLocal_144, 1);
				TASK::CLOSE_SEQUENCE_TASK(uLocal_144);
				TASK::TASK_PERFORM_SEQUENCE(Local_68[iVar0 /*20*/], uLocal_144);
				TASK::CLEAR_SEQUENCE_TASK(&uLocal_144);
				if (func_21(Local_68[iVar0 /*20*/]))
				{
					func_87(&uLocal_156, 4, Local_68[iVar0 /*20*/], "HILLBILLY", 0, 1);
					PED::SET_PED_CAN_USE_AUTO_CONVERSATION_LOOKAT(Local_68[iVar0 /*20*/], 1);
				}
			}
		}
		iVar0++;
...
void func_467(var uParam0, char* sParam1, int iParam2)//Position - 0x2F2A7
{
	char cVar0[16];
...
int func_468()//Position - 0x2F2C3
{
	...
	if (iLocal_133 > 0)
	{
		...
		{
			if (func_51(&(Local_68[iVar2 /*20*/]), Local_68[iVar2 /*20*/].f_13, Local_68[iVar2 /*20*/].f_1, Local_68[iVar2 /*20*/].f_4, 0, 0, 0))
			{
				if (func_21(Local_68[iVar2 /*20*/]))
				{
					PED::SET_PED_CONFIG_FLAG(Local_68[iVar2 /*20*/], 132, 1);
					iVar0++;
					iVar1++;
				}
			}
	...
	if (iVar1 == iLocal_133)
	{
		...
		while (iVar2 <= (iLocal_133 - 1))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(Local_68[iVar2 /*20*/].f_13);
			iVar2++;
		}
	}
	if (iLocal_130 > 0)
	{
		...
		{
			if (func_470(&(Local_70[iVar2 /*6*/]), Local_70[iVar2 /*6*/].f_5, Local_70[iVar2 /*6*/].f_1, Local_70[iVar2 /*6*/].f_4, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iLocal_132 > 0)
	{
		...
		{
			if (func_469(&(Local_73[iVar2 /*7*/]), Local_73[iVar2 /*7*/].f_5, Local_73[iVar2 /*7*/].f_2, Local_73[iVar2 /*7*/].f_6, Local_73[iVar2 /*7*/].f_1, 1))
			{
				iVar0++;
			}
			iVar2++;
	...
	if (iVar0 == ((((iLocal_133 + iLocal_130) + iLocal_131) + iLocal_129) + iLocal_132) + 1)
	{
		return 1;
	}
	return 0;
...
int func_469(var uParam0, var uParam1, struct<3> Param2, var uParam3, int iParam4, bool bParam5)//Position - 0x2F50A
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_53(iParam4))
...
int func_470(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0x2F57B
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
Vector3 func_471(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x2F614
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_472(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x2F688
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_473()//Position - 0x2F6FC
{
	...
	iVar0 = 0;
	iLocal_66 = 4;
	Local_67.f_B = joaat("a_m_y_salton_01");
	Local_67.f_D = { 162.5572f, 2289.158f, 93.1489f };
	Local_67.f_10 = 292.4985f;
	...
	Local_67.f_13 = 0;
	func_8();
	Local_68[0 /*20*/].f_13 = joaat("a_m_m_hillbilly_02");
	Local_68[0 /*20*/].f_1 = { 164.3371f, 2290.645f, 93.1434f };
	Local_68[0 /*20*/].f_4 = 119.9981f;
	Local_68[0 /*20*/].f_5 = joaat("weapon_pistol");
	Local_68[1 /*20*/].f_13 = joaat("a_m_m_hillbilly_02");
	Local_68[1 /*20*/].f_1 = { 162.4443f, 2283.816f, 92.9438f };
	Local_68[1 /*20*/].f_4 = 299.9979f;
	Local_68[1 /*20*/].f_5 = joaat("weapon_pistol");
	Local_68[2 /*20*/].f_13 = joaat("a_m_m_hillbilly_02");
	Local_68[2 /*20*/].f_1 = { 163.1961f, 2282.257f, 93.6852f };
	Local_68[2 /*20*/].f_4 = 299.9979f;
	Local_68[2 /*20*/].f_5 = joaat("weapon_pistol");
	Local_68[3 /*20*/].f_13 = joaat("a_m_m_hillbilly_02");
	Local_68[3 /*20*/].f_1 = { 163.9295f, 2283.512f, 92.6928f };
	Local_68[3 /*20*/].f_4 = 299.9979f;
	Local_68[3 /*20*/].f_5 = joaat("weapon_pistol");
	iVar0 = 0;
	while (iVar0 <= (iLocal_133 - 1))
	{
		Local_68[iVar0 /*20*/].f_F = 0;
		Local_68[iVar0 /*20*/].f_10 = 0;
		Local_68[iVar0 /*20*/].f_11 = 0;
		Local_68[iVar0 /*20*/].f_E = 0;
		iVar0++;
	}
	iLocal_133 = 4;
	Local_70[0 /*6*/].f_5 = joaat("bison");
	Local_70[0 /*6*/].f_1 = { 167.6809f, 2285.204f, 92.2978f };
	Local_70[0 /*6*/].f_4 = 164.9999f;
	Local_70[1 /*6*/].f_5 = joaat("gauntlet");
	Local_70[1 /*6*/].f_1 = { 183.4f, 2287.07f, 91.09f };
	Local_70[1 /*6*/].f_4 = 208.2f;
	iLocal_130 = 2;
	iLocal_131 = 0;
	iLocal_129 = 0;
	iLocal_132 = 0;
	Local_338 = { 232.541f, 2321.896f, 76.1228f };
	fLocal_118 = 129.6421f;
	Local_339 = { 190.8215f, 2284.055f, 88.3843f };
	fLocal_119 = 76.0608f;
	Local_340 = { 181.1229f, 2289.56f, 91.2944f };
	fLocal_120 = 103.4559f;
	Local_341 = { 0f, 0f, 0f };
	Local_342 = { 0f, 0f, 0f };
	iLocal_60 = 4;
	iLocal_80 = 0;
	...
	iLocal_138 = 0;
	iLocal_140 = -1;
	Local_337 = { 166.4233f, 2285.507f, 92.5205f };
	Local_335 = { 2722.661f, 4143.105f, 43.0617f };
	StringCopy(&Local_322, "", 24);
	StringCopy(&Local_334, "", 24);
	Local_74.f_6 = func_484(62);
	Local_74.f_1 = { func_483() };
	Local_74.f_4 = func_482();
	Local_76.f_5 = func_481();
	Local_76.f_1 = { func_480() };
	Local_76.f_4 = func_479();
	Local_77.f_5 = func_478();
	Local_77.f_1 = { func_477() };
	Local_77.f_4 = func_476();
	Local_78.f_5 = func_45();
	Local_78.f_1 = { func_44() };
	Local_78.f_4 = func_43();
	Local_79.f_5 = func_42();
	Local_79.f_1 = { func_475() };
	Local_79.f_4 = func_474();
	sLocal_145 = "BailBond2Jumper";
	sLocal_146 = "BB2_J1";
	sLocal_147 = "BB2_J3";
	sLocal_148[0] = "BB2_VC1";
	sLocal_148[1] = "BB2_VC2";
	sLocal_148[2] = "BB2_VC3";
	iVar0 = 0;
	while (iVar0 <= 2)
	{
		iLocal_85[iVar0] = 0;
...
float func_474()//Position - 0x2FB47
{
	return 75.15f;
}

Vector3 func_475()//Position - 0x2FB54
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_476()//Position - 0x2FB6B
{
	return 71f;
}

Vector3 func_477()//Position - 0x2FB78
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_478()//Position - 0x2FB8F
{
	return joaat("prop_laptop_01a");
}

float func_479()//Position - 0x2FB9C
{
	return -91.28f;
}

Vector3 func_480()//Position - 0x2FBA9
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_481()//Position - 0x2FBC0
{
	return joaat("prop_table_03_chr");
}

float func_482()//Position - 0x2FBCD
{
	return 89.19f;
}

Vector3 func_483()//Position - 0x2FBDA
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_484(int iParam0)//Position - 0x2FBF1
{
	if (!func_80(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
...
int func_485(bool bParam0)//Position - 0x2FC1C
{
...
int func_489(int iParam0)//Position - 0x2FD54
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_488()) || Global_17890) || Global_5F7E) || func_494()) || func_85(8, -1)) || func_493()) || func_492()) || func_486()) || func_487()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_488()) || Global_5F7E) || func_494()) || func_85(8, -1)) || func_486()) || func_493()) || func_492()) || func_487()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_488()) || Global_17890) || Global_5F7E) || func_494()) || func_85(8, -1)) || func_486()) || func_493()) || func_492()) || func_487()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_488()) || Global_17890) || Global_5F7E) || func_494()) || func_85(8, -1)) || func_493()) || func_492()) || func_487()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_488() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_85(8, -1)) || func_487()) || func_491()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_488()) || Global_5F7E) || func_494()) || func_85(8, -1)) || func_492()) || func_486()) || func_487()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_488()) || func_492()) || Global_17890) || Global_5F7E) || func_494()) || Global_8C75) || func_85(8, -1)) || func_486()) || func_491()) || func_487()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_488()) || Global_17890) || Global_5F7E) || func_494()) || func_85(8, -1)) || func_486()) || func_491()) || func_493()) || func_492()) || func_487())
						{
							return 0;
						}
						break;
...
var func_490()//Position - 0x30472
{
	return Global_15F91.f_1;
}

int func_491()//Position - 0x30480
{
	if (Global_154F9 != -1)
	{
...
bool func_492()//Position - 0x304A6
{
	return Global_15F9E.f_123 > 0;
}

bool func_493()//Position - 0x304B7
{
	return Global_15F9E.f_122 > 0;
}

var func_494()//Position - 0x304C8
{
	return Global_14143C;
}

bool func_495(int iParam0)//Position - 0x304D4
{
	return func_496(iParam0, Global_8861);
}

int func_496(int iParam0, int iParam1)//Position - 0x304E5
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_497(int iParam0)//Position - 0x306C6
{
	func_522();
	if (!func_521())
	{
		...
		func_498(SCRIPT::GET_THIS_SCRIPT_NAME());
	}
}

void func_498(char* sParam0)//Position - 0x30711
{
	if (Global_15F6A != 12)
	{
...
int func_499(char* sParam0, int iParam1, int iParam2)//Position - 0x3072E
{
	var uVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_510())
	{
		...
		{
			iVar2 = func_500(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar2 > -1)
			{
...
int func_500(char* sParam0)//Position - 0x308C0
{
...
void func_501(int iParam0, var uParam1)//Position - 0x30916
{
	switch (iParam0)
	{
		case 0:
...
int func_503(int iParam0)//Position - 0x31B5C
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_504(int iParam0)//Position - 0x31EA2
{
	struct<2> Var0;
	char[] cVar1[8];
	
	StringCopy(&Var0, "", 8);
	cVar1 = { func_505(iParam0) };
...
struct<2> func_505(int iParam0)//Position - 0x31ED9
{
	struct<2> Var0;
...
int func_506()//Position - 0x32325
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_507(&(Global_15F6A.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_507(char* sParam0, bool bParam1)//Position - 0x32349
{
	int iVar0;
	int iVar1;
...
int func_508(int iParam0, bool bParam1)//Position - 0x32373
{
	int iVar0;
...
int func_510()//Position - 0x323F9
{
	...
	{
		if (func_500(&(Global_15F6A.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_511(int iParam0)//Position - 0x32465
{
	if (iParam0 == 1)
	{
		Global_8A86 = 1;
...
void func_512(int iParam0)//Position - 0x3247E
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_513(int iParam0)//Position - 0x32492
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_514(int iParam0)//Position - 0x324CF
{
	if (iParam0 == 1)
	{
...
void func_515()//Position - 0x3250C
{
	Global_42CA.f_5 = 1;
}

void func_516()//Position - 0x3251A
{
	Global_42CA.f_5 = 0;
}

void func_517()//Position - 0x32528
{
	Global_14A3F = 0;
	Global_14A40 = 0;
}

void func_518()//Position - 0x3253A
{
	Global_15F6A = 13;
	Global_15F6A.f_1 = -1;
	Global_15F6A.f_2 = 0;
...
void func_522()//Position - 0x32625
{
	Global_15F8D = 1;
