...
void __EntryFunction__()//Position - 0x0
{
	...
	else if (func_412(0))
	{
		...
		{
			func_410(PLAYER::PLAYER_PED_ID(), Local_697, fLocal_457, 0, 0);
		...
		switch (iLocal_97)
		{
			case 0:
				if (iLocal_99 == 1)
				{
					if (!func_67())
					{
						func_18(PLAYER::PLAYER_PED_ID(), Local_700, fLocal_458, 0, 1);
			...
			case 1:
				...
				if (iLocal_99 == 1)
				{
					if (!func_67())
					{
						func_18(PLAYER::PLAYER_PED_ID(), Local_703, fLocal_459, 0, 1);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_442 == 0)
						{
			...
			case 3:
				...
				if (iLocal_99 == 1)
				{
					...
					if (!func_67())
					{
						func_410(PLAYER::PLAYER_PED_ID(), Local_688, 254.9762f, 0, 0);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
						CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
						if (iLocal_442 == 0)
						{
...
bool func_6(struct<3> Param0, var uParam3, var uParam4, int iParam5)//Position - 0x717
{
	var uVar0;
	struct<3> Var1;
...
void func_10(struct<3> Param0, float fParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x7ED
{
	var uVar0;
	int iVar1;
...
void func_17(int iParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x9F7
{
	struct<3> Var0;
	float fVar3;
	float fVar4;
...
int func_18(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0xA56
{
	bool bVar0;
	float fVar1;
...
int func_51(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6, bool bParam7, bool bParam8)//Position - 0x130F
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
int func_54(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x13E2
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
bool func_56(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x14B8
{
		...
		case 0:
			...
			if (iLocal_101 == 4)
			{
				if (func_21(Local_384))
				{
					...
					func_103(Local_384, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(Local_384))
					{
						if (func_102(Local_384, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
							AUDIO::STOP_PED_SPEAKING(Local_384, 0);
							func_100(Local_384, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
				if (func_21(Local_384))
			...
			else
			{
				if (!iLocal_433)
				{
					...
					if (iLocal_101 == 4)
					{
						if (func_21(Local_384))
						{
							if (func_102(Local_384, Local_691, 35f))
							{
				...
				if (iLocal_101 == 4)
				{
					...
					else if (func_21(Local_384))
					{
						if (!func_61(Local_384, 1805844857))
						{
							...
							{
								if (!ENTITY::IS_ENTITY_PLAYING_ANIM(Local_384, func_99(), func_70(), 3))
								{
									func_69(&Local_384);
...
bool func_102(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2C44
{
...
void func_122(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x3D13
{
	struct<3> Var0;
	var uVar3;
...
void func_123(int iParam0, struct<3> Param1, float fParam4, int iParam5, bool bParam6)//Position - 0x3D8E
{
	struct<54> Var0;
...
void func_154(int iParam0, struct<54> Param1, struct<3> Param55, float fParam58, int iParam59)//Position - 0x66B3
{
	if (func_151(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
...
void func_158(struct<54> Param0, var uParam54)//Position - 0x6870
{
...
bool func_161(struct<3> Param0, struct<3> Param3)//Position - 0x6A18
{
...
int func_167(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x6F4E
{
	int iVar0;
...
int func_168(struct<3> Param0, int iParam3, int iParam4)//Position - 0x7064
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_171(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x7127
{
	func_172(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_172(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x7150
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_174(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x7560
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_175(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x7856
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_178(struct<3> Param0, int iParam3)//Position - 0x79AE
{
	return func_179(Global_91351.f_2167.f_12.f_42, Param0, iParam3);
}

int func_179(int iParam0, struct<3> Param1, int iParam4)//Position - 0x79CB
{
	struct<3> Var0;
	struct<3> Var3;
				...
				if (!iLocal_447)
				{
					...
					if (Local_111.f_10 == 13 || Local_111.f_10 == 14)
					{
						...
						else
						{
							...
							{
								if (func_110(iLocal_462, MISC::GET_RANDOM_INT_IN_RANGE(5000, 12000)))
								{
									if (func_102(Local_111.f_9, Local_691, 30f))
									{
...
void func_308(int iParam0, struct<3> Param1, int iParam4, float fParam5)//Position - 0x2433B
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_312(int iParam0, struct<3> Param1, bool bParam4, bool bParam5, bool bParam6, int iParam7)//Position - 0x2460B
{
	int iVar0;
...
int func_313(int iParam0, struct<3> Param1, float fParam4, float fParam5)//Position - 0x24781
{
...
void func_317(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2484E
{
...
void func_318(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x24886
{
	int iVar0;
	int iVar1;
...
void func_326(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x24F72
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (!PED::IS_PED_PERFORMING_STEALTH_KILL(PLAYER::PLAYER_PED_ID()))
		{
			switch (Local_111.f_10)
			{
				...
				case 15:
					...
					{
						if ((!PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_253[0 /*6*/], 0) && func_102(Local_253[0 /*6*/], Local_253[0 /*6*/].f_1, 3f)) && func_347(ENTITY::GET_ENTITY_HEADING(Local_253[0 /*6*/]), Local_253[0 /*6*/].f_4, 20f))
						{
				...
				case 16:
					...
					else if (((PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_253[0 /*6*/], 0) || PED::IS_PED_BEING_JACKED(Local_111.f_9)) || !func_102(Local_253[0 /*6*/], Local_253[0 /*6*/].f_1, 3f)) || !func_347(ENTITY::GET_ENTITY_HEADING(Local_253[0 /*6*/]), Local_253[0 /*6*/].f_4, 20f))
					{
						Local_111.f_10 = 13;
					}
...
int func_354(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x26EDA
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_358(struct<3> Param0, struct<3> Param3)//Position - 0x271A6
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
{
	if (func_56(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_688, 100f))
	{
		if (!func_362())
		{
	...
	{
		if (!func_56(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_688, 120f))
		{
			if (CUTSCENE::HAS_CUTSCENE_LOADED())
			{
				CUTSCENE::REMOVE_CUTSCENE();
			...
			else
			{
				...
				else if (Local_111.f_10 == 24 && func_61(Local_111.f_9, -1519143300))
				{
					if (func_102(Local_111.f_9, Local_691, 25f))
					{
						...
						{
							if (func_110(iLocal_463, MISC::GET_RANDOM_INT_IN_RANGE(2500, 5000)))
							{
								if (func_59())
								{
									func_3();
				...
				else
				{
					...
					if (!func_59())
					{
						if (func_110(iLocal_462, MISC::GET_RANDOM_INT_IN_RANGE(3000, 6000)))
						{
							if (!func_102(Local_111.f_9, Local_691, 20f))
							{
				...
				if (!iLocal_448)
				{
					...
					else
					{
						if (!HUD::DOES_BLIP_EXIST(uLocal_455))
						{
							if (iLocal_435)
							{
								uLocal_455 = func_373(Local_688, 5, 1);
							}
						}
						if (!iLocal_418)
						{
						...
						if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
						{
							if (func_102(PLAYER::PLAYER_PED_ID(), Local_688, 6.5f))
							{
								iLocal_99 = 2;
							}
						}
						else if (func_102(PLAYER::PLAYER_PED_ID(), Local_688, 2.5f))
						{
							iLocal_99 = 2;
						}
					}
...
bool func_370(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x27FAA
{
	struct<3> Var0;
...
int func_371(int iParam0, struct<3> Param1, int iParam4, int iParam5, float fParam6)//Position - 0x27FD4
{
	struct<3> Var0;
	var uVar3;
	char[] cVar168[8];
...
int func_373(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2809C
{
	int iVar0;
		...
		switch (iLocal_99)
		{
			...
			case 1:
				...
				if (!iLocal_447)
				{
					...
					else if ((iLocal_467 > 0 && func_102(Local_111.f_9, Local_691, 85f)) || ENTITY::GET_ENTITY_HEALTH(Local_111.f_9) < 200)
					{
						Local_111.f_10 = 13;
						Local_111.f_18 = (MISC::GET_GAME_TIMER() - 5000);
						iLocal_474 = MISC::GET_GAME_TIMER();
					...
					{
						if (func_110(iLocal_462, MISC::GET_RANDOM_INT_IN_RANGE(3500, 7000)))
						{
							if (func_102(Local_111.f_9, Local_691, 30f))
							{
								if (MISC::GET_RANDOM_INT_IN_RANGE(0, 101) < 30)
...
int func_390(int iParam0, struct<3> Param1, float fParam4)//Position - 0x291DE
{
	struct<3> Var0;
	float fVar3;
...
int func_405(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x29CB5
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_410(int iParam0, struct<3> Param1, float fParam4, bool bParam5, bool bParam6)//Position - 0x29E41
{
...
void func_424(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2A31F
{
	if (func_464())
	{
...
void func_425(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x2A3B4
{
	int iVar0;
...
int func_426(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2A53C
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_437(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_437(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
	...
	if ((func_80(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_431(*iParam1, 0, &uVar0))
		{
			...
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_430(*iParam1);
				...
				func_428(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_428(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
void func_441(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2DDAE
{
	int iVar0;
...
void func_442(int iParam0)//Position - 0x2DDFE
{
	...
	if (func_151(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_67138.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_157(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_443(0, Global_67138.f_555[0 /*21*/].f_12) || !func_443(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
...
int func_443(int iParam0, int iParam1)//Position - 0x2DF73
{
	...
	if (iParam0 < 0 || iParam0 >= func_444(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
...
int func_445(struct<3> Param0, float fParam3)//Position - 0x2DFEF
{
	return func_446(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_446(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2E009
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_448(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2E376
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_450(iParam0, Global_67138.f_139[38], 0))
			{
				func_442(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_450(iParam0, Global_67138.f_139[43], 1))
			{
				func_442(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_450(iParam0, uVar1[iVar6], 1) && func_449(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
...
int func_449(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2E57C
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_451(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x2E628
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_453(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_452())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
...
{
	return func_454(&(Global_93588.f_2167));
}

void func_457()//Position - 0x2EAE2
{
	func_458(&(Global_93588.f_2167));
}
...
int func_459(int iParam0, int iParam1, int iParam2)//Position - 0x2EB13
{
	...
	if (iParam2 == 0 && func_461(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_469(var uParam0, var uParam1, struct<3> Param2, var uParam5, int iParam6, bool bParam7)//Position - 0x2F50A
{
	if (!OBJECT::DOES_PICKUP_EXIST(*uParam0))
	{
		if (func_53(iParam6))
...
int func_470(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2F57B
{
	if (!ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (func_53(iParam1))
...
Vector3 func_471(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x2F614
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_472(struct<5> Param0, var uParam5, var uParam6, var uParam7)//Position - 0x2F688
{
	switch (Param0.f_4)
	{
		case 0:
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_488()) || Global_96400) || Global_24446) || func_494()) || func_85(8, -1)) || func_493()) || func_492()) || func_486()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_488()) || Global_24446) || func_494()) || func_85(8, -1)) || func_486()) || func_493()) || func_492()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_488()) || Global_96400) || Global_24446) || func_494()) || func_85(8, -1)) || func_486()) || func_493()) || func_492()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5) || Global_35460 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_488()) || Global_96400) || Global_24446) || func_494()) || func_85(8, -1)) || func_493()) || func_492()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_488() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_85(8, -1)) || func_487()) || func_491()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_488()) || Global_24446) || func_494()) || func_85(8, -1)) || func_492()) || func_486()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_488()) || func_492()) || Global_96400) || Global_24446) || func_494()) || Global_35957) || func_85(8, -1)) || func_486()) || func_491()) || func_487()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_488()) || Global_96400) || Global_24446) || func_494()) || func_85(8, -1)) || func_486()) || func_491()) || func_493()) || func_492()) || func_487())
						{
							return 0;
						}
						break;
...
{
	return func_496(iParam0, Global_34913);
}
...
int func_499(char* sParam0, int iParam1, int iParam2)//Position - 0x3072E
{
	...
	if (func_510())
	{
		...
		{
			iVar33 = func_500(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_506()//Position - 0x32325
{
	...
	iVar0 = func_507(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_510()//Position - 0x323F9
{
	...
	{
		if (func_500(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
