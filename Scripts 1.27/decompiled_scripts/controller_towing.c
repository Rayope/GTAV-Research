...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_69 = 1;
	iLocal_245 = -1;
	Local_253 = { 405.8286f, -1627.996f, 28.2928f };
	fLocal_254 = 1f;
	...
	while (true)
	{
		if (func_132())
		{
			...
			{
				iLocal_272 = 0;
				func_2(&iLocal_271, iVar2, &uVar0, &iLocal_272, bVar1);
			}
			SYSTEM::WAIT(iLocal_272);
		}
		else
		{
			func_1();
...
void func_1()//Position - 0x100
{
	...
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_267))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("a_f_y_soucent_01"));
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_268))
	{
		if (ENTITY::IS_ENTITY_OCCLUDED(iLocal_268))
		{
			...
			if (ENTITY::IS_ENTITY_A_MISSION_ENTITY(iLocal_268))
			{
				VEHICLE::DELETE_VEHICLE(&iLocal_268);
			}
		}
		else
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
			ENTITY::SET_VEHICLE_AS_NO_LONGER_NEEDED(&iLocal_268);
		}
	}
}

void func_2(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x196
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
	...
	*iParam3 = 500;
	if (!ENTITY::IS_ENTITY_DEAD(iParam1))
	{
		...
		func_129(Global_17C49.f_4733.f_3, &Var1, &uVar3, &uVar0, &uVar2);
		if (Global_17C49.f_4733.f_3 >= 5 || uLocal_256)
		{
			func_128(iParam1, Var1, uVar3, iParam0);
			func_126(iParam0, iParam1);
		}
		switch (*iParam0)
		{
			case 0:
				uLocal_262 = uLocal_262;
				MISC::SET_RANDOM_SEED(((CLOCK::GET_CLOCK_SECONDS() * CLOCK::GET_CLOCK_MINUTES()) * CLOCK::GET_CLOCK_HOURS()));
				func_124(&(Global_17C49.f_4733.f_1), 2048);
				func_124(&(Global_17C49.f_4733.f_1), 4096);
				func_124(&(Global_17C49.f_4733.f_1), 8192);
				func_124(&(Global_17C49.f_4733.f_1), 16384);
				...
				if (func_130(iParam0, 0, 1))
				{
					...
					*iParam3 = 0;
					if (PAD::IS_CONTROL_JUST_PRESSED(0, 86) || PAD::IS_DISABLED_CONTROL_PRESSED(0, 86))
					{
						func_101();
						func_99();
						Local_50.x = iLocal_267;
						Local_50.f_1 = iLocal_268;
						*iParam0 = 16;
					}
				}
				break;
			...
			case 16:
				...
				*iParam3 = 0;
				iVar4 = func_91();
				func_124(&(Global_17C49.f_4733.f_1), 1073741824);
				if (iVar4 == 1)
				{
					if (!bParam4)
					{
			...
			case 17:
				if (!SCRIPT::IS_THREAD_ACTIVE(uLocal_244))
				{
					if (func_22(Global_17707, 3))
					{
						*iParam0 = 18;
					}
					else
					{
						func_21(&iLocal_44);
						func_3();
						func_124(&Global_17707, 3);
						func_1();
						func_23();
						iLocal_268 = 0;
						iLocal_267 = 0;
						if (func_22(Global_17C49.f_4733.f_1, 2048))
						{
							iLocal_248 = 0;
						}
						else if (func_22(Global_17C49.f_4733.f_1, 4096))
						{
							iLocal_248 = 10000;
						}
						else if (func_22(Global_17C49.f_4733.f_1, 8192))
						{
							iLocal_248 = 60000;
						}
						else if (func_22(Global_17C49.f_4733.f_1, 16384))
						{
							iLocal_248 = 120000;
						}
						else
						...
						func_124(&(Global_17C49.f_4733.f_1), 8192);
						func_124(&(Global_17C49.f_4733.f_1), 16384);
						if (ENTITY::DOES_ENTITY_EXIST(iLocal_267) && !ENTITY::IS_ENTITY_DEAD(iLocal_267))
						{
							PED::REMOVE_PED_FROM_GROUP(iLocal_267);
						}
						if (HUD::DOES_BLIP_EXIST(uLocal_266))
						{
							HUD::REMOVE_BLIP(&uLocal_266);
						}
			...
			case 18:
				if (Global_15F6A == 10)
				{
					...
					{
						bParam4 = true;
						if (iLocal_264 == joaat("towtruck"))
						{
							STREAMING::REQUEST_MODEL(joaat("towtruck"));
						}
						else if (iLocal_264 == joaat("towtruck2"))
						{
						...
						if (Global_17C49.f_4733.f_3 >= 5)
						{
							if (STREAMING::HAS_MODEL_LOADED(iLocal_264))
							{
								...
								if (!ENTITY::DOES_ENTITY_EXIST(iLocal_268))
								{
									...
									iLocal_268 = VEHICLE::CREATE_VEHICLE(iLocal_264, 408.8376f, -1638.952f, 28.2928f, 230.2387f, 1, 1);
									STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_264);
								}
								if (!ENTITY::IS_ENTITY_DEAD(PLAYER::PLAYER_PED_ID()) && !ENTITY::IS_ENTITY_DEAD(iLocal_268))
								{
									...
									ENTITY::SET_ENTITY_HEADING(iLocal_268, 230.2387f);
									*iParam0 = 16;
								}
							}
						}
			...
			case 19:
				if ((MISC::GET_GAME_TIMER() - *uParam2) > iLocal_248)
				{
					*uParam2 = 0;
					*iParam0 = 0;
				}
...
void func_4(int iParam0)//Position - 0x6A2
{
	if (iParam0 == 1)
	{
...
void func_6()//Position - 0x6E9
{
	StringCopy(&Global_10B7D, "", 16);
	StringCopy(&Global_10B81, "", 16);
}

void func_7()//Position - 0x703
{
	int iVar0;
...
void func_11(int iParam0)//Position - 0x7D5
{
	if (iParam0 == 1)
	{
		Global_8A86 = 1;
...
void func_12()//Position - 0x7EE
{
	func_13(&Global_16D94);
}

void func_13(var uParam0)//Position - 0x7FE
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_18(&(uParam0->f_19[0 /*223*/][iVar1 /*74*/]));
		func_18(&(uParam0->f_19[1 /*223*/][iVar1 /*74*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_17(&(uParam0->f_871));
	func_15(&(uParam0->f_877));
	func_14(&(uParam0->f_8B9));
}

void func_14(var uParam0)//Position - 0xD44
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_15(var uParam0)//Position - 0xD5F
{
	func_16(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_16(var uParam0)//Position - 0xD8E
{
	int iVar0;
...
void func_17(var uParam0)//Position - 0xE3E
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_18(var uParam0)//Position - 0xE5C
{
	int iVar0;
...
void func_19(var uParam0)//Position - 0xF3C
{
	*uParam0 = -15;
}

void func_20()//Position - 0xF4A
{
	StringCopy(&Global_164CF, "", 32);
	func_13(&Global_164D7);
}

void func_21(int iParam0)//Position - 0xF63
{
	if (*iParam0 == -1)
	{
		return;
...
bool func_22(var uParam0, int iParam1)//Position - 0xFA0
{
	return (uParam0 && iParam1) != 0;
}

void func_23()//Position - 0xFAF
{
	if (func_22(uLocal_246, 1))
	{
		func_124(&uLocal_246, 1);
		func_21(&iLocal_245);
	}
	if (SCRIPT::IS_THREAD_ACTIVE(uLocal_244))
	{
		SCRIPT::TERMINATE_THREAD(uLocal_244);
	}
	SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
}

void func_24(char[4] cParam0, int iParam1)//Position - 0xFE4
{
	MISC::CLEAR_BIT(&(Global_15F6A.f_14), 17);
	func_25(cParam0, iParam1, 0);
}

void func_25(char[4] cParam0, int iParam1, int iParam2)//Position - 0x1001
{
	if (Global_15F6A != 10 && Global_15F6A != 9)
	{
		StringCopy(&Global_164CF, cParam0, 32);
		func_27(&Global_164D7, cParam0, 0, "Start", iParam1, iParam2);
		func_26();
		Global_14A41 = 0;
	}
}

void func_26()//Position - 0x1045
{
	int iVar0;
	int iVar1;
...
void func_27(var uParam0, char* sParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1CD5
{
	int iVar0;
	int iVar1;
...
int func_28(var uParam0)//Position - 0x2B59
{
...
void func_29(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B7B
{
	int iVar0;
...
int func_30(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2C02
{
...
int func_31(int iParam0)//Position - 0x2C42
{
	int iVar0;
...
void func_32(var uParam0, int iParam1, int iParam2)//Position - 0x2C70
{
...
int func_33(int iParam0)//Position - 0x2D4C
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x2D8E
{
	int iVar0;
...
int func_35(int iParam0, int iParam1, int iParam2)//Position - 0x2DF1
{
	int iVar0;
...
int func_36(int iParam0, int iParam1)//Position - 0x2E7F
{
	struct<58> Var0;
...
void func_37(int iParam0, var uParam1, int iParam2)//Position - 0x2EC1
{
	int iVar0;
	struct<74> Var1;
...
bool func_38(int iParam0)//Position - 0x3134
{
	return iParam0 < 3;
}

void func_39(int iParam0, var uParam1)//Position - 0x3140
{
	int iVar0;
...
int func_40(int iParam0)//Position - 0x33EA
{
	switch (iParam0)
	{
		case 1:
...
int func_41(int iParam0, var uParam1, var uParam2)//Position - 0x349A
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3574
{
	var uVar0;
...
int func_43(int iParam0, int iParam1, bool bParam2)//Position - 0x369E
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x370F
{
...
int func_45(int iParam0)//Position - 0x37E0
{
	int iVar0;
	int iVar1;
...
int func_46(int iParam0)//Position - 0x381D
{
	if (func_38(iParam0))
	{
...
void func_47(int iParam0, var uParam1, int iParam2)//Position - 0x3847
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x39F1
{
	var uVar0;
	var uVar1;
...
int func_49(var uParam0)//Position - 0x3A23
{
	int iVar0;
	int iVar1;
...
var func_50()//Position - 0x3A57
{
	return Global_1407E1;
}

int func_51(int iParam0, int iParam1)//Position - 0x3A63
{
	var uVar0;
	var uVar1;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3A8F
{
	int iVar0;
...
void func_53(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3FD7
{
	int iVar0;
...
int func_54()//Position - 0x4219
{
	func_55();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_55()//Position - 0x4232
{
	int iVar0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_46(Global_17C49.f_6C1.f_21B.f_C8D) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (func_38(iVar0) && (!func_56(14) || Global_17832))
			{
...
bool func_56(int iParam0)//Position - 0x432F
{
	return Global_8861 == iParam0;
}

void func_57(int iParam0, bool bParam1)//Position - 0x433D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_58(int iParam0, var uParam1)//Position - 0x4430
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_59(int iParam0)//Position - 0x4694
{
...
int func_60(int iParam0, int iParam1)//Position - 0x47BA
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_61(int iParam0, var uParam1)//Position - 0x4FD6
{
	int iVar0;
	int iVar1;
...
int func_62(int iParam0)//Position - 0x5011
{
	int iVar0;
...
void func_63(int iParam0)//Position - 0x5285
{
	int iVar0;
...
void func_64(var uParam0, int iParam1)//Position - 0x52C1
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_65(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x581C
{
	int iVar0;
	int iVar1;
...
bool func_66(int iParam0, var uParam1, var uParam2)//Position - 0x5860
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_67(struct<3> Param0, struct<3> Param1)//Position - 0x5EB6
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_68(var uParam0)//Position - 0x5EDF
{
...
bool func_69(int iParam0)//Position - 0x5F38
{
	return func_70(iParam0, 0, 1);
}

int func_70(int iParam0, int iParam1, bool bParam2)//Position - 0x5F48
{
	if (bParam2)
	{
...
int func_71(int iParam0)//Position - 0x5FA8
{
	switch (iParam0)
	{
		case 0:
...
int func_72()//Position - 0x6251
{
	return Global_5F7C;
}

int func_73(int iParam0)//Position - 0x625C
{
	return func_70(iParam0, 5, 1);
}

int func_74(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x626C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_75(int iParam0)//Position - 0x6303
{
	switch (iParam0)
	{
		case -1:
...
int func_76(int iParam0)//Position - 0x67D4
{
	return func_70(iParam0, 0, 0);
}

int func_77(int iParam0)//Position - 0x67E4
{
	switch (iParam0)
	{
		case -1:
...
bool func_78()//Position - 0x6A3D
{
	return Global_15F9E.f_122 > 0;
}

var func_79()//Position - 0x6A4E
{
	var uVar0;
...
void func_80(var uParam0, int iParam1)//Position - 0x6A94
{
	if (iParam1 <= 0)
	{
		return;
...
void func_81(var uParam0, int iParam1)//Position - 0x6B1A
{
...
void func_82(var uParam0, int iParam1)//Position - 0x6B4D
{
	int iVar0;
	int iVar1;
...
int func_83(int iParam0, int iParam1)//Position - 0x6B9E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_84(var uParam0)//Position - 0x6C40
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_85(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_85(bool bParam0, int iParam1, int iParam2)//Position - 0x6C65
{
	if (bParam0)
	{
		return iParam1;
...
int func_86(var uParam0)//Position - 0x6C7C
{
	return uParam0 & 15;
}

void func_87(var uParam0, int iParam1)//Position - 0x6C89
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6CC3
{
...
void func_89(var uParam0, int iParam1)//Position - 0x6CFE
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_90()//Position - 0x6D3A
{
	func_55();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

int func_91()//Position - 0x6D53
{
	int iVar0;
	...
	if (SCRIPT::HAS_SCRIPT_LOADED("Towing"))
	{
		...
		if (iVar0 == 1)
		{
			...
			Local_50.f_2 = 1;
			uLocal_244 = SYSTEM::START_NEW_SCRIPT_WITH_ARGS("Towing", &Local_50, 9, 17000);
			SCRIPT::SET_SCRIPT_AS_NO_LONGER_NEEDED("Towing");
			if (!ENTITY::IS_ENTITY_DEAD(iLocal_267))
			{
...
void func_92(var uParam0, int iParam1)//Position - 0x6DEE
{
	func_93(uParam0, iParam1);
}

void func_93(var uParam0, var uParam1)//Position - 0x6DFE
{
	*uParam0 = (*uParam0 || uParam1);
}

int func_94(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6E0F
{
	int iVar0;
...
void func_95(var uParam0, int iParam1)//Position - 0x6F46
{
	int iVar0;
...
bool func_96(int iParam0)//Position - 0x6F95
{
	return func_97(iParam0, Global_8861);
}

int func_97(int iParam0, int iParam1)//Position - 0x6FA6
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_98(int iParam0)//Position - 0x7187
{
	if (Global_8861 == 15)
	{
		return 0;
...
void func_100(var uParam0)//Position - 0x71C8
{
	uParam0->f_1 = 0f;
	uParam0->f_2 = 0f;
	*uParam0 = 0;
...
void func_101()//Position - 0x71DE
{
	Global_42CA.f_6 = 1;
}

void func_102()//Position - 0x71EC
{
	switch (iLocal_69)
	{
		case 1:
			if (!func_122())
			{
				if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && !func_121(&uLocal_57))
				{
					AUDIO::SET_FRONTEND_RADIO_ACTIVE(0);
					func_119(&uLocal_57);
				}
				else if (!HUD::IS_HELP_MESSAGE_BEING_DISPLAYED() && func_121(&uLocal_57))
				{
					if (func_116(&uLocal_57) >= 2f)
					{
						iLocal_69 = 0;
					}
				}
		...
		case 0:
			if (!func_122())
			{
				func_115(&uLocal_79, 4, 0, "TOWDISPATCH", 0, 1);
				if (func_104(&uLocal_79, "TOWAUD", "TOW_DISP_GEN", 9, 0, 0, 0))
				{
					iLocal_69 = 2;
				}
			}
		...
		case 4:
			if (func_116(&uLocal_57) > 30f)
			{
				if (!func_22(Global_17C49.f_4733.f_1, 1024))
				{
					func_103("TOW_MISSEDJOB", -1);
					func_92(&(Global_17C49.f_4733.f_1), 1024);
				}
				iLocal_69 = 5;
			}
			break;
...
void func_103(char* sParam0, int iParam1)//Position - 0x733B
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(sParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

bool func_104(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7352
{
...
int func_105(char* sParam0, int iParam1, bool bParam2)//Position - 0x73A0
{
	Global_3D4D = 0;
...
bool func_112(int iParam0, int iParam1)//Position - 0x78EA
{
	switch (iParam0)
	{
		case 5:
...
void func_114(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x797C
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_115(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x79D2
{
...
float func_116(var uParam0)//Position - 0x7A6D
{
	if (func_121(uParam0))
	{
		if (func_118(uParam0))
		...
		{
			return (func_117(MISC::IS_BIT_SET(*uParam0, 4)) - uParam0->f_1);
		}
	}
	return uParam0->f_1;
}

float func_117(bool bParam0)//Position - 0x7AAC
{
	int iVar0;
...
bool func_118(var uParam0)//Position - 0x7AF4
{
	return MISC::IS_BIT_SET(*uParam0, 2);
}

void func_119(var uParam0)//Position - 0x7B04
{
	func_120(uParam0, 0f);
}

void func_120(var uParam0, float fParam1)//Position - 0x7B13
{
	uParam0->f_1 = (func_117(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
	MISC::SET_BIT(uParam0, 1);
	MISC::CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}

bool func_121(var uParam0)//Position - 0x7B41
{
	return MISC::IS_BIT_SET(*uParam0, 1);
}

int func_122()//Position - 0x7B51
{
...
int func_123(int iParam0)//Position - 0x7B73
{
	int iVar0;
	int iVar1;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
	{
		...
		if (!ENTITY::IS_ENTITY_DEAD(iVar0))
		{
			if (VEHICLE::GET_PED_IN_VEHICLE_SEAT(iVar0, -1) == iParam0)
			{
				...
				{
					iLocal_268 = iVar0;
					if (ENTITY::DOES_ENTITY_EXIST(iLocal_268) && !ENTITY::IS_ENTITY_DEAD(iLocal_268))
					{
						iLocal_264 = ENTITY::GET_ENTITY_MODEL(iLocal_268);
					}
					return 1;
				}
			}
...
void func_124(var uParam0, int iParam1)//Position - 0x7BF0
{
	func_125(uParam0, iParam1);
}

void func_125(var uParam0, var uParam1)//Position - 0x7C00
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_126(var uParam0, int iParam1)//Position - 0x7C15
{
	if (!func_130(uParam0, 0, 1))
	{
		if (func_123(iParam1))
		{
			if (PAD::IS_CONTROL_JUST_PRESSED(0, 86) || PAD::IS_DISABLED_CONTROL_PRESSED(0, 86))
			{
				if ((((((!func_122() && !HUD::IS_HELP_MESSAGE_BEING_DISPLAYED()) && !func_98(0)) && !func_56(6)) && !func_56(7)) && !PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) && func_90() == 1)
				{
					func_115(&uLocal_79, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
					func_115(&uLocal_79, 4, 0, "TOWDISPATCH", 0, 1);
					if (func_104(&uLocal_79, "TOWAUD", "TOW_JOBS_AVL", 4, 0, 0, 0))
					{
						if (!func_121(&uLocal_66))
						{
							func_127(&uLocal_66);
						}
						else
	...
	if (iLocal_263)
	{
		if (func_121(&uLocal_66))
		{
			if (func_116(&uLocal_66) > 4f)
			{
				if (func_104(&uLocal_79, "TOWAUD", "TOW_NO_JOBS", 4, 0, 0, 0))
				{
					iLocal_263 = 0;
				}
			}
...
void func_127(var uParam0)//Position - 0x7D1B
{
	if (!func_121(uParam0))
	{
		func_119(uParam0);
...
void func_128(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x7D33
{
	float fVar0;
	var uVar1;
	int iVar2;
	
	fVar0 = SYSTEM::VDIST2(Param1, ENTITY::GET_ENTITY_COORDS(uParam0, 1));
	switch (iLocal_70)
	{
		case 0:
			...
			if (fVar0 < 25f && !func_22(Global_17C49.f_4733.f_1, 1073741824))
			{
				return;
			}
			if (bLocal_261)
			...
			if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
			{
				uVar1 = PED::GET_VEHICLE_PED_IS_IN(iParam0, 0);
		...
		case 2:
			...
			{
				if (!CAM::IS_SPHERE_VISIBLE(Local_253, fLocal_254) || func_22(Global_17C49.f_4733.f_1, 1073741824))
				{
					if (!ENTITY::DOES_ENTITY_EXIST(iLocal_268))
					{
						iLocal_268 = VEHICLE::CREATE_VEHICLE(joaat("towtruck"), Param1, uParam2, 1, 1);
						STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(joaat("towtruck"));
						iLocal_70 = 3;
					}
				}
		...
		case 3:
			if (PED::IS_PED_IN_ANY_VEHICLE(iParam0, 0))
			{
				if (PED::GET_VEHICLE_PED_IS_IN(iParam0, 0) == iLocal_268)
				{
					iLocal_70 = 0;
				}
			}
			if (ENTITY::IS_ENTITY_DEAD(iLocal_268))
			{
				iLocal_70 = 0;
			}
			if (fVar0 > 62500f)
...
void func_129(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x7EC9
{
	switch (iParam0)
	{
		case 0:
...
int func_130(var uParam0, bool bParam1, bool bParam2)//Position - 0x7F95
{
	if (!bParam1)
	{
		if (func_98(9))
...
int func_131(int iParam0)//Position - 0x8036
{
	int iVar0;
...
int func_133(int iParam0)//Position - 0x80E2
{
	return Global_17C49.f_6DC5[iParam0 /*4*/];
}

bool func_134(int iParam0, int iParam1)//Position - 0x80F5
{
	bool bVar0;
...
int func_135(int iParam0)//Position - 0x8142
{
	int iVar0;
	int iVar1;
