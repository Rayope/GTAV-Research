...
void __EntryFunction__()//Position - 0x0
{
	...
	func_555(Local_168, 200f, &Var0, &Var3);
	func_554(iLocal_579);
	func_554(iLocal_582);
	func_554(iLocal_577);
	if (func_553(0))
...
void func_1()//Position - 0x409
{
	...
	func_19(&uLocal_631, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	if (func_2(&uLocal_631, "BARY2AU", "BARY2_FREAK", 6, 0, 0, 0))
	{
...
void func_26()//Position - 0xE5C
{
	if (bLocal_209)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), Local_185[0 /*3*/], Local_185[1 /*3*/], Local_185.f_7, 0, 1, 0))
		{
			...
			func_29(&uLocal_211);
			uLocal_211 = func_28(Local_168, 5, 1);
...
int func_28(struct<3> Param0, int iParam3, int iParam4)//Position - 0xF3B
{
	int iVar0;
...
int func_33(int iParam0)//Position - 0x1096
{
	...
	switch (iLocal_159)
	{
		...
		case 2:
			...
			if (iParam0 == 1)
			{
				if (func_2(&uLocal_631, "BARY2AU", "BARY2_PREOUT", 8, 0, 0, 0) || MISC::GET_GAME_TIMER() > iLocal_156)
				{
		...
		case 4:
			...
			else
			{
				...
				iLocal_161 = func_35(PLAYER::PLAYER_PED_ID(), 1, 0, 0, 0, 0);
				if (ENTITY::DOES_ENTITY_EXIST(iLocal_161))
				{
					if (func_40(PLAYER::PLAYER_PED_ID()))
					{
						...
						if (func_40(iLocal_161) && ENTITY::IS_ENTITY_ATTACHED(iLocal_161))
						{
							ENTITY::DETACH_ENTITY(iLocal_161, 1, 0);
						}
						bVar3 = true;
...
int func_36(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6)//Position - 0x1429
{
	...
	while (func_37(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_37(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_37(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_54(struct<3> Param0, float fParam3)//Position - 0x212E
{
	func_55(&(Global_93588.f_2167), Param0, fParam3);
}

void func_55(var uParam0, struct<3> Param1, var uParam4)//Position - 0x2147
{
	*uParam0 = { Param1 };
	uParam0->f_6 = uParam4;
}

void func_56(struct<3> Param0, float fParam3)//Position - 0x215D
{
	if (func_57(Global_68485, 0f, 0f, 0f))
	{
		Global_68485 = { Param0 };
...
bool func_57(struct<3> Param0, struct<3> Param3)//Position - 0x2188
{
...
void func_70(int iParam0)//Position - 0x23FC
{
	...
	switch (*iParam0)
	{
		case 0:
			func_41("bar_4_rcm", 0);
			func_356(Local_172, 1112014848, 12, 5000, 0, 0);
		...
		case 1:
			...
			if (func_291(1, 1093140480, 0) && SCRIPT::HAS_SCRIPT_LOADED("postRC_Barry1and2"))
			{
				...
				GRAPHICS::REMOVE_DECALS_IN_RANGE(Local_172, 500f);
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(0, sLocal_334, 2, func_611(49), 0);
		...
		case 2:
			...
			else
			{
				...
				if (!func_51(Local_95.f_41[3]))
				{
					func_274(&(Local_95.f_41[3]), iLocal_546);
				}
				if (!func_51(Local_95.f_28[0]))
				{
				...
				{
					if (func_51(Local_95.f_41[0]) && func_51(Local_95.f_41[2]))
					{
		...
		case 3:
			...
			func_52(1, 1, 1, 1);
			func_276(PLAYER::PLAYER_PED_ID(), Local_172);
...
void func_72(int iParam0, bool bParam1)//Position - 0x2893
{
	...
	{
		func_231(&(Global_96440[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_75()//Position - 0x2AF2
{
	...
	{
		func_77(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
void func_89(var uParam0)//Position - 0x341F
{
	...
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_94(&(uParam0->f_25[0 /*223*/][iVar1 /*74*/]));
		func_94(&(uParam0->f_25[1 /*223*/][iVar1 /*74*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_93(&(uParam0->f_2161));
	func_91(&(uParam0->f_2167));
	func_90(&(uParam0->f_2233));
}
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x3CBF
{
	...
	Global_68106[1 /*14*/] = { func_149(iVar0, iParam1, iParam2) };
	...
	{
		uVar30 = { func_145(iVar0, 0) };
		Global_68106[1 /*14*/] = { func_149(iVar0, iParam1, uVar30[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_141(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_141(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_100(int iParam0, int iParam1, int iParam2)//Position - 0x3E78
{
	...
	{
		if (!func_213(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_102(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x3F3F
{
	...
	if (iParam5 == 0)
	{
		Global_68106[1 /*14*/] = { func_149(iVar10, iParam1, iParam2) };
		if (!func_139(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_68106[1 /*14*/] = { func_149(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar27 = { func_142(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_68106[1 /*14*/] = { func_149(iVar10, 14, uVar27[iVar1]) };
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_141(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_132(iVar0);
						if (Global_68105 == 1)
						{
			...
			{
				Global_68106[1 /*14*/] = { func_149(iVar10, iVar0, func_108(iParam0, iVar0, -1)) };
		...
		if (iParam7 == 1)
		{
			Var53 = { func_149(iVar10, 8, iVar5) };
			if (iVar5 != -99)
			{
				if (func_106(iVar10, iParam2, 8, iVar5, &uVar11, &Var53))
				{
					func_102(iParam0, 8, iVar5, iParam3, iParam4, iParam5, iParam6, iParam7, -1, -1, -1, 0);
				}
			}
			Var53 = { func_149(iVar10, 9, iVar6) };
			if (iVar6 != -99)
			{
				if (func_106(iVar10, iParam2, 9, iVar6, &uVar11, &Var53))
				{
					func_102(iParam0, 9, iVar6, iParam3, iParam4, iParam5, iParam6, iParam7, -1, -1, -1, 0);
				}
			}
			Var53 = { func_149(iVar10, 14, iVar7) };
			if (iVar7 != -99)
			{
				if (func_106(iVar10, iParam2, 14, iVar7, &uVar11, &Var53))
				{
					func_102(iParam0, 14, iVar7, iParam3, iParam4, iParam5, iParam6, iParam7, -1, -1, -1, 0);
				}
			}
			Var53 = { func_149(iVar10, 14, iVar8) };
			if (iVar8 != -99)
			{
				if (func_106(iVar10, iParam2, 14, iVar8, &uVar11, &Var53))
				{
					func_102(iParam0, 14, iVar8, iParam3, iParam4, iParam5, iParam6, iParam7, -1, -1, -1, 0);
				}
			}
			Var53 = { func_149(iVar10, 14, iVar9) };
			if (iVar9 != -99)
			{
				if (func_106(iVar10, iParam2, 14, iVar9, &uVar11, &Var53))
				{
	...
	{
		uVar67 = { func_142(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			Global_68106[1 /*14*/] = { func_149(iVar10, 14, uVar67[iVar1]) };
			func_118(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
			func_132(14);
			if (Global_68105 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_141(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_141(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
{
	Global_68106[1 /*14*/] = { func_149(iParam0, iParam1, iParam2) };
...
int func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6DB1
{
	...
	else if (iParam2 == 14)
	{
		...
		iVar18 = 0;
		iVar19 = (iParam1 - func_122(iParam0));
		if (iVar19 < 0)
		{
			return -1;
		}
	...
	else
	{
		...
		iVar39 = 0;
		iVar40 = (iParam1 - func_121(iParam0, func_141(iParam2)));
		if (iVar40 < 0)
		{
			return -1;
		}
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_141(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_128(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7C07
{
	...
	else if (iParam2 == 14)
	{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var0))
			{
				if (iParam1 == Var0.f_1)
				{
					return (func_122(iParam0) + iVar18);
				}
				iVar18++;
			}
			iVar17++;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_141(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				...
				{
					return (func_121(iParam0, func_141(iParam2)) + iVar38);
				}
				iVar38++;
			}
			iVar37++;
...
void func_132(int iParam0)//Position - 0x7E51
{
	...
	{
		func_138(iParam0, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_134(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7F52
{
	...
	iVar0 = Global_2454605[iParam0 /*6*/][func_135(iParam2)];
	if (iVar0 != 0)
	{
...
int func_136(int iParam0, int iParam1, int iParam2)//Position - 0x7FB1
{
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_135(iParam1)];
...
int func_140(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x95F4
{
	...
	{
		if (!func_213(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_148(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[0], Global_97353.f_1729.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_148(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[1], Global_97353.f_1729.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_148(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[2], Global_97353.f_1729.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_147(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_147(Var16.f_2)] = func_128(iParam1, Var16.x, func_147(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*iParam0)[func_147(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar19++;
		}
...
void func_151(int iParam0)//Position - 0xC435
{
	...
	func_152(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_14(14))
			{
				uVar0 = func_136(func_155(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				iVar0 = func_136(func_154(iParam1, uParam0->f_2), Global_68104, 0);
				...
				{
					iVar0 = func_136(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_158(int iParam0, int iParam1, int iParam2)//Position - 0xE73F
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_152(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_152(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_152(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_141(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_152(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_213(int iParam0, int iParam1, int iParam2)//Position - 0x1FBA5
{
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_213(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar21 = { func_142(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_213(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_68106[2 /*14*/] = { func_149(iVar0, 14, iVar4) };
									if (Global_68106[2 /*14*/].f_12 == iVar3)
									{
										if (func_213(iParam0, 14, iVar4))
										{
											if (!func_106(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_68106[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_68106[2 /*14*/] = { func_149(iVar0, iVar2, iVar1) };
						if (!func_106(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_68106[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_141(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_141(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_220(int iParam0, int iParam1, int iParam2)//Position - 0x20525
{
	...
	if (iParam0 != -1)
	{
		...
		func_221(&uVar32, Var0.f_3, Global_89999, iParam1, iParam2);
	}
}
...
void func_226()//Position - 0x21B05
{
	...
	{
		func_10();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_227(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_232(int iParam0, bool bParam1)//Position - 0x21C10
{
	...
	if (Var0.f_22 != 0)
	{
		func_258(Var0.f_22, 0);
	}
	func_250(iParam0, Global_68514);
	if (!bParam1)
	{
...
{
	func_236(iParam0, 1);
	Global_97353.f_16828[iParam0 /*6*/].f_3 = func_235();
...
void func_262(int iParam0, bool bParam1, bool bParam2)//Position - 0x26F55
{
	...
	{
		func_263(iParam0, &(Global_97353.f_1729.f_539.f_298[iVar0 /*284*/]), bParam1);
		iVar1 = 0;
		while (iVar1 <= (8 - 1))
		{
			...
			if (bParam2)
			{
				if (iVar1 == Global_97353.f_1729.f_539.f_1184 || (Global_97353.f_1729.f_539.f_1184 == -1 && iVar1 == 4))
				{
					if (Global_97353.f_1729.f_539.f_1151[iVar1 /*4*/][iVar0] != 0 && Global_97353.f_1729.f_539.f_1151[iVar1 /*4*/][iVar0] != joaat("weapon_molotov"))
					{
						if (WEAPON::HAS_PED_GOT_WEAPON(iParam0, Global_97353.f_1729.f_539.f_1151[iVar1 /*4*/][iVar0], 0))
						{
							WEAPON::SET_CURRENT_PED_WEAPON(iParam0, Global_97353.f_1729.f_539.f_1151[iVar1 /*4*/][iVar0], 1);
						}
					}
				}
			}
...
void func_270(var uParam0)//Position - 0x27C61
{
	...
	while (iVar0 < 3)
	{
		Global_97353.f_1729.f_539.f_294[iVar0] = uParam0->f_17[iVar0];
		iVar1 = 0;
		while (iVar1 < 44)
		{
			Global_97353.f_1729.f_539.f_298[iVar0 /*284*/][iVar1 /*3*/] = { uParam0->f_668[iVar0 /*284*/][iVar1 /*3*/] };
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 50)
		{
			Global_97353.f_1729.f_539.f_298[iVar0 /*284*/].f_133[iVar1 /*3*/] = { uParam0->f_668[iVar0 /*284*/].f_133[iVar1 /*3*/] };
			iVar1++;
		}
		iVar0++;
	}
...
void func_271(var uParam0)//Position - 0x27D14
{
	...
	while (iVar0 < 3)
	{
		...
		{
			case 0:
				STATS::STAT_SET_INT(joaat("sp0_weap_purch_0"), uParam0->f_1521[iVar0 /*32*/][0], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_purch_1"), uParam0->f_1521[iVar0 /*32*/][1], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_0"), uParam0->f_1521[iVar0 /*32*/].f_5[0], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_1"), uParam0->f_1521[iVar0 /*32*/].f_5[1], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_2"), uParam0->f_1521[iVar0 /*32*/].f_5[2], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_3"), uParam0->f_1521[iVar0 /*32*/].f_5[3], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_addon_purch_4"), uParam0->f_1521[iVar0 /*32*/].f_5[4], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_0"), uParam0->f_1521[iVar0 /*32*/].f_16[0], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_1"), uParam0->f_1521[iVar0 /*32*/].f_16[1], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_2"), uParam0->f_1521[iVar0 /*32*/].f_16[2], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_3"), uParam0->f_1521[iVar0 /*32*/].f_16[3], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_4"), uParam0->f_1521[iVar0 /*32*/].f_16[4], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_5"), uParam0->f_1521[iVar0 /*32*/].f_16[5], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_6"), uParam0->f_1521[iVar0 /*32*/].f_16[6], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_7"), uParam0->f_1521[iVar0 /*32*/].f_16[7], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_8"), uParam0->f_1521[iVar0 /*32*/].f_16[8], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_9"), uParam0->f_1521[iVar0 /*32*/].f_16[9], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_10"), uParam0->f_1521[iVar0 /*32*/].f_16[10], 1);
				STATS::STAT_SET_INT(joaat("sp0_weap_tint_purch_11"), uParam0->f_1521[iVar0 /*32*/].f_16[11], 1);
				break;
			
			case 1:
				STATS::STAT_SET_INT(joaat("sp1_weap_purch_0"), uParam0->f_1521[iVar0 /*32*/][0], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_purch_1"), uParam0->f_1521[iVar0 /*32*/][1], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_0"), uParam0->f_1521[iVar0 /*32*/].f_5[0], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_1"), uParam0->f_1521[iVar0 /*32*/].f_5[1], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_2"), uParam0->f_1521[iVar0 /*32*/].f_5[2], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_3"), uParam0->f_1521[iVar0 /*32*/].f_5[3], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_addon_purch_4"), uParam0->f_1521[iVar0 /*32*/].f_5[4], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_0"), uParam0->f_1521[iVar0 /*32*/].f_16[0], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_1"), uParam0->f_1521[iVar0 /*32*/].f_16[1], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_2"), uParam0->f_1521[iVar0 /*32*/].f_16[2], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_3"), uParam0->f_1521[iVar0 /*32*/].f_16[3], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_4"), uParam0->f_1521[iVar0 /*32*/].f_16[4], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_5"), uParam0->f_1521[iVar0 /*32*/].f_16[5], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_6"), uParam0->f_1521[iVar0 /*32*/].f_16[6], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_7"), uParam0->f_1521[iVar0 /*32*/].f_16[7], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_8"), uParam0->f_1521[iVar0 /*32*/].f_16[8], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_9"), uParam0->f_1521[iVar0 /*32*/].f_16[9], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_10"), uParam0->f_1521[iVar0 /*32*/].f_16[10], 1);
				STATS::STAT_SET_INT(joaat("sp1_weap_tint_purch_11"), uParam0->f_1521[iVar0 /*32*/].f_16[11], 1);
				break;
			
			case 2:
				STATS::STAT_SET_INT(joaat("sp2_weap_purch_0"), uParam0->f_1521[iVar0 /*32*/][0], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_purch_1"), uParam0->f_1521[iVar0 /*32*/][1], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_0"), uParam0->f_1521[iVar0 /*32*/].f_5[0], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_1"), uParam0->f_1521[iVar0 /*32*/].f_5[1], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_2"), uParam0->f_1521[iVar0 /*32*/].f_5[2], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_3"), uParam0->f_1521[iVar0 /*32*/].f_5[3], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_addon_purch_4"), uParam0->f_1521[iVar0 /*32*/].f_5[4], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_0"), uParam0->f_1521[iVar0 /*32*/].f_16[0], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_1"), uParam0->f_1521[iVar0 /*32*/].f_16[1], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_2"), uParam0->f_1521[iVar0 /*32*/].f_16[2], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_3"), uParam0->f_1521[iVar0 /*32*/].f_16[3], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_4"), uParam0->f_1521[iVar0 /*32*/].f_16[4], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_5"), uParam0->f_1521[iVar0 /*32*/].f_16[5], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_6"), uParam0->f_1521[iVar0 /*32*/].f_16[6], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_7"), uParam0->f_1521[iVar0 /*32*/].f_16[7], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_8"), uParam0->f_1521[iVar0 /*32*/].f_16[8], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_9"), uParam0->f_1521[iVar0 /*32*/].f_16[9], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_10"), uParam0->f_1521[iVar0 /*32*/].f_16[10], 1);
				STATS::STAT_SET_INT(joaat("sp2_weap_tint_purch_11"), uParam0->f_1521[iVar0 /*32*/].f_16[11], 1);
				break;
		}
		iVar0++;
	}
...
void func_274(var uParam0, int iParam1)//Position - 0x28374
{
	...
	fVar3 = 23.45f;
	func_275(uParam0, iParam1, Var0, fVar3);
}

void func_275(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0x283A4
{
	func_34(uParam0);
...
void func_299(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28C89
{
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar5 = func_261(SCRIPT::GET_THIS_SCRIPT_NAME(), 1);
			if (iVar5 != -1)
			{
				Global_97353.f_16828[iVar5 /*6*/].f_4 = 0;
				MemCopy(&uVar6, {func_217(iVar5)}, 4);
				STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar6, 0, Global_89999, iParam0);
			}
			else
			{
				iVar10 = func_350(&(Global_89962.f_3));
				if (iVar10 > -1)
				{
...
{
	func_301(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_301(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28E19
{
	...
	*uParam0 = func_9();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_322())
		{
			func_318(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_303(&(uParam0->f_2167), uParam0, iParam5, 1, 1, 0);
	}
	func_302(&(uParam0->f_2233));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
void func_312(int iParam0, var uParam1)//Position - 0x2A27D
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_314(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_313(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_318(int iParam0, var uParam1, int iParam2)//Position - 0x2A928
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_319(161, -1))
			{
				uParam1->f_59 = func_136(2035, Global_68104, 0);
			}
			else
			{
				uParam1->f_59 = func_136(740, Global_68104, 0);
			}
			uParam1->f_60 = func_136(741, Global_68104, 0);
			uParam1->f_61 = func_136(742, Global_68104, 0);
		}
...
int func_319(int iParam0, int iParam1)//Position - 0x2AAD2
{
	...
	uVar0 = Global_2473393[iParam0 /*6*/][func_135(iParam1)];
...
void func_323(int iParam0, bool bParam1)//Position - 0x2B2A0
{
	...
	if (func_11(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_324(iParam0, &(Global_97353.f_1729.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_324(int iParam0, var uParam1)//Position - 0x2B393
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_264(Var9.f_1)) && iVar70 < 50)
			{
...
int func_327(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2BB8E
{
	int iVar0;
	int iVar1;
...
int func_334(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2C5AD
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 43)
	{
		if (iParam3 == 5 || iParam3 == func_337(iVar0))
		{
			if (!bParam5 || func_336(iVar0))
			{
...
int func_351(int iParam0)//Position - 0x2D0D1
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_352(Global_97353.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_352(Global_97353.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_352(Global_97353.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_352(Global_97353.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_352(Global_97353.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
void func_356(struct<3> Param0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x2D4C3
{
	var uVar0;
	int iVar1;
...
void func_365()//Position - 0x2D872
{
	...
	func_372(&uLocal_1107);
	if (!func_367(&uLocal_1107, 1.5f))
	{
		return;
	}
	if (func_366())
	...
	func_19(&uLocal_631, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	if (func_2(&uLocal_631, "BARY2AU", "BARY2_DUPE", 8, 0, 0, 0))
	{
		iLocal_1106 = 1;
	}
}
...
void func_375()//Position - 0x2DA3C
{
	...
	while (iVar0 < Local_345)
	{
		if (!func_57(Local_345[iVar0 /*19*/].f_16, 0f, 0f, 0f))
		{
			iLocal_584 = 1;
...
float func_381(struct<2> Param0, Vector3 vParam2, struct<2> Param3, Vector3 vParam5, int iParam6)//Position - 0x2DF5B
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_385(int iParam0)//Position - 0x2E03B
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (!iLocal_799)
			{
				if (func_396(&uLocal_1107, fLocal_1110))
				{
					func_386(2, 5, 5, 0);
...
var func_390(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5)//Position - 0x2E461
{
...
void func_399(int iParam0)//Position - 0x2E78D
{
	...
	switch (*iParam0)
	{
		...
		case 2:
			if (iLocal_581 > 1)
			{
				if (func_396(&uLocal_1107, MISC::GET_RANDOM_FLOAT_IN_RANGE(9f, 12f)))
				{
					func_386(1, 5, 5, 0);
				}
			}
...
{
	func_40(Local_345[iLocal_802 /*19*/].f_3);
	func_40(Local_345[iLocal_803 /*19*/].f_3);
	func_40(Local_345[iLocal_804 /*19*/].f_3);
	...
	if (!iLocal_805)
	{
		...
		{
			func_19(&uLocal_631, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			if (func_2(&uLocal_631, "BARY2AU", "BARY2_FREAK", 8, 1, 0, 0))
			{
				iLocal_805 = 1;
			}
		}
	...
	switch (iLocal_889)
	{
		...
		case 1:
			...
			{
				func_426(Local_345[iLocal_804 /*19*/].f_3, "CLOWN_LAUGH", "CLOWNS", 10);
			}
			if (CAM::DOES_CAM_EXIST(uLocal_806))
			{
...
int func_425(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x2F518
{
	bool bVar0;
	float fVar1;
...
void func_429()//Position - 0x2F7CE
{
	...
	if (func_382(&iVar0))
	{
		...
		{
			iLocal_802 = iVar0;
			func_379(&(Local_345[iLocal_802 /*19*/]), 1);
		}
	}
	if (func_382(&iVar0))
	{
...
bool func_430(var uParam0)//Position - 0x2F88F
{
	...
	if (MISC::GET_GAME_TIMER() > uParam0->f_116 || uParam0->f_116 == 0)
	{
		...
		{
			func_432(uParam0, uParam0->f_115);
			uParam0->f_115++;
		}
	...
	switch (*iParam0)
	{
		...
		case 1:
			...
			if (func_291(1, 1093140480, 0))
			{
				...
				{
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_95.f_28[0], sLocal_334, 2, func_611(49), 0);
				}
				if (func_51(Local_95.f_41[0]))
				{
...
{
	func_449(&uLocal_216, 0, 4, "SCRIPT\BARRY_02_CLOWN_A", 0);
	func_449(&uLocal_216, 1, 4, "SCRIPT\BARRY_02_CLOWN_B", 0);
	func_449(&uLocal_216, 2, 4, "SCRIPT\BARRY_02_CLOWN_C", 0);
	func_448(&uLocal_216, 3, iLocal_544);
	func_448(&uLocal_216, 4, iLocal_545);
	func_447(&uLocal_216, 5, "BARY2", 0);
	func_449(&uLocal_216, 6, 2, sLocal_341, 0);
	func_445(&uLocal_216, 7);
	func_449(&uLocal_216, 8, 2, sLocal_342, 0);
	func_448(&uLocal_216, 9, iLocal_807);
	func_448(&uLocal_216, 10, iLocal_808);
	func_449(&uLocal_216, 11, 2, sLocal_811, 0);
	func_449(&uLocal_216, 12, 2, sLocal_813, 0);
	func_449(&uLocal_216, 13, 2, sLocal_815, 0);
	func_448(&uLocal_216, 14, iLocal_546);
}
...
void func_451()//Position - 0x30613
{
	...
	if (VEHICLE::IS_THIS_MODEL_A_HELI(iVar0) || VEHICLE::IS_THIS_MODEL_A_PLANE(iVar0))
	{
		...
		fLocal_167 = 206.45f;
		func_479(Local_201[0 /*3*/], Local_201[1 /*3*/], Local_201.f_7, Local_164, fLocal_167, 0f, 0f, 0f, 1, 0, 1, 0, 0);
		func_455(Local_164, fLocal_167, 0, 145);
	}
	else
	{
		func_479(Local_201[0 /*3*/], Local_201[1 /*3*/], Local_201.f_7, Local_164, fLocal_167, func_454(), 1, 0, 1, 0, 0);
...
bool func_452(struct<3> Param0, int iParam3)//Position - 0x306D4
{
	return func_453(Global_91351.f_2167.f_12.f_42, Param0, iParam3);
}

int func_453(int iParam0, struct<3> Param1, int iParam4)//Position - 0x306F1
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_455(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x30772
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_91351.f_4))
	{
		...
		{
			if (func_478(24) != Global_91351.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_475(ENTITY::GET_ENTITY_COORDS(Global_91351.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_456(Global_91351.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_456(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)//Position - 0x307ED
{
	struct<54> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_471(iParam5, Var0, Param1, uParam4, func_308(iParam0));
		func_457(iParam5, iParam0, 0);
	}
}
...
void func_457(int iParam0, int iParam1, int iParam2)//Position - 0x30918
{
	...
	if (!func_470(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97353.f_18371.f_4249 = func_339();
			}
...
void func_458(int iParam0, int iParam1)//Position - 0x30A35
{
	...
	func_312(iParam0, &(Global_97353.f_18371.f_4742));
}
...
int func_470(var uParam0, int iParam1)//Position - 0x312AB
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_57(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_57(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_57(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
void func_471(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x3299E
{
	if (func_470(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_473(iParam0);
			func_472(Param1, &(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_472(struct<54> Param0, var uParam54)//Position - 0x32AA0
{
...
int func_475(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x32C0C
{
	int iVar0;
	
	iVar0 = func_476(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_476(struct<3> Param0, int iParam3, int iParam4)//Position - 0x32D22
{
	int iVar0;
	float fVar1;
	float fVar2;
...
void func_479(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x32DE5
{
	func_480(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_480(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x32E0F
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_482(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3321F
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_483(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x33515
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_489(int iParam0)//Position - 0x33739
{
	...
	switch (*iParam0)
	{
		...
		case 1:
			if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_342) && !func_23())
			{
				uVar0 = 16;
				func_19(&uVar0, 1, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
				func_19(&uVar0, 0, Local_95.f_28[0], "BARRY", 0, 1);
		...
		case 2:
			if (func_51(Local_95.f_28[0]))
			{
				if (!func_23() || MISC::GET_GAME_TIMER() > iLocal_594)
				{
					if (func_51(PLAYER::PLAYER_PED_ID()))
					{
...
void func_494()//Position - 0x33A68
{
	...
	if (iLocal_585)
	{
		Var1 = { func_498(Local_586, fLocal_583, 2f) };
	}
	else
	{
		Var1 = { func_498(Local_168, fLocal_583, 2f) };
	}
	if (!func_495(&Var1))
	{
		return;
...
int func_495(var uParam0)//Position - 0x33B34
{
	...
	if (func_497(PLAYER::PLAYER_PED_ID(), Var0, 1) < fLocal_574)
	{
		return 0;
	}
	if (bLocal_595)
...
float func_497(int iParam0, struct<3> Param1, int iParam4)//Position - 0x33C8A
{
	struct<3> Var0;
...
Vector3 func_498(struct<3> Param0, float fParam3, float fParam4)//Position - 0x33CC3
{
	struct<3> Var0;
	float fVar3;
	...
	fVar3 = (fParam4 / 2f);
	Var0 = { func_499(Var0, MISC::GET_RANDOM_FLOAT_IN_RANGE(0f, fParam3)) };
	Var0.f_2 = MISC::GET_RANDOM_FLOAT_IN_RANGE(-fVar3, fVar3);
	return Param0 + Var0;
}

Vector3 func_499(struct<3> Param0, float fParam3)//Position - 0x33D0B
{
	float fVar0;
...
int func_501(var uParam0)//Position - 0x33D7B
{
	...
	if (uParam0->f_9 == 0)
	{
		if (func_511(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1) < fLocal_580 || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uParam0->f_3, PLAYER::PLAYER_PED_ID(), 1))
		{
	...
	if (bLocal_212)
	{
		if (uParam0->f_9 == 0)
		{
			func_510(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_580, 255, 0, 0, 255, 32);
		}
		else
		{
			func_510(ENTITY::GET_ENTITY_COORDS(uParam0->f_3, 1), fLocal_580, 0, 0, 255, 255, 32);
		}
	}
	switch (uParam0->f_2)
	{
		...
		case 10:
			...
			if (func_382(&iVar0))
			{
				...
				if (func_506(&(Local_345[uParam0->f_14 /*19*/]), uParam0->f_3, 1))
				{
					...
					func_29(&(Local_345[uParam0->f_14 /*19*/].f_4));
		...
		case 11:
			if (func_51(Local_345[uParam0->f_14 /*19*/].f_3))
			{
				if (TASK::GET_SCRIPT_TASK_STATUS(Local_345[uParam0->f_14 /*19*/].f_3, 242628503) == 7)
				{
					...
					Local_345[uParam0->f_14 /*19*/].f_4 = func_505(Local_345[uParam0->f_14 /*19*/].f_3, 1, 0, 5);
		...
		case 12:
			...
			if (bLocal_212)
			{
				func_510(Var8, 1.5f, 255, 0, 0, 255, 32);
			}
...
int func_503(struct<3> Param0, float fParam3)//Position - 0x34523
{
	...
	while (iVar0 < Local_345)
	{
		...
		{
			if (func_497(Local_345[iVar0 /*19*/].f_3, Param0, 1) < fParam3)
			{
				return 1;
			}
		}
...
void func_504()//Position - 0x3456C
{
	...
	func_19(&uLocal_631, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	if (func_2(&uLocal_631, "BARY2AU", "BARY2_ONEOFF", 7, 0, 0, 0))
	{
		bLocal_597 = true;
	}
}
...
void func_510(struct<3> Param0, float fParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x348FC
{
	int iVar0;
	float fVar1;
	struct<3> Var2;
...
void func_516(var uParam0)//Position - 0x34B66
{
	...
	switch (uParam0->f_2)
	{
		...
		case 9:
			...
			{
				func_379(&(Local_345[iLocal_802 /*19*/]), 3);
				uParam0->f_11 = (MISC::GET_GAME_TIMER() + MISC::GET_RANDOM_INT_IN_RANGE(iLocal_599, iLocal_600));
				uParam0->f_2 = 12;
			}
			break;
...
void func_520(var uParam0)//Position - 0x35475
{
	...
	if (TASK::GET_SCRIPT_TASK_STATUS(uParam0->f_3, 242628503) != 1)
	{
		...
		if (func_511(uParam0->f_3, uParam0->f_15, 0) <= 5f)
		{
...
void func_524()//Position - 0x35651
{
	...
	func_19(&uLocal_631, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
	if (func_2(&uLocal_631, "BARY2AU", "BARY2_FIGHT", 6, 0, 0, 0))
	{
...
void func_526(char* sParam0, char* sParam1, struct<3> Param2, int iParam5)//Position - 0x356EB
{
	AUDIO::PLAY_AMBIENT_SPEECH_FROM_POSITION_NATIVE(sParam0, sParam1, Param2, func_427(iParam5));
}
...
void func_529(int iParam0)//Position - 0x35746
{
	...
	switch (Local_833[iParam0 /*11*/].f_6)
	{
		...
		case 2:
			if (func_51(PLAYER::PLAYER_PED_ID()))
			{
				if (func_51(Local_833[iParam0 /*11*/]))
				{
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_539(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_550(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_552(iParam0, Global_34913);
}
...
void func_555(struct<3> Param0, float fParam3, var uParam4, var uParam5)//Position - 0x3686B
{
	struct<3> Var0;
...
void func_556()//Position - 0x36897
{
	...
	func_444();
	func_588(&Local_185, 226.2213f, -848.2081f, 25.42136f, 163.9146f, -1012.38f, 54.88147f, 131.75f);
	Local_193 = { func_587(Local_185, -10f) };
	Local_177 = { func_587(Local_185, 20f) };
	func_588(&Local_201, 168.85f, -1001.024f, 23.09129f, 225.9042f, -862.5969f, 34.09233f, 55f);
	...
	if (func_574() == 1)
	{
		...
		{
			case 0:
				func_563(Local_172, fLocal_175, 0, 0);
				func_558(1);
				if (!GRAPHICS::ANIMPOSTFX_IS_RUNNING(sLocal_339))
				{
					GRAPHICS::ANIMPOSTFX_PLAY(sLocal_339, 0, 1);
...
void func_563(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x36FB7
{
	if (func_574())
	{
...
int func_565(var uParam0)//Position - 0x37076
{
	...
	switch (iLocal_81)
	{
		case 0:
			...
			func_573(&(uParam0->f_48), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_81 = 1;
			break;
		
		case 1:
			if (!func_572(&iVar0) || !func_570(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_81 = 2;
		...
		case 2:
			...
			{
				if (func_567(&(uParam0->f_28[0]), 49, Var6, fVar9, "RC LAUNCHER: BARRY 2", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[0]))
			{
				...
				func_275(&(uParam0->f_41[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_566(-2.01f));
				if (func_51(uParam0->f_41[0]))
				{
					ENTITY::FREEZE_ENTITY_POSITION(uParam0->f_41[0], 1);
					func_275(&(uParam0->f_41[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_566(-2.01f));
					if (func_51(uParam0->f_41[2]))
					{
...
int func_567(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x37426
{
	if (func_568(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
			if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
int func_568(var uParam0, int iParam1, struct<3> Param2, int iParam5, bool bParam6)//Position - 0x37481
{
	int iVar0;
...
struct<8> func_587(struct<8> Param0, float fParam8)//Position - 0x37C7F
{
	struct<8> Var0;
	struct<3> Var8;
	
	Var0 = 2;
	Var8 = { func_484(Param0[1 /*3*/] - Param0[0 /*3*/]) * Vector(fParam8, fParam8, fParam8) };
...
void func_588(var uParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x37CE1
{
	*(uParam0[0 /*3*/]) = { Param1 };
	*(uParam0[1 /*3*/]) = { Param4 };
	uParam0->f_7 = fParam7;
...
int func_597()//Position - 0x383C2
{
	...
	iVar0 = func_353(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_599()//Position - 0x38436
{
	...
	{
		if (func_350(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_610(&(uParam0->f_28));
	func_610(&(uParam0->f_35));
	func_610(&(uParam0->f_41));
}
