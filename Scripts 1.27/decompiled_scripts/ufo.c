...
void func_1(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xD7
{
	if (iParam0 != 198)
	{
		if (Global_10A95)
...
int func_6()//Position - 0xBA5
{
	return Global_5F7D;
}

int func_7()//Position - 0xBB0
{
	return Global_5F7C;
}

int func_8(var uParam0, int iParam1)//Position - 0xBBB
{
	int iVar0;
