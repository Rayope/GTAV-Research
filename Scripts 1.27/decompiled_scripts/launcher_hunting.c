...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_252(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_240(&Var0, 1);
	}
	...
	while (true)
	{
		...
		func_176(Var0);
		func_169(&iLocal_100, &(Var0.f_9), Var61);
		if (Var0 == 25)
		{
			func_164(&Var0, Var61, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_149(&Var0, 0) && MISC::ABSF((Var61.f_2 - Var67.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_240(&Var0, 1);
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5636
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5CD0
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x6086
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_164(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xAACF
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_28[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_168(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
		func_167(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
...
float func_168(int iParam0, struct<3> Param1, int iParam4)//Position - 0xAC83
{
	struct<3> Var0;
...
int func_177(int iParam0, bool bParam1)//Position - 0xAFF3
{
	...
	func_94(*iParam0, &Var0);
	if ((func_214(*iParam0) || func_212(*iParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_181(&(iParam0->f_48)) && bParam1)
	{
...
void func_182(var uParam0)//Position - 0xB618
{
	...
	if (*uParam0 == 52)
	{
		func_183(&(uParam0->f_41[1]));
		func_183(&(uParam0->f_41[2]));
	}
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_186(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_28[iVar0]))
				{
					...
					if (func_206(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_201(uParam0->f_28[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_182(uParam0);
...
bool func_191(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBF32
{
	...
	uVar0 = func_192(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_192(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xBFF3
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_196(struct<3> Param0, struct<3> Param3)//Position - 0xC2C2
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_204(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xC640
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_213() && Global_89962.f_11 == 6) && iParam0 == func_147(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_216(var uParam0)//Position - 0xC9F8
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			...
			{
				if (func_220(&(uParam0->f_28[0]), 54, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
				{
...
int func_220(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xCD63
{
	if (func_221(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_221(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0xCDBE
{
	int iVar0;
...
int func_224(var uParam0)//Position - 0xCEC3
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_226(&(uParam0->f_48), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_90 = 1;
			break;
		
		case 1:
			if ((!func_223(&iVar0) || !func_225(&(uParam0->f_48))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (func_220(&(uParam0->f_28[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
...
int func_237(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xD5C9
{
	int iVar0;
...
int func_238(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xD62E
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_239(Var1.f_6, Param1, fParam4))
	{
...
int func_239(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xD6AB
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
