...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_51 = func_256(54);
	iLocal_52 = joaat("dune");
	iLocal_53 = WEAPON::GET_WEAPONTYPE_MODEL(joaat("weapon_sniperrifle"));
	iLocal_54 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_scope_large"));
	iLocal_55 = WEAPON::GET_WEAPON_COMPONENT_TYPE_MODEL(joaat("component_at_ar_supp_02"));
	Local_56 = { -683.8261f, 5840.81f, 16.566f };
	iLocal_58 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_252(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_240(&Var0, 1);
	}
	if (!func_237(&iVar2, &Var0, Var1, 1f))
	{
		func_236();
	...
	MISC::CLEAR_AREA(Var1, 3f, 1, 0, 0, 0);
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_177(&Var0, 1))
		...
		func_176(Var0);
		func_169(&iLocal_58, &(Var0.f_9), Var1);
		if (Var0 == 25)
		{
			func_164(&Var0, Var1, "HUNT1AU", "HUNT1_AMB", 3, "CLETUS", 5000, 1101004800);
		}
		...
		if (func_149(&Var0, 0) && MISC::ABSF((Var1.f_2 - Var3.f_2)) < 2.5f)
		{
			if (!func_2(&Var0))
			{
				func_240(&Var0, 1);
...
int func_1(int iParam0)//Position - 0x2CC
{
...
void func_4(int iParam0)//Position - 0x46A
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x677
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xA5F
{
	Global_D5D7 = 1;
	Global_D5DA = 1;
	if (Global_1051D > 15)
...
void func_8(int iParam0)//Position - 0xAAA
{
...
struct<2> func_9(int iParam0)//Position - 0xADE
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xBD0
{
	Global_D67D = 0;
}

void func_14()//Position - 0xBDC
{
	Global_D5F1 = 0;
...
var func_15(int iParam0)//Position - 0xC30
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xC6E
{
	Global_10B99 = iParam0;
	Global_10B9A = iParam0;
}

void func_18()//Position - 0xC82
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xD27
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xD3A
{
	MISC::CLEAR_BIT(&(Global_15F6A.f_14), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xD57
{
...
int func_26(var uParam0)//Position - 0x28B0
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28D2
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2959
{
...
int func_29(int iParam0)//Position - 0x2999
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x29C7
{
...
int func_31(int iParam0)//Position - 0x2AA3
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2AE5
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2B48
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2BD6
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2C18
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2E90
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2E9C
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x3148
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x31F8
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x32D2
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3383
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x34B0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3521
{
...
int func_44(int iParam0)//Position - 0x35FA
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x3637
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x3661
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x380B
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x383D
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x3871
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x387D
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x38A9
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3DF1
{
	int iVar0;
...
int func_53()//Position - 0x4033
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x404C
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x4149
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x4157
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x424A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x44AE
{
...
int func_59(int iParam0, int iParam1)//Position - 0x45D4
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4DF0
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4E2B
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x509F
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x50DB
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x5636
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x567A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5CD0
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5CF9
{
...
bool func_68(int iParam0)//Position - 0x5D52
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5D62
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5DC2
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x606B
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x6076
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6086
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x611D
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x65EE
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x65FE
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x6857
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x6868
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x68AE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x6934
{
...
void func_81(var uParam0, int iParam1)//Position - 0x6967
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x69B8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x6A5A
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6A7F
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6A96
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6AA3
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6ADD
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6B18
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6B54
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6B6D
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6BC6
{
...
bool func_92(bool bParam0)//Position - 0x6C08
{
...
struct<2> func_93(int iParam0)//Position - 0x6C33
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x7080
{
	switch (iParam0)
	{
		case 0:
...
int func_97(int iParam0)//Position - 0x869F
{
	var uVar0;
...
int func_149(int iParam0, int iParam1)//Position - 0x9917
{
	switch (iParam0->f_10)
	{
		case 0:
...
int func_155(int iParam0)//Position - 0xA2C6
{
	int iVar0;
...
var func_156()//Position - 0xA9E3
{
	return Global_15F91.f_1;
}

int func_157()//Position - 0xA9F1
{
	if (Global_154F9 != -1)
	{
...
bool func_160()//Position - 0xAA5B
{
	return Global_15F9E.f_123 > 0;
}

bool func_161(int iParam0, int iParam1)//Position - 0xAA6C
{
	switch (iParam0)
	{
		case 5:
...
var func_162()//Position - 0xAAA7
{
	return Global_14143C;
}

int func_163()//Position - 0xAAB3
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_164(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xAACF
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_1C[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_168(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_167(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
		func_165(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_165(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB57
{
...
void func_166(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xAB92
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_167(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xABE8
{
...
float func_168(int iParam0, struct<3> Param1, int iParam2)//Position - 0xAC83
{
	struct<3> Var0;
...
void func_169(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xACBC
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_170(int iParam0, bool bParam1)//Position - 0xADAD
{
	if (iParam0 == -1)
	{
		return;
...
int func_171(int iParam0)//Position - 0xADE9
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_172(int iParam0, int iParam1)//Position - 0xAE22
{
	bool bVar0;
	int iVar1;
...
bool func_173()//Position - 0xAEC0
{
	return Global_1567C;
}

void func_174(int iParam0)//Position - 0xAECC
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_175(iParam0);
...
void func_175(int iParam0)//Position - 0xAEE3
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_176(int iParam0)//Position - 0xAFCB
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_177(int iParam0, bool bParam1)//Position - 0xAFF3
{
	...
	func_94(*iParam0, &Var0);
	if ((func_214(*iParam0) || func_212(*iParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
	...
	if (func_181(&(iParam0->f_30)) && bParam1)
	{
		func_178(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}
...
void func_178(int iParam0, var uParam1, int iParam2)//Position - 0xB266
{
	...
	if (func_111(iParam0))
	{
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_180(uParam1) || !ENTITY::IS_ENTITY_PLAYING_ANIM(iParam0, *uParam1, uParam1->f_2, 3))
				{
					if (func_179(iParam2) && !PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 25f))
					{
						TASK::TASK_TURN_PED_TO_FACE_ENTITY(iParam0, PLAYER::PLAYER_PED_ID(), 0);
						uParam1->f_3 = 5;
					}
					else if ((func_180(uParam1) && uParam1->f_4 == 0) && MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0, 1), 1) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
			...
			case 5:
				if (!func_179(iParam2) || PED::IS_PED_FACING_PED(iParam0, PLAYER::PLAYER_PED_ID(), 10f))
				{
					if (func_66(uParam1->f_5, 0f, 0f, 0f))
					{
						TASK::TASK_PLAY_ANIM(iParam0, *uParam1, uParam1->f_1, 8f, -8f, -1, 262153, 0, 0, 0, 0);
...
int func_179(int iParam0)//Position - 0xB5BB
{
...
int func_180(var uParam0)//Position - 0xB5DB
{
...
int func_181(var uParam0)//Position - 0xB5F3
{
...
void func_182(var uParam0)//Position - 0xB618
{
	int iVar0;
	var uVar1;
	...
	if (*uParam0 == 52)
	{
		func_183(&(uParam0->f_29[1]));
		func_183(&(uParam0->f_29[2]));
	}
...
void func_183(var uParam0)//Position - 0xB91C
{
...
void func_184(var uParam0)//Position - 0xB947
{
	int iVar0;
...
int func_185(var uParam0, bool bParam1, bool bParam2)//Position - 0xB9C7
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_186(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
...
int func_186(int iParam0, int iParam1)//Position - 0xBB84
{
	int iVar0;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[iVar0]))
			{
				if (!PED::IS_PED_INJURED(uParam0->f_1C[iVar0]))
				{
					...
					if (func_206(*uParam0))
					{
						if (!func_138(*uParam0))
						{
							if (func_201(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_182(uParam0);
						...
						if (func_189(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_182(uParam0);
...
int func_188(int iParam0)//Position - 0xBE70
{
...
bool func_191(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBF32
{
	...
	uVar0 = func_192(&(Local_36[iVar2 /*4*/]), Var1, iParam1, &(Local_36[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar2 /*4*/].f_3) < iParam4);
}

int func_192(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xBFF3
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_193(int iParam0, int iParam1)//Position - 0xC122
{
	int iVar0;
...
int func_195(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xC231
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_197(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_197(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_196(struct<3> Param0, struct<3> Param1)//Position - 0xC2C2
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_197(struct<3> Param0)//Position - 0xC2E3
{
	float fVar0;
	float fVar1;
...
void func_198(var uParam0)//Position - 0xC322
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_200(var uParam0)//Position - 0xC37C
{
...
int func_201(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xC3A4
{
	float fVar0;
	float fVar1;
	int iVar2;
	...
	if (func_111(PLAYER::PLAYER_PED_ID()) && func_111(uParam0))
	{
		...
		if (!bParam2)
		{
			if (func_205(uParam0, bParam1, fVar0, fVar1))
			{
				return 1;
			}
			if (func_202(uParam0, fVar1, bParam3, bParam4))
			{
				return 1;
			}
		}
...
int func_202(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xC49F
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_203(var uParam0, float fParam1)//Position - 0xC5AB
{
	var uVar0;
	struct<3> Var1;
...
int func_204(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xC640
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_197(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_205(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xC6CE
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_206(int iParam0)//Position - 0xC716
{
...
void func_207(int iParam0)//Position - 0xC760
{
	var uVar0;
...
int func_208(int iParam0)//Position - 0xC7FD
{
	if (iParam0 == -1)
	{
		iParam0 = func_146();
...
int func_209(int iParam0)//Position - 0xC895
{
...
int func_212(int iParam0)//Position - 0xC917
{
	if ((func_213() && Global_15F6A.f_B == 6) && iParam0 == func_147(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_214(int iParam0)//Position - 0xC989
{
	if (func_92(0))
	{
...
int func_216(var uParam0)//Position - 0xC9F8
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_223(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("rcmhunting2"))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			{
				if (func_220(&(uParam0->f_1C[0]), 54, -683.3276f, 5841.042f, 17.217f, 8.33f, "RC HUNTER 2", 1))
				{
					WEAPON::GIVE_WEAPON_TO_PED(uParam0->f_1C[0], joaat("weapon_pumpshotgun"), 0, 1, 1);
				}
				else
				{
					bVar2 = false;
			...
			{
				func_217(&(uParam0->f_23[0]), -685.2281f, 5833.982f, 16.331f, 313.2204f, 0);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uLocal_57))
			{
				iLocal_57 = WEAPON::CREATE_WEAPON_OBJECT(joaat("weapon_sniperrifle"), 0, Local_56, 0, 1065353216, 0);
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_57, joaat("component_at_scope_large"));
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(iLocal_57, joaat("component_at_ar_supp_02"));
			}
			if (bVar2)
			{
				iLocal_50 = 3;
		...
		case 3:
			if (func_111(uParam0->f_1C[0]))
			{
				...
				{
					TASK::TASK_PLAY_ANIM_ADVANCED(uParam0->f_1C[0], "rcmhunting2", "_idle_loop", -683.152f, 5841.281f, 17.32f, 0f, 0f, 17.024f, 1000f, -8f, -1, 790537, 0f, 2, 1);
				}
			}
			TASK::TASK_LOOK_AT_ENTITY(uParam0->f_1C[0], PLAYER::PLAYER_PED_ID(), -1, 3088, 2);
			if (OBJECT::DOES_OBJECT_OF_TYPE_EXIST_AT_COORDS(Local_56, 1f, iLocal_53, 0))
			{
				ENTITY::SET_ENTITY_ROTATION(iLocal_57, 0f, -90f, -162.64f, 2, 1);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_217(var uParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xCC2B
{
	func_218(uParam0, iLocal_52, Param1, fParam2);
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_218(var uParam0, int iParam1, struct<3> Param2, var uParam3)//Position - 0xCC8C
{
	func_219(uParam0);
...
void func_219(var uParam0)//Position - 0xCCC7
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_220(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xCD63
{
	if (func_221(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_221(var uParam0, int iParam1, struct<3> Param2, var uParam3, bool bParam4)//Position - 0xCDBE
{
	int iVar0;
...
int func_222(var uParam0, int iParam1)//Position - 0xCE4C
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0xCE92
{
	int iVar0;
...
int func_224(var uParam0)//Position - 0xCEC3
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_226(&(uParam0->f_30), "special_ped@cletus@base", "cletus_base", 0);
			STREAMING::REQUEST_ANIM_DICT("special_ped@cletus@base");
			iLocal_50 = 1;
			break;
		
		case 1:
			if ((!func_223(&iVar0) || !func_225(&(uParam0->f_30))) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@cletus@base"))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (func_220(&(uParam0->f_1C[0]), 54, 1804.33f, 3931.33f, 33.83f, 91.63f, "RC HUNTER 1", 1))
				{
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_217(&(uParam0->f_23[0]), 1806.732f, 3934.353f, 33.3275f, 76.1155f, 0);
...
int func_225(var uParam0)//Position - 0xD177
{
	if (func_181(uParam0))
	{
...
void func_226(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xD1A1
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_227(int iParam0)//Position - 0xD1DD
{
	struct<27> Var0;
	int iVar1;
...
int func_228(int iParam0)//Position - 0xD231
{
	char* sVar0;
...
int func_229(int iParam0)//Position - 0xD2C8
{
	var uVar0;
...
int func_230(int iParam0)//Position - 0xD389
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_231(int iParam0, char* sParam1)//Position - 0xD40E
{
...
bool func_232(int iParam0)//Position - 0xD4F0
{
...
bool func_233(int iParam0)//Position - 0xD51E
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_234(int iParam0)//Position - 0xD54C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_235(int iParam0)//Position - 0xD57A
{
	if (func_209(iParam0))
	{
		return 0;
...
void func_236()//Position - 0xD5AF
{
	func_253("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_237(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xD5C9
{
	int iVar0;
	
	if (*iParam0 == 1)
	{
		if (func_238((*iParam0)[0], Param2, fParam3, iParam1))
		{
			return 1;
		}
	}
	else
	{
		...
		while (iVar0 < *iParam0)
		{
			if (func_238((*iParam0)[iVar0], Param2, fParam3, iParam1))
			{
				iVar0 = *iParam0;
				return 1;
			}
...
int func_238(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0xD62E
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_239(Var1.f_6, Param1, fParam2))
	{
...
int func_239(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0xD6AB
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_241(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xD744
{
...
void func_242(var uParam0, bool bParam1)//Position - 0xD764
{
	func_243(&(uParam0->f_29), bParam1);
}

void func_243(var uParam0, bool bParam1)//Position - 0xD776
{
	int iVar0;
...
void func_244(var uParam0, bool bParam1)//Position - 0xD7B4
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_245(var uParam0, bool bParam1)//Position - 0xD7EF
{
	func_246(&(uParam0->f_23), bParam1);
}

void func_246(var uParam0, bool bParam1)//Position - 0xD801
{
	int iVar0;
...
void func_247(var uParam0)//Position - 0xD83E
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_248(var uParam0, int iParam1)//Position - 0xD875
{
	func_249(&(uParam0->f_1C), iParam1);
}

void func_249(var uParam0, int iParam1)//Position - 0xD887
{
	int iVar0;
...
void func_250(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD8C8
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_251(var uParam0)//Position - 0xD917
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
void func_253(char* sParam0)//Position - 0xD993
{
...
void func_254(var uParam0)//Position - 0xD9A5
{
	*uParam0 = -1;
...
void func_255()//Position - 0xD9D8
{
	func_253("Running start routines.");
	Global_17B2F++;
}

int func_256(int iParam0)//Position - 0xD9F2
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
