...
void func_1()//Position - 0x22F
{
	...
	switch (iLocal_87)
	{
		...
		case 1:
			...
			func_206();
			func_204();
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::GET_PLAYER_INDEX()) <= 0 && !func_203())
			{
				iVar0 = 1;
...
void func_3(int iParam0, bool bParam1)//Position - 0x438
{
	int iVar0;
	var uVar1;
...
bool func_5(bool bParam0)//Position - 0x5AF
{
...
void func_6(int iParam0, int iParam1, int iParam2)//Position - 0x5DA
{
	bool bVar0;
...
int func_8()//Position - 0xB83
{
	return Global_24444;
}

int func_9(int iParam0, int iParam1)//Position - 0xB8E
{
	int iVar0;
...
int func_10(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBDF
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_11()//Position - 0xE3C
{
	return Global_1312737;
}

void func_12()//Position - 0xE48
{
	func_29();
	func_21();
	func_17();
...
void func_13(int iParam0)//Position - 0xEA1
{
	if (iParam0 == 1)
	{
...
void func_15()//Position - 0xEE8
{
	StringCopy(&Global_68477, "", 16);
	StringCopy(&Global_68481, "", 16);
}

void func_16()//Position - 0xF04
{
	int iVar0;
...
void func_20(int iParam0)//Position - 0xFD6
{
	if (iParam0 == 1)
	{
		Global_35462 = 1;
...
void func_21()//Position - 0xFEF
{
	func_22(&Global_93588);
}

void func_22(var uParam0)//Position - 0xFFF
{
	int iVar0;
	int iVar1;
...
void func_23(var uParam0)//Position - 0x1545
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_24(var uParam0)//Position - 0x1560
{
...
void func_25(var uParam0)//Position - 0x158F
{
	int iVar0;
...
void func_26(var uParam0)//Position - 0x1640
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_27(var uParam0)//Position - 0x165E
{
	int iVar0;
...
void func_28(var uParam0)//Position - 0x173F
{
	*uParam0 = -15;
}

void func_29()//Position - 0x174D
{
	StringCopy(&Global_91343, "", 32);
	func_22(&Global_91351);
}

void func_30()//Position - 0x1767
{
...
int func_32(int iParam0, int iParam1, int iParam2)//Position - 0x18A5
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x1A5E
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x1AEA
{
	switch (iParam0)
	{
...
int func_35(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x1B25
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_36(int iParam0, int iParam1, int iParam2)//Position - 0x2312
{
	int iVar0;
	int iVar1;
...
int func_37(int iParam0, int iParam1, int iParam2)//Position - 0x239C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_38(int iParam0, int iParam1, int iParam2)//Position - 0x247A
{
	Global_68106[1 /*14*/] = { func_82(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_39(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x24A4
{
	var uVar0;
	int iVar10;
...
int func_40(int iParam0, int iParam1, int iParam2)//Position - 0x2A9F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_41(int iParam0, int iParam1, int iParam2)//Position - 0x2B38
{
	int iVar0;
	int iVar1;
...
int func_42(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2BD9
{
	int iVar0;
...
int func_43(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2EE0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_44(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x3A93
{
	int iVar0;
...
int func_45(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3D77
{
	int iVar0;
...
int func_46(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x403F
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4076
{
	int iVar0;
...
int func_48(int iParam0, int iParam1, int iParam2)//Position - 0x409F
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4369
{
	int iVar0;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x45F3
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_51(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0x474A
{
	if (iParam2 == -1)
	{
...
int func_52(int iParam0, int iParam1, int iParam2)//Position - 0x4773
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_53(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4996
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_54(int iParam0, int iParam1)//Position - 0x4A90
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_55(int iParam0)//Position - 0x4E37
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x4E98
{
	var uVar0;
	var uVar1;
...
int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x528D
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_58(int iParam0, int iParam1)//Position - 0x556C
{
	int iVar0;
	int iVar1;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_60(int iParam0, int iParam1)//Position - 0x56AE
{
	int iVar0;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x57EC
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
...
int func_62(int iParam0)//Position - 0x58CC
{
	switch (iParam0)
	{
		case 0:
...
int func_63(int iParam0, int iParam1)//Position - 0x5952
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_65(int iParam0)//Position - 0x5A36
{
...
void func_66(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5AEE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_67(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5B37
{
	int iVar0;
...
int func_68(var uParam0)//Position - 0x5B62
{
	int iVar0;
	int iVar1;
...
int func_69(int iParam0, int iParam1, int iParam2)//Position - 0x5B96
{
	var uVar0;
	var uVar1;
...
bool func_70(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5BC8
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6269
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_72(int iParam0)//Position - 0x7187
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x71D8
{
	int iVar0;
...
int func_74(int iParam0)//Position - 0x726E
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_75(int iParam0, int iParam1)//Position - 0x731E
{
	int iVar0;
	struct<10> Var1;
...
void func_76(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7C4D
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
...
void func_77(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7D77
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_78(int iParam0, int iParam1)//Position - 0x7DBF
{
	int iVar0;
	struct<16> Var1;
...
void func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9C03
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
...
int func_80(int iParam0)//Position - 0x9DB4
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9E64
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
struct<14> func_82(int iParam0, int iParam1, int iParam2)//Position - 0x9ED5
{
	func_146();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_83(int iParam0, int iParam1)//Position - 0x9F27
{
	switch (iParam0)
	{
		case 0:
...
void func_84(int iParam0)//Position - 0xA017
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_85(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xB28D
{
	var uVar0;
	int iVar1;
...
bool func_86(int iParam0, int iParam1, var uParam2)//Position - 0xB610
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_87(int iParam0, int iParam1)//Position - 0xBA15
{
	switch (iParam1)
	{
		case 0:
...
int func_88(int iParam0, int iParam1)//Position - 0xBE10
{
	switch (iParam1)
	{
		case 0:
...
bool func_89(int iParam0)//Position - 0xC20C
{
	return Global_34913 == iParam0;
}

int func_90(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xC21A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_91(int iParam0)//Position - 0xC25C
{
	switch (iParam0)
	{
		case -1:
...
void func_92(int iParam0, int iParam1, int iParam2)//Position - 0xC330
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
...
void func_93(int iParam0)//Position - 0xC5AB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0xC701
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xCC0E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xCC82
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0xCCF5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_98(int iParam0)//Position - 0xCDDB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0xD13D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0xD34D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0xD57C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0xD68B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0)//Position - 0xE029
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_104(int iParam0)//Position - 0xEB9B
{
	if (iParam0 < 136)
	{
		func_106(iParam0);
...
void func_105(int iParam0)//Position - 0xEBCF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0xF7D3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x106E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x1080E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0, int iParam1)//Position - 0x1090B
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0)//Position - 0x109FB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x11EEB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x1203B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x12545
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x12BB2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x12C25
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x12CF4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_117(int iParam0)//Position - 0x13223
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x133B9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x13BB6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x13CC5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_200(int iParam0)//Position - 0x25102
{
	bool bVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0x25173
{
	if (func_383(iParam0))
	{
...
void func_202(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x2519D
{
...
void func_204()//Position - 0x2520E
{
	if (iLocal_532 == 0)
	{
		if (func_205(PLAYER::PLAYER_PED_ID(), -1116.62f, 299.12f, 64.96f, 1) > 50f)
		{
...
float func_205(int iParam0, struct<3> Param1, int iParam4)//Position - 0x25254
{
	struct<3> Var0;
...
void func_206()//Position - 0x2528D
{
	if (iLocal_527 == 0)
	{
		if (!ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1208.581f, 309.8494f, 80.69189f, -1041.645f, 319.5811f, 60.40263f, 178.5f, 0, 1, 0))
		{
			...
			func_220(&uLocal_277, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
		...
		if (iLocal_101 != 0)
		{
			if ((MISC::GET_GAME_TIMER() - iLocal_530) > 6000)
			{
				...
				else if (iLocal_101 == 1)
				{
					if (func_383(Local_442.f_28[0]))
					{
						if (func_207(PLAYER::PLAYER_PED_ID(), Local_442.f_28[0], 1) < 75f)
						{
...
float func_207(int iParam0, int iParam1, int iParam2)//Position - 0x253D6
{
	struct<3> Var0;
	struct<3> Var3;
...
bool func_208(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x25432
{
...
int func_209(char* sParam0, int iParam1, bool bParam2)//Position - 0x25480
{
	Global_15693 = 0;
...
void func_210()//Position - 0x2574C
{
	int iVar0;
...
void func_211()//Position - 0x2577E
{
...
void func_214()//Position - 0x258D3
{
	if (func_89(14))
	{
...
int func_215()//Position - 0x25974
{
	func_153();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_216()//Position - 0x2598D
{
	int iVar0;
...
bool func_217(int iParam0, int iParam1)//Position - 0x259E5
{
	switch (iParam0)
	{
		case 5:
...
void func_218()//Position - 0x25A20
{
...
void func_219(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25A77
{
...
void func_220(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x25ACD
{
...
void func_221()//Position - 0x25B68
{
	Global_14558 = 0;
	func_222();
}

void func_222()//Position - 0x25B78
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
		...
		case 1:
			if (func_383(Local_442.f_28[0]))
			{
				if (!iLocal_524)
				{
					...
					{
						if (func_207(Local_442.f_28[0], PLAYER::PLAYER_PED_ID(), 0) < 20f)
						{
							func_220(&uLocal_277, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
							func_220(&uLocal_277, 4, Local_442.f_28[0], "JOSH", 0, 1);
							if (func_203())
				...
				if (func_207(PLAYER::PLAYER_PED_ID(), Local_442.f_28[0], 1) > 350f)
				{
				...
				if (func_383(PLAYER::PLAYER_PED_ID()) && func_383(Local_442.f_28[0]))
				{
					if (iLocal_528 < 3)
					{
						if (func_207(PLAYER::PLAYER_PED_ID(), Local_442.f_28[0], 1) < 10f)
						{
							if (!func_203() && (MISC::GET_GAME_TIMER() - iLocal_531) > 8000)
							{
...
void func_224(int iParam0)//Position - 0x260C0
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_225(var uParam0)//Position - 0x2615C
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_226(int iParam0)//Position - 0x2619B
{
	if (ENTITY::DOES_ENTITY_EXIST(*iParam0))
	{
...
void func_227(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x261D2
{
...
void func_228()//Position - 0x2620D
{
	Global_14558 = 0;
	func_218();
}
...
void func_230(char* sParam0, int iParam1)//Position - 0x265EC
{
	sParam0 = sParam0;
	iParam1 = iParam1;
}
	...
	switch (iLocal_100)
	{
		case 0:
			...
			while (iVar0 <= (Local_442.f_28 - 1))
			{
				if (func_383(Local_442.f_28[iVar0]))
				{
					if (func_207(Local_442.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 10f)
					{
		...
		case 2:
			...
			while (iVar0 <= (Local_442.f_28 - 1))
			{
				if (func_383(Local_442.f_28[iVar0]))
				{
					if (func_207(Local_442.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) > 12f)
					{
		...
		case 3:
			...
			if (!iLocal_517)
			{
				...
				func_220(&uLocal_112, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			...
			else
			{
				...
				while (iVar1 <= (Local_442.f_28 - 1))
				{
					...
					{
						if (func_207(Local_442.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) > 20f)
						{
				...
				if ((MISC::GET_GAME_TIMER() - iLocal_529) > 15000)
				{
					...
					while (iVar1 <= (Local_442.f_28 - 1))
					{
						if (func_383(Local_442.f_28[iVar1]))
						{
							if (func_207(Local_442.f_28[iVar1], PLAYER::PLAYER_PED_ID(), 1) >= 50f)
							{
	...
	if (iLocal_100 != 3)
	{
		...
		while (iVar0 <= (Local_442.f_28 - 1))
		{
			if (func_383(Local_442.f_28[iVar0]))
			{
				...
				if (iLocal_100 != 4)
				{
					if (func_207(Local_442.f_28[iVar0], PLAYER::PLAYER_PED_ID(), 0) < 2.3f)
					{
...
int func_236(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x26D0D
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_237(int iParam0, int iParam1)//Position - 0x26E39
{
	int iVar0;
...
int func_239(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x26F48
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_240(struct<3> Param0, struct<3> Param3)//Position - 0x26FD9
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_241(struct<3> Param0)//Position - 0x26FFA
{
	float fVar0;
	float fVar1;
...
void func_242(var uParam0)//Position - 0x27039
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_244(int iParam0)//Position - 0x27093
{
...
bool func_245(int iParam0, int iParam1, float fParam2)//Position - 0x270BB
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_246(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x27102
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_247(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x271FD
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_248(int iParam0, float fParam1)//Position - 0x27309
{
	var uVar0;
	struct<3> Var1;
...
int func_249(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x2739E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_250(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2742C
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
void func_251()//Position - 0x27474
{
	...
	else
	{
		switch (iLocal_102)
		{
			...
			case 1:
				if (!func_203() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					if (iLocal_103)
					{
						func_220(&uLocal_112, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
...
void func_252(char* sParam0, int iParam1, int iParam2)//Position - 0x275B0
{
	iParam2 = iParam2;
...
int func_256(int iParam0)//Position - 0x27B2E
{
	if (func_383(uParam0))
	{
		if (!PED::IS_PED_INJURED(uParam0))
...
void func_257(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x27B4E
{
	if (bParam0)
	{
...
int func_258(int iParam0)//Position - 0x27C1F
{
...
bool func_259()//Position - 0x27C60
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_260(int iParam0, int iParam1)//Position - 0x27C71
{
	bool bVar0;
...
int func_261(int iParam0, bool bParam1)//Position - 0x27CBC
{
	int iVar0;
	int iVar1;
...
int func_262(int iParam0, var uParam1, var uParam2)//Position - 0x27CFD
{
	int iVar0;
...
void func_263(int iParam0)//Position - 0x27D2E
{
	if (iParam0 == 1)
	{
...
void func_267(int iParam0, bool bParam1)//Position - 0x281A1
{
...
Vector3 func_268(var uParam0)//Position - 0x281DD
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_269(bool bParam0)//Position - 0x281F0
{
	int iVar0;
...
Vector3 func_270()//Position - 0x2822C
{
	return 2.55f, 5.59f, 2.55f;
}

void func_271(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x28243
{
	func_272(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_272(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x2826D
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_273(struct<3> Param0)//Position - 0x28653
{
...
int func_274(int iParam0, int iParam1, bool bParam2)//Position - 0x2867D
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_275(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x286EE
{
...
int func_276(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x287CE
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_277(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x28AC4
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_278(int iParam0)//Position - 0x28B78
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
void func_279()//Position - 0x28BDD
{
	int iVar0;
...
int func_281(int iParam0, float fParam1, int iParam2)//Position - 0x28D3A
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_285(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_282()//Position - 0x28E0D
{
	bool bVar0;
...
void func_283()//Position - 0x28E30
{
...
int func_284(int iParam0, int iParam1)//Position - 0x28E81
{
	if (func_256(iParam0))
	{
...
int func_285(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x28EB4
{
...
void func_288(char* sParam0, bool bParam1)//Position - 0x29334
{
	func_269(bParam1);
...
void func_289()//Position - 0x2934A
{
	...
	{
		case 0:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
		...
		case 1:
			if (!func_5(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1107.353f, 281.626f, 61.46451f, -1099.521f, 282.5073f, 65.99223f, 16f, 0, 1, 0))
			{
				if (func_383(PLAYER::PLAYER_PED_ID()) && func_256(Local_442.f_28[0]))
				{
					if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), -1105.571f, 290.008f, 62.87176f, -1100.577f, 290.4298f, 66.45212f, 4.5f, 0, 1, 0))
					{
						if (!func_290())
						{
							if (!func_284(PLAYER::PLAYER_PED_ID(), -875674219))
							{
				...
				if (!iLocal_518)
				{
					...
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_442.f_28[0], "rcmjosh4", "beckon_a_josh", 3) && !func_203())
						{
				...
				{
					if ((func_383(PLAYER::PLAYER_PED_ID()) && func_256(Local_442.f_28[0])) && !func_290())
					{
						if (!func_284(PLAYER::PLAYER_PED_ID(), -875674219))
						{
							TASK::TASK_TURN_PED_TO_FACE_ENTITY(PLAYER::PLAYER_PED_ID(), Local_442.f_28[0], 0);
					...
					if (func_256(Local_442.f_28[0]))
					{
						if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_442.f_28[0], "rcmjosh4", "josh_4_leadin_josh", 3))
						{
							...
							if (func_207(PLAYER::PLAYER_PED_ID(), Local_442.f_28[0], 1) <= 2f)
							{
								if (func_203())
								{
									func_221();
...
void func_291()//Position - 0x29755
{
	func_293();
	func_283();
	func_292();
...
void func_292()//Position - 0x29769
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_285(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1))
			{
...
void func_293()//Position - 0x297C0
{
...
void func_294(int iParam0)//Position - 0x297E8
{
	if (Global_14551)
	{
		func_295(0, 0);
...
void func_295(bool bParam0, bool bParam1)//Position - 0x29858
{
	if (bParam0)
	{
		if (func_296(0))
...
int func_296(int iParam0)//Position - 0x298CC
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
float func_298(var uParam0)//Position - 0x29C0B
{
	HUD::_BEGIN_TEXT_COMMAND_GET_WIDTH(uParam0);
	return HUD::_END_TEXT_COMMAND_GET_WIDTH(1);
}

struct<2> func_299(int iParam0, int iParam1, int iParam2)//Position - 0x29C1E
{
	struct<2> Var0;
	int iVar2;
...
char* func_300(int iParam0)//Position - 0x29CF5
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_301(int iParam0)//Position - 0x29E5D
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_302(int iParam0)//Position - 0x29E92
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_303(int iParam0)//Position - 0x29EC7
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_304(int iParam0)//Position - 0x29EFC
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_305(int iParam0)//Position - 0x29F31
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_306(int iParam0)//Position - 0x29F70
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_307(int iParam0)//Position - 0x29FA5
{
	struct<2> Var0;
...
int func_308(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x2A012
{
	if (((!func_310(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
	{
		...
		case 5:
			if ((CUTSCENE::IS_CUTSCENE_PLAYING() || func_296(0)) || func_309(1))
			{
			}
			else
			{
...
bool func_309(bool bParam0)//Position - 0x2A12B
{
	if (bParam0)
	{
...
int func_310(int iParam0)//Position - 0x2A154
{
	if (Global_34913 == 15)
	{
		return 0;
...
bool func_311(int iParam0)//Position - 0x2A176
{
	return func_312(iParam0, Global_34913);
}

int func_312(int iParam0, int iParam1)//Position - 0x2A187
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_313()//Position - 0x2A368
{
	...
	if (!func_319())
	{
		func_318(PLAYER::PLAYER_PED_ID(), Local_105, fLocal_108, 1, 1);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
		CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	}
	func_287(1);
...
void func_315(int iParam0, int iParam1, int iParam2)//Position - 0x2A53C
{
...
int func_318(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x2A714
{
	bool bVar0;
	float fVar1;
...
bool func_319()//Position - 0x2A76E
{
	return MISC::IS_BIT_SET(Global_89962.f_20, 13);
}

void func_320(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x2A782
{
	int iVar0;
...
int func_321(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2A90A
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
...
void func_322(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2B6F0
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_323(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2C2D0
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_324(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2C343
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_325(int iParam0)//Position - 0x2D8E5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_326(int iParam0, var uParam1, var uParam2)//Position - 0x2D9A3
{
	int iVar0;
	int iVar1;
...
int func_327(int iParam0, bool bParam1, var uParam2)//Position - 0x2DA7D
{
	int iVar0;
...
int func_328(int iParam0)//Position - 0x2DB1F
{
	int iVar0;
...
int func_329(int iParam0, bool bParam1, var uParam2)//Position - 0x2DB5A
{
	if (!bParam1)
	{
...
int func_330(int iParam0)//Position - 0x2DEF4
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_331(int iParam0, int iParam1)//Position - 0x2DF1D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_332(int iParam0, var uParam1)//Position - 0x2E11E
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_333(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_333(int iParam0)//Position - 0x2E3CC
{
	switch (iParam0)
	{
		case 1:
...
int func_334(int iParam0)//Position - 0x2E47C
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_274(iParam0, 0, 0)) || func_274(iParam0, 1, 0)) || func_274(iParam0, 2, 0)) || func_345(iParam0) != 145) || func_344(iParam0)) || func_343(iParam0)) || func_328(iParam0)) || func_342(iParam0)) || !func_335(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_343(iParam0))
		{
		}
...
int func_335(int iParam0)//Position - 0x2E559
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_336(int iParam0)//Position - 0x2E709
{
	int iVar0;
	struct<2> Var1;
...
int func_337()//Position - 0x2E8D8
{
	return 0;
}

int func_338()//Position - 0x2E8E1
{
	return 1;
}

int func_339()//Position - 0x2E8EA
{
	return 1;
}

int func_340()//Position - 0x2E8F3
{
...
int func_342(int iParam0)//Position - 0x2E98F
{
	int iVar0;
	char* sVar1;
...
int func_343(int iParam0)//Position - 0x2E9D5
{
	int iVar0;
...
int func_344(int iParam0)//Position - 0x2EA51
{
	int iVar0;
...
int func_345(int iParam0)//Position - 0x2EB39
{
	int iVar0;
...
void func_346(int iParam0, int iParam1)//Position - 0x2EB9C
{
	int iVar0;
...
void func_347(var uParam0)//Position - 0x2EC1E
{
	if (!func_348(*uParam0))
	{
...
bool func_348(int iParam0)//Position - 0x2EC49
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_349(var uParam0, var uParam1, var uParam2)//Position - 0x2EC58
{
	int iVar0;
	int iVar1;
...
int func_350(int iParam0)//Position - 0x2ED8A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_351(var uParam0, var uParam1)//Position - 0x2EE68
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_352(int iParam0, var uParam1, int iParam2)//Position - 0x2EEA9
{
	int iVar0;
	struct<74> Var1;
...
void func_353(int iParam0, int iParam1)//Position - 0x2F126
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_354(iParam0, iParam1))
				{
...
int func_354(int iParam0, int iParam1)//Position - 0x2F1C7
{
	struct<58> Var0;
...
void func_355(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2F209
{
	int iVar0;
...
void func_356(int iParam0)//Position - 0x2F259
{
	bool bVar0;
...
void func_357(struct<54> Param0, var uParam54)//Position - 0x2F3CE
{
...
int func_358(int iParam0, int iParam1)//Position - 0x2F499
{
	int iVar0;
...
int func_359(var uParam0)//Position - 0x2F50A
{
	return *uParam0;
}

int func_360(var uParam0, int iParam1)//Position - 0x2F515
{
	int iVar0;
	int iVar1;
...
bool func_361(struct<3> Param0, struct<3> Param3)//Position - 0x30C0C
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_362(struct<3> Param0, float fParam3)//Position - 0x30C35
{
	return func_363(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_363(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x30C4F
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_372(uParam0))
	{
		...
		if (func_371(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_365(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_364(int iParam0)//Position - 0x30EFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_365(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x30FBD
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_367(iParam0, uVar1[iVar6], 1) && func_366(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_361(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_366(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x311C3
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_367(int iParam0, int iParam1, bool bParam2)//Position - 0x3120F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_368(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x3126F
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_370(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_369())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_333(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
bool func_369()//Position - 0x3165E
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_370(int iParam0)//Position - 0x3166F
{
	var uVar0;
...
int func_371(var uParam0)//Position - 0x316BD
{
	if (func_372(uParam0))
	{
...
int func_372(var uParam0)//Position - 0x316F2
{
...
bool func_373()//Position - 0x3171B
{
	return func_371(&(Global_93588.f_2167));
}

void func_374()//Position - 0x3172E
{
	func_375(&(Global_93588.f_2167));
}

void func_375(var uParam0)//Position - 0x31741
{
	if (func_372(uParam0))
	{
...
int func_376(int iParam0, int iParam1, int iParam2)//Position - 0x3175F
{
...
int func_378(int iParam0)//Position - 0x31843
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_379()//Position - 0x3189C
{
	return func_372(&(Global_93588.f_2167));
}

void func_380(int iParam0, int iParam1, bool bParam2)//Position - 0x318AF
{
	Global_2949 = iParam0;
...
void func_381()//Position - 0x31A59
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
int func_383(int iParam0)//Position - 0x31DF6
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
...
void func_384(var uParam0, int iParam1, bool bParam2)//Position - 0x31E16
{
	int iVar0;
...
void func_388(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0x323AE
{
	func_225(uParam0);
	*uParam0 = PED::CREATE_PED(iParam6, uParam1, Param2, fParam5, 0, 0);
}

int func_389(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x323CF
{
...
int func_390(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x3242A
{
	int iVar0;
...
int func_391(var uParam0, int iParam1)//Position - 0x324B8
{
	int iVar0;
...
int func_392(var uParam0)//Position - 0x324FE
{
	if (func_393(uParam0))
	{
...
int func_393(var uParam0)//Position - 0x32528
{
...
int func_394(int iParam0)//Position - 0x3254D
{
	int iVar0;
...
void func_395(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x3257E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
void func_396(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x325BA
{
	if (func_397())
	{
...
void func_400(var uParam0, bool bParam1)//Position - 0x32765
{
	func_401(&(uParam0->f_41), bParam1);
}

void func_401(var uParam0, bool bParam1)//Position - 0x32777
{
	int iVar0;
...
void func_402(var uParam0, bool bParam1)//Position - 0x327B5
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_403(var uParam0)//Position - 0x327F0
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_404(var uParam0, bool bParam1)//Position - 0x3281B
{
	func_405(&(uParam0->f_35), bParam1);
}

void func_405(var uParam0, bool bParam1)//Position - 0x3282D
{
	int iVar0;
...
void func_406(var uParam0, int iParam1)//Position - 0x3286A
{
	func_407(&(uParam0->f_28), iParam1);
}

void func_407(var uParam0, int iParam1)//Position - 0x3287C
{
	int iVar0;
...
void func_409(bool bParam0)//Position - 0x3295E
{
	int iVar0;
	...
	if (!func_426())
	{
		...
		{
			func_158(iVar0, 1, 0);
			func_410(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_96440[iVar0 /*10*/].f_9 == -1)
...
void func_410(char* sParam0, int iParam1)//Position - 0x32A2E
{
	if (Global_89962 != 12)
	{
...
int func_411(char* sParam0, int iParam1, int iParam2)//Position - 0x32A56
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_417())
	{
		...
		{
			iVar33 = func_412(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_412(char* sParam0)//Position - 0x32BE8
{
...
int func_414(char* sParam0, bool bParam1)//Position - 0x32C66
{
	int iVar0;
	int iVar1;
...
int func_415(int iParam0, bool bParam1)//Position - 0x32C90
{
	int iVar0;
...
void func_418(int iParam0)//Position - 0x32D82
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_419(int iParam0)//Position - 0x32D96
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_420(int iParam0)//Position - 0x32DD3
{
	if (iParam0 == 1)
	{
...
void func_421()//Position - 0x32E10
{
	Global_17098.f_5 = 1;
}

void func_422()//Position - 0x32E1E
{
	Global_17098.f_5 = 0;
}

void func_423(bool bParam0)//Position - 0x32E2C
{
	if (bParam0)
	{
		func_424();
...
void func_424()//Position - 0x32E8F
{
...
void func_425()//Position - 0x32EB8
{
	Global_84543 = 0;
	Global_84544 = 0;
}

int func_426()//Position - 0x32ECA
{
	if (((Global_89962 == 13 || Global_89962 == 10) || Global_89962 == 11) || Global_89962 == 12)
	{
		return 0;
...
void func_427()//Position - 0x32F08
{
	Global_89997 = 1;
...
void func_428(char* sParam0)//Position - 0x32FFD
{
...
void func_429(var uParam0)//Position - 0x3300F
{
...
void func_430(var uParam0)//Position - 0x3302F
{
	int iVar0;
...
void func_431(char* sParam0)//Position - 0x33069
{
	sParam0 = sParam0;
}

int func_432(int iParam0)//Position - 0x33075
{
	if (!func_150(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
