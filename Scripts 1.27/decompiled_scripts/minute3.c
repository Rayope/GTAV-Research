...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	uLocal_94 = func_580(56);
	uLocal_95 = func_580(57);
	iLocal_96 = func_580(59);
...
void func_1()//Position - 0x567
{
	...
	if (!iLocal_172 == 9)
	{
		if (func_516(Local_110.f_28[0]))
		{
			if (((!func_35(Local_110.f_35[1]) || func_27(Local_110.f_28[0], 0, 0, 0, 0)) || WEAPON::HAS_ENTITY_BEEN_DAMAGED_BY_WEAPON(Local_110.f_35[1], 0, 2)) || (PED::IS_PED_BEING_JACKED(Local_110.f_28[0]) && PED::IS_PED_JACKING(PLAYER::PLAYER_PED_ID())))
			{
			...
			else if (iLocal_644 == 0)
			{
				if (PED::IS_PED_IN_VEHICLE(PLAYER::PLAYER_PED_ID(), Local_110.f_35[1], 1))
				{
					...
					{
						bVar0 = func_3(&uLocal_345, "MIN3AUD", "MIN3_STEAL", 8, 1, 0, 0);
					}
					else
					{
						bVar0 = func_3(&uLocal_345, "MIN3AUD", "MIN3_STEAL", 8, 0, 0, 0);
					}
					if (bVar0)
					{
...
void func_22(int iParam0)//Position - 0xF65
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		...
		if (func_516(Local_196) && func_516(PLAYER::PLAYER_PED_ID()))
		{
...
{
	func_26(&(Local_196.f_1));
	func_26(&(Local_202.f_1));
}
...
int func_30(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x1382
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	...
	{
		Var3 = { func_32(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar6 = func_31(Var3, Var0);
...
float func_31(struct<3> Param0, struct<3> Param3)//Position - 0x1410
{
...
void func_39()//Position - 0x1646
{
	...
	func_42(&Local_196);
	func_42(&Local_202);
	func_42(&(Local_110.f_28[0]));
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 5)
	{
		func_42(&(uLocal_209[iVar0]));
		iVar0++;
	}
	func_41(&iLocal_281);
	func_41(&iLocal_288);
...
void func_46()//Position - 0x1831
{
	switch (iLocal_174)
	{
		case 0:
			...
			func_25();
			func_23();
			func_242(&uLocal_345, 5);
			func_242(&uLocal_345, 4);
		...
		case 1:
			if (!func_21())
			{
				if (func_241(&uLocal_345, "MIN3AUD", "MIN3_KILL", "MIN3_KILL_2", 8, 0, 0))
				{
					iLocal_174 = 4;
				}
			}
...
void func_48(int iParam0, bool bParam1)//Position - 0x18EC
{
	...
	{
		func_209(&(Global_96440[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
void func_52()//Position - 0x1B76
{
	...
	{
		func_54(13, SYSTEM::FLOOR(Global_97353.f_8448.f_3853));
	}
...
void func_67(var uParam0)//Position - 0x24AF
{
	...
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_72(&(uParam0->f_25[0 /*223*/][iVar1 /*74*/]));
		func_72(&(uParam0->f_25[1 /*223*/][iVar1 /*74*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_71(&(uParam0->f_2161));
	func_69(&(uParam0->f_2167));
	func_68(&(uParam0->f_2233));
}
...
int func_77(int iParam0, int iParam1, int iParam2)//Position - 0x2D52
{
	...
	Global_68106[1 /*14*/] = { func_127(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_68106[1 /*14*/] = { func_127(iVar0, iParam1, uVar30[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_119(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_119(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x2F0B
{
	...
	{
		if (!func_191(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_80(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2FD2
{
	...
	if (iParam5 == 0)
	{
		Global_68106[1 /*14*/] = { func_127(iVar10, iParam1, iParam2) };
		if (!func_117(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_68106[1 /*14*/] = { func_127(iVar10, iVar0, uVar11[iVar0]) };
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_68106[1 /*14*/] = { func_127(iVar10, 14, uVar27[iVar1]) };
							func_96(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
							func_110(14);
							if (Global_68105 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_110(iVar0);
						if (Global_68105 == 1)
						{
			...
			{
				Global_68106[1 /*14*/] = { func_127(iVar10, iVar0, func_86(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_68106[1 /*14*/] = { func_127(iVar10, 14, uVar67[iVar1]) };
			func_96(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
			func_110(14);
			if (Global_68105 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_119(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_119(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
{
	Global_68106[1 /*14*/] = { func_127(iParam0, iParam1, iParam2) };
...
void func_110(int iParam0)//Position - 0x6EE4
{
	...
	{
		func_116(iParam0, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_112(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6FE5
{
	...
	iVar0 = Global_2454605[iParam0 /*6*/][func_113(iParam2)];
	if (iVar0 != 0)
	{
...
int func_114(int iParam0, int iParam1, int iParam2)//Position - 0x7044
{
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_113(iParam1)];
...
int func_118(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8689
{
	...
	{
		if (!func_191(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_126(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[0], Global_97353.f_1729.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_126(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[1], Global_97353.f_1729.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_126(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[2], Global_97353.f_1729.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_125(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_125(Var16.f_2)] = func_106(iParam1, Var16.x, func_125(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*iParam0)[func_125(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar19++;
		}
...
void func_129(int iParam0)//Position - 0xB4C7
{
	...
	func_130(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_15(14))
			{
				uVar0 = func_114(func_133(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_114(func_132(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_114(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_136(int iParam0, int iParam1, int iParam2)//Position - 0xD7D3
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_130(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_130(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_130(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
		...
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_130(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_191(int iParam0, int iParam1, int iParam2)//Position - 0x1EE31
{
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_191(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_191(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_68106[2 /*14*/] = { func_127(iVar0, 14, iVar4) };
									if (Global_68106[2 /*14*/].f_12 == iVar3)
									{
										if (func_191(iParam0, 14, iVar4))
										{
											if (!func_84(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_68106[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_68106[2 /*14*/] = { func_127(iVar0, iVar2, iVar1) };
						if (!func_84(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_68106[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_119(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_119(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_198(int iParam0, int iParam1, int iParam2)//Position - 0x1F693
{
	...
	if (iParam0 != -1)
	{
		...
		func_199(&uVar32, Var0.f_3, Global_89999, iParam1, iParam2);
	}
}
...
void func_204()//Position - 0x20CB5
{
	...
	{
		func_11();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_205(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
{
	func_214(iParam0, 1);
	Global_97353.f_16828[iParam0 /*6*/].f_3 = func_213();
...
void func_243()//Position - 0x262A8
{
	...
	func_275();
	func_274(Local_202.f_1, Local_202, 250f, 1061158912, 0);
	func_273();
	bVar0 = false;
	if (func_516(Local_202))
	{
	...
	if (bVar0 && bVar1)
	{
		fVar2 = func_271(Local_202, PLAYER::PLAYER_PED_ID());
		fVar3 = func_271(Local_196, PLAYER::PLAYER_PED_ID());
		if (fVar2 < fVar3)
		{
			func_246(&uLocal_35, Local_202, 0, 0, 1, 1, 1);
		}
		else
		{
			func_246(&uLocal_35, Local_196, 0, 0, 1, 1, 1);
		}
	}
	else if (bVar0)
	{
...
int func_244()//Position - 0x263D7
{
	...
	if (func_516(Local_202))
	{
		...
		{
			fVar0 = func_271(PLAYER::PLAYER_PED_ID(), Local_202);
			iLocal_173 = 5;
		}
	}
	if (fVar0 > 250f)
...
void func_248(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x2647D
{
...
void func_249(var uParam0, int iParam1, struct<3> Param2, char* sParam5, int iParam6, bool bParam7, var uParam8, bool bParam9)//Position - 0x264B5
{
	int iVar0;
	int iVar1;
...
void func_258(var uParam0, int iParam1, struct<3> Param2, int iParam5)//Position - 0x26BFB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_261(struct<3> Param0, struct<3> Param3)//Position - 0x26D2D
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}
...
void func_275()//Position - 0x27575
{
	...
	if (func_35(iLocal_556))
	{
		...
		{
			if (func_35(iLocal_543))
			{
				if (iLocal_564)
				{
					if (func_272(PLAYER::PLAYER_PED_ID(), iLocal_556, 1) < 100f)
					{
						if (func_516(iLocal_557) && !func_276(iLocal_557, 242628503))
						{
...
bool func_281(int iParam0, struct<3> Param1, float fParam4)//Position - 0x278BB
{
	struct<3> Var0;
	struct<3> Var3;
...
void func_282()//Position - 0x278F0
{
	...
	while (iVar0 < 5)
	{
		if (func_516(uLocal_209[iVar0]))
		{
			if ((!PED::IS_PED_FLEEING(uLocal_209[iVar0]) && !func_276(uLocal_209[iVar0], 242628503)) && iVar1 > (iVar0 * iVar2))
			{
...
void func_286()//Position - 0x27C74
{
	...
	if (func_35(iLocal_299) && func_516(Local_202))
	{
		if (func_276(Local_202, -235832601) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_314))
		{
		...
		if (!func_21() && (!HUD::IS_MESSAGE_BEING_DISPLAYED() || MISC::GET_PROFILE_SETTING(203) == 0))
		{
			...
			switch (iVar0)
			{
				case 1:
					if (iLocal_534 < 3)
					{
						if (func_3(&uLocal_345, "MIN3AUD", sLocal_535[iLocal_534], 8, 0, 0, 0))
						{
							iLocal_534++;
				...
				case 0:
					if (iLocal_527 < 5)
					{
						if (func_241(&uLocal_345, "MIN3AUD", "MIN3_CHASE", sLocal_528[iLocal_527], 8, 0, 0))
						{
							iLocal_527++;
							iLocal_567 = MISC::GET_GAME_TIMER() + 20000;
						}
...
int func_288()//Position - 0x27E1D
{
	...
	fVar1 = 10f;
	iVar2 = 0;
	if (func_516(Local_202) && iLocal_534 < 3)
	{
		fVar0 = func_271(PLAYER::PLAYER_PED_ID(), Local_202);
		if (fVar0 < fVar1)
		{
	...
	if (func_516(Local_196) && iLocal_539 < 3)
	{
		fVar0 = func_271(PLAYER::PLAYER_PED_ID(), Local_196);
		if (fVar0 < fVar1)
		{
			iVar2 = 2;
		}
...
int func_289()//Position - 0x27E8C
{
	...
	if (func_516(Local_202))
	{
		fVar1 = func_271(PLAYER::PLAYER_PED_ID(), Local_202);
	}
	if (func_516(Local_196))
	{
		fVar0 = func_271(PLAYER::PLAYER_PED_ID(), Local_196);
...
int func_290()//Position - 0x27EE7
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_202))
	{
		if (PED::IS_PED_INJURED(Local_202))
		{
			iLocal_174 = 0;
			iLocal_172 = 8;
			if (func_291(&uLocal_574, ENTITY::GET_ENTITY_COORDS(Local_202, 0)))
			{
				iLocal_573 = 1;
			}
			return 1;
...
bool func_291(var uParam0, struct<2> Param1, float fParam3)//Position - 0x27F22
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_292()//Position - 0x27FDE
{
	...
	switch (iLocal_174)
	{
		case 0:
			...
			if (func_516(Local_202))
			{
				if (((func_35(iLocal_299) && VEHICLE::IS_VEHICLE_SEAT_FREE(iLocal_299, -1)) && !func_364()) && !func_280())
				{
					func_363(&uLocal_345, 4, Local_202, "JOE", 1, 1);
					if (ENTITY::IS_ENTITY_ON_SCREEN(Local_202) && (func_362(PLAYER::PLAYER_PED_ID(), 420.7328f, 6463.86f, 27.90358f, 5f) || func_362(PLAYER::PLAYER_PED_ID(), 434.0566f, 6476.2f, 27.83386f, 10f)))
					{
		...
		case 1:
			if ((((func_516(Local_202) && func_35(iLocal_299)) && PED::IS_PED_IN_VEHICLE(Local_202, iLocal_299, 0)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_312)) && TASK::GET_IS_WAYPOINT_RECORDING_LOADED(sLocal_313))
			{
				func_23();
				if (func_3(&uLocal_345, "MIN3AUD", "MIN3_T_BARN", 7, 0, 0, 0))
				{
					func_359();
					iVar0 = PLAYER::GET_PLAYERS_LAST_VEHICLE();
					if (func_35(iVar0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(iVar0, Local_316, Local_319, fLocal_322, 0, 1, 0))
					{
					...
					func_26(&(Local_202.f_1));
					Local_202.f_1 = func_297(Local_202, 1, 0, 5);
...
void func_293()//Position - 0x282EE
{
	...
	{
		if ((((((((!func_35(iLocal_299) || FIRE::IS_ENTITY_ON_FIRE(iLocal_299)) || ENTITY::GET_ENTITY_HEALTH(iLocal_299) < 700) || VEHICLE::GET_VEHICLE_ENGINE_HEALTH(iLocal_299) < 50f) || VEHICLE::GET_VEHICLE_PETROL_TANK_HEALTH(iLocal_299) < 50f) || func_296()) || func_295()) || func_294(iLocal_299, &uLocal_629, &uLocal_631, &uLocal_628, &fLocal_630, 11, 5f)) || ENTITY::IS_ENTITY_IN_WATER(iLocal_299))
		{
			if (func_516(Local_202))
			{
	...
	if (func_516(Local_202))
	{
		if (PED::IS_PED_BEING_JACKED(Local_202) || !PED::IS_PED_IN_ANY_VEHICLE(Local_202, 0))
		{
			...
			TASK::TASK_SMART_FLEE_PED(Local_202, PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
			if (func_35(iLocal_299) && VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_299))
			{
...
int func_296()//Position - 0x28576
{
	...
	else if (func_35(iLocal_299) && !VEHICLE::IS_PLAYBACK_GOING_ON_FOR_VEHICLE(iLocal_299))
	{
		iVar0 = 0;
...
void func_298(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2865E
{
	...
	if (iVar0 == 1)
	{
		...
		else
		{
			...
			{
				iVar10 = func_353(&(Global_89962.f_3));
				if (iVar10 > -1)
				{
...
{
	func_300(&Global_93588, SCRIPT::GET_THIS_SCRIPT_NAME(), iParam0, uParam1, iParam3, iParam2);
}
...
void func_300(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x287EF
{
	...
	*uParam0 = func_10();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_321())
		{
			func_317(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (iParam4 == 1)
	{
		func_302(&(uParam0->f_2167), uParam0, iParam5, 1, 1, 0);
	}
	func_301(&(uParam0->f_2233));
	uParam3 = uParam3;
	uParam2 = uParam2;
}
...
{
	func_311(iParam1, &(uParam0->f_12));
	uParam0->f_7 = func_308(iParam1, 145, 0);
	uParam0->f_11 = func_307(iParam1);
	if (!uParam0->f_7)
	{
		if (!uParam0->f_10)
		{
			uParam0->f_10 = func_306(iParam1);
		}
	}
	if (iParam2 == 1)
	{
...
void func_317(int iParam0, var uParam1, int iParam2)//Position - 0x2A2FF
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar1 < 12)
		{
			func_320(iParam0, iVar1, &(uParam1->f_13[iVar1]), uParam1[iVar1], &(uParam1->f_26[iVar1]), iParam2, 145);
			iVar1++;
		}
		iVar1 = 0;
		while (iVar1 < 9)
		{
			func_319(iParam0, iVar1, &(uParam1->f_39[iVar1]), &(uParam1->f_49[iVar1]), iParam2, 145);
			iVar1++;
		}
		if (func_12(iVar0))
		{
		...
		else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && ENTITY::GET_ENTITY_MODEL(iParam0) == ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			if (func_318(161, -1))
			{
				uParam1->f_59 = func_114(2035, Global_68104, 0);
			}
			else
			{
				uParam1->f_59 = func_114(740, Global_68104, 0);
			}
			uParam1->f_60 = func_114(741, Global_68104, 0);
			uParam1->f_61 = func_114(742, Global_68104, 0);
		}
...
int func_318(int iParam0, int iParam1)//Position - 0x2A4A9
{
	...
	uVar0 = Global_2473393[iParam0 /*6*/][func_113(iParam1)];
...
void func_322(int iParam0, bool bParam1)//Position - 0x2AC77
{
	...
	if (func_12(iVar0) && !PED::IS_PED_INJURED(iParam0))
	{
		if (iParam0 == PLAYER::PLAYER_PED_ID())
		{
			func_323(iParam0, &(Global_97353.f_1729.f_539.f_298[iVar0 /*284*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_323(int iParam0, var uParam1)//Position - 0x2AD6A
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_324(Var9.f_1)) && iVar70 < 50)
			{
...
int func_330(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2C157
{
	int iVar0;
	int iVar1;
...
int func_337(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2CB73
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 43)
	{
		if (iParam3 == 5 || iParam3 == func_340(iVar0))
		{
...
int func_354(int iParam0)//Position - 0x2D697
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_355(Global_97353.f_7341.f_99.f_203[10]);
			break;
		
		case 74:
		case 75:
			return func_355(Global_97353.f_7341.f_99.f_203[8]);
			break;
		
		case 84:
		case 85:
			return func_355(Global_97353.f_7341.f_99.f_203[11]);
			break;
		
		case 90:
			return func_355(Global_97353.f_7341.f_99.f_203[7]);
			break;
		
		case 93:
			return func_355(Global_97353.f_7341.f_99.f_203[9]);
			break;
	}
	return 0;
}
...
bool func_362(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2DB42
{
...
{
	if (func_362(PLAYER::PLAYER_PED_ID(), Local_204, fParam0) || (uParam1 && MISC::GET_GAME_TIMER() > iLocal_565))
	{
		iLocal_174 = 0;
		iLocal_172 = 6;
		return 1;
...
void func_368()//Position - 0x2DD41
{
	if (iLocal_519 < 6)
	{
		...
		{
			if (func_516(Local_202) && MISC::GET_GAME_TIMER() > iLocal_568)
			{
				func_284(Local_202, sLocal_520[iLocal_519], "JOE", 24);
				iLocal_519++;
		...
		case 1:
			...
			if (!func_516(Local_196))
			{
				if (func_516(Local_202))
				{
					if (!func_366(0))
					{
						func_270(&uLocal_35, 0, 0);
						if (iLocal_511)
						{
							if (func_241(&uLocal_345, "MIN3AUD", "MIN3_KILL", "MIN3_KILL_1", 8, 0, 0))
							{
			...
			if (func_34(Local_196) && PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				func_246(&uLocal_35, Local_196, 0, 0, 1, 1, 1);
			}
			break;
...
void func_370()//Position - 0x2DEE2
{
	if (func_516(Local_202))
	{
		func_26(&(Local_202.f_1));
		Local_202.f_1 = func_297(Local_202, 1, 0, 5);
		func_371(&(Local_202.f_1), 405.69f, 6557.56f, 27.04f, 266.03f);
	}
	if (func_516(Local_196))
	{
		func_26(&(Local_196.f_1));
		Local_196.f_1 = func_297(Local_196, 1, 0, 5);
		func_371(&(Local_196.f_1), 405.69f, 6557.56f, 27.04f, 266.03f);
	}
}

void func_371(var uParam0, struct<3> Param1, float fParam4)//Position - 0x2DF5E
{
	if (HUD::DOES_BLIP_EXIST(*uParam0))
	{
...
void func_373()//Position - 0x2DFBE
{
	...
	switch (iLocal_174)
	{
		...
		case 1:
			if (!func_21() || func_394(&iLocal_632, 15000))
			{
				if (func_241(&uLocal_345, "MIN3AUD", "MIN3_MANUEL", "MIN3_MANUEL_2", 7, 0, 0))
				{
					iLocal_174 = 2;
				}
			}
		...
		case 2:
			func_393();
			if (func_392(PLAYER::PLAYER_PED_ID(), Local_198, 1) > 100f)
			{
				func_391();
			}
		...
		case 3:
			...
			func_387();
			func_368();
			if (func_392(PLAYER::PLAYER_PED_ID(), Local_198, 1) > 150f)
			{
				func_391();
			}
			else
			...
			if (func_516(Local_196) && func_392(PLAYER::PLAYER_PED_ID(), Local_198, 1) < 45f)
			{
				if (func_3(&uLocal_345, "MIN3AUD", "MIN3_J_FARM", 7, 0, 0, 0))
				{
					RECORDING::_0x293220DA1B46CEBC(3f, 10f, 0);
					iLocal_174 = 4;
				}
		...
		case 4:
			...
			{
				PED::SET_PED_RESET_FLAG(Local_196, 156, 1);
				if (func_392(PLAYER::PLAYER_PED_ID(), Local_198, 1) < 25f)
				{
					if (func_379(Local_196, 90f) || (func_379(Local_196, 0f) && !PED::GET_PED_STEALTH_MOVEMENT(PLAYER::PLAYER_PED_ID())))
					{
						func_23();
						if (func_3(&uLocal_345, "MIN3AUD", "MIN3_T_FARM", 7, 0, 0, 0))
						{
							func_378(1500);
						}
					}
				}
				else if (func_392(PLAYER::PLAYER_PED_ID(), Local_198, 1) > 100f)
				{
					if (func_21())
					{
						func_23();
				...
				else if (func_516(uLocal_209[0]))
				{
					if (iLocal_569 > 0)
					{
						if (MISC::GET_GAME_TIMER() > iLocal_569)
						{
							if (bLocal_570)
							{
								if (!func_21() && !PED::IS_PED_IN_COMBAT(Local_196, 0))
								{
							...
							{
								bLocal_570 = func_3(&uLocal_345, "MIN3AUD", "MIN3_REPLY", 7, 0, 0, 0);
							}
						}
					}
					else if (!func_21())
					{
						...
						func_363(&uLocal_345, 6, uLocal_209[0], "Min3Mexican0", 1, 1);
					}
				}
	...
	if ((ENTITY::DOES_ENTITY_EXIST(iLocal_281) && (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iLocal_281, PLAYER::PLAYER_PED_ID(), 1) || !func_34(iLocal_281))) || FIRE::IS_EXPLOSION_IN_SPHERE(-1, Local_198, 50f))
	{
		func_378(0);
	}
	if (ENTITY::DOES_ENTITY_EXIST(Local_196))
	{
		...
		else if (func_27(Local_196, 1, 0, 0, 0) || ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_196, PLAYER::PLAYER_PED_ID(), 1))
		{
			func_378(0);
		}
	}
	if (func_516(Local_110.f_28[0]))
	{
		if (!PED::IS_PED_FLEEING(Local_110.f_28[0]) && !PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_28[0], 1))
		{
			...
			{
				func_23();
				if (func_3(&uLocal_345, "MIN3AUD", "MIN3_THREAT", 7, 1, 0, 0))
				{
					TASK::TASK_SMART_FLEE_PED(Local_110.f_28[0], PLAYER::PLAYER_PED_ID(), 500f, -1, 0, 0);
				}
			}
			...
			{
				func_23();
				if (func_3(&uLocal_345, "MIN3AUD", "MIN3_AIM", 7, 1, 0, 0))
				{
					if (!func_276(Local_110.f_28[0], -1146898486))
					{
						TASK::TASK_WANDER_STANDARD(Local_110.f_28[0], 1193033728, 0);
					}
					iLocal_192 = 0;
		...
		if (MISC::GET_GAME_TIMER() > iLocal_195 && ENTITY::IS_ENTITY_TOUCHING_ENTITY(PLAYER::PLAYER_PED_ID(), Local_110.f_28[0]))
		{
			...
			if (func_3(&uLocal_345, "MIN3AUD", "MIN3_BUMP", 7, iVar0, 0, 0))
			{
				iLocal_195 = MISC::GET_GAME_TIMER() + 1000;
			}
		}
		if (MISC::GET_GAME_TIMER() > iLocal_194 && func_375(PLAYER::PLAYER_PED_ID(), Local_110.f_28[0], 15f))
		{
			if (!PED::IS_PED_IN_ANY_VEHICLE(Local_110.f_28[0], 0) && !PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				...
				if (func_3(&uLocal_345, "MIN3AUD", "MIN3_FOLLOW", 7, iVar1, 0, 0))
				{
		...
		{
			func_242(&uLocal_345, 3);
			func_374(&(Local_110.f_28[0]), 1, 0, 1);
		}
	}
}
...
bool func_380(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2E6BB
{
	...
	uVar0 = func_381(&(Local_51[iVar4 /*4*/]), Var1, iParam1, &(Local_51[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_51[iVar4 /*4*/].f_3) < iParam4);
}

int func_381(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x2E77C
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
void func_387()//Position - 0x2EAA2
{
	...
	if (func_35(iLocal_299) && func_35(iLocal_281))
	{
	...
	if (func_516(Local_202))
	{
		if (!func_276(Local_202, 1237250926))
		{
	...
	else if (STREAMING::HAS_MODEL_LOADED(func_580(iLocal_279)))
	{
		Local_202 = PED::CREATE_PED(26, func_580(iLocal_279), Local_204, fLocal_207, 1, 1);
	}
	iVar0 = 0;
	iVar1 = 0;
	iVar0 = 0;
	while (iVar0 < 3)
	{
		...
		{
			iVar1++;
			if (!func_276(iLocal_259[iVar0], -1519143300) && !func_276(iLocal_259[iVar0], 474215631))
			{
...
void func_388()//Position - 0x2EE62
{
	...
	while (iVar0 < 5)
	{
		if (func_516(uLocal_209[iVar0]))
		{
			if (!func_276(uLocal_209[iVar0], -1519143300) && !func_276(uLocal_209[iVar0], 474215631))
			{
	...
	if (STREAMING::HAS_ANIM_DICT_LOADED(sLocal_175) && STREAMING::HAS_ANIM_DICT_LOADED(sLocal_176))
	{
		if (ENTITY::DOES_ENTITY_EXIST(Local_196))
		{
			if (!PED::IS_PED_INJURED(Local_196))
			{
				if (!func_276(Local_196, 242628503))
				{
					...
					TASK::CLEAR_SEQUENCE_TASK(&uVar1);
					func_363(&uLocal_345, 5, Local_196, "JOSEF", 1, 1);
		...
		else if (STREAMING::HAS_MODEL_LOADED(func_580(iLocal_280)))
		{
			Local_196 = PED::CREATE_PED(26, func_580(iLocal_280), Local_198, fLocal_201, 1, 1);
		}
	}
	if (!func_35(iLocal_281))
	{
...
void func_390()//Position - 0x2F350
{
	func_278(iLocal_278);
	func_278(iLocal_277);
	func_278(func_580(iLocal_280));
	func_278(func_580(iLocal_279));
	func_278(iLocal_286);
	func_278(iLocal_289);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_286, 1);
	VEHICLE::SET_VEHICLE_MODEL_IS_SUPPRESSED(iLocal_289, 1);
...
void func_391()//Position - 0x2F3B9
{
	if (iLocal_513 < 4 && INTERIOR::GET_INTERIOR_FROM_ENTITY(PLAYER::PLAYER_PED_ID()) == 0)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_567)
		{
			if (!func_21())
			{
				if (func_241(&uLocal_345, "MIN3AUD", "MIN3_DRIVE", sLocal_514[iLocal_513], 8, 0, 0))
				{
					iLocal_513++;
					iLocal_567 = MISC::GET_GAME_TIMER() + 20000;
				}
...
float func_392(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2F419
{
	struct<3> Var0;
...
void func_393()//Position - 0x2F452
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(iLocal_549))
	{
		if (func_516(iLocal_549) && !func_276(iLocal_549, -2017877118))
		{
			STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iLocal_550);
			PED::SET_PED_CAN_BE_TARGETTED(iLocal_549, 0);
...
void func_396()//Position - 0x2F582
{
	...
	if (func_516(PLAYER::PLAYER_PED_ID()) && ENTITY::DOES_ENTITY_EXIST(iLocal_191))
	{
	...
	if (func_516(Local_110.f_28[0]))
	{
		...
		{
			func_408(Local_110.f_28[0], Local_295);
			ENTITY::SET_ENTITY_HEADING(Local_110.f_28[0], fLocal_298);
			TASK::OPEN_SEQUENCE_TASK(&uVar0);
			if ((func_35(Local_110.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_110.f_35[1], -1)) && func_375(Local_110.f_35[1], Local_110.f_28[0], 25f))
			{
	...
	else if (func_516(Local_110.f_28[0]))
	{
		if (func_241(&uLocal_345, "MIN3AUD", "MIN3_MANUEL", "MIN3_MANUEL_1", 7, 1, 0))
		{
			func_400(1, 0, 1, 1);
			func_537(&Local_110, 0, 0);
...
int func_398(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2F893
{
	int iVar0;
...
void func_410()//Position - 0x2FBE5
{
	...
	{
		case 0:
			func_363(&uLocal_345, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 0, 1);
			func_363(&uLocal_345, 3, Local_110.f_28[0], "MANUEL", 0, 1);
			func_434();
			iLocal_632 = -1;
			if (CAM::IS_SCREEN_FADED_IN() && func_34(Local_110.f_28[0]))
			{
		...
		case 1:
			if (func_3(&uLocal_345, "MIN3AUD", "MIN3_INT_LI", 7, 0, 0, 0) || func_394(&iLocal_632, 5000))
			{
				iLocal_174 = 2;
			}
			func_434();
...
void func_411()//Position - 0x2FD1E
{
	...
	if (func_426(1, 1093140480, 0))
	{
		...
		if (func_516(Local_110.f_28[0]))
		{
			...
			func_363(&uLocal_345, 3, Local_110.f_28[0], "MANUEL", 1, 1);
			TASK::TASK_CLEAR_LOOK_AT(Local_110.f_28[0]);
		}
		if (func_516(PLAYER::PLAYER_PED_ID()))
		{
			CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(PLAYER::PLAYER_PED_ID(), "Trevor", 0, 0, 0);
			func_363(&uLocal_345, 2, PLAYER::PLAYER_PED_ID(), "TREVOR", 1, 1);
			if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_pistol"), 0))
			{
				iLocal_191 = func_424(PLAYER::PLAYER_PED_ID(), joaat("weapon_pistol"), 1, 0, 0, 0, 0);
			}
			else if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_appistol"), 0))
			{
				iLocal_191 = func_424(PLAYER::PLAYER_PED_ID(), joaat("weapon_appistol"), 1, 0, 0, 0, 0);
			}
			else if (WEAPON::HAS_PED_GOT_WEAPON(PLAYER::PLAYER_PED_ID(), joaat("weapon_combatpistol"), 0))
			{
				iLocal_191 = func_424(PLAYER::PLAYER_PED_ID(), joaat("weapon_combatpistol"), 1, 0, 0, 0, 0);
			}
			else
			{
		...
		SYSTEM::WAIT(0);
		func_40(&(Local_110.f_41[1]));
		func_415(Local_637, Local_640, fLocal_643, Local_633, fLocal_636, func_421(), 1, 1, 1, 0, 0);
...
void func_415(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x300F0
{
	func_416(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_416(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x3011A
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_418(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x3052A
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_419(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x30820
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_424(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)//Position - 0x309AC
{
	...
	while (func_325(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_325(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_325(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_434()//Position - 0x3101C
{
	if (func_362(PLAYER::PLAYER_PED_ID(), -303.6752f, 6212.527f, 30.45596f, 2f))
	{
		...
		if (!func_276(PLAYER::PLAYER_PED_ID(), -875674219) && func_516(Local_110.f_28[0]))
		{
...
void func_440()//Position - 0x31200
{
	...
	{
		func_515(&uLocal_574);
		func_514(&uLocal_574, 468.6404f, 6547.756f, 26.09223f);
		func_514(&uLocal_574, 477.9092f, 6447.278f, 29.42946f);
		func_514(&uLocal_574, 240.0511f, 6414.416f, 30.42995f);
		func_514(&uLocal_574, 148.9169f, 6500.049f, 30.5832f);
		func_514(&uLocal_574, 229.8885f, 6546.03f, 30.67927f);
		func_513(&uLocal_574);
		if (func_549())
		{
			if (!AUDIO::IS_AUDIO_SCENE_ACTIVE("MINUTE_03_SCENE"))
...
void func_444(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x3160B
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_493(iParam6, iParam7, iParam8))
		{
			iVar0 = 0;
		}
	}
	...
	else if (iParam9 == 1)
	{
		...
		{
			func_472(iParam12, 0);
			while (!func_445(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_445(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x31793
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_469(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_469(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, Param2, fParam5, 1, 1);
				...
				func_469(iParam0, &(Var5.f_31), &(Var5.f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 1)
				{
...
void func_446(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x32579
{
	...
	if ((func_12(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_313(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_449(*iParam1);
				...
				func_447(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_447(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_447(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x33158
{
	...
	iVar0 = 0;
	while (func_448(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
void func_472(int iParam0, int iParam1)//Position - 0x35898
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_309(iParam0, iParam1))
				{
...
void func_473(struct<3> Param0, float fParam3, int iParam4)//Position - 0x35939
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_478(&(Global_67138.f_555[0 /*21*/]), iVar0))
		{
...
void func_474(int iParam0)//Position - 0x35989
{
	...
	if (func_478(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_219(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_476(0, Global_67138.f_555[0 /*21*/].f_12) || !func_476(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_475(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
void func_475(struct<54> Param0, var uParam54)//Position - 0x35AFE
{
...
int func_476(int iParam0, int iParam1)//Position - 0x35BC9
{
	...
	if (iParam0 < 0 || iParam0 >= func_477(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_457(Global_97353.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}
...
int func_478(var uParam0, int iParam1)//Position - 0x35C45
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_261(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_261(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_261(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
int func_479(struct<3> Param0, float fParam3)//Position - 0x37339
{
	return func_480(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_480(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x37353
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_489(uParam0))
	{
		...
		if (func_488(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				else if ((!func_482(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
...
int func_482(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x376C1
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_484(iParam0, Global_67138.f_139[38], 0))
			{
				func_474(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_484(iParam0, Global_67138.f_139[43], 1))
			{
				func_474(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_484(iParam0, uVar1[iVar6], 1) && func_483(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_261(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
						VEHICLE::DELETE_VEHICLE(&iParam0);
						return 1;
					}
...
int func_483(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x378C7
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_485(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x37973
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_487(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_486())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_469(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_312(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
{
	return func_488(&(Global_93588.f_2167));
}

void func_491()//Position - 0x37E30
{
	func_492(&(Global_93588.f_2167));
}
...
int func_493(int iParam0, int iParam1, int iParam2)//Position - 0x37E61
{
	...
	if (iParam2 == 0 && func_495(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
{
	return func_489(&(Global_93588.f_2167));
}
...
void func_498(struct<3> Param0, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7)//Position - 0x380A8
{
	var uVar0;
	int iVar1;
...
{
	if ((((func_516(Local_202) && func_35(iLocal_299)) && func_516(iLocal_259[0])) && func_516(iLocal_259[1])) && func_516(iLocal_259[2]))
	{
		return 1;
	}
	return 0;
...
{
	if (((((((((STREAMING::HAS_MODEL_LOADED(iLocal_278) && STREAMING::HAS_MODEL_LOADED(iLocal_277)) && STREAMING::HAS_MODEL_LOADED(func_580(iLocal_280))) && STREAMING::HAS_MODEL_LOADED(func_580(iLocal_279))) && STREAMING::HAS_MODEL_LOADED(iLocal_286)) && STREAMING::HAS_MODEL_LOADED(iLocal_289)) && STREAMING::HAS_MODEL_LOADED(iLocal_187)) && STREAMING::HAS_MODEL_LOADED(iLocal_188)) && STREAMING::HAS_MODEL_LOADED(iLocal_544)) && STREAMING::HAS_MODEL_LOADED(iLocal_550))
	{
		return 1;
	}
	return 0;
...
void func_504(struct<3> Param0, float fParam3)//Position - 0x38371
{
	...
	else
	{
		...
		func_41(&iVar0);
		func_444(&iVar1, Param0, fParam3, 1, 0, 1, 1, 1, joaat("sabregt"), 0, 145);
		func_505(&iVar1);
	}
	CAM::SET_GAMEPLAY_CAM_RELATIVE_HEADING(0f);
	CAM::SET_GAMEPLAY_CAM_RELATIVE_PITCH(0f, 1065353216);
...
{
	if (((((((((func_516(Local_196) && func_35(iLocal_281)) && func_35(iLocal_288)) && func_516(uLocal_209[0])) && func_516(uLocal_209[1])) && func_516(uLocal_209[2])) && func_516(uLocal_209[3])) && func_516(uLocal_209[4])) && ENTITY::DOES_ENTITY_EXIST(iLocal_185)) && ENTITY::DOES_ENTITY_EXIST(iLocal_186))
	{
		return 1;
	}
	return 0;
...
void func_511()//Position - 0x3874E
{
	...
	{
		TASK::OPEN_SEQUENCE_TASK(&uVar0);
		if (func_35(Local_110.f_35[1]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_110.f_35[1], -1))
		{
			TASK::TASK_ENTER_VEHICLE(0, Local_110.f_35[1], 20000, -1, 1f, 1, 0);
			TASK::TASK_VEHICLE_DRIVE_WANDER(0, Local_110.f_35[1], 20f, 786469);
		}
...
void func_512(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x38944
{
	if (func_549())
	{
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_521(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
...
{
	if (((!func_532(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_534(iParam0, Global_34913);
}
...
int func_538(var uParam0)//Position - 0x398BB
{
	...
	switch (iLocal_93)
	{
		case 0:
			...
			func_547(&(uParam0->f_48), "rcmminute3base", "base", "beckon");
		...
		case 1:
			if (!func_546(&iVar0) || !func_544(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_93 = 2;
		...
		case 2:
			...
			{
				func_543(&(uParam0->f_41[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_540(&(uParam0->f_28[0]), 59, uParam0->f_48.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
			...
			{
				func_539(&(uParam0->f_35[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
			...
			{
				func_539(&(uParam0->f_35[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.5016f);
			...
			{
				func_543(&(uParam0->f_41[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
...
void func_539(var uParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x39BE1
{
	func_41(uParam0);
...
int func_540(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x39C1C
{
...
int func_541(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x39C77
{
	int iVar0;
...
void func_543(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0x39D4B
{
	func_40(uParam0);
...
void func_558()//Position - 0x39FC6
{
	...
	func_374(&Local_196, 1, 0, 1);
	func_374(&Local_202, 1, 0, 1);
	iVar0 = 0;
	iVar0 = 0;
	while (iVar0 < 5)
	{
		if (ENTITY::DOES_ENTITY_EXIST(uLocal_209[iVar0]))
		{
			...
			{
				if (!(func_276(uLocal_209[iVar0], 713668775) || PED::IS_PED_FLEEING(uLocal_209[iVar0])))
				{
	...
	func_374(&iLocal_549, 1, 0, 1);
	if (func_516(iLocal_557))
	{
		ENTITY::SET_ENTITY_LOAD_COLLISION_FLAG(iLocal_557, 0);
	}
	func_374(&iLocal_557, 1, 0, 1);
	func_505(&iLocal_281);
	func_505(&iLocal_288);
	func_505(&iLocal_299);
	func_505(&iLocal_543);
...
int func_563()//Position - 0x3A4CB
{
	...
	iVar0 = func_356(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_565()//Position - 0x3A53F
{
	...
	{
		if (func_353(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
