...
void func_2(int iParam0, bool bParam1)//Position - 0x3AD
{
	...
	if (iVar0 < 31)
	{
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_97353.f_28192), iVar0);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_97353.f_28192), iVar0);
		}
	}
	else
	{
		...
		if (bParam1)
		{
			MISC::SET_BIT(&(Global_97353.f_28192.f_1), iVar0);
		}
		else
		{
			MISC::CLEAR_BIT(&(Global_97353.f_28192.f_1), iVar0);
		}
	}
}
...
{
	Global_68106[1 /*14*/] = { func_10(iParam0, iParam1, iParam2) };
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 0, 1);
		}
		else
		{
			func_9(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 1, 0);
		}
		return 1;
	}
	return 0;
...
void func_12(int iParam0)//Position - 0x17A7
{
	...
	switch (iParam0)
	{
		...
		default:
			func_23(iVar10, iParam0, 155);
			return;
			break;
	}
	func_13(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_103(14))
			{
				uVar0 = func_16(func_19(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_16(func_15(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_16(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
int func_16(int iParam0, int iParam1, int iParam2)//Position - 0x3514
{
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_17(iParam1)];
...
void func_23(int iParam0, int iParam1, int iParam2)//Position - 0x413A
{
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_13(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_13(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_13(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_24(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_13(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_79(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x15331
{
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			if (!bParam3 || MISC::IS_BIT_SET(Global_97353.f_5486[1], 0))
			{
				MISC::SET_BIT(&(Global_97353.f_1729.f_539.f_2708[0 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
		
		case joaat("player_two"):
			if (!bParam3 || MISC::IS_BIT_SET(Global_97353.f_5486[3], 0))
			{
				MISC::SET_BIT(&(Global_97353.f_1729.f_539.f_2708[1 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			if (!bParam3 || MISC::IS_BIT_SET(Global_97353.f_5486[4], 0))
			{
				MISC::SET_BIT(&(Global_97353.f_1729.f_539.f_2708[2 /*166*/][iParam1 /*11*/][(iParam2 / 32)]), (iParam2 % 32));
			}
			break;
	}
}
...
int func_80(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x1541A
{
	...
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 1, Global_68106[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
				...
				if (iVar0 == 1)
				{
					...
					while (iVar1 <= 14)
					{
						if ((uVar3[iVar1] != -99 && iVar1 != 12) && iVar1 != 14)
						{
							...
							{
								uVar19 = { func_81(iParam0, uVar3[iVar1]) };
								iVar2 = 0;
								while (iVar2 <= 8)
								{
									func_80(iParam0, 14, uVar19[iVar2], 1, 1);
									func_91(iParam0, 14, uVar19[iVar2], 1);
									iVar2++;
								}
							}
						}
		...
		{
			func_9(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 1, Global_68106[1 /*14*/].f_1, 0, 1);
		}
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1625A
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_24(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
...
int func_91(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x188A0
{
	...
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_9(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 0, Global_68106[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_9(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 0, Global_68106[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
bool func_93(int iParam0)//Position - 0x1896A
{
	...
	return MISC::IS_BIT_SET(Global_97353.f_8303.f_135[iVar0], uVar1);
}
...
void func_95(int iParam0, bool bParam1)//Position - 0x189A7
{
	...
	if (bParam1)
	{
		MISC::SET_BIT(&(Global_97353.f_8303.f_135[iVar0]), uVar1);
	}
	else
	{
		MISC::CLEAR_BIT(&(Global_97353.f_8303.f_135[iVar0]), iVar1);
	}
}
...
Vector3 func_101(struct<3> Param0, struct<3> Param3)//Position - 0x18C5B
{
...
bool func_105()//Position - 0x18D32
{
	...
	if (Global_97353.f_8303.f_135[1] == -1)
	{
		return 1;
	}
	...
	if (iVar0 > 0)
	{
		...
		while (iVar2 <= (iVar0 - 1))
		{
			if (Global_97353.f_8303.f_135[iVar2] != -1)
			{
				return 0;
			}
			iVar2++;
	...
	if (iVar1 == 31)
	{
		return Global_97353.f_8303.f_135[iVar0] == -1;
	}
	return Global_97353.f_8303.f_135[iVar0] == (SYSTEM::ROUND(SYSTEM::POW(2f, SYSTEM::TO_FLOAT(iVar1 + 1))) - 1);
}
...
void func_106()//Position - 0x18DC5
{
	if (bLocal_459)
	{
		...
		switch (iLocal_457)
		{
			...
			case 4:
				if ((((((iLocal_461 < MISC::GET_GAME_TIMER() || CAM::IS_SCREEN_FADED_OUT()) || !PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID())) || func_112()) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || func_110()) || func_109())
				{
