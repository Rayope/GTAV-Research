...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_91 = func_299(64);
	uLocal_92 = func_299(63);
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_277(&Var0, &Var116, 1);
	}
	if (!func_274(&iVar126, &Var0, Var61, 1f))
	{
		func_273();
	...
	while (true)
	{
		...
		func_195(Var0);
		func_188(&iLocal_107, &(Var0.f_9), Var61);
		if (Var0 == 42)
		{
		...
		if (func_185(&uLocal_95) && Var0 == 37)
		{
			func_182(Var0.f_28[1], &uLocal_95, Var0);
		}
		if (Var0 == 37)
		{
		...
		{
			func_173(&Var0, Var61, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0 == 43)
		{
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x56E6
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5D80
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x6136
{
	int iVar0;
	float fVar1;
	float fVar2;
...
int func_138(int iParam0)//Position - 0x9509
{
	...
	iVar0 = func_140(&(Global_96440[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
var func_149(struct<3> Param0, int iParam3)//Position - 0x9E1F
{
	var uVar0;
	...
	switch (iParam0->f_16)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					...
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0->f_28[0], 1), 1) < 3f)
						{
							if (func_159(2))
							{
		...
		case 1:
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_35[0]))
			{
				...
				{
					if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0->f_35[0], 1), 1) < iParam0->f_15)
					{
						if (func_159(2))
						{
							if (func_157(iParam0->f_27))
		...
		case 3:
			if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), iParam0->f_17[0 /*3*/], 1) < iParam0->f_15)
			{
				if (func_159(2))
				{
					if (func_157(iParam0->f_27))
		...
		case 4:
			if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), iParam0->f_17[0 /*3*/], iParam0->f_17[1 /*3*/], 0, 1, 0))
			{
				if (func_159(2))
				{
					if (func_157(iParam0->f_27))
		...
		case 5:
			...
			if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), iParam0->f_17[0 /*3*/], iParam0->f_17[1 /*3*/], iParam0->f_24, 0, 1, 0))
			{
				if (*iParam0 == 45)
				{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_167()) || Global_24446) || func_166()) || func_165(8, -1)) || func_163()) || func_77()) || func_164()) || func_162()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_96400) || Global_24446) || func_166()) || func_165(8, -1)) || func_77()) || func_164()) || func_162()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_167() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_165(8, -1)) || func_162()) || func_161()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_24446) || func_166()) || func_165(8, -1)) || func_164()) || func_163()) || func_162()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
...
int func_168(int iParam0)//Position - 0xB0DA
{
	...
	if (func_111(PLAYER::PLAYER_PED_ID()))
	{
		...
		while (iVar0 <= (iParam0->f_28 - 1))
		{
			...
			{
				if (func_111(iParam0->f_28[iVar0]))
				{
...
bool func_170(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0xB1DB
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_173(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xB5F6
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_28[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_177(int iParam0, struct<3> Param1, int iParam4)//Position - 0xB7AA
{
	struct<3> Var0;
...
int func_178(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, char* sParam9, var uParam10)//Position - 0xB7E3
{
	...
	if (!*uParam10 == 3)
	{
		if (func_159(2))
		{
			if (!func_128())
			{
				if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_28[0])) && func_111(iParam0->f_28[1])) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_176(&uVar0, iParam6, iParam0->f_28[0], sParam7, 0, 1);
						func_176(&uVar0, iParam8, iParam0->f_28[1], sParam9, 0, 1);
						func_174(&uVar0, cParam4, sParam5, 7, 0, 0);
						*uParam10 = 2;
					}
					else if (*uParam10 == 2)
			...
			else if (((func_180(sParam5) && !*uParam10 == 1) && func_111(PLAYER::PLAYER_PED_ID())) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_296("pause conversation");
				func_179(1);
				*uParam10 = 1;
			}
			if (func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam10 == 1)
			{
...
int func_196(var uParam0, bool bParam1)//Position - 0xC083
{
	...
	if ((func_229(*uParam0) || func_227(*uParam0)) || Global_68490 == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_201(PLAYER::PLAYER_PED_ID(), uParam0->f_35[iVar0]))
							{
...
bool func_206(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC10
{
	...
	uVar0 = func_207(&(Local_48[iVar4 /*4*/]), Var1, iParam1, &(Local_48[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_48[iVar4 /*4*/].f_3) < iParam4);
}

int func_207(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xCCD1
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xCF0C
{
	...
	{
		Var3 = { func_212(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_211(struct<3> Param0, struct<3> Param3)//Position - 0xCF9D
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_219(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xD31B
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_228() && Global_89962.f_11 == 6) && iParam0 == func_146(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_231(var uParam0)//Position - 0xD748
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_240(&(uParam0->f_48), "rcmnigel3", "base", 0);
			iLocal_90 = 1;
			break;
		
		case 1:
			if (!func_239(&iVar0) || !func_238(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			...
			{
				if (!func_235(&(uParam0->f_28[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar5 = false;
				}
			}
			...
			{
				func_233(&(uParam0->f_35[0]), iLocal_94, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_111(uParam0->f_35[0]))
				{
...
void func_233(var uParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xDA02
{
	func_234(uParam0);
...
int func_235(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xDAD9
{
...
int func_236(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xDB34
{
	int iVar0;
...
int func_241(var uParam0)//Position - 0xDC9F
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_242(42, 1);
			func_240(&(uParam0->f_48), "rcmnigel2", "base_nigel", "base_nigel");
			iVar4 = 0;
			while (iVar4 <= (iVar0 - 1))
			{
				STREAMING::REQUEST_MODEL(iVar0[iVar4]);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_235(&(uParam0->f_28[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar5 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_233(&(uParam0->f_35[0]), iLocal_94, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_111(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_35[0], 5, 0);
			...
			{
				func_233(&(uParam0->f_35[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
				if (func_111(uParam0->f_35[1]))
				{
...
int func_246(var uParam0, var uParam1)//Position - 0xE3B4
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if ((!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar8))
			{
				return 0;
			}
			iLocal_90 = 2;
...
int func_250(var uParam0)//Position - 0xEA8B
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar4))
			{
				return 0;
			}
			iLocal_90 = 2;
...
int func_251(var uParam0)//Position - 0xEDB9
{
	...
	switch (iLocal_90)
	{
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_233(&(uParam0->f_35[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (func_111(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_35[0]);
		...
		case 3:
			...
			func_233(&(uParam0->f_35[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (func_111(uParam0->f_35[1]))
			{
				VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[1], 27, 27);
			}
			func_253(&(uParam0->f_28[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			...
			func_253(&(uParam0->f_28[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			if (func_110(uParam0->f_28[1]))
			{
			...
			func_253(&(uParam0->f_28[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_110(uParam0->f_28[2]))
			{
			...
			func_252(&(uParam0->f_41[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_111(uParam0->f_41[0]))
			{
...
void func_252(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xF315
{
	func_198(uParam0);
...
void func_253(var uParam0, int iParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xF33C
{
	func_254(uParam0);
...
int func_255(var uParam0)//Position - 0xF39C
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_48))
			{
				return 0;
			}
			iLocal_90 = 2;
		...
		case 2:
			func_253(&(uParam0->f_28[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_253(&(uParam0->f_28[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (func_110(uParam0->f_28[1]))
			{
			...
			func_253(&(uParam0->f_28[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_253(&(uParam0->f_28[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_253(&(uParam0->f_28[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_253(&(uParam0->f_28[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (func_110(uParam0->f_28[2]))
			{
			...
			func_233(&(uParam0->f_35[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_111(uParam0->f_35[0]))
			{
...
int func_263(var uParam0)//Position - 0x107A7
{
	...
	switch (iLocal_90)
	{
		case 0:
			...
			func_240(&(uParam0->f_48), "rcmnigel1", "base_nigel", "base_nigel");
			func_240(&uLocal_95, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_90 = 1;
			break;
		...
		case 2:
			bVar6 = true;
			if (!func_235(&(uParam0->f_28[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar6 = false;
			}
			if (!func_235(&(uParam0->f_28[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar6 = false;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_35[0]))
			{
				func_233(&(uParam0->f_35[0]), iLocal_94, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_111(uParam0->f_35[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_35[0], 65, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_35[0], 5, 0);
		...
		case 3:
			if (func_111(uParam0->f_28[0]) && func_111(uParam0->f_28[1]))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[0], 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_28[1], 1);
...
int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0x10E34
{
	int iVar0;
...
int func_275(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0x10E99
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_276(Var1.f_6, Param1, fParam4))
	{
...
int func_276(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x10F16
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_292(var uParam0)//Position - 0x112A5
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[1]))
		{
			if (func_293(uParam0->f_28[1], 1785177548))
			{
...
void func_294(var uParam0)//Position - 0x11329
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_59))
	{
		if (func_110(uParam0->f_28[0]))
		{
			if (func_293(uParam0->f_28[0], 1785177548))
			{
