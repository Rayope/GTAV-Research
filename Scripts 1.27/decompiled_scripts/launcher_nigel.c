...
void __EntryFunction__()//Position - 0x0
{
	...
	uLocal_51 = func_299(64);
	uLocal_52 = func_299(63);
	iLocal_53 = joaat("u_m_m_aldinapoli");
	iLocal_54 = joaat("premier");
	iLocal_67 = -1;
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_178B8[Var0 /*10*/].f_9 != -1)
			{
				...
				func_295(&(Global_178B8[Var0 /*10*/].f_9));
			}
		}
		func_277(&Var0, &Var3, 1);
	}
	if (!func_274(&iVar4, &Var0, Var1, 1f))
	{
		func_273();
	...
	while (true)
	{
		...
		func_195(Var0);
		func_188(&iLocal_67, &(Var0.f_9), Var1);
		if (Var0 == 42)
		{
			if (CUTSCENE::CAN_REQUEST_ASSETS_FOR_CUTSCENE_ENTITY())
			{
				CUTSCENE::SET_CUTSCENE_PED_COMPONENT_VARIATION(func_187(), 4, 0, 0, func_186());
				func_296("Nigel 2 : set Di Napoli's cutscene trousers variation in launcher");
			}
		}
		if (func_185(&uLocal_55) && Var0 == 37)
		{
			func_182(Var0.f_1C[1], &uLocal_55, Var0);
		}
		if (Var0 == 37)
		{
			func_178(&Var0, Var1, "NIG1AAU", "NIG1A_AMB", 0, "NIGEL", 1, "MRSTHORNHILL", &uLocal_69);
		}
		else if (Var0 == 42)
		{
			func_173(&Var0, Var1, "NIG2AUD", "NIG2_AMB", 4, "NIGEL", 5000, 14f);
		}
		else if (Var0 == 43)
		{
			func_171(&Var3, &(Var0.f_23[0]), &(Var0.f_1C[1]));
			func_173(&Var0, -44.75f, -1289.86f, 29.16f, "NIGE3AU", "NIGEL3_AMB", 4, "NIGEL", 8000, 1101004800);
		}
		bVar5 = false;
		if (Var0 == 41)
		{
			if (func_169(&Var0, &uVar2) || func_168(&Var0))
			{
				bVar5 = true;
			}
		}
		else if (func_153(&Var0, 0))
		{
			bVar5 = true;
		}
		if (bVar5)
		{
			...
			if (func_1(&Var0))
			{
				func_277(&Var0, &Var3, 0);
			}
		}
	}
}

int func_1(int iParam0)//Position - 0x37B
{
...
void func_3(int iParam0, char* sParam1)//Position - 0x45B
{
	func_21(sParam1);
...
void func_4(int iParam0)//Position - 0x51A
{
	int iVar0;
	int iVar1;
...
void func_6(int iParam0)//Position - 0x727
{
	switch (iParam0)
	{
		case 2:
...
void func_7(int iParam0)//Position - 0xB0F
{
	Global_D5D7 = 1;
	Global_D5DA = 1;
	if (Global_1051D > 15)
...
void func_8(int iParam0)//Position - 0xB5A
{
...
struct<2> func_9(int iParam0)//Position - 0xB8E
{
	struct<2> Var0;
	char[] cVar1[8];
...
void func_13()//Position - 0xC80
{
	Global_D67D = 0;
}

void func_14()//Position - 0xC8C
{
	Global_D5F1 = 0;
...
var func_15(int iParam0)//Position - 0xCE0
{
	var uVar0;
...
void func_17(int iParam0)//Position - 0xD1E
{
	Global_10B99 = iParam0;
	Global_10B9A = iParam0;
}

void func_18()//Position - 0xD32
{
	int iVar0;
...
void func_21(char* sParam0)//Position - 0xDD7
{
...
void func_22(char[4] cParam0, int iParam1)//Position - 0xDEA
{
	MISC::CLEAR_BIT(&(Global_15F6A.f_14), 17);
	func_23(cParam0, iParam1, 0);
}

void func_23(char[4] cParam0, int iParam1, int iParam2)//Position - 0xE07
{
...
int func_26(var uParam0)//Position - 0x2960
{
...
void func_27(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2982
{
	int iVar0;
...
int func_28(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2A09
{
...
int func_29(int iParam0)//Position - 0x2A49
{
	int iVar0;
...
void func_30(var uParam0, int iParam1, int iParam2)//Position - 0x2A77
{
...
int func_31(int iParam0)//Position - 0x2B53
{
	int iVar0;
...
int func_32(int iParam0)//Position - 0x2B95
{
	int iVar0;
...
int func_33(int iParam0, int iParam1, int iParam2)//Position - 0x2BF8
{
	int iVar0;
...
int func_34(int iParam0, int iParam1)//Position - 0x2C86
{
	struct<58> Var0;
...
void func_35(int iParam0, var uParam1, int iParam2)//Position - 0x2CC8
{
	int iVar0;
	struct<74> Var1;
...
bool func_36(int iParam0)//Position - 0x2F40
{
	return iParam0 < 3;
}

void func_37(int iParam0, var uParam1)//Position - 0x2F4C
{
	int iVar0;
...
int func_38(int iParam0)//Position - 0x31F8
{
	switch (iParam0)
	{
		case 1:
...
int func_39(int iParam0, var uParam1, var uParam2)//Position - 0x32A8
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x3382
{
	int iVar0;
...
int func_41(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x3433
{
	char* sVar0;
...
int func_42(int iParam0, int iParam1, bool bParam2)//Position - 0x3560
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_43(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x35D1
{
...
int func_44(int iParam0)//Position - 0x36AA
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0)//Position - 0x36E7
{
	if (func_36(iParam0))
	{
...
void func_46(int iParam0, var uParam1, int iParam2)//Position - 0x3711
{
	int iVar0;
	int iVar1;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x38BB
{
	var uVar0;
	var uVar1;
...
int func_48(var uParam0)//Position - 0x38ED
{
	int iVar0;
	int iVar1;
...
int func_49()//Position - 0x3921
{
	return Global_1407E1;
}

int func_50(int iParam0, int iParam1)//Position - 0x392D
{
	var uVar0;
	var uVar1;
...
void func_51(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x3959
{
	int iVar0;
...
void func_52(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x3EA1
{
	int iVar0;
...
int func_53()//Position - 0x40E3
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_54()//Position - 0x40FC
{
	int iVar0;
...
bool func_55(int iParam0)//Position - 0x41F9
{
	return Global_8861 == iParam0;
}

void func_56(int iParam0, bool bParam1)//Position - 0x4207
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_57(int iParam0, var uParam1)//Position - 0x42FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_58(int iParam0)//Position - 0x455E
{
...
int func_59(int iParam0, int iParam1)//Position - 0x4684
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_60(int iParam0, var uParam1)//Position - 0x4EA0
{
	int iVar0;
	int iVar1;
...
int func_61(int iParam0)//Position - 0x4EDB
{
	int iVar0;
...
void func_62(int iParam0)//Position - 0x514F
{
	int iVar0;
...
void func_63(var uParam0, int iParam1)//Position - 0x518B
{
	int iVar0;
	struct<3> Var1;
	var uVar2;
...
int func_64(struct<3> Param0, char* sParam1, struct<3> Param2)//Position - 0x56E6
{
	int iVar0;
	int iVar1;
...
bool func_65(int iParam0, var uParam1, var uParam2)//Position - 0x572A
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_66(struct<3> Param0, struct<3> Param1)//Position - 0x5D80
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_67(var uParam0)//Position - 0x5DA9
{
...
bool func_68(int iParam0)//Position - 0x5E02
{
	return func_69(iParam0, 0, 1);
}

int func_69(int iParam0, int iParam1, bool bParam2)//Position - 0x5E12
{
	if (bParam2)
	{
...
int func_70(int iParam0)//Position - 0x5E72
{
	switch (iParam0)
	{
		case 0:
...
int func_71()//Position - 0x611B
{
	return Global_5F7C;
}

int func_72(int iParam0)//Position - 0x6126
{
	return func_69(iParam0, 5, 1);
}

int func_73(struct<3> Param0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x6136
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_74(int iParam0)//Position - 0x61CD
{
	switch (iParam0)
	{
		case -1:
...
int func_75(int iParam0)//Position - 0x669E
{
	return func_69(iParam0, 0, 0);
}

int func_76(int iParam0)//Position - 0x66AE
{
	switch (iParam0)
	{
		case -1:
...
bool func_77()//Position - 0x6907
{
	return Global_15F9E.f_122 > 0;
}

var func_78()//Position - 0x6918
{
	var uVar0;
...
void func_79(var uParam0, int iParam1)//Position - 0x695E
{
	if (iParam1 <= 0)
	{
		return;
...
void func_80(var uParam0, int iParam1)//Position - 0x69E4
{
...
void func_81(var uParam0, int iParam1)//Position - 0x6A17
{
	int iVar0;
	int iVar1;
...
int func_82(int iParam0, int iParam1)//Position - 0x6A68
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_83(var uParam0)//Position - 0x6B0A
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_84(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_84(bool bParam0, int iParam1, int iParam2)//Position - 0x6B2F
{
	if (bParam0)
	{
		return iParam1;
...
int func_85(var uParam0)//Position - 0x6B46
{
	return uParam0 & 15;
}

void func_86(var uParam0, int iParam1)//Position - 0x6B53
{
...
void func_87(var uParam0, int iParam1)//Position - 0x6B8D
{
...
void func_88(var uParam0, int iParam1)//Position - 0x6BC8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_89()//Position - 0x6C04
{
	func_54();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_90(int iParam0)//Position - 0x6C1D
{
	var uVar0;
	char cVar1[24];
...
void func_91(char* sParam0, var uParam1, int iParam2)//Position - 0x6C76
{
...
bool func_92(bool bParam0)//Position - 0x6CB8
{
...
struct<2> func_93(int iParam0)//Position - 0x6CE3
{
	struct<2> Var0;
...
void func_94(int iParam0, var uParam1)//Position - 0x7130
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x840B
{
	switch (iParam0)
	{
		case 0:
...
void func_98(int iParam0)//Position - 0x87F5
{
	struct<2> Var0;
...
void func_99(int iParam0)//Position - 0x8890
{
	if (iParam0 < 63)
	{
		func_100();
...
void func_101(int iParam0)//Position - 0x88EE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_102(int iParam0)//Position - 0x8947
{
...
int func_103(int iParam0)//Position - 0x89CA
{
	int iVar0;
...
void func_104(int iParam0, int iParam1, int iParam2)//Position - 0x89FB
{
	func_105(iParam0, iParam1, iParam2, 0, 0);
}

void func_105(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x8A0F
{
	int iVar0;
...
int func_107(int iParam0, int iParam1, int iParam2)//Position - 0x8AB7
{
...
int func_108(int iParam0, int iParam1, int iParam2)//Position - 0x8AD2
{
	int iVar0;
...
int func_109(int iParam0)//Position - 0x8B1E
{
	int iVar0;
...
int func_110(int iParam0)//Position - 0x8B67
{
	if (func_111(iParam0))
	{
		if (!PED::IS_PED_INJURED(iParam0))
...
int func_111(int iParam0)//Position - 0x8B87
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
...
int func_112(int iParam0)//Position - 0x8BA7
{
	switch (iParam0)
	{
		case 5:
...
int func_114(int iParam0)//Position - 0x8C77
{
	switch (iParam0)
	{
		case 5:
...
void func_115(var uParam0, int iParam1, bool bParam2)//Position - 0x8CCA
{
	int iVar0;
...
int func_116(int iParam0)//Position - 0x8DBE
{
	switch (iParam0)
	{
		case 5:
...
void func_118(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x8E65
{
	if (bParam0)
	{
...
int func_119(int iParam0)//Position - 0x8F36
{
...
bool func_120()//Position - 0x8F77
{
	return MISC::IS_BIT_SET(Global_240005, 3);
}

bool func_121(int iParam0, int iParam1)//Position - 0x8F88
{
	bool bVar0;
...
int func_122(int iParam0, bool bParam1)//Position - 0x8FD3
{
	int iVar0;
	int iVar1;
...
void func_124(int iParam0)//Position - 0x903B
{
	if (iParam0 == 1)
	{
...
int func_125(char* sParam0)//Position - 0x905E
{
...
void func_126()//Position - 0x909B
{
	Global_38DE = 0;
	func_127();
}

void func_127()//Position - 0x90AB
{
...
int func_131(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x918F
{
...
void func_134(int iParam0)//Position - 0x938A
{
	if (Global_38D7)
	{
		func_135(0, 0);
...
void func_135(bool bParam0, bool bParam1)//Position - 0x93FA
{
	if (bParam0)
	{
		if (func_136(0))
...
int func_136(int iParam0)//Position - 0x946E
{
	if (iParam0 == 1)
	{
		if (Global_3839.f_1 > 3)
...
int func_137(int iParam0)//Position - 0x94C8
{
...
int func_138(int iParam0)//Position - 0x9509
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0x954E
{
...
int func_140(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x9580
{
	int iVar0;
...
void func_141(var uParam0, int iParam1)//Position - 0x96B7
{
	int iVar0;
...
bool func_142(int iParam0)//Position - 0x9706
{
	return func_143(iParam0, Global_8861);
}

int func_143(int iParam0, int iParam1)//Position - 0x9717
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_144(int iParam0)//Position - 0x98F8
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_145()//Position - 0x991A
{
	return func_146(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_146(var uParam0, int iParam1)//Position - 0x992B
{
	int iVar0;
	var uVar1;
	int iVar2;
...
void func_148(int iParam0, var uParam1)//Position - 0x9998
{
	switch (iParam0)
	{
		case 0:
...
var func_149(struct<3> Param0, int iParam1)//Position - 0x9E1F
{
	var uVar0;
...
float func_150(bool bParam0, float fParam1, float fParam2)//Position - 0x9E4B
{
	if (bParam0)
	{
		return fParam1;
...
int func_151(int iParam0)//Position - 0x9E62
{
	switch (iParam0)
	{
		case 0:
...
int func_152(int iParam0, int iParam1, int iParam2)//Position - 0x9EF1
{
	int iVar0;
...
int func_153(int iParam0, int iParam1)//Position - 0x9F22
{
	switch (iParam0->f_10)
	{
		case 0:
			if (*iParam0 == 12)
			{
				if (ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, 1, 0))
				{
					if (func_111(iParam0->f_1C[0]))
					{
						if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), ENTITY::GET_ENTITY_COORDS(iParam0->f_1C[0], 1), 1) < 3f)
						{
							if (func_159(2))
							{
								if (func_157(iParam0->f_1B))
								{
									func_156(iParam0->f_1B, *iParam0);
				...
				else if (func_111(iParam0->f_1C[0]))
				{
					if (func_155(iParam0))
					{
						if (func_159(2))
...
void func_154()//Position - 0xA704
{
	func_27(&(Global_164D7.f_877), &Global_164D7, 0, 1, 1, 0);
}

int func_155(var uParam0)//Position - 0xA71F
{
	float fVar0;
...
void func_156(int iParam0, int iParam1)//Position - 0xA7AD
{
	if (iParam0 == 1)
	{
		if (!func_114(iParam1))
...
int func_157(bool bParam0)//Position - 0xA810
{
	int iVar0;
...
int func_158(int iParam0)//Position - 0xA8A7
{
	if (func_111(uParam0))
	{
...
int func_159(int iParam0)//Position - 0xA8D1
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_17890) || Global_5F7E) || func_166()) || func_165(8, -1)) || func_77()) || func_164()) || func_163()) || func_162()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_167()) || Global_5F7E) || func_166()) || func_165(8, -1)) || func_163()) || func_77()) || func_164()) || func_162()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_17890) || Global_5F7E) || func_166()) || func_165(8, -1)) || func_163()) || func_77()) || func_164()) || func_162()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_167()) || Global_17890) || Global_5F7E) || func_166()) || func_165(8, -1)) || func_77()) || func_164()) || func_162()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_167() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_165(8, -1)) || func_162()) || func_161()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_5F7E) || func_166()) || func_165(8, -1)) || func_164()) || func_163()) || func_162()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_167()) || Global_17890) || Global_5F7E) || func_166()) || func_165(8, -1)) || func_163()) || func_161()) || func_77()) || func_164()) || func_162())
						{
							return 0;
						}
						break;
...
var func_160()//Position - 0xAFEE
{
	return Global_15F91.f_1;
}

int func_161()//Position - 0xAFFC
{
	if (Global_154F9 != -1)
	{
...
bool func_164()//Position - 0xB066
{
	return Global_15F9E.f_123 > 0;
}

bool func_165(int iParam0, int iParam1)//Position - 0xB077
{
	switch (iParam0)
	{
		case 5:
...
var func_166()//Position - 0xB0B2
{
	return Global_14143C;
}

int func_167()//Position - 0xB0BE
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
...
int func_168(int iParam0)//Position - 0xB0DA
{
	...
	if (func_111(PLAYER::PLAYER_PED_ID()))
	{
		...
		{
			if (ENTITY::DOES_ENTITY_EXIST(iParam0->f_1C[iVar0]))
			{
				if (func_111(iParam0->f_1C[iVar0]))
				{
					if (ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(iParam0->f_1C[iVar0], PLAYER::PLAYER_PED_ID(), 1) || MISC::IS_BULLET_IN_AREA(ENTITY::GET_ENTITY_COORDS(iParam0->f_1C[iVar0], 1), 7.5f, 1))
					{
						if (func_159(2))
						{
							func_156(iParam0->f_1B, *iParam0);
						...
						{
							func_296("Player damaged the N1D peds but it's not safe to trigger the mission!");
						}
					}
				}
				else if (func_159(2))
				...
				{
					func_296("Player killed a N1D ped but it's not safe to trigger the mission!");
				}
			}
			iVar0++;
		}
...
{
	if (func_170(uParam1, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		if (func_159(2))
		{
			if (func_157(iParam0->f_1B))
...
bool func_170(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0xB1DB
{
	bool bVar0;
	int iVar1;
	int iVar2;
		...
		switch (*iParam0)
		{
			...
			case 1:
				if ((MISC::GET_GAME_TIMER() - iParam0->f_2) > iParam0->f_3)
				{
					...
					AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(*uParam2, "NIGE3_CXAA", "DINAPOLI", func_172(0), 0);
...
int func_172(int iParam0)//Position - 0xB401
{
	int iVar0;
...
int func_173(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xB5F6
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_1C[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_3C) > iParam6) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam7)
	{
		uVar0 = 16;
		func_176(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
		func_174(&uVar0, cParam2, sParam3, 7, 0, 0);
...
void func_174(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB67E
{
...
void func_175(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB6B9
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_176(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xB70F
{
...
float func_177(int iParam0, struct<3> Param1, int iParam2)//Position - 0xB7AA
{
	struct<3> Var0;
...
int func_178(int iParam0, struct<3> Param1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xB7E3
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_159(2))
		{
			if (!func_128())
			{
				if (((func_111(PLAYER::PLAYER_PED_ID()) && func_111(iParam0->f_1C[0])) && func_111(iParam0->f_1C[1])) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f)
				{
					...
					{
						func_176(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
						func_176(&uVar0, iParam6, iParam0->f_1C[1], sParam7, 0, 1);
						func_174(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
			...
			else if (((func_180(sParam3) && !*uParam8 == 1) && func_111(PLAYER::PLAYER_PED_ID())) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) >= 20f)
			{
				func_296("pause conversation");
				func_179(1);
				*uParam8 = 1;
			}
			if (func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < 20f && *uParam8 == 1)
			{
...
void func_179(int iParam0)//Position - 0xB92E
{
	Global_413F = iParam0;
}

int func_180(char* sParam0)//Position - 0xB93B
{
	struct<6> Var0;
...
struct<6> func_181()//Position - 0xB95B
{
	struct<6> Var0;
...
void func_182(int iParam0, var uParam1, int iParam2)//Position - 0xB97F
{
	var uVar0;
	var uVar1;
...
int func_183(int iParam0)//Position - 0xBCD4
{
...
int func_184(var uParam0)//Position - 0xBCF4
{
...
int func_185(var uParam0)//Position - 0xBD0C
{
...
void func_188(int iParam0, char* sParam1, struct<3> Param2)//Position - 0xBD4A
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
...
void func_189(int iParam0, bool bParam1)//Position - 0xBE3B
{
	if (iParam0 == -1)
	{
		return;
...
int func_190(int iParam0)//Position - 0xBE77
{
	if (Global_10A91 == iParam0)
	{
		if (Global_10A92 == -1)
...
void func_191(int iParam0, int iParam1)//Position - 0xBEB0
{
	bool bVar0;
	int iVar1;
...
bool func_192()//Position - 0xBF4E
{
	return Global_1567C;
}

void func_193(int iParam0)//Position - 0xBF5A
{
	CUTSCENE::STOP_CUTSCENE(0);
	CUTSCENE::REMOVE_CUTSCENE();
	func_194(iParam0);
...
void func_194(int iParam0)//Position - 0xBF71
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_195(int iParam0)//Position - 0xC05B
{
	if (iParam0 == -1)
	{
		iParam0 = func_145();
...
int func_196(var uParam0, bool bParam1)//Position - 0xC083
{
	...
	if ((func_229(*uParam0) || func_227(*uParam0)) || Global_10B8A == 1)
	{
		return 1;
	}
	if (!BRAIN::IS_WORLD_POINT_WITHIN_BRAIN_ACTIVATION_RANGE())
...
void func_197(var uParam0)//Position - 0xC2F6
{
	int iVar0;
	var uVar1;
...
void func_198(var uParam0)//Position - 0xC5FA
{
...
void func_199(var uParam0)//Position - 0xC625
{
	int iVar0;
...
int func_200(var uParam0, bool bParam1, bool bParam2)//Position - 0xC6A5
{
	int iVar0;
	int iVar1;
	var uVar2;
			...
			if (ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_201(PLAYER::PLAYER_PED_ID(), uParam0->f_23[iVar0]))
							{
...
int func_201(int iParam0, int iParam1)//Position - 0xC862
{
	int iVar0;
...
int func_203(int iParam0)//Position - 0xCB4E
{
...
int func_204(int iParam0, float fParam1)//Position - 0xCB82
{
	...
	{
		if (func_215(iParam0) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), iParam0))
		{
...
bool func_206(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC10
{
	...
	uVar0 = func_207(&(Local_48[iVar2 /*4*/]), Var1, iParam1, &(Local_48[iVar2 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_48[iVar2 /*4*/].f_3) < iParam4);
}

int func_207(var uParam0, struct<3> Param1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xCCD1
{
	var uVar0;
	struct<3> Var1;
	var uVar2;
...
Vector3 func_208(int iParam0, int iParam1)//Position - 0xCDFD
{
	int iVar0;
...
int func_210(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xCF0C
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_212(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
	...
	{
		Var1 = { func_212(PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 5f, 0f) - PED::GET_PED_BONE_COORDS(iParam0, 31086, 0f, 0f, 0f)) };
	}
	fVar2 = func_211(Var1, Var0);
...
float func_211(struct<3> Param0, struct<3> Param1)//Position - 0xCF9D
{
	return (((Param0.x * Param1.x) + (Param0.f_1 * Param1.f_1)) + (Param0.f_2 * Param1.f_2));
}

Vector3 func_212(struct<3> Param0)//Position - 0xCFBE
{
	float fVar0;
	float fVar1;
...
void func_213(var uParam0)//Position - 0xCFFD
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_215(var uParam0)//Position - 0xD057
{
...
int func_216(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD07F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_217(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xD17A
{
	struct<3> Var0;
	struct<3> Var1;
...
int func_218(var uParam0, float fParam1)//Position - 0xD286
{
	var uVar0;
	struct<3> Var1;
...
int func_219(int iParam0, struct<3> Param1, float fParam2, int iParam3)//Position - 0xD31B
{
	struct<3> Var0;
	struct<3> Var1;
	float fVar2;
	
	Var0 = { func_212(Param1 - ENTITY::GET_ENTITY_COORDS(uParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_220(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xD3A9
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
int func_221(int iParam0)//Position - 0xD3F1
{
...
void func_222(int iParam0)//Position - 0xD43B
{
	var uVar0;
...
int func_223(int iParam0)//Position - 0xD4D8
{
	if (iParam0 == -1)
	{
		iParam0 = func_145();
...
int func_224(int iParam0)//Position - 0xD570
{
...
int func_227(int iParam0)//Position - 0xD5F2
{
	if ((func_228() && Global_15F6A.f_B == 6) && iParam0 == func_146(&(Global_15F6A.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_229(int iParam0)//Position - 0xD664
{
	if (func_92(0))
	{
...
int func_231(var uParam0)//Position - 0xD748
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_240(&(uParam0->f_30), "rcmnigel3", "base", 0);
			iLocal_50 = 1;
			break;
		
		case 1:
			if (!func_239(&iVar0) || !func_238(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			{
				if (!func_235(&(uParam0->f_1C[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_233(&(uParam0->f_23[0]), iLocal_54, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_111(uParam0->f_23[0]))
				{
			...
			if (!func_232(&(uParam0->f_1C[1]), &(uParam0->f_23[0])))
			{
				bVar2 = false;
			}
			if (bVar2)
...
int func_232(var uParam0, var uParam1)//Position - 0xD92F
{
	...
	if (ENTITY::DOES_ENTITY_EXIST(*uParam1) && STREAMING::HAS_MODEL_LOADED(iLocal_53))
	{
		*uParam0 = PED::CREATE_PED(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, 1);
		...
		ENTITY::SET_ENTITY_ROTATION(*uParam0, Var1, 2, 1);
...
void func_233(var uParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0xDA02
{
	func_234(uParam0);
...
void func_234(var uParam0)//Position - 0xDA3D
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_235(var uParam0, int iParam1, struct<3> Param2, float fParam3, char* sParam4, int iParam5)//Position - 0xDAD9
{
	if (func_236(uParam0, iParam1, Param2, fParam3, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_236(var uParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4)//Position - 0xDB34
{
	int iVar0;
...
int func_237(var uParam0, int iParam1)//Position - 0xDBC2
{
	int iVar0;
...
int func_238(var uParam0)//Position - 0xDC08
{
	if (func_185(uParam0))
	{
...
int func_239(int iParam0)//Position - 0xDC32
{
	int iVar0;
...
void func_240(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xDC63
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_241(var uParam0)//Position - 0xDC9F
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_242(42, 1);
			func_240(&(uParam0->f_30), "rcmnigel2", "base_nigel", "base_nigel");
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::REQUEST_MODEL(iVar0[iVar1]);
		...
		case 2:
			...
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_1C[0]))
			{
				if (!func_235(&(uParam0->f_1C[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_233(&(uParam0->f_23[0]), iLocal_54, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_111(uParam0->f_23[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_23[0], 65, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_23[0], 5, 0);
			...
			{
				func_233(&(uParam0->f_23[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
				if (func_111(uParam0->f_23[1]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_23[1], 0, 0);
					VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[1], 10);
				}
			}
			if (bVar2)
			{
...
void func_242(int iParam0, bool bParam1)//Position - 0xDEBA
{
	switch (iParam0)
	{
		...
		case 38:
			if (bParam1)
			{
				uLocal_66 = PED::ADD_SCENARIO_BLOCKING_AREA(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_GUARD_STAND", 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_HUMAN_CLIPBOARD", 0);
				TASK::SET_SCENARIO_TYPE_ENABLED("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				uLocal_66 = PED::ADD_SCENARIO_BLOCKING_AREA(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				uLocal_66 = PED::ADD_SCENARIO_BLOCKING_AREA(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				uLocal_66 = PED::ADD_SCENARIO_BLOCKING_AREA(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
void func_243(bool bParam0)//Position - 0xE2CC
{
	struct<3> Var0;
	struct<3> Var1;
	struct<3> Var2;
...
int func_246(var uParam0, var uParam1)//Position - 0xE3B4
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_249(uParam1);
			func_248(uParam1, -1313.714f, -27.2202f, 48.0314f);
			func_248(uParam1, -1294.066f, -27.0136f, 47.5724f);
			func_248(uParam1, -1069.844f, -143.769f, 39.7493f);
			func_248(uParam1, -925.2529f, -89.9079f, 38.3457f);
			func_248(uParam1, -1010.948f, 40.0643f, 49.9277f);
			func_248(uParam1, -1122.838f, 233.7037f, 64.7587f);
			func_248(uParam1, -1282.578f, 188.8798f, 59.2769f);
			func_248(uParam1, -1328.153f, 192.0178f, 57.8136f);
			func_248(uParam1, -1386.75f, 167.32f, 57.11f);
			func_248(uParam1, -1411.5f, 109.64f, 51.49f);
			func_248(uParam1, -1379.52f, 111.05f, 54.28f);
			func_248(uParam1, -1371.77f, 24.07f, 52.88f);
			func_248(uParam1, -1342.27f, 16.92f, 52.16f);
			func_247(uParam1);
			iVar2 = 0;
			while (iVar2 <= (iVar0 - 1))
			{
		...
		case 1:
			if ((!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_30)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar1))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			...
			PED::SET_PED_PROP_INDEX(uParam0->f_1C[0], 0, 0, 0, 0);
...
void func_247(var uParam0)//Position - 0xE993
{
	int iVar0;
	float fVar1;
...
void func_248(var uParam0, struct<3> Param1)//Position - 0xEA33
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_249(var uParam0)//Position - 0xEA64
{
	if (uParam0->f_33)
	{
	}
...
int func_250(var uParam0)//Position - 0xEA8B
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			uParam0->f_1C[0] = PED::CREATE_PED(26, iVar0[0], -626.87f, -268.85f, 38f, 121f, 1, 1);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 0, 1, 1, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 2, 1, 2, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 3, 0, 0, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[0], 4, 0, 0, 0);
			PED::SET_PED_COMBAT_ATTRIBUTES(uParam0->f_1C[0], 17, 1);
			...
			TASK::TASK_PERFORM_SEQUENCE(uParam0->f_1C[0], uVar3);
			TASK::CLEAR_SEQUENCE_TASK(&uVar3);
			uParam0->f_1C[1] = PED::CREATE_PED(26, iVar0[1], -627.4f, -267.12f, 38.23f, -59.95f, 1, 1);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 3, 0, 3, 0);
			PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 4, 0, 1, 0);
			PED::SET_PED_CONFIG_FLAG(uParam0->f_1C[1], 132, 1);
			ENTITY::SET_ENTITY_ONLY_DAMAGED_BY_PLAYER(uParam0->f_1C[1], 1);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				STREAMING::SET_MODEL_AS_NO_LONGER_NEEDED(iVar0[iVar1]);
...
int func_251(var uParam0)//Position - 0xEDB9
{
	...
	switch (iLocal_50)
	{
		...
		case 1:
			if ((!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_30)) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_233(&(uParam0->f_23[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (func_111(uParam0->f_23[0]))
				{
					VEHICLE::SET_VEHICLE_ON_GROUND_PROPERLY(uParam0->f_23[0]);
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_23[0], 97, 97);
					VEHICLE::SET_VEHICLE_DIRT_LEVEL(uParam0->f_23[0], 13.5f);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_23[0], 2, 0);
					VEHICLE::SET_VEHICLE_DOOR_OPEN(uParam0->f_23[0], 2, 0, 1);
					VEHICLE::SET_VEHICLE_DOOR_CONTROL(uParam0->f_23[0], 2, 0, 1f);
					ENTITY::FORCE_ENTITY_AI_AND_ANIMATION_UPDATE(uParam0->f_23[0]);
					return 0;
				}
			}
			if (func_111(uParam0->f_23[0]))
			{
				fVar3 = VEHICLE::GET_VEHICLE_DOOR_ANGLE_RATIO(uParam0->f_23[0], 2);
				if (!VEHICLE::IS_VEHICLE_DOOR_FULLY_OPEN(uParam0->f_23[0], 2) && fVar3 < 0.8f)
				{
					VEHICLE::SET_VEHICLE_DOOR_CONTROL(uParam0->f_23[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_111(uParam0->f_23[0]))
			{
				if (!ENTITY::IS_ENTITY_PLAYING_ANIM(uParam0->f_23[0], sVar2, "idle_speedo", 3))
				{
					if (STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
					{
						TASK::TASK_VEHICLE_PLAY_ANIM(uParam0->f_23[0], sVar2, "idle_speedo");
						return 0;
					}
					else
					{
			...
			func_233(&(uParam0->f_23[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (func_111(uParam0->f_23[1]))
			{
				VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_23[1], 27, 27);
			}
			func_253(&(uParam0->f_1C[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_110(uParam0->f_1C[0]))
			{
				PED::SET_PED_DIES_IN_WATER(uParam0->f_1C[0], 0);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_1C[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				ENTITY::SET_ENTITY_HEADING(uParam0->f_1C[0], 23.67f);
				TASK::TASK_PLAY_ANIM(uParam0->f_1C[0], sVar2, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			func_253(&(uParam0->f_1C[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			if (func_110(uParam0->f_1C[1]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 0, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 2, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 3, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 4, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 8, 0, 1, 0);
				PED::SET_PED_DIES_IN_WATER(uParam0->f_1C[1], 0);
				uParam0->f_3B = PED::CREATE_SYNCHRONIZED_SCENE(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				PED::SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_3B, 1);
				PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uParam0->f_3B, 0);
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[1], uParam0->f_3B, uParam0->f_30, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_253(&(uParam0->f_1C[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_110(uParam0->f_1C[2]))
			{
				PED::SET_PED_DEFAULT_COMPONENT_VARIATION(uParam0->f_1C[2]);
				ENTITY::SET_ENTITY_COORDS_NO_OFFSET(uParam0->f_1C[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				ENTITY::SET_ENTITY_HEALTH(uParam0->f_1C[2], 160);
				if (STREAMING::HAS_ANIM_DICT_LOADED(sVar2))
				{
					TASK::TASK_PLAY_ANIM(uParam0->f_1C[2], sVar2, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_252(&(uParam0->f_29[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_111(uParam0->f_29[0]))
			{
				ENTITY::SET_ENTITY_ROTATION(uParam0->f_29[0], 0f, 0f, -11.27f, 2, 1);
				ENTITY::SET_ENTITY_CAN_BE_DAMAGED(uParam0->f_29[0], 0);
				ENTITY::SET_ENTITY_INVINCIBLE(uParam0->f_29[0], 1);
				ENTITY::SET_CAN_AUTO_VAULT_ON_ENTITY(uParam0->f_29[0], 0);
			...
			STREAMING::REMOVE_ANIM_DICT(uParam0->f_30);
...
void func_252(var uParam0, var uParam1, struct<3> Param2, float fParam3)//Position - 0xF315
{
	func_198(uParam0);
...
void func_253(var uParam0, int iParam1, struct<3> Param2, float fParam3, int iParam4)//Position - 0xF33C
{
	func_254(uParam0);
	*uParam0 = PED::CREATE_PED(iParam4, uParam1, Param2, fParam3, 0, 0);
}

void func_254(var uParam0)//Position - 0xF35D
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (!ENTITY::IS_ENTITY_DEAD(*uParam0))
...
int func_255(var uParam0)//Position - 0xF39C
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			uParam0->f_1B = 1;
			func_256(4, 0);
			func_296(" SetupScene_NIGEL_1A - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, FALSE)	");
			uParam0->f_30 = "rcmnigel1aig_1";
			uParam0->f_3B = -1;
			func_242(38, 1);
			uVar2 = INTERIOR::GET_INTERIOR_AT_COORDS_WITH_TYPE(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
		...
		case 1:
			if (!func_239(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(uParam0->f_30))
			{
				return 0;
			}
			iLocal_50 = 2;
		...
		case 2:
			func_253(&(uParam0->f_1C[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_253(&(uParam0->f_1C[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (func_110(uParam0->f_1C[1]))
			{
				PED::SET_PED_CAN_BE_TARGETTED(uParam0->f_1C[1], 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 0, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 2, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 3, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 4, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 7, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[1], 8, 1, 0, 0);
			}
			uParam0->f_3B = PED::CREATE_SYNCHRONIZED_SCENE(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			PED::SET_SYNCHRONIZED_SCENE_LOOPED(uParam0->f_3B, 1);
			PED::SET_SYNCHRONIZED_SCENE_HOLD_LAST_FRAME(uParam0->f_3B, 0);
			if (func_110(uParam0->f_1C[0]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[0], uParam0->f_3B, uParam0->f_30, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_110(uParam0->f_1C[1]))
			{
				TASK::TASK_SYNCHRONIZED_SCENE(uParam0->f_1C[1], uParam0->f_3B, uParam0->f_30, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			func_253(&(uParam0->f_1C[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_253(&(uParam0->f_1C[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_253(&(uParam0->f_1C[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_253(&(uParam0->f_1C[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (func_110(uParam0->f_1C[2]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 0, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 2, 1, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 3, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 4, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 7, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[2], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_1C[3]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[3], 0, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[3], 2, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[3], 3, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[3], 4, 1, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[3], 7, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[3], 8, 1, 0, 0);
			}
			if (func_110(uParam0->f_1C[4]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[4], 0, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[4], 2, 0, 2, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[4], 3, 0, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[4], 4, 0, 1, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[4], 8, 0, 0, 0);
			}
			if (func_110(uParam0->f_1C[5]))
			{
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[5], 0, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[5], 2, 2, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[5], 3, 0, 3, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[5], 4, 1, 0, 0);
				PED::SET_PED_COMPONENT_VARIATION(uParam0->f_1C[5], 8, 0, 2, 0);
			}
			func_233(&(uParam0->f_23[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_111(uParam0->f_23[0]))
			{
				VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uParam0->f_23[0], 1);
				VEHICLE::SET_VEHICLE_DOORS_LOCKED(uParam0->f_23[0], 1);
				ENTITY::SET_CAN_AUTO_VAULT_ON_ENTITY(uParam0->f_23[0], 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_256(int iParam0, bool bParam1)//Position - 0xF8EA
{
	char* sVar0;
	int iVar1;
...
int func_257(int iParam0)//Position - 0xF990
{
	struct<2> Var0;
...
struct<2> func_258(var uParam0)//Position - 0xF9B9
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_259(int iParam0, bool bParam1)//Position - 0xFA0B
{
	struct<2> Var0;
...
var func_260(int iParam0, int iParam1)//Position - 0xFA43
{
	struct<5> Var0;
...
struct<5> func_261(int iParam0)//Position - 0xFA68
{
	struct<5> Var0;
	struct<3> Var1;
...
struct<6> func_262(int iParam0)//Position - 0x10329
{
	struct<6> Var0;
...
int func_263(var uParam0)//Position - 0x107A7
{
	...
	switch (iLocal_50)
	{
		case 0:
			...
			func_240(&(uParam0->f_30), "rcmnigel1", "base_nigel", "base_nigel");
			func_240(&uLocal_55, "rcmnigel1", "base_mrs_thornhill", "base_mrs_thornhill");
			iLocal_50 = 1;
			break;
		...
		case 2:
			bVar3 = true;
			if (!func_235(&(uParam0->f_1C[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar3 = false;
			}
			if (!func_235(&(uParam0->f_1C[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar3 = false;
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_23[0]))
			{
				func_233(&(uParam0->f_23[0]), iLocal_54, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_111(uParam0->f_23[0]))
				{
					VEHICLE::SET_VEHICLE_COLOURS(uParam0->f_23[0], 65, 0);
					VEHICLE::_SET_VEHICLE_DOOR_CAN_BREAK(uParam0->f_23[0], 5, 0);
		...
		case 3:
			if (func_111(uParam0->f_1C[0]) && func_111(uParam0->f_1C[1]))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_1C[0], 1);
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uParam0->f_1C[1], 1);
...
int func_264(int iParam0)//Position - 0x10A48
{
	struct<27> Var0;
	int iVar1;
...
int func_265(int iParam0)//Position - 0x10A9C
{
	char* sVar0;
...
int func_266(int iParam0)//Position - 0x10B33
{
	var uVar0;
...
int func_267(int iParam0)//Position - 0x10BF4
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_268(int iParam0, char* sParam1)//Position - 0x10C79
{
...
bool func_269(int iParam0)//Position - 0x10D5B
{
...
bool func_270(int iParam0)//Position - 0x10D89
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_271(int iParam0)//Position - 0x10DB7
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_272(int iParam0)//Position - 0x10DE5
{
	if (func_224(iParam0))
	{
		return 0;
...
void func_273()//Position - 0x10E1A
{
	func_296("Running end routines.");
	Global_17B2F = (Global_17B2F - 1);
}

int func_274(int iParam0, int iParam1, struct<3> Param2, float fParam3)//Position - 0x10E34
{
	int iVar0;
...
int func_275(int iParam0, struct<3> Param1, float fParam2, var uParam3)//Position - 0x10E99
{
	int iVar0;
	struct<7> Var1;
	...
	if (func_276(Var1.f_6, Param1, fParam2))
	{
...
int func_276(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x10F16
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_277(int iParam0, int iParam1, bool bParam2)//Position - 0x10F62
{
	...
	if (bParam2)
	{
		...
		if (*iParam0 == 38)
		{
			func_256(4, 1);
			func_294(iParam0);
			func_296(" Script_Cleanup - SET_INTERIOR_CAPPED(INTERIOR_V_ROCKCLUB, TRUE)");
		}
		else if (*iParam0 == 39)
		{
			func_292(iParam0);
...
void func_278(char* sParam0)//Position - 0x1104C
{
...
void func_279()//Position - 0x1106B
{
	Global_38DE = 0;
	func_280();
}

void func_280()//Position - 0x1107B
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_413F = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
int func_281(var uParam0)//Position - 0x1109C
{
	if (func_185(uParam0))
	{
		if (STREAMING::HAS_ANIM_DICT_LOADED(*uParam0))
...
void func_282(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x110D2
{
...
void func_283(var uParam0, bool bParam1)//Position - 0x110F2
{
	func_284(&(uParam0->f_29), bParam1);
}

void func_284(var uParam0, bool bParam1)//Position - 0x11104
{
	int iVar0;
...
void func_285(var uParam0, bool bParam1)//Position - 0x11142
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_286(var uParam0, bool bParam1)//Position - 0x1117D
{
	func_287(&(uParam0->f_23), bParam1);
}

void func_287(var uParam0, bool bParam1)//Position - 0x1118F
{
	int iVar0;
...
void func_288(var uParam0)//Position - 0x111CC
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_289(var uParam0, int iParam1)//Position - 0x11203
{
	func_290(&(uParam0->f_1C), iParam1);
}

void func_290(var uParam0, int iParam1)//Position - 0x11215
{
	int iVar0;
...
void func_291(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11256
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_292(var uParam0)//Position - 0x112A5
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_3B))
	{
		if (func_110(uParam0->f_1C[1]))
		{
			if (func_293(uParam0->f_1C[1], 1785177548))
			{
				TASK::CLEAR_PED_TASKS(uParam0->f_1C[1]);
			}
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_1C[1], -1000f, 1);
		}
	}
}

int func_293(int iParam0, int iParam1)//Position - 0x112F6
{
	if (func_110(uParam0))
	{
...
void func_294(var uParam0)//Position - 0x11329
{
	if (PED::IS_SYNCHRONIZED_SCENE_RUNNING(uParam0->f_3B))
	{
		if (func_110(uParam0->f_1C[0]))
		{
			if (func_293(uParam0->f_1C[0], 1785177548))
			{
				TASK::CLEAR_PED_TASKS(uParam0->f_1C[0]);
			}
			ENTITY::STOP_SYNCHRONIZED_ENTITY_ANIM(uParam0->f_1C[0], -1000f, 1);
		}
		if (func_110(uParam0->f_1C[1]))
		{
			if (func_293(uParam0->f_1C[1], 1785177548))
...
void func_295(var uParam0)//Position - 0x113B8
{
	if (*uParam0 == -1)
	{
		return;
...
void func_296(char* sParam0)//Position - 0x113F5
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_297(var uParam0)//Position - 0x11407
{
	*uParam0 = -1;
...
void func_298()//Position - 0x1143A
{
	func_296("Running start routines.");
	Global_17B2F++;
}

int func_299(int iParam0)//Position - 0x11454
{
	if (!func_36(iParam0))
	{
		return Global_17C49.f_744E[iParam0 /*29*/];
