...
void func_1(float fParam0, float fParam1, char* sParam2, int iParam3)//Position - 0xD5
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_TEXT(sParam2);
	HUD::END_TEXT_COMMAND_DISPLAY_TEXT(fParam0, fParam1, iParam3);
}

void func_2()//Position - 0xED
{
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_3()//Position - 0xF9
{
	int iVar0;
	...
	if (Global_17C49.f_1CAD || func_18(0))
	{
		if (!func_17())
		{
			iVar0 = func_16();
...
int func_5()//Position - 0x24F
{
	func_6();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_6()//Position - 0x268
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_10(Global_17C49.f_6C1.f_21B.f_C8D) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_9(PLAYER::PLAYER_PED_ID());
			if (func_8(iVar0) && (!func_7(14) || Global_17832))
			{
...
bool func_7(int iParam0)//Position - 0x365
{
	return Global_8861 == iParam0;
}

bool func_8(int iParam0)//Position - 0x373
{
	return iParam0 < 3;
}

int func_9(var uParam0)//Position - 0x37F
{
	int iVar0;
	int iVar1;
...
int func_10(int iParam0)//Position - 0x3BC
{
	if (func_8(iParam0))
	{
...
int func_11(int iParam0)//Position - 0x3E6
{
	int iVar0;
	int iVar1;
	...
	func_12(&(Global_17C49.f_6C1.f_21B), iVar1);
...
void func_12(var uParam0, int iParam1)//Position - 0x4FD
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			Var2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_14(Global_17C49.f_4193[iVar0], &Var2, &fVar3))
			{
				Global_17C49.f_4193[iVar0] = 318;
				func_13(&(uParam0->f_5F4[iVar0]));
...
void func_13(var uParam0)//Position - 0x6C6
{
	*uParam0 = -15;
}

int func_14(int iParam0, var uParam1, float fParam2)//Position - 0x6D4
{
	switch (iParam0)
	{
		case 11:
...
void func_15(int iParam0, bool bParam1)//Position - 0x1043
{
	if (bParam1)
	{
...
bool func_18(bool bParam0)//Position - 0x10F4
{
