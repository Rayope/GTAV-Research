...
void __EntryFunction__()//Position - 0x0
{
	...
	func_36();
	func_35(&uLocal_86, 8, 0, "TANNOY", 0, 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_34();
					...
					else
					{
						if (iLocal_57)
						{
							...
							while (iLocal_67 < 8)
							{
								...
								{
									if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_67 + 1, 0, 0))
									{
							...
							if (func_29(iLocal_36, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)))
							{
								...
								if (func_28(iLocal_36))
								{
									...
									if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Local_71)) == 0)
									{
										...
										{
											func_26(iLocal_36, Global_24657[iLocal_36]);
										}
									}
								}
										...
										if (!bLocal_55)
										{
											if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_36, 0, 0))
											{
												...
												else if (iLocal_36 != 4)
												{
													if (!iLocal_56)
													{
														if (func_1(&uLocal_86, "FH1AUD", "FH1_TANNOY", 8, 0, 0, 0))
														{
															iLocal_56 = 1;
														}
													}
...
int func_32(struct<3> Param0, int iParam3, int iParam4, bool bParam5)//Position - 0x116E
{
	struct<3> Var0[15];
	struct<3> Var46[15];
	float fVar92[15];
