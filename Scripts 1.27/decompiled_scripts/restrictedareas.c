#region Local Var
	...
	int iLocal_40 = 0;
	int iLocal_41 = 0;
	int iLocal_42[8] = { 0, 0, 0, 0, 0, 0, 0, 0 };
	int iLocal_43 = 0;
	int iLocal_44 = 0;
	int iLocal_45 = 0;
	int iLocal_46 = 0;
	struct<6> Local_47 = { 0, 0, 0, 0, 0, 0 } ;
...
void __EntryFunction__()//Position - 0x0
{
	...
	func_36();
	func_35(&uLocal_49, 8, 0, "TANNOY", 0, 1);
	while (true)
	{
		SYSTEM::WAIT(0);
		func_34();
					...
					else
					{
						if (iLocal_41)
						{
							...
							while (iLocal_43 < 8)
							{
								...
								{
									if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_43 + 1, 0, 0))
									{
						...
						{
							iLocal_36 = iLocal_45 + 1;
							if (func_29(iLocal_36, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0)))
							{
								if (!iLocal_37[iLocal_45])
								{
									iLocal_37[iLocal_45] = 1;
								}
								if (func_28(iLocal_36))
								{
									if (!iLocal_38[iLocal_45])
									{
										iLocal_38[iLocal_45] = 1;
									}
									Local_47 = { func_27(iLocal_36) };
									if (SCRIPT::_GET_NUMBER_OF_REFERENCES_OF_SCRIPT_WITH_NAME_HASH(MISC::GET_HASH_KEY(&Local_47)) == 0)
									{
										if (!Global_6051[iLocal_36])
										{
											func_26(iLocal_36, Global_6051[iLocal_36]);
										}
									}
								}
								else if (!Global_6051[iLocal_36])
								{
									if (PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID()))
									{
										...
										if (!bLocal_39)
										{
											if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_36, 0, 0))
											{
												if ((MISC::GET_GAME_TIMER() - iLocal_48[iLocal_45]) > 8000)
												{
													func_18();
												}
												...
												else if (iLocal_36 != 4)
												{
													if (!iLocal_40)
													{
														if (func_1(&uLocal_49, "FH1AUD", "FH1_TANNOY", 8, 0, 0, 0))
														{
															iLocal_40 = 1;
														}
													}
											...
											{
												iLocal_48[iLocal_45] = MISC::GET_GAME_TIMER();
											}
										}
									}
									else
									{
										...
										if (!bLocal_39)
										{
											if (func_32(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), iLocal_36, 0, 0))
											{
												if (!iLocal_36 == 4 || (MISC::GET_GAME_TIMER() - iLocal_48[iLocal_45]) > 8000)
												{
													func_18();
												}
											}
							...
							else if (iLocal_37[iLocal_45])
							{
								if (func_28(iLocal_36))
								{
									...
									{
										func_26(iLocal_36, 0);
										iLocal_37[iLocal_45] = 0;
									}
								}
								else if (Global_6051[iLocal_36])
								{
									Global_6051[iLocal_36] = 0;
									iLocal_37[iLocal_45] = 0;
									iLocal_38[iLocal_45] = 0;
									iLocal_40 = 0;
								}
							}
							iLocal_45++;
...
bool func_1(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x434
{
...
int func_2(char* sParam0, int iParam1, bool bParam2)//Position - 0x482
{
	Global_3D4D = 0;
...
int func_8()//Position - 0x975
{
	func_9();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

void func_9()//Position - 0x98E
{
	int iVar0;
...
bool func_10(int iParam0)//Position - 0xA8B
{
	return iParam0 < 3;
}

int func_11(var uParam0)//Position - 0xA97
{
	int iVar0;
	int iVar1;
...
int func_12(int iParam0)//Position - 0xAD4
{
	if (func_10(iParam0))
	{
...
bool func_13(int iParam0)//Position - 0xAFE
{
	return Global_8861 == iParam0;
}

void func_14()//Position - 0xB0C
{
	int iVar0;
...
bool func_15(int iParam0, int iParam1)//Position - 0xB63
{
	switch (iParam0)
	{
		case 5:
...
void func_17(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0xBF5
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_18()//Position - 0xC4B
{
	switch (iLocal_45)
	{
		case 0:
			iLocal_46 = 2;
			if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < iLocal_46)
			{
			}
			break;
	...
	if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) < iLocal_46)
	{
		PLAYER::SET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID(), iLocal_46, 0);
		PLAYER::SET_PLAYER_WANTED_LEVEL_NOW(PLAYER::PLAYER_ID(), 0);
	}
	iLocal_42[iLocal_45] = 1;
	iLocal_41 = 1;
}
...
int func_20(int iParam0)//Position - 0xE4C
{
...
bool func_22(int iParam0, int iParam1)//Position - 0xEB9
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_25(int iParam0)//Position - 0xF5B
{
	return Global_17C49.f_6DC5[iParam0 /*4*/];
}

void func_26(int iParam0, bool bParam1)//Position - 0xF6E
{
...
{
	return Global_601A[iParam0 /*6*/];
}

int func_28(int iParam0)//Position - 0xFB6
{
	if (MISC::IS_BIT_SET(Global_6019, iParam0))
	{
		return 1;
...
bool func_29(int iParam0, struct<3> Param1)//Position - 0xFCF
{
	return SYSTEM::VDIST2(Param1, func_31(iParam0)) < func_30(iParam0);
}

float func_30(int iParam0)//Position - 0xFEC
{
	switch (iParam0)
	{
		case 1:
...
Vector3 func_31(int iParam0)//Position - 0x1084
{
	switch (iParam0)
	{
		case 1:
...
int func_32(struct<3> Param0, int iParam1, int iParam2, bool bParam3)//Position - 0x116E
{
	struct<3> Var0[15];
	struct<3> Var1[15];
	float fVar2[15];
...
void func_34()//Position - 0x1F00
{
}

void func_35(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x1F08
{
