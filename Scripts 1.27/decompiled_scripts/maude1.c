	...
	switch (iLocal_142)
	{
		case 0:
			...
			if (iLocal_143 == 1)
			{
				...
				if (func_17(iLocal_157))
				{
					func_16(&uLocal_162, 3);
					func_15(iLocal_157, 0);
					if (!AUDIO::IS_AMBIENT_SPEECH_PLAYING(iLocal_157))
					{
						if (func_14(iLocal_157, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), 35f))
						{
							AUDIO::STOP_PED_SPEAKING(iLocal_157, 0);
							func_12(iLocal_157, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
				if (func_10())
		...
		case 1:
			...
			else if (iLocal_143 == 1)
			{
				if (func_17(iLocal_157))
				{
					...
					else if (func_17(iLocal_157))
					{
						if (!func_2(iLocal_157, 1805844857))
						{
...
int func_2(int iParam0, int iParam1)//Position - 0x2DA
{
	if (func_17(iParam0))
	{
...
void func_4(var uParam0)//Position - 0x34B
{
...
void func_5(var uParam0, bool bParam1)//Position - 0x376
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
		if (ENTITY::IS_ENTITY_ATTACHED_TO_ANY_PED(*uParam0))
...
void func_6(int iParam0)//Position - 0x3B1
{
...
void func_8(char* sParam0, bool bParam1)//Position - 0x41D
{
	func_9(sParam0);
	func_414(bParam1);
}

void func_9(char* sParam0)//Position - 0x431
{
		...
		if (ENTITY::IS_ENTITY_PLAYING_ANIM(iLocal_157, "special_ped@maude@base", "base", 3))
		{
			if (!PED::IS_PED_RAGDOLL(iLocal_157) || TASK::IS_PED_GETTING_UP(iLocal_157))
			{
				...
				if (STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@exit_flee"))
				{
					...
					if (func_2(iLocal_157, 1785177548))
					{
...
void func_12(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x5C1
{
	AUDIO::PLAY_PED_AMBIENT_SPEECH_WITH_VOICE_NATIVE(iParam0, sParam1, sParam2, func_13(iParam3), 0);
}

int func_13(int iParam0)//Position - 0x5DA
{
	int iVar0;
...
bool func_14(int iParam0, struct<3> Param1, float fParam4)//Position - 0x7CF
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(iParam0, 1), Param1) <= (fParam4 * fParam4);
}

void func_15(int iParam0, bool bParam1)//Position - 0x7EC
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_16(var uParam0, int iParam1)//Position - 0x85D
{
...
int func_17(int iParam0)//Position - 0x87A
{
	if (func_11(iParam0))
	{
...
void func_22()//Position - 0x957
{
	Global_14558 = 0;
	func_23();
}

void func_23()//Position - 0x967
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_24()//Position - 0x988
{
	Global_14558 = 0;
	func_25();
}

void func_25()//Position - 0x998
{
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
	{
		AUDIO::RESTART_SCRIPTED_CONVERSATION();
...
struct<6> func_26()//Position - 0x9BC
{
	struct<6> Var0;
...
{
	func_227("BBONDS_UNLOCK", 1, 0, -1, 10000, 4, 0, 0, 1);
	func_223(62, 2, 1);
	func_29(107, 1);
	func_400();
}
...
void func_29(int iParam0, bool bParam1)//Position - 0xBCD
{
	...
	{
		func_195(&(Global_96440[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
...
bool func_31(bool bParam0)//Position - 0xD44
{
...
void func_32(int iParam0, int iParam1, int iParam2)//Position - 0xD6F
{
	bool bVar0;
...
int func_34()//Position - 0x1318
{
	return Global_24444;
}

int func_35(int iParam0, int iParam1)//Position - 0x1323
{
	int iVar0;
...
int func_36(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1374
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_37()//Position - 0x15D1
{
	return Global_1312737;
}

void func_38()//Position - 0x15DD
{
	func_55();
	func_47();
	func_43();
...
void func_39(int iParam0)//Position - 0x1636
{
	if (iParam0 == 1)
	{
...
void func_41()//Position - 0x167D
{
	StringCopy(&Global_68477, "", 16);
	StringCopy(&Global_68481, "", 16);
}

void func_42()//Position - 0x1697
{
	int iVar0;
...
void func_46(int iParam0)//Position - 0x1769
{
	if (iParam0 == 1)
	{
		Global_35462 = 1;
...
void func_47()//Position - 0x1782
{
	func_48(&Global_93588);
}

void func_48(var uParam0)//Position - 0x1792
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = 145;
	...
	while (iVar1 < 3)
	{
		...
		func_53(&(uParam0->f_25[0 /*223*/][iVar1 /*74*/]));
		func_53(&(uParam0->f_25[1 /*223*/][iVar1 /*74*/]));
		iVar0 = 0;
		while (iVar0 < 12)
		{
	...
	func_52(&(uParam0->f_2161));
	func_50(&(uParam0->f_2167));
	func_49(&(uParam0->f_2233));
}

void func_49(var uParam0)//Position - 0x1CD8
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_50(var uParam0)//Position - 0x1CF3
{
...
void func_51(var uParam0)//Position - 0x1D22
{
	int iVar0;
...
void func_52(var uParam0)//Position - 0x1DD2
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_53(var uParam0)//Position - 0x1DF0
{
	int iVar0;
...
void func_54(var uParam0)//Position - 0x1ED0
{
	*uParam0 = -15;
}

void func_55()//Position - 0x1EDE
{
	StringCopy(&Global_91343, "", 32);
	func_48(&Global_91351);
}

void func_56()//Position - 0x1EF7
{
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x2035
{
	...
	{
		uVar30 = { func_104(iVar0, 0) };
		Global_68106[1 /*14*/] = { func_108(iVar0, iParam1, uVar30[iParam1]) };
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_100(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_100(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_100(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
	if (func_99(iParam0, iVar0, &iVar46, 0))
	{
		func_61(iParam0, 2, iVar46, 0, -1, 0, 0, 0, -1, -1, -1, 0);
	}
	if (func_59(iParam0, iVar0, &iVar46))
	{
...
int func_59(int iParam0, int iParam1, int iParam2)//Position - 0x21EE
{
	int iVar0;
	...
	{
		if (!func_173(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_64, Global_97353.f_1729.f_539[iVar0 /*65*/].f_63))
		{
...
int func_60(int iParam0)//Position - 0x227A
{
	switch (iParam0)
	{
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x22B5
{
	...
	if (iParam1 == 12)
	{
		if (iParam7 == 1)
		{
			...
			if (!func_83(iVar10, 14, iVar7))
			{
				iVar7 = -99;
			}
			iVar8 = func_84(iParam0, 0);
			if (!func_82(iVar10, 14, iVar8) && !func_78(iVar10, 14, iVar8))
			{
				iVar8 = -99;
			}
			if (iVar10 == joaat("player_one"))
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						{
							uVar27 = { func_101(iVar10, uVar11[iVar0]) };
						}
						iVar1 = 0;
						while (iVar1 <= 8)
						{
							Global_68106[1 /*14*/] = { func_108(iVar10, 14, uVar27[iVar1]) };
							func_77(iParam0, Global_68106[1 /*14*/].f_12, Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4);
							func_91(14);
							if (Global_68105 == 1)
							{
								iVar2 = 0;
								while (iVar2 < 15)
								{
									iVar3 = func_69(iParam0, iVar10, 14, uVar27[iVar1], iVar2, 0);
									if (iVar3 != -99)
									{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_100(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_100(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_100(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_91(iVar0);
						if (Global_68105 == 1)
						{
	...
	{
		uVar67 = { func_101(iVar10, iParam2) };
		iVar1 = 0;
		while (iVar1 <= 8)
		{
			...
			if (Global_68105 == 1)
			{
				...
				while (iVar2 < 15)
				{
					iVar3 = func_69(iParam0, iVar10, 14, uVar67[iVar1], iVar2, 0);
					if (iVar3 != -99)
					{
						func_61(iParam0, iVar2, iVar3, 0, -1, 0, 0, 0, -1, -1, -1, 0);
					}
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_100(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_100(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_100(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
void func_62(int iParam0, int iParam1, int iParam2)//Position - 0x2AA2
{
	int iVar0;
	int iVar1;
...
int func_63(int iParam0, int iParam1, int iParam2)//Position - 0x2B2C
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_64(int iParam0, int iParam1, int iParam2)//Position - 0x2C0A
{
	Global_68106[1 /*14*/] = { func_108(iParam0, iParam1, iParam2) };
	return MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 2);
}

int func_65(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2C34
{
	var uVar0;
	int iVar10;
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x322F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3369
{
	int iVar0;
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3670
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x4224
{
	int iVar0;
...
int func_71(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4508
{
	int iVar0;
...
int func_72(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x47CF
{
	int iVar0;
	int iVar1;
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4806
{
	int iVar0;
...
int func_74(int iParam0, int iParam1, int iParam2)//Position - 0x482F
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4AF9
{
	int iVar0;
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x4D83
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_77(int iParam0, var uParam1, int iParam2, var uParam3)//Position - 0x4EDA
{
	if (iParam2 == -1)
	{
...
int func_78(int iParam0, int iParam1, int iParam2)//Position - 0x4F03
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 3), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 3), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			switch (iParam1)
			{
				case 14:
					...
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 4), joaat("HAT"), 1) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						return (FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 4), joaat("HAT"), 0) || FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5126
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar39 = 0;
		iVar40 = (iParam1 - func_80(iParam0, func_100(iParam2)));
		if (iVar40 < 0)
		{
			return -1;
		}
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_100(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_80(int iParam0, int iParam1)//Position - 0x5220
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_81(int iParam0)//Position - 0x55C7
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x5628
{
	var uVar0;
	var uVar1;
	...
	else if (iParam0 == joaat("mp_m_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					uVar0 = func_79(iParam0, iParam2, 1, 3);
	...
	else if (iParam0 == joaat("mp_f_freemode_01"))
	{
		if (iParam1 == 1)
		{
			if (iParam2 > 0)
			{
				if (iParam2 >= 26)
				{
					uVar1 = func_79(iParam0, iParam2, 1, 4);
...
int func_83(int iParam0, int iParam1, int iParam2)//Position - 0x5A1D
{
	switch (iParam0)
	{
		case joaat("player_zero"):
		...
		case joaat("mp_m_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 3), joaat("GLASSES"), 1);
				}
			}
			break;
		...
		case joaat("mp_f_freemode_01"):
			if (iParam1 == 14)
			{
				...
				{
					return FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(func_79(iParam0, iParam2, 14, 4), joaat("GLASSES"), 1);
				}
			}
			break;
	}
...
int func_84(int iParam0, int iParam1)//Position - 0x5CFC
{
	int iVar0;
	int iVar1;
	...
	return func_85(iParam0, iVar0, iVar1, iParam1);
}

int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5D42
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar1 != -1 && iVar1 != 0)
	{
		...
		{
			return func_87(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 3);
		}
		else if (iVar0 == joaat("mp_f_freemode_01"))
		{
			return func_87(ENTITY::GET_ENTITY_MODEL(iParam0), iVar1, 14, 4);
		}
	}
	...
	while (iVar4 <= (iVar2 - 1))
	{
		...
		else
		{
			...
			while (iVar5 <= (iVar6 - 1))
			{
				...
				{
					iVar3 = (iVar3 + func_86(iParam0, iParam3));
					return iVar3;
				}
				else
				{
...
int func_86(int iParam0, int iParam1)//Position - 0x5E3E
{
	int iVar0;
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5F7C
{
	struct<2> Var0;
	int iVar17;
	int iVar18;
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_100(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				...
				{
					return (func_80(iParam0, func_100(iParam2)) + iVar38);
				}
				iVar38++;
			}
			iVar37++;
...
int func_88(int iParam0)//Position - 0x605C
{
	switch (iParam0)
	{
		case 0:
...
int func_89(int iParam0, int iParam1)//Position - 0x60E2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6142
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_91(int iParam0)//Position - 0x61C6
{
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		func_97(iParam0, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 2, Global_68106[1 /*14*/].f_1, 1, 0);
	}
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 1) && MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_92(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x627E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_96(uParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
		uVar3 = func_95(iVar2, iVar0, 0);
		MISC::SET_BIT(&uVar3, iVar1);
		func_93(iVar2, uVar3, iVar0, 1);
	}
}

void func_93(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x62C7
{
	int iVar0;
	
	iVar0 = Global_2454605[iParam0 /*6*/][func_94(iParam2)];
	if (iVar0 != 0)
	{
...
int func_94(var uParam0)//Position - 0x62F2
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1, int iParam2)//Position - 0x6326
{
	var uVar0;
	var uVar1;
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_94(iParam1)];
...
bool func_96(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6358
{
	int iVar0;
...
int func_97(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x69F9
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_98(int iParam0)//Position - 0x7917
{
	if (!MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7968
{
	int iVar0;
	...
	{
		if (!func_173(iParam0, Global_97353.f_1729.f_539[iVar0 /*65*/].f_61, Global_97353.f_1729.f_539[iVar0 /*65*/].f_60) || iParam3 == 1)
		{
...
int func_100(int iParam0)//Position - 0x79FE
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_101(int iParam0, int iParam1)//Position - 0x7AAE
{
	int iVar0;
	struct<10> Var1;
...
void func_102(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x83DE
{
	int iVar0;
	struct<4> Var1;
	struct<3> Var16;
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_87(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
...
void func_103(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x8508
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<16> func_104(int iParam0, int iParam1)//Position - 0x8550
{
	int iVar0;
	struct<16> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_107(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[0], Global_97353.f_1729.f_539.f_200[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_107(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[1], Global_97353.f_1729.f_539.f_200[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_107(&Var1, -99, -99, Global_97353.f_1729.f_539.f_196[2], Global_97353.f_1729.f_539.f_200[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA393
{
	int iVar0;
	struct<5> Var1;
	struct<3> Var16;
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_106(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_106(Var16.f_2)] = func_87(iParam1, Var16.x, func_106(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
					(*iParam0)[func_106(Var16.f_2)] = Var16.f_1;
				}
			}
			iVar19++;
		}
...
int func_106(int iParam0)//Position - 0xA544
{
	switch (iParam0)
	{
		case 0:
...
void func_107(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xA5F4
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[2] = iParam2;
	(*iParam0)[3] = iParam3;
...
struct<14> func_108(int iParam0, int iParam1, int iParam2)//Position - 0xA665
{
	func_172();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_109(int iParam0, int iParam1)//Position - 0xA6B7
{
	switch (iParam0)
	{
		case 0:
...
void func_110(int iParam0)//Position - 0xA7A7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xBA1D
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_115(14))
			{
				uVar0 = func_95(func_114(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_95(func_113(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_95(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
bool func_112(int iParam0, int iParam1, var uParam2)//Position - 0xBDA0
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_113(int iParam0, int iParam1)//Position - 0xC1A7
{
	switch (iParam1)
	{
		case 0:
...
int func_114(int iParam0, int iParam1)//Position - 0xC5A2
{
	switch (iParam1)
	{
		case 0:
...
bool func_115(int iParam0)//Position - 0xC99D
{
	return Global_34913 == iParam0;
}

int func_116(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xC9AB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_117(int iParam0)//Position - 0xC9ED
{
	switch (iParam0)
	{
		case -1:
...
void func_118(int iParam0, int iParam1, int iParam2)//Position - 0xCAC1
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_111(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_100(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_111(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
void func_119(int iParam0)//Position - 0xCD3C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0xCE92
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121(int iParam0)//Position - 0xD39F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_122(int iParam0)//Position - 0xD413
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_123(int iParam0)//Position - 0xD486
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_124(int iParam0)//Position - 0xD56C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_125(int iParam0)//Position - 0xD8CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_126(int iParam0)//Position - 0xDADE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_127(int iParam0)//Position - 0xDD0D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_128(int iParam0)//Position - 0xDE1C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_129(int iParam0)//Position - 0xE7BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_130(int iParam0)//Position - 0xF32C
{
	if (iParam0 < 136)
	{
		func_132(iParam0);
...
void func_131(int iParam0)//Position - 0xF360
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_132(int iParam0)//Position - 0xFF64
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_133(int iParam0)//Position - 0x10EE7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_134(int iParam0)//Position - 0x11013
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_135(int iParam0, int iParam1)//Position - 0x11110
{
	switch (iParam0)
	{
		case 0:
...
void func_136(int iParam0)//Position - 0x11200
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0x126F0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0x12840
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0x12D4A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0x133B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0x1342A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x134F9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x13A28
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x13BBE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x143BB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x144CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x153F4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_148(int iParam0)//Position - 0x160B0
{
	if (iParam0 < 107)
	{
		func_151(iParam0);
...
void func_149(int iParam0)//Position - 0x160F5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x16B9A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x17989
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0)//Position - 0x185D4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_153(int iParam0)//Position - 0x1884C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0, int iParam1)//Position - 0x18991
{
	switch (iParam0)
	{
		case 0:
...
void func_155(int iParam0)//Position - 0x18A81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x1980A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x19983
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x19EF9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x1A422
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1A495
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x1A564
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x1AA3B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x1ACA3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x1AF78
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x1B140
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_166(int iParam0)//Position - 0x1BC93
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x1C8DD
{
	if (iParam0 < 60)
	{
		func_169(iParam0);
...
void func_168(int iParam0)//Position - 0x1C911
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1D6B1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1DD3D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0)//Position - 0x1DE23
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_172()//Position - 0x1DF20
{
...
int func_173(int iParam0, int iParam1, int iParam2)//Position - 0x1DF99
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		while (iVar2 <= 14)
		{
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_173(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						uVar21 = { func_101(iVar0, uVar5[iVar2]) };
						iVar3 = 0;
						while (iVar3 <= 8)
						{
							if (!func_173(iParam0, 14, uVar21[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									...
									if (Global_68106[2 /*14*/].f_12 == iVar3)
									{
										...
										{
											if (!func_65(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_68106[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						if (!func_65(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_68106[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_100(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_100(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_174(int iParam0)//Position - 0x1E1F1
{
	int iVar0;
	int iVar1;
...
int func_175(int iParam0)//Position - 0x1E22E
{
	if (func_176(iParam0))
	{
...
bool func_176(int iParam0)//Position - 0x1E258
{
	return iParam0 < 3;
}

void func_177(var uParam0, var uParam1)//Position - 0x1E264
{
...
void func_179()//Position - 0x1E304
{
	int iVar0;
	
	if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
	{
		if (func_175(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
			iVar0 = func_174(PLAYER::PLAYER_PED_ID());
			if (func_176(iVar0) && (!func_115(14) || Global_96306))
			{
...
struct<2> func_180(int iParam0)//Position - 0x1E401
{
	struct<2> Var0;
	char[] cVar2[8];
...
struct<2> func_181(int iParam0)//Position - 0x1E438
{
	struct<2> Var0;
...
void func_182(int iParam0, int iParam1)//Position - 0x1E884
{
...
void func_183(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1E8CE
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
...
void func_184(int iParam0, int iParam1, int iParam2)//Position - 0x1E96B
{
	struct<4> Var0;
	var uVar32;
	...
	if (iParam0 != -1)
	{
		...
		MemCopy(&uVar32, {func_181(iParam0)}, 4);
		STATS::PLAYSTATS_MISSION_CHECKPOINT(&uVar32, 0, Global_89999, 0);
		func_185(&uVar32, Var0.f_3, Global_89999, iParam1, iParam2);
	}
}

void func_185(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4)//Position - 0x1E9AA
{
...
void func_186(int iParam0, var uParam1)//Position - 0x1E9EE
{
	switch (iParam0)
	{
		case 0:
...
int func_188(int iParam0)//Position - 0x1FC34
{
	switch (iParam0)
	{
		case 0:
...
void func_189(int iParam0)//Position - 0x1FF7A
{
	Global_35464 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_190()//Position - 0x1FF8C
{
	if (Global_87679)
	{
		func_179();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_191(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
char* func_191(var uParam0)//Position - 0x1FFBE
{
	uParam0 = uParam0;
	return "";
}

void func_192()//Position - 0x1FFCD
{
	char cVar0[24];
...
void func_193(int iParam0, int iParam1)//Position - 0x20012
{
	Global_87674 = iParam0;
	Global_87675 = iParam1;
}

void func_194()//Position - 0x20026
{
	if (Global_68499 != 6)
	{
	}
...
void func_195(var uParam0)//Position - 0x2005E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_196(int iParam0, bool bParam1)//Position - 0x2009B
{
	struct<26> Var0;
	int iVar32;
	bool bVar33;
...
int func_197(int iParam0)//Position - 0x20221
{
	switch (iParam0)
	{
		case 0:
...
void func_198(int iParam0)//Position - 0x205A8
{
	func_200(iParam0, 1);
	Global_97353.f_16828[iParam0 /*6*/].f_3 = func_199();
	Global_97353.f_16828.f_380++;
}

int func_199()//Position - 0x205DE
{
	return (Global_97353.f_8270.f_21 + Global_97353.f_16828.f_380);
}

void func_200(var uParam0, bool bParam1)//Position - 0x205FA
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0)//Position - 0x2091E
{
...
void func_202(int iParam0)//Position - 0x20951
{
	switch (iParam0)
	{
		case 30:
...
void func_203(int iParam0, bool bParam1)//Position - 0x20986
{
	if (iParam0 == -1)
	{
		return;
...
void func_204(int iParam0, int iParam1, bool bParam2)//Position - 0x209E3
{
	if (iParam0 == -1)
	{
		return;
...
bool func_205(int iParam0, int iParam1)//Position - 0x20A1E
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_206(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x20A41
{
	if (iParam0 != 198)
	{
		if (Global_68245)
...
void func_207(int iParam0, int iParam1)//Position - 0x20A9C
{
	switch (iParam0)
	{
		case 12:
...
void func_208(int iParam0, bool bParam1)//Position - 0x20B85
{
	if (bParam1)
	{
...
bool func_209(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x20BAE
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_210()//Position - 0x214D3
{
	if ((func_34() == -1 || func_34() == 999) && !func_211() == 0)
	{
		return 1;
	}
	return 0;
...
int func_211()//Position - 0x21503
{
	return Global_24445;
}

int func_212(var uParam0, int iParam1)//Position - 0x2150E
{
	int iVar0;
...
int func_213(int iParam0)//Position - 0x24CA9
{
	switch (iParam0)
	{
		case 46:
...
void func_214(int iParam0, bool bParam1)//Position - 0x24D9B
{
	switch (iParam0)
	{
		case 46:
...
void func_215(int iParam0, bool bParam1)//Position - 0x24DEC
{
	int iVar0;
...
int func_216(int iParam0)//Position - 0x24E59
{
	int iVar0;
	int iVar1;
...
void func_219(int iParam0, int iParam1)//Position - 0x25093
{
...
int func_220(char* sParam0)//Position - 0x250D0
{
	int iVar0;
...
int func_221()//Position - 0x25130
{
	return func_222(SCRIPT::GET_THIS_SCRIPT_NAME(), 0);
}

int func_222(char* sParam0, int iParam1)//Position - 0x25141
{
	int iVar0;
	var uVar1;
	int iVar33;
...
void func_223(int iParam0, int iParam1, bool bParam2)//Position - 0x2518A
{
	Global_2949 = iParam0;
...
void func_224()//Position - 0x25334
{
	char cVar0[64];
	char cVar16[64];
	char* sVar32;
...
void func_225()//Position - 0x253B3
{
	if (func_115(14))
	{
...
int func_226()//Position - 0x25454
{
	func_179();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_227(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x2546D
{
	func_228(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_228(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x2548E
{
	int iVar0;
...
void func_229()//Position - 0x25661
{
	int iVar0;
...
bool func_230(char* sParam0, int iParam1, int iParam2)//Position - 0x25781
{
	...
	if (iLocal_152 < iLocal_150)
	{
		if (!func_20())
		{
			if (SYSTEM::VDIST2(Param3, Param0) < (fParam7 * fParam7))
			{
				...
				{
					func_234(&uLocal_162, 3, iLocal_157, "MAUDE", 0, 1);
					func_232(&uLocal_162, "MAUDEAU", "MAUDE_loiter", 7, 0, 0);
					iLocal_151 = MISC::GET_GAME_TIMER();
					iLocal_152++;
					return 1;
				}
...
void func_232(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25819
{
	func_233(uParam0, 145, sParam1, iParam4, iParam5, 0);
	if (iParam3 > 7)
	{
		if (iParam3 < 12)
		{
...
void func_233(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25854
{
...
void func_234(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x258AA
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
int func_235(bool bParam0)//Position - 0x25945
{
	if (func_17(iLocal_157))
	{
		...
		if (func_236(iLocal_157, 1, 0, 0, 0))
		{
			return 1;
		}
...
int func_236(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x25A8A
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_237(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x25B85
{
	struct<3> Var0;
	struct<3> Var3;
...
int func_238(int iParam0, float fParam1)//Position - 0x25C91
{
	var uVar0;
	struct<3> Var1;
...
int func_239(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x25D26
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_241(Param1 - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
float func_240(struct<3> Param0, struct<3> Param3)//Position - 0x25DB4
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}

Vector3 func_241(struct<3> Param0)//Position - 0x25DD5
{
	float fVar0;
	float fVar1;
...
int func_242(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x25E14
{
	if (bParam1)
	{
		if (PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID()))
...
bool func_245(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x25EEA
{
	...
	uVar0 = func_246(&(Local_36[iVar4 /*4*/]), Var1, iParam1, &(Local_36[iVar4 /*4*/].f_3), iParam0, iParam5);
	return (uVar0 || (MISC::GET_GAME_TIMER() - Local_36[iVar4 /*4*/].f_3) < iParam4);
}

int func_246(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x25FAB
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
Vector3 func_247(int iParam0, int iParam1)//Position - 0x260D7
{
	int iVar0;
...
int func_249(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x261E6
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
	
	Var0 = { func_241(ENTITY::GET_ENTITY_COORDS(iParam1, 1) - ENTITY::GET_ENTITY_COORDS(iParam0, 1)) };
...
void func_250(var uParam0)//Position - 0x26277
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_252(int iParam0)//Position - 0x262D1
{
...
void func_253(char* sParam0, int iParam1, int iParam2)//Position - 0x262F9
{
	iParam2 = iParam2;
...
void func_254()//Position - 0x26312
{
	...
	{
		case 0:
			func_344("MAUDE_MCS_1", 0);
			if (func_11(iLocal_157))
			{
			...
			if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
			{
				if (func_335())
				{
					...
					{
						func_330(&Local_80, 0, 1);
						func_329(&iLocal_157, &(Local_80.f_28[0]));
						func_328(&iLocal_153, &(Local_80.f_41[0]));
						func_328(&iLocal_154, &(Local_80.f_41[1]));
						func_327();
...
void func_257(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x266B4
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_258(PLAYER::PLAYER_ID()))
		{
...
int func_258(int iParam0)//Position - 0x26785
{
...
bool func_259()//Position - 0x267C6
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_260(int iParam0, int iParam1)//Position - 0x267D7
{
	bool bVar0;
...
int func_261(int iParam0, bool bParam1)//Position - 0x26822
{
	int iVar0;
	int iVar1;
...
int func_262(int iParam0, var uParam1, var uParam2)//Position - 0x26863
{
	int iVar0;
...
void func_264(int iParam0)//Position - 0x268BB
{
	if (iParam0 == 1)
	{
...
void func_267()//Position - 0x26A0E
{
	...
	if (func_319(Var6, 0))
	{
		func_313(Var0, Var3, fVar9, 2719.87f, 4143.46f, 43.46f, 261.91f, 1, 1, 1, 0, 0);
		func_268(2719.87f, 4143.46f, 43.46f, 261.91f, 0, 145);
		Local_328 = { 2719.87f, 4143.46f, 43.46f };
	}
	else
	{
		func_313(Var0, Var3, fVar9, 2710.665f, 4149.075f, 42.7026f, 180.9488f, 1, 1, 1, 0, 0);
		func_268(2710.665f, 4149.075f, 42.7026f, 180.9488f, 0, 145);
		Local_328 = { 2710.665f, 4149.075f, 42.7026f };
	}
}

void func_268(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x26B09
{
	struct<3> Var0;
	var uVar3;
	...
	if (ENTITY::DOES_ENTITY_EXIST(Global_91351.f_4))
	{
		...
		{
			if (func_312(24) != Global_91351.f_4)
			{
				if (iParam4 == 1)
				{
					if (func_309(ENTITY::GET_ENTITY_COORDS(Global_91351.f_4, 1), iParam5, &Var0, &uVar3))
					{
						Param0 = { Var0 };
						fParam3 = uVar3;
					}
				}
				func_269(Global_91351.f_4, Param0, fParam3, 24, 0);
			}
		}
	}
}

void func_269(int iParam0, struct<3> Param1, var uParam4, int iParam5, bool bParam6)//Position - 0x26B84
{
	struct<54> Var0;
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam0) && VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		func_300(iParam5, Var0, Param1, uParam4, func_303(iParam0));
		func_270(iParam5, iParam0, 0);
	}
}

void func_270(int iParam0, int iParam1, int iParam2)//Position - 0x26CAF
{
	int iVar0;
	...
	if (!func_297(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (ENTITY::DOES_ENTITY_EXIST(iParam1))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_97353.f_18371.f_4249 = func_286();
			}
...
void func_271(int iParam0, int iParam1)//Position - 0x26DCC
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_305(iParam0, &(Global_97353.f_18371.f_4742));
}

int func_272(int iParam0)//Position - 0x26FCD
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_284(iParam0, 0, 0)) || func_284(iParam0, 1, 0)) || func_284(iParam0, 2, 0)) || func_303(iParam0) != 145) || func_283(iParam0)) || func_282(iParam0)) || func_281(iParam0)) || func_280(iParam0)) || !func_273(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_282(iParam0))
		{
		}
...
int func_273(int iParam0)//Position - 0x270AA
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_274(int iParam0)//Position - 0x2725A
{
	int iVar0;
	struct<2> Var1;
...
int func_275()//Position - 0x27429
{
	return 0;
}

int func_276()//Position - 0x27432
{
	return 1;
}

int func_277()//Position - 0x2743B
{
	return 1;
}

int func_278()//Position - 0x27444
{
...
int func_280(int iParam0)//Position - 0x274E0
{
	int iVar0;
	char* sVar1;
...
int func_281(int iParam0)//Position - 0x27525
{
	int iVar0;
...
int func_282(int iParam0)//Position - 0x27560
{
	int iVar0;
...
int func_283(int iParam0)//Position - 0x275DC
{
	int iVar0;
...
int func_284(int iParam0, int iParam1, bool bParam2)//Position - 0x276C4
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_285(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x27735
{
...
var func_286()//Position - 0x2780D
{
	var uVar0;
	
	func_296(&uVar0, CLOCK::GET_CLOCK_SECONDS());
	func_295(&uVar0, CLOCK::GET_CLOCK_MINUTES());
	func_294(&uVar0, CLOCK::GET_CLOCK_HOURS());
	func_289(&uVar0, CLOCK::GET_CLOCK_DAY_OF_MONTH());
	func_288(&uVar0, CLOCK::GET_CLOCK_MONTH());
	func_287(&uVar0, CLOCK::GET_CLOCK_YEAR());
	return uVar0;
}

void func_287(var uParam0, int iParam1)//Position - 0x27853
{
	if (iParam1 <= 0)
	{
		return;
...
void func_288(var uParam0, int iParam1)//Position - 0x278D9
{
...
void func_289(var uParam0, int iParam1)//Position - 0x2790C
{
	int iVar0;
	int iVar1;
...
int func_290(int iParam0, int iParam1)//Position - 0x2795D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_291(var uParam0)//Position - 0x279FF
{
	return (SYSTEM::SHIFT_RIGHT(uParam0, 26) & 31 * func_292(MISC::IS_BIT_SET(uParam0, 31), -1, 1)) + 2011;
}

int func_292(bool bParam0, int iParam1, int iParam2)//Position - 0x27A24
{
	if (bParam0)
	{
		return iParam1;
...
int func_293(var uParam0)//Position - 0x27A3B
{
	return uParam0 & 15;
}

void func_294(var uParam0, int iParam1)//Position - 0x27A48
{
...
void func_295(var uParam0, int iParam1)//Position - 0x27A82
{
...
void func_296(var uParam0, int iParam1)//Position - 0x27ABD
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_297(var uParam0, int iParam1)//Position - 0x27AF9
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_304(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_304(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_304(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
int func_298(int iParam0, int iParam1)//Position - 0x291EE
{
	struct<58> Var0;
...
void func_299(int iParam0, var uParam1, int iParam2)//Position - 0x29230
{
	int iVar0;
	struct<74> Var1;
...
void func_300(int iParam0, struct<54> Param1, struct<3> Param55, var uParam58, int iParam59)//Position - 0x294A8
{
	if (func_297(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			func_302(iParam0);
			func_301(Param1, &(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/]));
...
void func_301(struct<54> Param0, var uParam54)//Position - 0x295AA
{
...
void func_302(int iParam0)//Position - 0x29675
{
	if (iParam0 == -1)
	{
		return;
...
int func_303(int iParam0)//Position - 0x296EF
{
	int iVar0;
...
bool func_304(struct<3> Param0, struct<3> Param3)//Position - 0x29752
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

void func_305(int iParam0, var uParam1)//Position - 0x2977B
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_307(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_306(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_306(int iParam0)//Position - 0x29A27
{
	switch (iParam0)
	{
		case 1:
...
int func_307(int iParam0, var uParam1, var uParam2)//Position - 0x29AD7
{
	int iVar0;
	int iVar1;
...
void func_308(int iParam0)//Position - 0x29BB1
{
...
int func_309(struct<3> Param0, int iParam3, var uParam4, var uParam5)//Position - 0x29BD8
{
	int iVar0;
	
	iVar0 = func_310(Param0, iParam3, 1);
	switch (iVar0)
	{
		case 0:
...
int func_310(struct<3> Param0, int iParam3, int iParam4)//Position - 0x29CEE
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_311(int iParam0)//Position - 0x29D7D
{
	return MISC::IS_BIT_SET(Global_97353.f_5486[iParam0], 0);
}

int func_312(int iParam0)//Position - 0x29D95
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_313(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, bool bParam11, bool bParam12, bool bParam13, bool bParam14, bool bParam15)//Position - 0x29DB1
{
	func_314(Param0, Param3, fParam6, Param7, fParam10, 0f, 0f, 0f, bParam11, bParam12, bParam13, bParam14, bParam15);
}

void func_314(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x29DDA
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_315(struct<3> Param0)//Position - 0x2A1C0
{
...
int func_316(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x2A1EA
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_317(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x2A4E0
{
	float fVar0;
	float fVar1;
	float fVar2;
...
void func_318(int iParam0)//Position - 0x2A594
{
	if (ENTITY::DOES_ENTITY_EXIST(iParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
...
bool func_319(struct<3> Param0, int iParam3)//Position - 0x2A5F9
{
	return func_320(Global_91351.f_2167.f_12.f_42, Param0, iParam3);
}

int func_320(int iParam0, struct<3> Param1, int iParam4)//Position - 0x2A616
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_321()//Position - 0x2A680
{
...
void func_322(struct<3> Param0, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8, bool bParam9, bool bParam10, int iParam11, bool bParam12)//Position - 0x2A697
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(uVar0))
	{
		...
		if (iParam6 == 1)
		{
			MISC::CLEAR_AREA_OF_PEDS(func_324(PLAYER::GET_PLAYER_INDEX()), 50f, 0);
		}
		if (iParam7 == 1)
		{
...
void func_323(int iParam0, bool bParam1)//Position - 0x2A84D
{
...
Vector3 func_324(var uParam0)//Position - 0x2A889
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_325(bool bParam0)//Position - 0x2A89C
{
	var uVar0;
...
void func_326()//Position - 0x2A8D8
{
	int iVar0;
...
void func_328(var uParam0, var uParam1)//Position - 0x2A95F
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_329(int iParam0, var uParam1)//Position - 0x2A971
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_330(var uParam0, int iParam1, bool bParam2)//Position - 0x2A983
{
	int iVar0;
...
int func_331(int iParam0, float fParam1, int iParam2)//Position - 0x2AA77
{
	int iVar0;
	...
	if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
	{
		...
		{
			if (!func_334(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), fParam1, 1, 1056964608, 0, 1))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_332()//Position - 0x2AB4A
{
	bool bVar0;
...
void func_333()//Position - 0x2AB6D
{
...
int func_334(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5)//Position - 0x2ABBE
{
...
{
	if ((func_397() || func_31(0)) || func_337())
	{
		return 1;
	}
	if (iLocal_147 == 0)
	{
		if (func_11(Local_80.f_28[0]))
		{
			if (!func_336(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 7f))
			{
	...
	{
		if ((iLocal_148 == -1 || (MISC::GET_GAME_TIMER() - iLocal_148) > 3000) || (func_11(Local_80.f_28[0]) && func_336(PLAYER::PLAYER_PED_ID(), Local_80.f_28[0], 4.5f)))
		{
			return 1;
		}
	}
...
void func_339()//Position - 0x2AEDB
{
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			if (func_334(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), 10.5f, 1, 1056964608, 0, 1))
			{
...
void func_340()//Position - 0x2AF32
{
...
void func_341(int iParam0)//Position - 0x2AF5A
{
	if (Global_14551)
	{
		func_342(0, 0);
...
void func_342(bool bParam0, bool bParam1)//Position - 0x2AFCA
{
	if (bParam0)
	{
		if (func_343(0))
...
int func_343(int iParam0)//Position - 0x2B03E
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
void func_344(char* sParam0, bool bParam1)//Position - 0x2B098
{
	func_325(bParam1);
...
void func_345()//Position - 0x2B0AE
{
	if (Global_84544)
	{
		func_359(&iLocal_327, 2662.644f, 4284.535f, 43.5787f, 19.8376f, 0, 0, 1, 0, 0, joaat("asterope"), 0, 145);
		func_358(2672.462f, 4288.777f, 43.607f, 78.1133f, 0, 0);
		func_356(1, 1);
		SYSTEM::WAIT(500);
		func_355(0, -1, 1);
		func_354(1, 1, 1);
	...
	else
	{
		...
		{
			func_359(&iLocal_327, 2704.078f, 4152.24f, 42.2514f, 175.193f, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
		}
		func_358(2718.649f, 4147.208f, 42.7043f, 76.7892f, 0, 0);
		func_356(1, 1);
		func_267();
		func_266(31, 1, 0);
		SYSTEM::WAIT(0);
...
int func_347(var uParam0)//Position - 0x2B232
{
	...
	switch (iLocal_78)
	{
		...
		case 1:
			if (!func_352(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED("special_ped@maude@base"))
			{
				return 0;
			}
			iLocal_78 = 2;
		...
		case 2:
			...
			{
				func_351(&(uParam0->f_41[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_41[1]))
			{
				func_351(&(uParam0->f_41[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!ENTITY::DOES_ENTITY_EXIST(uParam0->f_28[0]))
			{
				if (!func_348(&(uParam0->f_28[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar5 = false;
				}
			}
...
int func_348(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2B4C4
{
	if (func_349(uParam0, iParam1, Param2, fParam5, 1))
	{
		if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
		{
...
int func_349(int iParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0x2B51F
{
	int iVar0;
...
int func_350(var uParam0, int iParam1)//Position - 0x2B5AD
{
	int iVar0;
...
void func_351(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0x2B5F3
{
	func_4(uParam0);
...
int func_352(int iParam0)//Position - 0x2B61A
{
	int iVar0;
...
int func_353(int iParam0)//Position - 0x2B64B
{
	if (!func_176(iParam0))
	{
		return Global_97353.f_29774[iParam0 /*29*/];
...
void func_355(int iParam0, int iParam1, int iParam2)//Position - 0x2B6AA
{
	if (func_397() && func_337())
	{
...
void func_358(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2B800
{
	if (func_397())
	{
...
void func_359(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x2B895
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_393(iParam6, iParam7, iParam8))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_379(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_304(Param1, 0f, 0f, 0f))
		...
		func_375(Param1, 5f, 0);
		if (func_176(iParam12))
		{
			func_374(iParam12, 0);
			while (!func_360(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_360(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x2BA1D
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_371(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_371(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, Param2, fParam5, 1, 1);
				...
				func_371(iParam0, &(Var5.f_31), &(Var5.f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 1)
				{
...
void func_361(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2C805
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_176(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_365(*iParam1, 0, &uVar0))
		{
			func_307(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_364(*iParam1);
				...
				func_362(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_362(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_362(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2D3E4
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar0 = 0;
	while (func_363(iVar0, &sVar2, &iVar1, &iVar6, &iVar7))
	{
...
bool func_363(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2D457
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_364(int iParam0)//Position - 0x2E99E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_365(int iParam0, bool bParam1, var uParam2)//Position - 0x2EA5C
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if ((func_281(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_366(int iParam0, bool bParam1, var uParam2)//Position - 0x2EAFE
{
	if (!bParam1)
	{
...
int func_367(int iParam0)//Position - 0x2EE98
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_368(int iParam0, int iParam1)//Position - 0x2EEC1
{
	int iVar0;
...
void func_369(var uParam0)//Position - 0x2EF43
{
	if (!func_370(*uParam0))
	{
...
bool func_370(int iParam0)//Position - 0x2EF6E
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_371(var uParam0, var uParam1, var uParam2)//Position - 0x2EF7D
{
	int iVar0;
	int iVar1;
...
int func_372(int iParam0)//Position - 0x2F0AF
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_373(var uParam0, var uParam1)//Position - 0x2F18D
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_374(int iParam0, int iParam1)//Position - 0x2F1CE
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_298(iParam0, iParam1))
				{
...
void func_375(struct<3> Param0, float fParam3, int iParam4)//Position - 0x2F26F
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_297(&(Global_67138.f_555[0 /*21*/]), iVar0))
		{
...
void func_376(int iParam0)//Position - 0x2F2BF
{
	bool bVar0;
	...
	if (func_297(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		if (MISC::IS_BIT_SET(Global_67138.f_555[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_205(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_377(0, Global_67138.f_555[0 /*21*/].f_12) || !func_377(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_301(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
int func_377(int iParam0, int iParam1)//Position - 0x2F434
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_378(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_274(Global_97353.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}

int func_378(var uParam0)//Position - 0x2F4A5
{
	return *uParam0;
}

int func_379(struct<3> Param0, float fParam3)//Position - 0x2F4B0
{
	return func_380(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_380(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x2F4CA
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
	...
	if (func_389(uParam0))
	{
		...
		if (func_388(uParam0))
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(iVar0))
			{
				...
				func_385(iVar0, &(uParam0->f_12), 0, 1);
				bVar4 = true;
				...
				if (uParam0->f_7 == 1)
				{
					if (bParam5)
					{
						...
						{
							func_374(uParam0->f_11, 1);
						}
						else if (VEHICLE::IS_THIS_MODEL_A_BIKE(ENTITY::GET_ENTITY_MODEL(iVar0)))
						{
							func_374(uParam0->f_11, 2);
						}
					}
				...
				else if ((!func_382(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_10) && MISC::ARE_STRINGS_EQUAL(SCRIPT::GET_THIS_SCRIPT_NAME(), "startup_positioning"))
				{
					iVar8 = func_381(iVar0);
					if (iVar8 == -1)
					{
						uParam0->f_10 = 0;
					}
...
int func_381(int iParam0)//Position - 0x2F776
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_382(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x2F838
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_384(iParam0, Global_67138.f_139[38], 0))
			{
				func_376(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_384(iParam0, Global_67138.f_139[43], 1))
			{
				func_376(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_384(iParam0, uVar1[iVar6], 1) && func_383(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_304(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_383(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2FA3E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_384(int iParam0, int iParam1, bool bParam2)//Position - 0x2FA8A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_385(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x2FAEA
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_387(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_386())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_371(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_306(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
bool func_386()//Position - 0x2FED7
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_387(int iParam0)//Position - 0x2FEE8
{
	var uVar0;
...
int func_388(var uParam0)//Position - 0x2FF36
{
	if (func_389(uParam0))
	{
...
int func_389(var uParam0)//Position - 0x2FF6B
{
	if (uParam0->f_12.f_42 == 0)
	{
		return 0;
	}
	if (!func_274(uParam0->f_12.f_42))
	{
		return 0;
	}
	return 1;
...
bool func_390()//Position - 0x2FF94
{
	return func_388(&(Global_93588.f_2167));
}

void func_391()//Position - 0x2FFA7
{
	func_392(&(Global_93588.f_2167));
}

void func_392(var uParam0)//Position - 0x2FFBA
{
	if (func_389(uParam0))
	{
...
int func_393(int iParam0, int iParam1, int iParam2)//Position - 0x2FFD8
{
	...
	if (iParam2 == 0 && func_395(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_395(int iParam0)//Position - 0x300BD
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_396()//Position - 0x30116
{
	return func_389(&(Global_93588.f_2167));
}

int func_397()//Position - 0x30129
{
...
void func_399()//Position - 0x3017A
{
	Global_84545 = 1;
}
...
void func_400()//Position - 0x30187
{
	...
	func_401(&Local_80, 1, 0, 0);
	SCRIPT::TERMINATE_THIS_THREAD();
}

void func_401(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x301AB
{
...
void func_402(var uParam0, bool bParam1)//Position - 0x301CB
{
	func_403(&(uParam0->f_41), bParam1);
}

void func_403(var uParam0, bool bParam1)//Position - 0x301DD
{
	int iVar0;
...
void func_404(var uParam0, bool bParam1)//Position - 0x3021B
{
	func_405(&(uParam0->f_35), bParam1);
}

void func_405(var uParam0, bool bParam1)//Position - 0x3022D
{
	int iVar0;
...
void func_406(var uParam0)//Position - 0x3026A
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_407(var uParam0)//Position - 0x302A1
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
int func_408(int iParam0)//Position - 0x3033D
{
	if (func_11(uParam0))
	{
		if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
...
void func_409(var uParam0, int iParam1)//Position - 0x30367
{
	func_410(&(uParam0->f_28), iParam1);
}

void func_410(var uParam0, int iParam1)//Position - 0x30379
{
	int iVar0;
...
void func_411(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x303BA
{
	if (ENTITY::DOES_ENTITY_EXIST(*uParam0))
	{
...
void func_414(bool bParam0)//Position - 0x304D2
{
	int iVar0;
	...
	if (!func_431())
	{
		...
		{
			func_184(iVar0, 1, 0);
			func_415(SCRIPT::GET_THIS_SCRIPT_NAME(), iVar0);
		}
		else
		{
			if (Global_96440[iVar0 /*10*/].f_9 == -1)
...
void func_415(char* sParam0, int iParam1)//Position - 0x305A2
{
	if (Global_89962 != 12)
	{
...
int func_416(char* sParam0, int iParam1, int iParam2)//Position - 0x305CA
{
	var uVar0;
	struct<32> Var1;
	int iVar33;
	...
	if (func_422())
	{
		...
		{
			iVar33 = func_417(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_417(char* sParam0)//Position - 0x3075C
{
...
int func_418()//Position - 0x307B6
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_419(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_419(char* sParam0, bool bParam1)//Position - 0x307DA
{
	int iVar0;
	int iVar1;
...
int func_420(int iParam0, bool bParam1)//Position - 0x30804
{
	int iVar0;
...
int func_422()//Position - 0x3088A
{
	...
	{
		if (func_417(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_423(int iParam0)//Position - 0x308F6
{
	HUD::DISPLAY_HUD(iParam0);
	HUD::DISPLAY_RADAR(iParam0);
}

void func_424(int iParam0)//Position - 0x3090A
{
	if (iParam0 == 1)
	{
		HUD::THEFEED_PAUSE();
...
void func_425(int iParam0)//Position - 0x30947
{
	if (iParam0 == 1)
	{
...
void func_426()//Position - 0x30984
{
	Global_17098.f_5 = 1;
}

void func_427()//Position - 0x30992
{
	Global_17098.f_5 = 0;
}

void func_428(bool bParam0)//Position - 0x309A0
{
	if (bParam0)
	{
		func_429();
...
void func_429()//Position - 0x30A03
{
...
void func_430()//Position - 0x30A2C
{
	Global_84543 = 0;
	Global_84544 = 0;
}

int func_431()//Position - 0x30A3E
{
	if (((Global_89962 == 13 || Global_89962 == 10) || Global_89962 == 11) || Global_89962 == 12)
	{
		return 0;
...
void func_432()//Position - 0x30A7C
{
	Global_89997 = 1;
...
void func_433(char* sParam0)//Position - 0x30B6F
{
	if (!MISC::IS_STRING_NULL_OR_EMPTY(sParam0))
	{
	}
...
void func_434(var uParam0)//Position - 0x30B81
{
...
void func_435(var uParam0)//Position - 0x30BA1
{
	int iVar0;
