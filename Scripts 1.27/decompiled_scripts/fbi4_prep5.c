...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_189 = "FBIPRE";
	Local_198 = { 0f, 0f, 0f };
	Local_199 = { 20.8336f, -1113.793f, 28.797f };
	sLocal_201 = "FBIPRAU";
	iLocal_372 = -1;
	...
	Global_17C49.f_6C1.f_21B.f_65F[0] = -99;
	Global_17C49.f_6C1.f_21B.f_65F[1] = -99;
	Global_17C49.f_6C1.f_21B.f_65F[2] = -99;
	while (true)
	{
...
void func_1()//Position - 0x1C6
{
	switch (iLocal_81)
	{
		case 0:
			...
			HUD::CLEAR_HELP(1);
			func_20();
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_188))
			{
				if (MISC::ARE_STRINGS_EQUAL(sLocal_188, "PRE_FKICKOFF"))
				{
					while ((MISC::GET_GAME_TIMER() - iLocal_372) < 2000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_4(int iParam0)//Position - 0x283
{
	...
	if (Global_17C49.f_1CAD || func_221(0))
	{
		iVar0 = func_17();
		if (!func_5(iVar0))
		{
...
void func_22()//Position - 0x1296
{
	...
	{
		case 0:
			if (func_88(iLocal_80, bLocal_27))
			{
				func_86("PRE_LEAVE", &iLocal_190);
				iLocal_81 = 1;
			}
			break;
		...
		case 2:
			...
			{
				func_21(&uLocal_196);
				if (func_43(&uLocal_82, &cLocal_367, &uLocal_202))
				{
					func_38();
				}
			}
...
void func_36(int iParam0, struct<3> Param1, float fParam2)//Position - 0x16C8
{
	if (func_190(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_37(iParam0, Param1, fParam2, 0, 1);
}

int func_37(var uParam0, struct<3> Param1, var uParam2, bool bParam3, int iParam4)//Position - 0x16EE
{
	bool bVar0;
	float fVar1;
	...
	if (func_26(uParam0))
	{
		...
		ENTITY::SET_ENTITY_HEADING(uParam0, uParam2);
		if (bParam3)
		{
			return bVar0;
		}
...
void func_39(bool bParam0, int iParam1)//Position - 0x1767
{
	...
	if (bParam0)
	{
		if ((func_221(0) && Global_10B8B.f_1 == 1) && func_40(Global_10B8B))
		{
		}
		else
		{
...
int func_57(int iParam0)//Position - 0x1FCF
{
	...
	return Global_15725[func_58(iParam0)];
}
...
int func_88(int iParam0, bool bParam1)//Position - 0x2E90
{
	...
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_36(PLAYER::PLAYER_PED_ID(), Local_199, 354.7487f);
				bLocal_27 = false;
				func_23(1, 1, 1);
			}
			else
...
int func_89(int iParam0, struct<3> Param1, float fParam2)//Position - 0x2F3B
{
	switch (iParam0)
	{
		case 0:
			if (func_90(Param1, Local_198, 1056964608) && fParam2 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_189, 0);
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_201, 6);
...
int func_90(struct<3> Param0, struct<3> Param1, float fParam2)//Position - 0x2FA2
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_93()//Position - 0x3052
{
	...
	switch (iLocal_81)
	{
		case 0:
			if (func_88(iLocal_80, bLocal_27))
			{
				func_101(&uLocal_196, Local_199, 1, 1, "PRE_BLIP");
				if (HUD::DOES_BLIP_EXIST(uLocal_196))
				{
					HUD::SET_BLIP_COLOUR(uLocal_196, 2);
					HUD::SET_BLIP_ROUTE_COLOUR(uLocal_196, 2);
				}
				func_86("PRE_GCLOTH", &iLocal_190);
				iLocal_81 = 1;
			}
			break;
		...
		case 1:
			func_99();
			if (func_98(PLAYER::PLAYER_PED_ID(), Local_199, 2f) && func_97(28))
			{
				if (!iLocal_195)
				{
					PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
			...
			else
			{
				...
				else
				{
					...
					if (!func_98(PLAYER::PLAYER_PED_ID(), Local_199, 75f))
					{
						if (!iLocal_194)
						{
							func_21(&uLocal_196);
						...
						func_101(&uLocal_196, Local_199, 1, 1, "PRE_SHOP");
					}
					else if (func_98(PLAYER::PLAYER_PED_ID(), Local_199, 12f))
					{
						if (iLocal_194)
						{
							func_21(&uLocal_196);
		...
		case 2:
			...
			while (iVar0 < 3)
			{
				...
				{
					case 0:
						switch (Global_17C49.f_6C1.f_21B.f_65F[0])
						{
							case 20:
								if (Global_17C49.f_6C1.f_21B.f_65F[1] == 13 || Global_17C49.f_6C1.f_21B.f_65F[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 21:
								if (Global_17C49.f_6C1.f_21B.f_65F[1] == 14 || Global_17C49.f_6C1.f_21B.f_65F[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 22:
								if (Global_17C49.f_6C1.f_21B.f_65F[1] == 15 || Global_17C49.f_6C1.f_21B.f_65F[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 1:
						switch (Global_17C49.f_6C1.f_21B.f_65F[1])
						{
							case 13:
								if (Global_17C49.f_6C1.f_21B.f_65F[0] == 20 || Global_17C49.f_6C1.f_21B.f_65F[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 14:
								if (Global_17C49.f_6C1.f_21B.f_65F[0] == 21 || Global_17C49.f_6C1.f_21B.f_65F[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 15:
								if (Global_17C49.f_6C1.f_21B.f_65F[0] == 22 || Global_17C49.f_6C1.f_21B.f_65F[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 2:
						switch (Global_17C49.f_6C1.f_21B.f_65F[2])
						{
							case 17:
								if (Global_17C49.f_6C1.f_21B.f_65F[0] == 20 || Global_17C49.f_6C1.f_21B.f_65F[1] == 13)
								{
									bVar1 = false;
								}
								break;
							...
							case 18:
								if (Global_17C49.f_6C1.f_21B.f_65F[0] == 21 || Global_17C49.f_6C1.f_21B.f_65F[1] == 14)
								{
									bVar1 = false;
								}
								break;
							...
							case 19:
								if (Global_17C49.f_6C1.f_21B.f_65F[0] == 22 || Global_17C49.f_6C1.f_21B.f_65F[1] == 15)
								{
									bVar1 = false;
								}
								break;
		...
		case 3:
			Global_17C49.f_6C1.f_21B.f_65F[0] = 20;
			Global_17C49.f_6C1.f_21B.f_65F[1] = 13;
			Global_17C49.f_6C1.f_21B.f_65F[2] = 17;
			func_23(1, 1, 1);
			iLocal_81 = 1;
			break;
	}
...
{
	func_95(iLocal_80);
	iLocal_187 = iLocal_80;
	if (!bParam0)
	{
		iLocal_80 = iLocal_187 + 1;
	}
...
bool func_98(int iParam0, struct<3> Param1, float fParam2)//Position - 0x357F
{
...
void func_101(var uParam0, struct<3> Param1, int iParam2, bool bParam3, char* sParam4)//Position - 0x3608
{
	if (!HUD::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_102(Param1, 5, iParam2);
		if (bParam3)
		{
...
int func_102(struct<3> Param0, int iParam1, int iParam2)//Position - 0x3637
{
	int iVar0;
		...
		case 0:
			if (func_88(iLocal_80, 0))
			{
				if (func_228())
				{
					...
					func_109(&iVar3, Var1, fVar2, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
					func_106(0, -1, 1);
...
void func_109(int iParam0, struct<3> Param1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x38DE
{
	int iVar0;
	...
	if (iVar0 == 1)
	{
		if (!func_170(iParam4, iParam5, iParam6))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_157(Param1, fParam2);
	}
	else if (iParam7 == 1)
	{
		...
		{
			func_145(iParam10, 0);
			while (!func_110(iParam0, iParam10, Param1, fParam2, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_110(int iParam0, int iParam1, struct<3> Param2, float fParam3, bool bParam4, int iParam5)//Position - 0x3A66
{
	var uVar0;
	var uVar1;
	struct<73> Var2;
		...
		if (Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_141(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[0 /*223*/][iParam1 /*74*/].f_39));
		...
		else if (Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/] == Var2)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/], Param2, fParam3, 0, 0);
				...
				func_141(iParam0, &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[1 /*223*/][iParam1 /*74*/].f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var2))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var2, Param2, fParam3, 1, 1);
				...
				func_141(iParam0, &(Var2.f_1F), &(Var2.f_39));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var2.f_48);
				if (iParam1 == 1)
				{
...
void func_111(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x484D
{
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		{
			func_115(iParam1, &(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_1F), &(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_39));
			if (bParam3)
			{
				...
				Global_17C49.f_5B2F[iParam0 /*43*/].f_1F = func_114(*iParam1);
				...
				func_112(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_1));
				...
				func_112(Global_17C49.f_6C1.f_21B.f_663[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_17C49.f_5B2F[iParam0 /*43*/].f_2));
			}
		}
	}
}
...
int func_112(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x542C
{
	...
	iVar0 = 0;
	while (func_113(iVar0, &sVar2, &iVar1, &iVar3, &iVar4))
	{
...
void func_120(int iParam0, int iParam1)//Position - 0x6FC9
{
	...
	func_121(iParam0, &(Global_17C49.f_47C3.f_1286));
}
...
void func_121(int iParam0, var uParam1)//Position - 0x71CA
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_115(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_35), func_122(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_145(int iParam0, int iParam1)//Position - 0x83C2
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_15692[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_15692[iVar0]) == func_146(iParam0, iParam1))
				{
...
void func_147(struct<3> Param0, float fParam1, int iParam2)//Position - 0x84A5
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_155(&(Global_10642.f_22B[0 /*21*/]), iVar0))
		{
...
void func_148(int iParam0)//Position - 0x84F5
{
	...
	if (func_155(&(Global_10642.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_154(iParam0, 0)) && Global_109CF.f_2A == 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] != 0) && Global_17C49.f_47C3.f_57E[Global_10642.f_22B[0 /*21*/].f_E] > 3) && (!func_152(0, Global_10642.f_22B[0 /*21*/].f_C) || !func_152(1, Global_10642.f_22B[0 /*21*/].f_C)))
			{
				func_151(Global_17C49.f_47C3.f_45[Global_10642.f_22B[0 /*21*/].f_E /*54*/], &Global_109CF);
...
void func_151(struct<54> Param0, var uParam1)//Position - 0x8702
{
...
int func_152(int iParam0, int iParam1)//Position - 0x87CD
{
	...
	if (iParam0 < 0 || iParam0 >= func_153(&(Global_17C49.f_47C3.f_113E[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_126(Global_17C49.f_47C3.f_113E[iVar0 /*109*/][iParam0 /*54*/].f_2A);
}
...
int func_155(var uParam0, int iParam1)//Position - 0x886C
{
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_156(Global_17C49.f_47C3.f_520[uParam0->f_E /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_156(Global_17C49.f_6C1.f_21B.f_9E0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_156(Global_17C49.f_6C1.f_21B.f_9E0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f))
		{
...
bool func_156(struct<3> Param0, struct<3> Param1)//Position - 0x9F60
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

int func_157(struct<3> Param0, float fParam1)//Position - 0x9F89
{
	return func_158(&(Global_16D94.f_877), Param0, fParam1, 0);
}

int func_158(var uParam0, struct<3> Param1, float fParam2, bool bParam3)//Position - 0x9FA3
{
	int iVar0;
	struct<3> Var1;
	bool bVar2;
...
int func_160(int iParam0, struct<3> Param1, bool bParam2)//Position - 0xA310
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_161(iParam0, Global_10642.f_8B[38], 0))
			{
				func_148(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_161(iParam0, Global_10642.f_8B[43], 1))
			{
				func_148(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_161(iParam0, uVar1[iVar3], 1) && func_90(ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam2 || func_156(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar3], 1), 1) < 10f)
					{
...
void func_162(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xA576
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_35, 15) || func_164(iParam0)) || (((uParam1->f_26 == 0 && uParam1->f_27 == 0) && uParam1->f_28 == 0) && uParam1->f_9[20] > 0)) && func_163())
		{
			uParam1->f_26 = 0;
			uParam1->f_27 = 0;
			uParam1->f_28 = 0;
		...
		if (bParam3)
		{
			func_141(&iParam0, &(uParam1->f_9), &(uParam1->f_23));
		}
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_2A) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_2A))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_35, func_122(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
{
	return func_165(&(Global_16D94.f_877));
}

void func_168()//Position - 0xAA30
{
	func_169(&(Global_16D94.f_877));
}
...
int func_170(int iParam0, int iParam1, int iParam2)//Position - 0xAA61
{
	...
	if (iParam2 == 0 && func_172(Global_16D94.f_877.f_C.f_2A))
	{
		return 0;
	}
	if (iParam0 == 1)
...
{
	return func_166(&(Global_16D94.f_877));
}

bool func_174(struct<3> Param0, int iParam1)//Position - 0xABB1
{
	return func_175(Global_16D94.f_877.f_C.f_2A, Param0, iParam1);
}

int func_175(int iParam0, struct<3> Param1, int iParam2)//Position - 0xABCE
{
	struct<3> Var0;
	struct<3> Var1;
...
void func_177()//Position - 0xAC4F
{
	if (!bLocal_27 && iLocal_80 != 3)
	{
		if (iLocal_80 > 0)
		{
			...
			if (!bLocal_192)
			{
				if (!func_98(PLAYER::PLAYER_PED_ID(), Local_199, 150f))
				{
					func_184(2);
				}
				else if (!func_98(PLAYER::PLAYER_PED_ID(), Local_199, 75f))
				{
					if (!bLocal_200)
					{
						HUD::CLEAR_PRINTS();
						func_178("PRE_RETSHOP", &bLocal_200);
					}
				}
			}
		}
...
int func_179()//Position - 0xAD23
{
	...
	if (!func_180(bLocal_192, iVar0) && !bLocal_192)
	{
		return 0;
	}
	return 1;
...
void func_184(int iParam0)//Position - 0xADE0
{
	...
	switch (iParam0)
	{
		...
		case 1:
			sLocal_188 = "PRE_FKICKOFF";
			break;
		
		case 2:
			sLocal_188 = "PRE_FLEFT";
			break;
...
void func_186()//Position - 0xAE89
{
	if (func_188())
	{
		...
		{
			case 0:
				if (Global_17C49.f_6C1.f_21B.f_65F[0] == -99)
				{
					func_187(sLocal_79[0], sLocal_79[1], sLocal_79[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_65F[1] == -99)
				{
					func_187(sLocal_79[1], sLocal_79[0], sLocal_79[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_65F[2] == -99)
				{
			...
			case 1:
				if (Global_17C49.f_6C1.f_21B.f_65F[1] == -99)
				{
					func_187(sLocal_79[1], sLocal_79[0], sLocal_79[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_65F[0] == -99)
				{
					func_187(sLocal_79[0], sLocal_79[1], sLocal_79[2]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_65F[2] == -99)
			...
			case 2:
				if (Global_17C49.f_6C1.f_21B.f_65F[2] == -99)
				{
					func_187(sLocal_79[2], sLocal_79[1], sLocal_79[0]);
				}
				else if (Global_17C49.f_6C1.f_21B.f_65F[0] == -99)
...
int func_189()//Position - 0xB090
{
	...
	while (iVar1 <= 2)
	{
		if (Global_17C49.f_6C1.f_21B.f_65F[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
void func_192(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xB13C
{
	...
	func_193(Global_17C49.f_744E[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_196(int iParam0)//Position - 0xBAFE
{
	...
	else if (MISC::IS_BIT_SET(Global_17C49.f_5CED.f_1D7, iParam0) || MISC::IS_BIT_SET(Global_200000[func_198() /*8053*/].f_167C.f_A, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_17C49.f_5CED.f_1D7), iParam0);
		MISC::CLEAR_BIT(&(Global_200000[func_198() /*8053*/].f_167C.f_A), iParam0);
	}
	if (bVar0)
	{
...
bool func_200(int iParam0)//Position - 0xBC67
{
	...
	return MISC::IS_BIT_SET(Global_200000[func_198() /*8053*/].f_167C.f_A, iParam0);
}
...
int func_203(int iParam0, int iParam1)//Position - 0xBD75
{
	...
	if (func_213(&Global_26D4DB))
	{
		if (func_211(&Global_26D4DB, iParam0))
		{
			return 0;
		}
		if (func_204(&Global_26D4DB, iParam0))
		{
			return 1;
		}
	}
...
void func_227(struct<3> Param0, float fParam1, int iParam2, int iParam3)//Position - 0xC5CC
{
	if (func_228())
	{
...
{
	Global_10A0A[1 /*14*/] = { func_232(iParam0, iParam1, iParam2) };
	if (MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_10A0A[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_231(iParam1, Global_10A0A[1 /*14*/].f_5, Global_10A0A[1 /*14*/].f_2, 0, Global_10A0A[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_231(iParam1, Global_10A0A[1 /*14*/].f_5, Global_10A0A[1 /*14*/].f_2, 0, Global_10A0A[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
void func_234(int iParam0)//Position - 0xD80F
{
	...
	switch (iParam0)
	{
		...
		default:
			func_242(iVar7, iParam0, 155);
			return;
			break;
	}
	func_235(&(Global_10A0A[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}
...
void func_235(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xEA85
{
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_239(Global_280004, 1, 1, 1, -1))
			{
				MISC::CLEAR_BIT(&(uParam0->f_6), 2);
			}
			if (!func_239(Global_280004, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_13(14))
			{
				uVar0 = func_82(func_238(iParam1, uParam0->f_2), Global_10A08, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_82(func_237(iParam1, uParam0->f_2), Global_10A08, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_82(iVar1, Global_10A08, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_242(int iParam0, int iParam1, int iParam2)//Position - 0x101BB
{
		...
		while (iVar3 < iVar5)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_235(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_235(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_235(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var6.f_1, joaat("OUTFIT_ONLY"), 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 6, -1, 0, -1, func_243(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_235(&(Global_10A0A[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var11.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_300(var uParam0, int iParam1)//Position - 0x21751
{
	...
	{
		func_304(&uLocal_83, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_303(&uLocal_83);
	func_301(&uLocal_135, &uLocal_83, 50f);
}
...
void func_301(var uParam0, var uParam1, float fParam2)//Position - 0x21795
{
	...
	while (iVar1 < uParam1->f_2E)
	{
		...
		if (func_302(uParam1, *(uParam1[iVar1 /*3*/]) + Var5))
		{
			Var5 = { -Var5 };
		}
...
bool func_302(var uParam0, struct<2> Param1, Vector3 vParam2)//Position - 0x218A2
{
	bool bVar0;
	int iVar1;
	int iVar2;
