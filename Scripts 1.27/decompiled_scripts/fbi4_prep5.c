...
void __EntryFunction__()//Position - 0x0
{
	...
	sLocal_192 = "FBIPRE";
	Local_201 = { 0f, 0f, 0f };
	Local_204 = { 20.8336f, -1113.793f, 28.797f };
	sLocal_208 = "FBIPRAU";
	iLocal_379 = -1;
	...
	if (func_228())
	{
		func_227(16.5342f, -1122.583f, 27.8635f, 354.7487f, 1, 0);
	}
	func_222();
	if (func_221(0))
	{
	...
	Global_97353.f_1729.f_539.f_1631[0] = -99;
	Global_97353.f_1729.f_539.f_1631[1] = -99;
	Global_97353.f_1729.f_539.f_1631[2] = -99;
	while (true)
	{
...
void func_1()//Position - 0x1C6
{
	switch (iLocal_84)
	{
		case 0:
			...
			HUD::CLEAR_HELP(1);
			func_20();
			if (!MISC::IS_STRING_NULL_OR_EMPTY(sLocal_191))
			{
				if (MISC::ARE_STRINGS_EQUAL(sLocal_191, "PRE_FKICKOFF"))
				{
					while ((MISC::GET_GAME_TIMER() - iLocal_379) < 2000)
					{
						SYSTEM::WAIT(0);
					}
				}
...
void func_4(int iParam0)//Position - 0x283
{
	int iVar0;
	
	if (Global_97353.f_7341 || func_221(0))
	{
		iVar0 = func_17();
		if (!func_5(iVar0))
		{
...
int func_5(int iParam0)//Position - 0x2C8
{
	int iVar0;
	int iVar1;
...
void func_6(var uParam0, int iParam1)//Position - 0x3DF
{
	int iVar0;
	int iVar1;
	struct<3> Var2;
...
void func_7(var uParam0)//Position - 0x5A8
{
	*uParam0 = -15;
}

int func_8(int iParam0, var uParam1, float fParam2)//Position - 0x5B6
{
	switch (iParam0)
	{
		case 11:
...
void func_9(int iParam0, bool bParam1)//Position - 0xF25
{
	if (bParam1)
	{
...
int func_11()//Position - 0x104A
{
	func_12();
	return Global_97353.f_1729.f_539.f_3213;
}

void func_12()//Position - 0x1063
{
	int iVar0;
...
bool func_13(int iParam0)//Position - 0x1160
{
	return Global_34913 == iParam0;
}

bool func_14(int iParam0)//Position - 0x116E
{
	return iParam0 < 3;
}

int func_15(int iParam0)//Position - 0x117A
{
	int iVar0;
	int iVar1;
...
int func_16(int iParam0)//Position - 0x11B7
{
	if (func_14(iParam0))
	{
...
void func_18(char* sParam0)//Position - 0x1216
{
	func_19(sParam0);
	func_4(0);
}

void func_19(char* sParam0)//Position - 0x1229
{
...
void func_20()//Position - 0x1268
{
	func_21(&uLocal_199);
}

void func_21(var uParam0)//Position - 0x1276
{
...
void func_22()//Position - 0x1296
{
	switch (iLocal_84)
	{
		case 0:
			if (func_88(iLocal_83, bLocal_27))
			{
				func_86("PRE_LEAVE", &iLocal_193);
				iLocal_84 = 1;
			}
			break;
		...
		case 2:
			if (func_78("PRE_LEAVE", 0, 0))
			{
				HUD::CLEAR_THIS_PRINT("PRE_LEAVE");
			}
			if ((MISC::GET_GAME_TIMER() - iLocal_378) > 2000)
			{
				func_21(&uLocal_199);
				if (func_43(&uLocal_85, &cLocal_374, &uLocal_209))
				{
					func_38();
				}
			}
		...
		case 3:
			func_36(PLAYER::PLAYER_PED_ID(), 16.0317f, -1118.455f, 27.8667f, 170.4274f);
			func_23(1, 1, 1);
			iLocal_84 = 2;
			break;
	}
...
void func_23(int iParam0, int iParam1, int iParam2)//Position - 0x135B
{
...
void func_24(int iParam0, bool bParam1)//Position - 0x138F
{
...
void func_25(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13CB
{
	var uVar0;
...
int func_26(int iParam0)//Position - 0x1472
{
	if (ENTITY::DOES_ENTITY_EXIST(uParam0))
	{
...
void func_27(bool bParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1492
{
	if (bParam0)
	{
	...
	else
	{
		...
		if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()) && !func_28(PLAYER::PLAYER_ID()))
		{
...
int func_28(int iParam0)//Position - 0x1563
{
...
bool func_29()//Position - 0x15A4
{
	return MISC::IS_BIT_SET(Global_2359301, 3);
}

bool func_30(int iParam0, int iParam1)//Position - 0x15B5
{
	bool bVar0;
...
int func_31(int iParam0, bool bParam1)//Position - 0x1600
{
	int iVar0;
	int iVar1;
...
int func_32()//Position - 0x1641
{
	return Global_1312737;
}

int func_33(int iParam0, var uParam1, var uParam2)//Position - 0x164D
{
	int iVar0;
...
void func_35(int iParam0)//Position - 0x16A5
{
	if (iParam0 == 1)
	{
...
void func_36(int iParam0, struct<3> Param1, float fParam4)//Position - 0x16C8
{
	if (func_190(iParam0))
	{
		TASK::CLEAR_PED_TASKS(iParam0);
	}
	func_37(iParam0, Param1, fParam4, 0, 1);
}

int func_37(var uParam0, struct<3> Param1, var uParam4, bool bParam5, int iParam6)//Position - 0x16EE
{
	bool bVar0;
	float fVar1;
...
void func_39(bool bParam0, int iParam1)//Position - 0x1767
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	if (bParam0)
	{
		if ((func_221(0) && Global_68491.f_1 == 1) && func_40(Global_68491))
		{
		}
		else
		{
...
int func_40(int iParam0)//Position - 0x183D
{
	switch (iParam0)
	{
		case 71:
...
void func_41()//Position - 0x187B
{
	Global_14558 = 0;
	func_42();
}

void func_42()//Position - 0x188B
{
...
int func_43(var uParam0, char* sParam1, var uParam2)//Position - 0x18E2
{
	switch (*uParam0)
	{
		case 0:
			if (func_76())
			{
				if ((func_75(74) || func_75(75)) && func_74())
				{
					...
					else
					{
						...
						if (func_60(uParam2, func_70(), func_11(), "FBIPRAU", func_69(), 9, 1, 0, 0, 0))
						{
							*sParam1 = { func_59(1) };
							func_72(46, 1);
							*uParam0 = 1;
...
void func_44(int iParam0, int iParam1)//Position - 0x1A57
{
...
int func_45(int iParam0)//Position - 0x1A94
{
	if (iParam0 == 1)
	{
		if (Global_14393.f_1 > 3)
...
void func_47(bool bParam0)//Position - 0x1B11
{
...
void func_48(char* sParam0, char* sParam1)//Position - 0x1B25
{
	if (AUDIO::IS_MOBILE_PHONE_CALL_ONGOING())
	{
		Global_15749 = 1;
...
void func_50()//Position - 0x1B6B
{
	...
	func_51(func_54(), 0, func_11(), func_70(), 9, 6000, 6000, -1, 0, -1, 0);
}

int func_51(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1BC2
{
	struct<15> Var0;
	int iVar15;
...
void func_52(int iParam0)//Position - 0x1D13
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_53(int iParam0)//Position - 0x1DD7
{
	switch (iParam0)
	{
		case 0:
...
int func_55()//Position - 0x1F67
{
	return Global_68507;
}

int func_56(int iParam0, int iParam1)//Position - 0x1F73
{
	int iVar0;
...
int func_57(int iParam0)//Position - 0x1FCF
{
	if (iParam0 > 3)
	{
		return 0;
	...
	return Global_87845[func_58(iParam0)];
}

int func_58(int iParam0)//Position - 0x2000
{
	if (iParam0 == 0)
	{
		return 0;
...
struct<4> func_59(bool bParam0)//Position - 0x203B
{
	struct<4> Var0;
...
bool func_60(var uParam0, var uParam1, int iParam2, char* sParam3, char* sParam4, int iParam5, int iParam6, int iParam7, int iParam8, bool bParam9)//Position - 0x20A1
{
...
int func_61(char* sParam0, int iParam1, bool bParam2)//Position - 0x2109
{
	Global_15693 = 0;
...
bool func_67(int iParam0, int iParam1)//Position - 0x262C
{
	switch (iParam0)
	{
		case 5:
...
void func_68(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2667
{
...
void func_71(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x27FB
{
...
void func_72(int iParam0, int iParam1)//Position - 0x2896
{
...
void func_73(bool bParam0)//Position - 0x28DB
{
	if (bParam0)
	{
...
int func_75(int iParam0)//Position - 0x2977
{
...
int func_77(int iParam0)//Position - 0x29EB
{
	if (iParam0 == 144 || iParam0 == -1)
	{
		return 0;
...
bool func_78(char* sParam0, int iParam1, int iParam2)//Position - 0x2A18
{
...
void func_79(bool bParam0, int iParam1)//Position - 0x2A36
{
	int iVar0;
...
bool func_80(int iParam0)//Position - 0x2AD0
{
	return func_81(iParam0, 5, 1);
}

int func_81(int iParam0, int iParam1, bool bParam2)//Position - 0x2AE0
{
	if (bParam2)
	{
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_85() == 0)
		{
			return MISC::IS_BIT_SET(func_82(func_84(iParam0), -1, 0), iParam1);
		}
	}
	else
	{
...
int func_82(int iParam0, int iParam1, int iParam2)//Position - 0x2B40
{
	var uVar0;
	var uVar1;
...
int func_83(var uParam0)//Position - 0x2B72
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0)//Position - 0x2BA6
{
	switch (iParam0)
	{
		case 0:
...
int func_85()//Position - 0x2E4F
{
	return Global_24444;
}

void func_86(char* sParam0, int iParam1)//Position - 0x2E5A
{
	if (!*iParam1)
	{
...
void func_87(var uParam0, int iParam1, int iParam2)//Position - 0x2E77
{
	iParam2 = iParam2;
...
int func_88(int iParam0, bool bParam1)//Position - 0x2E90
{
	func_91();
	switch (iParam0)
	{
		...
		case 1:
			if (bParam1)
			{
				func_36(PLAYER::PLAYER_PED_ID(), Local_204, 354.7487f);
				bLocal_27 = false;
				func_23(1, 1, 1);
			}
			else
...
int func_89(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2F3B
{
	switch (iParam0)
	{
		case 0:
			if (func_90(Param1, Local_201, 1056964608) && fParam4 == 0f)
			{
				return 1;
			}
			break;
		...
		case 1:
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_192, 0);
			HUD::REQUEST_ADDITIONAL_TEXT(sLocal_208, 6);
...
int func_90(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x2FA2
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_91()//Position - 0x2FEE
{
	func_92(&uLocal_209);
}

void func_92(var uParam0)//Position - 0x2FFC
{
	int iVar0;
	char* sVar1;
...
void func_93()//Position - 0x3052
{
	...
	switch (iLocal_84)
	{
		case 0:
			if (func_88(iLocal_83, bLocal_27))
			{
				func_101(&uLocal_199, Local_204, 1, 1, "PRE_BLIP");
				if (HUD::DOES_BLIP_EXIST(uLocal_199))
				{
					HUD::SET_BLIP_COLOUR(uLocal_199, 2);
					HUD::SET_BLIP_ROUTE_COLOUR(uLocal_199, 2);
				}
				func_86("PRE_GCLOTH", &iLocal_193);
				iLocal_84 = 1;
			}
			break;
		...
		case 1:
			func_99();
			if (func_98(PLAYER::PLAYER_PED_ID(), Local_204, 2f) && func_97(28))
			{
				if (!iLocal_198)
				{
					PLAYER::CLEAR_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID());
			...
			else
			{
				...
				{
					if ((func_78("PRE_BUYM", 0, 0) || func_78("PRE_BUYT", 0, 0)) || func_78("PRE_BUYF", 0, 0))
					{
						HUD::CLEAR_PRINTS();
					}
					if (!func_98(PLAYER::PLAYER_PED_ID(), Local_204, 75f))
					{
						if (!iLocal_197)
						{
							func_21(&uLocal_199);
						...
						func_101(&uLocal_199, Local_204, 1, 1, "PRE_SHOP");
					}
					else if (func_98(PLAYER::PLAYER_PED_ID(), Local_204, 12f))
					{
						if (iLocal_197)
						{
							func_21(&uLocal_199);
		...
		case 2:
			...
			while (iVar0 < 3)
			{
				...
				{
					case 0:
						switch (Global_97353.f_1729.f_539.f_1631[0])
						{
							case 20:
								if (Global_97353.f_1729.f_539.f_1631[1] == 13 || Global_97353.f_1729.f_539.f_1631[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 21:
								if (Global_97353.f_1729.f_539.f_1631[1] == 14 || Global_97353.f_1729.f_539.f_1631[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 22:
								if (Global_97353.f_1729.f_539.f_1631[1] == 15 || Global_97353.f_1729.f_539.f_1631[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 1:
						switch (Global_97353.f_1729.f_539.f_1631[1])
						{
							case 13:
								if (Global_97353.f_1729.f_539.f_1631[0] == 20 || Global_97353.f_1729.f_539.f_1631[2] == 17)
								{
									bVar1 = false;
								}
								break;
							...
							case 14:
								if (Global_97353.f_1729.f_539.f_1631[0] == 21 || Global_97353.f_1729.f_539.f_1631[2] == 18)
								{
									bVar1 = false;
								}
								break;
							...
							case 15:
								if (Global_97353.f_1729.f_539.f_1631[0] == 22 || Global_97353.f_1729.f_539.f_1631[2] == 19)
								{
									bVar1 = false;
								}
								break;
					...
					case 2:
						switch (Global_97353.f_1729.f_539.f_1631[2])
						{
							case 17:
								if (Global_97353.f_1729.f_539.f_1631[0] == 20 || Global_97353.f_1729.f_539.f_1631[1] == 13)
								{
									bVar1 = false;
								}
								break;
							...
							case 18:
								if (Global_97353.f_1729.f_539.f_1631[0] == 21 || Global_97353.f_1729.f_539.f_1631[1] == 14)
								{
									bVar1 = false;
								}
								break;
							...
							case 19:
								if (Global_97353.f_1729.f_539.f_1631[0] == 22 || Global_97353.f_1729.f_539.f_1631[1] == 15)
								{
									bVar1 = false;
								}
								break;
		...
		case 3:
			Global_97353.f_1729.f_539.f_1631[0] = 20;
			Global_97353.f_1729.f_539.f_1631[1] = 13;
			Global_97353.f_1729.f_539.f_1631[2] = 17;
			func_23(1, 1, 1);
			iLocal_84 = 1;
			break;
	}
...
void func_94(bool bParam0)//Position - 0x34B3
{
	func_95(iLocal_83);
	iLocal_190 = iLocal_83;
	if (!bParam0)
	{
		iLocal_83 = iLocal_190 + 1;
	}
...
void func_95(int iParam0)//Position - 0x34E6
{
	switch (iParam0)
	{
		case 0:
...
void func_96(int iParam0)//Position - 0x34FE
{
	bool bVar0;
	int iVar1;
...
int func_97(int iParam0)//Position - 0x356F
{
	return func_81(iParam0, 6, 1);
}

bool func_98(int iParam0, struct<3> Param1, float fParam4)//Position - 0x357F
{
	return SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(uParam0, 1), Param1) <= (fParam4 * fParam4);
}

void func_99()//Position - 0x359C
{
	if (!iLocal_196)
	{
		if (func_80(28))
...
void func_100(int iParam0, bool bParam1)//Position - 0x35BE
{
	int iVar0;
...
void func_101(var uParam0, struct<3> Param1, int iParam4, bool bParam5, char* sParam6)//Position - 0x3608
{
	if (!HUD::DOES_BLIP_EXIST(*uParam0))
	{
		*uParam0 = func_102(Param1, 5, iParam4);
		if (bParam5)
		{
...
int func_102(struct<3> Param0, int iParam3, int iParam4)//Position - 0x3637
{
	int iVar0;
		...
		case 0:
			if (func_88(iLocal_83, 0))
			{
				if (func_228())
				{
					...
					func_109(&iVar5, Var1, fVar4, 0, 0, 0, 0, 0, joaat("asterope"), 0, 145);
					func_106(0, -1, 1);
					iVar0 = MISC::GET_GAME_TIMER();
					while (!func_105(28) && (MISC::GET_GAME_TIMER() - iVar0) < 2000)
					{
						SYSTEM::WAIT(0);
					}
					func_24(500, 1);
...
void func_104(int iParam0)//Position - 0x3796
{
...
bool func_105(int iParam0)//Position - 0x37CD
{
	return func_81(iParam0, 0, 1);
}

void func_106(int iParam0, int iParam1, int iParam2)//Position - 0x37DD
{
	if (func_228() && func_108())
	{
...
void func_107(int iParam0)//Position - 0x38A1
{
	if (iParam0 == 1)
	{
...
bool func_108()//Position - 0x38CA
{
	return MISC::IS_BIT_SET(Global_89962.f_20, 13);
}

void func_109(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x38DE
{
	int iVar0;
	
	iVar0 = 1;
	if (!func_228() || !func_173())
	{
		iVar0 = 0;
	}
	if (iVar0 == 1)
	{
		if (!func_170(iParam6, iParam7, iParam8))
		{
			iVar0 = 0;
		}
	}
	if (iVar0 == 1)
	{
		...
		*iParam0 = func_157(Param1, fParam4);
	}
	else if (iParam9 == 1)
	{
		if (func_156(Param1, 0f, 0f, 0f))
		{
			Param1 = { Global_93588.f_2167 };
			fParam4 = Global_93588.f_2167.f_6;
		}
		MISC::CLEAR_AREA(Param1, 5f, 1, 0, 0, 0);
		func_147(Param1, 5f, 0);
		if (func_14(iParam12))
		{
			func_145(iParam12, 0);
			while (!func_110(iParam0, iParam12, Param1, fParam4, 1, 0))
			{
				SYSTEM::WAIT(0);
			}
		}
...
int func_110(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x3A66
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
		...
		if (Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_141(iParam0, &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[0 /*223*/][iParam1 /*74*/].f_57));
		...
		else if (Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/] == Var5)
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/]))
			{
				*iParam0 = VEHICLE::CREATE_VEHICLE(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/], Param2, fParam5, 0, 0);
				...
				func_141(iParam0, &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[1 /*223*/][iParam1 /*74*/].f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 2)
				{
					if (ENTITY::GET_ENTITY_MODEL(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			if (STREAMING::HAS_MODEL_LOADED(Var5))
			{
				...
				*iParam0 = VEHICLE::CREATE_VEHICLE(Var5, Param2, fParam5, 1, 1);
				...
				func_141(iParam0, &(Var5.f_31), &(Var5.f_57));
				VEHICLE::SET_VEHICLE_ENVEFF_SCALE(*iParam0, Var5.f_72);
				if (iParam1 == 1)
				{
...
void func_111(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x484D
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_14(iParam0) && ENTITY::DOES_ENTITY_EXIST(*iParam1)) && VEHICLE::IS_VEHICLE_DRIVEABLE(*iParam1, 0))
	{
		...
		if ((VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) >= 0 && VEHICLE::GET_VEHICLE_MOD_KIT(*iParam1) < 255) && func_116(*iParam1, 0, &uVar0))
		{
			func_115(iParam1, &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_31), &(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_57));
			if (bParam3)
			{
				...
				Global_97353.f_23343[iParam0 /*43*/].f_31 = func_114(*iParam1);
				...
				func_112(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_5, Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_7, iVar3, 1, &(Global_97353.f_23343[iParam0 /*43*/].f_1));
				...
				func_112(Global_97353.f_1729.f_539.f_1635[iParam2 /*223*/][iParam0 /*74*/].f_6, -1, iVar3, 0, &(Global_97353.f_23343[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_112(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x542C
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_113(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x549F
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
float func_114(int iParam0)//Position - 0x6991
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_115(int iParam0, var uParam1, var uParam2)//Position - 0x6A4F
{
	int iVar0;
	int iVar1;
...
int func_116(int iParam0, bool bParam1, var uParam2)//Position - 0x6B29
{
	int iVar0;
	...
	*uParam2 = 0;
	...
	if (!func_118(iVar0, bParam1, uParam2))
	{
		return 0;
	}
	...
	{
		if ((func_117(iParam0) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("sentinel2")) && ENTITY::GET_ENTITY_MODEL(iParam0) != joaat("issi2"))
		{
			*uParam2 = 2;
			return 0;
		}
...
int func_117(int iParam0)//Position - 0x6BCB
{
	int iVar0;
...
int func_118(int iParam0, bool bParam1, var uParam2)//Position - 0x6C06
{
	if (!bParam1)
	{
...
int func_119(int iParam0)//Position - 0x6FA0
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_120(int iParam0, int iParam1)//Position - 0x6FC9
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_121(iParam0, &(Global_97353.f_18371.f_4742));
}

void func_121(int iParam0, var uParam1)//Position - 0x71CA
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		func_115(&iParam0, &(uParam1->f_9), &(uParam1->f_35));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
			{
				MISC::SET_BIT(&(uParam1->f_53), func_122(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_122(int iParam0)//Position - 0x7476
{
	switch (iParam0)
	{
		case 1:
...
void func_123(var uParam0)//Position - 0x7526
{
	int iVar0;
...
int func_124(int iParam0)//Position - 0x75D6
{
	if ((((((((((!ENTITY::DOES_ENTITY_EXIST(iParam0) || !VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0)) || func_136(iParam0, 0, 0)) || func_136(iParam0, 1, 0)) || func_136(iParam0, 2, 0)) || func_135(iParam0) != 145) || func_134(iParam0)) || func_133(iParam0)) || func_117(iParam0)) || func_132(iParam0)) || !func_125(ENTITY::GET_ENTITY_MODEL(iParam0)))
	{
		if (func_133(iParam0))
		{
		}
...
int func_125(int iParam0)//Position - 0x76B3
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_126(int iParam0)//Position - 0x7863
{
	int iVar0;
	struct<2> Var1;
...
int func_127()//Position - 0x7A32
{
	return 0;
}

int func_128()//Position - 0x7A3B
{
	return 1;
}

int func_129()//Position - 0x7A44
{
	return 1;
}

int func_130()//Position - 0x7A4D
{
...
int func_132(int iParam0)//Position - 0x7AE9
{
	int iVar0;
	var uVar1;
...
int func_133(int iParam0)//Position - 0x7B2E
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0x7BAA
{
	int iVar0;
...
int func_135(int iParam0)//Position - 0x7C92
{
	int iVar0;
...
int func_136(int iParam0, int iParam1, bool bParam2)//Position - 0x7CF5
{
	int iVar0;
	char* sVar1;
	int iVar9;
...
int func_137(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x7D66
{
...
void func_138(int iParam0, int iParam1)//Position - 0x7E3E
{
	int iVar0;
...
void func_139(var uParam0)//Position - 0x7EC0
{
	if (!func_140(*uParam0))
	{
...
bool func_140(int iParam0)//Position - 0x7EEB
{
	return VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, 5);
}

int func_141(var uParam0, var uParam1, var uParam2)//Position - 0x7EFA
{
	int iVar0;
	int iVar1;
...
int func_142(int iParam0)//Position - 0x802D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_143(var uParam0, var uParam1)//Position - 0x8109
{
	if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
	}
...
void func_144(int iParam0, var uParam1, int iParam2)//Position - 0x814A
{
	int iVar0;
	struct<74> Var1;
...
void func_145(int iParam0, int iParam1)//Position - 0x83C2
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_146(iParam0, iParam1))
				{
...
int func_146(int iParam0, int iParam1)//Position - 0x8463
{
	struct<58> Var0;
...
void func_147(struct<3> Param0, float fParam3, int iParam4)//Position - 0x84A5
{
	int iVar0;
	...
	while (iVar0 < 68)
	{
		if (func_155(&(Global_67138.f_555[0 /*21*/]), iVar0))
		{
...
void func_148(int iParam0)//Position - 0x84F5
{
	bool bVar0;
	...
	if (func_155(&(Global_67138.f_555[0 /*21*/]), iParam0))
	{
		...
		{
			if (((((iParam0 == 24 && func_154(iParam0, 0)) && Global_68047.f_42 == 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] != 0) && Global_97353.f_18371.f_1406[Global_67138.f_555[0 /*21*/].f_14] > 3) && (!func_152(0, Global_67138.f_555[0 /*21*/].f_12) || !func_152(1, Global_67138.f_555[0 /*21*/].f_12)))
			{
				func_151(Global_97353.f_18371.f_69[Global_67138.f_555[0 /*21*/].f_14 /*54*/], &Global_68047);
...
void func_149(int iParam0, bool bParam1)//Position - 0x866A
{
	if (iParam0 == -1)
	{
		return;
...
void func_150(int iParam0, int iParam1, bool bParam2)//Position - 0x86C7
{
	if (iParam0 == -1)
	{
		return;
...
void func_151(struct<54> Param0, var uParam54)//Position - 0x8702
{
...
int func_152(int iParam0, int iParam1)//Position - 0x87CD
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_153(&(Global_97353.f_18371.f_4414[iVar0 /*109*/])))
	{
		return 0;
	}
	return func_126(Global_97353.f_18371.f_4414[iVar0 /*109*/][iParam0 /*54*/].f_42);
}

int func_153(var uParam0)//Position - 0x883E
{
	return *uParam0;
}

bool func_154(int iParam0, int iParam1)//Position - 0x8849
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_155(var uParam0, int iParam1)//Position - 0x886C
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (MISC::IS_BIT_SET(uParam0->f_9, 10))
	{
		...
		if (!func_156(Global_97353.f_18371.f_1312[uParam0->f_14 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_156(Global_97353.f_1729.f_539.f_2528[1 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
	...
	{
		if (!func_156(Global_97353.f_1729.f_539.f_2528[0 /*10*/][uParam0->f_12 /*3*/], 0f, 0f, 0f))
		{
...
bool func_156(struct<3> Param0, struct<3> Param3)//Position - 0x9F60
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}

int func_157(struct<3> Param0, float fParam3)//Position - 0x9F89
{
	return func_158(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_158(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x9FA3
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_159(int iParam0)//Position - 0xA24E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_160(int iParam0, struct<3> Param1, bool bParam4)//Position - 0xA310
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	{
		case joaat("cargobob"):
			if (func_161(iParam0, Global_67138.f_139[38], 0))
			{
				func_148(38);
				return 1;
			}
		...
		case joaat("firetruk"):
			if (func_161(iParam0, Global_67138.f_139[43], 1))
			{
				func_148(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_161(iParam0, uVar1[iVar6], 1) && func_90(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_156(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_161(int iParam0, int iParam1, bool bParam2)//Position - 0xA516
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_162(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0xA576
{
	int iVar0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_164(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_163())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_122(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
bool func_163()//Position - 0xA963
{
	return DLC::IS_DLC_PRESENT(-1691188696);
}

int func_164(int iParam0)//Position - 0xA974
{
	var uVar0;
...
int func_165(var uParam0)//Position - 0xA9BF
{
	if (func_166(uParam0))
	{
...
int func_166(var uParam0)//Position - 0xA9F4
{
	if (uParam0->f_12.f_42 == 0)
	{
		return 0;
	}
	if (!func_126(uParam0->f_12.f_42))
	{
		return 0;
	}
	return 1;
...
bool func_167()//Position - 0xAA1D
{
	return func_165(&(Global_93588.f_2167));
}

void func_168()//Position - 0xAA30
{
	func_169(&(Global_93588.f_2167));
}

void func_169(var uParam0)//Position - 0xAA43
{
	if (func_166(uParam0))
	{
...
int func_170(int iParam0, int iParam1, int iParam2)//Position - 0xAA61
{
	...
	if (iParam2 == 0 && func_172(Global_93588.f_2167.f_12.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_172(int iParam0)//Position - 0xAB45
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_173()//Position - 0xAB9E
{
	return func_166(&(Global_93588.f_2167));
}

bool func_174(struct<3> Param0, int iParam3)//Position - 0xABB1
{
	return func_175(Global_93588.f_2167.f_12.f_42, Param0, iParam3);
}

int func_175(int iParam0, struct<3> Param1, int iParam4)//Position - 0xABCE
{
	struct<3> Var0;
	struct<3> Var3;
...
Vector3 func_176()//Position - 0xAC38
{
	return 2.55f, 5.59f, 2.55f;
}

void func_177()//Position - 0xAC4F
{
	if (!bLocal_27 && iLocal_83 != 3)
	{
		if (iLocal_83 > 0)
		{
			if (!bLocal_195)
			...
			if (!bLocal_195)
			{
				if (!func_98(PLAYER::PLAYER_PED_ID(), Local_204, 150f))
				{
					func_184(2);
				}
				else if (!func_98(PLAYER::PLAYER_PED_ID(), Local_204, 75f))
				{
					if (!bLocal_207)
					{
						HUD::CLEAR_PRINTS();
						func_178("PRE_RETSHOP", &bLocal_207);
					}
				}
			}
		}
...
void func_178(char* sParam0, bool bParam1)//Position - 0xAD06
{
	if (!*bParam1)
	{
		func_87(sParam0, 7500, 0);
...
int func_179()//Position - 0xAD23
{
	...
	if (!func_180(bLocal_195, iVar0) && !bLocal_195)
	{
		return 0;
	}
	return 1;
...
int func_180(bool bParam0, int iParam1)//Position - 0xAD60
{
	int iVar0;
...
int func_181(int iParam0, int iParam1)//Position - 0xADAC
{
	int iVar0;
...
int func_182(int iParam0)//Position - 0xADC1
{
	return Global_51925[iParam0];
}

bool func_183(int iParam0)//Position - 0xADD0
{
	return func_81(iParam0, 1, 1);
}

void func_184(int iParam0)//Position - 0xADE0
{
	HUD::CLEAR_PRINTS();
	func_41();
	switch (iParam0)
	{
		...
		case 1:
			sLocal_191 = "PRE_FKICKOFF";
			break;
		
		case 2:
			sLocal_191 = "PRE_FLEFT";
			break;
...
void func_186()//Position - 0xAE89
{
	if (func_188())
	{
		...
		{
			case 0:
				if (Global_97353.f_1729.f_539.f_1631[0] == -99)
				{
					func_187(sLocal_79[0], sLocal_79[1], sLocal_79[2]);
				}
				else if (Global_97353.f_1729.f_539.f_1631[1] == -99)
				{
					func_187(sLocal_79[1], sLocal_79[0], sLocal_79[2]);
				}
				else if (Global_97353.f_1729.f_539.f_1631[2] == -99)
				{
					func_187(sLocal_79[2], sLocal_79[1], sLocal_79[0]);
				}
				break;
			
			case 1:
				if (Global_97353.f_1729.f_539.f_1631[1] == -99)
				{
					func_187(sLocal_79[1], sLocal_79[0], sLocal_79[2]);
				}
				else if (Global_97353.f_1729.f_539.f_1631[0] == -99)
				{
					func_187(sLocal_79[0], sLocal_79[1], sLocal_79[2]);
				}
				else if (Global_97353.f_1729.f_539.f_1631[2] == -99)
			...
			case 2:
				if (Global_97353.f_1729.f_539.f_1631[2] == -99)
				{
					func_187(sLocal_79[2], sLocal_79[1], sLocal_79[0]);
				}
				else if (Global_97353.f_1729.f_539.f_1631[0] == -99)
...
void func_187(var uParam0, var uParam1, var uParam2)//Position - 0xB03F
{
	if (func_78(uParam1, 0, 0) || func_78(uParam2, 0, 0))
	{
		HUD::CLEAR_PRINTS();
	}
	if (!func_78(uParam0, 0, 0))
	{
		func_87(uParam0, 60000, 0);
	}
}

bool func_188()//Position - 0xB07B
{
	return MISC::GET_GAME_TIMER() <= Global_17236.f_5130 + 100;
}

int func_189()//Position - 0xB090
{
	int iVar0;
	int iVar1;
	...
	while (iVar1 <= 2)
	{
		if (Global_97353.f_1729.f_539.f_1631[iVar1] != -99)
		{
			iVar0++;
		}
		iVar1++;
...
int func_190(int iParam0)//Position - 0xB0CC
{
	if (func_26(uParam0))
	{
...
void func_191()//Position - 0xB0EC
{
	...
	if (func_182(iVar0) < 315)
	{
		func_192(func_11(), 94, 315, 0, 0);
	}
}

void func_192(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xB13C
{
	int iVar0;
	int iVar1;
	...
	func_193(Global_97353.f_29774[iParam0 /*29*/].f_17, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_193(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xB223
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_194(bool bParam0)//Position - 0xB822
{
	int iVar0;
	int iVar1;
...
void func_195(int iParam0)//Position - 0xBAA4
{
	int iVar0;
...
void func_196(int iParam0)//Position - 0xBAFE
{
	bool bVar0;
	char cVar1[64];
	...
	else if (MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0) || MISC::IS_BIT_SET(Global_2097152[func_198() /*8053*/].f_5756.f_10, iParam0))
	{
		bVar0 = true;
		MISC::CLEAR_BIT(&(Global_97353.f_23789.f_471), iParam0);
		MISC::CLEAR_BIT(&(Global_2097152[func_198() /*8053*/].f_5756.f_10), iParam0);
	}
	if (bVar0)
	{
...
char* func_197(int iParam0)//Position - 0xBBC0
{
	switch (iParam0)
	{
		case 0:
...
void func_199(int iParam0)//Position - 0xBC47
{
	func_216(93, iParam0);
	func_216(29, iParam0);
	func_216(30, iParam0);
...
bool func_200(int iParam0)//Position - 0xBC67
{
	if (!NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		return MISC::IS_BIT_SET(Global_97353.f_23789.f_471, iParam0);
	}
	return MISC::IS_BIT_SET(Global_2097152[func_198() /*8053*/].f_5756.f_10, iParam0);
}

int func_201(bool bParam0)//Position - 0xBCA3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_202(int iParam0, int iParam1)//Position - 0xBD5A
{
	if (iParam0 >= 61)
	{
		return 0;
...
int func_203(int iParam0, int iParam1)//Position - 0xBD75
{
	...
	if (func_213(&Global_2544859))
	{
		if (func_211(&Global_2544859, iParam0))
		{
			return 0;
		}
		if (func_204(&Global_2544859, iParam0))
		{
			return 1;
		}
	}
...
int func_204(var uParam0, int iParam1)//Position - 0xBDF9
{
	int iVar0;
	var uVar1[61];
...
int func_205(var uParam0, int iParam1)//Position - 0xBE7F
{
	int iVar0;
...
bool func_206(var uParam0, int iParam1)//Position - 0xBECF
{
	return (*uParam0)[iParam1] == 61;
}

void func_207(var uParam0)//Position - 0xBEE0
{
	int iVar0;
...
void func_208(var uParam0, float fParam1)//Position - 0xBF17
{
	uParam0->f_1 = (func_209(MISC::IS_BIT_SET(*uParam0, 4)) - fParam1);
	MISC::SET_BIT(uParam0, 1);
	MISC::CLEAR_BIT(uParam0, 2);
	uParam0->f_2 = 0f;
}

float func_209(bool bParam0)//Position - 0xBF45
{
	int iVar0;
...
void func_210(var uParam0, int iParam1)//Position - 0xBF8D
{
	(*uParam0)[iParam1] = 61;
}

bool func_211(var uParam0, int iParam1)//Position - 0xBF9D
{
	return func_212(uParam0, iParam1) != -1;
}

int func_212(var uParam0, int iParam1)//Position - 0xBFAF
{
	int iVar0;
...
bool func_213(var uParam0)//Position - 0xBFDC
{
	return uParam0->f_68 == 1;
}

int func_214(int iParam0, int iParam1)//Position - 0xBFEA
{
	int iVar0;
...
void func_215(int iParam0, int iParam1)//Position - 0xC03E
{
	int iVar0;
...
void func_216(int iParam0, int iParam1)//Position - 0xC061
{
	int iVar0;
...
void func_218(int iParam0)//Position - 0xC133
{
	if (Global_90014.f_17[iParam0])
	{
		func_219(iParam0, 10, 1);
		func_219(iParam0, 19, 1);
	}
}

void func_219(int iParam0, int iParam1, bool bParam2)//Position - 0xC15A
{
	var uVar0;
	...
	else if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS())
	{
		if (func_85() == 0)
		{
			uVar0 = func_82(func_84(iParam0), -1, 0);
			MISC::SET_BIT(&uVar0, iParam1);
			func_220(func_84(iParam0), uVar0, -1, 1);
		}
	}
	else
	{
...
void func_220(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC1C2
{
	int iVar0;
	
	iVar0 = Global_2454605[iParam0 /*6*/][func_83(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_221(bool bParam0)//Position - 0xC1ED
{
...
void func_223(int iParam0, bool bParam1, int iParam2)//Position - 0xC232
{
	if (bParam1)
	{
		if (!func_81(iParam0, 0, 0))
		{
			...
			{
				if (func_226(iParam0) == 3 && !func_80(iParam0))
				{
					func_218(iParam0);
...
void func_224(int iParam0)//Position - 0xC2F1
{
	Global_90014.f_153[iParam0] = 1;
	Global_90014.f_152 = 1;
}

void func_225(int iParam0, int iParam1, bool bParam2)//Position - 0xC30B
{
	var uVar0;
...
int func_226(int iParam0)//Position - 0xC373
{
	switch (iParam0)
	{
		case -1:
...
void func_227(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0xC5CC
{
	if (func_228())
	{
...
void func_229(bool bParam0)//Position - 0xC685
{
	func_230(joaat("player_zero"), 12, 20, bParam0);
	func_230(joaat("player_zero"), 12, 21, bParam0);
	func_230(joaat("player_zero"), 12, 22, bParam0);
	func_230(joaat("player_one"), 12, 13, bParam0);
	func_230(joaat("player_one"), 12, 14, bParam0);
	func_230(joaat("player_one"), 12, 15, bParam0);
	func_230(joaat("player_two"), 12, 17, bParam0);
	func_230(joaat("player_two"), 12, 18, bParam0);
	func_230(joaat("player_two"), 12, 19, bParam0);
}

int func_230(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0xC714
{
	Global_68106[1 /*14*/] = { func_232(iParam0, iParam1, iParam2) };
	if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0) && !MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_231(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 0, Global_68106[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_231(iParam1, Global_68106[1 /*14*/].f_5, Global_68106[1 /*14*/].f_2, 0, Global_68106[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_231(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC7AF
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
struct<14> func_232(int iParam0, int iParam1, int iParam2)//Position - 0xD6CD
{
	func_297();
...
void func_233(int iParam0, int iParam1)//Position - 0xD71F
{
	switch (iParam0)
	{
		case 0:
...
void func_234(int iParam0)//Position - 0xD80F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	switch (iParam0)
	{
		...
		default:
			func_242(iVar10, iParam0, 155);
			return;
			break;
	}
	func_235(&(Global_68106[0 /*14*/]), iVar10, iParam0, &Var2, iVar6, iVar7, iVar1, bVar0, iVar8, iVar9, 0);
}

void func_235(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xEA85
{
	var uVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else if (uParam0->f_5 >= 0 && uParam0->f_5 < 3)
	{
		MISC::SET_BIT(&(uParam0->f_6), 0);
		MISC::SET_BIT(&(uParam0->f_6), 5);
		if (func_231(iParam1, uParam0->f_5, uParam0->f_2, 0, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 1);
		}
		if (func_231(iParam1, uParam0->f_5, uParam0->f_2, 1, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 2);
		}
		if (!func_231(iParam1, uParam0->f_5, uParam0->f_2, 2, uParam0->f_1, 0, 0))
		{
			MISC::SET_BIT(&(uParam0->f_6), 4);
		}
	}
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_13(14))
			{
				uVar0 = func_82(func_238(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 1);
				}
				uVar0 = func_82(func_237(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
...
bool func_236(int iParam0, int iParam1, var uParam2)//Position - 0xEE08
{
	*uParam2 = 966;
	switch (iParam1)
	{
...
int func_237(int iParam0, int iParam1)//Position - 0xF20D
{
	switch (iParam1)
	{
		case 0:
...
int func_238(int iParam0, int iParam1)//Position - 0xF608
{
	switch (iParam1)
	{
		case 0:
...
int func_239(var uParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xFA03
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_240(uParam0, iParam1, &iVar2, &iVar1, bParam2, bParam3))
	{
...
bool func_240(var uParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0xFA45
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0x100E7
{
	switch (iParam0)
	{
		case -1:
...
void func_242(int iParam0, int iParam1, int iParam2)//Position - 0x101BB
{
	int iVar0;
	var uVar1;
	struct<8> Var2;
		...
		while (iVar17 < iVar19)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var2))
			{
				if (iVar18 == (iParam1 - iParam2))
				{
					...
					Global_2621445 = Var2;
					func_235(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar18++;
			}
	...
	{
		func_235(&(Global_68106[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_235(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(uVar1, 6, -1, 0, -1, func_243(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_235(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_243(int iParam0)//Position - 0x10436
{
	switch (iParam0)
	{
		case 0:
...
void func_244(int iParam0)//Position - 0x104E6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_245(int iParam0)//Position - 0x1063C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_246(int iParam0)//Position - 0x10B49
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_247(int iParam0)//Position - 0x10BBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_248(int iParam0)//Position - 0x10C30
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_249(int iParam0)//Position - 0x10D16
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_250(int iParam0)//Position - 0x11078
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_251(int iParam0)//Position - 0x11288
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252(int iParam0)//Position - 0x114B7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x115C6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x11F64
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x12AD6
{
	if (iParam0 < 136)
	{
		func_257(iParam0);
	...
	{
		func_242(3, iParam0, 242);
	}
}

void func_256(int iParam0)//Position - 0x12B0A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x1370E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x1461D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x14749
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0, int iParam1)//Position - 0x14846
{
	switch (iParam0)
	{
		case 0:
...
void func_261(int iParam0)//Position - 0x14936
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x15E26
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x15F76
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x16480
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x16AED
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x16B60
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x16C2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1715E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x172F4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x17AF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x17C00
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x18B2B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x197E7
{
	if (iParam0 < 107)
	{
		func_276(iParam0);
	...
	if (Global_68106[0 /*14*/].f_2 == -1)
	{
		func_242(3, iParam0, 318);
	}
}

void func_274(int iParam0)//Position - 0x1982C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1A2D1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1B0C0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1BD09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1BF81
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0, int iParam1)//Position - 0x1C0C8
{
	switch (iParam0)
	{
		case 0:
...
void func_280(int iParam0)//Position - 0x1C1B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1CF41
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1D0BA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x1D630
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x1DB59
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x1DBCC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x1DC9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x1E172
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x1E3DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x1E6AF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x1E877
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x1F3CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x20014
{
	if (iParam0 < 60)
	{
		func_294(iParam0);
	...
	if (Global_68106[0 /*14*/].f_2 == -1)
	{
		func_242(3, iParam0, 181);
	}
}

void func_293(int iParam0)//Position - 0x20048
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x20DE8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x21474
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x2155A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297()//Position - 0x21657
{
...
void func_298()//Position - 0x216D0
{
	func_307();
	func_306();
	func_299();
...
void func_299()//Position - 0x216E4
{
	struct<3> Var0[8];
...
void func_300(var uParam0, int iParam1)//Position - 0x21751
{
	int iVar0;
	...
	{
		func_304(&uLocal_86, *(uParam0[iVar0 /*3*/]));
		iVar0++;
	}
	func_303(&uLocal_86);
	func_301(&uLocal_138, &uLocal_86, 50f);
}

void func_301(var uParam0, var uParam1, float fParam2)//Position - 0x21795
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_302(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
bool func_302(var uParam0, struct<2> Param1, Vector3 vParam3)//Position - 0x218A2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_303(var uParam0)//Position - 0x2195E
{
	int iVar0;
	float fVar1;
...
void func_304(var uParam0, struct<3> Param1)//Position - 0x219FE
{
	if (uParam0->f_51 == 0)
	{
	}
...
void func_305(var uParam0)//Position - 0x21A2F
{
	if (uParam0->f_51)
	{
	}
...
void func_306()//Position - 0x21A56
{
	sLocal_79[0] = "PRE_BUYM";
	sLocal_79[1] = "PRE_BUYF";
	sLocal_79[2] = "PRE_BUYT";
}

void func_307()//Position - 0x21A79
{
}

void func_308()//Position - 0x21A81
{
	func_320(1);
	func_319();
	func_318();
...
void func_309(bool bParam0)//Position - 0x21A9F
{
	if (bParam0)
	{
	}
	...
	if (CAM::DOES_CAM_EXIST(uLocal_200))
	{
		CAM::RENDER_SCRIPT_CAMS(0, 0, 3000, 1, 0, 0);
		CAM::DESTROY_CAM(uLocal_200, 0);
	}
}

void func_310()//Position - 0x21B0A
{
}

void func_311()//Position - 0x21B12
{
	Global_14558 = 0;
	func_312();
}

void func_312()//Position - 0x21B22
{
	AUDIO::RESTART_SCRIPTED_CONVERSATION();
	Global_16703 = 0;
	if (AUDIO::IS_SCRIPTED_CONVERSATION_ONGOING())
...
void func_313()//Position - 0x21B43
{
}

void func_314()//Position - 0x21B4B
{
}

void func_315()//Position - 0x21B53
{
}

void func_316()//Position - 0x21B5B
{
}

void func_317(bool bParam0, int iParam1, int iParam2)//Position - 0x21B63
{
	bool bVar0;
...
void func_318()//Position - 0x21BC2
{
	func_223(21, 1, 0);
}

void func_319()//Position - 0x21BD2
{
	Global_86222 = 0;
}

void func_320(bool bParam0)//Position - 0x21BDF
{
...
void func_321()//Position - 0x21C26
{
	Global_97353.f_1729.f_539.f_1631[0] = -99;
	Global_97353.f_1729.f_539.f_1631[1] = -99;
	Global_97353.f_1729.f_539.f_1631[2] = -99;
...
void func_322()//Position - 0x21C6C
{
	int iVar0;
