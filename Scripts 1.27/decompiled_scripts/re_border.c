...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_41 = 49;
	iLocal_42 = 64;
	Local_46 = { 928.0903f, 1733.12f, 165.1067f };
	Local_47 = { 2374.21f, 316.6781f, 180.4001f };
	Local_48 = { -804.8174f, 4051.37f, 159.6384f };
	Local_45 = { ScriptParam_232.f_1[0 /*3*/] };
	func_140();
	...
	if (func_85(Local_45, 29, iLocal_49, 0, 0))
	{
		func_82(29);
	}
	else
...
void func_3(int iParam0, int iParam1)//Position - 0x214
{
	...
	if (iParam1 <= func_27(iParam0))
	{
		...
		{
			func_5(func_13(iParam0, iParam1), Local_43.x, Local_43.f_1);
		}
...
void func_4(int iParam0)//Position - 0x317
{
	Global_17C3B = iParam0;
}

void func_5(int iParam0, var uParam1, var uParam2)//Position - 0x325
{
	bool bVar0;
...
bool func_8(bool bParam0)//Position - 0x919
{
...
int func_11(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x9A0
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_13(int iParam0, int iParam1)//Position - 0xC07
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0xF7B
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0xFAA
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xFEC
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x100D
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x1443
{
	return Global_8861 == iParam0;
}

bool func_22(int iParam0)//Position - 0x1451
{
	return iParam0 < 3;
}

int func_23(var uParam0)//Position - 0x145D
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x149A
{
	if (func_22(iParam0))
	{
...
int func_25(int iParam0)//Position - 0x14C4
{
	int iVar0;
	int iVar1;
...
void func_26(int iParam0, int iParam1)//Position - 0x1507
{
	MISC::SET_BIT(&(Global_17C49.f_6E20.f_8[iParam0]), iParam1);
}

int func_27(int iParam0)//Position - 0x1522
{
	int iVar0;
...
int func_29(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x15F0
{
...
void func_30()//Position - 0x17CA
{
	func_7();
}

int func_31()//Position - 0x17D7
{
	return 1;
}
...
int func_32()//Position - 0x17E0
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
		{
			iVar1 = 0;
		}
		iVar0++;
...
int func_33()//Position - 0x1810
{
	...
	if (!func_49())
	{
		...
		while (iVar0 < 3)
		{
			if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
			{
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_62[iVar0], 0)) < 400f)
				{
					if (!iLocal_51)
					{
						if (iLocal_60 == 2)
						...
						if (((ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 1) || PED::IS_PED_SHOOTING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_TARGETTING_ENTITY(PLAYER::PLAYER_ID(), uLocal_62[iVar0])) || PLAYER::IS_PLAYER_FREE_AIMING_AT_ENTITY(PLAYER::PLAYER_ID(), uLocal_62[iVar0]))
						{
							iLocal_51 = 1;
							iLocal_54 = 1;
							iLocal_53 = 1;
					...
					if (!iLocal_51 || iLocal_60 < 3)
					{
						if (SYSTEM::TIMERA() > 5000)
						{
							if (!TASK::IS_PED_IN_WRITHE(uLocal_62[iVar0]))
							{
								func_48(&uLocal_67, 1);
								func_47(&uLocal_67, 1, uLocal_62[iVar0], "BorderPatrol", 0, 1);
								if (iLocal_60 == 0)
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
										if (func_46())
										{
											func_35(&uLocal_67, "REBORAU", "REBOR_INS1", 4, 0, 0, 0);
										}
										else
										{
											func_35(&uLocal_67, "REBORAU", "REBOR_INS2", 4, 0, 0, 0);
										}
										iLocal_60++;
									}
									else
								...
								{
									func_35(&uLocal_67, "REBORAU", "REBOR_STOP", 4, 0, 0, 0);
									iLocal_60++;
								}
								else
								{
									func_35(&uLocal_67, "REBORAU", "REBOR_PULL", 4, 0, 0, 0);
								}
								iLocal_52 = 1;
								iLocal_60++;
								if (iLocal_60 >= 3)
					...
					{
						if (!func_49() && !TASK::IS_PED_IN_WRITHE(uLocal_62[iVar0]))
						{
							PED::SET_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_65, 1862763509);
							PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_62[iVar0], 2, 1);
							func_48(&uLocal_67, 1);
							func_47(&uLocal_67, 1, uLocal_62[iVar0], "BorderPatrol", 0, 1);
							if (func_34() == 0)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_ATTM", 4, 0, 0, 0);
							}
							else if (func_34() == 1)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_ATTF", 4, 0, 0, 0);
							}
							else if (func_34() == 2)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_ATTT", 4, 0, 0, 0);
							}
							iLocal_53 = 1;
							iLocal_51 = 1;
							SYSTEM::SETTIMERA(0);
					...
					else if (!func_49())
					{
						if (!iLocal_55)
						{
							if (func_34() == 0)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_REACTM", 4, 0, 0, 0);
							}
							else if (func_34() == 1)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_REACTF", 4, 0, 0, 0);
							}
							else if (func_34() == 2)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_REACTT", 4, 0, 0, 0);
							}
							iLocal_55 = 1;
						}
						if (SYSTEM::TIMERA() > 5000 && !TASK::IS_PED_IN_WRITHE(uLocal_62[iVar0]))
						{
							func_48(&uLocal_67, 1);
							func_47(&uLocal_67, 1, uLocal_62[iVar0], "BorderPatrol", 0, 1);
							if (func_34() == 0)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_CONM", 4, 0, 0, 0);
							}
							else if (func_34() == 1)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_CONF", 4, 0, 0, 0);
							}
							else if (func_34() == 2)
							{
								func_35(&uLocal_67, "REBORAU", "REBOR_COTT", 4, 0, 0, 0);
							}
							SYSTEM::SETTIMERA(0);
						}
					}
...
int func_34()//Position - 0x1B93
{
	func_20();
	return Global_17C49.f_6C1.f_21B.f_C8D;
}

int func_35(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1BAC
{
...
int func_36(char* sParam0, int iParam1, bool bParam2)//Position - 0x1BFA
{
	Global_3D4D = 0;
...
bool func_43(int iParam0, int iParam1)//Position - 0x2144
{
	switch (iParam0)
	{
		case 5:
...
void func_45(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x21D6
{
	Global_3B2A = { *uParam0 };
	Global_62B = iParam1;
...
void func_47(var uParam0, int iParam1, var uParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x224D
{
...
void func_48(var uParam0, int iParam1)//Position - 0x22E8
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
int func_50()//Position - 0x2327
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
		{
			if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_62[iVar0], 0)) < 62500f)
			{
				return 1;
			}
			else
...
void func_51()//Position - 0x2381
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
		{
			...
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_62[iVar0], 0))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_56[iVar0])
					{
						if (!ENTITY::IS_ENTITY_DEAD(uLocal_63[iVar0]))
						{
							TASK::TASK_VEHICLE_MISSION(uLocal_62[iVar0], uLocal_63[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						}
						if (!iLocal_54)
						{
						...
						if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
						{
							if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_62[iVar0], 0))
							{
								TASK::TASK_DRIVE_BY(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 0, 0f, 0f, 0f, 1000f, 60, 1, -753768974);
								PED::SET_PED_KEEP_TASK(uLocal_62[iVar0], 1);
							}
						}
						iLocal_57[iVar0] = 0;
						iLocal_56[iVar0] = 1;
					}
					else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_57[iVar0])
					{
						if (!PED::IS_PED_INJURED(uLocal_62[iVar0]) && !ENTITY::IS_ENTITY_DEAD(uLocal_63[iVar0]))
						{
							TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_62[iVar0], uLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							if (!iLocal_54)
							{
								SYSTEM::WAIT(MISC::GET_RANDOM_INT_IN_RANGE(400, 800));
							}
				...
				else if (!PED::IS_PED_IN_ANY_VEHICLE(uLocal_62[iVar0], 0))
				{
					TASK::TASK_COMBAT_PED(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					PED::SET_PED_KEEP_TASK(uLocal_62[iVar0], 1);
				}
			}
			else if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_62[iVar0], 0))
			{
				if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_58[iVar0])
				{
					if (TASK::GET_SCRIPT_TASK_STATUS(uLocal_62[iVar0], 579380604) != 1 && TASK::GET_SCRIPT_TASK_STATUS(uLocal_62[iVar0], 579380604) != 0)
					{
						TASK::CLEAR_PED_TASKS(uLocal_62[iVar0]);
						if (!ENTITY::IS_ENTITY_DEAD(uLocal_63[iVar0]))
						{
							TASK::TASK_VEHICLE_MISSION(uLocal_62[iVar0], uLocal_63[iVar0], PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
							TASK::TASK_LOOK_AT_ENTITY(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
						}
						iLocal_59[iVar0] = 0;
						iLocal_58[iVar0] = 1;
					}
				}
				else if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && !iLocal_59[iVar0])
				{
					if ((!PED::IS_PED_INJURED(uLocal_62[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID())) && !ENTITY::IS_ENTITY_DEAD(uLocal_63[iVar0]))
					{
						TASK::CLEAR_PED_TASKS(uLocal_62[iVar0]);
						TASK::TASK_VEHICLE_MISSION_PED_TARGET(uLocal_62[iVar0], uLocal_63[iVar0], PLAYER::PLAYER_PED_ID(), iVar0 + 10, 30f, 786469, 10f, 5f, 1);
						TASK::TASK_LOOK_AT_ENTITY(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
			...
			{
				TASK::TASK_FOLLOW_TO_OFFSET_OF_ENTITY(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 1f, 0f, 0f, 2f, -1, 1036831949, 1);
			}
			if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
			{
				if (ENTITY::IS_ENTITY_IN_WATER(uLocal_62[iVar0]))
				{
					if (PED::IS_PED_IN_ANY_VEHICLE(uLocal_62[iVar0], 0))
					{
						TASK::TASK_LEAVE_ANY_VEHICLE(uLocal_62[iVar0], 0, 0);
					}
					if (!PED::IS_PED_IN_COMBAT(uLocal_62[iVar0], 0))
					{
						TASK::TASK_COMBAT_PED(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 0, 16);
					}
				}
			}
			if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0) && PED::IS_PED_IN_ANY_VEHICLE(uLocal_62[iVar0], 0))
			{
				if (ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()) > 13f)
				{
					if (ENTITY::IS_ENTITY_TOUCHING_ENTITY(PED::GET_VEHICLE_PED_IS_IN(PLAYER::PLAYER_PED_ID(), 0), PED::GET_VEHICLE_PED_IS_IN(uLocal_62[iVar0], 0)))
					{
						PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_62[iVar0], 3);
					}
					else
					{
						PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_62[iVar0], 1);
					}
				}
				else
				{
			...
			if (func_127())
			{
				TASK::TASK_SMART_FLEE_PED(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
			}
		}
		else if (ENTITY::DOES_ENTITY_EXIST(uLocal_62[iVar0]))
		{
			iLocal_54 = 1;
			iLocal_53 = 1;
		}
...
void func_52()//Position - 0x2857
{
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uLocal_62[iVar0]))
		{
			...
			{
				if (!HUD::DOES_BLIP_EXIST(uLocal_64[iVar0]))
				{
					uLocal_64[iVar0] = func_53(uLocal_62[iVar0], 1, 145);
				}
			}
		}
		else if (HUD::DOES_BLIP_EXIST(uLocal_64[iVar0]))
		{
			HUD::REMOVE_BLIP(&(uLocal_64[iVar0]));
		}
		iVar0++;
	}
}

var func_53(var uParam0, bool bParam1, int iParam2)//Position - 0x28C7
{
	var uVar0;
...
int func_54(var uParam0, bool bParam1, bool bParam2)//Position - 0x2919
{
	var uVar0;
	...
	{
		HUD::SET_BLIP_SCALE(uVar0, func_55(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		HUD::SET_BLIP_SCALE(uVar0, func_55(NETWORK::NETWORK_IS_GAME_IN_PROGRESS(), 0.7f, 0.7f));
		HUD::SET_BLIP_AS_FRIENDLY(uVar0, bParam1);
	}
...
float func_55(bool bParam0, float fParam1, float fParam2)//Position - 0x29BD
{
	if (bParam0)
	{
		return fParam1;
...
int func_56(int iParam0)//Position - 0x29D4
{
	if (func_60())
	{
		Global_17C3F = 1;
...
void func_57(int iParam0)//Position - 0x2A26
{
	switch (iParam0)
	{
		case 0:
...
void func_58(var uParam0, int iParam1)//Position - 0x2B07
{
	HUD::BEGIN_TEXT_COMMAND_DISPLAY_HELP(uParam0);
	HUD::END_TEXT_COMMAND_DISPLAY_HELP(0, 0, 1, iParam1);
}

char* func_59(int iParam0)//Position - 0x2B1E
{
	char* sVar0;
...
int func_61(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2B94
{
	int iVar0;
...
void func_62(var uParam0, int iParam1)//Position - 0x2CCB
{
	int iVar0;
...
bool func_63(int iParam0)//Position - 0x2D1A
{
	return func_64(iParam0, Global_8861);
}

int func_64(int iParam0, int iParam1)//Position - 0x2D2B
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_65(int iParam0)//Position - 0x2F0C
{
	if (Global_8861 == 15)
	{
		return 0;
...
int func_66()//Position - 0x2F2E
{
	...
	{
		if ((VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_63[0], 0) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_63[1], 0)) && VEHICLE::IS_VEHICLE_DRIVEABLE(uLocal_63[2], 0))
		{
			return 1;
		}
		else
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				{
					PED::ADD_RELATIONSHIP_GROUP("re_border badGuys", &uLocal_65);
					PED::SET_RELATIONSHIP_BETWEEN_GROUPS(3, uLocal_65, 1862763509);
					iVar2 = 0;
					while (iVar2 < 3)
					{
						Var0.x = (Var0.x + SYSTEM::TO_FLOAT(iVar2));
						Var0.f_1 = (Var0.f_1 + SYSTEM::TO_FLOAT(iVar2));
						iVar3 = MISC::GET_RANDOM_INT_IN_RANGE(0, 5);
						if (iVar3 > 1)
						{
							uLocal_63[iVar2] = VEHICLE::CREATE_VEHICLE(iVar4, Var0, uVar1, 1, 1);
						}
						else
						{
							uLocal_63[iVar2] = VEHICLE::CREATE_VEHICLE(iVar5, Var0, uVar1, 1, 1);
						}
						uLocal_62[iVar2] = PED::CREATE_PED_INSIDE_VEHICLE(uLocal_63[iVar2], 22, iVar6, -1, 1, 1);
						TASK::TASK_LOOK_AT_ENTITY(uLocal_62[iVar2], PLAYER::PLAYER_PED_ID(), -1, 2096, 4);
						PED::SET_PED_KEEP_TASK(uLocal_62[iVar2], 1);
						PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(uLocal_62[iVar2], 1);
						PED::SET_PED_RELATIONSHIP_GROUP_HASH(uLocal_62[iVar2], uLocal_65);
						WEAPON::GIVE_WEAPON_TO_PED(uLocal_62[iVar2], joaat("weapon_sawnoffshotgun"), -1, 1, 1);
						VEHICLE::SET_VEHICLE_FORWARD_SPEED(uLocal_63[iVar2], ENTITY::GET_ENTITY_SPEED(PLAYER::PLAYER_PED_ID()));
						PED::SET_PED_COMBAT_MOVEMENT(uLocal_62[iVar2], 2);
						PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_62[iVar2], 50, 1);
						PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_62[iVar2], 2, 1);
						PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_62[iVar2], 1, 1);
						PED::SET_PED_COMBAT_ATTRIBUTES(uLocal_62[iVar2], 52, 1);
						PED::SET_PED_ACCURACY(uLocal_62[iVar2], 5);
						PED::SET_PED_FIRING_PATTERN(uLocal_62[iVar2], 1566631136);
						PED::SET_PED_SHOOT_RATE(uLocal_62[iVar2], MISC::GET_RANDOM_INT_IN_RANGE(50, 100));
						PED::SET_PED_CAN_BE_KNOCKED_OFF_VEHICLE(uLocal_62[iVar2], 1);
						PED::SET_PED_CONFIG_FLAG(uLocal_62[iVar2], 42, 1);
						PED::SET_PED_HELMET(uLocal_62[iVar2], 0);
						PED::SET_PED_MONEY(uLocal_62[iVar2], 233);
						AUDIO::SET_AMBIENT_VOICE_NAME(uLocal_62[iVar2], "A_M_M_HILLBILLY_02_WHITE_MINI_04");
						AUDIO::STOP_PED_SPEAKING(uLocal_62[iVar2], 1);
						iVar2++;
					}
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_63[0], 0);
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_63[1], 1);
					VEHICLE::SET_VEHICLE_COLOUR_COMBINATION(uLocal_63[2], 2);
				}
			}
			switch (func_34())
			{
			...
			func_47(&uLocal_67, 0, PLAYER::PLAYER_PED_ID(), sLocal_66, 0, 1);
			func_47(&uLocal_67, 1, uLocal_62[0], "BorderPatrol", 0, 1);
		}
	}
	return 0;
}

int func_67()//Position - 0x3205
{
	if (!func_63(5))
	{
		return 1;
...
int func_68(float fParam0, bool bParam1)//Position - 0x3267
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_69(int iParam0, var uParam1)//Position - 0x331E
{
	switch (iParam0)
	{
		case 0:
...
void func_70(var uParam0, char* sParam1, struct<2> Param2, int iParam3, int iParam4, int iParam5, struct<3> Param6, int iParam7, char* sParam8, int iParam9, int iParam10, char* sParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16, int iParam17, int iParam18, var uParam19, int iParam20, int iParam21)//Position - 0x44D5
{
	uParam0->f_4 = iParam4;
	*uParam0 = sParam1;
	uParam0->f_1 = { Param2 };
...
int func_71(int iParam0)//Position - 0x4566
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_72(int iParam0)//Position - 0x48AC
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_73(int iParam0)//Position - 0x48E3
{
	struct<2> Var0;
...
bool func_76()//Position - 0x4D7E
{
	return Global_17B2F > 0;
}

int func_77()//Position - 0x4D8C
{
	if (Global_154F9 != -1)
	{
		return 1;
...
Vector3 func_80(var uParam0)//Position - 0x4DF2
{
	return ENTITY::GET_ENTITY_COORDS(PLAYER::GET_PLAYER_PED(uParam0), 0);
}

void func_81()//Position - 0x4E05
{
}

void func_82(int iParam0)//Position - 0x4E0D
{
	if (iParam0 == -1)
	{
		iParam0 = func_28();
...
void func_84(int iParam0)//Position - 0x4E80
{
	Global_17C3E = iParam0;
}

int func_85(struct<3> Param0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x4E8E
{
	bool bVar0;
	struct<3> Var1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_121(Global_17C49.f_6E20.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_86(struct<3> Param0, struct<3> Param1)//Position - 0x5227
{
	return ((Param0.x == Param1.x && Param0.f_1 == Param1.f_1) && Param0.f_2 == Param1.f_2);
}

bool func_87(int iParam0)//Position - 0x5250
{
	int iVar0;
...
int func_88(int iParam0)//Position - 0x5271
{
	return func_89(iParam0, 1);
}

int func_89(int iParam0, int iParam1)//Position - 0x5280
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_90(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x52D3
{
	func_91(func_102(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_91(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x52F1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_92(float fParam0, float fParam1, float fParam2)//Position - 0x54F2
{
	float fVar0;
...
int func_93(int iParam0, int iParam1)//Position - 0x5534
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_94(int iParam0)//Position - 0x55D6
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_95(int iParam0)//Position - 0x55E9
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_96(int iParam0)//Position - 0x55FC
{
...
int func_98(int iParam0)//Position - 0x5621
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_99(MISC::IS_BIT_SET(iParam0, 31), -1, 1)) + 2011;
}

int func_99(bool bParam0, int iParam1, int iParam2)//Position - 0x5646
{
	if (bParam0)
	{
		return iParam1;
...
int func_100(int iParam0)//Position - 0x565D
{
	return iParam0 & 15;
}

int func_101(int iParam0, int iParam1)//Position - 0x566A
{
	int iVar0;
	int iVar1;
...
void func_103(var uParam0, int iParam1)//Position - 0x57BC
{
	if (iParam1 <= 0)
	{
		return;
...
void func_104(var uParam0, int iParam1)//Position - 0x5842
{
...
void func_105(var uParam0, int iParam1)//Position - 0x5875
{
	int iVar0;
	int iVar1;
...
void func_106(var uParam0, int iParam1)//Position - 0x58C6
{
...
void func_107(var uParam0, int iParam1)//Position - 0x5900
{
...
void func_108(var uParam0, int iParam1)//Position - 0x593B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_109(int iParam0)//Position - 0x5977
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_110(int iParam0, int iParam1)//Position - 0x5A53
{
...
int func_111(int iParam0)//Position - 0x5A76
{
	int iVar0;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_119()) || Global_17890) || Global_5F7E) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_115()) || func_114()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_119()) || Global_5F7E) || func_118()) || func_43(8, -1)) || func_115()) || func_117()) || func_116()) || func_114()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_119()) || Global_17890) || Global_5F7E) || func_118()) || func_43(8, -1)) || func_115()) || func_117()) || func_116()) || func_114()) || Global_17C49.f_1738.f_397[iVar0] == 5) || Global_8A84 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_119()) || Global_17890) || Global_5F7E) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_114()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_119() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_43(8, -1)) || func_114()) || func_113()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_119()) || Global_5F7E) || func_118()) || func_43(8, -1)) || func_116()) || func_115()) || func_114()) || Global_17C49.f_1738.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_119()) || func_116()) || Global_17890) || Global_5F7E) || func_118()) || Global_8C75) || func_43(8, -1)) || func_115()) || func_113()) || func_114()) || Global_17C49.f_1738.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_119()) || Global_17890) || Global_5F7E) || func_118()) || func_43(8, -1)) || func_115()) || func_113()) || func_117()) || func_116()) || func_114())
						{
							return 0;
						}
						break;
...
var func_112()//Position - 0x6193
{
	return Global_15F91.f_1;
}

int func_113()//Position - 0x61A1
{
	if (Global_154F9 != -1)
	{
...
bool func_116()//Position - 0x620B
{
	return Global_15F9E.f_123 > 0;
}

bool func_117()//Position - 0x621C
{
	return Global_15F9E.f_122 > 0;
}

var func_118()//Position - 0x622D
{
	return Global_14143C;
}

int func_119()//Position - 0x6239
{
...
bool func_121(int iParam0)//Position - 0x627D
{
	return func_101(func_102(), iParam0);
}

int func_122(int iParam0, int iParam1, int iParam2)//Position - 0x628F
{
	int iVar0;
	int iVar1;
...
int func_123(int iParam0)//Position - 0x6373
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_124(int iParam0)//Position - 0x6397
{
	int iVar0;
	bool bVar1;
...
int func_127()//Position - 0x64AF
{
	if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
	{
		if (PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
		{
			...
			{
				if (((((PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("rhino")) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("ambulance"))) || PED::IS_PED_IN_MODEL(PLAYER::PLAYER_PED_ID(), joaat("firetruk"))) || PED::IS_PED_IN_ANY_POLICE_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_FLYING_VEHICLE(PLAYER::PLAYER_PED_ID())) || Global_17890 == 1)
				{
					return 1;
				}
			}
...
void func_128()//Position - 0x6543
{
	...
	if (iLocal_50)
	{
		...
		while (iVar0 < 3)
		{
			if (!PED::IS_PED_INJURED(uLocal_62[iVar0]) && !PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				TASK::TASK_SMART_FLEE_PED(uLocal_62[iVar0], PLAYER::PLAYER_PED_ID(), 1000f, -1, 0, 0);
				PED::SET_PED_KEEP_TASK(uLocal_62[iVar0], 1);
			}
...
void func_129(int iParam0)//Position - 0x65C0
{
	char cVar0[64];
	...
	if (func_79())
	{
		...
		func_132(30000);
		StringCopy(&cVar0, func_131(Global_17C3E, 1), 64);
	...
	func_130(&Global_5FB7);
	Global_17C3F = 0;
	func_84(-1);
}

void func_130(var uParam0)//Position - 0x6675
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_131(int iParam0, bool bParam1)//Position - 0x66B2
{
	switch (iParam0)
	{
		case 0:
...
void func_132(int iParam0)//Position - 0x68FB
{
	Global_8A88 = (MISC::GET_GAME_TIMER() + iParam0);
}

void func_133(int iParam0)//Position - 0x690D
{
	func_134(iParam0, 0, func_139(iParam0));
}

void func_134(int iParam0, int iParam1, int iParam2)//Position - 0x6922
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_135(var uParam0)//Position - 0x6951
{
	struct<16> Var0;
	int iVar1;
...
void func_136(int iParam0, var uParam1)//Position - 0x6A21
{
	Global_17C49.f_6E20.f_2B[iParam0] = *uParam1;
}

void func_137(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6A39
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_138(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6BBB
{
...
int func_139(int iParam0)//Position - 0x6BF3
{
	int iVar0;
...
Vector3 func_140()//Position - 0x6D96
{
	...
	if (PLAYER::IS_PLAYER_PLAYING(PLAYER::PLAYER_ID()))
	{
		fVar0 = MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_46, 1);
		iLocal_49 = 1;
		if (MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1), Local_47, 1) < fVar0)
		{
