				...
				if (SYSTEM::VDIST2(ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 0), ENTITY::GET_ENTITY_COORDS(uLocal_84[iVar0], 0)) < 400f)
				{
					...
					if (!iLocal_61 || iLocal_82 < 3)
					{
						if (SYSTEM::TIMERA() > 5000)
						{
							...
							{
								func_48(&uLocal_98, 1);
								func_47(&uLocal_98, 1, uLocal_84[iVar0], "BorderPatrol", 0, 1);
								if (iLocal_82 == 0)
								{
									if (!PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 0))
									{
										if (func_46())
										{
											func_35(&uLocal_98, "REBORAU", "REBOR_INS1", 4, 0, 0, 0);
										}
										else
										{
											func_35(&uLocal_98, "REBORAU", "REBOR_INS2", 4, 0, 0, 0);
										}
										iLocal_82++;
									}
									else
								...
								{
									func_35(&uLocal_98, "REBORAU", "REBOR_STOP", 4, 0, 0, 0);
									iLocal_82++;
								}
								else
								{
									func_35(&uLocal_98, "REBORAU", "REBOR_PULL", 4, 0, 0, 0);
								}
								iLocal_62 = 1;
								iLocal_82++;
								if (iLocal_82 >= 3)
					...
					{
						if (!func_49() && !TASK::IS_PED_IN_WRITHE(uLocal_84[iVar0]))
						{
							...
							if (func_34() == 0)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_ATTM", 4, 0, 0, 0);
							}
							else if (func_34() == 1)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_ATTF", 4, 0, 0, 0);
							}
							else if (func_34() == 2)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_ATTT", 4, 0, 0, 0);
							}
							iLocal_63 = 1;
							iLocal_61 = 1;
							SYSTEM::SETTIMERA(0);
					...
					else if (!func_49())
					{
						if (!iLocal_65)
						{
							if (func_34() == 0)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_REACTM", 4, 0, 0, 0);
							}
							else if (func_34() == 1)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_REACTF", 4, 0, 0, 0);
							}
							else if (func_34() == 2)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_REACTT", 4, 0, 0, 0);
							}
							iLocal_65 = 1;
						}
						if (SYSTEM::TIMERA() > 5000 && !TASK::IS_PED_IN_WRITHE(uLocal_84[iVar0]))
						{
							...
							if (func_34() == 0)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_CONM", 4, 0, 0, 0);
							}
							else if (func_34() == 1)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_CONF", 4, 0, 0, 0);
							}
							else if (func_34() == 2)
							{
								func_35(&uLocal_98, "REBORAU", "REBOR_COTT", 4, 0, 0, 0);
							}
							SYSTEM::SETTIMERA(0);
						}
					}
	...
	while (iVar0 < 3)
	{
		if (!PED::IS_PED_INJURED(uLocal_84[iVar0]))
		{
			if (iLocal_62 || iLocal_61)
			{
				...
				{
					uLocal_92[iVar0] = func_53(uLocal_84[iVar0], 1, 145);
				}
			}
		}
...
int func_66()//Position - 0x2F2E
{
	...
	if ((STREAMING::HAS_MODEL_LOADED(iVar8) && STREAMING::HAS_MODEL_LOADED(iVar6)) && STREAMING::HAS_MODEL_LOADED(iVar7))
	{
		...
		else
		{
			...
			func_47(&uLocal_98, 0, PLAYER::PLAYER_PED_ID(), sLocal_97, 0, 1);
			func_47(&uLocal_98, 1, uLocal_84[0], "BorderPatrol", 0, 1);
		}
	}
	return 0;
}
...
int func_85(struct<3> Param0, int iParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x4E8E
{
	...
	if (!bVar0)
	{
		...
		if (!func_121(Global_97353.f_28192.f_43[iParam3]))
		{
			return 0;
		}
...
bool func_86(struct<3> Param0, struct<3> Param3)//Position - 0x5227
{
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_119()) || Global_96400) || Global_24446) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_115()) || func_114()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_119()) || Global_24446) || func_118()) || func_43(8, -1)) || func_115()) || func_117()) || func_116()) || func_114()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_119()) || Global_96400) || Global_24446) || func_118()) || func_43(8, -1)) || func_115()) || func_117()) || func_116()) || func_114()) || Global_97353.f_5944.f_919[iVar0] == 5) || Global_35460 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_119()) || Global_96400) || Global_24446) || func_118()) || func_43(8, -1)) || func_117()) || func_116()) || func_114()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_119() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_43(8, -1)) || func_114()) || func_113()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
						{
							if ((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_119()) || Global_24446) || func_118()) || func_43(8, -1)) || func_116()) || func_115()) || func_114()) || Global_97353.f_5944.f_919[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || func_119()) || func_116()) || Global_96400) || Global_24446) || func_118()) || Global_35957) || func_43(8, -1)) || func_115()) || func_113()) || func_114()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 8:
						if (((((((((((((((((((((PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0) || !PLAYER::IS_PLAYER_CONTROL_ON(PLAYER::PLAYER_ID())) || !PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID())) || !CAM::IS_SCREEN_FADED_IN()) || PLAYER::IS_PLAYER_WANTED_LEVEL_GREATER(PLAYER::PLAYER_ID(), 0)) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_IN_ANY_VEHICLE(PLAYER::PLAYER_PED_ID(), 1)) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_SWIMMING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || func_119()) || Global_96400) || Global_24446) || func_118()) || func_43(8, -1)) || func_115()) || func_113()) || func_117()) || func_116()) || func_114())
						{
							return 0;
						}
						break;
...
void func_129(int iParam0)//Position - 0x65C0
{
	...
	if (func_79())
	{
		...
		func_132(30000);
		StringCopy(&cVar0, func_131(Global_97342, 1), 64);
