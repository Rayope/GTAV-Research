...
void __EntryFunction__()//Position - 0x0
{
	...
	fLocal_31 = 180f;
	iLocal_34 = 3;
	uLocal_79 = func_417(60);
	uLocal_80 = func_417(14);
	...
	uLocal_161 = func_383();
	uLocal_162 = func_382(1855.08f, 4755.85f, 36.81f, 25f);
	...
	if (func_393())
	{
		if (func_355() == 0)
		{
			func_354(Local_146, fLocal_149, 1, 0);
			func_353(1);
			func_352(&Local_82, 0, 1);
			func_351();
	...
	while (true)
	{
		...
		{
			if (func_330(PLAYER::PLAYER_PED_ID()) == iLocal_158)
			{
...
void func_11()//Position - 0x64C
{
	...
	while (func_330(PLAYER::PLAYER_PED_ID()) == iLocal_158)
	{
		SYSTEM::WAIT(0);
		HUD::HIDE_HUD_COMPONENT_THIS_FRAME(2);
...
int func_13(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x7BC
{
	...
	else
	{
		...
		iVar20 = 0;
		func_19(&iVar20);
		iVar21 = func_18(Var10, Global_97353.f_5944.f_765[iVar20 /*10*/]);
		if (iVar21 == 2)
		{
			func_16(Global_97353.f_5944.f_765[iVar20 /*10*/]);
		...
		else if (iVar21 == 1)
		{
			...
			{
				if (!func_14(Global_97353.f_5944.f_765[iVar20 /*10*/]))
				{
					Global_97353.f_5944.f_765[iVar20 /*10*/] = { Var10 };
					func_15(&Var10);
					return 1;
...
int func_14(struct<9> Param0, var uParam9)//Position - 0x9DE
{
	if (Param0.f_8 == 0)
	{
		return 0;
...
int func_18(struct<4> Param0, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, var uParam9, struct<4> Param10, var uParam14, var uParam15, var uParam16, var uParam17, var uParam18, var uParam19)//Position - 0xA62
{
	int iVar0;
	int iVar1;
...
void func_19(int iParam0)//Position - 0xA93
{
	...
	*iParam0 = 0;
	...
	{
		if (func_18(Global_97353.f_5944.f_765[iVar0 /*10*/], Global_97353.f_5944.f_765[*iParam0 /*10*/]) == 0)
		{
			*iParam0 = iVar0;
		}
		iVar0++;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_106(14))
			{
				...
				iVar0 = func_86(func_104(iParam1, uParam0->f_2), Global_68104, 0);
				...
				{
					iVar0 = func_86(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(iVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_224()//Position - 0x25552
{
	switch (Local_771.f_1)
	{
		...
		case 1:
			...
			else if (func_226(Local_605[0 /*8*/]))
			{
				if (func_225(PLAYER::PLAYER_PED_ID(), Local_605[0 /*8*/], 1) >= 50f)
				{
...
int func_231(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x259E8
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
float func_232(struct<3> Param0, struct<3> Param3)//Position - 0x25A76
{
...
void func_235()//Position - 0x25AE5
{
	...
	if (Local_771.f_1 == 0)
	{
		func_281("Doing setup for RockScene:", iLocal_352);
		func_279(1);
		func_278();
		...
		if (func_331(PLAYER::PLAYER_PED_ID()))
		{
			...
			if (iLocal_352 == 0)
			{
				...
				if (func_226(Local_624))
				{
					iLocal_640 = func_265(PLAYER::PLAYER_PED_ID(), joaat("weapon_digiscanner"), 1, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_640, "Artefact_Detector", 0, 0, 0);
				}
				if (func_226(Local_362[iLocal_352 /*43*/].f_1))
				{
			...
			func_256(Local_362[iLocal_352 /*43*/].f_25, Local_362[iLocal_352 /*43*/].f_28, Local_362[iLocal_352 /*43*/].f_31, Local_362[iLocal_352 /*43*/].f_32, Local_362[iLocal_352 /*43*/].f_35, func_264(), 1, 1, 1, 0, 0);
			func_251(Local_362[iLocal_352 /*43*/].f_2, 1, 0, 1, 1, 1, 1, 0, 1, 1, 1);
		}
		func_281("Finished setup, moving to run loop for RockScene #:", iLocal_352);
		Local_771.f_1 = 1;
	}
	if (Local_771.f_1 == 1)
	{
		...
		else
		{
			...
			if (Local_771.f_2 == -1)
			{
				...
				if (iLocal_352 >= 2)
				{
					...
					func_5(&(Local_362[iLocal_352 /*43*/].f_1));
				}
				Local_771.f_1 = 3;
				iLocal_352++;
				func_281("END CUTSCENE: iCurrentRock = ", iLocal_352);
			}
		}
	}
	if (Local_771.f_1 == 3)
...
void func_246()//Position - 0x265C5
{
	if (func_226(Local_605[1 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Jimmy_Boston", 0))
		{
			if (iLocal_352 >= 2)
			{
				if (func_226(Local_82.f_28[1]) && func_277(iLocal_361))
				{
...
void func_247()//Position - 0x26681
{
	if (func_226(Local_605[0 /*8*/]))
	{
		if (CUTSCENE::CAN_SET_EXIT_STATE_FOR_REGISTERED_ENTITY("Marnie", 0))
		{
			if (iLocal_352 >= 2)
			{
				if (func_226(Local_82.f_28[0]) && func_277(iLocal_361))
				{
					TASK::OPEN_SEQUENCE_TASK(&uLocal_781);
...
void func_256(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x26B6C
{
	func_257(Param0, Param3, fParam6, Param7, fParam10, Param11, bParam14, bParam15, bParam16, bParam17, bParam18);
}

void func_257(struct<3> Param0, struct<3> Param3, float fParam6, struct<3> Param7, float fParam10, struct<3> Param11, bool bParam14, bool bParam15, bool bParam16, bool bParam17, bool bParam18)//Position - 0x26B96
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_261(int iParam0, struct<3> Param1, struct<3> Param4, float fParam7)//Position - 0x270EF
{
	struct<3> Var0;
	struct<3> Var3;
	struct<3> Var6;
...
int func_262(struct<2> Param0, var uParam2, struct<2> Param3, var uParam5, struct<2> Param6, var uParam8, struct<2> Param9, var uParam11)//Position - 0x273E5
{
	float fVar0;
	float fVar1;
	float fVar2;
...
int func_265(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5, int iParam6)//Position - 0x27515
{
	...
	while (func_266(iVar2, iVar8) != 0)
	{
		if (!ENTITY::IS_ENTITY_DEAD(iParam0))
		{
			if (WEAPON::HAS_PED_GOT_WEAPON_COMPONENT(iParam0, iVar2, func_266(iVar2, iVar8)))
			{
				WEAPON::GIVE_WEAPON_COMPONENT_TO_WEAPON_OBJECT(uVar1, func_266(iVar2, iVar8));
			}
		}
		iVar8++;
	}
...
void func_284(int iParam0, var uParam1, int iParam2)//Position - 0x28547
{
	...
	while (iVar0 < 12)
	{
		...
		{
			if (func_59(iVar81, func_97(iVar0), func_81(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_97(iVar0)), &iVar1))
			{
				Var67 = { func_99(iVar81, 2, uParam1->f_59) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
				iVar82 = 1;
			}
			if (func_66(iVar81, func_97(iVar0), func_81(iParam0, Var2.f_13[iVar0], Var2[iVar0], func_97(iVar0)), &iVar1))
			{
				Var67 = { func_99(iVar81, 1, uParam1->f_62) };
	...
	while (iVar0 < 9)
	{
		...
		{
			if (func_59(iVar81, 14, func_76(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &iVar1))
			{
				Var67 = { func_99(iVar81, 2, uParam1->f_59) };
				uParam1->f_13[2] = Var67.f_3;
				(*uParam1)[2] = Var67.f_4;
			...
			if (func_66(iVar81, 14, func_76(iParam0, Var2.f_39[iVar0], Var2.f_49[iVar0], iVar0), &iVar1))
			{
				Var67 = { func_99(iVar81, 1, uParam1->f_62) };
				uParam1->f_13[1] = Var67.f_3;
				(*uParam1)[1] = Var67.f_4;
	...
	if (iVar83 || iVar82)
	{
		iVar84 = func_81(iParam0, uParam1->f_13[1], (*uParam1)[1], 1);
		iVar85 = func_81(iParam0, uParam1->f_13[2], (*uParam1)[2], 2);
		iVar86 = func_67(iVar81, iVar85, iVar84);
		if (iVar86 != -99)
		{
			Var67 = { func_99(iVar81, 0, iVar86) };
...
void func_292()//Position - 0x291BE
{
	...
	if (Local_771.f_1 == 0)
	{
		func_281("Doing setup for FindRock section:", iLocal_352);
		...
		func_314(&uLocal_167, 0, PLAYER::PLAYER_PED_ID(), "MICHAEL", 0, 1);
		func_314(&uLocal_167, 5, Local_605[1 /*8*/], "JIMMYBOSTON", 0, 1);
		func_314(&uLocal_167, 4, Local_605[0 /*8*/], "MARNIE", 0, 1);
		if (iLocal_352 == 0)
		{
		...
		func_281("Finished setup, moving to run loop for rock #:", iLocal_352);
		Local_771.f_1 = 1;
	}
	if (Local_771.f_1 == 1)
	{
		...
		else if (!func_312(&uLocal_693, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
		{
			func_234(6);
			Local_771.f_9 = 8;
			Local_771.f_1 = 3;
		...
		else
		{
			...
			if (ENTITY::DOES_ENTITY_EXIST(Local_362[iLocal_352 /*43*/].f_1))
			{
				if (iLocal_352 == 0)
				{
					if (func_225(PLAYER::PLAYER_PED_ID(), Local_362[iLocal_352 /*43*/].f_1, 1) < 100f)
					{
						if (!CUTSCENE::HAS_CUTSCENE_LOADED())
						{
					...
					else if (func_225(PLAYER::PLAYER_PED_ID(), Local_362[iLocal_352 /*43*/].f_1, 1) > 120f)
					{
						if (CUTSCENE::HAS_CUTSCENE_LOADED())
						{
				...
				else if (func_225(PLAYER::PLAYER_PED_ID(), Local_362[iLocal_352 /*43*/].f_1, 1) < 100f)
				{
					if (!CUTSCENE::HAS_CUTSCENE_LOADED())
					{
			...
			{
				func_306(&uLocal_163);
				if (!func_312(&uLocal_641, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
					iLocal_338 = 0;
					AUDIO::STOP_SCRIPTED_CONVERSATION(0);
					HUD::CLEAR_PRINTS();
				...
				{
					if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_36, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_36, 7, 0, 0, 0))
					{
						if (!MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_36, sLocal_160))
						{
							if (func_226(iLocal_360))
							{
				...
				{
					if (!func_272() && (MISC::GET_GAME_TIMER() - iLocal_357) >= 7500)
					{
						if ((MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_37, sLocal_160) || !ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_360, 30f, 30f, 30f, 0, 1, 0)) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_37, 7, 0, 0, 0))
						{
				...
				else if (iLocal_337 == 0 && !func_295(PLAYER::PLAYER_PED_ID(), Local_362[iLocal_352 /*43*/].f_2, 9f))
				{
					if (func_295(PLAYER::PLAYER_PED_ID(), Local_362[iLocal_352 /*43*/].f_2, 20f))
					{
						if (!iLocal_342)
						{
							if (!func_272())
							{
								if (func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_42, 7, 0, 0, 0))
								{
									if (func_226(iLocal_360))
									{
										TASK::TASK_LOOK_AT_ENTITY(iLocal_360, PLAYER::PLAYER_PED_ID(), 5000, 0, 2);
					...
					{
						if (func_294(PLAYER::PLAYER_PED_ID(), iLocal_360, 30f) || iLocal_352 == 2)
						{
							if (!func_272() && (MISC::GET_GAME_TIMER() - iLocal_355) > 15000)
							{
								if (bLocal_335)
								{
									if (iLocal_351 == 0)
									{
										...
										{
											if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_40, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_40, 7, 0, 0, 0))
											{
												if (func_331(iLocal_360))
												{
									...
									{
										if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_40, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", "EPS4_HASSIG", 7, 0, 0, 0))
										{
											iLocal_355 = MISC::GET_GAME_TIMER();
											iLocal_751++;
										}
								...
								{
									if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_41, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_41, 7, 0, 0, 0))
									{
										if (func_331(iLocal_360))
										{
											TASK::TASK_LOOK_AT_ENTITY(iLocal_360, PLAYER::PLAYER_PED_ID(), 3000, 0, 2);
				...
				if (iLocal_352 == 0)
				{
					if (iLocal_752 < 5)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_754) > 7500 && !func_272()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_226(Local_605[0 /*8*/]))
							{
								if (func_225(Local_605[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_297(&uLocal_167, "EPS4AUD", "EPS4_NEARM", 6, 0, 0, 0))
									{
										iLocal_752++;
										iLocal_754 = MISC::GET_GAME_TIMER();
									}
				...
				else if (iLocal_352 == 1)
				{
					if (iLocal_752 < 4)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_754) > 7500 && !func_272()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_226(Local_605[1 /*8*/]))
							{
								if (func_225(Local_605[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_297(&uLocal_167, "EPS4AUD", "EPS4_NEARJ", 6, 0, 0, 0))
									{
										iLocal_752++;
										iLocal_754 = MISC::GET_GAME_TIMER();
									}
					...
					if (iLocal_752 < 3)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_754) > 7500 && !func_272()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_226(Local_605[1 /*8*/]))
							{
								if (func_225(Local_605[1 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_297(&uLocal_167, "EPS4AUD", "EPS4_NEARJP", 6, 0, 0, 0))
									{
										iLocal_752++;
										iLocal_754 = MISC::GET_GAME_TIMER();
									}
					...
					if (iLocal_753 < 4)
					{
						if (((MISC::GET_GAME_TIMER() - iLocal_754) > 7500 && !func_272()) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
						{
							if (func_226(Local_605[0 /*8*/]))
							{
								if (func_225(Local_605[0 /*8*/], PLAYER::PLAYER_PED_ID(), 1) < 4f)
								{
									if (func_297(&uLocal_167, "EPS4AUD", "EPS4_NEARMP", 6, 0, 0, 0))
									{
										iLocal_753++;
										iLocal_754 = MISC::GET_GAME_TIMER();
									}
				...
				else if (!func_295(PLAYER::PLAYER_PED_ID(), Local_362[iLocal_352 /*43*/].f_2, (9f + 2f)))
				{
					iLocal_336 = 0;
				}
			}
			else
			{
				...
				{
					uLocal_163 = func_293(Local_143, 5, 0);
				}
				bLocal_335 = Local_624.f_1;
				if (func_312(&uLocal_641, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
				{
				...
				else if (iLocal_343 == 0)
				{
					if (iLocal_352 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_360, 30f, 30f, 30f, 0, 1, 0))
						{
							...
							{
								if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_38, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_38, 7, 0, 0, 0))
								{
									iLocal_343 = 1;
								}
							}
				...
				else if (iLocal_344 == 0)
				{
					if (iLocal_352 < 2)
					{
						if (ENTITY::IS_ENTITY_AT_ENTITY(PLAYER::PLAYER_PED_ID(), iLocal_360, 30f, 30f, 30f, 0, 1, 0))
						{
							if ((!func_272() && (MISC::GET_GAME_TIMER() - iLocal_357) >= 7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_39, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_39, 7, 0, 0, 0))
								{
									iLocal_344 = 1;
								}
							}
					...
					else if ((!func_272() && (MISC::GET_GAME_TIMER() - iLocal_357) >= 7500) && !HUD::IS_MESSAGE_BEING_DISPLAYED())
					{
						if (MISC::ARE_STRINGS_EQUAL(Local_362[iLocal_352 /*43*/].f_39, sLocal_160) || func_297(&uLocal_167, "EPS4AUD", Local_362[iLocal_352 /*43*/].f_39, 7, 0, 0, 0))
						{
							iLocal_344 = 1;
...
int func_293(struct<3> Param0, int iParam3, int iParam4)//Position - 0x2A541
{
	int iVar0;
...
bool func_295(int iParam0, struct<3> Param1, float fParam4)//Position - 0x2A58F
{
	...
	switch (uParam0->f_1)
	{
		...
		case 4:
			...
			else if (uParam0->f_2 == 1)
			{
					...
					if (!iLocal_349)
					{
						if ((MISC::GET_GAME_TIMER() - iLocal_755) > 6000)
						{
							...
							if (!func_272() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
							{
								if (*uParam0 == Local_605[1 /*8*/])
								{
									func_297(&uLocal_167, "EPS4AUD", "EPS4_DAWDJ", 7, 0, 0, 0);
								}
								else
								{
									func_297(&uLocal_167, "EPS4AUD", "EPS4_DAWDM", 7, 0, 0, 0);
								}
							}
							iLocal_349 = 1;
						}
				...
				{
					if ((((MISC::GET_GAME_TIMER() - iLocal_756) > 7500 && !func_272()) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_336)
					{
						if (*uParam0 == Local_605[1 /*8*/])
						{
							if (func_297(&uLocal_167, "EPS4AUD", "EPS4_MESSJ", 7, 0, 0, 0))
							{
								iLocal_756 = MISC::GET_GAME_TIMER();
							}
						}
						else if (func_297(&uLocal_167, "EPS4AUD", "EPS4_MESSM", 7, 0, 0, 0))
						{
							iLocal_756 = MISC::GET_GAME_TIMER();
						}
					}
				...
				{
					if ((((iLocal_757 < 4 && !func_272()) && !HUD::IS_MESSAGE_BEING_DISPLAYED()) && !iLocal_336) && !func_332())
					{
						if (*uParam0 == Local_605[1 /*8*/])
						{
							if (func_297(&uLocal_167, "EPS4AUD", "EPS4_PROMPTJ", 7, 0, 0, 0))
							{
								iLocal_758 = MISC::GET_GAME_TIMER();
								iLocal_757++;
							}
						}
						else if (func_297(&uLocal_167, "EPS4AUD", "EPS4_PROMPTM", 7, 0, 0, 0))
						{
							iLocal_758 = MISC::GET_GAME_TIMER();
							iLocal_757++;
						}
		...
		else if (func_331(iLocal_623))
		{
			if (TASK::IS_PED_GETTING_UP(iLocal_623) || PED::IS_PED_ON_FOOT(iLocal_623))
			{
				if (!func_272() && !HUD::IS_MESSAGE_BEING_DISPLAYED())
				{
					...
					{
						if (func_297(&uLocal_167, "EPS4AUD", "EPS4_JKNOCK", 7, 0, 0, 0))
						{
							iLocal_622 = 0;
							iLocal_623 = 0;
						}
					}
					else if (func_297(&uLocal_167, "EPS4AUD", "EPS4_MKNOCK", 7, 0, 0, 0))
					{
						iLocal_622 = 0;
						iLocal_623 = 0;
					}
...
bool func_312(var uParam0, struct<2> Param1, float fParam3)//Position - 0x2B959
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_324()//Position - 0x2BE0E
{
	...
	if (Local_771.f_1 == 0)
	{
		...
		if (func_268(1, 1093140480, 0))
		{
			...
			if (func_331(Local_82.f_28[0]))
			{
				CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(Local_82.f_28[0], "Marnie", 0, 0, 0);
			}
			if (func_331(Local_82.f_28[1]))
			{
				ENTITY::FREEZE_ENTITY_POSITION(Local_82.f_28[1], 0);
				if (func_226(WEAPON::GET_CURRENT_PED_WEAPON_ENTITY_INDEX(Local_82.f_28[1])))
				{
					iLocal_640 = func_265(Local_82.f_28[1], joaat("weapon_digiscanner"), 1, 0, 0, 0, 0);
					CUTSCENE::REGISTER_ENTITY_FOR_CUTSCENE(iLocal_640, "Artefact_Detector", 0, 0, 0);
				}
...
int func_327(int iParam0, struct<3> Param1, float fParam4, bool bParam5, int iParam6)//Position - 0x2C27A
{
	bool bVar0;
	float fVar1;
...
void func_329()//Position - 0x2C2F4
{
	...
	if (Local_771.f_1 == 0)
	{
		...
		if (!func_392(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			...
			func_314(&uLocal_167, 4, Local_82.f_28[0], "MARNIE", 0, 1);
			if (func_321())
			{
				Local_771.f_1 = 1;
			}
	...
	if (Local_771.f_1 == 1)
	{
		...
		if (!func_392(0) && ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, 1, 0))
		{
			if (func_225(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) >= 3f)
			{
				if (!CAM::IS_GAMEPLAY_HINT_ACTIVE())
				{
					if (!iLocal_332)
					{
						if (func_226(Local_82.f_28[0]))
						{
			...
			if (!iLocal_333)
			{
				if (func_331(Local_82.f_28[0]) && !func_272())
				{
			...
			else if (func_331(Local_82.f_28[0]))
			{
				if (ENTITY::IS_ENTITY_PLAYING_ANIM(Local_82.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie", 3))
				{
					if (ENTITY::GET_ENTITY_ANIM_CURRENT_TIME(Local_82.f_28[0], "rcm_epsilonism4leadinout", "ep_4_rcm_leadin_marnie") > 0.25f)
					{
						if (!iLocal_334)
						{
							if (func_297(&uLocal_167, "EPS4AUD", "ESP4_RCL", 8, 0, 0, 0))
							{
					...
					if (func_225(PLAYER::PLAYER_PED_ID(), Local_82.f_28[0], 1) <= 1.5f)
					{
						PLAYER::SET_PLAYER_CONTROL(PLAYER::PLAYER_ID(), false, 0);
						TASK::CLEAR_PED_TASKS(PLAYER::PLAYER_PED_ID());
					}
	...
	if (Global_68499 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !CAM::IS_SCREEN_FADED_OUT())
			{
				...
				Var4 = { func_335(Global_68500, Global_68502, iParam10) };
				if (fVar7 == -0.014f)
				{
				}
	...
	switch (iParam1)
	{
		...
		case 3:
			...
			switch (iVar2)
			{
				...
				default:
					StringCopy(&Var0, func_336(iVar2), 8);
					break;
			}
			break;
...
{
	if (((!func_346(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
{
	return func_348(iParam0, Global_34913);
}
...
void func_354(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x2D550
{
	if (func_393())
	{
...
void func_361()//Position - 0x2D7FA
{
	...
	func_365(&uLocal_641);
	func_364(&uLocal_641, 1897.42f, 4596.51f, 36.4f);
	func_364(&uLocal_641, 1912.2f, 4676.93f, 39.44f);
	func_364(&uLocal_641, 1886.09f, 4733.68f, 39.48f);
	func_364(&uLocal_641, 1800.24f, 4820.64f, 40.96f);
	func_364(&uLocal_641, 1796.556f, 4893.541f, 40.4741f);
	func_364(&uLocal_641, 1782.651f, 4916.333f, 41.4418f);
	func_364(&uLocal_641, 1746.552f, 4942.362f, 42.8677f);
	func_364(&uLocal_641, 1702.537f, 4893.824f, 36.7751f);
	func_364(&uLocal_641, 1707.273f, 4814.81f, 40.9407f);
	func_364(&uLocal_641, 1729.46f, 4655.21f, 42.61f);
	func_364(&uLocal_641, 1772.05f, 4602.143f, 36.457f);
	func_363(&uLocal_641);
	func_362(&uLocal_693, &uLocal_641, 20f);
}
...
void func_362(var uParam0, var uParam1, float fParam2)//Position - 0x2DCD4
{
	...
	while (iVar1 < uParam1->f_46)
	{
		...
		if (func_312(uParam1, *(uParam1[iVar1 /*3*/]) + Var9))
		{
			Var9 = { -Var9 };
		}
...
var func_382(struct<3> Param0, float fParam3)//Position - 0x2E23D
{
	struct<3> Var0;
...
int func_384(var uParam0)//Position - 0x2E29D
{
	...
	switch (iLocal_78)
	{
		case 0:
			...
			func_391(&(uParam0->f_48), "rcm_epsilonism4", "ep_4_rcm_marnie_base_marnie", "ep_4_rcm_marnie_lookaround_marnie");
			iLocal_78 = 1;
			break;
		
		case 1:
			if (!func_390(&iVar0) || !func_388(&(uParam0->f_48)))
			{
				return 0;
			}
			iLocal_78 = 2;
		...
		case 2:
			...
			{
				if (func_385(&(uParam0->f_28[0]), 60, 1826.13f, 4698.88f, 38.92f, 21.63f, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
			...
			{
				if (func_385(&(uParam0->f_28[1]), 55, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					...
					func_327(uParam0->f_28[1], 1827.24f, 4699.76f, 39.09f, 57.09f, 1, 1);
				}
				else
				{
					bVar4 = false;
...
int func_385(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0x2E4C9
{
...
int func_386(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0x2E524
{
	int iVar0;
...
void func_394()//Position - 0x2E703
{
	...
	if (func_226(Local_605[0 /*8*/]) && func_226(Local_605[1 /*8*/]))
	{
	...
	func_395(&(Local_605[0 /*8*/]), 1, 1, 1);
	func_395(&(Local_605[1 /*8*/]), 1, 1, 1);
...
int func_399(char* sParam0, int iParam1, int iParam2)//Position - 0x2E9FF
{
	...
	if (func_405())
	{
		...
		{
			iVar33 = func_400(SCRIPT::GET_THIS_SCRIPT_NAME());
			if (iVar33 > -1)
			{
...
int func_401()//Position - 0x2EBEB
{
	...
	iVar0 = func_402(&(Global_89962.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_405()//Position - 0x2ECBF
{
	...
	{
		if (func_400(&(Global_89962.f_3)) > -1)
		{
			return 1;
		}
	}
...
{
	func_416(&(uParam0->f_28));
	func_416(&(uParam0->f_35));
	func_416(&(uParam0->f_41));
}
