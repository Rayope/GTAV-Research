...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_286(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_269(&Var0, 1);
	}
	...
	while (true)
	{
		...
		if (func_181(Var0.f_28[0]))
		{
			if (Var0 == 2)
			{
				if (func_179(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_179(&Var0, ENTITY::GET_ENTITY_COORDS(Var0.f_28[0], 1), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5695
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5D2F
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x60E5
{
	int iVar0;
	float fVar1;
	float fVar2;
...
var func_149(struct<3> Param0, int iParam3)//Position - 0x9DDF
{
	var uVar0;
...
float func_177(int iParam0, struct<3> Param1, int iParam4)//Position - 0xB6F2
{
	struct<3> Var0;
...
int func_179(int iParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xB7C8
{
	var uVar0;
	
	if ((((func_181(PLAYER::PLAYER_PED_ID()) && func_181(iParam0->f_28[0])) && !func_128()) && (MISC::GET_GAME_TIMER() - iParam0->f_60) > iParam8) && func_177(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
int func_205(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xCBE4
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_209(struct<3> Param0, struct<3> Param3)//Position - 0xCEB0
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_217(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xD22E
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
{
	if ((func_226() && Global_89962.f_11 == 6) && iParam0 == func_146(&(Global_89962.f_3), 0))
	{
		return 1;
	}
	return 0;
...
void func_228()//Position - 0xD59F
{
	...
	if (func_181(PLAYER::PLAYER_PED_ID()))
	{
		if (func_229(PLAYER::PLAYER_PED_ID(), Var0, fVar3))
		{
			func_132();
		}
	}
...
bool func_229(int iParam0, struct<3> Param1, float fParam4)//Position - 0xD5E1
{
...
void func_239(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xDBB7
{
	func_196(uParam0);
...
void func_240(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xDBDE
{
	func_241(uParam0);
...
void func_244(var uParam0, var uParam1, struct<3> Param2, float fParam5, int iParam6)//Position - 0xE035
{
	func_245(uParam0);
...
int func_247(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xE28B
{
...
int func_248(var uParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6)//Position - 0xE2E6
{
	int iVar0;
...
int func_267(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xF0D9
{
	int iVar0;
	struct<7> Var1;
...
int func_268(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xF156
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
