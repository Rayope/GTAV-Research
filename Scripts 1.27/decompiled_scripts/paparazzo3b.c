...
void func_3()//Position - 0x215
{
	...
	switch (iLocal_275)
	{
		case 0:
			iLocal_415 = 0;
			iLocal_275 = 1;
			if ((func_223(Local_331) && func_222(Local_331, PLAYER::PLAYER_PED_ID(), 150f)) && iLocal_432 == 1)
			{
				...
				if (PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) == 0)
				{
					...
					if ((((!func_220() && !PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) && !TASK::IS_PED_GETTING_UP(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_PRONE(PLAYER::PLAYER_PED_ID())) && !PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID()))
					{
						if (!iLocal_415)
						{
							...
							func_219(&uLocal_760, 1, PLAYER::PLAYER_PED_ID(), "FRANKLIN", 0, 1);
							if (bLocal_418)
							{
...
int func_34(int iParam0, int iParam1, int iParam2)//Position - 0x183F
{
	...
	else
	{
		...
		if (PED::GET_NUMBER_OF_PED_DRAWABLE_VARIATIONS(iParam0, func_76(iParam1)) > 0 && PED::GET_NUMBER_OF_PED_TEXTURE_VARIATIONS(iParam0, func_76(iParam1), Global_68106[1 /*14*/].f_3) > 0)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, 0);
		}
	}
...
int func_37(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x1ABF
{
			...
			if (uVar11[iVar0] != -99)
			{
				...
				if (MISC::IS_BIT_SET(Global_68106[1 /*14*/].f_6, 0))
				{
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iVar0)));
						}
						else
						{
							PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iVar0), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
						}
						func_67(iVar0);
						if (Global_68105 == 1)
						{
	...
	else
	{
		if (iParam4 == -1)
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, PED::GET_PED_PALETTE_VARIATION(iParam0, func_76(iParam1)));
		}
		else
		{
			PED::SET_PED_COMPONENT_VARIATION(iParam0, func_76(iParam1), Global_68106[1 /*14*/].f_3, Global_68106[1 /*14*/].f_4, iParam4);
		}
		if (Global_68105 == 1)
		{
			iVar2 = 0;
...
int func_55(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x492F
{
	...
	else
	{
		...
		iVar41 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_76(iParam2));
		iVar38 = 0;
		while (iVar38 < iVar41)
		{
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5785
{
	...
	else
	{
		...
		iVar38 = 0;
		iVar39 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iParam3, 6, -1, 0, -1, func_76(iParam2));
		iVar37 = 0;
		while (iVar37 < iVar39)
		{
		...
		if (!FILES::IS_CONTENT_ITEM_LOCKED(Var1))
		{
			...
			while (iVar19 < Var1.f_3)
			{
				if (FILES::GET_SHOP_PED_OUTFIT_PROP_VARIANT(Var1.f_1, iVar19, &Var16) && Var16.f_2 != -1)
				{
					...
					{
						(*iParam0)[Var16.f_2] = func_63(iParam1, Var16.x, 14, iVar0);
					}
					else if (Var16.f_1 != -1)
					{
		...
		while (iVar19 < Var1.f_4)
		{
			if (FILES::GET_SHOP_PED_OUTFIT_COMPONENT_VARIANT(Var1.f_1, iVar19, &Var16))
			{
				if ((Var16.x != 0 && Var16.x != -1) && Var16.x != joaat("0"))
				{
					if (Var16.f_2 == 10)
					{
						(*iParam0)[func_82(Var16.f_2)] = Var16.x;
					}
					else
					{
						(*iParam0)[func_82(Var16.f_2)] = func_63(iParam1, Var16.x, func_82(Var16.f_2), iVar0);
					}
				}
				else if (Var16.f_1 != -1)
				{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			if (!func_91(14))
			{
				...
				uVar0 = func_71(func_89(iParam1, uParam0->f_2), Global_68104, 0);
				if (MISC::IS_BIT_SET(uVar0, uParam0->f_1))
				{
					MISC::SET_BIT(&(uParam0->f_6), 2);
				}
				...
				{
					uVar0 = func_71(iVar1, Global_68104, 0);
					if (!MISC::IS_BIT_SET(uVar0, uParam0->f_1))
					{
						MISC::SET_BIT(&(uParam0->f_6), 4);
					}
...
void func_94(int iParam0, int iParam1, int iParam2)//Position - 0xC289
{
		...
		while (iVar38 < iVar40)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var20))
			{
				if (iVar39 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var20.f_9), Var20.f_3, Var20.f_4, Var20.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var20.f_1, joaat("OUTFIT_ONLY"), 0), iVar37, 2, Var20.f_1 != 0);
					return;
				}
				iVar39++;
			}
	...
	else
	{
		...
		iVar59 = 0;
		iVar60 = FILES::SETUP_SHOP_PED_APPAREL_QUERY_TU(iVar1, 6, -1, 0, -1, func_76(iParam0));
		iVar58 = 0;
		while (iVar58 < iVar60)
		{
			...
			if (!FILES::IS_CONTENT_ITEM_LOCKED(Var41))
			{
				if (iVar59 == (iParam1 - iParam2))
				{
					...
					func_87(&(Global_68106[0 /*14*/]), iParam0, iParam1, &(Var41.f_9), Var41.f_3, Var41.f_4, Var41.f_5, FILES::DOES_SHOP_PED_APPAREL_HAVE_RESTRICTION_TAG(Var41.f_1, joaat("OUTFIT_ONLY"), 0), -1, 2, Var41.f_1 != 0);
					return;
				}
				iVar59++;
			}
...
int func_149(int iParam0, int iParam1, int iParam2)//Position - 0x1D641
{
	...
	else if (Global_68106[1 /*14*/].f_3 == PED::GET_PED_DRAWABLE_VARIATION(iParam0, func_76(iParam1)) && Global_68106[1 /*14*/].f_4 == PED::GET_PED_TEXTURE_VARIATION(iParam0, func_76(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_155()//Position - 0x1D9AC
{
	...
	{
		if (func_151(Global_97353.f_1729.f_539.f_3213) != ENTITY::GET_ENTITY_MODEL(PLAYER::PLAYER_PED_ID()))
		{
...
void func_166()//Position - 0x1F634
{
	...
	{
		func_155();
		GRAPHICS::SET_NEXT_PLAYER_TCMODIFIER(func_167(Global_97353.f_1729.f_539.f_3213));
	}
	else
	{
...
void func_204(int iParam0)//Position - 0x24BAA
{
	if (iParam0 == 1)
	{
		MISC::SET_BIT(&Global_2264, 28);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_2264, 28);
	}
}
...
{
	if (func_223(Local_331) && func_458(Local_377[0 /*6*/]))
	{
		if (func_223(Local_294[0 /*9*/]) && func_223(Local_331))
		{
	...
	if (func_223(Local_294[0 /*9*/]) && PED::IS_PED_IN_ANY_VEHICLE(Local_294[0 /*9*/], 0))
	{
...
void func_224()//Position - 0x256EB
{
	...
	if (iLocal_416 == 0)
	{
		...
		{
			if (func_226(Local_377[0 /*6*/]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_377[0 /*6*/], 1))
			{
				if (!PED::IS_PED_IN_VEHICLE(Local_331, Local_377[0 /*6*/], 0))
				{
					if (!func_225(Local_331, -1794415470))
					{
						TASK::TASK_ENTER_VEHICLE(Local_331, Local_377[0 /*6*/], 20000, 1, 1f, 1, 0);
						iLocal_276 = 2;
					}
		...
		if ((MISC::GET_GAME_TIMER() - iLocal_455) > 400)
		{
			...
			{
				if (func_226(Local_377[0 /*6*/]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_377[0 /*6*/], 0))
				{
		...
		if ((MISC::GET_GAME_TIMER() - iLocal_455) > 600)
		{
			...
			{
				if (func_226(Local_377[1 /*6*/]) && VEHICLE::IS_VEHICLE_SEAT_FREE(Local_377[1 /*6*/], -1))
				{
					if (!PED::IS_PED_IN_VEHICLE(Local_294[2 /*9*/], Local_377[1 /*6*/], 0))
					{
		...
		{
			if (func_223(Local_340) && !func_225(Local_340, 63541484))
			{
		...
		case 1:
			...
			if (!func_220())
			{
				...
				else if (iLocal_479 == 0)
				{
					...
					func_219(&uLocal_760, 6, Local_340, "Paparazzo3BDrugDealer", 0, 1);
			...
			if (func_223(Local_331) && PED::IS_PED_IN_ANY_VEHICLE(Local_331, 0))
			{
...
int func_230()//Position - 0x260E5
{
	...
	while (iVar0 <= 3)
	{
		...
		{
			if (!func_222(PLAYER::PLAYER_PED_ID(), Local_294[iVar0 /*9*/], 200f))
			{
...
void func_237()//Position - 0x26306
{
	if (iLocal_470 < 2)
	{
		if (MISC::GET_GAME_TIMER() > iLocal_471 + 10000)
		{
			if (!func_220())
			{
				if (func_239(PLAYER::PLAYER_PED_ID(), Local_331, 1) < 50f)
				{
...
bool func_240(int iParam0, struct<3> Param1, float fParam4)//Position - 0x26416
{
	...
	switch (iLocal_275)
	{
		...
		case 1:
			...
			if (((MISC::GET_GAME_TIMER() > iLocal_451 && func_253()) || (MISC::GET_GAME_TIMER() > iLocal_452 && (func_253() || iLocal_413))) || func_251())
			{
				...
				{
					func_244();
					func_219(&uLocal_760, 5, Local_331, "PRINCESS", 0, 1);
...
{
	if (func_252(&uLocal_550, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		return 0;
	}
	return 1;
...
bool func_252(var uParam0, struct<2> Param1, float fParam3)//Position - 0x26B86
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
{
	if (func_252(&uLocal_654, ENTITY::GET_ENTITY_COORDS(PLAYER::PLAYER_PED_ID(), 1)))
	{
		return 1;
	}
	return 0;
...
void func_254()//Position - 0x26C62
{
	if (ENTITY::DOES_ENTITY_EXIST(Local_368))
	{
		if (!ENTITY::IS_ENTITY_DEAD(Local_368))
		{
			...
			else if (func_458(PLAYER::GET_PLAYERS_LAST_VEHICLE()) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_368, PLAYER::GET_PLAYERS_LAST_VEHICLE(), 1))
			{
				PED::SET_BLOCKING_OF_NON_TEMPORARY_EVENTS(Local_368, 0);
				PED::SET_PED_SHOULD_PLAY_IMMEDIATE_SCENARIO_EXIT(Local_368);
				if (!PED::IS_PED_FLEEING(Local_368))
...
int func_259(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0x26F83
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_263(struct<3> Param0, struct<3> Param3)//Position - 0x2724F
{
...
int func_272(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0x27614
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
void func_278()//Position - 0x28106
{
	...
	switch (iLocal_275)
	{
		case 0:
			...
			iLocal_449 = 0;
			func_233(&uLocal_287);
			uLocal_287 = func_241(Local_331, 1, 1, 5);
			if (func_223(Local_331))
			{
		...
		case 1:
			...
			if ((func_223(Local_368) && ENTITY::HAS_ENTITY_BEEN_DAMAGED_BY_ENTITY(Local_368, PLAYER::PLAYER_PED_ID(), 1)) && !AUDIO::IS_ANY_SPEECH_PLAYING(Local_213.f_28[0]))
			{
			...
			if (bLocal_437)
			{
				...
				else
				{
					...
					if (iLocal_411 && !func_240(PLAYER::PLAYER_PED_ID(), 1087.297f, -791.3091f, 57.2626f, 60f))
					{
						iLocal_432 = 1;
						PED::CLEAR_RELATIONSHIP_BETWEEN_GROUPS(5, uLocal_758, 1862763509);
						func_224();
			...
			if (iLocal_432 == 0)
			{
				...
				if (func_458(Local_331) && !ENTITY::IS_ENTITY_OCCLUDED(Local_331))
				{
					func_302();
				}
				if (iLocal_426 == 0)
				...
				if ((iLocal_478 == 1 && MISC::GET_GAME_TIMER() > iLocal_477 + 1000) && func_223(Local_294[3 /*9*/]))
				{
				...
				if (func_223(Local_294[0 /*9*/]))
				{
					if (func_239(PLAYER::PLAYER_PED_ID(), Local_294[0 /*9*/], 1) < 12f && PLAYER::GET_PLAYER_CURRENT_STEALTH_NOISE(PLAYER::PLAYER_ID()) > 20f)
					{
						if (!PED::IS_PED_IN_COMBAT(Local_294[0 /*9*/], PLAYER::PLAYER_PED_ID()))
						{
							TASK::TASK_COMBAT_PED(Local_294[0 /*9*/], PLAYER::PLAYER_PED_ID(), 0, 16);
				...
				if (iLocal_427 == 0)
				{
					...
					if (func_458(Local_390) && VEHICLE::IS_VEHICLE_ALARM_ACTIVATED(Local_390))
					{
						if (iLocal_427 == 0)
						{
							if (func_458(Local_294[0 /*9*/]))
				...
				else
				{
					if (iLocal_432 == 0)
					{
						...
						else
						{
							...
							if (!func_222(Local_331, PLAYER::PLAYER_PED_ID(), 60f))
							{
								Var6 = { func_228() };
								if (MISC::ARE_STRINGS_EQUAL(&Var6, "PAP3_DEALER"))
								{
					...
					if (func_458(Local_331) && !func_222(PLAYER::PLAYER_PED_ID(), Local_331, 209f))
					{
						iLocal_274 = 7;
						iLocal_275 = 0;
					}
...
int func_280()//Position - 0x29CAD
{
	...
	if (func_223(Local_331))
	{
		...
		if (((func_223(Local_340) && ENTITY::IS_ENTITY_ON_SCREEN(Local_331)) && ENTITY::IS_ENTITY_ON_SCREEN(Local_340)) && CAM::IS_SPHERE_VISIBLE(ENTITY::GET_ENTITY_COORDS(Local_331, 1), 1f))
		{
			...
			{
				if (!func_222(Local_331, PLAYER::PLAYER_PED_ID(), 50f))
				{
					iLocal_429 = 1;
					return 0;
				}
...
int func_284(var uParam0, char* sParam1, int iParam2, int iParam3, char* sParam4, char* sParam5, int iParam6, int iParam7, var uParam8, var uParam9, bool bParam10, var uParam11, var uParam12, int iParam13, char* sParam14, char* sParam15, int iParam16)//Position - 0x29F66
{
	...
	if (!Global_14552)
	{
		if (Global_14393.f_1 == 6)
		{
			...
			func_285(1);
			func_288(Global_14374, "DISPLAY_VIEW", 1f, SYSTEM::TO_FLOAT(Global_14373), -1082130432, -1082130432, -1082130432);
		}
	}
	return 1;
}
					...
					if (iVar0 == Global_2270[iVar1 /*15*/].f_4)
					{
						if (Global_2832[iVar0] == 0)
						{
							...
							if (iVar1 == 1)
							{
								...
								func_286(Global_14374, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2270[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16760), -1f, &(Global_2270[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 7)
							{
								if (Global_68245)
								{
									...
									func_286(Global_14374, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2270[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar5), -1f, &(Global_2270[iVar1 /*15*/]), 0, 0, 0, 0);
								}
								else
								{
									switch (Global_14393)
									...
									func_286(Global_14374, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2270[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(iVar6), -1f, &(Global_2270[iVar1 /*15*/]), 0, 0, 0, 0);
								}
							}
							else if (iVar1 == 14)
							{
								func_286(Global_14374, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2270[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(Global_16755), -1f, &(Global_2270[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							else if (iVar1 == 20)
							{
								GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD(Global_14374, "SET_DATA_SLOT");
							...
							{
								func_286(Global_14374, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(1), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(Global_2270[iVar1 /*15*/].f_10), SYSTEM::TO_FLOAT(0), -1f, &(Global_2270[iVar1 /*15*/]), 0, 0, 0, 0);
							}
							Global_2832[iVar0] = 1;
						}
					}
...
int func_293(struct<6> Param0, struct<6> Param6)//Position - 0x2AB63
{
	struct<4> Var0;
	struct<4> Var6;
	int iVar12;
...
void func_309()//Position - 0x2B3AC
{
	...
	if (!MISC::IS_STRING_NULL_OR_EMPTY(&Var0))
	{
		if (MISC::ARE_STRINGS_EQUAL(&Var0, "PAP3_DEALER") && AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() > 0)
		{
			if (iLocal_474 == 0)
			{
				if (func_239(PLAYER::PLAYER_PED_ID(), Local_331, 1) > 40f)
				{
					iLocal_286 = 1;
					iLocal_474 = 1;
					iLocal_475 = 1;
...
void func_313(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2B8DF
{
	...
	*uParam0 = func_214();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_334())
		{
			func_330(PLAYER::PLAYER_PED_ID(), &(uParam0->f_472[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(iParam0, 0))
	{
		...
		*uParam1 = VEHICLE::GET_VEHICLE_NUMBER_PLATE_TEXT_INDEX(iParam0);
		...
		while (iVar0 <= 11)
		{
			...
			{
				MISC::SET_BIT(&(uParam1->f_53), func_325(iVar0 + 1));
			}
			iVar0++;
		}
...
void func_336(int iParam0, var uParam1)//Position - 0x2DE6E
{
	...
	if (!PED::IS_PED_INJURED(iParam0))
	{
		...
		while (iVar7 < iVar8)
		{
			if ((FILES::GET_DLC_WEAPON_DATA(iVar7, &Var9) && !func_337(Var9.f_1)) && iVar70 < 50)
			{
...
int func_343(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x2F25B
{
	int iVar0;
	int iVar1;
...
bool func_345(struct<3> Param0, struct<3> Param3)//Position - 0x2F8F5
{
	return ((Param0.x == Param3.x && Param0.f_1 == Param3.f_1) && Param0.f_2 == Param3.f_2);
}
...
int func_351(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2FCA0
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	if (bLocal_409)
	{
		...
		while (iVar6 <= 3)
		{
			if (func_223(Local_294[iVar6 /*9*/]))
			{
				...
				else if (func_222(Local_294[iVar6 /*9*/], PLAYER::PLAYER_PED_ID(), 5f))
				{
	...
	switch (iLocal_275)
	{
		case 0:
			if (!func_377())
			{
				...
				{
					uLocal_287 = func_241(Local_368, 1, 1, 5);
			...
			func_219(&uLocal_760, 8, Local_368, "Paparazzo3BDealerGoon1", 0, 1);
			iLocal_275 = 1;
			break;
		...
		case 1:
			...
			if (bLocal_409 == 1)
			{
				...
				if (ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_489, 5f, 5f, 2f, 0, 1, 0) && func_223(Local_368))
				{
					if (!PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()))
					{
						func_219(&uLocal_760, 8, Local_368, "Paparazzo3BDealerGoon1", 0, 1);
				...
				if ((ENTITY::IS_ENTITY_AT_COORD(PLAYER::PLAYER_PED_ID(), Local_489, 15f, 15f, 2f, 0, 1, 0) && func_223(Local_368)) && TASK::GET_SCRIPT_TASK_STATUS(Local_368, 993674639) == 1)
				{
		...
		case 2:
			...
			if ((!func_220() || func_239(PLAYER::PLAYER_PED_ID(), Local_368, 1) > (5f * 2f)) || ENTITY::IS_ENTITY_IN_ANGLED_AREA(PLAYER::PLAYER_PED_ID(), 1071.164f, -783.0585f, 53.73021f, 1062.915f, -782.8473f, 59.3433f, 3f, 0, 1, 0))
			{
				func_235();
				if (func_223(Local_368) && !PED::IS_PED_FLEEING(Local_368))
				{
	...
	if (bLocal_409)
	{
		...
		while (iVar0 <= 3)
		{
			if (func_223(Local_294[iVar0 /*9*/]))
			{
				...
				else if (func_222(Local_294[iVar0 /*9*/], PLAYER::PLAYER_PED_ID(), 5f))
				{
...
void func_380()//Position - 0x312E7
{
	...
	switch (iLocal_275)
	{
		...
		case 1:
			...
			{
				if ((AUDIO::GET_CURRENT_SCRIPTED_CONVERSATION_LINE() > 6 && !HUD::DOES_BLIP_EXIST(uLocal_287)) && func_223(Local_368))
				{
					uLocal_287 = func_241(Local_368, 1, 1, 5);
					if (HUD::DOES_BLIP_EXIST(uLocal_287))
					{
...
void func_397(int iParam0, struct<3> Param1, float fParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12)//Position - 0x31C62
{
	int iVar0;
...
int func_398(int iParam0, int iParam1, struct<3> Param2, float fParam5, bool bParam6, int iParam7)//Position - 0x31DEA
{
	var uVar0;
	var uVar1;
	struct<73> Var5;
...
void func_425(int iParam0, int iParam1)//Position - 0x35EEF
{
	...
	while (iVar0 < 9)
	{
		if (ENTITY::DOES_ENTITY_EXIST(Global_87698[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || ENTITY::GET_ENTITY_MODEL(Global_87698[iVar0]) == func_322(iParam0, iParam1))
				{
...
void func_426(struct<3> Param0, float fParam3, int iParam4)//Position - 0x35F90
{
	int iVar0;
...
void func_428(struct<54> Param0, var uParam54)//Position - 0x36155
{
...
int func_432(struct<3> Param0, float fParam3)//Position - 0x37990
{
	return func_433(&(Global_93588.f_2167), Param0, fParam3, 0);
}

int func_433(var uParam0, struct<3> Param1, float fParam4, bool bParam5)//Position - 0x379AA
{
	int iVar0;
	struct<3> Var1;
	bool bVar4;
...
int func_435(int iParam0, struct<3> Param1, bool bParam4)//Position - 0x37D18
{
	int iVar0;
	var uVar1[3];
	int iVar5;
	...
	switch (iVar0)
	{
		...
		case joaat("cuban800"):
			...
			while (iVar6 <= (iVar5 - 1))
			{
				if (func_437(iParam0, uVar1[iVar6], 1) && func_436(ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 2136.133f, 4780.563f, 39.9702f, 5f))
				{
					if ((!bParam4 || func_345(Param1, 0f, 0f, 0f)) || MISC::GET_DISTANCE_BETWEEN_COORDS(ENTITY::GET_ENTITY_COORDS(iParam0, 1), ENTITY::GET_ENTITY_COORDS(uVar1[iVar6], 1), 1) < 10f)
					{
...
int func_436(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0x37F1E
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
void func_438(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x37FCA
{
	...
	if (VEHICLE::IS_VEHICLE_DRIVEABLE(uParam0, 0))
	{
		...
		if (((MISC::IS_BIT_SET(uParam1->f_53, 15) || func_440(iParam0)) || (((uParam1->f_38 == 0 && uParam1->f_39 == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_439())
		{
			uParam1->f_38 = 0;
			uParam1->f_39 = 0;
			uParam1->f_40 = 0;
		...
		if (!VEHICLE::IS_THIS_MODEL_A_HELI(uParam1->f_42) && !VEHICLE::IS_THIS_MODEL_A_BOAT(uParam1->f_42))
		{
			...
			while (iVar0 <= 11)
			{
				if (MISC::IS_BIT_SET(uParam1->f_53, func_325(iVar0 + 1)))
				{
					if (!VEHICLE::IS_VEHICLE_EXTRA_TURNED_ON(iParam0, iVar0 + 1))
					{
...
void func_455(struct<3> Param0, float fParam3, int iParam4, int iParam5)//Position - 0x388A2
{
	if (func_494())
	{
...
{
	if (((!func_479(0) || Global_68514) || Global_68503 == 1) || !CAM::IS_SCREEN_FADED_IN())
	{
		return 0;
	}
	switch (Global_68499)
...
void func_482(int iParam0)//Position - 0x3982C
{
	if (iParam0 == 1)
	{
		MISC::SET_BIT(&Global_2265, 4);
	}
	else
	{
		MISC::CLEAR_BIT(&Global_2265, 4);
	}
}
...
void func_504(char* sParam0)//Position - 0x3A4BF
{
	...
	while (iVar0 < 35)
	{
		if (!MISC::IS_STRING_NULL(&(Global_97353.f_12395[iVar0 /*104*/])))
		{
			if (MISC::ARE_STRINGS_EQUAL(&(Global_97353.f_12395[iVar0 /*104*/]), sParam0))
			{
