...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(4))
	{
		...
		HUD::PAUSE_MENU_SET_BUSY_SPINNER(0, -1, 0);
		Global_1312435 = 0;
	...
	Global_1323632.f_7 = 0;
	Global_1323632.f_6 = 0;
	func_133(&Global_1327209);
	func_132(0, &Global_1327209);
	func_131(&Global_1327209);
	func_129(&Global_1326354);
	func_128(-1, &Global_1326354);
	func_127(&Global_1326354);
	func_126(&Global_1326354);
	func_122();
	...
	switch (iScriptParam_0)
	{
		case 3:
			while (iVar0 == 0)
			{
				...
				if (Global_1326354.f_469 == 0 && Global_1326354.f_470 == 0)
				{
					if (PAD::IS_CONTROL_JUST_PRESSED(2, 201))
					{
						if (iVar1 == 0)
						{
							...
							func_132(Global_1323632.f_6, &Global_1327209);
							func_131(&Global_1327209);
							GRAPHICS::BEGIN_SCALEFORM_MOVIE_METHOD_ON_FRONTEND("MENU_SHIFT_DEPTH");
							GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_INT(1);
							GRAPHICS::END_SCALEFORM_MOVIE_METHOD();
						...
						else
						{
							switch (Global_1323632.f_7)
							{
								case 0:
									...
									HUD::PAUSE_MENU_DEACTIVATE_CONTEXT(874957556);
									HUD::_0x4895BDEA16E7C080(0);
									Global_1323632.f_7 = 1;
									func_120(&Global_1326354, &Global_1323632);
									func_128(func_119(&(Global_1323632.f_1), &(Global_1323632.f_3), Global_1323632.f_5, 188), &Global_1326354);
									func_127(&Global_1326354);
									func_126(&Global_1326354);
									func_117(&Global_1326354, &Global_1323632);
									break;
								}
							}
						}
				...
				func_15(&Global_1323632);
				if (iVar1 == 1)
				{
					func_2(&Global_1326354, &Global_1323632, &uLocal_204);
				}
			}
			break;
...
void func_2(var uParam0, var uParam1, var uParam2)//Position - 0x4CF
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if ((PAD::IS_CONTROL_PRESSED(2, 187) || func_12(187, &(Global_1327593.f_961), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		MISC::SET_BIT(&(uParam0->f_464), 0);
	}
	if ((PAD::IS_CONTROL_PRESSED(2, 188) || func_12(188, &(Global_1327593.f_961), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		MISC::SET_BIT(&(uParam0->f_464), 1);
	}
	if (((PAD::IS_CONTROL_PRESSED(2, 189) || PAD::IS_CONTROL_PRESSED(2, 241)) || func_12(189, &(Global_1327593.f_961), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
		MISC::SET_BIT(&(uParam0->f_464), 2);
	}
	if (((PAD::IS_CONTROL_PRESSED(2, 190) || PAD::IS_CONTROL_PRESSED(2, 242)) || func_12(190, &(Global_1327593.f_961), 1)) && iVar0)
	{
		func_11(uParam2);
		func_10(uParam2, 0, 0);
	...
	if (MISC::IS_BIT_SET(uParam0->f_464, 1))
	{
		...
		switch (uParam1->f_7)
		{
			case 0:
				...
				func_132(uParam1->f_6, &Global_1327209);
				func_131(&Global_1327209);
				uParam0->f_469 = 1;
			...
			case 1:
				...
				func_128(func_119(&(uParam1->f_1), &(uParam1->f_3), uParam1->f_5, 188), uParam0);
				func_127(uParam0);
				func_126(uParam0);
	...
	if (MISC::IS_BIT_SET(uParam0->f_464, 0))
	{
		...
		switch (uParam1->f_7)
		{
			...
			case 1:
				...
				func_128(func_119(&(uParam1->f_1), &(uParam1->f_3), uParam1->f_5, 187), uParam0);
				func_127(uParam0);
				func_126(uParam0);
				func_117(uParam0, uParam1);
				break;
		...
		switch (uParam1->f_7)
		{
			case 1:
				...
				if (uParam1->f_1 < 0)
				{
					...
					{
						uParam1->f_5 = iLocal_202;
						uParam1->f_1 = 3;
						iVar1 = (uParam1->f_1 + uParam1->f_3 * 4);
						if (iVar1 >= iLocal_203)
						{
							uParam1->f_1 = ((iLocal_203 - 1) % 4);
							uParam1->f_3 = ((iLocal_203 - 1) / 4);
						}
					}
				}
				AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_LEFT_RIGHT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
				func_128(func_119(&(uParam1->f_1), &(uParam1->f_3), uParam1->f_5, 189), uParam0);
				func_127(uParam0);
				func_126(uParam0);
				func_117(uParam0, uParam1);
				break;
	...
	if (MISC::IS_BIT_SET(uParam0->f_464, 3))
	{
		...
		switch (uParam1->f_7)
		{
			case 1:
				...
				if (uParam1->f_1 >= 4 || (uParam1->f_5 == iLocal_202 && iVar2 >= iLocal_203))
				{
					if (iLocal_202 >= 1)
					{
						func_129(uParam0);
					...
					uParam1->f_1 = 0;
					uParam1->f_5++;
					if (uParam1->f_5 > iLocal_202)
					{
						uParam1->f_5 = 0;
					}
				}
				AUDIO::PLAY_SOUND_FRONTEND(-1, "NAV_LEFT_RIGHT", "HUD_FRONTEND_DEFAULT_SOUNDSET", 1);
				func_128(func_119(&(uParam1->f_1), &(uParam1->f_3), uParam1->f_5, 190), uParam0);
				func_127(uParam0);
				func_126(uParam0);
				func_117(uParam0, uParam1);
				break;
		...
		switch (uParam1->f_7)
		{
			case 0:
				if (iVar4 == 0 || iVar4 == 1)
				{
					...
					{
						Global_1323632.f_1 = (iVar5 % 4);
						Global_1323632.f_3 = (iVar5 / 4);
					}
				}
				break;
			}
...
void func_3(int iParam0)//Position - 0xB23
{
	HUD::PAUSE_MENU_SET_BUSY_SPINNER(iParam0, 6, 0);
}

int func_4(var uParam0, int iParam1, bool bParam2)//Position - 0xB33
{
	if (iParam1 == -1)
	{
		return 1;
...
void func_5(var uParam0, bool bParam1, bool bParam2)//Position - 0xB9D
{
...
int func_6(var uParam0, bool bParam1)//Position - 0xBDA
{
	int iVar0;
	int iVar1;
...
int func_7()//Position - 0xC1B
{
	return Global_1312737;
}

int func_8()//Position - 0xC27
{
	return Global_24445;
}

int func_9()//Position - 0xC32
{
	return Global_24444;
}

void func_10(var uParam0, bool bParam1, bool bParam2)//Position - 0xC3D
{
	if (uParam0->f_1 == 0)
	{
		if (NETWORK::NETWORK_IS_GAME_IN_PROGRESS() && !bParam1)
...
void func_11(var uParam0)//Position - 0xC82
{
	uParam0->f_1 = 0;
}

int func_12(int iParam0, var uParam1, int iParam2)//Position - 0xC8F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_13(var uParam0, int iParam1, bool bParam2)//Position - 0xDF2
{
	if (iParam1 == -1)
	{
		return 1;
...
bool func_14(var uParam0)//Position - 0xE50
{
	return uParam0->f_1;
}

void func_15(var uParam0)//Position - 0xE5C
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (((((((GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards1") && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards2")) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards3")) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards4")) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards5")) && GRAPHICS::HAS_STREAMED_TEXTURE_DICT_LOADED("MPAwards6")) && iVar0) && iVar1)
		{
			...
			switch (uParam0->f_5)
			{
				case 0:
					...
					{
						case 0:
							func_110(9, 8, iVar3, &Global_1326354);
							func_110(1, 8, iVar3, &Global_1326354);
							func_110(4, 8, iVar3, &Global_1326354);
							func_110(5, 8, iVar3, &Global_1326354);
							func_110(2, 8, iVar3, &Global_1326354);
							func_110(8, 8, iVar3, &Global_1326354);
							func_110(7, 8, iVar3, &Global_1326354);
							func_110(3, 8, iVar3, &Global_1326354);
							func_110(6, 8, iVar3, &Global_1326354);
							func_110(10, 8, iVar3, &Global_1326354);
							func_110(19, 8, iVar3, &Global_1326354);
							func_110(24, 8, iVar3, &Global_1326354);
							break;
						
						case 1:
							func_110(40, 8, iVar3, &Global_1326354);
							func_110(41, 8, iVar3, &Global_1326354);
							func_110(42, 8, iVar3, &Global_1326354);
							func_110(21, 8, iVar3, &Global_1326354);
							func_110(58, 8, iVar3, &Global_1326354);
							func_110(57, 8, iVar3, &Global_1326354);
							func_110(37, 8, iVar3, &Global_1326354);
							func_98(20, 8, iVar3, &Global_1326354);
							func_110(51, 8, iVar3, &Global_1326354);
							func_110(52, 8, iVar3, &Global_1326354);
							func_110(54, 8, iVar3, &Global_1326354);
							func_98(14, 8, iVar3, &Global_1326354);
							break;
						
						case 2:
							func_98(15, 8, iVar3, &Global_1326354);
							func_98(16, 8, iVar3, &Global_1326354);
							func_110(29, 8, iVar3, &Global_1326354);
							func_110(28, 8, iVar3, &Global_1326354);
							func_110(47, 8, iVar3, &Global_1326354);
							func_98(6, 8, iVar3, &Global_1326354);
							func_98(7, 8, iVar3, &Global_1326354);
							func_110(30, 8, iVar3, &Global_1326354);
							func_98(2, 8, iVar3, &Global_1326354);
							func_110(36, 8, iVar3, &Global_1326354);
							func_110(49, 8, iVar3, &Global_1326354);
							func_110(15, 8, iVar3, &Global_1326354);
							break;
						
						case 3:
							func_110(60, 8, iVar3, &Global_1326354);
							func_110(19, 8, iVar3, &Global_1326354);
							func_110(53, 8, iVar3, &Global_1326354);
							func_110(12, 8, iVar3, &Global_1326354);
							func_110(11, 8, iVar3, &Global_1326354);
							func_110(18, 8, iVar3, &Global_1326354);
							func_110(14, 8, iVar3, &Global_1326354);
							func_110(66, 8, iVar3, &Global_1326354);
							break;
						
						case 4:
							func_110(10, 8, iVar3, &Global_1326354);
							func_110(17, 8, iVar3, &Global_1326354);
							func_110(61, 8, iVar3, &Global_1326354);
							func_110(0, 8, iVar3, &Global_1326354);
							func_110(16, 8, iVar3, &Global_1326354);
							func_98(13, 8, iVar3, &Global_1326354);
							func_110(20, 8, iVar3, &Global_1326354);
							func_110(62, 8, iVar3, &Global_1326354);
							func_110(63, 8, iVar3, &Global_1326354);
							func_98(23, 8, iVar3, &Global_1326354);
							func_110(68, 8, iVar3, &Global_1326354);
							func_98(27, 8, iVar3, &Global_1326354);
							break;
						
						case 5:
							func_110(9, 8, iVar3, &Global_1326354);
							func_110(56, 8, iVar3, &Global_1326354);
							func_110(55, 8, iVar3, &Global_1326354);
							func_110(45, 8, iVar3, &Global_1326354);
							func_110(43, 8, iVar3, &Global_1326354);
							func_110(46, 8, iVar3, &Global_1326354);
							func_110(44, 8, iVar3, &Global_1326354);
							func_98(22, 8, iVar3, &Global_1326354);
							func_98(17, 8, iVar3, &Global_1326354);
							func_98(18, 8, iVar3, &Global_1326354);
							func_110(59, 8, iVar3, &Global_1326354);
							func_110(1, 8, iVar3, &Global_1326354);
							break;
						
						case 6:
							func_110(69, 8, iVar3, &Global_1326354);
							func_87(1, 8, iVar3, &Global_1326354);
							func_87(2, 8, iVar3, &Global_1326354);
							func_87(3, 8, iVar3, &Global_1326354);
							func_87(4, 8, iVar3, &Global_1326354);
							func_87(5, 8, iVar3, &Global_1326354);
							func_110(70, 8, iVar3, &Global_1326354);
							func_87(6, 8, iVar3, &Global_1326354);
							func_87(7, 8, iVar3, &Global_1326354);
							func_87(8, 8, iVar3, &Global_1326354);
							func_110(74, 8, iVar3, &Global_1326354);
							func_98(29, 8, iVar3, &Global_1326354);
							break;
						
						case 7:
							func_81(4, 8, iVar3, &Global_1326354);
							func_81(2, 8, iVar3, &Global_1326354);
							func_81(7, 8, iVar3, &Global_1326354);
							func_81(0, 8, iVar3, &Global_1326354);
							func_81(6, 8, iVar3, &Global_1326354);
							func_81(8, 8, iVar3, &Global_1326354);
							func_81(5, 8, iVar3, &Global_1326354);
							func_81(3, 8, iVar3, &Global_1326354);
							func_81(1, 8, iVar3, &Global_1326354);
							func_81(54, 8, iVar3, &Global_1326354);
							func_81(57, 8, iVar3, &Global_1326354);
							func_81(58, 8, iVar3, &Global_1326354);
							break;
					}
					break;
				...
				case 1:
					switch (uParam0->f_6)
					{
						case 0:
							...
							func_110(12, 8, iVar3, &Global_1326354);
							func_110(40, 8, iVar3, &Global_1326354);
							func_110(31, 8, iVar3, &Global_1326354);
							func_110(37, 8, iVar3, &Global_1326354);
							func_110(34, 8, iVar3, &Global_1326354);
							func_110(33, 8, iVar3, &Global_1326354);
							func_110(32, 8, iVar3, &Global_1326354);
							func_110(41, 8, iVar3, &Global_1326354);
							func_110(35, 8, iVar3, &Global_1326354);
							func_110(63, 8, iVar3, &Global_1326354);
							func_69(1, 8, iVar3, &Global_1326354);
							break;
						
						case 1:
							func_110(39, 8, iVar3, &Global_1326354);
							func_98(11, 8, iVar3, &Global_1326354);
							func_110(38, 8, iVar3, &Global_1326354);
							func_98(10, 8, iVar3, &Global_1326354);
							func_110(48, 8, iVar3, &Global_1326354);
							func_110(22, 8, iVar3, &Global_1326354);
							func_110(23, 8, iVar3, &Global_1326354);
							func_110(31, 8, iVar3, &Global_1326354);
							func_110(35, 8, iVar3, &Global_1326354);
							func_98(4, 8, iVar3, &Global_1326354);
							func_98(5, 8, iVar3, &Global_1326354);
							func_110(32, 8, iVar3, &Global_1326354);
							break;
						
						case 2:
							if (!Global_1326354.f_1[0])
							{
								func_110(50, 8, iVar3, &Global_1326354);
								func_98(9, 8, iVar3, &Global_1326354);
								func_98(12, 8, iVar3, &Global_1326354);
								func_110(27, 8, iVar3, &Global_1326354);
								func_98(0, 8, iVar3, &Global_1326354);
								func_98(21, 8, iVar3, &Global_1326354);
								func_69(1, 8, iVar3, &Global_1326354);
								func_69(0, 8, iVar3, &Global_1326354);
								func_69(3, 8, iVar3, &Global_1326354);
								func_69(2, 8, iVar3, &Global_1326354);
								func_110(76, 8, iVar3, &Global_1326354);
								func_110(77, 8, iVar3, &Global_1326354);
							}
							break;
						...
						case 5:
							if (!Global_1326354.f_1[0])
							{
								func_110(5, 8, iVar3, &Global_1326354);
								func_110(4, 8, iVar3, &Global_1326354);
								func_110(25, 8, iVar3, &Global_1326354);
								func_110(2, 8, iVar3, &Global_1326354);
								func_110(26, 8, iVar3, &Global_1326354);
								func_110(7, 8, iVar3, &Global_1326354);
								func_110(3, 8, iVar3, &Global_1326354);
								func_110(6, 8, iVar3, &Global_1326354);
								func_110(8, 8, iVar3, &Global_1326354);
								func_110(24, 8, iVar3, &Global_1326354);
								func_110(78, 8, iVar3, &Global_1326354);
								func_110(80, 8, iVar3, &Global_1326354);
							}
							break;
						...
						case 6:
							if (!Global_1326354.f_1[0])
							{
								func_110(72, 8, iVar3, &Global_1326354);
								func_110(71, 8, iVar3, &Global_1326354);
								func_98(31, 8, iVar3, &Global_1326354);
								func_98(28, 8, iVar3, &Global_1326354);
								func_98(32, 8, iVar3, &Global_1326354);
								func_110(81, 8, iVar3, &Global_1326354);
								func_87(10, 8, iVar3, &Global_1326354);
								if ((MISC::IS_DURANGO_VERSION() || MISC::IS_ORBIS_VERSION()) || MISC::IS_PC_VERSION())
								{
									func_87(9, 8, iVar3, &Global_1326354);
								}
							}
							break;
						
						case 7:
							func_81(59, 8, iVar3, &Global_1326354);
							func_81(60, 8, iVar3, &Global_1326354);
							func_81(12, 8, iVar3, &Global_1326354);
							func_81(56, 8, iVar3, &Global_1326354);
							func_81(55, 8, iVar3, &Global_1326354);
							func_81(25, 8, iVar3, &Global_1326354);
							func_81(34, 8, iVar3, &Global_1326354);
							func_81(45, 8, iVar3, &Global_1326354);
							func_81(48, 8, iVar3, &Global_1326354);
							func_81(49, 8, iVar3, &Global_1326354);
							func_81(65, 8, iVar3, &Global_1326354);
							func_81(46, 8, iVar3, &Global_1326354);
							break;
					}
					break;
				...
				case 2:
					switch (uParam0->f_6)
					{
						...
						case 1:
							...
							{
								func_110(34, 8, iVar3, &Global_1326354);
								func_98(3, 8, iVar3, &Global_1326354);
								func_110(33, 8, iVar3, &Global_1326354);
								func_98(8, 8, iVar3, &Global_1326354);
								func_110(84, 8, iVar3, &Global_1326354);
								func_110(85, 8, iVar3, &Global_1326354);
								func_110(86, 8, iVar3, &Global_1326354);
								func_110(75, 8, iVar3, &Global_1326354);
								func_110(79, 8, iVar3, &Global_1326354);
							}
							break;
						...
						case 2:
							if (!Global_1326354.f_1[0])
							{
								func_110(83, 8, iVar3, &Global_1326354);
								func_98(33, 8, iVar3, &Global_1326354);
								func_110(87, 8, iVar3, &Global_1326354);
								func_110(67, 8, iVar3, &Global_1326354);
								func_98(25, 8, iVar3, &Global_1326354);
								func_98(26, 8, iVar3, &Global_1326354);
							}
							break;
						...
						case 5:
							if (!Global_1326354.f_1[0])
							{
								func_110(82, 8, iVar3, &Global_1326354);
								func_110(65, 8, iVar3, &Global_1326354);
							}
							break;
						...
						case 7:
							if (!Global_1326354.f_1[0])
							{
								func_81(9, 8, iVar3, &Global_1326354);
								func_81(10, 8, iVar3, &Global_1326354);
								func_81(11, 8, iVar3, &Global_1326354);
								func_81(87, 8, iVar3, &Global_1326354);
								func_81(88, 8, iVar3, &Global_1326354);
								func_81(89, 8, iVar3, &Global_1326354);
								iVar2 = 0;
								if (func_66(3608, -1, -1))
								{
									iVar2 = 1;
								}
								func_62("CLO_LTS_T_0", "CLO_LTS_TD_0", "Elitas_Tshirt", "MPTshirtAwardLTS", 1, iVar2, -1, 1, &Global_1326354);
								func_59(0);
								func_59(1);
								func_59(2);
								iVar2 = 0;
								...
								func_62("CLO_HST_A_4", "CLO_HST_AD_5", "CantTouchThis", "MPTShirtAwards2", 1, iVar2, -1, 1, &Global_1326354);
								func_59(5);
							}
							break;
					}
				...
				case 3:
					switch (uParam0->f_6)
					{
						...
						case 7:
							...
							func_62("CLO_HST_A_9", "CLO_HST_AD_9", "Showroom", "MPTShirtAwards2", 1, iVar2, -1, 1, &Global_1326354);
							func_62("CHR_HST_A_0", "CHR_HST_AD_0", "SportMod", "MPAwardMods", func_44(75, 5, 0), func_42(75, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_1", "CHR_HST_AD_1", "LowriderMod", "MPAwardMods", func_44(76, 5, 0), func_42(76, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_2", "CHR_HST_AD_2", "OffroadMod", "MPAwardMods", func_44(78, 5, 0), func_42(78, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_3", "CHR_HST_AD_3", "HighendMod", "MPAwardMods", func_44(69, 5, 0), func_42(69, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_4", "CHR_HST_AD_4", "TunerMod", "MPAwardMods", func_44(70, 5, 0), func_42(70, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_5", "CHR_HST_AD_5", "BikeMod", "MPAwardMods", func_44(80, 5, 0), func_42(80, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_6", "CHR_HST_AD_6", "SUVMod", "MPAwardMods", func_44(84, 5, 0), func_42(84, -1), -1, 1, &Global_1326354);
							func_62("CHR_HST_A_7", "CHR_HST_AD_7", "MuscleMod", "MPAwardMods", func_44(85, 5, 0), func_42(85, -1), -1, 1, &Global_1326354);
							break;
					}
					break;
			...
			func_29(&Global_1326354, func_41(&Global_1326354));
			func_28(1, &Global_1327209);
			func_27(1, &Global_1327209);
			func_26(1, &Global_1327209);
			func_25(0, "HUD_AWDLIST1", &Global_1327209);
			func_25(1, "HUD_AWDLIST12", &Global_1327209);
			func_25(2, "HUD_AWDLIST3b", &Global_1327209);
			func_25(3, "HUD_AWDLIST6", &Global_1327209);
			func_25(4, "HUD_AWDLIST9", &Global_1327209);
			func_25(5, "HUD_AWDLIST10", &Global_1327209);
			func_25(6, "HUD_AWDLIST13", &Global_1327209);
			func_25(7, "HUD_AWDLIST6b", &Global_1327209);
			func_16(&Global_1327209, func_24(&Global_1327209));
		}
	}
}

void func_16(var uParam0, int iParam1)//Position - 0x2402
{
	int iVar0;
	int iVar1;
...
void func_17(var uParam0, int iParam1)//Position - 0x2522
{
	if (iParam1 == 1)
	{
		uParam0->f_381 = 0;
...
void func_18(var uParam0)//Position - 0x2575
{
	uParam0->f_383 = 0;
}

int func_19(var uParam0)//Position - 0x2583
{
	return uParam0->f_383;
}

void func_20(int iParam0)//Position - 0x2590
{
...
void func_21(var uParam0)//Position - 0x25AD
{
	GRAPHICS::SCALEFORM_MOVIE_METHOD_ADD_PARAM_PLAYER_NAME_STRING(uParam0);
}

void func_22(char* sParam0)//Position - 0x25BB
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
	GRAPHICS::END_TEXT_COMMAND_SCALEFORM_STRING();
}

void func_23(var uParam0)//Position - 0x25CD
{
	uParam0->f_382 = 0;
}

int func_24(var uParam0)//Position - 0x25DB
{
	return uParam0->f_382;
}

void func_25(int iParam0, char* sParam1, var uParam2)//Position - 0x25E8
{
	StringCopy(&(uParam2->f_18[iParam0 /*16*/]), sParam1, 64);
	uParam2->f_1[iParam0] = 1;
}

void func_26(int iParam0, var uParam1)//Position - 0x2605
{
	uParam1->f_379 = iParam0;
}

void func_27(int iParam0, var uParam1)//Position - 0x2614
{
	uParam1->f_377 = iParam0;
}

void func_28(int iParam0, var uParam1)//Position - 0x2623
{
	uParam1->f_378 = iParam0;
}

void func_29(var uParam0, int iParam1)//Position - 0x2632
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_30(var uParam0, int iParam1)//Position - 0x281B
{
	if (iParam1 == 1)
	{
		uParam0->f_458 = 0;
...
void func_31(var uParam0)//Position - 0x2865
{
	uParam0->f_462 = 0;
}

int func_32(var uParam0)//Position - 0x2873
{
	return uParam0->f_462;
}

void func_33(var uParam0, int iParam1)//Position - 0x2880
{
	if (iParam1 == 1)
	{
		uParam0->f_459 = 0;
...
void func_34(char* sParam0, var uParam1)//Position - 0x292C
{
	GRAPHICS::BEGIN_TEXT_COMMAND_SCALEFORM_STRING(sParam0);
...
void func_35(var uParam0)//Position - 0x2944
{
	uParam0->f_463 = 0;
}

int func_36(var uParam0)//Position - 0x2952
{
	return uParam0->f_463;
}

int func_37(char[4] cParam0)//Position - 0x295F
{
...
char* func_38(int iParam0)//Position - 0x2999
{
	switch (iParam0)
	{
		case 107:
...
int func_39(var uParam0)//Position - 0x29EC
{
	int iVar0;
...
void func_40(var uParam0)//Position - 0x2A48
{
	uParam0->f_460 = 0;
}

int func_41(var uParam0)//Position - 0x2A56
{
	return uParam0->f_460;
}

int func_42(int iParam0, int iParam1)//Position - 0x2A63
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2475233[iParam0 /*6*/][func_43(iParam1)];
...
int func_43(var uParam0)//Position - 0x2A8F
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1, int iParam2)//Position - 0x2AC3
{
	if (iParam2 == 0)
	{
	}
...
int func_45(int iParam0)//Position - 0x457C
{
	bool bVar0;
	
	bVar0 = func_56(386, -1, -1) == false;
	if (bVar0)
	{
		if (func_46(func_52(func_55(iParam0, bVar0), 3), -1))
		{
			return 1;
		}
		else
	...
	if (func_46(func_52(func_55(iParam0, bVar0), 4), -1))
	{
		return 1;
	}
	return 0;
...
bool func_46(int iParam0, int iParam1)//Position - 0x45D6
{
	var uVar0;
	int iVar1;
	
	if (func_50(iParam0) == 2903)
	{
		return 0;
	}
	uVar0 = func_48(iParam0, iParam1);
	iVar1 = iParam0;
	return MISC::IS_BIT_SET(uVar0, func_47(iVar1));
}

int func_47(int iParam0)//Position - 0x4608
{
	return (iParam0 % 32);
}

int func_48(var uParam0, int iParam1)//Position - 0x4615
{
	int iVar0;
	
	iVar0 = func_49(func_50(uParam0), iParam1, 0);
	return iVar0;
}

int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x462E
{
	var uVar0;
	var uVar1;
	...
	uVar0 = Global_2454605[iParam0 /*6*/][func_43(iParam1)];
	if (STATS::STAT_GET_INT(uVar0, &uVar1, -1))
	{
		return uVar1;
	}
...
int func_50(var uParam0)//Position - 0x4660
{
	int iVar0;
	int iVar1;
...
int func_51(int iParam0)//Position - 0x47AD
{
	return (iParam0 / 32);
}

int func_52(int iParam0, int iParam1)//Position - 0x47BA
{
	var uVar0;
	int iVar1;
	int iVar2;
...
int func_53(int iParam0, var uParam1)//Position - 0x482B
{
	int iVar0;
...
int func_54(int iParam0, var uParam1)//Position - 0x5660
{
	int iVar0;
...
int func_55(int iParam0, bool bParam1)//Position - 0x63DF
{
	switch (iParam0)
	{
		case 0:
...
int func_56(int iParam0, int iParam1, int iParam2)//Position - 0x6892
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_57(int iParam0)//Position - 0x68D8
{
	int iVar0;
...
int func_58(int iParam0, int iParam1)//Position - 0x6A52
{
	int iVar0;
...
void func_59(int iParam0)//Position - 0x6BA4
{
	char* sVar0;
	char* sVar1;
	char* sVar2;
	...
	if (iParam0 != 34)
	{
		iVar7 = func_44(iVar4, iVar6, 9);
		iVar8 = func_42(iVar4, -1);
	}
	else
	{
		iVar7 = 5;
	...
	func_62(sVar0, sVar1, sVar2, sVar3, iVar7, iVar8, -1, iVar5, &Global_1326354);
}

int func_60()//Position - 0x6D20
{
	int iVar0;
...
int func_61(int iParam0, int iParam1)//Position - 0x6D84
{
	if (iParam1 == 9)
	{
	}
...
void func_62(char* sParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, var uParam8)//Position - 0x70F7
{
	int iVar0;
...
void func_63(int iParam0, char* sParam1, char* sParam2, var uParam3, var uParam4, var uParam5)//Position - 0x714B
{
...
void func_64(int iParam0, char* sParam1, char* sParam2, var uParam3, int iParam4, var uParam5)//Position - 0x717F
{
...
int func_65(int iParam0)//Position - 0x71BA
{
	switch (iParam0)
	{
		case 2:
...
int func_66(int iParam0, int iParam1, int iParam2)//Position - 0x7209
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	iVar1 = func_68(iParam0, iParam1);
	uVar2 = func_67(iParam0);
	if (0 != iVar1)
	{
...
int func_67(int iParam0)//Position - 0x7246
{
	int iVar0;
...
int func_68(int iParam0, int iParam1)//Position - 0x73A6
{
	int iVar0;
...
void func_69(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x74F1
{
	int iVar0;
	char* sVar1;
	char* sVar2;
	...
	if (iParam1 != 0)
	{
		if (iParam1 != 1)
		{
			if (func_77(iParam0, iParam2) != 1)
			{
				iParam1 = 1;
			}
		}
	}
	sVar1 = func_76(iParam0, iParam2, 0);
	sVar2 = func_75(iParam0, iParam1, iParam2, 0);
	sVar3 = func_74(iParam0, iParam2);
	sVar4 = func_73(iParam0, iParam2);
	iVar5 = func_72(iParam0, iVar0, iParam2);
	iVar6 = func_71(iParam0);
	iVar7 = func_70(iParam1);
	iVar8 = func_72(iParam0, iVar7, iParam2);
	iVar9 = (iVar5 - iVar8);
	iVar10 = (iVar6 - iVar8);
	iVar11 = SYSTEM::FLOOR(((SYSTEM::TO_FLOAT(iVar10) / SYSTEM::TO_FLOAT(iVar9)) * 100f));
	func_62(sVar1, sVar2, sVar3, sVar4, iVar5, iVar6, iVar11, iParam1, uParam3);
}

int func_70(int iParam0)//Position - 0x762A
{
	int iVar0;
...
int func_71(int iParam0)//Position - 0x7683
{
	var uVar0;
	var uVar1;
	var uVar2;
	
	uVar0 = Global_1335462[iParam0];
	uVar1 = uVar0;
...
int func_72(int iParam0, int iParam1, int iParam2)//Position - 0x76AB
{
	if (iParam2 == 0)
	{
	}
...
char* func_73(int iParam0, int iParam1)//Position - 0x7801
{
	if (iParam1 == 9)
	{
	}
...
char* func_74(int iParam0, int iParam1)//Position - 0x784F
{
	if (iParam1 == 9)
	{
	}
...
char* func_75(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x789D
{
	if (iParam2 == 9)
	{
	}
	...
	if (func_72(iParam0, iParam1, iParam2) == 1)
	{
	}
	switch (iParam0)
	{
...
char* func_76(int iParam0, int iParam1, bool bParam2)//Position - 0x78FE
{
	if (bParam2)
	{
	}
...
int func_77(int iParam0, int iParam1)//Position - 0x7951
{
	if (iParam1 == 9)
	{
	}
...
int func_78(int iParam0, int iParam1)//Position - 0x7990
{
	if (func_79(func_71(iParam0), func_72(iParam0, 5, iParam1)))
	{
		return 5;
	}
	if (func_79(func_71(iParam0), func_72(iParam0, 4, iParam1)))
	{
		return 5;
	}
	if (func_79(func_71(iParam0), func_72(iParam0, 3, iParam1)))
	{
		return 4;
	}
	if (func_79(func_71(iParam0), func_72(iParam0, 2, iParam1)))
	{
		return 3;
	}
	return 2;
...
int func_79(int iParam0, int iParam1)//Position - 0x7A01
{
	if (iParam1 <= iParam0)
	{
		return 1;
...
int func_80(int iParam0, int iParam1)//Position - 0x7A15
{
	if (!func_79(func_71(iParam0), func_72(iParam0, 5, iParam1)))
	{
		return 0;
...
void func_81(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x7A8A
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	sVar2 = func_85(iParam0, iVar0);
	sVar3 = func_84(iParam0, iVar0);
	sVar4 = func_83(iParam0, iVar0);
	sVar5 = func_82(iParam0, iVar0);
	iVar6 = func_44(iVar1, iParam1, 0);
	iVar7 = func_42(iVar1, -1);
	if (iVar1 == 64)
	{
		iVar6 = 1;
		iVar7 = 0;
	...
	if (func_46(iParam0, -1))
	{
		iVar7 = func_44(func_86(iParam0), iParam1, 0);
		if (iVar1 == 64)
		{
			iVar7 = 1;
		}
	...
	iParam1 = 1;
	func_62(sVar2, sVar3, sVar4, sVar5, iVar6, iVar7, iVar8, iParam1, uParam3);
}

char* func_82(int iParam0, int iParam1)//Position - 0x7BB1
{
	char* sVar0;
...
char* func_83(int iParam0, int iParam1)//Position - 0x7C96
{
	char* sVar0;
...
char* func_84(int iParam0, int iParam1)//Position - 0x8152
{
	char* sVar0;
...
char* func_85(int iParam0, int iParam1)//Position - 0x860E
{
	char* sVar0;
...
int func_86(int iParam0)//Position - 0x8ACA
{
	switch (iParam0)
	{
		case 4:
...
void func_87(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x8BC0
{
	int iVar0;
	int iVar1;
	char* sVar2;
	...
	iVar1 = func_96();
	sVar2 = func_94(iParam0, iParam2, 0);
	sVar3 = func_93(iParam0, iParam1, iParam2, 0);
	sVar4 = func_92(iParam0, iParam2);
	sVar5 = func_91(iParam0, iParam2);
	iVar6 = func_90(iParam0, iVar1, iParam2);
	...
	iVar8 = func_70(iParam1);
	iVar9 = func_90(iParam0, iVar8, iParam2);
	iVar10 = (iVar6 - iVar9);
	iVar11 = (iVar7 - iVar9);
	if (func_89(iParam0))
	{
	...
	else
	{
		switch (iParam0)
		{
			case 6:
				iVar11 = 0;
				uVar13 = func_88(joaat("mpply_heistfloworderprogress"));
				iVar0 = 0;
				while (iVar0 < 28)
				{
					if (MISC::IS_BIT_SET(uVar13, iVar0))
					{
						iVar11++;
					}
					iVar0++;
				}
				if (MISC::IS_BIT_SET(uVar13, 9))
				{
					iVar11 = (iVar11 - 1);
				}
				if (MISC::IS_BIT_SET(uVar13, 26))
				{
					iVar11 = (iVar11 - 1);
				}
				if (iVar11 < 0)
			...
			case 7:
				iVar11 = 0;
				uVar13 = func_88(joaat("mpply_heistteamprogressbitset"));
				iVar0 = 0;
				while (iVar0 < 28)
				{
					if (MISC::IS_BIT_SET(uVar13, iVar0))
			...
			case 8:
				iVar11 = 0;
				uVar13 = func_88(joaat("mpply_heistnodeathprogreitset"));
				iVar0 = 0;
				while (iVar0 < 28)
				{
					if (MISC::IS_BIT_SET(uVar13, iVar0))
			...
			case 9:
				iVar11 = 0;
				uVar13 = func_88(joaat("mpply_heist_1stperson_prog"));
				iVar0 = 0;
				while (iVar0 < 28)
				{
					if (MISC::IS_BIT_SET(uVar13, iVar0))
			...
			case 10:
				iVar11 = 0;
				uVar13 = func_88(joaat("mpply_heistmemberprogressbitset"));
				iVar0 = 0;
				while (iVar0 < 28)
				{
					if (MISC::IS_BIT_SET(uVar13, iVar0))
	...
	func_62(sVar2, sVar3, sVar4, sVar5, iVar6, iVar7, iVar12, iParam1, uParam3);
}

int func_88(int iParam0)//Position - 0x8FA7
{
	var uVar0;
	var uVar1;
...
int func_89(int iParam0)//Position - 0x8FC5
{
	var uVar0;
	var uVar1;
	var uVar2;
...
int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x8FED
{
	if (iParam1 == 5)
	{
	}
...
char* func_91(int iParam0, int iParam1)//Position - 0x900B
{
	if (iParam1 == 9)
	{
	}
...
char* func_92(int iParam0, int iParam1)//Position - 0x90A7
{
	if (iParam1 == 9)
	{
	}
...
char* func_93(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x9143
{
	if (iParam2 == 9)
	{
	}
	...
	if (func_90(iParam0, iParam1, iParam2) == 1)
	{
	}
	switch (iParam0)
	{
...
char* func_94(int iParam0, int iParam1, bool bParam2)//Position - 0x91F2
{
	if (bParam2)
	{
	}
...
int func_95(int iParam0, int iParam1)//Position - 0x9293
{
	if (iParam1 == 0)
	{
	}
...
int func_96()//Position - 0x930D
{
	return 5;
}

int func_97(int iParam0)//Position - 0x9316
{
	if (func_89(iParam0))
	{
		return 5;
...
void func_98(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0x932C
{
	int iVar0;
	char* sVar1;
	char* sVar2;
	...
	iVar0 = func_108();
	sVar1 = func_106(iParam0, iParam2, 0);
	sVar2 = func_105(iParam0, iParam1, iParam2, 0);
	sVar3 = func_104(iParam0, iParam2);
	sVar4 = func_103(iParam0, iParam2);
	iVar5 = func_102(iParam0, iVar0, iParam2);
	...
	iVar8 = func_70(iParam1);
	iVar9 = func_102(iParam0, iVar8, iParam2);
	iVar10 = (iVar5 - iVar9);
	iVar11 = (iVar6 - iVar9);
	switch (iParam0)
	{
		case 15:
			iVar6 = func_49(1140, -1, 0);
			if (iVar6 > 25)
			{
				iVar6 = 25;
			}
		...
		case 25:
			...
			{
				iVar6 = func_49(2099, -1, 0) * 7;
				iVar7 = func_49(2098, -1, 0);
				iVar6 = 7;
				iVar10 = 7;
				iVar11 = iVar6;
			}
	...
	func_62(sVar1, sVar2, sVar3, sVar4, iVar5, iVar6, iVar12, iParam1, uParam3);
}

int func_99()//Position - 0x95F7
{
	int iVar0;
	int iVar1;
...
int func_100(int iParam0)//Position - 0x9624
{
	switch (iParam0)
	{
		case default:
		...
		case 0:
			return func_49(2640, -1, 0);
		
		case 1:
			return func_49(2641, -1, 0);
		
		case 2:
			return func_49(2642, -1, 0);
		
		case 3:
			return func_49(2643, -1, 0);
		
		case 4:
			return func_49(2644, -1, 0);
		
		case 5:
			return func_49(2645, -1, 0);
		
		case 6:
			return func_49(2646, -1, 0);
		
		case 7:
			return func_49(2647, -1, 0);
		
		case 8:
			return func_49(2648, -1, 0);
		
		case 9:
			return func_49(2649, -1, 0);
		
		case 10:
			return func_49(2650, -1, 0);
		
		case 11:
			return func_49(2651, -1, 0);
		
		case 12:
			return func_49(2652, -1, 0);
		
		case 13:
			return func_49(2653, -1, 0);
		
		case 14:
			return func_49(2654, -1, 0);
		
		case 15:
			return func_49(2655, -1, 0);
		
		case 16:
			return func_49(2656, -1, 0);
		
		case 17:
			return func_49(2657, -1, 0);
		
		case 18:
			return func_49(2658, -1, 0);
		
		case 19:
			return func_49(2659, -1, 0);
		
		case 20:
			return func_49(2660, -1, 0);
		
		case 21:
			return func_49(2661, -1, 0);
		
		case 22:
			return func_49(2662, -1, 0);
		
		case 23:
			return func_49(2663, -1, 0);
		
		case 24:
			return func_49(2664, -1, 0);
		
		case 25:
			return func_49(2665, -1, 0);
		
		case 26:
			return func_49(2666, -1, 0);
		
		case 27:
			return func_49(2667, -1, 0);
		
		case 28:
			return func_49(2668, -1, 0);
		
		case 29:
			return func_49(2669, -1, 0);
		
		case 30:
			return func_49(2670, -1, 0);
		
		case 31:
			return func_49(2671, -1, 0);
		
		case 32:
			return func_49(2672, -1, 0);
		
		case 33:
			return func_49(2673, -1, 0);
		
		case 34:
			return func_49(2674, -1, 0);
		
		case 35:
			return func_49(2675, -1, 0);
		
		case 36:
			return func_49(2676, -1, 0);
		
		case 37:
			return func_49(2677, -1, 0);
		
		case 38:
			return func_49(2678, -1, 0);
		
		case 39:
			return func_49(2679, -1, 0);
		
		case 40:
			return func_49(2680, -1, 0);
		
		case 41:
			return func_49(2681, -1, 0);
		
		case 42:
			return func_49(2682, -1, 0);
		
		case 43:
			return func_49(2683, -1, 0);
		
		case 44:
			return func_49(2684, -1, 0);
		
		case 45:
			return func_49(2685, -1, 0);
		
		case 46:
			return func_49(2686, -1, 0);
		
		case 47:
			return func_49(2687, -1, 0);
		
		case 48:
			return func_49(2688, -1, 0);
		
		case 49:
			return func_49(2689, -1, 0);
	}
	return 0;
}

int func_101(int iParam0, int iParam1)//Position - 0x99BB
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2475762[iParam0 /*6*/][func_43(iParam1)];
...
int func_102(int iParam0, int iParam1, int iParam2)//Position - 0x99E7
{
	if (iParam1 == 5)
	{
	}
...
char* func_103(int iParam0, int iParam1)//Position - 0x9A56
{
	if (iParam1 == 9)
	{
	}
...
char* func_104(int iParam0, int iParam1)//Position - 0x9BE1
{
	if (iParam1 == 9)
	{
		iParam1 = 9;
...
char* func_105(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x9D85
{
	if (iParam2 == 9)
	{
	}
...
char* func_106(int iParam0, int iParam1, bool bParam2)//Position - 0x9F44
{
	if (bParam2)
	{
	}
...
int func_107(int iParam0, int iParam1)//Position - 0xA0EC
{
	if (iParam1 == 9)
	{
	}
...
int func_108()//Position - 0xA22F
{
	return 5;
}

int func_109(int iParam0)//Position - 0xA238
{
	if (func_101(iParam0, -1))
	{
		return 5;
...
void func_110(int iParam0, int iParam1, int iParam2, var uParam3)//Position - 0xA24F
{
	int iVar0;
	char* sVar1;
	char* sVar2;
	...
	switch (iParam1)
	{
		...
		case 6:
			iParam1 = func_116(iParam0, iParam2);
			break;
		
		case 7:
		case 8:
			iParam1 = func_115(iParam0, iParam2);
			break;
	}
	...
	sVar1 = func_114(iParam0, iParam2);
	sVar2 = func_113(iParam0, iParam1, iParam2);
	sVar3 = func_112(iParam0, iParam1, iParam2);
	sVar4 = func_111(iParam0, iParam1, iParam2);
	iVar5 = func_44(iParam0, iVar0, iParam2);
	iVar6 = func_42(iParam0, -1);
	iVar7 = func_70(iParam1);
	iVar8 = func_44(iParam0, iVar7, iParam2);
	iVar9 = (iVar5 - iVar8);
	iVar10 = (iVar6 - iVar8);
	uVar11 = SYSTEM::FLOOR(((SYSTEM::TO_FLOAT(iVar10) / SYSTEM::TO_FLOAT(iVar9)) * 100f));
	func_62(sVar1, sVar2, sVar3, sVar4, iVar5, iVar6, uVar11, iParam1, uParam3);
}

char* func_111(int iParam0, int iParam1, int iParam2)//Position - 0xA38B
{
	switch (iParam0)
	{
		case 53:
...
char* func_112(int iParam0, int iParam1, int iParam2)//Position - 0xA833
{
	if (iParam2 == 9)
	{
	}
...
char* func_113(int iParam0, int iParam1, int iParam2)//Position - 0xB157
{
	if (iParam1 == 5)
	{
	}
...
char* func_114(int iParam0, int iParam1)//Position - 0xB5FD
{
	if (iParam1 == 9)
	{
	}
...
int func_115(int iParam0, int iParam1)//Position - 0xBA89
{
	if (func_79(func_42(iParam0, -1), func_44(iParam0, 5, iParam1)))
	{
		return 5;
	}
	if (func_79(func_42(iParam0, -1), func_44(iParam0, 4, iParam1)))
	{
		return 5;
	}
	if (func_79(func_42(iParam0, -1), func_44(iParam0, 3, iParam1)))
	{
		return 4;
	}
	if (func_79(func_42(iParam0, -1), func_44(iParam0, 2, iParam1)))
	{
		return 3;
	}
	return 2;
...
int func_116(int iParam0, int iParam1)//Position - 0xBAFE
{
	if (!func_79(func_42(iParam0, -1), func_44(iParam0, 2, iParam1)))
	{
		return 0;
...
void func_117(var uParam0, var uParam1)//Position - 0xBB77
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar2 = uParam1->f_5 + 1;
	iVar3 = iLocal_202 + 1;
	func_118(0, iVar2, iVar3, "HUD_PAGE", 0);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0xBBE3
{
...
int func_119(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0xBC40
{
	int iVar0;
	int iVar1;
	...
	{
		case 188:
			if (iParam2 == iLocal_202)
			{
				if (iVar0 < 0 || iVar0 > (iLocal_203 - 1))
				{
					iVar1 = 0;
					while (iVar1 <= 3)
					{
...
void func_120(var uParam0, var uParam1)//Position - 0xBDAA
{
	if (uParam1->f_5 > iLocal_202)
	{
		func_129(uParam0);
...
void func_121()//Position - 0xBDCB
{
	func_118(0, -1, -1, 0, 0);
}

void func_122()//Position - 0xBDDC
{
	func_123();
	func_118(0, -1, -1, 0, 0);
}

void func_123()//Position - 0xBDF1
{
	func_124(0);
}

void func_124(bool bParam0)//Position - 0xBDFE
{
	if (bParam0)
	{
		func_125(0, 3, 0, 2, 0, 0);
	}
	else
	{
		func_125(0, 2, 0, 2, 1, 0);
	}
}

void func_125(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xBE22
{
...
void func_126(var uParam0)//Position - 0xBE65
{
	uParam0->f_463 = 1;
}

void func_127(var uParam0)//Position - 0xBE73
{
	uParam0->f_462 = 1;
}

void func_128(int iParam0, var uParam1)//Position - 0xBE81
{
	uParam1->f_455 = iParam0;
	uParam1->f_456 = iParam0;
}

void func_129(var uParam0)//Position - 0xBE97
{
	func_130(uParam0);
	uParam0->f_460 = 1;
}

void func_130(var uParam0)//Position - 0xBEAB
{
	struct<471> Var0;
...
void func_131(var uParam0)//Position - 0xBF04
{
	uParam0->f_383 = 1;
}

void func_132(int iParam0, var uParam1)//Position - 0xBF12
{
	uParam1->f_380 = iParam0;
}

void func_133(var uParam0)//Position - 0xBF21
{
	func_134(uParam0);
	uParam0->f_382 = 1;
}

void func_134(var uParam0)//Position - 0xBF35
{
	struct<384> Var0;
