...
void __EntryFunction__()//Position - 0x0
{
	...
	if (PLAYER::HAS_FORCE_CLEANUP_OCCURRED(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_96440[Var0 /*10*/].f_9 != -1)
			{
				...
				func_251(&(Global_96440[Var0 /*10*/].f_9));
			}
		}
		func_239(&Var0, 1);
	}
	...
	while (true)
	{
		...
		{
			if (!func_179(-72.323f, -1258.643f, 28.648f, ENTITY::GET_ENTITY_COORDS(Var0.f_35[0], 1), 1056964608))
			{
...
int func_64(struct<3> Param0, char* sParam3, struct<3> Param4)//Position - 0x5632
{
	int iVar0;
	int iVar1;
...
bool func_66(struct<3> Param0, struct<3> Param3)//Position - 0x5CCC
{
...
int func_73(struct<3> Param0, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x6082
{
	int iVar0;
	float fVar1;
	float fVar2;
		...
		if (ENTITY::DOES_ENTITY_EXIST(PLAYER::PLAYER_PED_ID()))
		{
			if (!PED::IS_PED_INJURED(PLAYER::PLAYER_PED_ID()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!PLAYER::IS_PLAYER_READY_FOR_CUTSCENE(PLAYER::PLAYER_ID()) || ENTITY::IS_ENTITY_IN_AIR(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_GETTING_INTO_A_VEHICLE(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID())) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PLAYER::IS_PLAYER_CLIMBING(PLAYER::PLAYER_ID())) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_162()) || Global_96400) || Global_24446) || func_161()) || func_160(8, -1)) || func_77()) || func_159()) || func_158()) || func_157()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1) || func_162()) || Global_24446) || func_161()) || func_160(8, -1)) || func_158()) || func_77()) || func_159()) || func_157()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((PED::IS_PED_RAGDOLL(PLAYER::PLAYER_PED_ID()) || PED::IS_PED_FALLING(PLAYER::PLAYER_PED_ID())) || PLAYER::IS_PLAYER_BEING_ARRESTED(PLAYER::PLAYER_ID(), 1)) || PED::IS_PED_IN_COMBAT(PLAYER::PLAYER_PED_ID(), 0)) || func_162()) || Global_96400) || Global_24446) || func_161()) || func_160(8, -1)) || func_77()) || func_159()) || func_157()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_162() || PLAYER::GET_PLAYER_WANTED_LEVEL(PLAYER::PLAYER_ID()) > 0) || func_160(8, -1)) || func_157()) || func_156()) || Global_97353.f_5944.f_919[iVar0] == 5)
						{
							return 0;
						}
						break;
...
int func_163(var uParam0, struct<3> Param1, char[4] cParam4, char* sParam5, int iParam6, char* sParam7, int iParam8, float fParam9)//Position - 0xAAA5
{
	var uVar0;
	
	if ((((func_111(PLAYER::PLAYER_PED_ID()) && func_111(uParam0->f_28[0])) && !func_129()) && (MISC::GET_GAME_TIMER() - uParam0->f_60) > iParam8) && func_167(PLAYER::PLAYER_PED_ID(), Param1, 1) < fParam9)
	{
		uVar0 = 16;
...
float func_167(int iParam0, struct<3> Param1, int iParam4)//Position - 0xAC59
{
	struct<3> Var0;
...
int func_179(struct<2> Param0, float fParam2, struct<2> Param3, Vector3 vParam5, float fParam6)//Position - 0xB395
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
...
int func_194(var uParam0, struct<3> Param1, int iParam4, var uParam5, int iParam6, int iParam7)//Position - 0xC0CB
{
	var uVar0;
	struct<3> Var1;
	var uVar4;
...
float func_198(struct<3> Param0, struct<3> Param3)//Position - 0xC397
{
	return (((Param0.x * Param3.x) + (Param0.f_1 * Param3.f_1)) + (Param0.f_2 * Param3.f_2));
}
...
int func_206(int iParam0, struct<3> Param1, float fParam4, int iParam5)//Position - 0xC715
{
	struct<3> Var0;
	struct<3> Var3;
	float fVar6;
...
int func_217(var uParam0)//Position - 0xCA08
{
	...
	switch (iLocal_90)
	{
		...
		case 1:
			if (!func_224(&iVar0) || !STREAMING::HAS_ANIM_DICT_LOADED(sVar7))
			{
				return 0;
			}
			iLocal_90 = 2;
...
void func_218(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xCE6C
{
	func_178(uParam0);
...
void func_219(var uParam0, var uParam1, struct<3> Param2, float fParam5)//Position - 0xCE93
{
	func_220(uParam0);
...
int func_221(var uParam0, int iParam1, struct<3> Param2, float fParam5, char* sParam6, int iParam7)//Position - 0xCF6A
{
...
int func_222(var uParam0, int iParam1, struct<3> Param2, var uParam5, bool bParam6)//Position - 0xCFC5
{
	int iVar0;
...
int func_236(int iParam0, int iParam1, struct<3> Param2, float fParam5)//Position - 0xD51E
{
	int iVar0;
...
int func_237(int iParam0, struct<3> Param1, float fParam4, var uParam5)//Position - 0xD583
{
	int iVar0;
	struct<7> Var1;
...
int func_238(struct<3> Param0, struct<3> Param3, float fParam6)//Position - 0xD600
{
	if (fParam6 < 0f)
	{
		fParam6 = 0f;
